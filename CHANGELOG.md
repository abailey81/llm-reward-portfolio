...
- Corpus now **+42 verified cites** over the two research days (18 + 24), each with per-entry provenance + grade; NONE fabricated. Wiring them into CH2/CH4 prose + the A3 tier + the CRN methods note are the next (write-time / design-amendment) steps.
