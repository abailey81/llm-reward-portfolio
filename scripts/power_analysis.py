...
-----
  ...
  --val-track-length  Validation track length T for the Sharpe->validation-DSR MDE reconciliation (T2.5;
                   default 3y x 252 = 756 sessions, val split [2015,2017]). Maps the Sharpe-unit MDE into the
                   SESOI's DSR units (conservative ceiling) so the null framing is single-unit.
...
(`D=1`), giving the conservative **ceiling**
    ...
    ΔDSR_max = 0.3989 · √(T−1) / √{PERIODS_PER_YEAR} · ΔSR_ann      (T = {val_track_length} sessions, val split [2015,2017]).
