...
| 2026-07-23 | R99 | model_suite (Sol/Terra assessment, budget resolution) | **GPT-5.6 Sol + Terra as full legs 11–12 CONSIDERED AND DECLINED on Tamer's budget decision ("I don't have money"), recorded pre-event.** The assessment is preserved: the pair would have formed the study's only closed-vendor 3-point within-family capability ladder (Luna 82.5 / Terra 84.3 / Sol 88.8, GA 2026-07-09, ~$9.32 expected) — the strongest available instrument for the R87 gradient-shape adjudication; registered as the named FIRST-PRIORITY Stage-2/Papers-2/3 extension. Executed instead at reading-axis cost: **Terra seated in the M2 extras** beside Sol (~$0.30, inside the $10 M2 budget cap) so the M2 family ladder carries all three GPT-5.6 points. Legs stay n=10; no confirmatory surface changes. | `config/m2_models.yaml` (terra row); this row |
