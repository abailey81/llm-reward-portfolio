...
def deflated_sharpe_ratio(
    ...
    var_sr:
        Optional variance of the trial Sharpe estimates. If omitted, the
        default estimate ``Var[SR_hat] = (1 - skew*SR + (kurt-1)/4 SR^2)/(n-1)``
        of a single Sharpe estimate is used as a proxy for the cross-trial
        Sharpe variance.
    periods_per_year:
