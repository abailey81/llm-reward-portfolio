...
| $\mathrm{VaR}_\alpha$ | Value-at-risk at level $\alpha$ (the $\alpha$-quantile of the realised-return lower tail; equivalently minus the $(1-lpha)$-quantile of the loss $\ell=-Z$); appears jointly with $\mathrm{CVaR}_\alpha$ in the elicitability argument. | Ch. 3 (§3.5) |
