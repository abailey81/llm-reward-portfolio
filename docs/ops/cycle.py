...
RUNNING_SHA = "b5fdde5"   # re-based 2026-08-01: b44a566 -> a51d2ea (§100.33) -> b5fdde5 (§100.34).
# TWO fenced files moved, and BOTH are PROVEN OUTSIDE the driver import closure:
