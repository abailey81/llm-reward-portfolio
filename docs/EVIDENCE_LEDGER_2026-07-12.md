...
| 16 | A100 (L-pool) pack behavior — F_A100 at pack {5, 8} | **UNMEASURED (probes live)** | the F-curve (claim 3) is V100-only; the striped blocks run HALF the campaign on A100s blind to their packing response | probes 785630 (pack-5) + 785631 (pack-8) submitted 2026-07-13 on pool L — read before launch; if F_A100(8) ≫ F_A100(5), a per-pool pack parameter is the follow-up |
