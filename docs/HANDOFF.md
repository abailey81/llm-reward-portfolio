...
handoff_state:
  ...
  suite_status: "exit 0 (13th certification, post-audit)"
  gate_checks: 21
...
| Amendments | through **R97** (R93 freeze-prep evidence retained · R94 lift · R95 K3 seated · R96 the OPTIONAL M2 module · R97 the DDR downside companion + the secondary panel's execution path, runbook §9(h)) |
...
panel's execution path (runbook §9(h)).
