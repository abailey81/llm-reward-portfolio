...
**Auto-generated 2026-08-05 02:49 UTC -- T+173h40m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+173h40m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 4.3 h ago; none live, newest failure 33 min ago** |
...
```
generated 2026-08-05 02:50 UTC | elapsed 7.24 d | 21.9 d to the Aug-27 stop
test tier: 13,596 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      27 records      27.0 rec/h
    last  3 h     260 records      86.7 rec/h
    last 12 h    1980 records     165.0 rec/h
    last 24 h    4140 records     172.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,324       3  GATED             GATED             barrier>=30
      189       7,774       3  GATED             GATED             barrier>=30
      279      12,274       3  GATED             GATED             barrier>=30
      340      15,324       3  GATED             GATED             barrier>=30
      403      18,474       3  GATED             GATED             barrier>=30
      568      26,732      27  GATED             GATED             barrier>=30
