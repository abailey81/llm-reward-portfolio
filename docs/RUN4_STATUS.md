...
**Auto-generated 2026-08-05 00:20 UTC -- T+171h11m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+171h11m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 1.8 h ago; none live, newest failure 44 min ago** |
...
| | |
|---|---|
| cluster jobs | **963** (167 running, 794 queued) |
| **cores computing** | **1336** |
...
```
generated 2026-08-05 00:20 UTC | elapsed 7.13 d | 22.0 d to the Aug-27 stop
test tier: 13,401 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     144 records     144.0 rec/h
    last  3 h     444 records     148.0 rec/h
    last 12 h    2249 records     187.4 rec/h
    last 24 h    4226 records     176.1 rec/h
    12 h rate is 55% from ONE line (test_leg_sonnet_5); 10 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 56% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_sonnet_5, test_leg_gpt_5_6_luna) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (83 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,340       0  GATED             GATED             barrier>=30
      189       7,790       0  GATED             GATED             barrier>=30
      279      12,290       0  GATED             GATED             barrier>=30
      340      15,340       0  GATED             GATED             barrier>=30
      403      18,490       0  GATED             GATED             barrier>=30
      568      26,927     144  GATED             GATED             barrier>=30
...
2026-08-05T00:01:55Z  OK  records=14891 (+19)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.9m  drift=0  sci=OK  r115=22B  sweep=506.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T00:07:17Z  ATTN  records=14911 (+20)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  sweep=291.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T00:12:11Z  OK  records=14921 (+10)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  sweep=263.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T00:16:34Z  OK  records=14933 (+12)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  cores=1360  sweep=232.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
