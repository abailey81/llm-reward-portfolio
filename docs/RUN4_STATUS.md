...
**Auto-generated 2026-08-12 01:03 UTC -- T+339h54m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+339h54m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **744** |
| **cores doing RUNG-RAISING work** | **37.8%** -- 248 of 656 cores (91 min old **STALE**) |
...
```
generated 2026-08-12 01:04 UTC | elapsed 14.16 d | 15.0 d to the Aug-27 stop
test tier: 30,102 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    2458 records     102.4 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279          72      39  GATED             GATED             barrier
      340       1,497      44  GATED             GATED             barrier>=279
      403       3,702      44  GATED             GATED             barrier>=279
      568      10,226      44  GATED             GATED             barrier>=279
