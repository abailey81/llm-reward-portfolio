...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,727     168  GATED             GATED             barrier>=30
      189       6,297     224  GATED             GATED             barrier>=30
      279      10,346     225  GATED             GATED             barrier>=30
      340      13,091     225  GATED             GATED             barrier>=30
      403      15,926     225  GATED             GATED             barrier>=30
      568      23,359     225  GATED             GATED             barrier>=30
