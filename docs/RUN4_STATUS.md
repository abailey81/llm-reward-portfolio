...
**Auto-generated 2026-08-02 05:25 UTC -- T+104h16m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+104h16m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **382** (114 running, 268 queued) |
| **cores computing** | **912** |
...
```
 rung              @912 cores              @830 cores   binding
  ...
  340           10.1 d  08-08           11.1 d  08-09   throughput
  403           11.9 d  08-09           13.0 d  08-10   throughput
  568           16.5 d  08-14           18.1 d  08-15   throughput
```
...
```
2026-08-02T05:20:24Z  RED  records=3305 (+1)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=20B  sweep=20.8s  auto-cycle
2026-08-02T05:21:15Z  RED  records=3306 (+1)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=20B  sweep=38.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T05:22:24Z  RED  records=3307 (+1)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=20B  sweep=21.0s  auto-cycle
2026-08-02T05:23:15Z  RED  records=3307 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=3.4m  drift=0  sci=OK  r115=20B  sweep=21.1s  auto-cycle
2026-08-02T05:24:06Z  RED  records=3307 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=4.3m  drift=0  sci=OK  r115=20B  sweep=21.7s  auto-cycle
2026-08-02T05:24:58Z  RED  records=3308 (+1)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=1.9m  drift=0  sci=OK  r115=20B  sweep=19.9s  auto-cycle
```
