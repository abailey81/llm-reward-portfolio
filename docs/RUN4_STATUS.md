...
**Auto-generated 2026-08-05 16:57 UTC -- T+187h48m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+187h48m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **884** (168 running, 716 queued) |
...
```
generated 2026-08-05 16:57 UTC | elapsed 7.83 d | 21.3 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     595 records     198.3 rec/h
    last 12 h    2165 records     180.4 rec/h
    last 24 h    3848 records     160.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      403      16,471      21  GATED             GATED             barrier>=30
      568      24,540     199  GATED             GATED             barrier>=30
