...
**Auto-generated 2026-08-06 15:01 UTC -- T+209h52m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+209h52m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 27 min ago; none live, newest failure 27 min ago** |
...
| **cores computing** | **632** |
| **cores doing RUNG-RAISING work** | **22.6%** -- 184 of 816 cores (137 min old **STALE**) |
...
```
generated 2026-08-06 15:01 UTC | elapsed 8.74 d | 20.4 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,441     197  GATED             GATED             unstarted:2-unit(s)-absent>=30
      340      12,186     197  GATED             GATED             unstarted:2-unit(s)-absent>=30
      403      15,021     197  GATED             GATED             unstarted:2-unit(s)-absent>=30
      568      22,454     197  GATED             GATED             unstarted:2-unit(s)-absent>=30
