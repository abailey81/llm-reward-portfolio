...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 77 min ago; none live, newest failure 77 min ago** |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,695      37  GATED             GATED             barrier>=30
      189       6,259      43  GATED             GATED             barrier>=30
      279      10,307      44  GATED             GATED             barrier>=30
      340      13,052      44  GATED             GATED             barrier>=30
      403      15,887      44  GATED             GATED             barrier>=30
      568      23,320      44  GATED             GATED             barrier>=30
