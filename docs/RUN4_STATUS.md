...
**Auto-generated 2026-08-03 13:58 UTC -- T+136h49m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+136h49m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **9159** |
| LLM calls / spend | 2951 / **$45.4853** |
| transport timeouts | **59** |
...
| | |
|---|---|
| cluster jobs | **695** (181 running, 514 queued) |
...
```
 rung             @1448 cores              @830 cores   binding
  ...
  279            5.3 d  08-03            9.3 d  08-07   throughput
  340            6.4 d  08-04           11.1 d  08-09   throughput
  403            7.5 d  08-05           13.0 d  08-10   throughput
  568           10.4 d  08-08           18.1 d  08-15   throughput
```
...
| deepseek_v4_pro | **0** | 30 | 5 | 3 arm(s) still at zero |
...
```
2026-08-03T13:39:48Z  RED  records=9116 (+5)  spend=$45.4852  guards=2  arms_full=10/10  budget=2  stalest=2.1m  drift=0  sci=OK  r115=21B  sweep=156.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T13:42:54Z  RED  records=9124 (+8)  spend=$45.4852  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=21B  sweep=145.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T13:45:50Z  RED  records=9132 (+8)  spend=$45.4852  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=21B  sweep=123.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T13:48:24Z  RED  records=9138 (+6)  spend=$45.4852  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=21B  sweep=181.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T13:51:55Z  RED  records=9146 (+8)  spend=$45.4852  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=21B  sweep=165.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T13:55:11Z  RED  records=9153 (+7)  spend=$45.4852  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=21B  sweep=115.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
