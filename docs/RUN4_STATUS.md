...
**Auto-generated 2026-08-06 09:39 UTC -- T+204h30m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+204h30m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **904** |
| **cores doing RUNG-RAISING work** | **20.7%** -- 200 of 968 cores (20 min old) |
...
test tier: 17,510 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,757     127  GATED             GATED             barrier>=30
      279       9,805     127  GATED             GATED             barrier>=30
      340      12,550     127  GATED             GATED             barrier>=30
      403      15,385     127  GATED             GATED             barrier>=30
      568      22,818     127  GATED             GATED             barrier>=30
