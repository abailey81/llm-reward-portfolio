...
**Auto-generated 2026-08-06 01:07 UTC -- T+195h58m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h58m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 63 min ago; none live, newest failure 63 min ago** |
...
| | |
|---|---|
| cluster jobs | **972** (69 running, 903 queued) |
| **cores computing** | **552** |
...
```
generated 2026-08-06 01:07 UTC | elapsed 8.17 d | 21.0 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,704      78  GATED             GATED             barrier>=30
      189       6,268      88  GATED             GATED             barrier>=30
      279      10,316      90  GATED             GATED             barrier>=30
      340      13,061      90  GATED             GATED             barrier>=30
      403      15,896      90  GATED             GATED             barrier>=30
      568      23,329      90  GATED             GATED             barrier>=30
...
2026-08-06T01:07:51Z  ATTN  records=18542 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.6m  drift=0  sci=OK  r115=22B  sweep=165.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
