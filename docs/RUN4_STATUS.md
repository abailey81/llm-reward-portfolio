...
**Auto-generated 2026-08-01 00:09 UTC -- T+75h00m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+75h00m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **181** (120 running, 61 queued) |
| **cores computing** | **960** |
...
```
2026-08-01T00:05:29Z  RED  records=1553 (+0)  spend=$38.9374  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=13B  sweep=11.2s  auto-cycle
2026-08-01T00:06:11Z  RED  records=1553 (+0)  spend=$38.9374  guards=2  arms_full=10/10  budget=2  stalest=2.1m  drift=0  sci=OK  r115=13B  sweep=12.4s  auto-cycle
2026-08-01T00:06:53Z  RED  records=1554 (+1)  spend=$38.9374  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=13B  sweep=12.8s  auto-cycle
2026-08-01T00:07:36Z  RED  records=1555 (+1)  spend=$38.9374  guards=2  arms_full=10/10  budget=2  stalest=1.4m  drift=0  sci=OK  r115=13B  sweep=12.2s  auto-cycle
2026-08-01T00:08:19Z  RED  records=1556 (+1)  spend=$38.9374  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=13B  sweep=12.4s  auto-cycle
2026-08-01T00:09:01Z  RED  records=1556 (+0)  spend=$38.9983  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=13B  sweep=12.6s  auto-cycle
```
...
```
  anthropic   spent $ 31.8785  + still to author $  6.1436  = $ 38.0221   credited $ 28.1500   margin $  -9.8721 (-35%)  over the credit ESTIMATE (owner-watched)
