...
test tier: 17,048 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      50 records      50.0 rec/h
    last  3 h     406 records     135.3 rec/h
    last 12 h    1852 records     154.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,655      50  GATED             GATED             barrier>=30
      189       6,219      50  GATED             GATED             barrier>=30
      279      10,267      50  GATED             GATED             barrier>=30
      340      13,012      50  GATED             GATED             barrier>=30
      403      15,847      50  GATED             GATED             barrier>=30
      568      23,280      50  GATED             GATED             barrier>=30
