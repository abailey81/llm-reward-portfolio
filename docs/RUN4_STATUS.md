...
**Auto-generated 2026-08-02 15:53 UTC -- T+114h44m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+114h44m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **886** (240 running, 646 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1152 |
| scalar | g5 of 5 | 562 |
| placebo | g5 of 5 | 793 |
| scalar_cvar5 | g5 of 5 | 750 |
| placebo_shuffled | g5 of 5 | 737 |
...
```
2026-08-02T15:46:47Z  RED  records=4356 (+2)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=21B  sweep=29.1s  auto-cycle
2026-08-02T15:47:47Z  RED  records=4365 (+9)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0  sci=OK  r115=21B  cores=1952  sweep=55.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T15:49:13Z  RED  records=4370 (+5)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=21B  sweep=28.9s  auto-cycle
2026-08-02T15:50:12Z  RED  records=4379 (+9)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.6m  drift=0  sci=OK  r115=21B  sweep=30.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T15:51:13Z  RED  records=4381 (+2)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=21B  sweep=33.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T15:52:17Z  RED  records=4388 (+7)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=21B  sweep=55.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
