...
**Auto-generated 2026-08-12 01:17 UTC -- T+340h08m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+340h08m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **508** = 96 running + **84 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **768** |
| **cores doing RUNG-RAISING work** | **37.8%** -- 248 of 656 cores (104 min old **STALE**) |
...
```
generated 2026-08-12 01:18 UTC | elapsed 14.17 d | 14.9 d to the Aug-27 stop
test tier: 30,113 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279          72      29  GATED             GATED             barrier
      340       1,486      45  GATED             GATED             barrier>=279
      403       3,691      45  GATED             GATED             barrier>=279
      568      10,215      45  GATED             GATED             barrier>=279
