...
**Auto-generated 2026-08-06 04:06 UTC -- T+198h57m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+198h57m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
test tier: 17,096 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      18 records      18.0 rec/h
    last  3 h      97 records      32.3 rec/h
    last 12 h    1478 records     123.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,607      18  GATED             GATED             barrier>=30
      189       6,171      18  GATED             GATED             barrier>=30
      279      10,219      18  GATED             GATED             barrier>=30
      340      12,964      18  GATED             GATED             barrier>=30
      403      15,799      18  GATED             GATED             barrier>=30
      568      23,232      18  GATED             GATED             barrier>=30
