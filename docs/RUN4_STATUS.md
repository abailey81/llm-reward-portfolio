...
**Auto-generated 2026-08-05 00:53 UTC -- T+171h44m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+171h44m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 2.4 h ago; none live, newest failure 77 min ago** |
...
| | |
|---|---|
| cluster jobs | **955** (170 running, 783 queued) |
...
```
generated 2026-08-05 00:53 UTC | elapsed 7.16 d | 22.0 d to the Aug-27 stop
test tier: 13,465 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     123 records     123.0 rec/h
    last  3 h     453 records     151.0 rec/h
    last 12 h    2216 records     184.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      26,863     123  GATED             GATED             barrier>=30
