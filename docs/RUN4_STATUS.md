...
**Auto-generated 2026-08-06 01:05 UTC -- T+195h56m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h56m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 61 min ago; none live, newest failure 61 min ago** |
...
| | |
|---|---|
| cluster jobs | **972** (68 running, 904 queued) |
| **cores computing** | **544** |
...
```
generated 2026-08-06 01:05 UTC | elapsed 8.16 d | 21.0 d to the Aug-27 stop
test tier: 16,999 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      96 records      96.0 rec/h
    last  3 h     486 records     162.0 rec/h
    last 12 h    1908 records     159.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,704      83  GATED             GATED             barrier>=30
      189       6,268      94  GATED             GATED             barrier>=30
      279      10,316      96  GATED             GATED             barrier>=30
      340      13,061      96  GATED             GATED             barrier>=30
      403      15,896      96  GATED             GATED             barrier>=30
      568      23,329      96  GATED             GATED             barrier>=30
...
2026-08-06T01:03:23Z  ATTN  records=18541 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.1m  drift=0  sci=OK  r115=22B  sweep=28.1s  auto-cycle
2026-08-06T01:04:35Z  ATTN  records=18542 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.1m  drift=0  sci=OK  r115=22B  sweep=41.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
