...
**Auto-generated 2026-08-05 09:07 UTC -- T+179h58m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+179h58m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 1.9 h ago; none live, newest failure 1.9 h ago** |
...
| | |
|---|---|
| cluster jobs | **872** (187 running, 685 queued) |
...
```
generated 2026-08-05 09:08 UTC | elapsed 7.50 d | 21.6 d to the Aug-27 stop
test tier: 14,628 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     256 records     256.0 rec/h
    last  3 h     729 records     243.0 rec/h
    last 12 h    1718 records     143.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,050     161  GATED             GATED             barrier>=30
      189       7,015     201  GATED             GATED             barrier>=30
      279      11,250     256  GATED             GATED             barrier>=30
      340      14,300     256  GATED             GATED             barrier>=30
      403      17,450     256  GATED             GATED             barrier>=30
      568      25,700     256  GATED             GATED             barrier>=30
