...
**Auto-generated 2026-08-06 01:04 UTC -- T+195h55m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h55m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,704      84  GATED             GATED             barrier>=30
      189       6,268      95  GATED             GATED             barrier>=30
      279      10,316      97  GATED             GATED             barrier>=30
      340      13,061      97  GATED             GATED             barrier>=30
      403      15,896      97  GATED             GATED             barrier>=30
      568      23,329      97  GATED             GATED             barrier>=30
