...
**Auto-generated 2026-08-06 11:03 UTC -- T+205h54m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+205h54m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **856** |
| **cores doing RUNG-RAISING work** | **21.4%** -- 192 of 896 cores (13 min old) |
...
```
generated 2026-08-06 11:03 UTC | elapsed 8.58 d | 20.5 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,728      63  GATED             GATED             barrier>=30
      340      12,473      63  GATED             GATED             barrier>=30
      403      15,308      63  GATED             GATED             barrier>=30
      568      22,741      63  GATED             GATED             barrier>=30
