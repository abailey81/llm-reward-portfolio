...
**Auto-generated 2026-08-05 13:28 UTC -- T+184h19m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+184h19m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 2.6 h ago; none live, newest failure 24 min ago** |
...
| | |
|---|---|
| cluster jobs | **964** (195 running, 769 queued) |
...
```
generated 2026-08-05 13:28 UTC | elapsed 7.68 d | 21.4 d to the Aug-27 stop
test tier: 15,119 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,809      66  GATED             GATED             barrier>=30
      403      16,959      66  GATED             GATED             barrier>=30
      568      25,209      66  GATED             GATED             barrier>=30
