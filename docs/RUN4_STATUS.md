...
**Auto-generated 2026-08-05 10:51 UTC -- T+181h42m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+181h42m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 3.6 h ago; LIVE, still failing** |
...
```
generated 2026-08-05 10:51 UTC | elapsed 7.57 d | 21.5 d to the Aug-27 stop
test tier: 14,888 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     165 records     165.0 rec/h
    last  3 h     589 records     196.3 rec/h
    last 12 h    1736 records     144.7 rec/h
    last 24 h    3949 records     164.5 rec/h
    12 h rate is 51% from ONE line (test_leg_haiku_4_5); 5 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 25% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         180      42  GATED             GATED             barrier
      100       2,980      42  GATED             GATED             barrier>=30
      189       6,842      85  GATED             GATED             barrier>=30
      279      10,990     165  GATED             GATED             barrier>=30
      340      14,040     165  GATED             GATED             barrier>=30
      403      17,190     165  GATED             GATED             barrier>=30
      568      25,440     165  GATED             GATED             barrier>=30
