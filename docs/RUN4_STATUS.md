...
**Auto-generated 2026-08-06 09:17 UTC -- T+204h08m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+204h08m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **927** (125 running, 802 queued) |
| **cores computing** | **986** |
| **cores doing RUNG-RAISING work** | **20.8%** -- 208 of 1000 cores (25 min old) |
...
```
generated 2026-08-06 09:17 UTC | elapsed 8.51 d | 20.6 d to the Aug-27 stop
test tier: 17,439 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,828      74  GATED             GATED             barrier>=30
      279       9,876      74  GATED             GATED             barrier>=30
      340      12,621      74  GATED             GATED             barrier>=30
      403      15,456      74  GATED             GATED             barrier>=30
      568      22,889      74  GATED             GATED             barrier>=30
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung      @986 cores      @830 cores   binding
