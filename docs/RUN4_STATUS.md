...
**Auto-generated 2026-08-02 14:06 UTC -- T+112h57m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+112h57m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **926** (226 running, 700 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1096 |
| scalar | g5 of 5 | 504 |
| placebo | g5 of 5 | 730 |
| scalar_cvar5 | g5 of 5 | 689 |
| placebo_shuffled | g5 of 5 | 678 |
...
2026-08-02T14:02:09Z  RED  records=4069 (+2)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=21B  sweep=26.8s  auto-cycle
2026-08-02T14:03:06Z  RED  records=4076 (+7)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=21B  sweep=30.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T14:04:06Z  RED  records=4076 (+0)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.8m  drift=0  sci=OK  r115=21B  sweep=27.1s  auto-cycle
