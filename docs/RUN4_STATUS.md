...
**Auto-generated 2026-08-01 06:26 UTC -- T+81h17m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+81h17m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **145** (126 running, 19 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 796 |
| scalar | g5 of 5 | 296 |
| placebo | g5 of 5 | 244 |
| scalar_cvar5 | g5 of 5 | 227 |
| placebo_shuffled | g5 of 5 | 181 |
...
```
2026-08-01T06:22:31Z  RED  records=2132 (+0)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=0.7m  drift=0  sci=OK  r115=14B  sweep=14.1s  auto-cycle
2026-08-01T06:23:15Z  RED  records=2133 (+1)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=1.5m  drift=0  sci=OK  r115=14B  sweep=14.7s  auto-cycle
2026-08-01T06:24:00Z  RED  records=2134 (+1)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=14B  sweep=14.4s  auto-cycle
2026-08-01T06:24:45Z  RED  records=2134 (+0)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=14B  sweep=11.0s  auto-cycle
2026-08-01T06:25:26Z  RED  records=2134 (+0)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=14B  sweep=15.0s  auto-cycle
2026-08-01T06:26:11Z  RED  records=2134 (+0)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=1.3m  drift=0  sci=OK  r115=14B  sweep=14.3s  auto-cycle
```
...
```
  anthropic   spent $ 35.2446  + still to author $  5.6346  = $ 40.8792   credited $ 28.1500   margin $ -12.7292 (-45%)  over the credit ESTIMATE (owner-watched)
  openrouter  spent $  8.0197  + still to author $  2.0889  = $ 10.1086   credited $ 19.3100   margin $  +9.2014 (+48%)  comfortable
```
