...
```
generated 2026-08-06 03:52 UTC | elapsed 8.28 d | 20.8 d to the Aug-27 stop
test tier: 17,080 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h       2 records       2.0 rec/h
    last  3 h      86 records      28.7 rec/h
    last 12 h    1505 records     125.4 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,623       2  GATED             GATED             barrier>=30
      189       6,187       2  GATED             GATED             barrier>=30
      279      10,235       2  GATED             GATED             barrier>=30
      340      12,980       2  GATED             GATED             barrier>=30
      403      15,815       2  GATED             GATED             barrier>=30
      568      23,248       2  GATED             GATED             barrier>=30
...
```
2026-08-06T03:31:45Z  OK  records=18622 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.0m  drift=0  sci=OK  r115=22B  sweep=26.7s  auto-cycle
