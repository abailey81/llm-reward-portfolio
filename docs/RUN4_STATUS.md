...
**Auto-generated 2026-08-06 10:30 UTC -- T+205h22m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    2696 records     112.3 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,728      44  GATED             GATED             barrier>=30
      279       9,776      44  GATED             GATED             barrier>=30
      340      12,521      44  GATED             GATED             barrier>=30
      403      15,356      44  GATED             GATED             barrier>=30
      568      22,789      44  GATED             GATED             barrier>=30
