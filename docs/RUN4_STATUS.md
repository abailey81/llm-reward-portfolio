...
**Auto-generated 2026-08-06 00:03 UTC -- T+194h54m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+194h54m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **971** (68 running, 903 queued) |
| **cores computing** | **544** |
...
```
generated 2026-08-06 00:03 UTC | elapsed 8.12 d | 21.0 d to the Aug-27 stop
test tier: 16,893 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     226 records     226.0 rec/h
    last  3 h     510 records     170.0 rec/h
    last 12 h    1857 records     154.8 rec/h
    last 24 h    3526 records     146.9 rec/h
    12 h rate is 75% from ONE line (test_leg_haiku_4_5); 4 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 75% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_haiku_4_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,796     123  GATED             GATED             barrier>=30
      189       6,372     226  GATED             GATED             barrier>=30
      279      10,422     226  GATED             GATED             barrier>=30
      340      13,167     226  GATED             GATED             barrier>=30
      403      16,002     226  GATED             GATED             barrier>=30
      568      23,435     226  GATED             GATED             barrier>=30
