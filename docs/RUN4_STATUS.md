...
**Auto-generated 2026-08-05 01:37 UTC -- T+172h28m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+172h28m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 3.1 h ago; none live, newest failure 2.0 h ago** |
...
| | |
|---|---|
| cluster jobs | **946** (177 running, 767 queued) |
| **cores computing** | **1416** |
...
```
generated 2026-08-05 01:37 UTC | elapsed 7.19 d | 21.9 d to the Aug-27 stop
test tier: 13,547 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     107 records     107.0 rec/h
    last  3 h     445 records     148.3 rec/h
    last 12 h    2179 records     181.6 rec/h
    last 24 h    4254 records     177.2 rec/h
    12 h rate is 47% from ONE line (test_leg_sonnet_5); 10 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 64% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_sonnet_5, test_leg_qwen3_5_9b) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,333       7  GATED             GATED             barrier>=30
      189       7,783       7  GATED             GATED             barrier>=30
      279      12,283       7  GATED             GATED             barrier>=30
      340      15,333       7  GATED             GATED             barrier>=30
      403      18,483       7  GATED             GATED             barrier>=30
      568      26,781     107  GATED             GATED             barrier>=30
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung     @1416 cores      @830 cores   binding
       30           4.6 d           4.6 d   critical_chain
      100           4.6 d           4.6 d   critical_chain
      189           4.6 d           6.5 d   throughput
      279           5.4 d           9.3 d   throughput
      340           6.5 d          11.1 d   throughput
      403           7.6 d          13.0 d   throughput
      568          10.6 d          18.1 d   throughput
...
```
2026-08-05T01:05:59Z  OK  records=15030 (+16)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.0m  drift=0  sci=OK  r115=22B  sweep=312.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T01:11:16Z  OK  records=15041 (+11)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.3m  drift=0  sci=OK  r115=22B  cores=1368  sweep=287.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T01:17:58Z  OK  records=15057 (+16)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=371.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T01:23:39Z  OK  records=15065 (+8)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  sweep=310.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
