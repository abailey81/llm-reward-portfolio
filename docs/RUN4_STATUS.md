...
**Auto-generated 2026-08-05 06:20 UTC -- T+177h11m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+177h11m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 78 min ago; none live, newest failure 78 min ago** |
...
```
generated 2026-08-05 06:20 UTC | elapsed 7.38 d | 21.7 d to the Aug-27 stop
test tier: 13,932 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,238      20  GATED             GATED             barrier>=30
      189       7,446     261  GATED             GATED             barrier>=30
      279      11,946     261  GATED             GATED             barrier>=30
      340      14,996     261  GATED             GATED             barrier>=30
      403      18,146     261  GATED             GATED             barrier>=30
      568      26,396     261  GATED             GATED             barrier>=30
