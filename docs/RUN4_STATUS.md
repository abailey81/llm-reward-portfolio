...
**Auto-generated 2026-08-05 14:09 UTC -- T+185h00m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+185h00m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 3.3 h ago; none live, newest failure 65 min ago** |
...
| | |
|---|---|
| cluster jobs | **955** (188 running, 767 queued) |
...
```
generated 2026-08-05 14:09 UTC | elapsed 7.71 d | 21.4 d to the Aug-27 stop
test tier: 15,236 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     143 records     143.0 rec/h
    last  3 h     316 records     105.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,692     143  GATED             GATED             barrier>=30
      403      16,842     143  GATED             GATED             barrier>=30
      568      25,092     143  GATED             GATED             barrier>=30
