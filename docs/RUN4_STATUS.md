...
**Auto-generated 2026-08-03 07:22 UTC -- T+130h13m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+130h13m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **936** (283 running, 653 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1771 |
| scalar | g5 of 5 | 1181 |
| placebo | g5 of 5 | 1309 |
| scalar_cvar5 | g5 of 5 | 1273 |
| placebo_shuffled | g5 of 5 | 1290 |
...
2026-08-03T07:21:18Z  RED  records=7223 (+9)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=3.2m  drift=0  sci=OK  r115=21B  sweep=129.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
