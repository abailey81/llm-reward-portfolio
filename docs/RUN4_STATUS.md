...
| **cores computing** | **520** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (76 min old) |
...
```
generated 2026-08-11 20:49 UTC | elapsed 13.99 d | 15.1 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,662      90  GATED             GATED             barrier>=279
      403       3,867      90  GATED             GATED             barrier>=279
      568      10,391      90  GATED             GATED             barrier>=279
