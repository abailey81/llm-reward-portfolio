...
**Auto-generated 2026-08-11 20:55 UTC -- T+335h46m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+335h46m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **520** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (82 min old) |
...
```
generated 2026-08-11 20:56 UTC | elapsed 13.99 d | 15.1 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,657      84  GATED             GATED             barrier>=279
      403       3,862      84  GATED             GATED             barrier>=279
      568      10,386      84  GATED             GATED             barrier>=279
