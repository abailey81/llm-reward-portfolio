...
**Auto-generated 2026-08-05 07:34 UTC -- T+178h25m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+178h25m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **920** (198 running, 722 queued) |
...
```
generated 2026-08-05 07:35 UTC | elapsed 7.43 d | 21.7 d to the Aug-27 stop
test tier: 14,223 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     234 records     234.0 rec/h
    last  3 h     616 records     205.3 rec/h
    last 12 h    1688 records     140.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,233       5  GATED             GATED             barrier>=30
      189       7,238     151  GATED             GATED             barrier>=30
      279      11,655     234  GATED             GATED             barrier>=30
      340      14,705     234  GATED             GATED             barrier>=30
      403      17,855     234  GATED             GATED             barrier>=30
      568      26,105     234  GATED             GATED             barrier>=30
