...
**Auto-generated 2026-08-02 02:36 UTC -- T+101h27m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+101h27m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **55** (49 running, 6 queued) |
| **cores computing** | **392** |
...
```
 rung              @392 cores              @830 cores   binding
  ...
  100            8.1 d  08-05            4.6 d  08-02   critical_chain
  189           13.8 d  08-11            6.5 d  08-04   throughput
  279           19.6 d  08-17            9.3 d  08-07   throughput
  340           23.6 d  08-21           11.1 d  08-09   throughput
  403           27.6 d  08-25           13.0 d  08-10   throughput
  568        38.3 d  09-05  X           18.1 d  08-15   throughput
```
...
| scalar | g5 of 5 | 326 |
| placebo | g5 of 5 | 588 |
| scalar_cvar5 | g5 of 5 | 520 |
| placebo_shuffled | g5 of 5 | 463 |
...
```
2026-08-02T02:30:50Z  RED  records=3194 (+0)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0  sci=OK  r115=20B  sweep=17.8s  auto-cycle
2026-08-02T02:31:38Z  RED  records=3194 (+0)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=3.7m  drift=0  sci=OK  r115=20B  sweep=20.4s  auto-cycle
2026-08-02T02:32:29Z  RED  records=3194 (+0)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=4.5m  drift=0  sci=OK  r115=20B  sweep=20.0s  auto-cycle
2026-08-02T02:33:19Z  RED  records=3195 (+1)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=20B  sweep=37.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T02:34:27Z  RED  records=3196 (+1)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0  sci=OK  r115=20B  sweep=19.5s  auto-cycle
2026-08-02T02:35:17Z  RED  records=3196 (+0)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=20B  sweep=21.2s  auto-cycle
```
