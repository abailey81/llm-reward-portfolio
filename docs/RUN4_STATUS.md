...
**Auto-generated 2026-08-12 02:04 UTC -- T+340h55m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+340h55m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **502** = 100 running + **74 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **800** |
| **cores doing RUNG-RAISING work** | **56.7%** -- 440 of 776 cores (32 min old) |
...
```
generated 2026-08-12 02:05 UTC | elapsed 14.21 d | 14.9 d to the Aug-27 stop
test tier: 30,155 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     106 records      35.3 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,444      50  GATED             GATED             barrier>=279
      403       3,649      50  GATED             GATED             barrier>=279
      568      10,173      50  GATED             GATED             barrier>=279
...
```
2026-08-12T01:43:50Z  OK  records=31678 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.9m  drift=0  sci=OK  r115=22B  sweep=55.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T01:45:16Z  OK  records=31680 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  sweep=56.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T01:46:39Z  OK  records=31682 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.7m  drift=0  sci=OK  r115=22B  sweep=52.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T01:48:14Z  OK  records=31684 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  cores=768  sweep=64.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T01:49:37Z  OK  records=31685 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.4m  drift=0  sci=OK  r115=22B  sweep=52.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T02:04:03Z  OK  records=31697 (+12)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.8m  drift=0  sci=OK  r115=22B  sweep=836.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
