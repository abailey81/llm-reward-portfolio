...
**Auto-generated 2026-08-06 06:00 UTC -- T+200h51m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h51m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **942** (71 running, 871 queued) |
| **cores computing** | **568** |
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    1291 records     107.6 rec/h
    last 24 h    3415 records     142.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,984     139  GATED             GATED             barrier>=30
      279      10,032     139  GATED             GATED             barrier>=30
      340      12,777     139  GATED             GATED             barrier>=30
      403      15,612     139  GATED             GATED             barrier>=30
      568      23,045     139  GATED             GATED             barrier>=30
