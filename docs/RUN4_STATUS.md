...
**Auto-generated 2026-08-13 01:59 UTC -- T+364h50m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+364h50m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **318** = 56 running + **196 ELIGIBLE** + 66 held by us + 0 held only by the site |
...
| **cores computing** | **448** |
| **cores doing RUNG-RAISING work** | **27.5%** -- 112 of 408 cores (25 min old) |
...
```
generated 2026-08-13 02:00 UTC | elapsed 15.20 d | 13.9 d to the Aug-27 stop
test tier: 31,536 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 23.2 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h     279 records      23.2 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340         424       0  2026-08-13 20:14  2026-08-13 20:14  yes
      403       2,445       0  2026-08-17 11:09  2026-08-17 11:09  yes
      568       8,792       0  2026-08-28 20:09  2026-08-28 20:09  NO
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung      @448 cores      @830 cores   binding
      ...
      100           7.1 d           4.6 d   critical_chain
      189          12.1 d           6.5 d   throughput
      279          17.2 d           9.3 d   throughput
      340          20.6 d          11.1 d   throughput
      403          24.2 d          13.0 d   throughput
      568          33.5 d          18.1 d   throughput
