...
**Auto-generated 2026-08-05 10:55 UTC -- T+181h46m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+181h46m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 10:55 UTC | elapsed 7.57 d | 21.5 d to the Aug-27 stop
test tier: 14,891 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     159 records     159.0 rec/h
    last  3 h     575 records     191.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         180      39  GATED             GATED             barrier
      100       2,980      39  GATED             GATED             barrier>=30
      189       6,842      77  GATED             GATED             barrier>=30
      279      10,987     159  GATED             GATED             barrier>=30
      340      14,037     159  GATED             GATED             barrier>=30
      403      17,187     159  GATED             GATED             barrier>=30
      568      25,437     159  GATED             GATED             barrier>=30
