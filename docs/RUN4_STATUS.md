...
**Auto-generated 2026-08-05 13:22 UTC -- T+184h13m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+184h13m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 2.5 h ago; none live, newest failure 17 min ago** |
...
| | |
|---|---|
| cluster jobs | **964** (188 running, 776 queued) |
...
```
generated 2026-08-05 13:22 UTC | elapsed 7.68 d | 21.4 d to the Aug-27 stop
test tier: 15,107 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      57 records      57.0 rec/h
    last  3 h     296 records      98.7 rec/h
    last 12 h    1582 records     131.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,821      57  GATED             GATED             barrier>=30
      403      16,971      57  GATED             GATED             barrier>=30
      568      25,221      57  GATED             GATED             barrier>=30
