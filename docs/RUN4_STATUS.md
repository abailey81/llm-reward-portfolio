...
**Auto-generated 2026-08-05 15:08 UTC -- T+185h59m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+185h59m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 4.3 h ago; none live, newest failure 2.1 h ago** |
...
| | |
|---|---|
| cluster jobs | **924** (190 running, 734 queued) |
...
```
generated 2026-08-05 15:09 UTC | elapsed 7.75 d | 21.4 d to the Aug-27 stop
test tier: 15,483 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     246 records     246.0 rec/h
    last  3 h     441 records     147.0 rec/h
    last 12 h    1886 records     157.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,636      55  GATED             GATED             barrier>=30
      403      16,595     246  GATED             GATED             barrier>=30
      568      24,845     246  GATED             GATED             barrier>=30
