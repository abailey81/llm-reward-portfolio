...
**Auto-generated 2026-08-05 02:47 UTC -- T+173h38m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+173h38m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 4.3 h ago; none live, newest failure 31 min ago** |
...
| | |
|---|---|
| cluster jobs | **991** (184 running, 807 queued) |
| **cores computing** | **1472** |
...
```
generated 2026-08-05 02:47 UTC | elapsed 7.24 d | 21.9 d to the Aug-27 stop
test tier: 13,596 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      31 records      31.0 rec/h
    last  3 h     267 records      89.0 rec/h
    last 12 h    1989 records     165.8 rec/h
    last 24 h    4144 records     172.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (166 rec/h); latest excludes cells already within
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,324       5  GATED             GATED             barrier>=30
      189       7,774       5  GATED             GATED             barrier>=30
      279      12,274       5  GATED             GATED             barrier>=30
      340      15,324       5  GATED             GATED             barrier>=30
      403      18,474       5  GATED             GATED             barrier>=30
      568      26,732      31  GATED             GATED             barrier>=30
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung     @1472 cores      @830 cores   binding
