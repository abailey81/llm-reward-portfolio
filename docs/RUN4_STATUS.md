...
**Auto-generated 2026-08-06 04:20 UTC -- T+199h12m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+199h12m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **959** (67 running, 892 queued) |
| **cores computing** | **536** |
...
```
generated 2026-08-06 04:21 UTC | elapsed 8.30 d | 20.8 d to the Aug-27 stop
test tier: 17,106 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      27 records      27.0 rec/h
    last  3 h      98 records      32.7 rec/h
    last 12 h    1450 records     120.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,597      27  GATED             GATED             barrier>=30
      189       6,161      27  GATED             GATED             barrier>=30
      279      10,209      27  GATED             GATED             barrier>=30
      340      12,954      27  GATED             GATED             barrier>=30
      403      15,789      27  GATED             GATED             barrier>=30
      568      23,222      27  GATED             GATED             barrier>=30
