...
```
generated 2026-08-06 11:59 UTC | elapsed 8.62 d | 20.5 d to the Aug-27 stop
test tier: 17,606 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 59.9 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h     719 records      59.9 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,709      28  GATED             GATED             barrier>=30
      340      12,454      28  GATED             GATED             barrier>=30
      403      15,289      28  GATED             GATED             barrier>=30
      568      22,722      28  GATED             GATED             barrier>=30
