...
| transport health | **timeouts 6h=156; worst streak 11/240 (4.6% to fatal), pull on core, 1.6 h ago; none live, newest failure 1.5 h ago** |
...
```
generated 2026-08-06 18:30 UTC | elapsed 8.89 d | 20.2 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,689      43  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,524      43  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,957      43  GATED             GATED             no-records:test/distributional,test/scalar>=30
