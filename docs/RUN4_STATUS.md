...
**Auto-generated 2026-08-01 12:09 UTC -- T+87h00m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+87h00m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **2360** |
| LLM calls / spend | 2848 / **$44.2942** |
...
| | |
|---|---|
| cluster jobs | **121** (116 running, 4 queued) |
| **cores computing** | **928** |
...
```
2026-08-01T12:05:35Z  RED  records=2357 (+0)  spend=$44.2823  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0  sci=OK  r115=17B  sweep=23.3s  auto-cycle
2026-08-01T12:06:29Z  RED  records=2358 (+1)  spend=$44.2867  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=17B  sweep=17.3s  auto-cycle
2026-08-01T12:07:16Z  RED  records=2359 (+1)  spend=$44.2941  guards=2  arms_full=10/10  budget=2  stalest=1.5m  drift=0  sci=OK  r115=17B  sweep=16.9s  auto-cycle
2026-08-01T12:08:03Z  RED  records=2360 (+1)  spend=$44.2941  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=17B  sweep=17.3s  auto-cycle
2026-08-01T12:08:51Z  RED  records=2360 (+0)  spend=$44.2941  guards=2  arms_full=10/10  budget=2  stalest=1.6m  drift=0+1dirty  sci=OK  r115=17B  sweep=16.8s  auto-cycle
2026-08-01T12:09:38Z  RED  records=2360 (+0)  spend=$44.2941  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0+1dirty  sci=OK  r115=17B  sweep=16.8s  auto-cycle
```
...
```
  anthropic   spent $ 35.9845  + still to author $  1.2532  = $ 37.2377   credited $ 28.1500   margin $  -9.0877 (-32%)  over the credit ESTIMATE (owner-watched)
