...
**Auto-generated 2026-08-05 06:18 UTC -- T+177h09m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+177h09m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 76 min ago; none live, newest failure 76 min ago** |
...
```
generated 2026-08-05 06:19 UTC | elapsed 7.38 d | 21.7 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     330 records     110.0 rec/h
    last 12 h    1652 records     137.7 rec/h
    last 24 h    4013 records     167.2 rec/h
    12 h rate is 37% from ONE line (test_leg_qwen3_5_9b); 10 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 46% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,238      25  GATED             GATED             barrier>=30
      189       7,446     267  GATED             GATED             barrier>=30
      279      11,946     267  GATED             GATED             barrier>=30
      340      14,996     267  GATED             GATED             barrier>=30
      403      18,146     267  GATED             GATED             barrier>=30
      568      26,396     267  GATED             GATED             barrier>=30
