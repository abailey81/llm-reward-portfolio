...
**Auto-generated 2026-08-11 17:42 UTC -- T+332h33m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+332h33m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **520** |
| **cores doing RUNG-RAISING work** | **4.8%** -- 24 of 504 cores (9 min old) |
...
```
generated 2026-08-11 17:43 UTC | elapsed 13.86 d | 15.3 d to the Aug-27 stop
test tier: 29,693 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    2760 records     115.0 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,906     100  GATED             GATED             barrier>=279
      403       4,111     100  GATED             GATED             barrier>=279
      568      10,635     100  GATED             GATED             barrier>=279
