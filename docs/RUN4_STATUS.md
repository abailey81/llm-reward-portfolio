...
**Auto-generated 2026-08-05 20:05 UTC -- T+190h56m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+190h56m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 62 min ago; none live, newest failure 62 min ago** |
...
```
generated 2026-08-05 20:06 UTC | elapsed 7.96 d | 21.2 d to the Aug-27 stop
test tier: 16,245 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      82 records      82.0 rec/h
    last  3 h     434 records     144.7 rec/h
    last 12 h    1882 records     156.8 rec/h
    last 24 h    3610 records     150.4 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      24,083      82  GATED             GATED             barrier>=30
