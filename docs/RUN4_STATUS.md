...
**Auto-generated 2026-08-03 09:56 UTC -- T+132h47m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+132h47m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **823** (202 running, 621 queued) |
...
```
 rung             @1616 cores              @830 cores   binding
  ...
  340            5.7 d  08-03           11.1 d  08-09   throughput
  403            6.7 d  08-04           13.0 d  08-10   throughput
  568            9.3 d  08-07           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 1955 |
| scalar | g5 of 5 | 1374 |
| placebo | g5 of 5 | 1484 |
| scalar_cvar5 | g5 of 5 | 1462 |
| placebo_shuffled | g5 of 5 | 1475 |
...
```
2026-08-03T09:44:02Z  RED  records=8055 (+4)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=21B  sweep=71.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T09:45:43Z  RED  records=8074 (+19)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=21B  sweep=84.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T09:47:38Z  RED  records=8080 (+6)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=21B  sweep=73.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T09:49:22Z  RED  records=8092 (+12)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=1.3m  drift=0  sci=OK  r115=21B  cores=1704  sweep=157.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T09:52:30Z  RED  records=8127 (+35)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.1m  drift=0  sci=OK  r115=21B  sweep=135.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T09:55:15Z  RED  records=8141 (+14)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=21B  sweep=72.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
