...
**Auto-generated 2026-08-11 20:14 UTC -- T+335h05m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+335h05m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **430** = 58 running + **44 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **464** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (42 min old) |
...
```
generated 2026-08-11 20:15 UTC | elapsed 13.96 d | 15.2 d to the Aug-27 stop
test tier: 29,891 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,708      94  GATED             GATED             barrier>=279
      403       3,913      94  GATED             GATED             barrier>=279
      568      10,437      94  GATED             GATED             barrier>=279
