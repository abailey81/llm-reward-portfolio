...
```
generated 2026-08-06 12:07 UTC | elapsed 8.62 d | 20.5 d to the Aug-27 stop
test tier: 17,611 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,704      22  GATED             GATED             barrier>=30
      340      12,449      22  GATED             GATED             barrier>=30
      403      15,284      22  GATED             GATED             barrier>=30
      568      22,717      22  GATED             GATED             barrier>=30
