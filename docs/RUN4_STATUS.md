...
**Auto-generated 2026-08-06 10:16 UTC -- T+205h07m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+205h07m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **909** (114 running, 795 queued) |
| **cores computing** | **912** |
| **cores doing RUNG-RAISING work** | **20.3%** -- 184 of 904 cores (22 min old) |
...
```
generated 2026-08-06 10:17 UTC | elapsed 8.55 d | 20.6 d to the Aug-27 stop
test tier: 17,531 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    12 h rate is 76% from ONE line (test_leg_kimi_k3); 4 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,736      92  GATED             GATED             barrier>=30
      279       9,784      92  GATED             GATED             barrier>=30
      340      12,529      92  GATED             GATED             barrier>=30
      403      15,364      92  GATED             GATED             barrier>=30
      568      22,797      92  GATED             GATED             barrier>=30
