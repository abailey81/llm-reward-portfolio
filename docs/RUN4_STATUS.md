...
**Auto-generated 2026-08-03 03:07 UTC -- T+125h58m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+125h58m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **978** (290 running, 688 queued) |
...
| scalar_cvar5 | g5 of 5 | 1166 |
| placebo_shuffled | g5 of 5 | 1167 |
...
```
2026-08-03T02:56:00Z  RED  records=6641 (+3)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=26.5m  drift=0  sci=OK  r115=21B  sweep=55.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
