...
**Auto-generated 2026-08-05 01:21 UTC -- T+172h12m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+172h12m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 2.9 h ago; none live, newest failure 1.7 h ago** |
...
```
generated 2026-08-05 01:21 UTC | elapsed 7.18 d | 21.9 d to the Aug-27 stop
test tier: 13,523 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     116 records     116.0 rec/h
    last  3 h     466 records     155.3 rec/h
    last 12 h    2193 records     182.8 rec/h
    last 24 h    4253 records     177.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      26,805     116  GATED             GATED             barrier>=30
