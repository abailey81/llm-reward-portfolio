...
**Auto-generated 2026-08-05 07:28 UTC -- T+178h19m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+178h19m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 12 min ago; none live, newest failure 12 min ago** |
...
| | |
|---|---|
| cluster jobs | **924** (201 running, 723 queued) |
...
```
generated 2026-08-05 07:29 UTC | elapsed 7.43 d | 21.7 d to the Aug-27 stop
test tier: 14,192 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     230 records     230.0 rec/h
    last  3 h     587 records     195.7 rec/h
    last 12 h    1680 records     140.0 rec/h
    last 24 h    4076 records     169.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,236       2  GATED             GATED             barrier>=30
      189       7,241     175  GATED             GATED             barrier>=30
      279      11,686     230  GATED             GATED             barrier>=30
      340      14,736     230  GATED             GATED             barrier>=30
      403      17,886     230  GATED             GATED             barrier>=30
      568      26,136     230  GATED             GATED             barrier>=30
