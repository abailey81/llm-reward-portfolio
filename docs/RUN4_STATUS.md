...
```
generated 2026-08-06 12:44 UTC | elapsed 8.65 d | 20.5 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,690      25  GATED             GATED             barrier>=30
      340      12,435      25  GATED             GATED             barrier>=30
      403      15,270      25  GATED             GATED             barrier>=30
      568      22,703      25  GATED             GATED             barrier>=30
