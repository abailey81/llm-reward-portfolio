...
**Auto-generated 2026-08-05 05:30 UTC -- T+176h21m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+176h21m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 28 min ago; none live, newest failure 28 min ago** |
...
| | |
|---|---|
| cluster jobs | **982** (204 running, 778 queued) |
...
```
generated 2026-08-05 05:30 UTC | elapsed 7.35 d | 21.8 d to the Aug-27 stop
test tier: 13,705 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     100 records     100.0 rec/h
    last  3 h     113 records      37.7 rec/h
    last 12 h    1649 records     137.4 rec/h
    last 24 h    3893 records     162.2 rec/h
    12 h rate is 37% from ONE line (test_leg_qwen3_5_9b); 10 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 59% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,241      82  GATED             GATED             barrier>=30
      189       7,673     100  GATED             GATED             barrier>=30
      279      12,173     100  GATED             GATED             barrier>=30
      340      15,223     100  GATED             GATED             barrier>=30
      403      18,373     100  GATED             GATED             barrier>=30
      568      26,623     100  GATED             GATED             barrier>=30
