...
**Auto-generated 2026-08-12 04:03 UTC -- T+342h54m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+342h54m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **486** = 112 running + **46 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **896** |
| **cores doing RUNG-RAISING work** | **76.4%** -- 672 of 880 cores (30 min old) |
...
```
generated 2026-08-12 04:03 UTC | elapsed 14.29 d | 14.8 d to the Aug-27 stop
test tier: 30,294 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 64.4 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h     773 records      64.4 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,357      16  GATED             GATED             barrier>=279
      403       3,562      16  GATED             GATED             barrier>=279
      568      10,034      59  GATED             GATED             barrier>=279
