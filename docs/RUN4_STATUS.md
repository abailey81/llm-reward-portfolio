...
**Auto-generated 2026-08-04 18:29 UTC -- T+165h20m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+165h20m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 21/240 (8.8% to fatal), pull on core, 6.0 h ago; none live, newest failure 2.7 h ago** |
...
```
generated 2026-08-04 18:29 UTC | elapsed 6.89 d | 22.2 d to the Aug-27 stop
test tier: 12,312 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     262 records     262.0 rec/h
    last  3 h     582 records     194.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (197 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,886      18  GATED             GATED             barrier>=30
      189       8,336      18  GATED             GATED             barrier>=30
      279      12,836      18  GATED             GATED             barrier>=30
      340      15,886      18  GATED             GATED             barrier>=30
      403      19,036      18  GATED             GATED             barrier>=30
      568      28,016     262  GATED             GATED             barrier>=30
    ...
    !! 92% of the rung-568 backlog (25,646 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
...
```
2026-08-04T18:02:30Z  OK  records=13760 (+13)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.9m  drift=0  sci=OK  r115=22B  sweep=189.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
