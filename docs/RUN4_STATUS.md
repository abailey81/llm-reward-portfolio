...
**Auto-generated 2026-08-05 07:13 UTC -- T+178h04m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+178h04m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **928** (195 running, 733 queued) |
...
```
generated 2026-08-05 07:14 UTC | elapsed 7.42 d | 21.7 d to the Aug-27 stop
test tier: 14,131 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     208 records     208.0 rec/h
    last  3 h     527 records     175.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       7,253     202  GATED             GATED             barrier>=30
      279      11,747     208  GATED             GATED             barrier>=30
      340      14,797     208  GATED             GATED             barrier>=30
      403      17,947     208  GATED             GATED             barrier>=30
      568      26,197     208  GATED             GATED             barrier>=30
