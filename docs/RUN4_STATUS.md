...
**Auto-generated 2026-08-06 00:52 UTC -- T+195h43m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h43m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.8 h ago; none live, newest failure 48 min ago** |
...
| | |
|---|---|
| cluster jobs | **974** (68 running, 906 queued) |
| **cores computing** | **544** |
...
```
generated 2026-08-06 00:53 UTC | elapsed 8.16 d | 21.0 d to the Aug-27 stop
test tier: 16,994 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     128 records     128.0 rec/h
    last  3 h     532 records     177.3 rec/h
    last 12 h    1919 records     159.9 rec/h
    last 24 h    3528 records     147.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,709     106  GATED             GATED             barrier>=30
      189       6,273     126  GATED             GATED             barrier>=30
      279      10,321     128  GATED             GATED             barrier>=30
      340      13,066     128  GATED             GATED             barrier>=30
      403      15,901     128  GATED             GATED             barrier>=30
      568      23,334     128  GATED             GATED             barrier>=30
...
```
2026-08-06T00:32:34Z  OK  records=18523 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=28.3s  auto-cycle
