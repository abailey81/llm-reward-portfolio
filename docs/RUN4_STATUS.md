...
**Auto-generated 2026-08-06 12:48 UTC -- T+207h39m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+207h39m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=21; worst streak 2/240 (0.8% to fatal), ops on kimi-k3, 8 min ago; LIVE, still failing** |
...
```
generated 2026-08-06 12:49 UTC | elapsed 8.65 d | 20.5 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,688      25  GATED             GATED             barrier>=30
      340      12,433      25  GATED             GATED             barrier>=30
      403      15,268      25  GATED             GATED             barrier>=30
      568      22,701      25  GATED             GATED             barrier>=30
