...
**Auto-generated 2026-08-02 09:52 UTC -- T+108h43m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+108h43m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **384** (211 running, 173 queued) |
...
```
 rung             @1688 cores              @830 cores   binding
  ...
  340            5.5 d  08-03           11.1 d  08-09   throughput
  403            6.4 d  08-04           13.0 d  08-10   throughput
  568            8.9 d  08-06           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 972 |
| scalar | g5 of 5 | 377 |
| placebo | g5 of 5 | 618 |
| scalar_cvar5 | g5 of 5 | 577 |
| placebo_shuffled | g5 of 5 | 548 |
...
```
2026-08-02T09:47:19Z  RED  records=3475 (+3)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=21B  sweep=42.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T09:48:32Z  RED  records=3475 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0+1dirty  sci=OK  r115=21B  sweep=29.2s  auto-cycle
2026-08-02T09:49:31Z  RED  records=3476 (+1)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0+2dirty  sci=OK  r115=21B  sweep=22.6s  auto-cycle
2026-08-02T09:50:24Z  RED  records=3477 (+1)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=3.4m  drift=0+4dirty  sci=OK  r115=21B  sweep=21.9s  auto-cycle
2026-08-02T09:51:16Z  RED  records=3477 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=4.3m  drift=0+4dirty  sci=OK  r115=21B  sweep=24.3s  auto-cycle
2026-08-02T09:52:11Z  RED  records=3477 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=4.4m  drift=0+4dirty  sci=OK  r115=21B  sweep=24.4s  auto-cycle
```
