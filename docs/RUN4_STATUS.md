...
**Auto-generated 2026-08-06 01:20 UTC -- T+196h11m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+196h11m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 76 min ago; none live, newest failure 76 min ago** |
...
```
generated 2026-08-06 01:21 UTC | elapsed 8.18 d | 20.9 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,695      39  GATED             GATED             barrier>=30
      189       6,259      45  GATED             GATED             barrier>=30
      279      10,307      46  GATED             GATED             barrier>=30
      340      13,052      46  GATED             GATED             barrier>=30
      403      15,887      46  GATED             GATED             barrier>=30
      568      23,320      46  GATED             GATED             barrier>=30
