...
| **cores computing** | **888** |
| **cores doing RUNG-RAISING work** | **20.3%** -- 184 of 904 cores (4 min old) |
...
```
generated 2026-08-06 09:59 UTC | elapsed 8.54 d | 20.6 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,743     125  GATED             GATED             barrier>=30
      279       9,791     125  GATED             GATED             barrier>=30
      340      12,536     125  GATED             GATED             barrier>=30
      403      15,371     125  GATED             GATED             barrier>=30
      568      22,804     125  GATED             GATED             barrier>=30
