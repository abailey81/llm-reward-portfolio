...
**Auto-generated 2026-08-06 09:40 UTC -- T+204h31m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+204h31m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 09:40 UTC | elapsed 8.52 d | 20.6 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,756     128  GATED             GATED             barrier>=30
      279       9,804     128  GATED             GATED             barrier>=30
      340      12,549     128  GATED             GATED             barrier>=30
      403      15,384     128  GATED             GATED             barrier>=30
      568      22,817     128  GATED             GATED             barrier>=30
