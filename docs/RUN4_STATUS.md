...
**Auto-generated 2026-08-05 03:47 UTC -- T+174h38m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+174h38m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 5.3 h ago; none live, newest failure 1.5 h ago** |
...
```
generated 2026-08-05 03:47 UTC | elapsed 7.28 d | 21.8 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     149 records      49.7 rec/h
    last 12 h    1826 records     152.2 rec/h
    last 24 h    4004 records     166.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (152 rec/h); latest excludes cells already within
