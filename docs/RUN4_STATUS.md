...
**Auto-generated 2026-08-05 02:32 UTC -- T+173h23m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+173h23m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 4.0 h ago; none live, newest failure 16 min ago** |
...
```
generated 2026-08-05 02:33 UTC | elapsed 7.23 d | 21.9 d to the Aug-27 stop
test tier: 13,592 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      50 records      50.0 rec/h
    last  3 h     299 records      99.7 rec/h
    last 12 h    2039 records     169.9 rec/h
    last 24 h    4179 records     174.1 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (170 rec/h); latest excludes cells already within
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,324      10  GATED             GATED             barrier>=30
      189       7,774      10  GATED             GATED             barrier>=30
      279      12,274      10  GATED             GATED             barrier>=30
      340      15,324      10  GATED             GATED             barrier>=30
      403      18,474      10  GATED             GATED             barrier>=30
      568      26,736      50  GATED             GATED             barrier>=30
