...
**Auto-generated 2026-08-05 02:18 UTC -- T+173h09m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+173h09m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 02:19 UTC | elapsed 7.22 d | 21.9 d to the Aug-27 stop
test tier: 13,590 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      69 records      69.0 rec/h
    last  3 h     335 records     111.7 rec/h
    last 12 h    2092 records     174.3 rec/h
    last 24 h    4208 records     175.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      26,738      69  GATED             GATED             barrier>=30
