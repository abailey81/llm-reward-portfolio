...
**Auto-generated 2026-08-06 02:18 UTC -- T+197h09m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+197h09m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 2.2 h ago; none live, newest failure 2.2 h ago** |
...
| | |
|---|---|
| cluster jobs | **965** (67 running, 898 queued) |
| **cores computing** | **536** |
...
```
generated 2026-08-06 02:18 UTC | elapsed 8.22 d | 20.9 d to the Aug-27 stop
test tier: 17,064 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,639      57  GATED             GATED             barrier>=30
      189       6,203      57  GATED             GATED             barrier>=30
      279      10,251      57  GATED             GATED             barrier>=30
      340      12,996      57  GATED             GATED             barrier>=30
      403      15,831      57  GATED             GATED             barrier>=30
      568      23,264      57  GATED             GATED             barrier>=30
