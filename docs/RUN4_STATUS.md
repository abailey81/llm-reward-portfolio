...
```
generated 2026-08-06 07:31 UTC | elapsed 8.43 d | 20.7 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    3154 records     131.4 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,908       9  GATED             GATED             barrier>=30
      279       9,956       9  GATED             GATED             barrier>=30
      340      12,701       9  GATED             GATED             barrier>=30
      403      15,536       9  GATED             GATED             barrier>=30
      568      22,969       9  GATED             GATED             barrier>=30
