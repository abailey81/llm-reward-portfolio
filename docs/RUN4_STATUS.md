...
**Auto-generated 2026-08-04 23:52 UTC -- T+170h43m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+170h43m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 83 min ago; none live, newest failure 16 min ago** |
...
| | |
|---|---|
| cluster jobs | **975** (170 running, 803 queued) |
...
```
generated 2026-08-04 23:53 UTC | elapsed 7.11 d | 22.0 d to the Aug-27 stop
test tier: 13,340 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     184 records     184.0 rec/h
    last  3 h     485 records     161.7 rec/h
    last 12 h    2254 records     187.8 rec/h
    last 24 h    4241 records     176.7 rec/h
    12 h rate is 58% from ONE line (test_leg_sonnet_5); 10 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 59% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_sonnet_5, test_leg_gpt_5_6_luna) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      26,988     184  GATED             GATED             barrier>=30
