...
```
generated 2026-08-06 18:45 UTC | elapsed 8.90 d | 20.2 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,683      29  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,518      29  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,951      29  GATED             GATED             no-records:test/distributional,test/scalar>=30
