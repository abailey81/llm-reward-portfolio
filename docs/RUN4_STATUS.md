...
**Auto-generated 2026-08-06 17:25 UTC -- T+212h16m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+212h16m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=156; worst streak 11/240 (4.6% to fatal), pull on core, 29 min ago; none live, newest failure 27 min ago** |
...
| | |
|---|---|
| cluster jobs | **849** (63 running, 786 queued) |
| **cores computing** | **504** |
| **cores doing RUNG-RAISING work** | **27.7%** -- 144 of 520 cores (4 min old) |
...
```
2026-08-06T17:05:03Z  RED  records=19824 (+85)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  cores=488  sweep=664.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T17:10:04Z  RED  records=19824 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  sweep=270.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T17:11:07Z  OK  records=19830 (+6)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.4m  drift=0  sci=OK  r115=22B  sweep=33.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T17:23:19Z  OK  records=19858 (+28)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.9m  drift=0  sci=OK  r115=22B  sweep=701.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T17:24:17Z  OK  records=19858 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=28.6s  auto-cycle
2026-08-06T17:25:27Z  OK  records=19859 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  cores=504  sweep=39.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
