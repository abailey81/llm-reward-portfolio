...
**Auto-generated 2026-08-05 07:58 UTC -- T+178h49m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+178h49m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **906** (205 running, 701 queued) |
...
```
generated 2026-08-05 07:58 UTC | elapsed 7.45 d | 21.7 d to the Aug-27 stop
test tier: 14,327 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     242 records     242.0 rec/h
    last  3 h     704 records     234.7 rec/h
    last 12 h    1712 records     142.7 rec/h
    last 24 h    4108 records     171.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,219      17  GATED             GATED             barrier>=30
      189       7,224      69  GATED             GATED             barrier>=30
      279      11,551     242  GATED             GATED             barrier>=30
      340      14,601     242  GATED             GATED             barrier>=30
      403      17,751     242  GATED             GATED             barrier>=30
      568      26,001     242  GATED             GATED             barrier>=30
...
2026-08-05T07:59:43Z  OK  records=15861 (+21)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.7m  drift=0  sci=OK  r115=22B  sweep=386.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
