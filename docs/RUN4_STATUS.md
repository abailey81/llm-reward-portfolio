...
**Auto-generated 2026-08-01 20:33 UTC -- T+95h24m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+95h24m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **91** (85 running, 6 queued) |
| **cores computing** | **680** |
...
```
 rung              @680 cores              @830 cores   binding
  ...
  100            4.7 d  08-02            4.6 d  08-02   critical_chain
  189            8.0 d  08-05            6.5 d  08-04   throughput
  279           11.3 d  08-09            9.3 d  08-07   throughput
  340           13.6 d  08-11           11.1 d  08-09   throughput
  403           15.9 d  08-13           13.0 d  08-10   throughput
  568           22.1 d  08-19           18.1 d  08-15   throughput
```
...
```
2026-08-01T20:29:09Z  RED  records=2743 (+1)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=1.7m  drift=0  sci=OK  r115=19B  sweep=17.5s  auto-cycle
2026-08-01T20:29:56Z  RED  records=2743 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=19B  sweep=16.8s  auto-cycle
2026-08-01T20:30:43Z  RED  records=2743 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=19B  cores=688  sweep=19.5s  auto-cycle
2026-08-01T20:31:33Z  RED  records=2745 (+2)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=19B  sweep=17.4s  auto-cycle
2026-08-01T20:32:21Z  RED  records=2746 (+1)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=3.3m  drift=0  sci=OK  r115=19B  sweep=18.0s  auto-cycle
2026-08-01T20:33:09Z  RED  records=2748 (+2)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=4.1m  drift=0  sci=OK  r115=19B  sweep=23.6s  auto-cycle
```
