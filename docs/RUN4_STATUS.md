...
**Auto-generated 2026-08-03 01:04 UTC -- T+123h55m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+123h55m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **662** (277 running, 385 queued) |
| **cores computing** | **2216** |

Per-rung ETAs from the registered model at the cores we actually hold:

```
 rung             @2216 cores              @830 cores   binding
  ...
  403            4.9 d  08-02           13.0 d  08-10   throughput
  568            6.8 d  08-04           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 1540 |
| scalar | g5 of 5 | 947 |
| placebo | g5 of 5 | 1149 |
| scalar_cvar5 | g5 of 5 | 1111 |
| placebo_shuffled | g5 of 5 | 1092 |
...
```
2026-08-03T00:55:36Z  RED  records=6210 (+8)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=21B  cores=2152  sweep=93.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T00:57:39Z  RED  records=6216 (+6)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=21B  sweep=92.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T00:59:42Z  RED  records=6221 (+5)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=3.2m  drift=0  sci=OK  r115=21B  sweep=52.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T01:01:05Z  RED  records=6225 (+4)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=21B  sweep=47.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T01:02:22Z  RED  records=6231 (+6)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=4.3m  drift=0  sci=OK  r115=21B  sweep=66.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T01:03:59Z  RED  records=6237 (+6)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=21B  sweep=58.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
