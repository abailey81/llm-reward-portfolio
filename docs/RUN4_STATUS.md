...
**Auto-generated 2026-08-06 09:20 UTC -- T+204h11m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+204h11m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **960** |
| **cores doing RUNG-RAISING work** | **20.7%** -- 200 of 968 cores (1 min old) |
...
test tier: 17,452 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,815      86  GATED             GATED             barrier>=30
      279       9,863      86  GATED             GATED             barrier>=30
      340      12,608      86  GATED             GATED             barrier>=30
      403      15,443      86  GATED             GATED             barrier>=30
      568      22,876      86  GATED             GATED             barrier>=30
