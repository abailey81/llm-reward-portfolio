...
**Auto-generated 2026-08-04 18:50 UTC -- T+165h41m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+165h41m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **169** (167 running, 0 queued) |
...
```
generated 2026-08-04 18:51 UTC | elapsed 6.90 d | 22.2 d to the Aug-27 stop
test tier: 12,369 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     187 records     187.0 rec/h
    last  3 h     577 records     192.3 rec/h
    last 12 h    2387 records     198.9 rec/h
    last 24 h    4265 records     177.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,865      39  GATED             GATED             barrier>=30
      189       8,315      39  GATED             GATED             barrier>=30
      279      12,815      39  GATED             GATED             barrier>=30
      340      15,865      39  GATED             GATED             barrier>=30
      403      19,015      39  GATED             GATED             barrier>=30
      568      27,959     187  GATED             GATED             barrier>=30
