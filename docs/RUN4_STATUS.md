...
**Auto-generated 2026-08-11 21:11 UTC -- T+336h02m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+336h02m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **552** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (98 min old **STALE**) |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,648      67  GATED             GATED             barrier>=279
      403       3,853      67  GATED             GATED             barrier>=279
      568      10,377      67  GATED             GATED             barrier>=279
