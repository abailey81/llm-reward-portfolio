...
**Auto-generated 2026-08-05 16:37 UTC -- T+187h28m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+187h28m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 5.8 h ago; none live, newest failure 3.5 h ago** |
...
| | |
|---|---|
| cluster jobs | **893** (171 running, 722 queued) |
...
```
generated 2026-08-05 16:37 UTC | elapsed 7.81 d | 21.3 d to the Aug-27 stop
test tier: 15,710 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      403      16,471      52  GATED             GATED             barrier>=30
      568      24,618     155  GATED             GATED             barrier>=30
