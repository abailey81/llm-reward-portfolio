...
**Auto-generated 2026-08-12 01:50 UTC -- T+340h41m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+340h41m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **504** = 95 running + **81 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
```
generated 2026-08-12 01:51 UTC | elapsed 14.20 d | 14.9 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,452      53  GATED             GATED             barrier>=279
      403       3,657      53  GATED             GATED             barrier>=279
      568      10,181      53  GATED             GATED             barrier>=279
