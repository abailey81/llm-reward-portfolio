...
**Auto-generated 2026-08-05 15:44 UTC -- T+186h35m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+186h35m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 4.9 h ago; none live, newest failure 2.7 h ago** |
...
```
generated 2026-08-05 15:45 UTC | elapsed 7.78 d | 21.3 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      403      16,513     188  GATED             GATED             barrier>=30
      568      24,763     188  GATED             GATED             barrier>=30
