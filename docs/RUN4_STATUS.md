...
**Auto-generated 2026-08-03 03:58 UTC -- T+126h49m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+126h49m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **989** (291 running, 698 queued) |
| **cores computing** | **2328** |

Per-rung ETAs from the registered model at the cores we actually hold:

```
 rung             @2328 cores              @830 cores   binding
  ...
  568            6.4 d  08-04           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 1694 |
| scalar | g5 of 5 | 1104 |
| placebo | g5 of 5 | 1228 |
| scalar_cvar5 | g5 of 5 | 1204 |
| placebo_shuffled | g5 of 5 | 1217 |
...
```
2026-08-03T03:47:38Z  RED  records=6817 (+11)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=21B  sweep=109.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T03:49:57Z  RED  records=6824 (+7)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=21B  sweep=91.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T03:51:59Z  RED  records=6831 (+7)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=21B  sweep=85.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T03:53:55Z  RED  records=6834 (+3)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=21B  sweep=54.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T03:55:20Z  RED  records=6838 (+4)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=21B  sweep=55.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T03:56:46Z  RED  records=6843 (+5)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=21B  sweep=58.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
