...
**Auto-generated 2026-08-06 06:12 UTC -- T+201h03m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+201h03m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **939** (78 running, 861 queued) |
| **cores computing** | **624** |
...
```
generated 2026-08-06 06:13 UTC | elapsed 8.38 d | 20.7 d to the Aug-27 stop
test tier: 17,307 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     144 records     144.0 rec/h
    last  3 h     228 records      76.0 rec/h
    last 12 h    1262 records     105.2 rec/h
    last 24 h    3386 records     141.1 rec/h
    12 h rate is 42% from ONE line (test_leg_kimi_k3); 4 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 30% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_haiku_4_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,960     144  GATED             GATED             barrier>=30
      279      10,008     144  GATED             GATED             barrier>=30
      340      12,753     144  GATED             GATED             barrier>=30
      403      15,588     144  GATED             GATED             barrier>=30
      568      23,021     144  GATED             GATED             barrier>=30
