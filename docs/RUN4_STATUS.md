...
**Auto-generated 2026-08-03 09:55 UTC -- T+132h46m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+132h46m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **826** (205 running, 621 queued) |
...
```
 rung             @1640 cores              @830 cores   binding
  ...
  279            4.7 d  08-02            9.3 d  08-07   throughput
  340            5.6 d  08-03           11.1 d  08-09   throughput
  403            6.6 d  08-04           13.0 d  08-10   throughput
  568            9.1 d  08-07           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 1953 |
| scalar | g5 of 5 | 1372 |
| placebo | g5 of 5 | 1484 |
| scalar_cvar5 | g5 of 5 | 1461 |
| placebo_shuffled | g5 of 5 | 1472 |
...
```
2026-08-03T09:41:15Z  RED  records=8051 (+11)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.0m  drift=0  sci=OK  r115=21B  sweep=136.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
