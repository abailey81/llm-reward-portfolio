...
| | |
|---|---|
| cluster jobs | **930** (124 running, 806 queued) |
| **cores computing** | **992** |
| **cores doing RUNG-RAISING work** | **20.2%** -- 200 of 992 cores (2 min old) |
...
```
generated 2026-08-06 08:24 UTC | elapsed 8.47 d | 20.6 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    2910 records     121.2 rec/h   usable
