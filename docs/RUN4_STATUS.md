...
**Auto-generated 2026-08-12 05:08 UTC -- T+343h59m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+343h59m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 0/240 (0.0% to fatal), - on -, age UNKNOWN; none live, newest failure 11.5 h ago** |
...
| | |
|---|---|
| cluster jobs | **482** = 120 running + **34 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **960** |
| **cores doing RUNG-RAISING work** | **76.4%** -- 672 of 880 cores (95 min old **STALE**) |
...
```
generated 2026-08-12 05:09 UTC | elapsed 14.33 d | 14.8 d to the Aug-27 stop
test tier: 30,367 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 60.6 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h     727 records      60.6 rec/h   usable
    last 24 h    2273 records      94.7 rec/h   usable
    12 h rate is 32% from ONE line (test); 5 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279          70       2  2026-08-12 06:18  2026-08-12 06:18  yes
      340       1,355       2  2026-08-13 03:31  2026-08-13 03:31  yes
      403       3,560       2  2026-08-14 15:54  2026-08-14 15:54  yes
      568       9,961      71  2026-08-19 01:34  2026-08-19 01:34  yes
    GATED = the relevant rate is zero, so no throughput number can date that row -- it is
    waiting on a stage barrier (C1 chain / C3 gate), not on cores.
    !! 14% of the rung-568 backlog (1,387 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.

REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung      @960 cores      @830 cores   binding
       30           4.6 d           4.6 d   critical_chain
      100           4.6 d           4.6 d   critical_chain
      189           5.6 d           6.5 d   throughput
      279           8.0 d           9.3 d   throughput
      340           9.6 d          11.1 d   throughput
      403          11.3 d          13.0 d   throughput
      568          15.6 d          18.1 d   throughput
...
|---|---|---|---|---|
| nemotron_3_super | **264** | 266 | 5 |  |
| test | **306** | 307 | 9 |  |
| glm_5_2 | **307** | 309 | 5 |  |
| deepseek_v4_pro | **312** | 314 | 5 |  |
| kimi_k3 | **471** | 474 | 5 |  |
| qwen3_6_27b | **528** | 542 | 5 |  |
...
```
2026-08-12T04:47:12Z  OK  records=31874 (+3)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.5m  drift=0  sci=OK  r115=22B  cores=944  sweep=61.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T04:48:38Z  OK  records=31881 (+7)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.0m  drift=0  sci=OK  r115=22B  sweep=55.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T04:50:01Z  OK  records=31882 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.2m  drift=0  sci=OK  r115=22B  sweep=52.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T04:51:26Z  OK  records=31885 (+3)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  sweep=55.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T04:52:52Z  OK  records=31890 (+5)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  sweep=55.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T05:07:42Z  OK  records=31908 (+18)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.3m  drift=0  sci=OK  r115=22B  cores=960  sweep=860.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
