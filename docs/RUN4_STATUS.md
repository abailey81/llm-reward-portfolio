...
**Auto-generated 2026-08-06 04:34 UTC -- T+199h25m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+199h25m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
test tier: 17,114 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      35 records      35.0 rec/h
    last  3 h      99 records      33.0 rec/h
    last 12 h    1412 records     117.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,589      35  GATED             GATED             barrier>=30
      189       6,153      35  GATED             GATED             barrier>=30
      279      10,201      35  GATED             GATED             barrier>=30
      340      12,946      35  GATED             GATED             barrier>=30
      403      15,781      35  GATED             GATED             barrier>=30
      568      23,214      35  GATED             GATED             barrier>=30
