...
**Auto-generated 2026-08-05 19:08 UTC -- T+189h59m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+189h59m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5 min ago; LIVE, still failing** |
...
| | |
|---|---|
| cluster jobs | **832** (118 running, 714 queued) |
| **cores computing** | **944** |
...
```
generated 2026-08-05 19:09 UTC | elapsed 7.92 d | 21.2 d to the Aug-27 stop
test tier: 16,167 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      24,161     139  GATED             GATED             barrier>=30
