...
**Auto-generated 2026-08-05 09:13 UTC -- T+180h04m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+180h04m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 2.0 h ago; none live, newest failure 1.9 h ago** |
...
```
generated 2026-08-05 09:13 UTC | elapsed 7.50 d | 21.6 d to the Aug-27 stop
test tier: 14,646 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     240 records     240.0 rec/h
    last  3 h     724 records     241.3 rec/h
    last 12 h    1715 records     142.9 rec/h
    last 24 h    4081 records     170.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,048     143  GATED             GATED             barrier>=30
      189       7,000     196  GATED             GATED             barrier>=30
      279      11,232     240  GATED             GATED             barrier>=30
      340      14,282     240  GATED             GATED             barrier>=30
      403      17,432     240  GATED             GATED             barrier>=30
      568      25,682     240  GATED             GATED             barrier>=30
