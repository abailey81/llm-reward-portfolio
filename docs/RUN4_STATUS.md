...
**Auto-generated 2026-08-05 05:03 UTC -- T+175h54m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+175h54m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 1 min ago; LIVE, still failing** |
...
```
generated 2026-08-05 05:03 UTC | elapsed 7.33 d | 21.8 d to the Aug-27 stop
test tier: 13,630 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      26 records      26.0 rec/h
    last  3 h      48 records      16.0 rec/h
    last 12 h    1670 records     139.2 rec/h
    last 24 h    3886 records     161.9 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,298      26  GATED             GATED             barrier>=30
      189       7,748      26  GATED             GATED             barrier>=30
      279      12,248      26  GATED             GATED             barrier>=30
      340      15,298      26  GATED             GATED             barrier>=30
      403      18,448      26  GATED             GATED             barrier>=30
      568      26,698      26  GATED             GATED             barrier>=30
