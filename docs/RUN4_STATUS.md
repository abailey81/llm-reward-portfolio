...
**Auto-generated 2026-08-06 10:13 UTC -- T+205h04m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+205h04m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **888** |
| **cores doing RUNG-RAISING work** | **20.3%** -- 184 of 904 cores (19 min old) |
...
```
generated 2026-08-06 10:14 UTC | elapsed 8.55 d | 20.6 d to the Aug-27 stop
test tier: 17,529 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    12 h rate is 75% from ONE line (test_leg_kimi_k3); 4 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,738      98  GATED             GATED             barrier>=30
      279       9,786      98  GATED             GATED             barrier>=30
      340      12,531      98  GATED             GATED             barrier>=30
      403      15,366      98  GATED             GATED             barrier>=30
      568      22,799      98  GATED             GATED             barrier>=30
    ...
    !! 78% of the rung-568 backlog (17,877 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
...
```
2026-08-06T09:51:25Z  OK  records=19061 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.1m  drift=0  sci=OK  r115=22B  sweep=28.4s  auto-cycle
2026-08-06T09:52:22Z  OK  records=19063 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.9m  drift=0  sci=OK  r115=22B  sweep=27.3s  auto-cycle
2026-08-06T09:53:20Z  OK  records=19063 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  sweep=27.9s  auto-cycle
2026-08-06T09:58:55Z  OK  records=19067 (+4)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.1m  drift=0  sci=OK  r115=22B  sweep=305.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T09:59:55Z  OK  records=19067 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  sweep=29.4s  auto-cycle
