...
**Auto-generated 2026-08-03 08:55 UTC -- T+131h46m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+131h46m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **879** (252 running, 627 queued) |
| **cores computing** | **2016** |

Per-rung ETAs from the registered model at the cores we actually hold:

```
 rung             @2016 cores              @830 cores   binding
  ...
  403            5.4 d  08-03           13.0 d  08-10   throughput
  568            7.4 d  08-05           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 1869 |
| scalar | g5 of 5 | 1287 |
| placebo | g5 of 5 | 1397 |
| scalar_cvar5 | g5 of 5 | 1371 |
| placebo_shuffled | g5 of 5 | 1385 |
...
```
2026-08-03T08:43:55Z  RED  records=7642 (+15)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.0m  drift=0  sci=OK  r115=21B  sweep=65.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T08:45:31Z  RED  records=7646 (+4)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.1m  drift=0  sci=OK  r115=21B  sweep=77.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T08:47:19Z  RED  records=7657 (+11)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=21B  sweep=72.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T08:49:01Z  RED  records=7662 (+5)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=21B  cores=2048  sweep=129.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T08:51:41Z  RED  records=7688 (+26)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.1m  drift=0  sci=OK  r115=21B  sweep=70.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T08:53:22Z  RED  records=7704 (+16)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=1.8m  drift=0  sci=OK  r115=21B  sweep=129.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
