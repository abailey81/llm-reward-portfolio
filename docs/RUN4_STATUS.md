...
**Auto-generated 2026-08-06 03:18 UTC -- T+198h09m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+198h09m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 03:19 UTC | elapsed 8.26 d | 20.9 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    1565 records     130.4 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,624      14  GATED             GATED             barrier>=30
      189       6,188      14  GATED             GATED             barrier>=30
      279      10,236      14  GATED             GATED             barrier>=30
      340      12,981      14  GATED             GATED             barrier>=30
      403      15,816      14  GATED             GATED             barrier>=30
      568      23,249      14  GATED             GATED             barrier>=30
