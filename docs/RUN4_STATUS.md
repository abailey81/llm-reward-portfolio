...
**Auto-generated 2026-08-05 10:45 UTC -- T+181h36m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+181h36m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **831** (170 running, 661 queued) |
...
```
generated 2026-08-05 10:46 UTC | elapsed 7.57 d | 21.6 d to the Aug-27 stop
test tier: 14,880 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     168 records     168.0 rec/h
    last  3 h     599 records     199.7 rec/h
    last 12 h    1750 records     145.8 rec/h
    last 24 h    3956 records     164.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         180      46  GATED             GATED             barrier
      100       2,980      46  GATED             GATED             barrier>=30
      189       6,843      94  GATED             GATED             barrier>=30
      279      10,998     168  GATED             GATED             barrier>=30
      340      14,048     168  GATED             GATED             barrier>=30
      403      17,198     168  GATED             GATED             barrier>=30
      568      25,448     168  GATED             GATED             barrier>=30
