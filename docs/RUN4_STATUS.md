...
**Auto-generated 2026-08-11 19:27 UTC -- T+334h18m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+334h18m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **512** |
| **cores doing RUNG-RAISING work** | **4.8%** -- 24 of 504 cores (114 min old **STALE**) |
...
```
generated 2026-08-11 19:27 UTC | elapsed 13.93 d | 15.2 d to the Aug-27 stop
test tier: 29,818 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,781      52  GATED             GATED             barrier>=279
      403       3,986      52  GATED             GATED             barrier>=279
      568      10,510      52  GATED             GATED             barrier>=279
