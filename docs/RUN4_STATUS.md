...
**Auto-generated 2026-08-03 09:53 UTC -- T+132h44m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+132h44m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **828** (207 running, 621 queued) |
...
```
 rung             @1656 cores              @830 cores   binding
  ...
  403            6.5 d  08-04           13.0 d  08-10   throughput
  568            9.1 d  08-06           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 1952 |
| scalar | g5 of 5 | 1367 |
| placebo | g5 of 5 | 1480 |
| scalar_cvar5 | g5 of 5 | 1460 |
| placebo_shuffled | g5 of 5 | 1469 |
