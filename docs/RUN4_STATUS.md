...
**Auto-generated 2026-08-04 22:23 UTC -- T+169h14m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+169h14m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **826** (153 running, 671 queued) |
...
```
generated 2026-08-04 22:24 UTC | elapsed 7.05 d | 22.1 d to the Aug-27 stop
test tier: 13,064 records over 68 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      97 records      97.0 rec/h
    last  3 h     564 records     188.0 rec/h
    last 12 h    2194 records     182.8 rec/h
    last 24 h    4334 records     180.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         240      13  GATED             GATED             barrier
      100       3,344      37  GATED             GATED             barrier>=30
      189       7,794      37  GATED             GATED             barrier>=30
      279      12,294      37  GATED             GATED             barrier>=30
      340      15,344      37  GATED             GATED             barrier>=30
      403      18,494      37  GATED             GATED             barrier>=30
      568      27,264      97  GATED             GATED             barrier>=30
