...
**Auto-generated 2026-08-06 21:11 UTC -- T+216h02m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+216h02m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 11/240 (4.6% to fatal), pull on core, 4.2 h ago; none live, newest failure 4.2 h ago** |
...
| | |
|---|---|
| cluster jobs | **834** = 105 running + **183 ELIGIBLE** + 546 held by us + 0 held only by the site |
...
| **cores computing** | **840** |
| **cores doing RUNG-RAISING work** | **29.4%** -- 240 of 816 cores (46 min old) |
...
```
generated 2026-08-06 21:11 UTC | elapsed 9.00 d | 20.1 d to the Aug-27 stop
...
2026-08-06T21:11:17Z  OK  records=19970 (+8)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  cores=840  sweep=842.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
