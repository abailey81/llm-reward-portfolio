...
**Auto-generated 2026-08-06 04:36 UTC -- T+199h27m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+199h27m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
test tier: 17,117 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      38 records      38.0 rec/h
    last  3 h      98 records      32.7 rec/h
    last 12 h    1408 records     117.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,586      38  GATED             GATED             barrier>=30
      189       6,150      38  GATED             GATED             barrier>=30
      279      10,198      38  GATED             GATED             barrier>=30
      340      12,943      38  GATED             GATED             barrier>=30
      403      15,778      38  GATED             GATED             barrier>=30
      568      23,211      38  GATED             GATED             barrier>=30
