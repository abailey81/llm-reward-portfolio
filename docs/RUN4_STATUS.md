...
**Auto-generated 2026-08-13 01:00 UTC -- T+363h51m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+363h51m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **321** = 47 running + **208 ELIGIBLE** + 66 held by us + 0 held only by the site |
...
| **cores computing** | **376** |
| **cores doing RUNG-RAISING work** | **43.8%** -- 112 of 256 cores (88 min old) |
...
```
generated 2026-08-13 01:01 UTC | elapsed 15.16 d | 14.0 d to the Aug-27 stop
test tier: 31,536 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 33.2 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h     398 records      33.2 rec/h   usable
    last 24 h    1434 records      59.8 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (33 rec/h); latest excludes cells already within
    8 of the ceiling (33 rec/h). Window 12 h.
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340         424       0  2026-08-13 13:48  2026-08-13 13:48  yes
      403       2,445       0  2026-08-16 02:44  2026-08-16 02:44  yes
      568       8,792       0  2026-08-24 02:06  2026-08-24 02:06  yes
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung      @376 cores      @830 cores   binding
       30           4.6 d           4.6 d   critical_chain
      100           8.4 d           4.6 d   critical_chain
      189          14.4 d           6.5 d   throughput
      279          20.5 d           9.3 d   throughput
      340          24.6 d          11.1 d   throughput
      403          28.8 d          13.0 d   throughput
      568          39.9 d          18.1 d   throughput
