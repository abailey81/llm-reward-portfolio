...
**Auto-generated 2026-08-06 09:36 UTC -- T+204h27m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+204h27m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **896** |
| **cores doing RUNG-RAISING work** | **20.7%** -- 200 of 968 cores (17 min old) |
...
test tier: 17,507 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,760     128  GATED             GATED             barrier>=30
      279       9,808     128  GATED             GATED             barrier>=30
      340      12,553     128  GATED             GATED             barrier>=30
      403      15,388     128  GATED             GATED             barrier>=30
      568      22,821     128  GATED             GATED             barrier>=30
