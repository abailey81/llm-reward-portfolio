...
**Auto-generated 2026-08-06 00:29 UTC -- T+195h20m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h20m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.4 h ago; none live, newest failure 25 min ago** |
...
| | |
|---|---|
| cluster jobs | **977** (67 running, 910 queued) |
| **cores computing** | **536** |
...
```
generated 2026-08-06 00:29 UTC | elapsed 8.14 d | 21.0 d to the Aug-27 stop
test tier: 16,977 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,721     164  GATED             GATED             barrier>=30
      189       6,290     212  GATED             GATED             barrier>=30
      279      10,338     214  GATED             GATED             barrier>=30
      340      13,083     214  GATED             GATED             barrier>=30
      403      15,918     214  GATED             GATED             barrier>=30
      568      23,351     214  GATED             GATED             barrier>=30
