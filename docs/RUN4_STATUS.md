...
**Auto-generated 2026-08-05 07:42 UTC -- T+178h33m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+178h33m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **915** (200 running, 715 queued) |
...
```
generated 2026-08-05 07:42 UTC | elapsed 7.44 d | 21.7 d to the Aug-27 stop
test tier: 14,264 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       7,237     128  GATED             GATED             barrier>=30
      279      11,614     251  GATED             GATED             barrier>=30
      340      14,664     251  GATED             GATED             barrier>=30
      403      17,814     251  GATED             GATED             barrier>=30
      568      26,064     251  GATED             GATED             barrier>=30
