...
**Auto-generated 2026-08-05 06:39 UTC -- T+177h30m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+177h30m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **945** (207 running, 738 queued) |
...
```
generated 2026-08-05 06:39 UTC | elapsed 7.40 d | 21.7 d to the Aug-27 stop
test tier: 13,999 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     242 records     242.0 rec/h
    last  3 h     395 records     131.7 rec/h
    last 12 h    1654 records     137.8 rec/h
    last 24 h    4038 records     168.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       7,379     242  GATED             GATED             barrier>=30
      279      11,879     242  GATED             GATED             barrier>=30
      340      14,929     242  GATED             GATED             barrier>=30
      403      18,079     242  GATED             GATED             barrier>=30
      568      26,329     242  GATED             GATED             barrier>=30
