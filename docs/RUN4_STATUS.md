...
**Auto-generated 2026-08-01 10:11 UTC -- T+85h02m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+85h02m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **2318** |
| LLM calls / spend | 2828 / **$44.2335** |
...
| scalar | g5 of 5 | 296 |
| placebo | g5 of 5 | 268 |
| scalar_cvar5 | g5 of 5 | 248 |
| placebo_shuffled | g5 of 5 | 235 |
...
```
2026-08-01T10:07:40Z  RED  records=2318 (+0)  spend=$44.2335  guards=2  arms_full=10/10  budget=2  stalest=2.0m  drift=0  sci=OK  r115=17B  sweep=11.7s  auto-cycle
2026-08-01T10:08:22Z  RED  records=2318 (+0)  spend=$44.2335  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=17B  sweep=16.5s  auto-cycle
2026-08-01T10:09:09Z  RED  records=2318 (+0)  spend=$44.2335  guards=2  arms_full=10/10  budget=2  stalest=2.0m  drift=0  sci=OK  r115=17B  sweep=16.5s  auto-cycle
2026-08-01T10:09:56Z  RED  records=2318 (+0)  spend=$44.2335  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=17B  sweep=12.1s  auto-cycle
2026-08-01T10:10:38Z  RED  records=2318 (+0)  spend=$44.2335  guards=2  arms_full=10/10  budget=2  stalest=1.8m  drift=0  sci=OK  r115=17B  sweep=16.0s  auto-cycle
2026-08-01T10:11:24Z  RED  records=2318 (+0)  spend=$44.2335  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=17B  sweep=15.7s  auto-cycle
```
...
```
  ...
  openrouter  spent $  8.2490  + still to author $  1.1598  = $  9.4089   credited $ 19.3100   margin $  +9.9011 (+51%)  comfortable
```
