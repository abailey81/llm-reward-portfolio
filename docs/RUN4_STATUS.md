...
**Auto-generated 2026-08-06 06:28 UTC -- T+201h19m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+201h19m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    3380 records     140.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,926     139  GATED             GATED             barrier>=30
      279       9,974     139  GATED             GATED             barrier>=30
      340      12,719     139  GATED             GATED             barrier>=30
      403      15,554     139  GATED             GATED             barrier>=30
      568      22,987     139  GATED             GATED             barrier>=30
