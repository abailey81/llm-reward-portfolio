...
**Auto-generated 2026-08-02 12:54 UTC -- T+111h45m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+111h45m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **958** (227 running, 731 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1050 |
| scalar | g5 of 5 | 459 |
| placebo | g5 of 5 | 688 |
| scalar_cvar5 | g5 of 5 | 646 |
| placebo_shuffled | g5 of 5 | 631 |
...
```
2026-08-02T12:48:45Z  RED  records=3845 (+5)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=4.1m  drift=0  sci=OK  r115=21B  sweep=25.1s  auto-cycle
2026-08-02T12:49:41Z  RED  records=3848 (+3)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0  sci=OK  r115=21B  sweep=25.7s  auto-cycle
2026-08-02T12:50:36Z  RED  records=3850 (+2)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=21B  sweep=49.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T12:51:56Z  RED  records=3854 (+4)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=21B  sweep=24.9s  auto-cycle
2026-08-02T12:52:51Z  RED  records=3859 (+5)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.2m  drift=0  sci=OK  r115=21B  sweep=25.3s  auto-cycle
2026-08-02T12:53:47Z  RED  records=3861 (+2)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=4.1m  drift=0  sci=OK  r115=21B  sweep=27.4s  auto-cycle
```
