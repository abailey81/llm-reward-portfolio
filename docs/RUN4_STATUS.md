...
**Auto-generated 2026-08-04 18:52 UTC -- T+165h43m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+165h43m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on nemotron-3-super, 3.1 h ago; none live, newest failure 3.1 h ago** |
...
| | |
|---|---|
| cluster jobs | **168** (166 running, 0 queued) |
...
```
generated 2026-08-04 18:52 UTC | elapsed 6.91 d | 22.2 d to the Aug-27 stop
test tier: 12,377 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     183 records     183.0 rec/h
    last  3 h     582 records     194.0 rec/h
    last 12 h    2394 records     199.5 rec/h
    last 24 h    4273 records     178.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (200 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,860      44  GATED             GATED             barrier>=30
      189       8,310      44  GATED             GATED             barrier>=30
      279      12,810      44  GATED             GATED             barrier>=30
      340      15,860      44  GATED             GATED             barrier>=30
      403      19,010      44  GATED             GATED             barrier>=30
      568      27,951     183  GATED             GATED             barrier>=30
