...
**Auto-generated 2026-08-05 01:53 UTC -- T+172h44m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+172h44m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 3.4 h ago; none live, newest failure 2.3 h ago** |
...
| | |
|---|---|
| cluster jobs | **942** (175 running, 765 queued) |
| **cores computing** | **1400** |
...
```
generated 2026-08-05 01:54 UTC | elapsed 7.20 d | 21.9 d to the Aug-27 stop
test tier: 13,573 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     105 records     105.0 rec/h
    last  3 h     414 records     138.0 rec/h
    last 12 h    2158 records     179.8 rec/h
    last 24 h    4240 records     176.7 rec/h
    12 h rate is 46% from ONE line (test_leg_sonnet_5); 10 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (180 rec/h); latest excludes cells already within
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,326      14  GATED             GATED             barrier>=30
      189       7,776      14  GATED             GATED             barrier>=30
      279      12,276      14  GATED             GATED             barrier>=30
      340      15,326      14  GATED             GATED             barrier>=30
      403      18,476      14  GATED             GATED             barrier>=30
      568      26,755     105  GATED             GATED             barrier>=30
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung     @1400 cores      @830 cores   binding
