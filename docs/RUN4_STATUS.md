...
**Auto-generated 2026-08-06 01:42 UTC -- T+196h33m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+196h33m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 01:42 UTC | elapsed 8.19 d | 20.9 d to the Aug-27 stop
test tier: 17,027 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,676      39  GATED             GATED             barrier>=30
      189       6,240      39  GATED             GATED             barrier>=30
      279      10,288      39  GATED             GATED             barrier>=30
      340      13,033      39  GATED             GATED             barrier>=30
      403      15,868      39  GATED             GATED             barrier>=30
      568      23,301      39  GATED             GATED             barrier>=30
