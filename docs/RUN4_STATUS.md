...
**Auto-generated 2026-08-06 05:05 UTC -- T+199h56m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+199h56m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 05:05 UTC | elapsed 8.33 d | 20.8 d to the Aug-27 stop
test tier: 17,149 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      54 records      54.0 rec/h
    last  3 h      90 records      30.0 rec/h
    last 12 h    1339 records     111.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,570      38  GATED             GATED             barrier>=30
      189       6,118      54  GATED             GATED             barrier>=30
      279      10,166      54  GATED             GATED             barrier>=30
      340      12,911      54  GATED             GATED             barrier>=30
      403      15,746      54  GATED             GATED             barrier>=30
      568      23,179      54  GATED             GATED             barrier>=30
