...
```
generated 2026-08-06 07:27 UTC | elapsed 8.43 d | 20.7 d to the Aug-27 stop
test tier: 17,359 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      16 records      16.0 rec/h
    last  3 h     248 records      82.7 rec/h
    last 12 h    1176 records      98.0 rec/h
    last 24 h    3168 records     132.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,908      16  GATED             GATED             barrier>=30
      279       9,956      16  GATED             GATED             barrier>=30
      340      12,701      16  GATED             GATED             barrier>=30
      403      15,536      16  GATED             GATED             barrier>=30
      568      22,969      16  GATED             GATED             barrier>=30
