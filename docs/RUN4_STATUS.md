...
**Auto-generated 2026-08-05 01:58 UTC -- T+172h49m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+172h49m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **973** (176 running, 796 queued) |
...
```
generated 2026-08-05 01:59 UTC | elapsed 7.20 d | 21.9 d to the Aug-27 stop
test tier: 13,574 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      92 records      92.0 rec/h
    last  3 h     396 records     132.0 rec/h
    last 12 h    2147 records     178.9 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      26,754      92  GATED             GATED             barrier>=30
