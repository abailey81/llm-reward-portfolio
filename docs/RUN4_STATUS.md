...
**Auto-generated 2026-07-31 22:44 UTC -- T+73h35m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+73h35m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **196** (120 running, 76 queued) |
| **cores computing** | **960** |
...
| scalar | g5 of 5 | 296 |
| placebo | g5 of 5 | 193 |
| scalar_cvar5 | g5 of 5 | 170 |
| placebo_shuffled | g5 of 5 | 161 |
...
```
2026-07-31T22:40:30Z  RED  records=1534 (+0)  spend=$38.9044  guards=2  arms_full=10/10  budget=2  stalest=1.5m  drift=0  sci=OK  r115=13B  sweep=12.7s  auto-cycle
2026-07-31T22:41:13Z  RED  records=1534 (+0)  spend=$38.9044  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=13B  sweep=11.9s  auto-cycle
2026-07-31T22:41:55Z  RED  records=1534 (+0)  spend=$38.9044  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=13B  sweep=12.0s  auto-cycle
2026-07-31T22:42:38Z  RED  records=1534 (+0)  spend=$38.9044  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=13B  sweep=12.1s  auto-cycle
2026-07-31T22:43:20Z  RED  records=1534 (+0)  spend=$38.9044  guards=2  arms_full=10/10  budget=2  stalest=1.2m  drift=0  sci=OK  r115=13B  sweep=12.0s  auto-cycle
2026-07-31T22:44:02Z  RED  records=1535 (+1)  spend=$38.9044  guards=2  arms_full=10/10  budget=2  stalest=1.9m  drift=0  sci=OK  r115=13B  sweep=12.1s  auto-cycle
```
...
```
  ...
  openrouter  spent $  7.1081  + still to author $  2.3902  = $  9.4983   credited $ 19.3100   margin $  +9.8117 (+51%)  comfortable
```
