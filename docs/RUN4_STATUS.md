...
**Auto-generated 2026-08-06 14:41 UTC -- T+209h32m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+209h32m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 8 min ago; LIVE, still failing** |
...
| | |
|---|---|
| cluster jobs | **879** (85 running, 794 queued) |
| **cores computing** | **680** |
...
```
generated 2026-08-06 14:42 UTC | elapsed 8.73 d | 20.4 d to the Aug-27 stop
test tier: 17,789 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,526     132  GATED             GATED             unstarted:2-unit(s)-absent>=30
      340      12,271     132  GATED             GATED             unstarted:2-unit(s)-absent>=30
      403      15,106     132  GATED             GATED             unstarted:2-unit(s)-absent>=30
      568      22,539     132  GATED             GATED             unstarted:2-unit(s)-absent>=30
