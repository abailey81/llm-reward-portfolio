...
**Auto-generated 2026-08-01 21:16 UTC -- T+96h07m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+96h07m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **87** (81 running, 6 queued) |
| **cores computing** | **648** |
...
```
 rung              @648 cores              @830 cores   binding
  ...
  100            4.9 d  08-02            4.6 d  08-02   critical_chain
  189            8.4 d  08-06            6.5 d  08-04   throughput
  279           11.9 d  08-09            9.3 d  08-07   throughput
  340           14.3 d  08-12           11.1 d  08-09   throughput
  403           16.7 d  08-14           13.0 d  08-10   throughput
  568           23.2 d  08-21           18.1 d  08-15   throughput
```
...
```
2026-08-01T21:12:19Z  RED  records=2770 (+1)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=19B  sweep=14.8s  auto-cycle
2026-08-01T21:13:04Z  RED  records=2771 (+1)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=3.5m  drift=0  sci=OK  r115=19B  sweep=17.5s  auto-cycle
2026-08-01T21:13:52Z  RED  records=2773 (+2)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=4.3m  drift=0  sci=OK  r115=19B  sweep=17.9s  auto-cycle
2026-08-01T21:14:40Z  RED  records=2774 (+1)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0  sci=OK  r115=19B  sweep=17.0s  auto-cycle
2026-08-01T21:15:27Z  RED  records=2776 (+2)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.1m  drift=0  sci=OK  r115=19B  sweep=25.6s  auto-cycle
2026-08-01T21:16:23Z  RED  records=2776 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=19B  sweep=16.9s  auto-cycle
```
