...
**Auto-generated 2026-08-06 19:24 UTC -- T+214h15m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+214h15m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=85; worst streak 11/240 (4.6% to fatal), pull on core, 2.5 h ago; none live, newest failure 2.4 h ago** |
...
| | |
|---|---|
| cluster jobs | **838** = 87 running + **26 ELIGIBLE** + 387 held by us + 338 held only by the site |
...
| **cores computing** | **696** |
| **cores doing RUNG-RAISING work** | **31.8%** -- 216 of 680 cores (31 min old) |
...
```
generated 2026-08-06 19:25 UTC | elapsed 8.93 d | 20.2 d to the Aug-27 stop
test tier: 18,407 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,653      39  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,488      39  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,921      39  GATED             GATED             no-records:test/distributional,test/scalar>=30
