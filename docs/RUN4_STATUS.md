...
**Auto-generated 2026-08-06 00:24 UTC -- T+195h15m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h15m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.3 h ago; none live, newest failure 20 min ago** |
...
| | |
|---|---|
| cluster jobs | **980** (66 running, 914 queued) |
| **cores computing** | **528** |
...
```
generated 2026-08-06 00:24 UTC | elapsed 8.14 d | 21.0 d to the Aug-27 stop
test tier: 16,969 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     230 records     230.0 rec/h
    last  3 h     562 records     187.3 rec/h
    last 12 h    1917 records     159.8 rec/h
    last 24 h    3553 records     148.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,727     171  GATED             GATED             barrier>=30
      189       6,297     229  GATED             GATED             barrier>=30
      279      10,346     230  GATED             GATED             barrier>=30
      340      13,091     230  GATED             GATED             barrier>=30
      403      15,926     230  GATED             GATED             barrier>=30
      568      23,359     230  GATED             GATED             barrier>=30
