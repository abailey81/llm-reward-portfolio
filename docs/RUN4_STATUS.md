...
| **cores computing** | **848** |
| **cores doing RUNG-RAISING work** | **22.6%** -- 192 of 848 cores (17 min old) |
...
```
generated 2026-08-06 11:40 UTC | elapsed 8.60 d | 20.5 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,689      30  GATED             GATED             barrier>=30
      279       9,717      50  GATED             GATED             barrier>=30
      340      12,462      50  GATED             GATED             barrier>=30
      403      15,297      50  GATED             GATED             barrier>=30
      568      22,730      50  GATED             GATED             barrier>=30
