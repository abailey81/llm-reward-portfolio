...
**Auto-generated 2026-08-06 20:01 UTC -- T+214h52m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+214h52m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **835** = 102 running + **21 ELIGIBLE** + 712 held by us + 0 held only by the site |
...
```
generated 2026-08-06 20:02 UTC | elapsed 8.95 d | 20.2 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,641      38  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,476      38  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,909      38  GATED             GATED             no-records:test/distributional,test/scalar>=30
