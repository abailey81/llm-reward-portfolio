...
**Auto-generated 2026-08-06 00:31 UTC -- T+195h22m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h22m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.5 h ago; none live, newest failure 27 min ago** |
...
test tier: 16,980 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     204 records     204.0 rec/h
    last  3 h     567 records     189.0 rec/h
    last 12 h    1927 records     160.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,718     157  GATED             GATED             barrier>=30
      189       6,287     202  GATED             GATED             barrier>=30
      279      10,335     204  GATED             GATED             barrier>=30
      340      13,080     204  GATED             GATED             barrier>=30
      403      15,915     204  GATED             GATED             barrier>=30
      568      23,348     204  GATED             GATED             barrier>=30
