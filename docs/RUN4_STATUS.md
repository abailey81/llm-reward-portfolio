...
**Auto-generated 2026-08-11 22:41 UTC -- T+337h32m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+337h32m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on deepseek-v4-pro, 5.0 h ago; none live, newest failure 5.0 h ago** |
...
| | |
|---|---|
| cluster jobs | **406** = 78 running + **0 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **624** |
| **cores doing RUNG-RAISING work** | **36.2%** -- 232 of 640 cores (3 min old) |
...
```
generated 2026-08-11 22:42 UTC | elapsed 14.07 d | 15.1 d to the Aug-27 stop
test tier: 30,049 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 106.2 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last  3 h     211 records      70.3 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last 12 h    1275 records     106.2 rec/h   usable
    last 24 h    2656 records     110.7 rec/h   usable
    12 h rate is 84% from ONE line (test); 3 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (106 rec/h); latest excludes cells already within
    8 of the ceiling (106 rec/h). Window 12 h.
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279         120       8  2026-08-11 23:50  2026-08-11 23:50  yes
      340       1,550      67  2026-08-12 13:17  2026-08-12 13:17  yes
      403       3,755      67  2026-08-13 10:03  2026-08-13 10:03  yes
      568      10,279      67  2026-08-15 23:27  2026-08-15 23:27  yes
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung      @624 cores      @830 cores   binding
      ...
      189           8.7 d           6.5 d   throughput
      279          12.3 d           9.3 d   throughput
      340          14.8 d          11.1 d   throughput
      403          17.4 d          13.0 d   throughput
      568          24.0 d          18.1 d   throughput
...
```
2026-08-11T22:28:52Z  OK  records=31579 (+3)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.4m  drift=0  sci=OK  r115=22B  sweep=81.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T22:30:21Z  OK  records=31579 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  sweep=57.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T22:31:45Z  OK  records=31579 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.4m  drift=0  sci=OK  r115=22B  sweep=53.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T22:33:09Z  OK  records=31583 (+4)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  sweep=54.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T22:34:52Z  OK  records=31583 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.1m  drift=0  sci=OK  r115=22B  sweep=72.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T22:37:06Z  OK  records=31585 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  sweep=103.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
