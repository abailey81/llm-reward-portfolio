...
**Auto-generated 2026-08-10 09:44 UTC -- T+300h35m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+300h35m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **837** = 145 running + **316 ELIGIBLE** + 376 held by us + 0 held only by the site |
...
| **cores doing RUNG-RAISING work** | **81.1%** -- 960 of 1184 cores (8 min old) |
...
```
generated 2026-08-10 09:47 UTC | elapsed 12.53 d | 16.6 d to the Aug-27 stop
test tier: 26,254 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189         112      32  2026-08-10 10:54  2026-08-10 10:54  yes
      279       2,688     121  2026-08-11 12:28  2026-08-11 12:28  yes
      340       4,823     121  2026-08-12 09:39  2026-08-12 09:39  yes
      403       7,028     125  2026-08-13 07:32  2026-08-13 07:32  yes
      568      14,074     155  2026-08-16 05:28  2026-08-16 05:28  yes
...
```
UNDECIDED (cluster unreachable or tag unresolved -- NOT an alarm): test_leg_nemotron_3_super, test_leg_glm_5_2, test_leg_deepseek_v4_pro, test, test_leg_qwen3_6_27b, test_leg_kimi_k3
