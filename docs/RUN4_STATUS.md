...
**Auto-generated 2026-08-05 07:15 UTC -- T+178h06m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+178h06m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 2.2 h ago; none live, newest failure 2.2 h ago** |
...
| | |
|---|---|
| cluster jobs | **926** (194 running, 732 queued) |
...
```
generated 2026-08-05 07:16 UTC | elapsed 7.42 d | 21.7 d to the Aug-27 stop
test tier: 14,136 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     207 records     207.0 rec/h
    last  3 h     532 records     177.3 rec/h
    last 12 h    1663 records     138.6 rec/h
    last 24 h    4071 records     169.6 rec/h
    12 h rate is 42% from ONE line (test_leg_haiku_4_5); 10 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 39% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       7,250     199  GATED             GATED             barrier>=30
      279      11,742     207  GATED             GATED             barrier>=30
      340      14,792     207  GATED             GATED             barrier>=30
      403      17,942     207  GATED             GATED             barrier>=30
      568      26,192     207  GATED             GATED             barrier>=30
