...
**Auto-generated 2026-08-05 10:56 UTC -- T+181h47m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+181h47m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 10:57 UTC | elapsed 7.58 d | 21.5 d to the Aug-27 stop
test tier: 14,893 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,842      75  GATED             GATED             barrier>=30
      279      10,985     159  GATED             GATED             barrier>=30
      340      14,035     159  GATED             GATED             barrier>=30
      403      17,185     159  GATED             GATED             barrier>=30
      568      25,435     159  GATED             GATED             barrier>=30
