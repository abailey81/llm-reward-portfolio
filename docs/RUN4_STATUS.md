...
```
generated 2026-08-06 03:11 UTC | elapsed 8.25 d | 20.9 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,624      16  GATED             GATED             barrier>=30
      189       6,188      16  GATED             GATED             barrier>=30
      279      10,236      16  GATED             GATED             barrier>=30
      340      12,981      16  GATED             GATED             barrier>=30
      403      15,816      16  GATED             GATED             barrier>=30
      568      23,249      16  GATED             GATED             barrier>=30
