...
```
generated 2026-08-06 00:31 UTC | elapsed 8.14 d | 21.0 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,718     159  GATED             GATED             barrier>=30
      189       6,287     204  GATED             GATED             barrier>=30
      279      10,335     206  GATED             GATED             barrier>=30
      340      13,080     206  GATED             GATED             barrier>=30
      403      15,915     206  GATED             GATED             barrier>=30
      568      23,348     206  GATED             GATED             barrier>=30
