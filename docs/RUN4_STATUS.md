...
```
generated 2026-08-06 06:04 UTC | elapsed 8.37 d | 20.7 d to the Aug-27 stop
test tier: 17,291 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,976     142  GATED             GATED             barrier>=30
      279      10,024     142  GATED             GATED             barrier>=30
      340      12,769     142  GATED             GATED             barrier>=30
      403      15,604     142  GATED             GATED             barrier>=30
      568      23,037     142  GATED             GATED             barrier>=30
