...
**Auto-generated 2026-08-06 14:59 UTC -- T+209h50m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+209h50m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 26 min ago; none live, newest failure 25 min ago** |
...
| | |
|---|---|
| cluster jobs | **874** (80 running, 794 queued) |
| **cores computing** | **640** |
...
test tier: 17,870 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,636      48  GATED             GATED             unstarted:2-unit(s)-absent>=30
      279       9,445     195  GATED             GATED             unstarted:2-unit(s)-absent>=30
      340      12,190     195  GATED             GATED             unstarted:2-unit(s)-absent>=30
      403      15,025     195  GATED             GATED             unstarted:2-unit(s)-absent>=30
      568      22,458     195  GATED             GATED             unstarted:2-unit(s)-absent>=30
