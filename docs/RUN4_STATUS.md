...
**Auto-generated 2026-08-05 02:16 UTC -- T+173h07m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+173h07m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 02:17 UTC | elapsed 7.21 d | 21.9 d to the Aug-27 stop
test tier: 13,588 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      71 records      71.0 rec/h
    last  3 h     337 records     112.3 rec/h
    last 12 h    2093 records     174.4 rec/h
    last 24 h    4212 records     175.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,324      13  GATED             GATED             barrier>=30
      189       7,774      13  GATED             GATED             barrier>=30
      279      12,274      13  GATED             GATED             barrier>=30
      340      15,324      13  GATED             GATED             barrier>=30
      403      18,474      13  GATED             GATED             barrier>=30
      568      26,740      71  GATED             GATED             barrier>=30
