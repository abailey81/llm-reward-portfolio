...
**Auto-generated 2026-08-12 07:14 UTC -- T+346h06m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+346h06m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **32123** |
| **Myriad maintenance** | **2026-08-12 from 08:00 UTC, at risk all day** (in 0.0 days). Delayed from Aug 11. Jobs may die and REQUEUE idempotently; the supervisors ride it. Playbook: docs/ops/MAINTENANCE_2026-08-12.md |
| LLM calls / spend | 2956 / **$45.5021** |
| transport health | **timeouts 6h=0; worst streak 0/240 (0.0% to fatal), - on -, age UNKNOWN; none live, newest failure 13.6 h ago** |
...
| | |
|---|---|
| cluster jobs | **443** = 115 running + **0 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **920** |
| **cores doing RUNG-RAISING work** | **78.3%** -- 720 of 920 cores (102 min old **STALE**) |
...
```
generated 2026-08-12 07:15 UTC | elapsed 14.42 d | 14.7 d to the Aug-27 stop
test tier: 30,580 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 65.2 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    last  1 h      88 records      88.0 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last  3 h     282 records      94.0 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last 12 h     783 records      65.2 rec/h   usable
    last 24 h    2182 records      90.9 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279           0       1  REACHED           REACHED           yes
      340       1,196      80  2026-08-13 01:35  2026-08-13 01:35  yes
      403       3,401      80  2026-08-14 11:23  2026-08-14 11:23  yes
      568       9,748      88  2026-08-18 12:39  2026-08-18 12:39  yes
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung      @920 cores      @830 cores   binding
       30           4.6 d           4.6 d   critical_chain
      100           4.6 d           4.6 d   critical_chain
      189           5.9 d           6.5 d   throughput
      279           8.4 d           9.3 d   throughput
      340          10.0 d          11.1 d   throughput
      403          11.8 d          13.0 d   throughput
      568          16.3 d          18.1 d   throughput
...
```
2026-08-12T06:39:50Z  OK  records=32084 (+20)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.5m  drift=0  sci=OK  r115=22B  cores=928  sweep=683.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T06:56:22Z  ATTN  records=32085 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  sweep=961.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T07:10:32Z  ATTN  records=32120 (+35)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  cores=936  sweep=819.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T07:12:13Z  ATTN  records=32122 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.2m  drift=0  sci=OK  r115=22B  sweep=70.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T07:13:42Z  ATTN  records=32123 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=58.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
