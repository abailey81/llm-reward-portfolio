...
**Auto-generated 2026-08-05 01:48 UTC -- T+172h39m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+172h39m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 3.3 h ago; none live, newest failure 2.2 h ago** |
...
| | |
|---|---|
| cluster jobs | **943** (176 running, 765 queued) |
...
```
generated 2026-08-05 01:48 UTC | elapsed 7.19 d | 21.9 d to the Aug-27 stop
test tier: 13,565 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     106 records     106.0 rec/h
    last  3 h     427 records     142.3 rec/h
    last 12 h    2168 records     180.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,329      11  GATED             GATED             barrier>=30
      189       7,779      11  GATED             GATED             barrier>=30
      279      12,279      11  GATED             GATED             barrier>=30
      340      15,329      11  GATED             GATED             barrier>=30
      403      18,479      11  GATED             GATED             barrier>=30
      568      26,763     106  GATED             GATED             barrier>=30
