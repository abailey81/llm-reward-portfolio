...
**Auto-generated 2026-08-06 12:14 UTC -- T+207h05m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
test tier: 17,616 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,699      25  GATED             GATED             barrier>=30
      340      12,444      25  GATED             GATED             barrier>=30
      403      15,279      25  GATED             GATED             barrier>=30
      568      22,712      25  GATED             GATED             barrier>=30
