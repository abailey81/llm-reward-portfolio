...
test tier: 17,026 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,677      39  GATED             GATED             barrier>=30
      189       6,241      40  GATED             GATED             barrier>=30
      279      10,289      40  GATED             GATED             barrier>=30
      340      13,034      40  GATED             GATED             barrier>=30
      403      15,869      40  GATED             GATED             barrier>=30
      568      23,302      40  GATED             GATED             barrier>=30
