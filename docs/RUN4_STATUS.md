...
**Auto-generated 2026-08-03 00:48 UTC -- T+123h39m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+123h39m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **668** (266 running, 402 queued) |
| **cores computing** | **2128** |

Per-rung ETAs from the registered model at the cores we actually hold:

```
 rung             @2128 cores              @830 cores   binding
  ...
  568            7.1 d  08-04           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 1520 |
| scalar | g5 of 5 | 927 |
| placebo | g5 of 5 | 1147 |
| scalar_cvar5 | g5 of 5 | 1103 |
| placebo_shuffled | g5 of 5 | 1083 |
...
2026-08-03T00:45:46Z  RED  records=6175 (+14)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=4.0m  drift=0  sci=OK  r115=21B  sweep=130.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
