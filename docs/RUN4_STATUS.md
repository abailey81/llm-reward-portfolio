...
**Auto-generated 2026-08-05 05:05 UTC -- T+175h56m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+175h56m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 3 min ago; LIVE, still failing** |
...
| | |
|---|---|
| cluster jobs | **988** (194 running, 794 queued) |
...
```
generated 2026-08-05 05:05 UTC | elapsed 7.33 d | 21.8 d to the Aug-27 stop
test tier: 13,634 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      30 records      30.0 rec/h
    last  3 h      51 records      17.0 rec/h
    last 12 h    1669 records     139.1 rec/h
    last 24 h    3880 records     161.7 rec/h
    12 h rate is 36% from ONE line (test_leg_qwen3_5_9b); 10 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 63% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,294      30  GATED             GATED             barrier>=30
      189       7,744      30  GATED             GATED             barrier>=30
      279      12,244      30  GATED             GATED             barrier>=30
      340      15,294      30  GATED             GATED             barrier>=30
      403      18,444      30  GATED             GATED             barrier>=30
      568      26,694      30  GATED             GATED             barrier>=30
