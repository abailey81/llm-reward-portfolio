...
**Auto-generated 2026-08-04 17:17 UTC -- T+164h08m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+164h08m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=11; worst streak 21/240 (8.8% to fatal), pull on core, 4.8 h ago; none live, newest failure 88 min ago** |
...
| | |
|---|---|
| cluster jobs | **218** (216 running, 0 queued) |
...
```
generated 2026-08-04 17:17 UTC | elapsed 6.84 d | 22.3 d to the Aug-27 stop
test tier: 12,016 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     176 records     176.0 rec/h
    last  3 h     521 records     173.7 rec/h
    last 12 h    2235 records     186.2 rec/h
    last 24 h    4018 records     167.4 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      28,312     176  GATED             GATED             barrier>=30
