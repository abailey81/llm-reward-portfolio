...
| transport health | **timeouts 6h=93; worst streak 11/240 (4.6% to fatal), pull on core, 2.5 h ago; none live, newest failure 2.4 h ago** |
...
```
generated 2026-08-06 19:24 UTC | elapsed 8.93 d | 20.2 d to the Aug-27 stop
test tier: 18,404 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,656      36  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,491      36  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,924      36  GATED             GATED             no-records:test/distributional,test/scalar>=30
