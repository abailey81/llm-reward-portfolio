...
**Auto-generated 2026-08-05 00:51 UTC -- T+171h42m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+171h42m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 2.4 h ago; none live, newest failure 75 min ago** |
...
| | |
|---|---|
| cluster jobs | **956** (170 running, 784 queued) |
...
```
generated 2026-08-05 00:52 UTC | elapsed 7.15 d | 22.0 d to the Aug-27 stop
test tier: 13,462 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     121 records     121.0 rec/h
    last  3 h     452 records     150.7 rec/h
    last 12 h    2223 records     185.2 rec/h
    last 24 h    4231 records     176.3 rec/h
    12 h rate is 52% from ONE line (test_leg_sonnet_5); 10 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      26,866     121  GATED             GATED             barrier>=30
...
2026-08-05T00:49:43Z  OK  records=14998 (+15)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.1m  drift=0  sci=OK  r115=22B  sweep=272.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
