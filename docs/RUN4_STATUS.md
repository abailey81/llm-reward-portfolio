...
**Auto-generated 2026-08-06 05:11 UTC -- T+200h02m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h02m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 05:11 UTC | elapsed 8.34 d | 20.8 d to the Aug-27 stop
test tier: 17,158 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      59 records      59.0 rec/h
    last  3 h      95 records      31.7 rec/h
    last 12 h    1326 records     110.5 rec/h
    ...
    !! 45% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_haiku_4_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,570      34  GATED             GATED             barrier>=30
      189       6,109      59  GATED             GATED             barrier>=30
      279      10,157      59  GATED             GATED             barrier>=30
      340      12,902      59  GATED             GATED             barrier>=30
      403      15,737      59  GATED             GATED             barrier>=30
      568      23,170      59  GATED             GATED             barrier>=30
