...
**Auto-generated 2026-08-02 03:08 UTC -- T+101h59m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+101h59m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **48** (42 running, 6 queued) |
| **cores computing** | **336** |
...
```
 rung              @336 cores              @830 cores   binding
  ...
  100            9.4 d  08-07            4.6 d  08-02   critical_chain
  189           16.1 d  08-14            6.5 d  08-04   throughput
  279           22.9 d  08-20            9.3 d  08-07   throughput
  340           27.5 d  08-25           11.1 d  08-09   throughput
  403        32.2 d  08-30  X           13.0 d  08-10   throughput
  568        44.7 d  09-11  X           18.1 d  08-15   throughput
```
...
| scalar | g5 of 5 | 326 |
| placebo | g5 of 5 | 588 |
| scalar_cvar5 | g5 of 5 | 539 |
| placebo_shuffled | g5 of 5 | 499 |
...
```
2026-08-02T03:03:41Z  RED  records=3248 (+2)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=20B  sweep=20.0s  auto-cycle
2026-08-02T03:04:31Z  RED  records=3249 (+1)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=20B  sweep=37.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T03:05:38Z  RED  records=3249 (+0)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=20B  sweep=19.7s  auto-cycle
2026-08-02T03:06:28Z  RED  records=3250 (+1)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0  sci=OK  r115=20B  sweep=20.6s  auto-cycle
2026-08-02T03:07:19Z  RED  records=3250 (+0)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=4.0m  drift=0  sci=OK  r115=20B  sweep=20.5s  auto-cycle
2026-08-02T03:08:10Z  RED  records=3251 (+1)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0  sci=OK  r115=20B  sweep=21.2s  auto-cycle
```
