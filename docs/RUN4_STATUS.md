...
**Auto-generated 2026-08-05 07:08 UTC -- T+177h59m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+177h59m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 07:08 UTC | elapsed 7.42 d | 21.7 d to the Aug-27 stop
test tier: 14,114 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     214 records     214.0 rec/h
    last  3 h     510 records     170.0 rec/h
    last 12 h    1675 records     139.6 rec/h
    last 24 h    4075 records     169.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       7,266     212  GATED             GATED             barrier>=30
      279      11,764     214  GATED             GATED             barrier>=30
      340      14,814     214  GATED             GATED             barrier>=30
      403      17,964     214  GATED             GATED             barrier>=30
      568      26,214     214  GATED             GATED             barrier>=30
