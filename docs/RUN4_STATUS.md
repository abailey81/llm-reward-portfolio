...
**Auto-generated 2026-08-05 12:19 UTC -- T+183h10m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+183h10m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=5; worst streak 1/240 (0.4% to fatal), ops on core, 5.0 h ago; none live, newest failure 89 min ago** |
...
```
generated 2026-08-05 12:19 UTC | elapsed 7.63 d | 21.5 d to the Aug-27 stop
test tier: 15,048 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     112 records     112.0 rec/h
    last  3 h     384 records     128.0 rec/h
    last 12 h    1648 records     137.3 rec/h
    last 24 h    3899 records     162.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279      10,891      51  GATED             GATED             barrier>=30
      340      13,880     112  GATED             GATED             barrier>=30
      403      17,030     112  GATED             GATED             barrier>=30
      568      25,280     112  GATED             GATED             barrier>=30
