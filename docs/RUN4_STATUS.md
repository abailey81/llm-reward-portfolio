...
**Auto-generated 2026-08-03 01:34 UTC -- T+124h25m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+124h25m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **649** (286 running, 363 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1573 |
| scalar | g5 of 5 | 983 |
| placebo | g5 of 5 | 1153 |
...
```
2026-08-03T01:26:24Z  RED  records=6305 (+7)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=4.3m  drift=0  sci=OK  r115=21B  sweep=50.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T01:27:45Z  RED  records=6308 (+3)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=5.4m  drift=0  sci=OK  r115=21B  sweep=52.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
