...
**Auto-generated 2026-08-05 12:05 UTC -- T+182h57m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+182h57m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=5; worst streak 1/240 (0.4% to fatal), ops on core, 4.8 h ago; none live, newest failure 76 min ago** |
...
| | |
|---|---|
| cluster jobs | **975** (177 running, 798 queued) |
...
```
generated 2026-08-05 12:06 UTC | elapsed 7.62 d | 21.5 d to the Aug-27 stop
test tier: 15,037 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279      10,891      75  GATED             GATED             barrier>=30
      340      13,891     125  GATED             GATED             barrier>=30
      403      17,041     125  GATED             GATED             barrier>=30
      568      25,291     125  GATED             GATED             barrier>=30
