...
**Auto-generated 2026-08-06 06:35 UTC -- T+201h26m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+201h26m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **933** (92 running, 841 queued) |
| **cores computing** | **736** |
...
```
generated 2026-08-06 06:35 UTC | elapsed 8.39 d | 20.7 d to the Aug-27 stop
test tier: 17,355 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     128 records     128.0 rec/h
    last  3 h     276 records      92.0 rec/h
    last 12 h    1242 records     103.5 rec/h
    last 24 h    3365 records     140.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,912     128  GATED             GATED             barrier>=30
      279       9,960     128  GATED             GATED             barrier>=30
      340      12,705     128  GATED             GATED             barrier>=30
      403      15,540     128  GATED             GATED             barrier>=30
      568      22,973     128  GATED             GATED             barrier>=30
