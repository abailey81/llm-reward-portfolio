...
| **cores computing** | **848** |
| **cores doing RUNG-RAISING work** | **21.4%** -- 192 of 896 cores (31 min old) |
...
```
generated 2026-08-06 11:21 UTC | elapsed 8.59 d | 20.5 d to the Aug-27 stop
test tier: 17,594 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,721      60  GATED             GATED             barrier>=30
      340      12,466      60  GATED             GATED             barrier>=30
      403      15,301      60  GATED             GATED             barrier>=30
      568      22,734      60  GATED             GATED             barrier>=30
