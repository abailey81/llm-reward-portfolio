...
**Auto-generated 2026-08-05 13:19 UTC -- T+184h10m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+184h10m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 2.5 h ago; none live, newest failure 14 min ago** |
...
| | |
|---|---|
| cluster jobs | **965** (186 running, 779 queued) |
...
```
generated 2026-08-05 13:19 UTC | elapsed 7.67 d | 21.4 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     302 records     100.7 rec/h
    last 12 h    1583 records     131.9 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,824      54  GATED             GATED             barrier>=30
      403      16,974      54  GATED             GATED             barrier>=30
      568      25,224      54  GATED             GATED             barrier>=30
