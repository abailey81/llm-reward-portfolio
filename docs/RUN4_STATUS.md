...
| **cores computing** | **888** |
| **cores doing RUNG-RAISING work** | **20.3%** -- 184 of 904 cores (17 min old) |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,738     103  GATED             GATED             barrier>=30
      279       9,786     103  GATED             GATED             barrier>=30
      340      12,531     103  GATED             GATED             barrier>=30
      403      15,366     103  GATED             GATED             barrier>=30
      568      22,799     103  GATED             GATED             barrier>=30
