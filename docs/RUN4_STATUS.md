...
**Auto-generated 2026-08-11 20:48 UTC -- T+335h39m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+335h39m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **520** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (75 min old) |
...
```
generated 2026-08-11 20:48 UTC | elapsed 13.99 d | 15.1 d to the Aug-27 stop
test tier: 29,936 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,663      90  GATED             GATED             barrier>=279
      403       3,868      90  GATED             GATED             barrier>=279
      568      10,392      90  GATED             GATED             barrier>=279
