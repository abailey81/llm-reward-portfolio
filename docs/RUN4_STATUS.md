...
| **cores computing** | **904** |
| **cores doing RUNG-RAISING work** | **21.2%** -- 192 of 904 cores (19 min old) |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,721      35  GATED             GATED             barrier>=30
      279       9,769      35  GATED             GATED             barrier>=30
      340      12,514      35  GATED             GATED             barrier>=30
      403      15,349      35  GATED             GATED             barrier>=30
      568      22,782      35  GATED             GATED             barrier>=30
