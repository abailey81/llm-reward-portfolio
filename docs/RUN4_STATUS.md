...
**Auto-generated 2026-08-01 20:28 UTC -- T+95h19m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+95h19m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **92** (86 running, 6 queued) |
| **cores computing** | **688** |
...
```
 rung              @688 cores              @830 cores   binding
  ...
  189            7.9 d  08-05            6.5 d  08-04   throughput
  279           11.2 d  08-09            9.3 d  08-07   throughput
  340           13.4 d  08-11           11.1 d  08-09   throughput
  403           15.7 d  08-13           13.0 d  08-10   throughput
  568           21.8 d  08-19           18.1 d  08-15   throughput
```
...
```
2026-08-01T20:23:35Z  RED  records=2740 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=4.6m  drift=0  sci=OK  r115=19B  sweep=16.9s  auto-cycle
2026-08-01T20:24:22Z  RED  records=2740 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=19B  sweep=22.6s  auto-cycle
2026-08-01T20:25:14Z  RED  records=2740 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=19B  sweep=18.1s  auto-cycle
2026-08-01T20:26:03Z  RED  records=2740 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.0m  drift=0  sci=OK  r115=19B  sweep=17.7s  auto-cycle
2026-08-01T20:26:51Z  RED  records=2741 (+1)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=19B  sweep=14.8s  auto-cycle
2026-08-01T20:27:36Z  RED  records=2741 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=3.6m  drift=0  sci=OK  r115=19B  sweep=17.9s  auto-cycle
```
