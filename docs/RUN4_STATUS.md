...
**Auto-generated 2026-08-06 06:18 UTC -- T+201h09m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+201h09m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **939** (85 running, 854 queued) |
| **cores computing** | **680** |
...
```
generated 2026-08-06 06:19 UTC | elapsed 8.38 d | 20.7 d to the Aug-27 stop
test tier: 17,317 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     148 records     148.0 rec/h
    last  3 h     238 records      79.3 rec/h
    last 12 h    1255 records     104.6 rec/h
    last 24 h    3382 records     140.9 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,950     148  GATED             GATED             barrier>=30
      279       9,998     148  GATED             GATED             barrier>=30
      340      12,743     148  GATED             GATED             barrier>=30
      403      15,578     148  GATED             GATED             barrier>=30
      568      23,011     148  GATED             GATED             barrier>=30
