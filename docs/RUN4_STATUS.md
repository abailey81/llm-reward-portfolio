...
**Auto-generated 2026-08-05 14:58 UTC -- T+185h49m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+185h49m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 4.1 h ago; none live, newest failure 1.9 h ago** |
...
| | |
|---|---|
| cluster jobs | **929** (185 running, 744 queued) |
...
```
generated 2026-08-05 14:58 UTC | elapsed 7.74 d | 21.4 d to the Aug-27 stop
test tier: 15,440 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     244 records     244.0 rec/h
    last  3 h     411 records     137.0 rec/h
    last 12 h    1843 records     153.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,636      96  GATED             GATED             barrier>=30
      403      16,638     244  GATED             GATED             barrier>=30
      568      24,888     244  GATED             GATED             barrier>=30
