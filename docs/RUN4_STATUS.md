...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.5 h ago; none live, newest failure 29 min ago** |
...
```
generated 2026-08-06 00:33 UTC | elapsed 8.14 d | 21.0 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,718     150  GATED             GATED             barrier>=30
      189       6,284     196  GATED             GATED             barrier>=30
      279      10,332     198  GATED             GATED             barrier>=30
      340      13,077     198  GATED             GATED             barrier>=30
      403      15,912     198  GATED             GATED             barrier>=30
      568      23,345     198  GATED             GATED             barrier>=30
