...
**Auto-generated 2026-08-06 10:40 UTC -- T+205h31m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+205h31m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 10:40 UTC | elapsed 8.56 d | 20.6 d to the Aug-27 stop
test tier: 17,547 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,720      36  GATED             GATED             barrier>=30
      279       9,768      36  GATED             GATED             barrier>=30
      340      12,513      36  GATED             GATED             barrier>=30
      403      15,348      36  GATED             GATED             barrier>=30
      568      22,781      36  GATED             GATED             barrier>=30
