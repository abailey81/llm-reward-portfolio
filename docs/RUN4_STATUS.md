...
**Auto-generated 2026-08-05 08:15 UTC -- T+179h06m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+179h06m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 59 min ago; none live, newest failure 59 min ago** |
...
| | |
|---|---|
| cluster jobs | **897** (196 running, 701 queued) |
...
```
generated 2026-08-05 08:15 UTC | elapsed 7.46 d | 21.7 d to the Aug-27 stop
test tier: 14,415 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     279 records     279.0 rec/h
    last  3 h     760 records     253.3 rec/h
    last 12 h    1743 records     145.2 rec/h
    last 24 h    4086 records     170.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,184      52  GATED             GATED             barrier>=30
      189       7,189      61  GATED             GATED             barrier>=30
      279      11,463     279  GATED             GATED             barrier>=30
      340      14,513     279  GATED             GATED             barrier>=30
      403      17,663     279  GATED             GATED             barrier>=30
      568      25,913     279  GATED             GATED             barrier>=30
