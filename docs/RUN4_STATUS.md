...
**Auto-generated 2026-08-05 15:55 UTC -- T+186h46m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+186h46m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 5.1 h ago; none live, newest failure 2.8 h ago** |
...
| | |
|---|---|
| cluster jobs | **907** (183 running, 724 queued) |
...
```
generated 2026-08-05 15:56 UTC | elapsed 7.78 d | 21.3 d to the Aug-27 stop
test tier: 15,583 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      403      16,495     158  GATED             GATED             barrier>=30
      568      24,745     158  GATED             GATED             barrier>=30
...
2026-08-05T15:35:49Z  OK  records=17095 (+14)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=398.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T15:44:31Z  OK  records=17099 (+4)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.9m  drift=0  sci=OK  r115=22B  sweep=491.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
