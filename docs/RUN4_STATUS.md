...
**Auto-generated 2026-08-11 20:41 UTC -- T+335h32m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+335h32m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **424** = 64 running + **32 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
```
generated 2026-08-11 20:42 UTC | elapsed 13.98 d | 15.1 d to the Aug-27 stop
test tier: 29,929 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,670      91  GATED             GATED             barrier>=279
      403       3,875      91  GATED             GATED             barrier>=279
      568      10,399      91  GATED             GATED             barrier>=279
