...
**Auto-generated 2026-08-03 05:25 UTC -- T+128h16m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+128h16m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **957** (291 running, 666 queued) |
...
| scalar | g5 of 5 | 1138 |
| placebo | g5 of 5 | 1275 |
| scalar_cvar5 | g5 of 5 | 1238 |
| placebo_shuffled | g5 of 5 | 1251 |
...
2026-08-03T05:18:52Z  RED  records=7030 (+0)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.1m  drift=0  sci=OK  r115=21B  sweep=109.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T05:21:12Z  RED  records=7032 (+2)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=3.2m  drift=0  sci=OK  r115=21B  sweep=57.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T05:22:39Z  RED  records=7032 (+0)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.0m  drift=0  sci=OK  r115=21B  sweep=56.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T05:24:06Z  RED  records=7032 (+0)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=21B  cores=2328  sweep=103.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
