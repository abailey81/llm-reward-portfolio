...
**Auto-generated 2026-08-05 00:06 UTC -- T+170h57m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+170h57m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 1.6 h ago; none live, newest failure 30 min ago** |
...
| | |
|---|---|
| cluster jobs | **968** (168 running, 798 queued) |
...
```
generated 2026-08-05 00:06 UTC | elapsed 7.12 d | 22.0 d to the Aug-27 stop
test tier: 13,370 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     160 records     160.0 rec/h
    last  3 h     466 records     155.3 rec/h
    last 12 h    2255 records     187.9 rec/h
    last 24 h    4230 records     176.2 rec/h
    12 h rate is 57% from ONE line (test_leg_sonnet_5); 10 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      26,958     160  GATED             GATED             barrier>=30
