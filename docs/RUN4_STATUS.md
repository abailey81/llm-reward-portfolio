...
**Auto-generated 2026-08-06 22:57 UTC -- T+217h48m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+217h48m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 11/240 (4.6% to fatal), pull on kimi-k3, 6.0 h ago; none live, newest failure 6.0 h ago** |
...
| | |
|---|---|
| cluster jobs | **833** = 106 running + **181 ELIGIBLE** + 546 held by us + 0 held only by the site |
...
| **cores computing** | **848** |
| **cores doing RUNG-RAISING work** | **32.1%** -- 272 of 848 cores (78 min old) |
...
```
generated 2026-08-06 22:58 UTC | elapsed 9.08 d | 20.0 d to the Aug-27 stop
