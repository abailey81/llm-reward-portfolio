...
**Auto-generated 2026-08-05 11:42 UTC -- T+182h33m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+182h33m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=5; worst streak 1/240 (0.4% to fatal), ops on core, 4.4 h ago; none live, newest failure 53 min ago** |
...
```
generated 2026-08-05 11:43 UTC | elapsed 7.61 d | 21.5 d to the Aug-27 stop
test tier: 14,983 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     112 records     112.0 rec/h
    last  3 h     441 records     147.0 rec/h
    last 12 h    1669 records     139.1 rec/h
    last 24 h    3906 records     162.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,841       5  GATED             GATED             barrier>=30
      279      10,899     108  GATED             GATED             barrier>=30
      340      13,945     112  GATED             GATED             barrier>=30
      403      17,095     112  GATED             GATED             barrier>=30
      568      25,345     112  GATED             GATED             barrier>=30
