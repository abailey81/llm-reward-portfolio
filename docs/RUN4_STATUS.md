...
**Auto-generated 2026-08-11 19:37 UTC -- T+334h28m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+334h28m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **512** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (4 min old) |
...
```
generated 2026-08-11 19:38 UTC | elapsed 13.94 d | 15.2 d to the Aug-27 stop
test tier: 29,833 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,766      46  GATED             GATED             barrier>=279
      403       3,971      46  GATED             GATED             barrier>=279
      568      10,495      46  GATED             GATED             barrier>=279
