...
```
generated 2026-08-06 02:31 UTC | elapsed 8.22 d | 20.9 d to the Aug-27 stop
test tier: 17,073 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,630      61  GATED             GATED             barrier>=30
      189       6,194      61  GATED             GATED             barrier>=30
      279      10,242      61  GATED             GATED             barrier>=30
      340      12,987      61  GATED             GATED             barrier>=30
      403      15,822      61  GATED             GATED             barrier>=30
      568      23,255      61  GATED             GATED             barrier>=30
