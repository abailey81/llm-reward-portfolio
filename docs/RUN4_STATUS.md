...
**Auto-generated 2026-08-05 06:37 UTC -- T+177h28m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+177h28m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **946** (208 running, 738 queued) |
...
```
generated 2026-08-05 06:38 UTC | elapsed 7.40 d | 21.7 d to the Aug-27 stop
test tier: 13,999 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     250 records     250.0 rec/h
    last  3 h     395 records     131.7 rec/h
    last 12 h    1660 records     138.3 rec/h
    last 24 h    4040 records     168.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       7,379     250  GATED             GATED             barrier>=30
      279      11,879     250  GATED             GATED             barrier>=30
      340      14,929     250  GATED             GATED             barrier>=30
      403      18,079     250  GATED             GATED             barrier>=30
      568      26,329     250  GATED             GATED             barrier>=30
