...
**Auto-generated 2026-08-05 18:47 UTC -- T+189h38m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+189h38m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.7 h ago; none live, newest failure 5.7 h ago** |
...
| | |
|---|---|
| cluster jobs | **838** (124 running, 714 queued) |
| **cores computing** | **992** |
...
```
generated 2026-08-05 18:48 UTC | elapsed 7.90 d | 21.2 d to the Aug-27 stop
test tier: 16,130 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     183 records     183.0 rec/h
    last  3 h     563 records     187.7 rec/h
    last 12 h    2091 records     174.2 rec/h
    last 24 h    3763 records     156.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      24,198     183  GATED             GATED             barrier>=30
...
2026-08-05T18:35:37Z  OK  records=17649 (+15)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.2m  drift=0  sci=OK  r115=22B  sweep=339.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T18:47:22Z  ATTN  records=17661 (+12)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  cores=992  sweep=674.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
