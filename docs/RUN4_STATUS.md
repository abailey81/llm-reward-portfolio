...
**Auto-generated 2026-08-04 22:33 UTC -- T+169h24m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+169h24m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 4 min ago; LIVE, still failing** |
...
```
generated 2026-08-04 22:34 UTC | elapsed 7.06 d | 22.1 d to the Aug-27 stop
test tier: 13,086 records over 68 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      97 records      97.0 rec/h
    last  3 h     554 records     184.7 rec/h
    last 12 h    2188 records     182.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,343      27  GATED             GATED             barrier>=30
      189       7,793      27  GATED             GATED             barrier>=30
      279      12,293      27  GATED             GATED             barrier>=30
      340      15,343      27  GATED             GATED             barrier>=30
      403      18,493      27  GATED             GATED             barrier>=30
      568      27,242      97  GATED             GATED             barrier>=30
