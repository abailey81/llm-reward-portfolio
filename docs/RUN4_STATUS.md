...
**Auto-generated 2026-08-07 00:32 UTC -- T+219h23m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+219h23m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **880** |
| **cores doing RUNG-RAISING work** | **33.6%** -- 288 of 856 cores (52 min old) |
...
test tier: 18,440 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,500      10  GATED             GATED             no-records:test/distributional,test/scalar>=30
      189       5,615      10  GATED             GATED             no-records:test/distributional,test/scalar>=30
      279       9,145      10  GATED             GATED             no-records:test/distributional,test/scalar>=30
      340      11,620      13  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,455      13  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,888      13  GATED             GATED             no-records:test/distributional,test/scalar>=30
