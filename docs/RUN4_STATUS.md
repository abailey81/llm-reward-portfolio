...
**Auto-generated 2026-08-01 10:54 UTC -- T+85h45m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+85h45m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **2334** |
| LLM calls / spend | 2833 / **$44.2440** |
...
| | |
|---|---|
| cluster jobs | **124** (123 running, 0 queued) |
| **cores computing** | **984** |
...
```
 rung              @984 cores              @830 cores   binding
  ...
  189            5.5 d  08-03            6.5 d  08-04   throughput
  279            7.8 d  08-05            9.3 d  08-07   throughput
  340            9.4 d  08-07           11.1 d  08-09   throughput
  403           11.0 d  08-08           13.0 d  08-10   throughput
  568           15.2 d  08-13           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 879 |
| scalar | g5 of 5 | 296 |
| placebo | g5 of 5 | 273 |
| scalar_cvar5 | g5 of 5 | 257 |
| placebo_shuffled | g5 of 5 | 238 |
...
```
2026-08-01T10:49:44Z  RED  records=2333 (+1)  spend=$44.2439  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=17B  sweep=16.8s  auto-cycle
2026-08-01T10:50:31Z  RED  records=2333 (+0)  spend=$44.2439  guards=2  arms_full=10/10  budget=2  stalest=0.6m  drift=0  sci=OK  r115=17B  sweep=17.6s  auto-cycle
2026-08-01T10:51:19Z  RED  records=2333 (+0)  spend=$44.2439  guards=2  arms_full=10/10  budget=2  stalest=1.2m  drift=0  sci=OK  r115=17B  sweep=21.8s  auto-cycle
2026-08-01T10:52:11Z  RED  records=2334 (+1)  spend=$44.2439  guards=2  arms_full=10/10  budget=2  stalest=2.0m  drift=0  sci=OK  r115=17B  sweep=17.0s  auto-cycle
2026-08-01T10:52:58Z  RED  records=2334 (+0)  spend=$44.2439  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=17B  cores=952  sweep=33.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-01T10:54:02Z  RED  records=2334 (+0)  spend=$44.2439  guards=2  arms_full=10/10  budget=2  stalest=0.7m  drift=0  sci=OK  r115=17B  sweep=17.4s  auto-cycle
```
...
```
  anthropic   spent $ 35.9845  + still to author $  2.3618  = $ 38.3463   credited $ 28.1500   margin $ -10.1963 (-36%)  over the credit ESTIMATE (owner-watched)
  openrouter  spent $  8.2595  + still to author $  1.0996  = $  9.3590   credited $ 19.3100   margin $  +9.9510 (+52%)  comfortable
```
