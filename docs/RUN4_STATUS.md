...
**Auto-generated 2026-08-05 13:08 UTC -- T+183h59m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+183h59m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 13:09 UTC | elapsed 7.67 d | 21.5 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     328 records     109.3 rec/h
    last 12 h    1590 records     132.5 rec/h
    last 24 h    3779 records     157.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,837      49  GATED             GATED             barrier>=30
      403      16,987      49  GATED             GATED             barrier>=30
      568      25,237      49  GATED             GATED             barrier>=30
