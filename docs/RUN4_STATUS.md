...
**Auto-generated 2026-08-05 08:12 UTC -- T+179h03m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+179h03m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 56 min ago; none live, newest failure 56 min ago** |
...
| | |
|---|---|
| cluster jobs | **899** (198 running, 701 queued) |
...
```
generated 2026-08-05 08:12 UTC | elapsed 7.46 d | 21.7 d to the Aug-27 stop
test tier: 14,392 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,201      35  GATED             GATED             barrier>=30
      189       7,206      51  GATED             GATED             barrier>=30
      279      11,486     267  GATED             GATED             barrier>=30
      340      14,536     267  GATED             GATED             barrier>=30
      403      17,686     267  GATED             GATED             barrier>=30
      568      25,936     267  GATED             GATED             barrier>=30
