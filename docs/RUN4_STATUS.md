...
**Auto-generated 2026-08-05 01:29 UTC -- T+172h20m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+172h20m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 3.0 h ago; none live, newest failure 1.9 h ago** |
...
| | |
|---|---|
| cluster jobs | **946** (175 running, 769 queued) |
...
```
generated 2026-08-05 01:30 UTC | elapsed 7.18 d | 21.9 d to the Aug-27 stop
test tier: 13,536 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     110 records     110.0 rec/h
    last  3 h     457 records     152.3 rec/h
    last 12 h    2185 records     182.1 rec/h
    last 24 h    4258 records     177.4 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,335       5  GATED             GATED             barrier>=30
      189       7,785       5  GATED             GATED             barrier>=30
      279      12,285       5  GATED             GATED             barrier>=30
      340      15,335       5  GATED             GATED             barrier>=30
      403      18,485       5  GATED             GATED             barrier>=30
      568      26,792     110  GATED             GATED             barrier>=30
