...
**Auto-generated 2026-08-04 18:04 UTC -- T+164h56m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+164h56m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 21/240 (8.8% to fatal), pull on core, 5.6 h ago; none live, newest failure 2.3 h ago** |
...
```
generated 2026-08-04 18:05 UTC | elapsed 6.87 d | 22.2 d to the Aug-27 stop
test tier: 12,230 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      28,098     266  GATED             GATED             barrier>=30
