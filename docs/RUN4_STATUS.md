...
**Auto-generated 2026-08-11 19:59 UTC -- T+334h50m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+334h50m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **488** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (26 min old) |
...
```
generated 2026-08-11 20:00 UTC | elapsed 13.95 d | 15.2 d to the Aug-27 stop
test tier: 29,862 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 115.6 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h    1387 records     115.6 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,737      68  GATED             GATED             barrier>=279
      403       3,942      68  GATED             GATED             barrier>=279
      568      10,466      68  GATED             GATED             barrier>=279
