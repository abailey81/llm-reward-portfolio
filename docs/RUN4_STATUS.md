...
**Auto-generated 2026-08-06 05:39 UTC -- T+200h30m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h30m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 05:40 UTC | elapsed 8.36 d | 20.8 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    3475 records     144.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,570      14  GATED             GATED             barrier>=30
      189       6,029     118  GATED             GATED             barrier>=30
      279      10,077     118  GATED             GATED             barrier>=30
      340      12,822     118  GATED             GATED             barrier>=30
      403      15,657     118  GATED             GATED             barrier>=30
      568      23,090     118  GATED             GATED             barrier>=30
