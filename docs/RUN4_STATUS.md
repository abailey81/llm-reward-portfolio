...
**Auto-generated 2026-08-11 18:09 UTC -- T+333h00m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+333h00m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on core, 5.6 h ago; none live, newest failure 29 min ago** |
...
| | |
|---|---|
| cluster jobs | **450** = 63 running + **59 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **504** |
| **cores doing RUNG-RAISING work** | **4.8%** -- 24 of 504 cores (36 min old) |
...
```
generated 2026-08-11 18:10 UTC | elapsed 13.88 d | 15.2 d to the Aug-27 stop
test tier: 29,740 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 125.8 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h    1509 records     125.8 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279         128       3  GATED             GATED             barrier
      340       1,859     100  GATED             GATED             barrier>=279
      403       4,064     100  GATED             GATED             barrier>=279
      568      10,588     100  GATED             GATED             barrier>=279
...
```
2026-08-11T18:01:44Z  OK  records=31267 (+40)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.3m  drift=0  sci=OK  r115=22B  cores=520  sweep=483.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T18:03:10Z  OK  records=31272 (+5)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.0m  drift=0  sci=OK  r115=22B  sweep=55.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T18:04:31Z  OK  records=31272 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.3m  drift=0  sci=OK  r115=22B  sweep=51.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T18:06:00Z  OK  records=31274 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  sweep=58.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T18:07:25Z  OK  records=31274 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.2m  drift=0  sci=OK  r115=22B  sweep=54.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T18:08:46Z  OK  records=31274 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=51.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
