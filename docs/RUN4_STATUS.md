...
**Auto-generated 2026-08-06 07:31 UTC -- T+202h22m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+202h22m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 07:32 UTC | elapsed 8.43 d | 20.7 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    3146 records     131.1 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,908       8  GATED             GATED             barrier>=30
      279       9,956       8  GATED             GATED             barrier>=30
      340      12,701       8  GATED             GATED             barrier>=30
      403      15,536       8  GATED             GATED             barrier>=30
      568      22,969       8  GATED             GATED             barrier>=30
