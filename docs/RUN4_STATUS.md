...
**Auto-generated 2026-08-11 20:00 UTC -- T+334h51m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+334h51m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on deepseek-v4-pro, 2.3 h ago; none live, newest failure 2.3 h ago** |
...
| **cores computing** | **480** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (27 min old) |
...
```
generated 2026-08-11 20:01 UTC | elapsed 13.95 d | 15.2 d to the Aug-27 stop
test tier: 29,864 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 115.5 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h    1386 records     115.5 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,735      70  GATED             GATED             barrier>=279
      403       3,940      70  GATED             GATED             barrier>=279
      568      10,464      70  GATED             GATED             barrier>=279
