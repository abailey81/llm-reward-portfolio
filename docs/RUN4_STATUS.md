...
**Auto-generated 2026-08-01 21:21 UTC -- T+96h12m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+96h12m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **86** (80 running, 6 queued) |
| **cores computing** | **640** |
...
```
 rung              @640 cores              @830 cores   binding
  ...
  100            5.0 d  08-02            4.6 d  08-02   critical_chain
  189            8.5 d  08-06            6.5 d  08-04   throughput
  279           12.0 d  08-09            9.3 d  08-07   throughput
  340           14.4 d  08-12           11.1 d  08-09   throughput
  403           16.9 d  08-14           13.0 d  08-10   throughput
  568           23.4 d  08-21           18.1 d  08-15   throughput
```
...
```
2026-08-01T21:18:04Z  RED  records=2781 (+2)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=3.5m  drift=0  sci=OK  r115=19B  sweep=16.7s  auto-cycle
2026-08-01T21:18:50Z  RED  records=2782 (+1)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=4.3m  drift=0  sci=OK  r115=19B  sweep=18.0s  auto-cycle
2026-08-01T21:19:39Z  RED  records=2786 (+4)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=19B  cores=648  sweep=19.4s  auto-cycle
2026-08-01T21:20:28Z  RED  records=2786 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=19B  sweep=18.2s  auto-cycle
2026-08-01T21:21:17Z  RED  records=2788 (+2)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=19B  sweep=17.7s  auto-cycle
2026-08-01T21:22:05Z  RED  records=2789 (+1)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=19B  sweep=14.2s  auto-cycle
```
