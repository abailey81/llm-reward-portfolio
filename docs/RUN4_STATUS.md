...
```
generated 2026-08-06 10:37 UTC | elapsed 8.56 d | 20.6 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,721      38  GATED             GATED             barrier>=30
      279       9,769      38  GATED             GATED             barrier>=30
      340      12,514      38  GATED             GATED             barrier>=30
      403      15,349      38  GATED             GATED             barrier>=30
      568      22,782      38  GATED             GATED             barrier>=30
