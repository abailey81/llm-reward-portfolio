...
**Auto-generated 2026-08-05 05:54 UTC -- T+176h45m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+176h45m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 52 min ago; none live, newest failure 52 min ago** |
...
| | |
|---|---|
| cluster jobs | **967** (209 running, 758 queued) |
...
```
generated 2026-08-05 05:54 UTC | elapsed 7.37 d | 21.8 d to the Aug-27 stop
test tier: 13,834 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,238      70  GATED             GATED             barrier>=30
      189       7,544     214  GATED             GATED             barrier>=30
      279      12,044     214  GATED             GATED             barrier>=30
      340      15,094     214  GATED             GATED             barrier>=30
      403      18,244     214  GATED             GATED             barrier>=30
      568      26,494     214  GATED             GATED             barrier>=30
