...
| | |
|---|---|
| cluster jobs | **771** (92 running, 679 queued) |
| **cores computing** | **736** |
...
```
generated 2026-08-05 23:17 UTC | elapsed 8.09 d | 21.0 d to the Aug-27 stop
test tier: 16,710 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
