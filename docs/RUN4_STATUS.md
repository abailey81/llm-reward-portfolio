...
**Auto-generated 2026-08-05 01:50 UTC -- T+172h41m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+172h41m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 01:50 UTC | elapsed 7.20 d | 21.9 d to the Aug-27 stop
test tier: 13,568 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     106 records     106.0 rec/h
    last  3 h     422 records     140.7 rec/h
    last 12 h    2164 records     180.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,327      13  GATED             GATED             barrier>=30
      189       7,777      13  GATED             GATED             barrier>=30
      279      12,277      13  GATED             GATED             barrier>=30
      340      15,327      13  GATED             GATED             barrier>=30
      403      18,477      13  GATED             GATED             barrier>=30
      568      26,760     106  GATED             GATED             barrier>=30
