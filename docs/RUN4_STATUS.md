...
| | |
|---|---|
| elapsed | **T+196h38m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 01:47 UTC | elapsed 8.19 d | 20.9 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,672      40  GATED             GATED             barrier>=30
      189       6,236      40  GATED             GATED             barrier>=30
      279      10,284      40  GATED             GATED             barrier>=30
      340      13,029      40  GATED             GATED             barrier>=30
      403      15,864      40  GATED             GATED             barrier>=30
      568      23,297      40  GATED             GATED             barrier>=30
