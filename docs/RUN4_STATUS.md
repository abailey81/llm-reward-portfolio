...
**Auto-generated 2026-08-01 23:26 UTC -- T+98h17m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+98h17m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **71** (64 running, 7 queued) |
| **cores computing** | **512** |
...
```
 rung              @512 cores              @830 cores   binding
  ...
  100            6.2 d  08-04            4.6 d  08-02   critical_chain
  189           10.6 d  08-08            6.5 d  08-04   throughput
  279           15.0 d  08-12            9.3 d  08-07   throughput
  340           18.0 d  08-15           11.1 d  08-09   throughput
  403           21.2 d  08-19           13.0 d  08-10   throughput
  568        29.3 d  08-27  X           18.1 d  08-15   throughput
```
...
```
2026-08-01T23:21:26Z  RED  records=2928 (+0)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0  sci=OK  r115=19B  sweep=17.2s  auto-cycle
2026-08-01T23:22:13Z  RED  records=2928 (+0)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=19B  sweep=18.1s  auto-cycle
2026-08-01T23:23:02Z  RED  records=2929 (+1)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=19B  sweep=18.8s  auto-cycle
2026-08-01T23:23:51Z  RED  records=2929 (+0)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=19B  sweep=26.2s  auto-cycle
2026-08-01T23:24:47Z  RED  records=2930 (+1)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=3.8m  drift=0  sci=OK  r115=19B  cores=512  sweep=19.5s  auto-cycle
2026-08-01T23:25:37Z  RED  records=2931 (+1)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=19B  sweep=25.9s  auto-cycle
```
