...
**Auto-generated 2026-08-05 01:14 UTC -- T+172h05m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+172h05m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 01:15 UTC | elapsed 7.17 d | 21.9 d to the Aug-27 stop
test tier: 13,514 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     121 records     121.0 rec/h
    last  3 h     465 records     155.0 rec/h
    last 12 h    2193 records     182.8 rec/h
    last 24 h    4256 records     177.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,338       2  GATED             GATED             barrier>=30
      189       7,788       2  GATED             GATED             barrier>=30
      279      12,288       2  GATED             GATED             barrier>=30
      340      15,338       2  GATED             GATED             barrier>=30
      403      18,488       2  GATED             GATED             barrier>=30
      568      26,814     121  GATED             GATED             barrier>=30
