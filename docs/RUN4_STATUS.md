...
**Auto-generated 2026-08-06 02:44 UTC -- T+197h35m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+197h35m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 2.7 h ago; none live, newest failure 2.7 h ago** |
...
```
generated 2026-08-06 02:44 UTC | elapsed 8.23 d | 20.9 d to the Aug-27 stop
test tier: 17,076 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    12 h rate is 62% from ONE line (test_leg_haiku_4_5); 4 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 62% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_haiku_4_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,627      45  GATED             GATED             barrier>=30
      189       6,191      45  GATED             GATED             barrier>=30
      279      10,239      45  GATED             GATED             barrier>=30
      340      12,984      45  GATED             GATED             barrier>=30
      403      15,819      45  GATED             GATED             barrier>=30
      568      23,252      45  GATED             GATED             barrier>=30
...
```
2026-08-06T02:25:44Z  OK  records=18611 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  sweep=28.1s  auto-cycle
2026-08-06T02:26:42Z  OK  records=18611 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.2m  drift=0  sci=OK  r115=22B  sweep=27.2s  auto-cycle
2026-08-06T02:27:42Z  OK  records=18613 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=30.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T02:35:11Z  OK  records=18613 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.1m  drift=0  sci=OK  r115=22B  sweep=419.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T02:43:20Z  OK  records=18619 (+6)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  cores=536  sweep=459.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T02:44:18Z  OK  records=18619 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=0.8m  drift=0  sci=OK  r115=22B  sweep=27.7s  auto-cycle
```
