...
**Auto-generated 2026-08-06 01:53 UTC -- T+196h44m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+196h44m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
test tier: 17,040 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,663      43  GATED             GATED             barrier>=30
      189       6,227      43  GATED             GATED             barrier>=30
      279      10,275      43  GATED             GATED             barrier>=30
      340      13,020      43  GATED             GATED             barrier>=30
      403      15,855      43  GATED             GATED             barrier>=30
      568      23,288      43  GATED             GATED             barrier>=30
