...
**Auto-generated 2026-08-05 02:11 UTC -- T+173h02m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+173h02m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 02:12 UTC | elapsed 7.21 d | 21.9 d to the Aug-27 stop
test tier: 13,585 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      77 records      77.0 rec/h
    last  3 h     356 records     118.7 rec/h
    last 12 h    2100 records     175.0 rec/h
    last 24 h    4215 records     175.6 rec/h
    12 h rate is 44% from ONE line (test_leg_sonnet_5); 10 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 67% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_sonnet_5, test_leg_qwen3_5_9b) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,325      14  GATED             GATED             barrier>=30
      189       7,775      14  GATED             GATED             barrier>=30
      279      12,275      14  GATED             GATED             barrier>=30
      340      15,325      14  GATED             GATED             barrier>=30
      403      18,475      14  GATED             GATED             barrier>=30
      568      26,743      77  GATED             GATED             barrier>=30
