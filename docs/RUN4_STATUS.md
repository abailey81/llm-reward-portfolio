...
**Auto-generated 2026-08-05 19:17 UTC -- T+190h08m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+190h08m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 14 min ago; none live, newest failure 14 min ago** |
...
```
generated 2026-08-05 19:18 UTC | elapsed 7.92 d | 21.2 d to the Aug-27 stop
test tier: 16,177 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     118 records     118.0 rec/h
    last  3 h     531 records     177.0 rec/h
    last 12 h    2034 records     169.5 rec/h
    last 24 h    3700 records     154.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      24,151     118  GATED             GATED             barrier>=30
...
2026-08-05T19:20:12Z  OK  records=17720 (+7)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=0.5m  drift=0  sci=OK  r115=22B  sweep=261.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
