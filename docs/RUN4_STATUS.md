...
**Auto-generated 2026-08-06 09:53 UTC -- T+204h44m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+204h44m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **904** |
| **cores doing RUNG-RAISING work** | **20.3%** -- 184 of 904 cores (2 min old) |
...
```
generated 2026-08-06 09:53 UTC | elapsed 8.53 d | 20.6 d to the Aug-27 stop
test tier: 17,521 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    12 h rate is 70% from ONE line (test_leg_kimi_k3); 4 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,746     123  GATED             GATED             barrier>=30
      279       9,794     123  GATED             GATED             barrier>=30
      340      12,539     123  GATED             GATED             barrier>=30
      403      15,374     123  GATED             GATED             barrier>=30
      568      22,807     123  GATED             GATED             barrier>=30
