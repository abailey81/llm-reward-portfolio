...
**Auto-generated 2026-08-01 06:47 UTC -- T+81h38m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+81h38m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **136** (122 running, 14 queued) |
| **cores computing** | **976** |
...
|---|---|---|
| distributional | g5 of 5 | 814 |
| scalar | g5 of 5 | 296 |
| placebo | g5 of 5 | 248 |
| scalar_cvar5 | g5 of 5 | 227 |
| placebo_shuffled | g5 of 5 | 183 |
...
```
2026-08-01T06:43:43Z  RED  records=2152 (+2)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=14B  cores=992  sweep=17.3s  auto-cycle
2026-08-01T06:44:31Z  RED  records=2153 (+1)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=1.2m  drift=0  sci=OK  r115=14B  sweep=15.7s  auto-cycle
2026-08-01T06:45:16Z  RED  records=2153 (+0)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=2.0m  drift=0  sci=OK  r115=14B  sweep=15.6s  auto-cycle
2026-08-01T06:46:02Z  RED  records=2155 (+2)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=14B  sweep=15.0s  auto-cycle
2026-08-01T06:46:47Z  RED  records=2156 (+1)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=14B  sweep=11.6s  auto-cycle
2026-08-01T06:47:29Z  RED  records=2158 (+2)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0  sci=OK  r115=14B  sweep=16.2s  auto-cycle
```
