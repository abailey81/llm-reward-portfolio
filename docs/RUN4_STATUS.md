...
**Auto-generated 2026-08-03 10:19 UTC -- T+133h10m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+133h10m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **807** (187 running, 620 queued) |
...
```
 rung             @1496 cores              @830 cores   binding
  ...
  279            5.1 d  08-03            9.3 d  08-07   throughput
  340            6.2 d  08-04           11.1 d  08-09   throughput
  403            7.2 d  08-05           13.0 d  08-10   throughput
  568           10.0 d  08-07           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 1995 |
| scalar | g5 of 5 | 1412 |
| placebo | g5 of 5 | 1516 |
| scalar_cvar5 | g5 of 5 | 1491 |
| placebo_shuffled | g5 of 5 | 1508 |
...
```
2026-08-03T10:01:16Z  RED  records=8186 (+18)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=21B  sweep=159.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T10:04:26Z  RED  records=8215 (+29)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=21B  sweep=209.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T10:08:25Z  RED  records=8233 (+18)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=1.6m  drift=0  sci=OK  r115=21B  sweep=80.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
