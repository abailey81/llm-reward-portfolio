...
**Auto-generated 2026-08-05 05:32 UTC -- T+176h23m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+176h23m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 30 min ago; none live, newest failure 30 min ago** |
...
| | |
|---|---|
| cluster jobs | **982** (205 running, 777 queued) |
...
```
generated 2026-08-05 05:32 UTC | elapsed 7.35 d | 21.8 d to the Aug-27 stop
test tier: 13,708 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     103 records     103.0 rec/h
    last  3 h     116 records      38.7 rec/h
    last 12 h    1638 records     136.5 rec/h
    last 24 h    3891 records     162.1 rec/h
    12 h rate is 37% from ONE line (test_leg_qwen3_5_9b); 10 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 58% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,240      83  GATED             GATED             barrier>=30
      189       7,670     103  GATED             GATED             barrier>=30
      279      12,170     103  GATED             GATED             barrier>=30
      340      15,220     103  GATED             GATED             barrier>=30
      403      18,370     103  GATED             GATED             barrier>=30
      568      26,620     103  GATED             GATED             barrier>=30
...
```
2026-08-05T05:00:41Z  OK  records=15165 (+5)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  sweep=338.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T05:05:43Z  OK  records=15171 (+6)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  sweep=272.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T05:09:58Z  OK  records=15181 (+10)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.5m  drift=0  sci=OK  r115=22B  cores=1576  sweep=224.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
