...
**Auto-generated 2026-08-06 07:22 UTC -- T+202h13m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+202h13m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 07:23 UTC | elapsed 8.43 d | 20.7 d to the Aug-27 stop
test tier: 17,359 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      29 records      29.0 rec/h
    last  3 h     248 records      82.7 rec/h
    last 12 h    1178 records      98.2 rec/h
    last 24 h    3193 records     133.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,908      29  GATED             GATED             barrier>=30
      279       9,956      29  GATED             GATED             barrier>=30
      340      12,701      29  GATED             GATED             barrier>=30
      403      15,536      29  GATED             GATED             barrier>=30
      568      22,969      29  GATED             GATED             barrier>=30
