...
**Auto-generated 2026-08-06 03:41 UTC -- T+198h32m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+198h32m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 03:41 UTC | elapsed 8.27 d | 20.8 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,624       3  GATED             GATED             barrier>=30
      189       6,188       3  GATED             GATED             barrier>=30
      279      10,236       3  GATED             GATED             barrier>=30
      340      12,981       3  GATED             GATED             barrier>=30
      403      15,816       3  GATED             GATED             barrier>=30
      568      23,249       3  GATED             GATED             barrier>=30
