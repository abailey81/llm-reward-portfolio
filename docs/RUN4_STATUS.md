...
**Auto-generated 2026-08-05 01:18 UTC -- T+172h09m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+172h09m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 2.8 h ago; none live, newest failure 1.7 h ago** |
...
| | |
|---|---|
| cluster jobs | **947** (172 running, 773 queued) |
...
```
generated 2026-08-05 01:18 UTC | elapsed 7.17 d | 21.9 d to the Aug-27 stop
test tier: 13,517 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     119 records     119.0 rec/h
    last  3 h     467 records     155.7 rec/h
    last 12 h    2191 records     182.6 rec/h
    last 24 h    4255 records     177.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,337       3  GATED             GATED             barrier>=30
      189       7,787       3  GATED             GATED             barrier>=30
      279      12,287       3  GATED             GATED             barrier>=30
      340      15,337       3  GATED             GATED             barrier>=30
      403      18,487       3  GATED             GATED             barrier>=30
      568      26,811     119  GATED             GATED             barrier>=30
