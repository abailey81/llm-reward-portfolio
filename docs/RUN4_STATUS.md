...
```
generated 2026-08-06 05:25 UTC | elapsed 8.34 d | 20.8 d to the Aug-27 stop
test tier: 17,193 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,074      82  GATED             GATED             barrier>=30
      279      10,122      82  GATED             GATED             barrier>=30
      340      12,867      82  GATED             GATED             barrier>=30
      403      15,702      82  GATED             GATED             barrier>=30
      568      23,135      82  GATED             GATED             barrier>=30
