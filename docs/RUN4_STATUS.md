...
**Auto-generated 2026-08-06 06:03 UTC -- T+200h54m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h54m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
test tier: 17,287 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     139 records     139.0 rec/h
    last  3 h     209 records      69.7 rec/h
    last 12 h    1282 records     106.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,980     139  GATED             GATED             barrier>=30
      279      10,028     139  GATED             GATED             barrier>=30
      340      12,773     139  GATED             GATED             barrier>=30
      403      15,608     139  GATED             GATED             barrier>=30
      568      23,041     139  GATED             GATED             barrier>=30
