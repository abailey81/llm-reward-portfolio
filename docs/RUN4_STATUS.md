...
**Auto-generated 2026-08-05 01:57 UTC -- T+172h48m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+172h48m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **943** (175 running, 767 queued) |
...
```
generated 2026-08-05 01:57 UTC | elapsed 7.20 d | 21.9 d to the Aug-27 stop
test tier: 13,574 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      99 records      99.0 rec/h
    last  3 h     406 records     135.3 rec/h
    last 12 h    2149 records     179.1 rec/h
    last 24 h    4231 records     176.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      26,754      99  GATED             GATED             barrier>=30
