...
**Auto-generated 2026-08-06 06:34 UTC -- T+201h25m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+201h25m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **934** (93 running, 841 queued) |
| **cores computing** | **744** |
...
```
generated 2026-08-06 06:34 UTC | elapsed 8.39 d | 20.7 d to the Aug-27 stop
test tier: 17,353 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,914     128  GATED             GATED             barrier>=30
      279       9,962     128  GATED             GATED             barrier>=30
      340      12,707     128  GATED             GATED             barrier>=30
      403      15,542     128  GATED             GATED             barrier>=30
      568      22,975     128  GATED             GATED             barrier>=30
