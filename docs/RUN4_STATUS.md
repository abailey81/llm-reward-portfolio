...
**Auto-generated 2026-08-05 17:55 UTC -- T+188h46m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+188h46m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=2; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 4.8 h ago; none live, newest failure 4.8 h ago** |
...
| | |
|---|---|
| cluster jobs | **861** (147 running, 714 queued) |
...
```
generated 2026-08-05 17:55 UTC | elapsed 7.87 d | 21.3 d to the Aug-27 stop
test tier: 15,969 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     183 records     183.0 rec/h
    last  3 h     546 records     182.0 rec/h
    last 12 h    2130 records     177.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      24,359     183  GATED             GATED             barrier>=30
