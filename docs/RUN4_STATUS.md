...
**Auto-generated 2026-08-01 15:15 UTC -- T+90h06m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+90h06m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **2494** |
| LLM calls / spend | 2923 / **$45.3722** |
...
| | |
|---|---|
| cluster jobs | **117** (105 running, 11 queued) |
| **cores computing** | **840** |
...
```
 rung              @840 cores              @830 cores   binding
  ...
  340           11.0 d  08-08           11.1 d  08-09   throughput
  403           12.9 d  08-10           13.0 d  08-10   throughput
  568           17.9 d  08-15           18.1 d  08-15   throughput
```
...
| scalar | g5 of 5 | 326 |
| placebo | g5 of 5 | 308 |
| scalar_cvar5 | g5 of 5 | 283 |
| placebo_shuffled | g5 of 5 | 279 |
...
```
2026-08-01T15:10:47Z  RED  records=2491 (+0)  spend=$45.3721  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=17B  sweep=22.3s  auto-cycle
2026-08-01T15:11:40Z  RED  records=2492 (+1)  spend=$45.3721  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=17B  sweep=16.8s  auto-cycle
2026-08-01T15:12:27Z  RED  records=2492 (+0)  spend=$45.3721  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0+1dirty  sci=OK  r115=17B  sweep=16.9s  auto-cycle
2026-08-01T15:13:14Z  RED  records=2492 (+0)  spend=$45.3721  guards=2  arms_full=10/10  budget=2  stalest=2.1m  drift=0+1dirty  sci=OK  r115=17B  sweep=17.1s  auto-cycle
2026-08-01T15:14:01Z  RED  records=2494 (+2)  spend=$45.3721  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0+1dirty  sci=OK  r115=17B  sweep=16.9s  auto-cycle
2026-08-01T15:14:48Z  RED  records=2494 (+0)  spend=$45.3721  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=1  sci=OK  r115=17B  sweep=16.5s  auto-cycle
```
...
```
  ...
  openrouter  spent $  8.6304  + still to author $  0.5422  = $  9.1727   credited $ 19.3100   margin $ +10.1373 (+52%)  comfortable
```
