...
**Auto-generated 2026-08-03 08:22 UTC -- T+131h13m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+131h13m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **909** (273 running, 636 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1833 |
| scalar | g5 of 5 | 1243 |
| placebo | g5 of 5 | 1357 |
| scalar_cvar5 | g5 of 5 | 1325 |
| placebo_shuffled | g5 of 5 | 1339 |
...
```
2026-08-03T08:10:55Z  RED  records=7418 (+11)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.1m  drift=0  sci=OK  r115=21B  sweep=103.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T08:13:10Z  RED  records=7428 (+10)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=21B  sweep=81.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
