...
**Auto-generated 2026-08-06 18:40 UTC -- T+213h31m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+213h31m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=139; worst streak 11/240 (4.6% to fatal), pull on core, 1.7 h ago; none live, newest failure 1.7 h ago** |
...
| | |
|---|---|
| cluster jobs | **841** (84 running, **470 ELIGIBLE**, 287 held by us, 287 held by the site) |
| | *"queued" used to lump all three together and overstated the ready backlog by ~62%. Only the ELIGIBLE figure can be dispatched.  is the LADDER LOCK (ours to lift, see below);  is the policyjsv throttle, which drains on its own at ~700-1,000 jobs/h and is NOT ours to lift.* |
| **cores computing** | **672** |
| **cores doing RUNG-RAISING work** | **28.8%** -- 168 of 584 cores (38 min old) |
...
```
generated 2026-08-06 18:40 UTC | elapsed 8.90 d | 20.2 d to the Aug-27 stop
test tier: 18,375 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,685      33  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,520      33  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,953      33  GATED             GATED             no-records:test/distributional,test/scalar>=30
