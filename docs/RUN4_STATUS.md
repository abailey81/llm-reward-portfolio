...
**Auto-generated 2026-08-05 05:28 UTC -- T+176h19m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+176h19m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 26 min ago; none live, newest failure 26 min ago** |
...
| | |
|---|---|
| cluster jobs | **982** (203 running, 779 queued) |
...
```
generated 2026-08-05 05:28 UTC | elapsed 7.35 d | 21.8 d to the Aug-27 stop
test tier: 13,697 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      92 records      92.0 rec/h
    last  3 h     105 records      35.0 rec/h
    last 12 h    1653 records     137.8 rec/h
    last 24 h    3888 records     162.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,242      81  GATED             GATED             barrier>=30
      189       7,681      92  GATED             GATED             barrier>=30
      279      12,181      92  GATED             GATED             barrier>=30
      340      15,231      92  GATED             GATED             barrier>=30
      403      18,381      92  GATED             GATED             barrier>=30
      568      26,631      92  GATED             GATED             barrier>=30
