...
**Auto-generated 2026-08-06 02:54 UTC -- T+197h45m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+197h45m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **963** (68 running, 895 queued) |
| **cores computing** | **544** |
...
```
generated 2026-08-06 02:54 UTC | elapsed 8.24 d | 20.9 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     210 records      70.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,625      37  GATED             GATED             barrier>=30
      189       6,189      37  GATED             GATED             barrier>=30
      279      10,237      37  GATED             GATED             barrier>=30
      340      12,982      37  GATED             GATED             barrier>=30
      403      15,817      37  GATED             GATED             barrier>=30
      568      23,250      37  GATED             GATED             barrier>=30
