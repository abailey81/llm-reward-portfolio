...
**Auto-generated 2026-08-05 02:02 UTC -- T+172h53m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+172h53m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **994** (175 running, 818 queued) |
...
```
generated 2026-08-05 02:02 UTC | elapsed 7.20 d | 21.9 d to the Aug-27 stop
test tier: 13,578 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      26,750      89  GATED             GATED             barrier>=30
