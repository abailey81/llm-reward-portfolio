...
**Auto-generated 2026-08-06 17:11 UTC -- T+212h02m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+212h02m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=156; worst streak 11/240 (4.6% to fatal), pull on core, 16 min ago; none live, newest failure 13 min ago** |
...
| | |
|---|---|
| cluster jobs | **854** (62 running, 792 queued) |
| **cores computing** | **496** |
| **cores doing RUNG-RAISING work** | **17.0%** -- 72 of 424 cores (93 min old **STALE**) |
