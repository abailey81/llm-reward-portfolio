...
```
generated 2026-08-06 03:59 UTC | elapsed 8.28 d | 20.8 d to the Aug-27 stop
test tier: 17,090 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      12 records      12.0 rec/h
    last  3 h      92 records      30.7 rec/h
    last 12 h    1495 records     124.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,613      12  GATED             GATED             barrier>=30
      189       6,177      12  GATED             GATED             barrier>=30
      279      10,225      12  GATED             GATED             barrier>=30
      340      12,970      12  GATED             GATED             barrier>=30
      403      15,805      12  GATED             GATED             barrier>=30
      568      23,238      12  GATED             GATED             barrier>=30
