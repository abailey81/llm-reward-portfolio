...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 77 min ago; none live, newest failure 77 min ago** |
...
```
generated 2026-08-06 15:51 UTC | elapsed 8.78 d | 20.3 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,224     259  GATED             GATED             unstarted:2-unit(s)-absent>=30
      340      11,969     259  GATED             GATED             unstarted:2-unit(s)-absent>=30
      403      14,804     259  GATED             GATED             unstarted:2-unit(s)-absent>=30
      568      22,237     259  GATED             GATED             unstarted:2-unit(s)-absent>=30
