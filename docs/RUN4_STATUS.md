...
**Auto-generated 2026-08-06 04:35 UTC -- T+199h26m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+199h26m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 04:36 UTC | elapsed 8.31 d | 20.8 d to the Aug-27 stop
test tier: 17,116 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      37 records      37.0 rec/h
    last  3 h      98 records      32.7 rec/h
    last 12 h    1410 records     117.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,587      37  GATED             GATED             barrier>=30
      189       6,151      37  GATED             GATED             barrier>=30
      279      10,199      37  GATED             GATED             barrier>=30
      340      12,944      37  GATED             GATED             barrier>=30
      403      15,779      37  GATED             GATED             barrier>=30
      568      23,212      37  GATED             GATED             barrier>=30
