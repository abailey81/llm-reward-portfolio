...
**Auto-generated 2026-08-06 05:38 UTC -- T+200h29m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
test tier: 17,235 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     116 records     116.0 rec/h
    last  3 h     159 records      53.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,032     116  GATED             GATED             barrier>=30
      279      10,080     116  GATED             GATED             barrier>=30
      340      12,825     116  GATED             GATED             barrier>=30
      403      15,660     116  GATED             GATED             barrier>=30
      568      23,093     116  GATED             GATED             barrier>=30
