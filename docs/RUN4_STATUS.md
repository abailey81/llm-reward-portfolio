...
```
generated 2026-08-06 01:11 UTC | elapsed 8.17 d | 21.0 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279      10,314      78  GATED             GATED             barrier>=30
      340      13,059      78  GATED             GATED             barrier>=30
      403      15,894      78  GATED             GATED             barrier>=30
      568      23,327      78  GATED             GATED             barrier>=30
