...
**Auto-generated 2026-08-11 21:19 UTC -- T+336h10m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+336h10m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **544** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (106 min old **STALE**) |
...
```
generated 2026-08-11 21:20 UTC | elapsed 14.01 d | 15.1 d to the Aug-27 stop
test tier: 29,958 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,641      60  GATED             GATED             barrier>=279
      403       3,846      60  GATED             GATED             barrier>=279
      568      10,370      60  GATED             GATED             barrier>=279
