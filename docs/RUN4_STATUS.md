...
```
generated 2026-08-06 00:43 UTC | elapsed 8.15 d | 21.0 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,715     122  GATED             GATED             barrier>=30
      189       6,279     160  GATED             GATED             barrier>=30
      279      10,327     162  GATED             GATED             barrier>=30
      340      13,072     162  GATED             GATED             barrier>=30
      403      15,907     162  GATED             GATED             barrier>=30
      568      23,340     162  GATED             GATED             barrier>=30
