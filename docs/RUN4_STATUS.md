...
**Auto-generated 2026-08-06 02:57 UTC -- T+197h48m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+197h48m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 2.9 h ago; none live, newest failure 2.9 h ago** |
...
```
generated 2026-08-06 02:58 UTC | elapsed 8.24 d | 20.9 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,625      30  GATED             GATED             barrier>=30
      189       6,189      30  GATED             GATED             barrier>=30
      279      10,237      30  GATED             GATED             barrier>=30
      340      12,982      30  GATED             GATED             barrier>=30
      403      15,817      30  GATED             GATED             barrier>=30
      568      23,250      30  GATED             GATED             barrier>=30
