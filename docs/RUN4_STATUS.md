...
**Auto-generated 2026-08-05 14:27 UTC -- T+185h18m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+185h18m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 3.6 h ago; none live, newest failure 82 min ago** |
...
```
generated 2026-08-05 14:27 UTC | elapsed 7.72 d | 21.4 d to the Aug-27 stop
test tier: 15,299 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     181 records     181.0 rec/h
    last  3 h     348 records     116.0 rec/h
    last 12 h    1707 records     142.2 rec/h
    last 24 h    3771 records     157.1 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (141 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,642     168  GATED             GATED             barrier>=30
      403      16,779     181  GATED             GATED             barrier>=30
      568      25,029     181  GATED             GATED             barrier>=30
