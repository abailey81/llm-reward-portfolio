...
```
generated 2026-08-06 00:52 UTC | elapsed 8.16 d | 21.0 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    3529 records     147.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,709     110  GATED             GATED             barrier>=30
      189       6,273     134  GATED             GATED             barrier>=30
      279      10,321     136  GATED             GATED             barrier>=30
      340      13,066     136  GATED             GATED             barrier>=30
      403      15,901     136  GATED             GATED             barrier>=30
      568      23,334     136  GATED             GATED             barrier>=30
