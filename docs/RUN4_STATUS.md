...
**Auto-generated 2026-08-10 23:52 UTC -- T+314h43m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+314h43m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 0/240 (0.0% to fatal), - on -, age UNKNOWN; none live, newest failure 13.1 h ago** |
...
| | |
|---|---|
| cluster jobs | **726** = 136 running + **236 ELIGIBLE** + 354 held by us + 0 held only by the site |
...
| **cores doing RUNG-RAISING work** | **100.0%** -- 1048 of 1048 cores (20 min old) |
...
```
generated 2026-08-10 23:54 UTC | elapsed 13.11 d | 16.0 d to the Aug-27 stop
test tier: 27,528 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 82.1 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last  3 h     386 records     128.7 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last 12 h     985 records      82.1 rec/h   usable
    last 24 h    2336 records      97.3 rec/h   usable
    12 h rate is 42% from ONE line (test_leg_nemotron_3_super); 4 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       1,936     104  2026-08-11 23:29  2026-08-11 23:29  yes
      340       4,071     104  2026-08-13 01:29  2026-08-13 01:29  yes
      403       6,276     104  2026-08-14 04:21  2026-08-14 04:21  yes
      568      12,800     104  2026-08-17 11:50  2026-08-17 11:50  yes
    GATED = the relevant rate is zero, so no throughput number can date that row -- it is
    waiting on a stage barrier (C1 chain / C3 gate), not on cores.
    !! 51% of the rung-568 backlog (6,571 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
...
```
2026-08-10T23:13:09Z  OK  records=29012 (+3)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.6m  drift=0  sci=OK  r115=22B  sweep=45.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-10T23:14:37Z  OK  records=29016 (+4)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=58.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-10T23:16:34Z  OK  records=29017 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.6m  drift=0  sci=OK  r115=22B  sweep=85.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-10T23:29:08Z  OK  records=29045 (+28)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  cores=1048  sweep=723.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-10T23:41:13Z  OK  records=29047 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=694.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-10T23:52:39Z  OK  records=29068 (+21)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  cores=1056  sweep=655.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
