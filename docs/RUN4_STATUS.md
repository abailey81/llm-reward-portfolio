...
**Auto-generated 2026-08-12 03:32 UTC -- T+342h23m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+342h23m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **880** |
| **cores doing RUNG-RAISING work** | **56.7%** -- 440 of 776 cores (119 min old **STALE**) |
...
```
generated 2026-08-12 03:32 UTC | elapsed 14.27 d | 14.9 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,357      69  GATED             GATED             barrier>=279
      403       3,562      69  GATED             GATED             barrier>=279
      568      10,058      97  GATED             GATED             barrier>=279
