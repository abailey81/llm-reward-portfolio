...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 66 min ago; none live, newest failure 66 min ago** |
...
```
generated 2026-08-06 01:10 UTC | elapsed 8.17 d | 21.0 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    1906 records     158.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,703      74  GATED             GATED             barrier>=30
      189       6,267      83  GATED             GATED             barrier>=30
      279      10,315      85  GATED             GATED             barrier>=30
      340      13,060      85  GATED             GATED             barrier>=30
      403      15,895      85  GATED             GATED             barrier>=30
      568      23,328      85  GATED             GATED             barrier>=30
...
2026-08-06T01:09:47Z  ATTN  records=18543 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=26.9s  auto-cycle
```
