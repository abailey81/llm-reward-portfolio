...
**Auto-generated 2026-08-05 20:03 UTC -- T+190h54m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+190h54m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 59 min ago; none live, newest failure 59 min ago** |
...
```
generated 2026-08-05 20:03 UTC | elapsed 7.95 d | 21.2 d to the Aug-27 stop
test tier: 16,243 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      85 records      85.0 rec/h
    last  3 h     440 records     146.7 rec/h
    last 12 h    1890 records     157.5 rec/h
    last 24 h    3616 records     150.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      24,085      85  GATED             GATED             barrier>=30
