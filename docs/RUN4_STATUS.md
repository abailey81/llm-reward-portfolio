...
**Auto-generated 2026-08-07 01:02 UTC -- T+219h53m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+219h53m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **827** = 108 running + **173 ELIGIBLE** + 546 held by us + 0 held only by the site |
...
| **cores computing** | **864** |
| **cores doing RUNG-RAISING work** | **33.6%** -- 288 of 856 cores (82 min old) |
...
test tier: 18,501 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    1502 records      62.6 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,466      44  GATED             GATED             no-records:test/scalar>=30
      189       5,581      44  GATED             GATED             no-records:test/scalar>=30
      279       9,111      44  GATED             GATED             no-records:test/scalar>=30
      340      11,560      72  GATED             GATED             no-records:test/scalar>=30
      403      14,394      73  GATED             GATED             no-records:test/scalar>=30
      568      21,827      73  GATED             GATED             no-records:test/scalar>=30
