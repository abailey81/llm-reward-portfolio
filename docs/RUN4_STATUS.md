...
| | |
|---|---|
| cluster jobs | **961** (67 running, 894 queued) |
| **cores computing** | **536** |
...
```
generated 2026-08-06 04:06 UTC | elapsed 8.29 d | 20.8 d to the Aug-27 stop
test tier: 17,095 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,608      17  GATED             GATED             barrier>=30
      189       6,172      17  GATED             GATED             barrier>=30
      279      10,220      17  GATED             GATED             barrier>=30
      340      12,965      17  GATED             GATED             barrier>=30
      403      15,800      17  GATED             GATED             barrier>=30
      568      23,233      17  GATED             GATED             barrier>=30
