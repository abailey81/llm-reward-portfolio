...
**Auto-generated 2026-08-06 09:59 UTC -- T+204h50m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+204h50m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **888** |
| **cores doing RUNG-RAISING work** | **20.3%** -- 184 of 904 cores (5 min old) |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,743     124  GATED             GATED             barrier>=30
      279       9,791     124  GATED             GATED             barrier>=30
      340      12,536     124  GATED             GATED             barrier>=30
      403      15,371     124  GATED             GATED             barrier>=30
      568      22,804     124  GATED             GATED             barrier>=30
