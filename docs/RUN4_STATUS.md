...
**Auto-generated 2026-08-05 12:35 UTC -- T+183h26m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+183h26m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=5; worst streak 1/240 (0.4% to fatal), ops on core, 5.3 h ago; none live, newest failure 1.8 h ago** |
...
| | |
|---|---|
| cluster jobs | **971** (173 running, 798 queued) |
...
```
generated 2026-08-05 12:35 UTC | elapsed 7.64 d | 21.5 d to the Aug-27 stop
test tier: 15,055 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      91 records      91.0 rec/h
    last  3 h     359 records     119.7 rec/h
    last 12 h    1622 records     135.2 rec/h
    last 24 h    3861 records     160.9 rec/h
    12 h rate is 65% from ONE line (test_leg_haiku_4_5); 5 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279      10,891      23  GATED             GATED             barrier>=30
      340      13,873      91  GATED             GATED             barrier>=30
      403      17,023      91  GATED             GATED             barrier>=30
      568      25,273      91  GATED             GATED             barrier>=30
...
2026-08-05T12:38:01Z  ATTN  records=16597 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  cores=1384  sweep=502.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
