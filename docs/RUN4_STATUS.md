...
**Auto-generated 2026-08-03 07:17 UTC -- T+130h09m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+130h09m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **939** (285 running, 654 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1767 |
| scalar | g5 of 5 | 1180 |
| placebo | g5 of 5 | 1306 |
| scalar_cvar5 | g5 of 5 | 1270 |
| placebo_shuffled | g5 of 5 | 1286 |
...
```
2026-08-03T07:07:44Z  RED  records=7181 (+3)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=21B  sweep=62.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T07:09:17Z  RED  records=7184 (+3)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=21B  sweep=56.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
