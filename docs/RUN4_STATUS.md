...
**Auto-generated 2026-08-06 19:01 UTC -- T+213h52m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+213h52m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=135; worst streak 11/240 (4.6% to fatal), pull on core, 2.1 h ago; none live, newest failure 2.0 h ago** |
...
| | |
|---|---|
| cluster jobs | **841** = 85 running + **31 ELIGIBLE** + 725 held by us + 0 held only by the site |
...
| **cores computing** | **680** |
| **cores doing RUNG-RAISING work** | **31.8%** -- 216 of 680 cores (7 min old) |
...
```
generated 2026-08-06 19:01 UTC | elapsed 8.91 d | 20.2 d to the Aug-27 stop
test tier: 18,381 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,679      21  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,514      21  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,947      21  GATED             GATED             no-records:test/distributional,test/scalar>=30
