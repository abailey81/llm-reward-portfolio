...
**Auto-generated 2026-08-03 08:57 UTC -- T+131h48m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+131h48m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **878** (251 running, 627 queued) |
| **cores computing** | **2008** |

Per-rung ETAs from the registered model at the cores we actually hold:

```
 rung             @2008 cores              @830 cores   binding
  ...
  568            7.5 d  08-05           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 1870 |
| scalar | g5 of 5 | 1290 |
| placebo | g5 of 5 | 1399 |
| scalar_cvar5 | g5 of 5 | 1373 |
| placebo_shuffled | g5 of 5 | 1386 |
