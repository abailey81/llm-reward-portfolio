...
**Auto-generated 2026-08-13 02:03 UTC -- T+364h54m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+364h54m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **318** = 58 running + **194 ELIGIBLE** + 66 held by us + 0 held only by the site |
...
| **cores computing** | **464** |
| **cores doing RUNG-RAISING work** | **27.5%** -- 112 of 408 cores (30 min old) |
...
```
generated 2026-08-13 02:04 UTC | elapsed 15.21 d | 13.9 d to the Aug-27 stop
test tier: 31,536 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 22.2 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h     267 records      22.2 rec/h   usable
    last 24 h    1381 records      57.5 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (22 rec/h); latest excludes cells already within
    8 of the ceiling (22 rec/h). Window 12 h.
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340         424       0  2026-08-13 21:08  2026-08-13 21:08  yes
      403       2,445       0  2026-08-17 15:58  2026-08-17 15:58  yes
      568       8,792       0  2026-08-29 13:13  2026-08-29 13:13  NO
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung      @464 cores      @830 cores   binding
      ...
      100           6.8 d           4.6 d   critical_chain
      189          11.7 d           6.5 d   throughput
      279          16.6 d           9.3 d   throughput
      340          19.9 d          11.1 d   throughput
      403          23.3 d          13.0 d   throughput
      568          32.3 d          18.1 d   throughput
