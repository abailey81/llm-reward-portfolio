...
**Auto-generated 2026-08-01 16:30 UTC -- T+91h21m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+91h21m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **106** (95 running, 11 queued) |
| **cores computing** | **760** |
...
```
 rung              @760 cores              @830 cores   binding
  ...
  189            7.1 d  08-05            6.5 d  08-04   throughput
  279           10.1 d  08-08            9.3 d  08-07   throughput
  340           12.2 d  08-10           11.1 d  08-09   throughput
  403           14.3 d  08-12           13.0 d  08-10   throughput
  568           19.7 d  08-17           18.1 d  08-15   throughput
```
...
```
2026-08-01T16:28:45Z  RED  records=2595 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=19B  sweep=18.8s  auto-cycle
2026-08-01T16:28:45Z  RED  records=2595 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=19B  cores=760  sweep=20.5s  auto-cycle
2026-08-01T16:29:34Z  RED  records=2596 (+1)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=19B  sweep=18.0s  auto-cycle
2026-08-01T16:29:36Z  RED  records=2596 (+1)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=19B  sweep=16.9s  auto-cycle
2026-08-01T16:30:23Z  RED  records=2596 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=19B  sweep=17.4s  auto-cycle
2026-08-01T16:30:22Z  RED  records=2596 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=19B  sweep=18.1s  auto-cycle
```
...
```
  ...
  openrouter  spent $  8.7012  + still to author $  0.4444  = $  9.1457   credited $ 19.3100   margin $ +10.1643 (+53%)  comfortable
```
