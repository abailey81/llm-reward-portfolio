...
**Auto-generated 2026-08-02 15:30 UTC -- T+114h21m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+114h21m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **898** (242 running, 656 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1138 |
| scalar | g5 of 5 | 543 |
| placebo | g5 of 5 | 775 |
| scalar_cvar5 | g5 of 5 | 732 |
| placebo_shuffled | g5 of 5 | 720 |
...
```
2026-08-02T15:24:48Z  RED  records=4277 (+5)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.6m  drift=0  sci=OK  r115=21B  sweep=28.6s  auto-cycle
2026-08-02T15:25:47Z  RED  records=4278 (+1)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=4.6m  drift=0  sci=OK  r115=21B  sweep=31.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T15:26:48Z  RED  records=4281 (+3)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=21B  sweep=29.6s  auto-cycle
2026-08-02T15:27:48Z  RED  records=4289 (+8)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=21B  sweep=28.4s  auto-cycle
2026-08-02T15:28:47Z  RED  records=4293 (+4)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0  sci=OK  r115=21B  sweep=32.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T15:29:50Z  RED  records=4299 (+6)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.5m  drift=0  sci=OK  r115=21B  sweep=30.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
