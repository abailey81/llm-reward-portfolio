...
**Auto-generated 2026-08-01 05:49 UTC -- T+80h40m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+80h40m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **155** (122 running, 33 queued) |
| **cores computing** | **976** |
...
|---|---|---|
| distributional | g5 of 5 | 750 |
| scalar | g5 of 5 | 296 |
| placebo | g5 of 5 | 241 |
| scalar_cvar5 | g5 of 5 | 223 |
| placebo_shuffled | g5 of 5 | 180 |
...
```
2026-08-01T05:45:07Z  RED  records=2065 (+5)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=0.4m  drift=0  sci=OK  r115=14B  sweep=14.7s  auto-cycle
2026-08-01T05:45:51Z  RED  records=2071 (+6)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=1.1m  drift=0+2dirty  sci=OK  r115=14B  sweep=11.6s  auto-cycle
2026-08-01T05:46:33Z  RED  records=2074 (+3)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=1.8m  drift=0+2dirty  sci=OK  r115=14B  sweep=13.6s  auto-cycle
2026-08-01T05:47:17Z  RED  records=2077 (+3)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0+2dirty  sci=OK  r115=14B  sweep=13.6s  auto-cycle
2026-08-01T05:48:01Z  RED  records=2079 (+2)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=0.7m  drift=0+2dirty  sci=OK  r115=14B  sweep=11.8s  auto-cycle
2026-08-01T05:48:43Z  RED  records=2082 (+3)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=0.9m  drift=0+2dirty  sci=OK  r115=14B  sweep=14.5s  auto-cycle
```
...
```
  anthropic   spent $ 35.2446  + still to author $  5.6945  = $ 40.9391   credited $ 28.1500   margin $ -12.7891 (-45%)  over the credit ESTIMATE (owner-watched)
  openrouter  spent $  8.0197  + still to author $  2.0999  = $ 10.1195   credited $ 19.3100   margin $  +9.1905 (+48%)  comfortable
```
