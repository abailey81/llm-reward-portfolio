...
**Auto-generated 2026-08-05 16:02 UTC -- T+186h53m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+186h53m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **906** (182 running, 724 queued) |
...
```
generated 2026-08-05 16:03 UTC | elapsed 7.79 d | 21.3 d to the Aug-27 stop
test tier: 15,604 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      403      16,483     140  GATED             GATED             barrier>=30
      568      24,724     149  GATED             GATED             barrier>=30
