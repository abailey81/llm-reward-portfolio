...
**Auto-generated 2026-08-05 05:46 UTC -- T+176h37m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+176h37m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 44 min ago; none live, newest failure 44 min ago** |
...
```
generated 2026-08-05 05:46 UTC | elapsed 7.36 d | 21.8 d to the Aug-27 stop
test tier: 13,796 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     181 records     181.0 rec/h
    last  3 h     200 records      66.7 rec/h
    last 12 h    1640 records     136.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       7,582     181  GATED             GATED             barrier>=30
      279      12,082     181  GATED             GATED             barrier>=30
      340      15,132     181  GATED             GATED             barrier>=30
      403      18,282     181  GATED             GATED             barrier>=30
      568      26,532     181  GATED             GATED             barrier>=30
