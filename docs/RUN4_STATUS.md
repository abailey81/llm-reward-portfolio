...
**Auto-generated 2026-08-06 06:23 UTC -- T+201h14m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+201h14m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **939** (87 running, 852 queued) |
| **cores computing** | **696** |
...
```
generated 2026-08-06 06:23 UTC | elapsed 8.39 d | 20.7 d to the Aug-27 stop
test tier: 17,330 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     144 records     144.0 rec/h
    last  3 h     251 records      83.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,937     144  GATED             GATED             barrier>=30
      279       9,985     144  GATED             GATED             barrier>=30
      340      12,730     144  GATED             GATED             barrier>=30
      403      15,565     144  GATED             GATED             barrier>=30
      568      22,998     144  GATED             GATED             barrier>=30
