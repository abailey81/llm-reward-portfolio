...
**Auto-generated 2026-08-06 00:08 UTC -- T+194h59m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+194h59m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **993** (67 running, 926 queued) |
| **cores computing** | **536** |
...
```
generated 2026-08-06 00:08 UTC | elapsed 8.13 d | 21.0 d to the Aug-27 stop
test tier: 16,910 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,781     135  GATED             GATED             barrier>=30
      189       6,355     233  GATED             GATED             barrier>=30
      279      10,405     233  GATED             GATED             barrier>=30
      340      13,150     233  GATED             GATED             barrier>=30
      403      15,985     233  GATED             GATED             barrier>=30
      568      23,418     233  GATED             GATED             barrier>=30
