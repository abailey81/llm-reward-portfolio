...
**Auto-generated 2026-08-06 12:21 UTC -- T+207h12m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+207h12m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **824** |
| **cores doing RUNG-RAISING work** | **22.1%** -- 184 of 832 cores (8 min old) |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,695      26  GATED             GATED             barrier>=30
      340      12,440      26  GATED             GATED             barrier>=30
      403      15,275      26  GATED             GATED             barrier>=30
      568      22,708      26  GATED             GATED             barrier>=30
