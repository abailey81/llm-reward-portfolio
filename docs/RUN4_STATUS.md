...
**Auto-generated 2026-08-01 09:17 UTC -- T+84h08m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+84h08m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **2283** |
| LLM calls / spend | 2808 / **$44.0678** |
...
| | |
|---|---|
| cluster jobs | **124** (122 running, 1 queued) |
| **cores computing** | **976** |
...
```
2026-08-01T09:13:51Z  RED  records=2280 (+0)  spend=$44.0158  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=14B  sweep=15.8s  auto-cycle
2026-08-01T09:14:37Z  RED  records=2281 (+1)  spend=$44.0158  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=14B  sweep=15.4s  auto-cycle
2026-08-01T09:15:22Z  RED  records=2281 (+0)  spend=$44.0158  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=14B  sweep=16.4s  auto-cycle
2026-08-01T09:16:09Z  RED  records=2282 (+1)  spend=$44.0158  guards=2  arms_full=10/10  budget=2  stalest=1.4m  drift=0  sci=OK  r115=15B  sweep=15.6s  auto-cycle
2026-08-01T09:16:55Z  RED  records=2283 (+1)  spend=$44.0201  guards=2  arms_full=10/10  budget=2  stalest=2.1m  drift=0  sci=OK  r115=15B  sweep=15.3s  auto-cycle
2026-08-01T09:17:40Z  RED  records=2283 (+0)  spend=$44.0678  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=15B  sweep=16.2s  auto-cycle
```
...
```
  anthropic   spent $ 35.9442  + still to author $  3.4844  = $ 39.4286   credited $ 28.1500   margin $ -11.2786 (-40%)  over the credit ESTIMATE (owner-watched)
  openrouter  spent $  8.1509  + still to author $  1.2068  = $  9.3577   credited $ 19.3100   margin $  +9.9523 (+52%)  comfortable
```
