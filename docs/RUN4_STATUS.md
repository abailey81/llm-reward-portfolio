...
**Auto-generated 2026-08-11 17:50 UTC -- T+332h41m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+332h41m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **454** = 64 running + **62 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **512** |
| **cores doing RUNG-RAISING work** | **4.8%** -- 24 of 504 cores (17 min old) |
...
```
generated 2026-08-11 17:51 UTC | elapsed 13.86 d | 15.3 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    2761 records     115.0 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279         128      20  GATED             GATED             barrier
      340       1,896      94  GATED             GATED             barrier>=279
      403       4,101      94  GATED             GATED             barrier>=279
      568      10,625      94  GATED             GATED             barrier>=279
