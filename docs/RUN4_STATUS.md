...
**Auto-generated 2026-08-05 05:00 UTC -- T+175h51m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+175h51m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 05:00 UTC | elapsed 7.33 d | 21.8 d to the Aug-27 stop
test tier: 13,624 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      20 records      20.0 rec/h
    last  3 h      49 records      16.3 rec/h
    last 12 h    1676 records     139.7 rec/h
    last 24 h    3892 records     162.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,304      20  GATED             GATED             barrier>=30
      189       7,754      20  GATED             GATED             barrier>=30
      279      12,254      20  GATED             GATED             barrier>=30
      340      15,304      20  GATED             GATED             barrier>=30
      403      18,454      20  GATED             GATED             barrier>=30
      568      26,704      20  GATED             GATED             barrier>=30
