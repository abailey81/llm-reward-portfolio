...
```
generated 2026-08-06 06:33 UTC | elapsed 8.39 d | 20.7 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    3368 records     140.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,915     129  GATED             GATED             barrier>=30
      279       9,963     129  GATED             GATED             barrier>=30
      340      12,708     129  GATED             GATED             barrier>=30
      403      15,543     129  GATED             GATED             barrier>=30
      568      22,976     129  GATED             GATED             barrier>=30
