...
**Auto-generated 2026-08-06 04:54 UTC -- T+199h45m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+199h45m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 4.8 h ago; none live, newest failure 4.8 h ago** |
...
| | |
|---|---|
| cluster jobs | **958** (70 running, 888 queued) |
| **cores computing** | **560** |
...
test tier: 17,135 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      51 records      51.0 rec/h
    last  3 h      94 records      31.3 rec/h
    last 12 h    1354 records     112.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,575      44  GATED             GATED             barrier>=30
      189       6,132      51  GATED             GATED             barrier>=30
      279      10,180      51  GATED             GATED             barrier>=30
      340      12,925      51  GATED             GATED             barrier>=30
      403      15,760      51  GATED             GATED             barrier>=30
      568      23,193      51  GATED             GATED             barrier>=30
