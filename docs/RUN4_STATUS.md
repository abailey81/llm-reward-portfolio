...
**Auto-generated 2026-08-06 13:06 UTC -- T+207h57m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+207h57m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=21; worst streak 2/240 (0.8% to fatal), ops on kimi-k3, 26 min ago; none live, newest failure 26 min ago** |
...
| **cores computing** | **808** |
| **cores doing RUNG-RAISING work** | **22.6%** -- 184 of 816 cores (22 min old) |
...
```
generated 2026-08-06 13:06 UTC | elapsed 8.67 d | 20.5 d to the Aug-27 stop
test tier: 17,635 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,680      24  GATED             GATED             barrier>=30
      340      12,425      24  GATED             GATED             barrier>=30
      403      15,260      24  GATED             GATED             barrier>=30
      568      22,693      24  GATED             GATED             barrier>=30
...
```
2026-08-06T12:55:55Z  ATTN  records=19173 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  sweep=29.9s  auto-cycle
