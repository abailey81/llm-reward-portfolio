...
**Auto-generated 2026-08-05 14:59 UTC -- T+185h50m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+185h50m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 4.2 h ago; none live, newest failure 1.9 h ago** |
...
| | |
|---|---|
| cluster jobs | **929** (186 running, 743 queued) |
...
```
generated 2026-08-05 15:00 UTC | elapsed 7.74 d | 21.4 d to the Aug-27 stop
test tier: 15,445 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     243 records     243.0 rec/h
    last  3 h     412 records     137.3 rec/h
    last 12 h    1848 records     154.0 rec/h
    last 24 h    3798 records     158.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,636      90  GATED             GATED             barrier>=30
      403      16,633     243  GATED             GATED             barrier>=30
      568      24,883     243  GATED             GATED             barrier>=30
