...
**Auto-generated 2026-08-06 04:12 UTC -- T+199h03m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+199h03m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **960** (67 running, 893 queued) |
| **cores computing** | **536** |
...
```
generated 2026-08-06 04:13 UTC | elapsed 8.29 d | 20.8 d to the Aug-27 stop
test tier: 17,100 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      21 records      21.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,603      21  GATED             GATED             barrier>=30
      189       6,167      21  GATED             GATED             barrier>=30
      279      10,215      21  GATED             GATED             barrier>=30
      340      12,960      21  GATED             GATED             barrier>=30
      403      15,795      21  GATED             GATED             barrier>=30
      568      23,228      21  GATED             GATED             barrier>=30
