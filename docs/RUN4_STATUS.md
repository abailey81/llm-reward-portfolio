...
**Auto-generated 2026-08-05 14:33 UTC -- T+185h24m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+185h24m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 3.7 h ago; none live, newest failure 89 min ago** |
...
| | |
|---|---|
| cluster jobs | **941** (181 running, 760 queued) |
...
```
generated 2026-08-05 14:34 UTC | elapsed 7.73 d | 21.4 d to the Aug-27 stop
test tier: 15,323 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     196 records     196.0 rec/h
    last  3 h     362 records     120.7 rec/h
    last 12 h    1731 records     144.2 rec/h
    last 24 h    3764 records     156.8 rec/h
    12 h rate is 76% from ONE line (test_leg_haiku_4_5); 5 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (143 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,636     165  GATED             GATED             barrier>=30
      403      16,755     196  GATED             GATED             barrier>=30
      568      25,005     196  GATED             GATED             barrier>=30
