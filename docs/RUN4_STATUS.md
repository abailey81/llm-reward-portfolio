...
**Auto-generated 2026-08-01 19:39 UTC -- T+94h30m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+94h30m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **100** (94 running, 6 queued) |
| **cores computing** | **752** |
...
| scalar | g5 of 5 | 326 |
| placebo | g5 of 5 | 411 |
| scalar_cvar5 | g5 of 5 | 347 |
| placebo_shuffled | g5 of 5 | 300 |
...
```
2026-08-01T19:35:13Z  RED  records=2679 (+1)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=1.8m  drift=0  sci=OK  r115=19B  sweep=17.5s  auto-cycle
2026-08-01T19:36:01Z  RED  records=2680 (+1)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=19B  sweep=20.3s  auto-cycle
2026-08-01T19:36:51Z  RED  records=2680 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=3.3m  drift=0  sci=OK  r115=19B  sweep=18.8s  auto-cycle
2026-08-01T19:37:40Z  RED  records=2680 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=4.2m  drift=0  sci=OK  r115=19B  sweep=21.3s  auto-cycle
2026-08-01T19:38:32Z  RED  records=2682 (+2)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.1m  drift=0  sci=OK  r115=19B  sweep=15.6s  auto-cycle
2026-08-01T19:39:17Z  RED  records=2682 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=19B  sweep=15.2s  auto-cycle
```
