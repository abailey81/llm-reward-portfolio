...
```
generated 2026-08-06 01:03 UTC | elapsed 8.16 d | 21.0 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,705      86  GATED             GATED             barrier>=30
      189       6,269      97  GATED             GATED             barrier>=30
      279      10,317      99  GATED             GATED             barrier>=30
      340      13,062      99  GATED             GATED             barrier>=30
      403      15,897      99  GATED             GATED             barrier>=30
      568      23,330      99  GATED             GATED             barrier>=30
