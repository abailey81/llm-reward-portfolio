...
**Auto-generated 2026-08-05 14:20 UTC -- T+185h11m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+185h11m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 3.5 h ago; none live, newest failure 76 min ago** |
...
| | |
|---|---|
| cluster jobs | **948** (182 running, 766 queued) |
...
```
generated 2026-08-05 14:21 UTC | elapsed 7.72 d | 21.4 d to the Aug-27 stop
test tier: 15,280 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     171 records     171.0 rec/h
    last  3 h     341 records     113.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,653     166  GATED             GATED             barrier>=30
      403      16,798     171  GATED             GATED             barrier>=30
      568      25,048     171  GATED             GATED             barrier>=30
