...
```
generated 2026-08-06 00:08 UTC | elapsed 8.12 d | 21.0 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,784     132  GATED             GATED             barrier>=30
      189       6,358     231  GATED             GATED             barrier>=30
      279      10,408     231  GATED             GATED             barrier>=30
      340      13,153     231  GATED             GATED             barrier>=30
      403      15,988     231  GATED             GATED             barrier>=30
      568      23,421     231  GATED             GATED             barrier>=30
