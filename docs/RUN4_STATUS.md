...
**Auto-generated 2026-08-05 13:40 UTC -- T+184h31m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+184h31m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 2.8 h ago; none live, newest failure 36 min ago** |
...
| | |
|---|---|
| cluster jobs | **961** (194 running, 767 queued) |
...
```
generated 2026-08-05 13:41 UTC | elapsed 7.69 d | 21.4 d to the Aug-27 stop
test tier: 15,134 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      74 records      74.0 rec/h
    last  3 h     265 records      88.3 rec/h
    last 12 h    1583 records     131.9 rec/h
    last 24 h    3757 records     156.5 rec/h
    12 h rate is 71% from ONE line (test_leg_haiku_4_5); 5 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 3% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,794      74  GATED             GATED             barrier>=30
      403      16,944      74  GATED             GATED             barrier>=30
      568      25,194      74  GATED             GATED             barrier>=30
