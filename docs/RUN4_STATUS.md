...
**Auto-generated 2026-08-06 08:40 UTC -- T+203h31m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+203h31m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores doing RUNG-RAISING work** | **20.2%** -- 200 of 992 cores (19 min old) |
...
```
generated 2026-08-06 08:41 UTC | elapsed 8.48 d | 20.6 d to the Aug-27 stop
test tier: 17,383 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    2851 records     118.8 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,884      24  GATED             GATED             barrier>=30
      279       9,932      24  GATED             GATED             barrier>=30
      340      12,677      24  GATED             GATED             barrier>=30
      403      15,512      24  GATED             GATED             barrier>=30
      568      22,945      24  GATED             GATED             barrier>=30
