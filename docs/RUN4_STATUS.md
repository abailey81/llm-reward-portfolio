...
| **cores computing** | **968** |
| **cores doing RUNG-RAISING work** | **20.8%** -- 208 of 1000 cores (27 min old) |
...
```
generated 2026-08-06 09:19 UTC | elapsed 8.51 d | 20.6 d to the Aug-27 stop
test tier: 17,445 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,822      80  GATED             GATED             barrier>=30
      279       9,870      80  GATED             GATED             barrier>=30
      340      12,615      80  GATED             GATED             barrier>=30
      403      15,450      80  GATED             GATED             barrier>=30
      568      22,883      80  GATED             GATED             barrier>=30
