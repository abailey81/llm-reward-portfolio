...
**Auto-generated 2026-08-02 17:00 UTC -- T+115h51m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+115h51m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **844** (247 running, 597 queued) |
| **cores computing** | **1976** |

Per-rung ETAs from the registered model at the cores we actually hold:

```
 rung             @1976 cores              @830 cores   binding
...
|---|---|---|
| distributional | g5 of 5 | 1222 |
| scalar | g5 of 5 | 627 |
| placebo | g5 of 5 | 857 |
| scalar_cvar5 | g5 of 5 | 818 |
| placebo_shuffled | g5 of 5 | 801 |
...
2026-08-02T16:55:59Z  RED  records=4705 (+4)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.7m  drift=0  sci=OK  r115=21B  sweep=33.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T16:57:03Z  RED  records=4710 (+5)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=21B  sweep=62.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T16:58:35Z  RED  records=4713 (+3)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=21B  sweep=36.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T16:59:42Z  RED  records=4718 (+5)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=21B  sweep=32.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T17:00:44Z  RED  records=4719 (+1)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.3m  drift=0  sci=OK  r115=21B  sweep=35.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
