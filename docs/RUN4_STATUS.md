...
**Auto-generated 2026-08-06 02:46 UTC -- T+197h37m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+197h37m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 02:47 UTC | elapsed 8.23 d | 20.9 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,626      45  GATED             GATED             barrier>=30
      189       6,190      45  GATED             GATED             barrier>=30
      279      10,238      45  GATED             GATED             barrier>=30
      340      12,983      45  GATED             GATED             barrier>=30
      403      15,818      45  GATED             GATED             barrier>=30
      568      23,251      45  GATED             GATED             barrier>=30
...
2026-08-06T02:46:12Z  OK  records=18620 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  sweep=27.5s  auto-cycle
2026-08-06T02:47:13Z  OK  records=18620 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.1m  drift=0  sci=OK  r115=22B  sweep=31.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
