...
**Auto-generated 2026-08-11 11:05 UTC -- T+325h56m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+325h56m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **563** = 129 running + **106 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores doing RUNG-RAISING work** | **87.4%** -- 1000 of 1144 cores (92 min old **STALE**) |
...
```
generated 2026-08-11 11:06 UTC | elapsed 13.58 d | 15.5 d to the Aug-27 stop
test tier: 28,817 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    12 h rate is 66% from ONE line (test); 3 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279         647     104  2026-08-11 16:48  2026-08-11 16:48  yes
      340       2,782     104  2026-08-12 11:39  2026-08-12 11:39  yes
      403       4,987     104  2026-08-13 07:06  2026-08-13 07:06  yes
      568      11,511     104  2026-08-15 16:40  2026-08-15 16:40  yes
...
> **What is holding it right now: test -- baseline_differential_downside_ratio has 153 HOLE(S) below its frontier 406 -- that is what caps this line**
