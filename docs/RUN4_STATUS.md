...
**Auto-generated 2026-08-11 17:37 UTC -- T+332h28m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+332h28m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **504** |
| **cores doing RUNG-RAISING work** | **4.8%** -- 24 of 504 cores (5 min old) |
...
```
generated 2026-08-11 17:38 UTC | elapsed 13.85 d | 15.3 d to the Aug-27 stop
test tier: 29,683 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279         128      29  GATED             GATED             barrier
      340       1,916      99  GATED             GATED             barrier>=279
      403       4,121      99  GATED             GATED             barrier>=279
      568      10,645      99  GATED             GATED             barrier>=279
