...
**Auto-generated 2026-08-11 17:45 UTC -- T+332h36m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+332h36m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **528** |
| **cores doing RUNG-RAISING work** | **4.8%** -- 24 of 504 cores (12 min old) |
...
```
generated 2026-08-11 17:46 UTC | elapsed 13.86 d | 15.3 d to the Aug-27 stop
test tier: 29,699 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279         128      24  GATED             GATED             barrier
      340       1,900     100  GATED             GATED             barrier>=279
      403       4,105     100  GATED             GATED             barrier>=279
      568      10,629     100  GATED             GATED             barrier>=279
