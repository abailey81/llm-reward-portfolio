...
**Auto-generated 2026-08-12 03:08 UTC -- T+341h59m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+341h59m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **872** |
| **cores doing RUNG-RAISING work** | **56.7%** -- 440 of 776 cores (96 min old **STALE**) |
...
```
generated 2026-08-12 03:09 UTC | elapsed 14.25 d | 14.9 d to the Aug-27 stop
test tier: 30,245 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,368      72  GATED             GATED             barrier>=279
      403       3,573      72  GATED             GATED             barrier>=279
      568      10,083      86  GATED             GATED             barrier>=279
