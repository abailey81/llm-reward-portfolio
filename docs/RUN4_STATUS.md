...
**Auto-generated 2026-08-12 02:39 UTC -- T+341h30m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+341h30m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **840** |
| **cores doing RUNG-RAISING work** | **56.7%** -- 440 of 776 cores (66 min old) |
...
```
generated 2026-08-12 02:40 UTC | elapsed 14.23 d | 14.9 d to the Aug-27 stop
test tier: 30,185 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h     939 records      78.2 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,414      51  GATED             GATED             barrier>=279
      403       3,619      51  GATED             GATED             barrier>=279
      568      10,143      51  GATED             GATED             barrier>=279
