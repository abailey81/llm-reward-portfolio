...
**Auto-generated 2026-08-06 06:30 UTC -- T+201h21m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+201h21m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    1248 records     104.0 rec/h
    last 24 h    3376 records     140.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,919     134  GATED             GATED             barrier>=30
      279       9,967     134  GATED             GATED             barrier>=30
      340      12,712     134  GATED             GATED             barrier>=30
      403      15,547     134  GATED             GATED             barrier>=30
      568      22,980     134  GATED             GATED             barrier>=30
