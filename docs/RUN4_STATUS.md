...
**Auto-generated 2026-08-06 05:59 UTC -- T+200h50m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h50m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
test tier: 17,277 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     136 records     136.0 rec/h
    last  3 h     199 records      66.3 rec/h
    last 12 h    1293 records     107.8 rec/h
    last 24 h    3412 records     142.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,990     136  GATED             GATED             barrier>=30
      279      10,038     136  GATED             GATED             barrier>=30
      340      12,783     136  GATED             GATED             barrier>=30
      403      15,618     136  GATED             GATED             barrier>=30
      568      23,051     136  GATED             GATED             barrier>=30
