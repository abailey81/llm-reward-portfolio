...
**Auto-generated 2026-08-03 02:28 UTC -- T+125h19m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+125h19m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **964** (291 running, 673 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1636 |
| scalar | g5 of 5 | 1048 |
| placebo | g5 of 5 | 1182 |
| scalar_cvar5 | g5 of 5 | 1144 |
| placebo_shuffled | g5 of 5 | 1142 |
...
```
2026-08-03T02:19:01Z  RED  records=6527 (+6)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=21B  sweep=51.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T02:20:23Z  RED  records=6532 (+5)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=21B  sweep=100.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
