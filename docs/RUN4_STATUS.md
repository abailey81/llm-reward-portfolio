...
**Auto-generated 2026-08-01 19:01 UTC -- T+93h52m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+93h52m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **108** (101 running, 7 queued) |
| **cores computing** | **808** |
...
| scalar | g5 of 5 | 326 |
| placebo | g5 of 5 | 390 |
| scalar_cvar5 | g5 of 5 | 332 |
| placebo_shuffled | g5 of 5 | 297 |
...
```
2026-08-01T18:57:14Z  RED  records=2634 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=19B  sweep=17.4s  auto-cycle
2026-08-01T18:58:01Z  RED  records=2635 (+1)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=1.9m  drift=0  sci=OK  r115=19B  sweep=24.0s  auto-cycle
2026-08-01T18:58:56Z  RED  records=2635 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=19B  sweep=17.0s  auto-cycle
2026-08-01T18:59:43Z  RED  records=2636 (+1)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=19B  sweep=22.7s  auto-cycle
2026-08-01T19:00:36Z  RED  records=2636 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=19B  sweep=17.2s  auto-cycle
2026-08-01T19:01:23Z  RED  records=2636 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.1m  drift=0  sci=OK  r115=19B  sweep=17.5s  auto-cycle
```
