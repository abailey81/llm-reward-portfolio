...
**Auto-generated 2026-08-05 04:51 UTC -- T+175h42m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+175h42m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 04:51 UTC | elapsed 7.32 d | 21.8 d to the Aug-27 stop
test tier: 13,617 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      13 records      13.0 rec/h
    last  3 h      46 records      15.3 rec/h
    last 12 h    1697 records     141.4 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,311      13  GATED             GATED             barrier>=30
      189       7,761      13  GATED             GATED             barrier>=30
      279      12,261      13  GATED             GATED             barrier>=30
      340      15,311      13  GATED             GATED             barrier>=30
      403      18,461      13  GATED             GATED             barrier>=30
      568      26,711      13  GATED             GATED             barrier>=30
