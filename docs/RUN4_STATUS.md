...
**Auto-generated 2026-08-06 06:42 UTC -- T+201h33m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+201h33m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 06:43 UTC | elapsed 8.40 d | 20.7 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    1238 records     103.2 rec/h
    last 24 h    3345 records     139.4 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,908     107  GATED             GATED             barrier>=30
      279       9,956     107  GATED             GATED             barrier>=30
      340      12,701     107  GATED             GATED             barrier>=30
      403      15,536     107  GATED             GATED             barrier>=30
      568      22,969     107  GATED             GATED             barrier>=30
