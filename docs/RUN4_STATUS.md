...
**Auto-generated 2026-08-05 08:20 UTC -- T+179h11m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+179h11m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 65 min ago; none live, newest failure 65 min ago** |
...
| | |
|---|---|
| cluster jobs | **894** (194 running, 700 queued) |
...
```
generated 2026-08-05 08:21 UTC | elapsed 7.47 d | 21.7 d to the Aug-27 stop
test tier: 14,444 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     291 records     291.0 rec/h
    last  3 h     771 records     257.0 rec/h
    last 12 h    1754 records     146.2 rec/h
    last 24 h    4095 records     170.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,165      71  GATED             GATED             barrier>=30
      189       7,170      77  GATED             GATED             barrier>=30
      279      11,434     291  GATED             GATED             barrier>=30
      340      14,484     291  GATED             GATED             barrier>=30
      403      17,634     291  GATED             GATED             barrier>=30
      568      25,884     291  GATED             GATED             barrier>=30
...
```
2026-08-05T08:03:41Z  OK  records=15893 (+14)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.4m  drift=0  sci=OK  r115=22B  sweep=87.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
