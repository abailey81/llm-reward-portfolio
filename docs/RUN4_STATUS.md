...
**Auto-generated 2026-07-31 19:18 UTC -- T+70h09m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+70h09m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **193** (96 running, 97 queued) |
| **cores computing** | **768** |
...
```
2026-07-31T19:06:50Z  ATTN  records=1483 (+0)  spend=$37.7084  guards=2  arms_full=10/10  budget=2  stalest=0.8m  drift=0  sci=OK  r115=12B  auto-cycle
2026-07-31T19:09:02Z  ATTN  records=1483 (+0)  spend=$37.7084  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=12B  auto-cycle
2026-07-31T19:11:14Z  ATTN  records=1484 (+1)  spend=$37.7084  guards=2  arms_full=10/10  budget=2  stalest=2.0m  drift=0  sci=OK  r115=12B  auto-cycle
2026-07-31T19:13:27Z  ATTN  records=1486 (+2)  spend=$37.801  guards=2  arms_full=10/10  budget=2  stalest=1.1m  drift=0  sci=OK  r115=12B  auto-cycle
2026-07-31T19:15:35Z  ATTN  records=1488 (+2)  spend=$38.0367  guards=2  arms_full=10/10  budget=2  stalest=0.5m  drift=0  sci=OK  r115=12B  auto-cycle
...
```
  anthropic   spent $ 31.2866  + still to author $  8.4229  = $ 39.7095   credited $ 28.1500   margin $ -11.5595 (-41%)  over the credit ESTIMATE (owner-watched)
  openrouter  spent $  6.9694  + still to author $  2.7768  = $  9.7461   credited $ 19.3100   margin $  +9.5639 (+50%)  comfortable
```
