...
**Auto-generated 2026-08-06 01:10 UTC -- T+196h01m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+196h01m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,703      69  GATED             GATED             barrier>=30
      189       6,267      78  GATED             GATED             barrier>=30
      279      10,315      80  GATED             GATED             barrier>=30
      340      13,060      80  GATED             GATED             barrier>=30
      403      15,895      80  GATED             GATED             barrier>=30
      568      23,328      80  GATED             GATED             barrier>=30
