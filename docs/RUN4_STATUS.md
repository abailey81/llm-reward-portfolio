...
| transport health | **timeouts 6h=21; worst streak 2/240 (0.8% to fatal), ops on kimi-k3, 14 min ago; none live, newest failure 14 min ago** |
...
| **cores computing** | **816** |
| **cores doing RUNG-RAISING work** | **22.6%** -- 184 of 816 cores (11 min old) |
...
```
generated 2026-08-06 12:55 UTC | elapsed 8.66 d | 20.5 d to the Aug-27 stop
test tier: 17,630 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,685      24  GATED             GATED             barrier>=30
      340      12,430      24  GATED             GATED             barrier>=30
      403      15,265      24  GATED             GATED             barrier>=30
      568      22,698      24  GATED             GATED             barrier>=30
