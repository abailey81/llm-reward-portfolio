...
```
generated 2026-08-06 05:39 UTC | elapsed 8.35 d | 20.8 d to the Aug-27 stop
test tier: 17,237 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     118 records     118.0 rec/h
    last  3 h     161 records      53.7 rec/h
    last 12 h    1311 records     109.2 rec/h
    last 24 h    3480 records     145.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,030     118  GATED             GATED             barrier>=30
      279      10,078     118  GATED             GATED             barrier>=30
      340      12,823     118  GATED             GATED             barrier>=30
      403      15,658     118  GATED             GATED             barrier>=30
      568      23,091     118  GATED             GATED             barrier>=30
