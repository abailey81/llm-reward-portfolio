...
**Auto-generated 2026-08-10 02:56 UTC -- T+293h47m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+293h47m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **753** = 159 running + **218 ELIGIBLE** + 376 held by us + 0 held only by the site |
...
| **cores doing RUNG-RAISING work** | **100.0%** -- 1280 of 1280 cores (79 min old) |
...
```
generated 2026-08-10 02:57 UTC | elapsed 12.24 d | 16.9 d to the Aug-27 stop
test tier: 25,425 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 122.6 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h    1471 records     122.6 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189         354      83  2026-08-10 05:50  2026-08-10 05:50  yes
      279       3,464     100  2026-08-11 07:12  2026-08-11 07:12  yes
      340       5,599     100  2026-08-12 00:37  2026-08-12 00:37  yes
      403       7,827     100  2026-08-12 18:48  2026-08-12 18:48  yes
      568      14,903     100  2026-08-15 04:31  2026-08-15 04:31  yes
...
> **What is holding it right now: test -- baseline_raw_return has 230 HOLE(S) below its frontier 406 -- that is what caps this line**
