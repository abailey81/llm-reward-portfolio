...
**Auto-generated 2026-08-06 00:19 UTC -- T+195h11m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
```
generated 2026-08-06 00:20 UTC | elapsed 8.13 d | 21.0 d to the Aug-27 stop
test tier: 16,958 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,737     168  GATED             GATED             barrier>=30
      189       6,308     236  GATED             GATED             barrier>=30
      279      10,357     237  GATED             GATED             barrier>=30
      340      13,102     237  GATED             GATED             barrier>=30
      403      15,937     237  GATED             GATED             barrier>=30
      568      23,370     237  GATED             GATED             barrier>=30
