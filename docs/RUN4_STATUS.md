...
**Auto-generated 2026-08-05 03:29 UTC -- T+174h20m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+174h20m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 5.0 h ago; none live, newest failure 73 min ago** |
...
| | |
|---|---|
| cluster jobs | **990** (187 running, 803 queued) |
| **cores computing** | **1496** |
...
```
generated 2026-08-05 03:30 UTC | elapsed 7.26 d | 21.9 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     177 records      59.0 rec/h
    last 12 h    1872 records     156.0 rec/h
    last 24 h    4039 records     168.3 rec/h
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung     @1496 cores      @830 cores   binding
