...
**Auto-generated 2026-08-12 03:09 UTC -- T+342h00m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+342h00m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **494** = 109 running + **57 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **872** |
| **cores doing RUNG-RAISING work** | **56.7%** -- 440 of 776 cores (97 min old **STALE**) |
...
```
generated 2026-08-12 03:10 UTC | elapsed 14.25 d | 14.9 d to the Aug-27 stop
test tier: 30,246 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    2487 records     103.6 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,367      71  GATED             GATED             barrier>=279
      403       3,572      71  GATED             GATED             barrier>=279
      568      10,082      85  GATED             GATED             barrier>=279
