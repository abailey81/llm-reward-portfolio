...
**Auto-generated 2026-08-02 09:58 UTC -- T+108h49m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+108h49m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **3482** |
| LLM calls / spend | 2938 / **$45.4652** |
| transport timeouts | **19** |
...
| | |
|---|---|
| cluster jobs | **673** (213 running, 460 queued) |
...
```
 rung             @1704 cores              @830 cores   binding
  ...
  340            5.4 d  08-03           11.1 d  08-09   throughput
  403            6.4 d  08-04           13.0 d  08-10   throughput
  568            8.8 d  08-06           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 974 |
| scalar | g5 of 5 | 377 |
| placebo | g5 of 5 | 618 |
| scalar_cvar5 | g5 of 5 | 577 |
| placebo_shuffled | g5 of 5 | 550 |
...
```
2026-08-02T09:53:06Z  RED  records=3478 (+1)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0+4dirty  sci=OK  r115=21B  sweep=21.9s  auto-cycle
2026-08-02T09:53:58Z  RED  records=3479 (+1)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0+4dirty  sci=OK  r115=21B  cores=1696  sweep=31.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T09:54:59Z  RED  records=3479 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0+4dirty  sci=OK  r115=21B  sweep=22.2s  auto-cycle
2026-08-02T09:55:52Z  RED  records=3479 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=3.8m  drift=0+4dirty  sci=OK  r115=21B  sweep=23.5s  auto-cycle
2026-08-02T09:56:46Z  RED  records=3479 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=4.7m  drift=0+4dirty  sci=OK  r115=21B  sweep=23.1s  auto-cycle
2026-08-02T09:57:39Z  RED  records=3482 (+3)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0+4dirty  sci=OK  r115=21B  sweep=46.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
...
```
  ...
  openrouter  spent $  8.7234  + still to author $  0.0171  = $  8.7405   credited $ 19.3100   margin $ +10.5695 (+55%)  comfortable
```
