...
**Auto-generated 2026-08-06 05:19 UTC -- T+200h10m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h10m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 5.3 h ago; none live, newest failure 5.3 h ago** |
...
| | |
|---|---|
| cluster jobs | **958** (71 running, 887 queued) |
| **cores computing** | **568** |
...
```
generated 2026-08-06 05:20 UTC | elapsed 8.34 d | 20.8 d to the Aug-27 stop
test tier: 17,170 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      65 records      65.0 rec/h
    last  3 h     103 records      34.3 rec/h
    last 12 h    1310 records     109.2 rec/h
    last 24 h    3501 records     145.9 rec/h
    12 h rate is 43% from ONE line (test_leg_haiku_4_5); 4 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 43% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_haiku_4_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,570      28  GATED             GATED             barrier>=30
      189       6,097      65  GATED             GATED             barrier>=30
      279      10,145      65  GATED             GATED             barrier>=30
      340      12,890      65  GATED             GATED             barrier>=30
      403      15,725      65  GATED             GATED             barrier>=30
      568      23,158      65  GATED             GATED             barrier>=30
...
```
2026-08-06T04:47:25Z  OK  records=18667 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=29.9s  auto-cycle
2026-08-06T04:48:32Z  OK  records=18671 (+4)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.9m  drift=0  sci=OK  r115=22B  cores=560  sweep=37.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T04:54:47Z  OK  records=18678 (+7)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.2m  drift=0  sci=OK  r115=22B  sweep=344.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T04:55:48Z  OK  records=18678 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.3m  drift=0  sci=OK  r115=22B  sweep=31.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T05:07:04Z  OK  records=18683 (+5)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.3m  drift=0  sci=OK  r115=22B  sweep=645.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
