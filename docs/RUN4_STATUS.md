...
| **cores computing** | **896** |
| **cores doing RUNG-RAISING work** | **33.6%** -- 288 of 856 cores (87 min old) |
...
```
generated 2026-08-07 01:07 UTC | elapsed 9.17 d | 20.0 d to the Aug-27 stop
test tier: 18,508 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,554      77  GATED             GATED             no-records:test/scalar>=30
      403      14,387      79  GATED             GATED             no-records:test/scalar>=30
      568      21,820      79  GATED             GATED             no-records:test/scalar>=30
