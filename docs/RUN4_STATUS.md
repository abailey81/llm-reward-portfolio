...
**Auto-generated 2026-08-02 08:57 UTC -- T+107h48m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+107h48m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **396** (204 running, 192 queued) |
...
```
 rung             @1632 cores              @830 cores   binding
  ...
  568            9.2 d  08-07           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 937 |
| scalar | g5 of 5 | 344 |
| placebo | g5 of 5 | 618 |
| scalar_cvar5 | g5 of 5 | 577 |
| placebo_shuffled | g5 of 5 | 530 |
...
```
2026-08-02T08:52:49Z  RED  records=3384 (+2)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0  sci=OK  r115=21B  sweep=20.0s  auto-cycle
2026-08-02T08:53:39Z  RED  records=3386 (+2)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=21B  sweep=38.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T08:54:48Z  RED  records=3387 (+1)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=21B  sweep=23.0s  auto-cycle
2026-08-02T08:55:42Z  RED  records=3389 (+2)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=3.6m  drift=0  sci=OK  r115=21B  sweep=21.2s  auto-cycle
2026-08-02T08:56:33Z  RED  records=3390 (+1)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=4.4m  drift=0  sci=OK  r115=21B  sweep=20.8s  auto-cycle
2026-08-02T08:57:24Z  RED  records=3391 (+1)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=21B  sweep=22.3s  auto-cycle
```
