...
**Auto-generated 2026-08-06 04:30 UTC -- T+199h21m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+199h21m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 4.4 h ago; none live, newest failure 4.4 h ago** |
...
```
generated 2026-08-06 04:30 UTC | elapsed 8.31 d | 20.8 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    1425 records     118.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,592      32  GATED             GATED             barrier>=30
      189       6,156      32  GATED             GATED             barrier>=30
      279      10,204      32  GATED             GATED             barrier>=30
      340      12,949      32  GATED             GATED             barrier>=30
      403      15,784      32  GATED             GATED             barrier>=30
      568      23,217      32  GATED             GATED             barrier>=30
