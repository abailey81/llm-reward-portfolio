...
**Auto-generated 2026-08-04 14:57 UTC -- T+161h48m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+161h48m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **13180** |
| **Myriad maintenance** | **2026-08-12 from 08:00 UTC, at risk all day** (in 7.7 days). Delayed from Aug 11. Jobs may die and REQUEUE idempotently; the supervisors ride it. Playbook: docs/ops/MAINTENANCE_2026-08-12.md |
| LLM calls / spend | 2956 / **$45.5021** |
| transport health | **timeouts 6h=13; worst streak 21/240 (8.8% to fatal), pull on core, 2.4 h ago; none live, newest failure 2.4 h ago** |
...
| | |
|---|---|
| cluster jobs | **265** (233 running, 30 queued) |
| **cores computing** | **1864** |
...
```
generated 2026-08-04 14:58 UTC | elapsed 6.74 d | 22.4 d to the Aug-27 stop
test tier: 11,641 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     215 records     215.0 rec/h
    last  3 h     545 records     181.7 rec/h
    last 12 h    2154 records     179.5 rec/h
    last 24 h    3887 records     162.0 rec/h
    12 h rate is 89% from ONE line (test_leg_sonnet_5); 3 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (180 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         404       0  2026-08-04 23:52  2026-08-04 23:52  yes
      100       3,904       0  2026-08-05 12:43  2026-08-05 12:43  yes
      189       8,354       0  2026-08-06 13:30  2026-08-06 13:30  yes
      279      12,854       0  2026-08-07 14:34  2026-08-07 14:34  yes
      340      15,904       0  2026-08-08 07:34  2026-08-08 07:34  yes
      403      19,054     157  2026-08-09 01:07  2026-08-09 01:07  yes
      568      28,687     215  2026-08-11 06:47  2026-08-11 06:47  yes
    ...
    !! 91% of the rung-568 backlog (26,200 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.

REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung     @1864 cores      @830 cores   binding
       30           4.6 d           4.6 d   critical_chain
      100           4.6 d           4.6 d   critical_chain
      189           4.6 d           6.5 d   throughput
      279           4.6 d           9.3 d   throughput
      340           5.0 d          11.1 d   throughput
      403           5.8 d          13.0 d   throughput
      568           8.0 d          18.1 d   throughput

    saturation: more than ~3235 cores buy NOTHING at rung 568
    critical-chain floor: 4.64 d total, 0.37 d still to run   (bayes_opt owes 2 of 30 candidates)
...
```
2026-08-04T14:37:42Z  ATTN  records=13101 (+27)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  sweep=256.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T14:41:15Z  ATTN  records=13112 (+11)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.9m  drift=0  sci=OK  r115=22B  sweep=182.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T14:44:08Z  ATTN  records=13121 (+9)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.0m  drift=0  sci=OK  r115=22B  sweep=143.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T14:47:37Z  ATTN  records=13135 (+14)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=178.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T14:50:28Z  ATTN  records=13148 (+13)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.9m  drift=0  sci=OK  r115=22B  sweep=140.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T14:55:33Z  ATTN  records=13162 (+14)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.1m  drift=0  sci=OK  r115=22B  cores=1888  sweep=275.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
