...
**Auto-generated 2026-08-11 20:42 UTC -- T+335h33m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+335h33m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on deepseek-v4-pro, 3.0 h ago; none live, newest failure 3.0 h ago** |
...
| | |
|---|---|
| cluster jobs | **423** = 64 running + **31 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **512** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (69 min old) |
...
```
generated 2026-08-11 20:43 UTC | elapsed 13.98 d | 15.1 d to the Aug-27 stop
test tier: 29,930 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    2805 records     116.9 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,669      92  GATED             GATED             barrier>=279
      403       3,874      92  GATED             GATED             barrier>=279
      568      10,398      92  GATED             GATED             barrier>=279
