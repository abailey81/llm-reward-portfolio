...
**Auto-generated 2026-08-06 00:48 UTC -- T+195h39m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h39m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.7 h ago; none live, newest failure 44 min ago** |
...
```
generated 2026-08-06 00:48 UTC | elapsed 8.15 d | 21.0 d to the Aug-27 stop
test tier: 16,992 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     146 records     146.0 rec/h
    last  3 h     550 records     183.3 rec/h
    last 12 h    1925 records     160.4 rec/h
    last 24 h    3534 records     147.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,711     115  GATED             GATED             barrier>=30
      189       6,275     144  GATED             GATED             barrier>=30
      279      10,323     146  GATED             GATED             barrier>=30
      340      13,068     146  GATED             GATED             barrier>=30
      403      15,903     146  GATED             GATED             barrier>=30
      568      23,336     146  GATED             GATED             barrier>=30
