...
**Auto-generated 2026-08-06 19:21 UTC -- T+214h12m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+214h12m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=105; worst streak 11/240 (4.6% to fatal), pull on core, 2.4 h ago; none live, newest failure 2.4 h ago** |
...
| | |
|---|---|
| cluster jobs | **839** = 87 running + **29 ELIGIBLE** + 385 held by us + 338 held only by the site |
...
| **cores computing** | **696** |
| **cores doing RUNG-RAISING work** | **31.8%** -- 216 of 680 cores (27 min old) |
...
```
generated 2026-08-06 19:22 UTC | elapsed 8.93 d | 20.2 d to the Aug-27 stop
test tier: 18,401 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,659      33  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,494      33  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,927      33  GATED             GATED             no-records:test/distributional,test/scalar>=30
...
2026-08-06T19:19:42Z  OK  records=19935 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  sweep=31.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
