...
**Auto-generated 2026-08-05 19:38 UTC -- T+190h29m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+190h29m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 35 min ago; none live, newest failure 35 min ago** |
...
| | |
|---|---|
| cluster jobs | **829** (117 running, 712 queued) |
| **cores computing** | **936** |
...
```
generated 2026-08-05 19:39 UTC | elapsed 7.94 d | 21.2 d to the Aug-27 stop
test tier: 16,200 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      85 records      85.0 rec/h
    last  3 h     484 records     161.3 rec/h
    last 12 h    1949 records     162.4 rec/h
    last 24 h    3646 records     151.9 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      24,128      85  GATED             GATED             barrier>=30
