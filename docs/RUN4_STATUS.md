...
**Auto-generated 2026-08-01 05:06 UTC -- T+79h57m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+79h57m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **179** (121 running, 58 queued) |
| **cores computing** | **968** |
...
|---|---|---|
| distributional | g5 of 5 | 616 |
| scalar | g5 of 5 | 296 |
| placebo | g5 of 5 | 239 |
| scalar_cvar5 | g5 of 5 | 221 |
...
```
2026-08-01T05:02:45Z  RED  records=1925 (+1)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=1.6m  drift=0  sci=OK  r115=14B  sweep=13.6s  auto-cycle
2026-08-01T05:03:29Z  RED  records=1929 (+4)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=14B  sweep=12.4s  auto-cycle
2026-08-01T05:04:11Z  RED  records=1929 (+0)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=14B  sweep=13.0s  auto-cycle
2026-08-01T05:04:54Z  RED  records=1929 (+0)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=0.7m  drift=0  sci=OK  r115=14B  sweep=14.0s  auto-cycle
2026-08-01T05:05:39Z  RED  records=1934 (+5)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=1.4m  drift=0  sci=OK  r115=14B  sweep=13.0s  auto-cycle
2026-08-01T05:06:22Z  RED  records=1941 (+7)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=2.1m  drift=0  sci=OK  r115=14B  sweep=9.7s  auto-cycle
```
