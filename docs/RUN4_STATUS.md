...
**Auto-generated 2026-08-05 19:12 UTC -- T+190h03m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+190h03m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 9 min ago; LIVE, still failing** |
...
```
generated 2026-08-05 19:13 UTC | elapsed 7.92 d | 21.2 d to the Aug-27 stop
test tier: 16,169 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     124 records     124.0 rec/h
    last  3 h     532 records     177.3 rec/h
    last 12 h    2041 records     170.1 rec/h
    last 24 h    3710 records     154.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      24,159     124  GATED             GATED             barrier>=30
