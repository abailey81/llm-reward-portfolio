...
**Auto-generated 2026-08-04 22:55 UTC -- T+169h46m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+169h46m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 25 min ago; none live, newest failure 25 min ago** |
...
```
generated 2026-08-04 22:55 UTC | elapsed 7.07 d | 22.0 d to the Aug-27 stop
test tier: 13,161 records over 68 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     146 records     146.0 rec/h
    last  3 h     561 records     187.0 rec/h
    last 12 h    2213 records     184.4 rec/h
    last 24 h    4302 records     179.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         240       5  GATED             GATED             barrier
      100       3,341      14  GATED             GATED             barrier>=30
      189       7,791      14  GATED             GATED             barrier>=30
      279      12,291      14  GATED             GATED             barrier>=30
      340      15,341      14  GATED             GATED             barrier>=30
      403      18,491      14  GATED             GATED             barrier>=30
      568      27,167     146  GATED             GATED             barrier>=30
