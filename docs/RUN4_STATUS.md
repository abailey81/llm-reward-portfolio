...
**Auto-generated 2026-08-05 06:56 UTC -- T+177h47m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+177h47m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 06:56 UTC | elapsed 7.41 d | 21.7 d to the Aug-27 stop
test tier: 14,075 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     227 records     227.0 rec/h
    last  3 h     471 records     157.0 rec/h
    last 12 h    1680 records     140.0 rec/h
    last 24 h    4084 records     170.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       7,303     227  GATED             GATED             barrier>=30
      279      11,803     227  GATED             GATED             barrier>=30
      340      14,853     227  GATED             GATED             barrier>=30
      403      18,003     227  GATED             GATED             barrier>=30
      568      26,253     227  GATED             GATED             barrier>=30
