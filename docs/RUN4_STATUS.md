...
**Auto-generated 2026-08-12 03:56 UTC -- T+342h47m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| cluster jobs | **487** = 111 running + **48 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **888** |
| **cores doing RUNG-RAISING work** | **76.4%** -- 672 of 880 cores (24 min old) |
...
```
generated 2026-08-12 03:57 UTC | elapsed 14.28 d | 14.8 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,357      21  GATED             GATED             barrier>=279
      403       3,562      21  GATED             GATED             barrier>=279
      568      10,037      63  GATED             GATED             barrier>=279
...
2026-08-12T03:57:40Z  OK  records=31834 (+21)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=0.9m  drift=0  sci=OK  r115=22B  cores=888  sweep=761.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
