...
**Auto-generated 2026-08-06 05:50 UTC -- T+200h42m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h42m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **947** (71 running, 876 queued) |
| **cores computing** | **568** |
...
```
generated 2026-08-06 05:51 UTC | elapsed 8.36 d | 20.8 d to the Aug-27 stop
test tier: 17,266 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     134 records     134.0 rec/h
    last  3 h     189 records      63.0 rec/h
    last 12 h    1309 records     109.1 rec/h
    last 24 h    3444 records     143.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,001     134  GATED             GATED             barrier>=30
      279      10,049     134  GATED             GATED             barrier>=30
      340      12,794     134  GATED             GATED             barrier>=30
      403      15,629     134  GATED             GATED             barrier>=30
      568      23,062     134  GATED             GATED             barrier>=30
