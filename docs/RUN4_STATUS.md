...
**Auto-generated 2026-08-05 13:17 UTC -- T+184h08m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+184h08m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 2.5 h ago; none live, newest failure 13 min ago** |
...
| | |
|---|---|
| cluster jobs | **965** (181 running, 784 queued) |
...
```
generated 2026-08-05 13:18 UTC | elapsed 7.67 d | 21.4 d to the Aug-27 stop
test tier: 15,104 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      55 records      55.0 rec/h
    last  3 h     308 records     102.7 rec/h
    last 12 h    1586 records     132.2 rec/h
    last 24 h    3778 records     157.4 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,824      55  GATED             GATED             barrier>=30
      403      16,974      55  GATED             GATED             barrier>=30
      568      25,224      55  GATED             GATED             barrier>=30
...
2026-08-05T13:17:14Z  OK  records=16642 (+8)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=0.3m  drift=0  sci=OK  r115=22B  sweep=465.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
