...
**Auto-generated 2026-08-11 19:18 UTC -- T+334h09m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+334h09m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **439** = 64 running + **47 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **512** |
| **cores doing RUNG-RAISING work** | **4.8%** -- 24 of 504 cores (105 min old **STALE**) |
...
```
generated 2026-08-11 19:19 UTC | elapsed 13.92 d | 15.2 d to the Aug-27 stop
test tier: 29,799 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 116.4 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h    1397 records     116.4 rec/h   usable
    last 24 h    2768 records     115.3 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,800      49  GATED             GATED             barrier>=279
      403       4,005      49  GATED             GATED             barrier>=279
      568      10,529      49  GATED             GATED             barrier>=279
