...
**Auto-generated 2026-08-11 19:11 UTC -- T+334h02m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+334h02m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **504** |
| **cores doing RUNG-RAISING work** | **4.8%** -- 24 of 504 cores (98 min old **STALE**) |
...
```
generated 2026-08-11 19:12 UTC | elapsed 13.92 d | 15.2 d to the Aug-27 stop
test tier: 29,794 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 116.9 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h    1403 records     116.9 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,805      51  GATED             GATED             barrier>=279
      403       4,010      51  GATED             GATED             barrier>=279
      568      10,534      51  GATED             GATED             barrier>=279
