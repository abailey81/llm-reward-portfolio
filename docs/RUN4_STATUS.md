...
**Auto-generated 2026-08-12 01:00 UTC -- T+339h51m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+339h51m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **752** |
| **cores doing RUNG-RAISING work** | **37.8%** -- 248 of 656 cores (88 min old) |
...
```
generated 2026-08-12 01:01 UTC | elapsed 14.16 d | 15.0 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279          72      41  GATED             GATED             barrier
      340       1,497      46  GATED             GATED             barrier>=279
      403       3,702      46  GATED             GATED             barrier>=279
      568      10,226      46  GATED             GATED             barrier>=279
