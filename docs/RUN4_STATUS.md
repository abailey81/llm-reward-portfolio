...
**Auto-generated 2026-08-06 19:45 UTC -- T+214h36m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+214h36m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=85; worst streak 11/240 (4.6% to fatal), pull on core, 2.8 h ago; none live, newest failure 2.8 h ago** |
...
| | |
|---|---|
| cluster jobs | **836** = 100 running + **121 ELIGIBLE** + 565 held by us + 50 held only by the site |
...
| **cores computing** | **800** |
| **cores doing RUNG-RAISING work** | **31.8%** -- 216 of 680 cores (51 min old) |
...
```
generated 2026-08-06 19:46 UTC | elapsed 8.94 d | 20.2 d to the Aug-27 stop
