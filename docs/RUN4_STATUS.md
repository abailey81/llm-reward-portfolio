...
**Auto-generated 2026-08-05 06:57 UTC -- T+177h49m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+177h49m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 06:58 UTC | elapsed 7.41 d | 21.7 d to the Aug-27 stop
test tier: 14,081 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       7,297     223  GATED             GATED             barrier>=30
      279      11,797     223  GATED             GATED             barrier>=30
      340      14,847     223  GATED             GATED             barrier>=30
      403      17,997     223  GATED             GATED             barrier>=30
      568      26,247     223  GATED             GATED             barrier>=30
