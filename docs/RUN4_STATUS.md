...
**Auto-generated 2026-08-01 20:54 UTC -- T+95h45m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+95h45m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **88** (82 running, 6 queued) |
| **cores computing** | **656** |
...
```
 rung              @656 cores              @830 cores   binding
  ...
  100            4.8 d  08-02            4.6 d  08-02   critical_chain
  189            8.3 d  08-06            6.5 d  08-04   throughput
  279           11.7 d  08-09            9.3 d  08-07   throughput
  340           14.1 d  08-11           11.1 d  08-09   throughput
  403           16.5 d  08-14           13.0 d  08-10   throughput
  568           22.9 d  08-20           18.1 d  08-15   throughput
```
...
```
2026-08-01T20:50:04Z  RED  records=2761 (+1)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=19B  sweep=17.5s  auto-cycle
2026-08-01T20:50:52Z  RED  records=2761 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.0m  drift=0  sci=OK  r115=19B  sweep=19.2s  auto-cycle
2026-08-01T20:51:42Z  RED  records=2763 (+2)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=19B  sweep=18.5s  auto-cycle
2026-08-01T20:52:30Z  RED  records=2763 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0  sci=OK  r115=19B  sweep=19.4s  auto-cycle
2026-08-01T20:53:20Z  RED  records=2764 (+1)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=3.9m  drift=0  sci=OK  r115=19B  sweep=19.4s  auto-cycle
2026-08-01T20:54:10Z  RED  records=2764 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=19B  sweep=31.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
