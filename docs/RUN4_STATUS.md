...
**Auto-generated 2026-08-06 00:02 UTC -- T+194h53m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+194h53m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **920** (69 running, 851 queued) |
| **cores computing** | **552** |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         120       3  GATED             GATED             barrier
      100       2,796     124  GATED             GATED             barrier>=30
      189       6,372     229  GATED             GATED             barrier>=30
      279      10,422     229  GATED             GATED             barrier>=30
      340      13,167     229  GATED             GATED             barrier>=30
      403      16,002     229  GATED             GATED             barrier>=30
      568      23,435     229  GATED             GATED             barrier>=30
