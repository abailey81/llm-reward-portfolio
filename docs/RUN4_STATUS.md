...
**Auto-generated 2026-08-03 08:35 UTC -- T+131h26m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+131h26m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **898** (267 running, 631 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1846 |
| scalar | g5 of 5 | 1260 |
| placebo | g5 of 5 | 1368 |
| scalar_cvar5 | g5 of 5 | 1343 |
| placebo_shuffled | g5 of 5 | 1360 |
...
2026-08-03T08:33:02Z  RED  records=7567 (+9)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=21B  sweep=64.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T08:34:37Z  RED  records=7576 (+9)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=1.8m  drift=0  sci=OK  r115=21B  sweep=81.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
