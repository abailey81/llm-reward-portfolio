...
**Auto-generated 2026-08-01 08:02 UTC -- T+82h53m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+82h53m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **2239** |
| LLM calls / spend | 2783 / **$43.4582** |
...
| | |
|---|---|
| cluster jobs | **129** (121 running, 7 queued) |
| **cores computing** | **968** |
...
|---|---|---|
| distributional | g5 of 5 | 868 |
| scalar | g5 of 5 | 296 |
| placebo | g5 of 5 | 256 |
| scalar_cvar5 | g5 of 5 | 233 |
| placebo_shuffled | g5 of 5 | 196 |
...
```
2026-08-01T07:58:23Z  RED  records=2238 (+0)  spend=$43.4582  guards=2  arms_full=10/10  budget=2  stalest=1.9m  drift=0  sci=OK  r115=14B  sweep=15.8s  auto-cycle
2026-08-01T07:59:09Z  RED  records=2238 (+0)  spend=$43.4582  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=14B  sweep=15.8s  auto-cycle
2026-08-01T07:59:55Z  RED  records=2238 (+0)  spend=$43.4582  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=14B  sweep=12.7s  auto-cycle
2026-08-01T08:00:38Z  RED  records=2239 (+1)  spend=$43.4582  guards=2  arms_full=10/10  budget=2  stalest=1.0m  drift=0  sci=OK  r115=14B  sweep=16.9s  auto-cycle
2026-08-01T08:01:25Z  RED  records=2239 (+0)  spend=$43.4582  guards=2  arms_full=10/10  budget=2  stalest=1.8m  drift=0  sci=OK  r115=14B  sweep=16.1s  auto-cycle
2026-08-01T08:02:11Z  RED  records=2239 (+0)  spend=$43.4582  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=14B  sweep=12.7s  auto-cycle
```
...
```
  anthropic   spent $ 35.4004  + still to author $  4.3929  = $ 39.7932   credited $ 28.1500   margin $ -11.6432 (-41%)  over the credit ESTIMATE (owner-watched)
