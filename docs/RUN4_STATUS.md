...
**Auto-generated 2026-08-05 02:26 UTC -- T+173h17m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+173h17m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 3.9 h ago; none live, newest failure 10 min ago** |
...
```
generated 2026-08-05 02:27 UTC | elapsed 7.22 d | 21.9 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     312 records     104.0 rec/h
    last 12 h    2065 records     172.1 rec/h
    last 24 h    4196 records     174.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      26,736      62  GATED             GATED             barrier>=30
