...
**Auto-generated 2026-08-13 01:20 UTC -- T+364h12m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+364h12m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **320** = 51 running + **203 ELIGIBLE** + 66 held by us + 0 held only by the site |
...
| **cores computing** | **408** |
| **cores doing RUNG-RAISING work** | **43.8%** -- 112 of 256 cores (108 min old **STALE**) |
...
```
generated 2026-08-13 01:21 UTC | elapsed 15.18 d | 13.9 d to the Aug-27 stop
test tier: 31,536 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 28.4 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h     341 records      28.4 rec/h   usable
    last 24 h    1421 records      59.2 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (28 rec/h); latest excludes cells already within
    8 of the ceiling (28 rec/h). Window 12 h.
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340         424       0  2026-08-13 16:17  2026-08-13 16:17  yes
      403       2,445       0  2026-08-16 15:24  2026-08-16 15:24  yes
      568       8,792       0  2026-08-25 22:45  2026-08-25 22:45  yes
