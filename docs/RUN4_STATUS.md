...
**Auto-generated 2026-08-06 08:51 UTC -- T+203h42m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+203h42m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 08:52 UTC | elapsed 8.49 d | 20.6 d to the Aug-27 stop
test tier: 17,395 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,872      32  GATED             GATED             barrier>=30
      279       9,920      32  GATED             GATED             barrier>=30
      340      12,665      32  GATED             GATED             barrier>=30
      403      15,500      32  GATED             GATED             barrier>=30
      568      22,933      32  GATED             GATED             barrier>=30
