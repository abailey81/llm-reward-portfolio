...
**Auto-generated 2026-08-05 05:12 UTC -- T+176h03m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+176h03m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 10 min ago; LIVE, still failing** |
...
| | |
|---|---|
| cluster jobs | **988** (199 running, 789 queued) |
...
```
generated 2026-08-05 05:12 UTC | elapsed 7.34 d | 21.8 d to the Aug-27 stop
test tier: 13,646 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      42 records      42.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,282      42  GATED             GATED             barrier>=30
      189       7,732      42  GATED             GATED             barrier>=30
      279      12,232      42  GATED             GATED             barrier>=30
      340      15,282      42  GATED             GATED             barrier>=30
      403      18,432      42  GATED             GATED             barrier>=30
      568      26,682      42  GATED             GATED             barrier>=30
