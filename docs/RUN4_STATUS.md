...
**Auto-generated 2026-08-05 18:33 UTC -- T+189h24m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+189h24m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **17649** |
| **Myriad maintenance** | **2026-08-12 from 08:00 UTC, at risk all day** (in 6.6 days). Delayed from Aug 11. Jobs may die and REQUEUE idempotently; the supervisors ride it. Playbook: docs/ops/MAINTENANCE_2026-08-12.md |
| LLM calls / spend | 2956 / **$45.5021** |
| transport health | **timeouts 6h=2; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.5 h ago; none live, newest failure 5.5 h ago** |
...
| | |
|---|---|
| cluster jobs | **840** (126 running, 714 queued) |
...
```
generated 2026-08-05 18:33 UTC | elapsed 7.89 d | 21.2 d to the Aug-27 stop
test tier: 16,106 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     196 records     196.0 rec/h
    last  3 h     554 records     184.7 rec/h
    last 12 h    2119 records     176.6 rec/h
    last 24 h    3782 records     157.6 rec/h
    12 h rate is 81% from ONE line (test_leg_haiku_4_5); 3 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,636       0  GATED             GATED             barrier>=30
      403      16,471       0  GATED             GATED             barrier>=30
      568      24,222     196  GATED             GATED             barrier>=30
    ...
    !! 85% of the rung-568 backlog (20,624 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
...
```
2026-08-05T17:58:48Z  ATTN  records=17519 (+20)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=99  stalest=1.9m  drift=0  sci=OK  r115=22B  sweep=394.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T18:06:01Z  OK  records=17547 (+28)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.6m  drift=0  sci=OK  r115=22B  cores=1144  sweep=402.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T18:14:21Z  OK  records=17575 (+28)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  sweep=469.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T18:19:44Z  OK  records=17599 (+24)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.2m  drift=0  sci=OK  r115=22B  cores=1088  sweep=292.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T18:25:48Z  OK  records=17627 (+28)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.9m  drift=0  sci=OK  r115=22B  sweep=334.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T18:29:28Z  OK  records=17634 (+7)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.1m  drift=0  sci=OK  r115=22B  sweep=190.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
