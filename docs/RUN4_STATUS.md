...
**Auto-generated 2026-08-07 01:07 UTC -- T+219h58m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+219h58m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **896** |
| **cores doing RUNG-RAISING work** | **33.6%** -- 288 of 856 cores (88 min old) |
...
```
generated 2026-08-07 01:08 UTC | elapsed 9.17 d | 20.0 d to the Aug-27 stop
test tier: 18,511 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      403      14,384      82  GATED             GATED             no-records:test/scalar>=30
      568      21,817      82  GATED             GATED             no-records:test/scalar>=30
