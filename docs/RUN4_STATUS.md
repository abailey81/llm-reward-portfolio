...
**Auto-generated 2026-08-05 14:00 UTC -- T+184h51m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+184h51m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 3.2 h ago; none live, newest failure 56 min ago** |
...
| | |
|---|---|
| cluster jobs | **958** (191 running, 767 queued) |
...
```
generated 2026-08-05 14:01 UTC | elapsed 7.70 d | 21.4 d to the Aug-27 stop
test tier: 15,202 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     116 records     116.0 rec/h
    last  3 h     303 records     101.0 rec/h
    last 12 h    1625 records     135.4 rec/h
    last 24 h    3768 records     157.0 rec/h
    12 h rate is 74% from ONE line (test_leg_haiku_4_5); 5 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,726     116  GATED             GATED             barrier>=30
      403      16,876     116  GATED             GATED             barrier>=30
      568      25,126     116  GATED             GATED             barrier>=30
