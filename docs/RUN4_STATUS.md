...
**Auto-generated 2026-08-03 11:19 UTC -- T+134h10m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+134h10m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **757** (176 running, 581 queued) |
...
| scalar | g5 of 5 | 1467 |
| placebo | g5 of 5 | 1593 |
| scalar_cvar5 | g5 of 5 | 1569 |
| placebo_shuffled | g5 of 5 | 1580 |
...
2026-08-03T11:17:09Z  RED  records=8657 (+30)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=1.9m  drift=0  sci=OK  r115=21B  sweep=177.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
