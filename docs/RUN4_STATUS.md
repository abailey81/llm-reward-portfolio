...
**Auto-generated 2026-08-05 18:22 UTC -- T+189h13m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+189h13m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=2; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.3 h ago; none live, newest failure 5.3 h ago** |
...
| | |
|---|---|
| cluster jobs | **847** (133 running, 714 queued) |
...
```
generated 2026-08-05 18:23 UTC | elapsed 7.89 d | 21.2 d to the Aug-27 stop
test tier: 16,081 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      24,247     207  GATED             GATED             barrier>=30
