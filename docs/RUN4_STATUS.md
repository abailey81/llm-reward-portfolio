...
**Auto-generated 2026-08-06 10:15 UTC -- T+205h06m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+205h06m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **912** |
| **cores doing RUNG-RAISING work** | **20.3%** -- 184 of 904 cores (21 min old) |
...
```
generated 2026-08-06 10:15 UTC | elapsed 8.55 d | 20.6 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,736      97  GATED             GATED             barrier>=30
      279       9,784      97  GATED             GATED             barrier>=30
      340      12,529      97  GATED             GATED             barrier>=30
      403      15,364      97  GATED             GATED             barrier>=30
      568      22,797      97  GATED             GATED             barrier>=30
