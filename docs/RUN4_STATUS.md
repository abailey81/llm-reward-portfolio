...
| | |
|---|---|
| cluster jobs | **936** (95 running, 841 queued) |
| **cores computing** | **760** |
...
```
generated 2026-08-06 06:28 UTC | elapsed 8.39 d | 20.7 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,926     140  GATED             GATED             barrier>=30
      279       9,974     140  GATED             GATED             barrier>=30
      340      12,719     140  GATED             GATED             barrier>=30
      403      15,554     140  GATED             GATED             barrier>=30
      568      22,987     140  GATED             GATED             barrier>=30
