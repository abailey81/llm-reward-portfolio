...
**Auto-generated 2026-08-04 18:33 UTC -- T+165h24m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+165h24m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on nemotron-3-super, 2.7 h ago; none live, newest failure 2.7 h ago** |
...
| | |
|---|---|
| cluster jobs | **176** (174 running, 0 queued) |
...
```
generated 2026-08-04 18:34 UTC | elapsed 6.89 d | 22.2 d to the Aug-27 stop
test tier: 12,324 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     240 records     240.0 rec/h
    last  3 h     586 records     195.3 rec/h
    last 12 h    2371 records     197.6 rec/h
    last 24 h    4237 records     176.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,880      24  GATED             GATED             barrier>=30
      189       8,330      24  GATED             GATED             barrier>=30
      279      12,830      24  GATED             GATED             barrier>=30
      340      15,880      24  GATED             GATED             barrier>=30
      403      19,030      24  GATED             GATED             barrier>=30
      568      28,004     240  GATED             GATED             barrier>=30
