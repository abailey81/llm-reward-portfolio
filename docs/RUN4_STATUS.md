...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.9 h ago; none live, newest failure 52 min ago** |
...
```
generated 2026-08-06 00:56 UTC | elapsed 8.16 d | 21.0 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    3524 records     146.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,706     104  GATED             GATED             barrier>=30
      189       6,270     123  GATED             GATED             barrier>=30
      279      10,318     125  GATED             GATED             barrier>=30
      340      13,063     125  GATED             GATED             barrier>=30
      403      15,898     125  GATED             GATED             barrier>=30
      568      23,331     125  GATED             GATED             barrier>=30
