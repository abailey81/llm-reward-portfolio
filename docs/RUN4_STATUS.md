...
**Auto-generated 2026-08-05 11:04 UTC -- T+181h55m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+181h55m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 3.8 h ago; none live, newest failure 15 min ago** |
...
```
generated 2026-08-05 11:05 UTC | elapsed 7.58 d | 21.5 d to the Aug-27 stop
test tier: 14,909 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     157 records     157.0 rec/h
    last  3 h     552 records     184.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         180      34  GATED             GATED             barrier
      100       2,980      34  GATED             GATED             barrier>=30
      189       6,842      61  GATED             GATED             barrier>=30
      279      10,969     157  GATED             GATED             barrier>=30
      340      14,019     157  GATED             GATED             barrier>=30
      403      17,169     157  GATED             GATED             barrier>=30
      568      25,419     157  GATED             GATED             barrier>=30
