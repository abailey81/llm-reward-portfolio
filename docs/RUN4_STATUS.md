...
**Auto-generated 2026-08-06 00:00 UTC -- T+194h51m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+194h51m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **806** (69 running, 737 queued) |
| **cores computing** | **552** |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,384     230  GATED             GATED             barrier>=30
      279      10,434     230  GATED             GATED             barrier>=30
      340      13,179     230  GATED             GATED             barrier>=30
      403      16,014     230  GATED             GATED             barrier>=30
      568      23,447     230  GATED             GATED             barrier>=30
