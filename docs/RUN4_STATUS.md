...
**Auto-generated 2026-08-05 13:44 UTC -- T+184h35m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+184h35m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 2.9 h ago; none live, newest failure 40 min ago** |
...
```
generated 2026-08-05 13:44 UTC | elapsed 7.69 d | 21.4 d to the Aug-27 stop
test tier: 15,149 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,779      84  GATED             GATED             barrier>=30
      403      16,929      84  GATED             GATED             barrier>=30
      568      25,179      84  GATED             GATED             barrier>=30
