...
**Auto-generated 2026-08-04 17:38 UTC -- T+164h29m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+164h29m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=1; worst streak 21/240 (8.8% to fatal), pull on core, 5.1 h ago; none live, newest failure 1.8 h ago** |
...
| | |
|---|---|
| cluster jobs | **212** (210 running, 0 queued) |
...
```
generated 2026-08-04 17:39 UTC | elapsed 6.85 d | 22.3 d to the Aug-27 stop
test tier: 12,116 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     224 records     224.0 rec/h
    last  3 h     544 records     181.3 rec/h
    last 12 h    2281 records     190.1 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (190 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      28,212     224  GATED             GATED             barrier>=30
