...
**Auto-generated 2026-08-04 17:06 UTC -- T+163h57m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+163h57m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=11; worst streak 21/240 (8.8% to fatal), pull on core, 4.6 h ago; none live, newest failure 77 min ago** |
...
| | |
|---|---|
| cluster jobs | **222** (220 running, 0 queued) |
...
```
generated 2026-08-04 17:06 UTC | elapsed 6.83 d | 22.3 d to the Aug-27 stop
test tier: 11,969 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      28,359     147  GATED             GATED             barrier>=30
