...
**Auto-generated 2026-08-05 05:35 UTC -- T+176h26m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+176h26m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 33 min ago; none live, newest failure 33 min ago** |
...
```
generated 2026-08-05 05:35 UTC | elapsed 7.35 d | 21.8 d to the Aug-27 stop
test tier: 13,732 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,238      82  GATED             GATED             barrier>=30
      189       7,646     124  GATED             GATED             barrier>=30
      279      12,146     124  GATED             GATED             barrier>=30
      340      15,196     124  GATED             GATED             barrier>=30
      403      18,346     124  GATED             GATED             barrier>=30
      568      26,596     124  GATED             GATED             barrier>=30
