...
**Auto-generated 2026-08-06 00:40 UTC -- T+195h31m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h31m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,717     125  GATED             GATED             barrier>=30
      189       6,282     165  GATED             GATED             barrier>=30
      279      10,330     167  GATED             GATED             barrier>=30
      340      13,075     167  GATED             GATED             barrier>=30
      403      15,910     167  GATED             GATED             barrier>=30
      568      23,343     167  GATED             GATED             barrier>=30
