...
```
generated 2026-08-06 05:22 UTC | elapsed 8.34 d | 20.8 d to the Aug-27 stop
test tier: 17,182 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,085      72  GATED             GATED             barrier>=30
      279      10,133      72  GATED             GATED             barrier>=30
      340      12,878      72  GATED             GATED             barrier>=30
      403      15,713      72  GATED             GATED             barrier>=30
      568      23,146      72  GATED             GATED             barrier>=30
