...
**Auto-generated 2026-08-06 09:31 UTC -- T+204h22m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+204h22m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **944** |
| **cores doing RUNG-RAISING work** | **20.7%** -- 200 of 968 cores (12 min old) |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,771     123  GATED             GATED             barrier>=30
      279       9,819     123  GATED             GATED             barrier>=30
      340      12,564     123  GATED             GATED             barrier>=30
      403      15,399     123  GATED             GATED             barrier>=30
      568      22,832     123  GATED             GATED             barrier>=30
