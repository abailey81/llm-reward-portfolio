...
```
generated 2026-08-06 03:55 UTC | elapsed 8.28 d | 20.8 d to the Aug-27 stop
test tier: 17,083 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h       5 records       5.0 rec/h
    last  3 h      86 records      28.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,620       5  GATED             GATED             barrier>=30
      189       6,184       5  GATED             GATED             barrier>=30
      279      10,232       5  GATED             GATED             barrier>=30
      340      12,977       5  GATED             GATED             barrier>=30
      403      15,812       5  GATED             GATED             barrier>=30
      568      23,245       5  GATED             GATED             barrier>=30
