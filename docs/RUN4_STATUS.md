...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 6 min ago; LIVE, still failing** |
...
| **cores computing** | **688** |
| **cores doing RUNG-RAISING work** | **22.6%** -- 184 of 816 cores (116 min old **STALE**) |
...
```
generated 2026-08-06 14:40 UTC | elapsed 8.73 d | 20.4 d to the Aug-27 stop
