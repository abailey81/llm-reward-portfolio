...
**Auto-generated 2026-08-06 11:18 UTC -- T+206h09m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+206h09m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 11:19 UTC | elapsed 8.59 d | 20.5 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,689      46  GATED             GATED             barrier>=30
      279       9,722      61  GATED             GATED             barrier>=30
      340      12,467      61  GATED             GATED             barrier>=30
      403      15,302      61  GATED             GATED             barrier>=30
      568      22,735      61  GATED             GATED             barrier>=30
