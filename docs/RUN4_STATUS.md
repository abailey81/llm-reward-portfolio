...
**Auto-generated 2026-08-03 08:24 UTC -- T+131h15m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+131h15m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **908** (272 running, 636 queued) |
| **cores computing** | **2176** |

Per-rung ETAs from the registered model at the cores we actually hold:

```
 rung             @2176 cores              @830 cores   binding
...
| scalar | g5 of 5 | 1244 |
| placebo | g5 of 5 | 1358 |
| scalar_cvar5 | g5 of 5 | 1330 |
| placebo_shuffled | g5 of 5 | 1345 |
