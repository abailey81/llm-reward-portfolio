...
**Auto-generated 2026-08-03 11:56 UTC -- T+134h47m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+134h47m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **738** (162 running, 576 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 2078 |
| scalar | g5 of 5 | 1490 |
| placebo | g5 of 5 | 1624 |
| scalar_cvar5 | g5 of 5 | 1591 |
| placebo_shuffled | g5 of 5 | 1604 |
...
```
2026-08-03T11:43:44Z  RED  records=8750 (+16)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=1.8m  drift=0  sci=OK  r115=21B  sweep=110.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T11:46:04Z  RED  records=8757 (+7)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=0.9m  drift=0  sci=OK  r115=21B  sweep=80.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T11:47:55Z  RED  records=8759 (+2)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=21B  sweep=77.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T11:49:42Z  RED  records=8767 (+8)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=1.7m  drift=0  sci=OK  r115=21B  sweep=108.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
