...
```
generated 2026-08-06 01:55 UTC | elapsed 8.20 d | 20.9 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,662      44  GATED             GATED             barrier>=30
      189       6,226      44  GATED             GATED             barrier>=30
      279      10,274      44  GATED             GATED             barrier>=30
      340      13,019      44  GATED             GATED             barrier>=30
      403      15,854      44  GATED             GATED             barrier>=30
      568      23,287      44  GATED             GATED             barrier>=30
