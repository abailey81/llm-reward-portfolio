...
| transport health | **timeouts 6h=0; worst streak 11/240 (4.6% to fatal), pull on core, 3.7 h ago; none live, newest failure 3.7 h ago** |
...
| **cores computing** | **816** |
| **cores doing RUNG-RAISING work** | **29.4%** -- 240 of 816 cores (13 min old) |
...
```
generated 2026-08-06 20:38 UTC | elapsed 8.98 d | 20.1 d to the Aug-27 stop
