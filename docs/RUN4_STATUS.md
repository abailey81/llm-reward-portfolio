...
**Auto-generated 2026-08-04 18:22 UTC -- T+165h13m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+165h13m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 21/240 (8.8% to fatal), pull on core, 5.9 h ago; none live, newest failure 2.6 h ago** |
...
| | |
|---|---|
| cluster jobs | **181** (179 running, 0 queued) |
...
```
generated 2026-08-04 18:22 UTC | elapsed 6.88 d | 22.2 d to the Aug-27 stop
test tier: 12,291 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     263 records     263.0 rec/h
    last  3 h     583 records     194.3 rec/h
    last 12 h    2362 records     196.8 rec/h
    last 24 h    4209 records     175.4 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,892      12  GATED             GATED             barrier>=30
      189       8,342      12  GATED             GATED             barrier>=30
      279      12,842      12  GATED             GATED             barrier>=30
      340      15,892      12  GATED             GATED             barrier>=30
      403      19,042      12  GATED             GATED             barrier>=30
      568      28,037     263  GATED             GATED             barrier>=30
    ...
    !! 91% of the rung-568 backlog (25,646 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
