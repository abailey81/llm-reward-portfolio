...
**Auto-generated 2026-08-05 08:46 UTC -- T+179h37m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+179h37m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 1.5 h ago; none live, newest failure 1.5 h ago** |
...
| | |
|---|---|
| cluster jobs | **883** (193 running, 690 queued) |
...
```
generated 2026-08-05 08:46 UTC | elapsed 7.48 d | 21.6 d to the Aug-27 stop
test tier: 14,551 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     270 records     270.0 rec/h
    last  3 h     755 records     251.7 rec/h
    last 12 h    1739 records     144.9 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,078     152  GATED             GATED             barrier>=30
      189       7,081     154  GATED             GATED             barrier>=30
      279      11,327     270  GATED             GATED             barrier>=30
      340      14,377     270  GATED             GATED             barrier>=30
      403      17,527     270  GATED             GATED             barrier>=30
      568      25,777     270  GATED             GATED             barrier>=30
...
```
2026-08-05T08:29:44Z  OK  records=16023 (+8)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  sweep=98.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T08:31:58Z  OK  records=16029 (+6)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.6m  drift=0  sci=OK  r115=22B  sweep=103.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T08:36:43Z  OK  records=16044 (+15)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=254.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
