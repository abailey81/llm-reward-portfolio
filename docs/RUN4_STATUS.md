...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.8 h ago; none live, newest failure 46 min ago** |
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    3531 records     147.1 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,710     110  GATED             GATED             barrier>=30
      189       6,274     136  GATED             GATED             barrier>=30
      279      10,322     138  GATED             GATED             barrier>=30
      340      13,067     138  GATED             GATED             barrier>=30
      403      15,902     138  GATED             GATED             barrier>=30
      568      23,335     138  GATED             GATED             barrier>=30
