...
| **cores computing** | **984** |
| **cores doing RUNG-RAISING work** | **20.8%** -- 208 of 1000 cores (20 min old) |
...
```
generated 2026-08-06 09:12 UTC | elapsed 8.50 d | 20.6 d to the Aug-27 stop
test tier: 17,427 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,840      64  GATED             GATED             barrier>=30
      279       9,888      64  GATED             GATED             barrier>=30
      340      12,633      64  GATED             GATED             barrier>=30
      403      15,468      64  GATED             GATED             barrier>=30
      568      22,901      64  GATED             GATED             barrier>=30
