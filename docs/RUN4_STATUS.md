...
**Auto-generated 2026-08-04 23:46 UTC -- T+170h37m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+170h37m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 76 min ago; none live, newest failure 10 min ago** |
...
| | |
|---|---|
| cluster jobs | **977** (167 running, 808 queued) |
...
```
generated 2026-08-04 23:47 UTC | elapsed 7.11 d | 22.0 d to the Aug-27 stop
test tier: 13,322 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     191 records     191.0 rec/h
    last  3 h     506 records     168.7 rec/h
    last 12 h    2241 records     186.8 rec/h
    last 24 h    4247 records     177.0 rec/h
    12 h rate is 59% from ONE line (test_leg_sonnet_5); 10 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,340       2  GATED             GATED             barrier>=30
      189       7,790       2  GATED             GATED             barrier>=30
      279      12,290       2  GATED             GATED             barrier>=30
      340      15,340       2  GATED             GATED             barrier>=30
      403      18,490       2  GATED             GATED             barrier>=30
      568      27,006     191  GATED             GATED             barrier>=30
