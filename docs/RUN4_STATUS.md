...
```
generated 2026-08-06 06:12 UTC | elapsed 8.38 d | 20.7 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    1265 records     105.4 rec/h
    last 24 h    3388 records     141.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,960     145  GATED             GATED             barrier>=30
      279      10,008     145  GATED             GATED             barrier>=30
      340      12,753     145  GATED             GATED             barrier>=30
      403      15,588     145  GATED             GATED             barrier>=30
      568      23,021     145  GATED             GATED             barrier>=30
