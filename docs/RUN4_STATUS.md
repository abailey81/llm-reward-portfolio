...
**Auto-generated 2026-08-12 06:59 UTC -- T+345h50m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+345h50m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 0/240 (0.0% to fatal), - on -, age UNKNOWN; none live, newest failure 13.3 h ago** |
...
| | |
|---|---|
| cluster jobs | **448** = 119 running + **1 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **952** |
| **cores doing RUNG-RAISING work** | **78.3%** -- 720 of 920 cores (86 min old) |
...
```
generated 2026-08-12 07:00 UTC | elapsed 14.41 d | 14.7 d to the Aug-27 stop
test tier: 30,566 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    2209 records      92.0 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279           0      17  REACHED           REACHED           yes
      340       1,210      92  2026-08-13 01:48  2026-08-13 01:48  yes
      403       3,415      92  2026-08-14 12:05  2026-08-14 12:05  yes
      568       9,762     106  2026-08-18 14:44  2026-08-18 14:44  yes
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung      @952 cores      @830 cores   binding
       30           4.6 d           4.6 d   critical_chain
      100           4.6 d           4.6 d   critical_chain
      189           5.7 d           6.5 d   throughput
      279           8.1 d           9.3 d   throughput
      340           9.7 d          11.1 d   throughput
      403          11.4 d          13.0 d   throughput
      568          15.8 d          18.1 d   throughput
...
```
2026-08-12T06:23:38Z  OK  records=32052 (+5)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  sweep=56.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T06:25:05Z  OK  records=32057 (+5)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  sweep=56.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T06:26:30Z  OK  records=32060 (+3)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.2m  drift=0  sci=OK  r115=22B  sweep=55.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T06:27:57Z  OK  records=32064 (+4)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.0m  drift=0  sci=OK  r115=22B  sweep=56.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
