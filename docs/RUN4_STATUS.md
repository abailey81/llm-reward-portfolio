...
**Auto-generated 2026-08-05 07:30 UTC -- T+178h21m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+178h21m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 07:30 UTC | elapsed 7.43 d | 21.7 d to the Aug-27 stop
test tier: 14,196 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,235       3  GATED             GATED             barrier>=30
      189       7,240     168  GATED             GATED             barrier>=30
      279      11,682     226  GATED             GATED             barrier>=30
      340      14,732     226  GATED             GATED             barrier>=30
      403      17,882     226  GATED             GATED             barrier>=30
      568      26,132     226  GATED             GATED             barrier>=30
