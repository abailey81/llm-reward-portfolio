...
**Auto-generated 2026-08-03 09:00 UTC -- T+131h51m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+131h51m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **876** (250 running, 626 queued) |
| **cores computing** | **2000** |

Per-rung ETAs from the registered model at the cores we actually hold:

```
 rung             @2000 cores              @830 cores   binding
...
|---|---|---|
| distributional | g5 of 5 | 1873 |
| scalar | g5 of 5 | 1295 |
| placebo | g5 of 5 | 1403 |
| scalar_cvar5 | g5 of 5 | 1375 |
| placebo_shuffled | g5 of 5 | 1390 |
