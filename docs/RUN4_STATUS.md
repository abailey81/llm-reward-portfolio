...
**Auto-generated 2026-08-05 05:57 UTC -- T+176h48m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+176h48m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 55 min ago; none live, newest failure 55 min ago** |
...
| | |
|---|---|
| cluster jobs | **964** (209 running, 755 queued) |
...
```
generated 2026-08-05 05:58 UTC | elapsed 7.37 d | 21.8 d to the Aug-27 stop
test tier: 13,852 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,238      67  GATED             GATED             barrier>=30
      189       7,526     229  GATED             GATED             barrier>=30
      279      12,026     229  GATED             GATED             barrier>=30
      340      15,076     229  GATED             GATED             barrier>=30
      403      18,226     229  GATED             GATED             barrier>=30
      568      26,476     229  GATED             GATED             barrier>=30
