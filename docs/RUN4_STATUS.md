...
| | |
|---|---|
| cluster jobs | **931** (116 running, 815 queued) |
| **cores computing** | **928** |
...
```
generated 2026-08-06 07:57 UTC | elapsed 8.45 d | 20.7 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    3042 records     126.8 rec/h   usable
