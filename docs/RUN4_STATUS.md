...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,625      25  GATED             GATED             barrier>=30
      189       6,189      25  GATED             GATED             barrier>=30
      279      10,237      25  GATED             GATED             barrier>=30
      340      12,982      25  GATED             GATED             barrier>=30
      403      15,817      25  GATED             GATED             barrier>=30
      568      23,250      25  GATED             GATED             barrier>=30
