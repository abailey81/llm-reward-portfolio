...
**Auto-generated 2026-08-04 23:28 UTC -- T+170h19m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+170h19m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 59 min ago; none live, newest failure 14 min ago** |
...
| | |
|---|---|
| cluster jobs | **987** (162 running, 823 queued) |
| **cores computing** | **1296** |
...
```
generated 2026-08-04 23:29 UTC | elapsed 7.10 d | 22.0 d to the Aug-27 stop
test tier: 13,283 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     205 records     205.0 rec/h
    last  3 h     566 records     188.7 rec/h
    last 12 h    2250 records     187.5 rec/h
    last 24 h    4269 records     177.9 rec/h
    12 h rate is 61% from ONE line (test_leg_sonnet_5); 10 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (73 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      27,045     205  GATED             GATED             barrier>=30
