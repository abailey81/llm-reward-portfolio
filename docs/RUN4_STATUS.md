...
| | |
|---|---|
| cluster jobs | **958** (69 running, 889 queued) |
| **cores computing** | **552** |
...
```
generated 2026-08-06 05:34 UTC | elapsed 8.35 d | 20.8 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,570      19  GATED             GATED             barrier>=30
      189       6,042     111  GATED             GATED             barrier>=30
      279      10,090     111  GATED             GATED             barrier>=30
      340      12,835     111  GATED             GATED             barrier>=30
      403      15,670     111  GATED             GATED             barrier>=30
      568      23,103     111  GATED             GATED             barrier>=30
