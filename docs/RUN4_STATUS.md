...
**Auto-generated 2026-08-02 14:34 UTC -- T+113h25m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+113h25m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **920** (233 running, 687 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1114 |
| scalar | g5 of 5 | 519 |
| placebo | g5 of 5 | 747 |
| scalar_cvar5 | g5 of 5 | 702 |
| placebo_shuffled | g5 of 5 | 692 |
...
```
2026-08-02T14:29:40Z  RED  records=4148 (+2)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.9m  drift=0  sci=OK  r115=21B  sweep=26.8s  auto-cycle
2026-08-02T14:30:38Z  RED  records=4152 (+4)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=21B  sweep=29.4s  auto-cycle
2026-08-02T14:31:37Z  RED  records=4155 (+3)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=21B  sweep=31.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T14:32:39Z  RED  records=4158 (+3)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=21B  sweep=28.0s  auto-cycle
2026-08-02T14:33:37Z  RED  records=4159 (+1)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=21B  sweep=28.7s  auto-cycle
