...
**Auto-generated 2026-08-06 17:58 UTC -- T+212h49m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+212h49m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=156; worst streak 11/240 (4.6% to fatal), pull on core, 62 min ago; none live, newest failure 60 min ago** |
...
| | |
|---|---|
| cluster jobs | **844** (72 running, 772 queued) |
| **cores computing** | **576** |
| **cores doing RUNG-RAISING work** | **28.3%** -- 136 of 480 cores (19 min old) |
...
```
2026-08-06T17:28:26Z  OK  records=19867 (+3)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.3m  drift=0  sci=OK  r115=22B  sweep=30.0s  auto-cycle
