...
**Auto-generated 2026-08-11 20:40 UTC -- T+335h31m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+335h31m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **496** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (68 min old) |
...
```
generated 2026-08-11 20:41 UTC | elapsed 13.98 d | 15.1 d to the Aug-27 stop
test tier: 29,927 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 112.7 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h    1352 records     112.7 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,672      90  GATED             GATED             barrier>=279
      403       3,877      90  GATED             GATED             barrier>=279
      568      10,401      90  GATED             GATED             barrier>=279
