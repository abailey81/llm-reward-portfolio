...
test tier: 17,392 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,875      31  GATED             GATED             barrier>=30
      279       9,923      31  GATED             GATED             barrier>=30
      340      12,668      31  GATED             GATED             barrier>=30
      403      15,503      31  GATED             GATED             barrier>=30
      568      22,936      31  GATED             GATED             barrier>=30
