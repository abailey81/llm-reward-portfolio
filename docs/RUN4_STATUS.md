...
**Auto-generated 2026-08-06 03:07 UTC -- T+197h58m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+197h58m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 3.0 h ago; none live, newest failure 3.0 h ago** |
...
```
generated 2026-08-06 03:07 UTC | elapsed 8.25 d | 20.9 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     171 records      57.0 rec/h
    last 12 h    1599 records     133.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,625      16  GATED             GATED             barrier>=30
      189       6,189      16  GATED             GATED             barrier>=30
      279      10,237      16  GATED             GATED             barrier>=30
      340      12,982      16  GATED             GATED             barrier>=30
      403      15,817      16  GATED             GATED             barrier>=30
      568      23,250      16  GATED             GATED             barrier>=30
