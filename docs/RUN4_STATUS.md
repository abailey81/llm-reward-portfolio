...
**Auto-generated 2026-08-05 12:29 UTC -- T+183h20m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+183h20m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=5; worst streak 1/240 (0.4% to fatal), ops on core, 5.2 h ago; none live, newest failure 1.7 h ago** |
...
```
generated 2026-08-05 12:29 UTC | elapsed 7.64 d | 21.5 d to the Aug-27 stop
test tier: 15,053 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     100 records     100.0 rec/h
    last  3 h     367 records     122.3 rec/h
    last 12 h    1627 records     135.6 rec/h
    last 24 h    3875 records     161.5 rec/h
    12 h rate is 64% from ONE line (test_leg_haiku_4_5); 5 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 10% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279      10,891      34  GATED             GATED             barrier>=30
      340      13,875     100  GATED             GATED             barrier>=30
      403      17,025     100  GATED             GATED             barrier>=30
      568      25,275     100  GATED             GATED             barrier>=30
...
2026-08-05T12:25:59Z  OK  records=16595 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.1m  drift=0  sci=OK  r115=22B  sweep=90.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T12:29:08Z  OK  records=16595 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  sweep=159.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
