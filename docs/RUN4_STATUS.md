...
**Auto-generated 2026-08-06 05:22 UTC -- T+200h13m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h13m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
test tier: 17,183 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,084      72  GATED             GATED             barrier>=30
      279      10,132      72  GATED             GATED             barrier>=30
      340      12,877      72  GATED             GATED             barrier>=30
      403      15,712      72  GATED             GATED             barrier>=30
      568      23,145      72  GATED             GATED             barrier>=30
