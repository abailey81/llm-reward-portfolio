...
**Auto-generated 2026-08-02 07:19 UTC -- T+106h10m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+106h10m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **390** (157 running, 233 queued) |
...
```
 rung             @1256 cores              @830 cores   binding
  ...
  279            6.1 d  08-04            9.3 d  08-07   throughput
  340            7.4 d  08-05           11.1 d  08-09   throughput
  403            8.6 d  08-06           13.0 d  08-10   throughput
  568           11.9 d  08-09           18.1 d  08-15   throughput
```
...
```
2026-08-02T07:14:43Z  RED  records=3342 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=3.7m  drift=0  sci=OK  r115=21B  sweep=18.4s  auto-cycle
2026-08-02T07:15:32Z  RED  records=3342 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=4.5m  drift=0  sci=OK  r115=21B  sweep=20.2s  auto-cycle
2026-08-02T07:16:22Z  RED  records=3343 (+1)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=21B  sweep=22.1s  auto-cycle
2026-08-02T07:17:15Z  RED  records=3343 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=1.7m  drift=0  sci=OK  r115=21B  sweep=21.4s  auto-cycle
2026-08-02T07:18:06Z  RED  records=3343 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=21B  sweep=38.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T07:19:15Z  RED  records=3343 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=3.2m  drift=0  sci=OK  r115=21B  sweep=20.9s  auto-cycle
```
