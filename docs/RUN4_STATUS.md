...
| | |
|---|---|
| cluster jobs | **938** (90 running, 848 queued) |
| **cores computing** | **720** |
...
```
generated 2026-08-06 06:25 UTC | elapsed 8.39 d | 20.7 d to the Aug-27 stop
test tier: 17,336 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,931     141  GATED             GATED             barrier>=30
      279       9,979     141  GATED             GATED             barrier>=30
      340      12,724     141  GATED             GATED             barrier>=30
      403      15,559     141  GATED             GATED             barrier>=30
      568      22,992     141  GATED             GATED             barrier>=30
