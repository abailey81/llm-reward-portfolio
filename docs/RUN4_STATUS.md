...
| **cores computing** | **952** |
| **cores doing RUNG-RAISING work** | **20.7%** -- 200 of 968 cores (8 min old) |
...
test tier: 17,479 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,788     111  GATED             GATED             barrier>=30
      279       9,836     111  GATED             GATED             barrier>=30
      340      12,581     111  GATED             GATED             barrier>=30
      403      15,416     111  GATED             GATED             barrier>=30
      568      22,849     111  GATED             GATED             barrier>=30
