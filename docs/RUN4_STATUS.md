...
**Auto-generated 2026-08-11 21:55 UTC -- T+336h46m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+336h46m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **415** = 79 running + **8 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **632** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (143 min old **STALE**) |
...
```
generated 2026-08-11 21:56 UTC | elapsed 14.03 d | 15.1 d to the Aug-27 stop
