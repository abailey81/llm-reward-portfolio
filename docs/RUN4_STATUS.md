...
**Auto-generated 2026-08-05 20:00 UTC -- T+190h51m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+190h51m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 57 min ago; none live, newest failure 57 min ago** |
...
| | |
|---|---|
| cluster jobs | **824** (116 running, 708 queued) |
| **cores computing** | **928** |
...
```
generated 2026-08-05 20:01 UTC | elapsed 7.95 d | 21.2 d to the Aug-27 stop
test tier: 16,237 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      81 records      81.0 rec/h
    last  3 h     437 records     145.7 rec/h
    last 12 h    1900 records     158.3 rec/h
    last 24 h    3617 records     150.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      24,091      81  GATED             GATED             barrier>=30
