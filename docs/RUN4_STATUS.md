...
test tier: 17,380 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,887      21  GATED             GATED             barrier>=30
      279       9,935      21  GATED             GATED             barrier>=30
      340      12,680      21  GATED             GATED             barrier>=30
      403      15,515      21  GATED             GATED             barrier>=30
      568      22,948      21  GATED             GATED             barrier>=30
