...
**Auto-generated 2026-08-05 06:04 UTC -- T+176h55m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+176h55m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 62 min ago; none live, newest failure 62 min ago** |
...
```
generated 2026-08-05 06:05 UTC | elapsed 7.37 d | 21.7 d to the Aug-27 stop
test tier: 13,883 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     250 records     250.0 rec/h
    last  3 h     286 records      95.3 rec/h
    last 12 h    1653 records     137.8 rec/h
    last 24 h    3987 records     166.1 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,238      57  GATED             GATED             barrier>=30
      189       7,495     250  GATED             GATED             barrier>=30
      279      11,995     250  GATED             GATED             barrier>=30
      340      15,045     250  GATED             GATED             barrier>=30
      403      18,195     250  GATED             GATED             barrier>=30
      568      26,445     250  GATED             GATED             barrier>=30
