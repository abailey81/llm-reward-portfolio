...
**Auto-generated 2026-08-05 06:31 UTC -- T+177h22m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+177h22m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 89 min ago; none live, newest failure 89 min ago** |
...
| | |
|---|---|
| cluster jobs | **948** (207 running, 741 queued) |
...
```
generated 2026-08-05 06:31 UTC | elapsed 7.39 d | 21.7 d to the Aug-27 stop
test tier: 13,972 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     253 records     253.0 rec/h
    last  3 h     369 records     123.0 rec/h
    last 12 h    1652 records     137.7 rec/h
    last 24 h    4022 records     167.6 rec/h
    12 h rate is 37% from ONE line (test_leg_haiku_4_5); 10 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,238       1  GATED             GATED             barrier>=30
      189       7,406     253  GATED             GATED             barrier>=30
      279      11,906     253  GATED             GATED             barrier>=30
      340      14,956     253  GATED             GATED             barrier>=30
      403      18,106     253  GATED             GATED             barrier>=30
      568      26,356     253  GATED             GATED             barrier>=30
