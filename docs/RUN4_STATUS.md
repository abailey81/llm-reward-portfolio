...
**Auto-generated 2026-08-04 22:35 UTC -- T+169h26m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+169h26m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 5 min ago; LIVE, still failing** |
...
```
generated 2026-08-04 22:35 UTC | elapsed 7.06 d | 22.1 d to the Aug-27 stop
test tier: 13,092 records over 68 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     102 records     102.0 rec/h
    last  3 h     555 records     185.0 rec/h
    last 12 h    2191 records     182.6 rec/h
    last 24 h    4310 records     179.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      27,236     102  GATED             GATED             barrier>=30
