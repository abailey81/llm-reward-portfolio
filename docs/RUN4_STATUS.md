...
```
generated 2026-08-06 02:42 UTC | elapsed 8.23 d | 20.9 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,627      49  GATED             GATED             barrier>=30
      189       6,191      49  GATED             GATED             barrier>=30
      279      10,239      49  GATED             GATED             barrier>=30
      340      12,984      49  GATED             GATED             barrier>=30
      403      15,819      49  GATED             GATED             barrier>=30
      568      23,252      49  GATED             GATED             barrier>=30
