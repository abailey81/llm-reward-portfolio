...
**Auto-generated 2026-08-04 23:00 UTC -- T+169h51m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+169h51m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 30 min ago; none live, newest failure 30 min ago** |
...
| | |
|---|---|
| cluster jobs | **990** (159 running, 829 queued) |
...
```
generated 2026-08-04 23:01 UTC | elapsed 7.08 d | 22.0 d to the Aug-27 stop
test tier: 13,185 records over 68 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     162 records     162.0 rec/h
    last  3 h     566 records     188.7 rec/h
    last 12 h    2233 records     186.1 rec/h
    last 24 h    4300 records     179.2 rec/h
    12 h rate is 65% from ONE line (test_leg_sonnet_5); 10 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 65% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_sonnet_5, test_leg_gpt_5_6_luna) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (65 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         240       3  GATED             GATED             barrier
      100       3,341       9  GATED             GATED             barrier>=30
      189       7,791       9  GATED             GATED             barrier>=30
      279      12,291       9  GATED             GATED             barrier>=30
      340      15,341       9  GATED             GATED             barrier>=30
      403      18,491       9  GATED             GATED             barrier>=30
      568      27,143     162  GATED             GATED             barrier>=30
