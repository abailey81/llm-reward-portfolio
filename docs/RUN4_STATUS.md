...
**Auto-generated 2026-08-11 19:31 UTC -- T+334h22m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+334h22m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **512** |
| **cores doing RUNG-RAISING work** | **4.8%** -- 24 of 504 cores (118 min old **STALE**) |
...
```
generated 2026-08-11 19:32 UTC | elapsed 13.93 d | 15.2 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,777      44  GATED             GATED             barrier>=279
      403       3,982      44  GATED             GATED             barrier>=279
      568      10,506      44  GATED             GATED             barrier>=279
