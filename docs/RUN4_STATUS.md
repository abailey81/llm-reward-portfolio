...
**Auto-generated 2026-08-11 21:48 UTC -- T+336h39m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+336h39m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **417** = 75 running + **14 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **600** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (136 min old **STALE**) |
...
```
generated 2026-08-11 21:49 UTC | elapsed 14.03 d | 15.1 d to the Aug-27 stop
