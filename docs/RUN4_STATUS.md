...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 4.3 h ago; none live, newest failure 4.3 h ago** |
...
```
generated 2026-08-06 04:20 UTC | elapsed 8.30 d | 20.8 d to the Aug-27 stop
test tier: 17,104 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      25 records      25.0 rec/h
    last  3 h      96 records      32.0 rec/h
    last 12 h    1451 records     120.9 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,599      25  GATED             GATED             barrier>=30
      189       6,163      25  GATED             GATED             barrier>=30
      279      10,211      25  GATED             GATED             barrier>=30
      340      12,956      25  GATED             GATED             barrier>=30
      403      15,791      25  GATED             GATED             barrier>=30
      568      23,224      25  GATED             GATED             barrier>=30
