...
**Auto-generated 2026-08-03 03:08 UTC -- T+125h59m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+125h59m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **978** (291 running, 687 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1660 |
| scalar | g5 of 5 | 1071 |
| placebo | g5 of 5 | 1203 |
| scalar_cvar5 | g5 of 5 | 1168 |
| placebo_shuffled | g5 of 5 | 1168 |
...
```
2026-08-03T02:57:26Z  RED  records=6642 (+1)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=28.0m  drift=0  sci=OK  r115=21B  sweep=72.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T02:59:08Z  RED  records=6646 (+4)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=29.8m  drift=0  sci=OK  r115=21B  sweep=74.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T03:00:54Z  RED  records=6648 (+2)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=31.5m  drift=0  sci=OK  r115=21B  sweep=64.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T03:02:28Z  RED  records=6651 (+3)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=33.1m  drift=0  sci=OK  r115=21B  sweep=80.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T03:04:19Z  RED  records=6660 (+9)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=36.3m  drift=0  sci=OK  r115=21B  sweep=145.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T03:07:15Z  RED  records=6666 (+6)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=37.8m  drift=0  sci=OK  r115=21B  sweep=61.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
