...
**Auto-generated 2026-08-06 00:22 UTC -- T+195h13m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h13m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.3 h ago; none live, newest failure 18 min ago** |
...
| | |
|---|---|
| cluster jobs | **982** (66 running, 916 queued) |
| **cores computing** | **528** |
...
```
generated 2026-08-06 00:22 UTC | elapsed 8.13 d | 21.0 d to the Aug-27 stop
test tier: 16,967 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     236 records     236.0 rec/h
    last  3 h     561 records     187.0 rec/h
    last 12 h    1916 records     159.7 rec/h
    last 24 h    3556 records     148.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,729     171  GATED             GATED             barrier>=30
      189       6,299     235  GATED             GATED             barrier>=30
      279      10,348     236  GATED             GATED             barrier>=30
      340      13,093     236  GATED             GATED             barrier>=30
      403      15,928     236  GATED             GATED             barrier>=30
      568      23,361     236  GATED             GATED             barrier>=30
