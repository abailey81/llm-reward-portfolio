...
**Auto-generated 2026-08-06 01:52 UTC -- T+196h43m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+196h43m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 1.8 h ago; none live, newest failure 1.8 h ago** |
...
| | |
|---|---|
| cluster jobs | **969** (68 running, 901 queued) |
| **cores computing** | **544** |
...
```
generated 2026-08-06 01:53 UTC | elapsed 8.20 d | 20.9 d to the Aug-27 stop
test tier: 17,039 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,664      42  GATED             GATED             barrier>=30
      189       6,228      42  GATED             GATED             barrier>=30
      279      10,276      42  GATED             GATED             barrier>=30
      340      13,021      42  GATED             GATED             barrier>=30
      403      15,856      42  GATED             GATED             barrier>=30
      568      23,289      42  GATED             GATED             barrier>=30
...
```
2026-08-06T01:44:08Z  OK  records=18573 (+3)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=28.2s  auto-cycle
2026-08-06T01:45:05Z  OK  records=18573 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  sweep=27.4s  auto-cycle
