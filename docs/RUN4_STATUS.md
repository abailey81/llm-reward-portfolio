...
**Auto-generated 2026-08-02 06:52 UTC -- T+105h43m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+105h43m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **393** (144 running, 249 queued) |
...
```
 rung             @1152 cores              @830 cores   binding
  ...
  189            4.7 d  08-02            6.5 d  08-04   throughput
  279            6.7 d  08-04            9.3 d  08-07   throughput
  340            8.0 d  08-05           11.1 d  08-09   throughput
  403            9.4 d  08-07           13.0 d  08-10   throughput
  568           13.0 d  08-10           18.1 d  08-15   throughput
```
...
```
2026-08-02T06:48:15Z  RED  records=3334 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=20B  sweep=19.8s  auto-cycle
2026-08-02T06:49:05Z  RED  records=3335 (+1)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=3.4m  drift=0  sci=OK  r115=20B  sweep=21.5s  auto-cycle
2026-08-02T06:49:57Z  RED  records=3336 (+1)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=4.3m  drift=0  sci=OK  r115=20B  sweep=21.7s  auto-cycle
2026-08-02T06:50:49Z  RED  records=3336 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=20B  sweep=21.6s  auto-cycle
2026-08-02T06:51:41Z  RED  records=3336 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=20B  sweep=21.4s  auto-cycle
2026-08-02T06:52:32Z  RED  records=3336 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.0m  drift=0  sci=OK  r115=20B  sweep=21.2s  auto-cycle
```
