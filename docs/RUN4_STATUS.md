...
**Auto-generated 2026-08-05 07:47 UTC -- T+178h38m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+178h38m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 31 min ago; none live, newest failure 31 min ago** |
...
| | |
|---|---|
| cluster jobs | **911** (199 running, 712 queued) |
...
```
generated 2026-08-05 07:47 UTC | elapsed 7.44 d | 21.7 d to the Aug-27 stop
test tier: 14,286 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,230       8  GATED             GATED             barrier>=30
      189       7,235     107  GATED             GATED             barrier>=30
      279      11,592     250  GATED             GATED             barrier>=30
      340      14,642     250  GATED             GATED             barrier>=30
      403      17,792     250  GATED             GATED             barrier>=30
      568      26,042     250  GATED             GATED             barrier>=30
