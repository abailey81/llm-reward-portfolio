...
**Auto-generated 2026-08-05 05:21 UTC -- T+176h12m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+176h12m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 19 min ago; none live, newest failure 19 min ago** |
...
| | |
|---|---|
| cluster jobs | **985** (201 running, 784 queued) |
...
```
generated 2026-08-05 05:22 UTC | elapsed 7.34 d | 21.8 d to the Aug-27 stop
test tier: 13,672 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      68 records      68.0 rec/h
    last  3 h      80 records      26.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,258      66  GATED             GATED             barrier>=30
      189       7,706      68  GATED             GATED             barrier>=30
      279      12,206      68  GATED             GATED             barrier>=30
      340      15,256      68  GATED             GATED             barrier>=30
      403      18,406      68  GATED             GATED             barrier>=30
      568      26,656      68  GATED             GATED             barrier>=30
