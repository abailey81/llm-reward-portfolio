...
**Auto-generated 2026-08-06 10:00 UTC -- T+204h51m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+204h51m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **888** |
| **cores doing RUNG-RAISING work** | **20.3%** -- 184 of 904 cores (6 min old) |
...
```
generated 2026-08-06 10:00 UTC | elapsed 8.54 d | 20.6 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    12 h rate is 72% from ONE line (test_leg_kimi_k3); 4 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,743     123  GATED             GATED             barrier>=30
      279       9,791     123  GATED             GATED             barrier>=30
      340      12,536     123  GATED             GATED             barrier>=30
      403      15,371     123  GATED             GATED             barrier>=30
      568      22,804     123  GATED             GATED             barrier>=30
