...
```
generated 2026-08-06 09:28 UTC | elapsed 8.51 d | 20.6 d to the Aug-27 stop
test tier: 17,481 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,786     112  GATED             GATED             barrier>=30
      279       9,834     112  GATED             GATED             barrier>=30
      340      12,579     112  GATED             GATED             barrier>=30
      403      15,414     112  GATED             GATED             barrier>=30
      568      22,847     112  GATED             GATED             barrier>=30
