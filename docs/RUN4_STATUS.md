...
**Auto-generated 2026-08-05 07:50 UTC -- T+178h41m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+178h41m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 34 min ago; none live, newest failure 34 min ago** |
...
| | |
|---|---|
| cluster jobs | **909** (205 running, 704 queued) |
...
```
generated 2026-08-05 07:50 UTC | elapsed 7.45 d | 21.7 d to the Aug-27 stop
test tier: 14,296 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     241 records     241.0 rec/h
    last  3 h     678 records     226.0 rec/h
    last 12 h    1710 records     142.5 rec/h
    last 24 h    4110 records     171.2 rec/h
    12 h rate is 46% from ONE line (test_leg_haiku_4_5); 10 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,227      10  GATED             GATED             barrier>=30
      189       7,232      91  GATED             GATED             barrier>=30
      279      11,582     241  GATED             GATED             barrier>=30
      340      14,632     241  GATED             GATED             barrier>=30
      403      17,782     241  GATED             GATED             barrier>=30
      568      26,032     241  GATED             GATED             barrier>=30
...
```
2026-08-05T07:06:50Z  OK  records=15641 (+25)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  sweep=411.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
