...
**Auto-generated 2026-08-05 13:47 UTC -- T+184h38m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+184h38m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 3.0 h ago; none live, newest failure 43 min ago** |
...
| | |
|---|---|
| cluster jobs | **960** (193 running, 767 queued) |
...
```
generated 2026-08-05 13:48 UTC | elapsed 7.69 d | 21.4 d to the Aug-27 stop
test tier: 15,155 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      88 records      88.0 rec/h
    last  3 h     271 records      90.3 rec/h
    last 12 h    1588 records     132.3 rec/h
    last 24 h    3759 records     156.6 rec/h
    12 h rate is 72% from ONE line (test_leg_haiku_4_5); 5 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,773      88  GATED             GATED             barrier>=30
      403      16,923      88  GATED             GATED             barrier>=30
      568      25,173      88  GATED             GATED             barrier>=30
