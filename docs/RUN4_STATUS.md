...
**Auto-generated 2026-08-06 04:00 UTC -- T+198h51m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+198h51m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 3.9 h ago; none live, newest failure 3.9 h ago** |
...
| | |
|---|---|
| cluster jobs | **962** (68 running, 894 queued) |
| **cores computing** | **544** |
...
```
generated 2026-08-06 04:01 UTC | elapsed 8.29 d | 20.8 d to the Aug-27 stop
test tier: 17,092 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      14 records      14.0 rec/h
    last  3 h      94 records      31.3 rec/h
    last 12 h    1492 records     124.3 rec/h
    last 24 h    3488 records     145.3 rec/h
    12 h rate is 55% from ONE line (test_leg_haiku_4_5); 4 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,611      14  GATED             GATED             barrier>=30
      189       6,175      14  GATED             GATED             barrier>=30
      279      10,223      14  GATED             GATED             barrier>=30
      340      12,968      14  GATED             GATED             barrier>=30
      403      15,803      14  GATED             GATED             barrier>=30
      568      23,236      14  GATED             GATED             barrier>=30
...
```
2026-08-06T03:45:20Z  OK  records=18623 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.7m  drift=0  sci=OK  r115=22B  sweep=344.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T03:49:42Z  OK  records=18623 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.9m  drift=0  sci=OK  r115=22B  sweep=232.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T03:53:13Z  OK  records=18623 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  cores=544  sweep=181.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T03:54:10Z  OK  records=18625 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=26.2s  auto-cycle
2026-08-06T03:55:08Z  OK  records=18626 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.5m  drift=0  sci=OK  r115=22B  sweep=27.9s  auto-cycle
2026-08-06T04:00:50Z  OK  records=18634 (+8)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.0m  drift=0  sci=OK  r115=22B  sweep=311.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
