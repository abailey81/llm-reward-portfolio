...
**Auto-generated 2026-08-02 06:25 UTC -- T+105h16m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+105h16m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **393** (132 running, 261 queued) |
...
```
 rung             @1056 cores              @830 cores   binding
  ...
  189            5.1 d  08-03            6.5 d  08-04   throughput
  279            7.3 d  08-05            9.3 d  08-07   throughput
  340            8.7 d  08-06           11.1 d  08-09   throughput
  403           10.3 d  08-08           13.0 d  08-10   throughput
  568           14.2 d  08-12           18.1 d  08-15   throughput
```
...
| scalar | g5 of 5 | 326 |
| placebo | g5 of 5 | 618 |
| scalar_cvar5 | g5 of 5 | 553 |
| placebo_shuffled | g5 of 5 | 526 |
...
```
2026-08-02T06:20:33Z  RED  records=3323 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=20B  cores=1064  sweep=28.9s  auto-cycle
2026-08-02T06:21:32Z  RED  records=3323 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=20B  sweep=21.3s  auto-cycle
2026-08-02T06:22:24Z  RED  records=3323 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=20B  sweep=20.6s  auto-cycle
2026-08-02T06:23:14Z  RED  records=3323 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=20B  sweep=21.2s  auto-cycle
2026-08-02T06:24:06Z  RED  records=3324 (+1)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=3.6m  drift=0  sci=OK  r115=20B  sweep=21.4s  auto-cycle
2026-08-02T06:24:57Z  RED  records=3324 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=20B  sweep=40.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
...
```
  ...
  openrouter  spent $  8.7234  + still to author $  0.0411  = $  8.7645   credited $ 19.3100   margin $ +10.5455 (+55%)  comfortable
```
