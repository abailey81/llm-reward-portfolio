...
**Auto-generated 2026-08-05 06:14 UTC -- T+177h05m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+177h05m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 72 min ago; none live, newest failure 72 min ago** |
...
| | |
|---|---|
| cluster jobs | **955** (208 running, 747 queued) |
...
```
generated 2026-08-05 06:14 UTC | elapsed 7.38 d | 21.7 d to the Aug-27 stop
test tier: 13,922 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     272 records     272.0 rec/h
    last  3 h     323 records     107.7 rec/h
    last 12 h    1663 records     138.6 rec/h
    last 24 h    4006 records     166.9 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,238      40  GATED             GATED             barrier>=30
      189       7,456     272  GATED             GATED             barrier>=30
      279      11,956     272  GATED             GATED             barrier>=30
      340      15,006     272  GATED             GATED             barrier>=30
      403      18,156     272  GATED             GATED             barrier>=30
      568      26,406     272  GATED             GATED             barrier>=30
