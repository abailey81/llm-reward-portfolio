...
**Auto-generated 2026-08-05 07:55 UTC -- T+178h46m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+178h46m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 39 min ago; none live, newest failure 39 min ago** |
...
| | |
|---|---|
| cluster jobs | **908** (206 running, 702 queued) |
...
```
generated 2026-08-05 07:55 UTC | elapsed 7.45 d | 21.7 d to the Aug-27 stop
test tier: 14,315 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     243 records     243.0 rec/h
    last  3 h     693 records     231.0 rec/h
    last 12 h    1715 records     142.9 rec/h
    last 24 h    4112 records     171.3 rec/h
    12 h rate is 47% from ONE line (test_leg_haiku_4_5); 10 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 36% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       7,228      78  GATED             GATED             barrier>=30
      279      11,563     243  GATED             GATED             barrier>=30
      340      14,613     243  GATED             GATED             barrier>=30
      403      17,763     243  GATED             GATED             barrier>=30
      568      26,013     243  GATED             GATED             barrier>=30
