...
**Auto-generated 2026-08-05 13:35 UTC -- T+184h27m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+184h27m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 2.8 h ago; none live, newest failure 31 min ago** |
...
| | |
|---|---|
| cluster jobs | **963** (196 running, 767 queued) |
...
```
generated 2026-08-05 13:36 UTC | elapsed 7.69 d | 21.4 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,798      75  GATED             GATED             barrier>=30
      403      16,948      75  GATED             GATED             barrier>=30
      568      25,198      75  GATED             GATED             barrier>=30
