...
**Auto-generated 2026-08-05 04:54 UTC -- T+175h45m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+175h45m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 2.6 h ago; none live, newest failure 2.6 h ago** |
...
```
generated 2026-08-05 04:55 UTC | elapsed 7.32 d | 21.8 d to the Aug-27 stop
test tier: 13,618 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      14 records      14.0 rec/h
    last  3 h      44 records      14.7 rec/h
    last 12 h    1685 records     140.4 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,310      14  GATED             GATED             barrier>=30
      189       7,760      14  GATED             GATED             barrier>=30
      279      12,260      14  GATED             GATED             barrier>=30
      340      15,310      14  GATED             GATED             barrier>=30
      403      18,460      14  GATED             GATED             barrier>=30
      568      26,710      14  GATED             GATED             barrier>=30
