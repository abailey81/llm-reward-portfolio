...
**Auto-generated 2026-08-06 01:09 UTC -- T+196h00m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+196h00m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 65 min ago; none live, newest failure 65 min ago** |
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     479 records     159.7 rec/h
    last 12 h    1907 records     158.9 rec/h
    last 24 h    3497 records     145.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,703      77  GATED             GATED             barrier>=30
      189       6,267      86  GATED             GATED             barrier>=30
      279      10,315      88  GATED             GATED             barrier>=30
      340      13,060      88  GATED             GATED             barrier>=30
      403      15,895      88  GATED             GATED             barrier>=30
      568      23,328      88  GATED             GATED             barrier>=30
