...
**Auto-generated 2026-08-05 16:59 UTC -- T+187h50m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+187h50m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 3.9 h ago; none live, newest failure 3.9 h ago** |
...
| | |
|---|---|
| cluster jobs | **884** (169 running, 715 queued) |
...
```
generated 2026-08-05 16:59 UTC | elapsed 7.83 d | 21.3 d to the Aug-27 stop
test tier: 15,788 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     191 records     191.0 rec/h
    last  3 h     588 records     196.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      403      16,471      15  GATED             GATED             barrier>=30
      568      24,540     191  GATED             GATED             barrier>=30
...
2026-08-05T16:54:12Z  OK  records=17311 (+27)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.7m  drift=0  sci=OK  r115=22B  cores=1336  sweep=408.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T17:01:52Z  OK  records=17331 (+20)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.5m  drift=0  sci=OK  r115=22B  sweep=430.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
