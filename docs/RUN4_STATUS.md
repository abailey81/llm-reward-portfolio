...
**Auto-generated 2026-08-06 04:50 UTC -- T+199h41m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+199h41m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 04:51 UTC | elapsed 8.32 d | 20.8 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    1364 records     113.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,576      47  GATED             GATED             barrier>=30
      189       6,135      52  GATED             GATED             barrier>=30
      279      10,183      52  GATED             GATED             barrier>=30
      340      12,928      52  GATED             GATED             barrier>=30
      403      15,763      52  GATED             GATED             barrier>=30
      568      23,196      52  GATED             GATED             barrier>=30
