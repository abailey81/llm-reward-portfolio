...
```
generated 2026-08-06 05:31 UTC | elapsed 8.35 d | 20.8 d to the Aug-27 stop
test tier: 17,215 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     102 records     102.0 rec/h
    last  3 h     141 records      47.0 rec/h
    last 12 h    1312 records     109.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,052     102  GATED             GATED             barrier>=30
      279      10,100     102  GATED             GATED             barrier>=30
      340      12,845     102  GATED             GATED             barrier>=30
      403      15,680     102  GATED             GATED             barrier>=30
      568      23,113     102  GATED             GATED             barrier>=30
