...
| **cores computing** | **824** |
| **cores doing RUNG-RAISING work** | **22.1%** -- 184 of 832 cores (3 min old) |
...
```
generated 2026-08-06 12:16 UTC | elapsed 8.63 d | 20.5 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,698      25  GATED             GATED             barrier>=30
      340      12,443      25  GATED             GATED             barrier>=30
      403      15,278      25  GATED             GATED             barrier>=30
      568      22,711      25  GATED             GATED             barrier>=30
