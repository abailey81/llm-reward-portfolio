...
test tier: 16,930 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     229 records     229.0 rec/h
    last  3 h     533 records     177.7 rec/h
    last 12 h    1884 records     157.0 rec/h
    last 24 h    3538 records     147.4 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,764     145  GATED             GATED             barrier>=30
      189       6,336     228  GATED             GATED             barrier>=30
      279      10,385     229  GATED             GATED             barrier>=30
      340      13,130     229  GATED             GATED             barrier>=30
      403      15,965     229  GATED             GATED             barrier>=30
      568      23,398     229  GATED             GATED             barrier>=30
