...
**Auto-generated 2026-08-05 11:44 UTC -- T+182h35m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+182h35m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=5; worst streak 1/240 (0.4% to fatal), ops on core, 4.5 h ago; none live, newest failure 55 min ago** |
...
| | |
|---|---|
| cluster jobs | **984** (186 running, 798 queued) |
...
```
generated 2026-08-05 11:44 UTC | elapsed 7.61 d | 21.5 d to the Aug-27 stop
test tier: 14,987 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     111 records     111.0 rec/h
    last  3 h     437 records     145.7 rec/h
    last 12 h    1669 records     139.1 rec/h
    last 24 h    3908 records     162.8 rec/h
    12 h rate is 59% from ONE line (test_leg_haiku_4_5); 5 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 16% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (139 rec/h); latest excludes cells already within
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         180       1  GATED             GATED             barrier
      100       2,980       1  GATED             GATED             barrier>=30
      189       6,841       3  GATED             GATED             barrier>=30
      279      10,898     104  GATED             GATED             barrier>=30
      340      13,941     111  GATED             GATED             barrier>=30
      403      17,091     111  GATED             GATED             barrier>=30
      568      25,341     111  GATED             GATED             barrier>=30
...
```
2026-08-05T11:27:33Z  ATTN  records=16488 (+11)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.0m  drift=0  sci=OK  r115=22B  cores=1464  sweep=514.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T11:29:43Z  ATTN  records=16494 (+6)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  sweep=99.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T11:34:08Z  ATTN  records=16500 (+6)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.5m  drift=0  sci=OK  r115=22B  sweep=234.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T11:40:13Z  ATTN  records=16519 (+19)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=335.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T11:42:49Z  ATTN  records=16524 (+5)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  sweep=125.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T11:44:53Z  ATTN  records=16530 (+6)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=93.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
