...
**Auto-generated 2026-08-06 23:55 UTC -- T+218h46m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+218h46m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **856** |
| **cores doing RUNG-RAISING work** | **33.6%** -- 288 of 856 cores (15 min old) |
...
```
generated 2026-08-06 23:55 UTC | elapsed 9.12 d | 20.0 d to the Aug-27 stop
...
```
2026-08-06T23:28:51Z  OK  records=19970 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.9m  drift=0  sci=OK  r115=22B  sweep=497.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
