...
**Auto-generated 2026-08-06 10:08 UTC -- T+204h59m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+204h59m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **888** |
| **cores doing RUNG-RAISING work** | **20.3%** -- 184 of 904 cores (14 min old) |
...
```
generated 2026-08-06 10:09 UTC | elapsed 8.54 d | 20.6 d to the Aug-27 stop
test tier: 17,527 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    12 h rate is 74% from ONE line (test_leg_kimi_k3); 4 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,740     111  GATED             GATED             barrier>=30
      279       9,788     111  GATED             GATED             barrier>=30
      340      12,533     111  GATED             GATED             barrier>=30
      403      15,368     111  GATED             GATED             barrier>=30
      568      22,801     111  GATED             GATED             barrier>=30
...
```
2026-08-06T09:50:26Z  OK  records=19059 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.0m  drift=0  sci=OK  r115=22B  cores=904  sweep=224.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
