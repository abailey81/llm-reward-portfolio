...
**Auto-generated 2026-08-05 07:17 UTC -- T+178h08m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+178h08m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **926** (201 running, 725 queued) |
...
```
generated 2026-08-05 07:18 UTC | elapsed 7.42 d | 21.7 d to the Aug-27 stop
test tier: 14,139 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       7,249     195  GATED             GATED             barrier>=30
      279      11,739     205  GATED             GATED             barrier>=30
      340      14,789     205  GATED             GATED             barrier>=30
      403      17,939     205  GATED             GATED             barrier>=30
      568      26,189     205  GATED             GATED             barrier>=30
