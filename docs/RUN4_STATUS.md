...
**Auto-generated 2026-08-03 01:54 UTC -- T+124h45m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+124h45m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **978** (285 running, 693 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1592 |
| scalar | g5 of 5 | 1011 |
| placebo | g5 of 5 | 1161 |
| scalar_cvar5 | g5 of 5 | 1131 |
| placebo_shuffled | g5 of 5 | 1116 |
...
2026-08-03T01:47:40Z  RED  records=6382 (+32)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=3.9m  drift=0  sci=OK  r115=21B  sweep=103.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T01:49:54Z  RED  records=6385 (+3)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=3.8m  drift=0  sci=OK  r115=21B  sweep=49.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T01:51:14Z  RED  records=6394 (+9)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=3.4m  drift=0  sci=OK  r115=21B  sweep=61.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T01:52:46Z  RED  records=6405 (+11)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=21B  sweep=54.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T01:54:12Z  RED  records=6409 (+4)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=21B  sweep=50.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
