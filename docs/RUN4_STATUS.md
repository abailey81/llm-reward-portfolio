...
**Auto-generated 2026-08-05 14:37 UTC -- T+185h28m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+185h28m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **939** (184 running, 755 queued) |
...
```
generated 2026-08-05 14:38 UTC | elapsed 7.73 d | 21.4 d to the Aug-27 stop
test tier: 15,335 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,636     158  GATED             GATED             barrier>=30
      403      16,743     201  GATED             GATED             barrier>=30
      568      24,993     201  GATED             GATED             barrier>=30
