...
**Auto-generated 2026-08-06 03:12 UTC -- T+198h03m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+198h03m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 3.1 h ago; none live, newest failure 3.1 h ago** |
...
```
generated 2026-08-06 03:12 UTC | elapsed 8.25 d | 20.9 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    12 h rate is 59% from ONE line (test_leg_haiku_4_5); 4 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 59% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_haiku_4_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,624      15  GATED             GATED             barrier>=30
      189       6,188      15  GATED             GATED             barrier>=30
      279      10,236      15  GATED             GATED             barrier>=30
      340      12,981      15  GATED             GATED             barrier>=30
      403      15,816      15  GATED             GATED             barrier>=30
      568      23,249      15  GATED             GATED             barrier>=30
...
2026-08-06T03:04:16Z  OK  records=18621 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.0m  drift=0  sci=OK  r115=22B  cores=552  sweep=185.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T03:11:34Z  OK  records=18621 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.0m  drift=0  sci=OK  r115=22B  sweep=407.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
