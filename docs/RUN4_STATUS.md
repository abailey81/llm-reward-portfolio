...
```
generated 2026-08-06 04:49 UTC | elapsed 8.32 d | 20.8 d to the Aug-27 stop
test tier: 17,128 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      48 records      48.0 rec/h
    last  3 h      92 records      30.7 rec/h
    last 12 h    1366 records     113.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,139      48  GATED             GATED             barrier>=30
      279      10,187      48  GATED             GATED             barrier>=30
      340      12,932      48  GATED             GATED             barrier>=30
      403      15,767      48  GATED             GATED             barrier>=30
      568      23,200      48  GATED             GATED             barrier>=30
