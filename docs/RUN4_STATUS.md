...
**Auto-generated 2026-08-05 02:40 UTC -- T+173h31m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+173h31m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 4.2 h ago; none live, newest failure 24 min ago** |
...
| | |
|---|---|
| cluster jobs | **993** (182 running, 811 queued) |
...
```
generated 2026-08-05 02:41 UTC | elapsed 7.23 d | 21.9 d to the Aug-27 stop
test tier: 13,594 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      43 records      43.0 rec/h
    last  3 h     284 records      94.7 rec/h
    last 12 h    2015 records     167.9 rec/h
    last 24 h    4165 records     173.5 rec/h
    12 h rate is 41% from ONE line (test_leg_sonnet_5); 10 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (168 rec/h); latest excludes cells already within
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,324       8  GATED             GATED             barrier>=30
      189       7,774       8  GATED             GATED             barrier>=30
      279      12,274       8  GATED             GATED             barrier>=30
      340      15,324       8  GATED             GATED             barrier>=30
      403      18,474       8  GATED             GATED             barrier>=30
      568      26,734      43  GATED             GATED             barrier>=30
