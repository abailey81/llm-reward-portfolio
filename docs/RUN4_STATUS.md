...
```
generated 2026-08-06 06:22 UTC | elapsed 8.38 d | 20.7 d to the Aug-27 stop
test tier: 17,326 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,941     143  GATED             GATED             barrier>=30
      279       9,989     143  GATED             GATED             barrier>=30
      340      12,734     143  GATED             GATED             barrier>=30
      403      15,569     143  GATED             GATED             barrier>=30
      568      23,002     143  GATED             GATED             barrier>=30
