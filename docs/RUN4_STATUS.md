...
**Auto-generated 2026-08-06 20:02 UTC -- T+214h53m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+214h53m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **816** |
| **cores doing RUNG-RAISING work** | **30.3%** -- 240 of 792 cores (9 min old) |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,641      37  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,476      37  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,909      37  GATED             GATED             no-records:test/distributional,test/scalar>=30
