...
**Auto-generated 2026-08-06 01:24 UTC -- T+196h15m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+196h15m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 80 min ago; none live, newest failure 80 min ago** |
...
```
generated 2026-08-06 01:24 UTC | elapsed 8.18 d | 20.9 d to the Aug-27 stop
test tier: 17,008 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,695      30  GATED             GATED             barrier>=30
      189       6,259      36  GATED             GATED             barrier>=30
      279      10,307      37  GATED             GATED             barrier>=30
      340      13,052      37  GATED             GATED             barrier>=30
      403      15,887      37  GATED             GATED             barrier>=30
      568      23,320      37  GATED             GATED             barrier>=30
...
2026-08-06T01:20:19Z  OK  records=18547 (+3)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.5m  drift=0  sci=OK  r115=22B  sweep=391.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
