...
```
generated 2026-08-06 04:54 UTC | elapsed 8.32 d | 20.8 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    1356 records     113.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,575      45  GATED             GATED             barrier>=30
      189       6,132      52  GATED             GATED             barrier>=30
      279      10,180      52  GATED             GATED             barrier>=30
      340      12,925      52  GATED             GATED             barrier>=30
      403      15,760      52  GATED             GATED             barrier>=30
      568      23,193      52  GATED             GATED             barrier>=30
