...
**Auto-generated 2026-08-11 21:07 UTC -- T+335h58m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+335h58m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on deepseek-v4-pro, 3.5 h ago; none live, newest failure 3.5 h ago** |
...
| | |
|---|---|
| cluster jobs | **421** = 69 running + **24 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **552** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (94 min old **STALE**) |
...
```
generated 2026-08-11 21:08 UTC | elapsed 14.00 d | 15.1 d to the Aug-27 stop
test tier: 29,950 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,649      71  GATED             GATED             barrier>=279
      403       3,854      71  GATED             GATED             barrier>=279
      568      10,378      71  GATED             GATED             barrier>=279
