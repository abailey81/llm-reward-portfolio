...
**Auto-generated 2026-08-04 18:47 UTC -- T+165h38m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+165h38m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on nemotron-3-super, 3.0 h ago; none live, newest failure 3.0 h ago** |
...
| | |
|---|---|
| cluster jobs | **172** (170 running, 0 queued) |
...
```
generated 2026-08-04 18:47 UTC | elapsed 6.90 d | 22.2 d to the Aug-27 stop
test tier: 12,363 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     203 records     203.0 rec/h
    last  3 h     588 records     196.0 rec/h
    last 12 h    2388 records     199.0 rec/h
    last 24 h    4262 records     177.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,867      37  GATED             GATED             barrier>=30
      189       8,317      37  GATED             GATED             barrier>=30
      279      12,817      37  GATED             GATED             barrier>=30
      340      15,867      37  GATED             GATED             barrier>=30
      403      19,017      37  GATED             GATED             barrier>=30
      568      27,965     203  GATED             GATED             barrier>=30
