...
**Auto-generated 2026-08-04 00:16 UTC -- T+147h07m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+147h07m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=39; worst streak 2/240 (0.8% to fatal), pull on core** |
| transport timeouts (cumulative, ever) | 163 -- a level with no rate; read the row above |
...
| | |
|---|---|
| cluster jobs | **494** (205 running, 289 queued) |
| **cores computing** | **1640** |
...
```
generated 2026-08-04 00:16 UTC | elapsed 6.13 d | 23.0 d to the Aug-27 stop
test tier: 9,166 records over 62 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     202 records     202.0 rec/h
    last  3 h     681 records     227.0 rec/h
    last 12 h    1828 records     152.3 rec/h
    last 24 h    4666 records     194.4 rec/h
    12 h rate is 85% from ONE line (test_leg_qwen3_5_9b); 3 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 14% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_gpt_5_6_luna) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         428       0  2026-08-04 22:32  2026-08-04 22:32  yes
      100       4,278       0  2026-08-05 04:21  2026-08-05 08:51  yes
      189       9,173       0  2026-08-06 12:29  2026-08-06 22:07  yes
      279      14,123      12  2026-08-07 20:59  2026-08-08 11:49  yes
      340      17,495     181  2026-08-08 19:07  2026-08-09 13:29  yes
      403      21,254     202  2026-08-09 19:48  2026-08-10 18:06  yes
      568      31,162     202  2026-08-12 12:50  2026-08-13 21:33  yes
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung     @1640 cores      @830 cores   binding
...
```
2026-08-03T23:51:00Z  RED  records=10632 (+21)  spend=$45.5019  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  sweep=277.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T23:56:08Z  RED  records=10648 (+16)  spend=$45.5019  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=22B  sweep=172.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T23:59:31Z  RED  records=10653 (+5)  spend=$45.5019  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  sweep=188.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T00:03:10Z  RED  records=10668 (+15)  spend=$45.5019  guards=2  arms_full=10/10  budget=2  stalest=3.3m  drift=0  sci=OK  r115=22B  sweep=241.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T00:07:42Z  RED  records=10680 (+12)  spend=$45.5019  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  sweep=216.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T00:11:49Z  RED  records=10686 (+6)  spend=$45.5019  guards=2  arms_full=10/10  budget=2  stalest=5.2m  drift=0  sci=OK  r115=22B  sweep=192.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
