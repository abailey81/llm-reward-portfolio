...
**Auto-generated 2026-08-04 18:10 UTC -- T+165h01m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+165h01m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **189** (187 running, 0 queued) |
...
```
generated 2026-08-04 18:11 UTC | elapsed 6.88 d | 22.2 d to the Aug-27 stop
test tier: 12,252 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     263 records     263.0 rec/h
    last  3 h     574 records     191.3 rec/h
    last 12 h    2343 records     195.2 rec/h
    last 24 h    4186 records     174.4 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,902       2  GATED             GATED             barrier>=30
      189       8,352       2  GATED             GATED             barrier>=30
      279      12,852       2  GATED             GATED             barrier>=30
      340      15,902       2  GATED             GATED             barrier>=30
      403      19,052       2  GATED             GATED             barrier>=30
      568      28,076     263  GATED             GATED             barrier>=30
    ...
    !! 95% of the rung-568 backlog (26,722 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
