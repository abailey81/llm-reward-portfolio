...
**Auto-generated 2026-08-06 06:56 UTC -- T+201h47m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+201h47m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **931** (100 running, 831 queued) |
| **cores computing** | **800** |
...
```
generated 2026-08-06 06:57 UTC | elapsed 8.41 d | 20.7 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    1210 records     100.8 rec/h
    last 24 h    3279 records     136.6 rec/h
    12 h rate is 48% from ONE line (test_leg_kimi_k3); 4 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 23% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_haiku_4_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,908      85  GATED             GATED             barrier>=30
      279       9,956      85  GATED             GATED             barrier>=30
      340      12,701      85  GATED             GATED             barrier>=30
      403      15,536      85  GATED             GATED             barrier>=30
      568      22,969      85  GATED             GATED             barrier>=30
...
```
2026-08-06T06:38:23Z  OK  records=18900 (+7)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  sweep=300.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T06:39:23Z  OK  records=18900 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=29.5s  auto-cycle
2026-08-06T06:40:20Z  OK  records=18901 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  sweep=27.6s  auto-cycle
2026-08-06T06:46:33Z  OK  records=18902 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.7m  drift=0  sci=OK  r115=22B  sweep=342.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T06:47:32Z  OK  records=18902 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=28.2s  auto-cycle
2026-08-06T06:52:15Z  OK  records=18902 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  cores=784  sweep=253.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
