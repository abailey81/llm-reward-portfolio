...
**Auto-generated 2026-08-06 00:32 UTC -- T+195h23m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h23m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.5 h ago; none live, newest failure 28 min ago** |
...
| | |
|---|---|
| cluster jobs | **975** (65 running, 910 queued) |
| **cores computing** | **520** |
...
```
generated 2026-08-06 00:32 UTC | elapsed 8.14 d | 21.0 d to the Aug-27 stop
test tier: 16,983 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     202 records     202.0 rec/h
    last  3 h     570 records     190.0 rec/h
    last 12 h    1930 records     160.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,718     153  GATED             GATED             barrier>=30
      189       6,284     200  GATED             GATED             barrier>=30
      279      10,332     202  GATED             GATED             barrier>=30
      340      13,077     202  GATED             GATED             barrier>=30
      403      15,912     202  GATED             GATED             barrier>=30
      568      23,345     202  GATED             GATED             barrier>=30
