...
**Auto-generated 2026-08-06 05:44 UTC -- T+200h35m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h35m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
test tier: 17,255 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     131 records     131.0 rec/h
    last  3 h     179 records      59.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,012     131  GATED             GATED             barrier>=30
      279      10,060     131  GATED             GATED             barrier>=30
      340      12,805     131  GATED             GATED             barrier>=30
      403      15,640     131  GATED             GATED             barrier>=30
      568      23,073     131  GATED             GATED             barrier>=30
