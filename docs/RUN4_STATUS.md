...
**Auto-generated 2026-08-05 13:06 UTC -- T+183h57m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+183h57m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on core, 5.8 h ago; LIVE, still failing** |
...
| | |
|---|---|
| cluster jobs | **966** (168 running, 798 queued) |
...
```
generated 2026-08-05 13:06 UTC | elapsed 7.67 d | 21.5 d to the Aug-27 stop
test tier: 15,091 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      52 records      52.0 rec/h
    last  3 h     335 records     111.7 rec/h
    last 12 h    1594 records     132.8 rec/h
    last 24 h    3788 records     157.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,837      52  GATED             GATED             barrier>=30
      403      16,987      52  GATED             GATED             barrier>=30
      568      25,237      52  GATED             GATED             barrier>=30
