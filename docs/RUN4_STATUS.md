...
**Auto-generated 2026-08-04 17:14 UTC -- T+164h05m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+164h05m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=11; worst streak 21/240 (8.8% to fatal), pull on core, 4.7 h ago; none live, newest failure 86 min ago** |
...
| | |
|---|---|
| cluster jobs | **220** (218 running, 0 queued) |
...
```
generated 2026-08-04 17:15 UTC | elapsed 6.84 d | 22.3 d to the Aug-27 stop
test tier: 12,005 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     166 records     166.0 rec/h
    last  3 h     516 records     172.0 rec/h
    last 12 h    2229 records     185.8 rec/h
    last 24 h    4008 records     167.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      28,323     166  GATED             GATED             barrier>=30
