...
**Auto-generated 2026-08-06 06:37 UTC -- T+201h28m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+201h28m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **932** (92 running, 840 queued) |
| **cores computing** | **736** |
...
```
generated 2026-08-06 06:37 UTC | elapsed 8.39 d | 20.7 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    1243 records     103.6 rec/h
    last 24 h    3361 records     140.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,910     124  GATED             GATED             barrier>=30
      279       9,958     124  GATED             GATED             barrier>=30
      340      12,703     124  GATED             GATED             barrier>=30
      403      15,538     124  GATED             GATED             barrier>=30
      568      22,971     124  GATED             GATED             barrier>=30
