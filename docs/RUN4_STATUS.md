...
**Auto-generated 2026-08-12 10:59 UTC -- T+349h50m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+349h50m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 0/240 (0.0% to fatal), - on -, age UNKNOWN; none live, newest failure 17.3 h ago** |
...
| | |
|---|---|
| cluster jobs | **404** = 85 running + **0 ELIGIBLE** + 319 held by us + 0 held only by the site |
...
| **cores computing** | **680** |
| **cores doing RUNG-RAISING work** | **100.0%** -- 776 of 776 cores (86 min old) |
...
```
generated 2026-08-12 10:59 UTC | elapsed 14.58 d | 14.5 d to the Aug-27 stop
test tier: 30,925 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 73.0 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    last  1 h     110 records     110.0 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last  3 h     292 records      97.3 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last 12 h     876 records      73.0 rec/h   usable
    last 24 h    2119 records      88.3 rec/h   usable
    12 h rate is 35% from ONE line (test); 4 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (73 rec/h); latest excludes cells already within
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340         851     110  2026-08-12 22:39  2026-08-12 22:39  yes
      403       3,056     110  2026-08-14 04:51  2026-08-14 04:51  yes
      568       9,403     110  2026-08-17 19:48  2026-08-17 19:48  yes
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung      @680 cores      @830 cores   binding
       30           4.6 d           4.6 d   critical_chain
      100           4.7 d           4.6 d   critical_chain
      189           8.0 d           6.5 d   throughput
      279          11.3 d           9.3 d   throughput
      340          13.6 d          11.1 d   throughput
      403          15.9 d          13.0 d   throughput
      568          22.1 d          18.1 d   throughput
...
currently at **319 seeds each** (read live from the archive on this publish). !! THE
...
```
2026-08-12T10:32:43Z  OK  records=32412 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.7m  drift=0  sci=OK  r115=22B  cores=720  sweep=67.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T10:34:08Z  OK  records=32413 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.5m  drift=0  sci=OK  r115=22B  sweep=54.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T10:35:32Z  OK  records=32413 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.9m  drift=0  sci=OK  r115=22B  sweep=54.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T10:36:58Z  OK  records=32414 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  sweep=55.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T10:38:21Z  OK  records=32417 (+3)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.5m  drift=0  sci=OK  r115=22B  sweep=53.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T10:51:03Z  OK  records=32431 (+14)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.0m  drift=0  sci=OK  r115=22B  sweep=731.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
