...
| | |
|---|---|
| cluster jobs | **931** (104 running, 827 queued) |
| **cores computing** | **832** |
...
```
generated 2026-08-06 07:05 UTC | elapsed 8.41 d | 20.7 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     264 records      88.0 rec/h
    last 12 h    1197 records      99.8 rec/h
    last 24 h    3251 records     135.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,908      66  GATED             GATED             barrier>=30
      279       9,956      66  GATED             GATED             barrier>=30
      340      12,701      66  GATED             GATED             barrier>=30
      403      15,536      66  GATED             GATED             barrier>=30
      568      22,969      66  GATED             GATED             barrier>=30
