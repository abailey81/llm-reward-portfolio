...
```
generated 2026-08-06 04:23 UTC | elapsed 8.30 d | 20.8 d to the Aug-27 stop
test tier: 17,110 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,593      31  GATED             GATED             barrier>=30
      189       6,157      31  GATED             GATED             barrier>=30
      279      10,205      31  GATED             GATED             barrier>=30
      340      12,950      31  GATED             GATED             barrier>=30
      403      15,785      31  GATED             GATED             barrier>=30
      568      23,218      31  GATED             GATED             barrier>=30
