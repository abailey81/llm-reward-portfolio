...
**Auto-generated 2026-08-07 00:27 UTC -- T+219h18m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+219h18m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **880** |
| **cores doing RUNG-RAISING work** | **33.6%** -- 288 of 856 cores (47 min old) |
...
```
generated 2026-08-07 00:27 UTC | elapsed 9.14 d | 20.0 d to the Aug-27 stop
test tier: 18,434 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    1458 records      60.8 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,505       5  GATED             GATED             no-records:test/distributional,test/scalar>=30
      189       5,620       5  GATED             GATED             no-records:test/distributional,test/scalar>=30
      279       9,150       5  GATED             GATED             no-records:test/distributional,test/scalar>=30
      340      11,626       7  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,461       7  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,894       7  GATED             GATED             no-records:test/distributional,test/scalar>=30
