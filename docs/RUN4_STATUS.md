...
| transport health | **timeouts 6h=107; worst streak 11/240 (4.6% to fatal), pull on core, 2.4 h ago; none live, newest failure 2.4 h ago** |
...
| **cores computing** | **688** |
| **cores doing RUNG-RAISING work** | **31.8%** -- 216 of 680 cores (26 min old) |
...
```
generated 2026-08-06 19:20 UTC | elapsed 8.92 d | 20.2 d to the Aug-27 stop
test tier: 18,394 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,666      27  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,501      27  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,934      27  GATED             GATED             no-records:test/distributional,test/scalar>=30
