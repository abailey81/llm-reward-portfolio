...
**Auto-generated 2026-08-06 15:38 UTC -- T+210h29m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+210h29m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 65 min ago; none live, newest failure 64 min ago** |
...
| | |
|---|---|
| cluster jobs | **852** (53 running, 799 queued) |
| **cores computing** | **424** |
| **cores doing RUNG-RAISING work** | **22.6%** -- 184 of 816 cores (175 min old **STALE**) |
...
```
generated 2026-08-06 15:39 UTC | elapsed 8.77 d | 20.3 d to the Aug-27 stop
test tier: 18,056 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 81.4 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h     977 records      81.4 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30          63      13  GATED             GATED             unstarted:2-unit(s)-absent
      100       2,513      13  GATED             GATED             unstarted:2-unit(s)-absent>=30
      189       5,628      13  GATED             GATED             unstarted:2-unit(s)-absent>=30
      279       9,259     271  GATED             GATED             unstarted:2-unit(s)-absent>=30
      340      12,004     271  GATED             GATED             unstarted:2-unit(s)-absent>=30
      403      14,839     271  GATED             GATED             unstarted:2-unit(s)-absent>=30
      568      22,272     271  GATED             GATED             unstarted:2-unit(s)-absent>=30
