...
**Auto-generated 2026-08-11 18:02 UTC -- T+332h53m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+332h53m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on core, 5.5 h ago; none live, newest failure 22 min ago** |
...
| **cores computing** | **520** |
| **cores doing RUNG-RAISING work** | **4.8%** -- 24 of 504 cores (29 min old) |
...
```
generated 2026-08-11 18:03 UTC | elapsed 13.87 d | 15.2 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279         128       8  GATED             GATED             barrier
      340       1,870     101  GATED             GATED             barrier>=279
      403       4,075     101  GATED             GATED             barrier>=279
      568      10,599     101  GATED             GATED             barrier>=279
