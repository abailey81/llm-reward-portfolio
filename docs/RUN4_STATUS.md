...
**Auto-generated 2026-08-05 12:31 UTC -- T+183h22m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+183h22m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 12:32 UTC | elapsed 7.64 d | 21.5 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     362 records     120.7 rec/h
    last 12 h    1623 records     135.2 rec/h
    last 24 h    3869 records     161.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279      10,891      28  GATED             GATED             barrier>=30
      340      13,875      94  GATED             GATED             barrier>=30
      403      17,025      94  GATED             GATED             barrier>=30
      568      25,275      94  GATED             GATED             barrier>=30
