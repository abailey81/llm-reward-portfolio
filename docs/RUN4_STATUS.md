...
**Auto-generated 2026-08-05 00:23 UTC -- T+171h14m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+171h14m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 1.9 h ago; none live, newest failure 47 min ago** |
...
| | |
|---|---|
| cluster jobs | **962** (168 running, 792 queued) |
...
```
generated 2026-08-05 00:23 UTC | elapsed 7.14 d | 22.0 d to the Aug-27 stop
test tier: 13,411 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     145 records     145.0 rec/h
    last  3 h     444 records     148.0 rec/h
    last 12 h    2246 records     187.2 rec/h
    ...
    !! 55% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_sonnet_5, test_leg_gpt_5_6_luna) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (84 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      26,917     145  GATED             GATED             barrier>=30
...
2026-08-05T00:23:01Z  OK  records=14944 (+11)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.2m  drift=0  sci=OK  r115=22B  sweep=356.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
