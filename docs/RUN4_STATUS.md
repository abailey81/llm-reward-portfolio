...
**Auto-generated 2026-08-05 15:35 UTC -- T+186h26m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+186h26m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 4.8 h ago; none live, newest failure 2.5 h ago** |
...
| | |
|---|---|
| cluster jobs | **910** (186 running, 724 queued) |
...
```
generated 2026-08-05 15:36 UTC | elapsed 7.77 d | 21.3 d to the Aug-27 stop
test tier: 15,553 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     218 records     218.0 rec/h
    last  3 h     498 records     166.0 rec/h
    last 12 h    1949 records     162.4 rec/h
    last 24 h    3805 records     158.5 rec/h
    12 h rate is 79% from ONE line (test_leg_haiku_4_5); 3 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      403      16,525     218  GATED             GATED             barrier>=30
      568      24,775     218  GATED             GATED             barrier>=30
