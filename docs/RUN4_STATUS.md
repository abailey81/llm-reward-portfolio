...
**Auto-generated 2026-08-05 23:57 UTC -- T+194h49m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
test tier: 16,874 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         120       6  GATED             GATED             barrier
      100       2,808     117  GATED             GATED             barrier>=30
      189       6,391     234  GATED             GATED             barrier>=30
      279      10,441     234  GATED             GATED             barrier>=30
      340      13,186     234  GATED             GATED             barrier>=30
      403      16,021     234  GATED             GATED             barrier>=30
      568      23,454     234  GATED             GATED             barrier>=30
