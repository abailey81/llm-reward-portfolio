...
**Auto-generated 2026-08-04 22:46 UTC -- T+169h37m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+169h37m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 16 min ago; none live, newest failure 16 min ago** |
...
```
generated 2026-08-04 22:46 UTC | elapsed 7.07 d | 22.1 d to the Aug-27 stop
test tier: 13,130 records over 68 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,342      21  GATED             GATED             barrier>=30
      189       7,792      21  GATED             GATED             barrier>=30
      279      12,292      21  GATED             GATED             barrier>=30
      340      15,342      21  GATED             GATED             barrier>=30
      403      18,492      21  GATED             GATED             barrier>=30
      568      27,198     128  GATED             GATED             barrier>=30
