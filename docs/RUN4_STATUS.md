...
**Auto-generated 2026-08-05 13:56 UTC -- T+184h47m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+184h47m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 3.1 h ago; none live, newest failure 52 min ago** |
...
| | |
|---|---|
| cluster jobs | **959** (191 running, 768 queued) |
...
```
generated 2026-08-05 13:57 UTC | elapsed 7.70 d | 21.4 d to the Aug-27 stop
test tier: 15,185 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     104 records     104.0 rec/h
    last  3 h     291 records      97.0 rec/h
    last 12 h    1611 records     134.2 rec/h
    last 24 h    3760 records     156.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,743     104  GATED             GATED             barrier>=30
      403      16,893     104  GATED             GATED             barrier>=30
      568      25,143     104  GATED             GATED             barrier>=30
