...
**Auto-generated 2026-08-05 05:08 UTC -- T+175h59m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+175h59m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 6 min ago; LIVE, still failing** |
...
```
generated 2026-08-05 05:09 UTC | elapsed 7.33 d | 21.8 d to the Aug-27 stop
test tier: 13,642 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,286      38  GATED             GATED             barrier>=30
      189       7,736      38  GATED             GATED             barrier>=30
      279      12,236      38  GATED             GATED             barrier>=30
      340      15,286      38  GATED             GATED             barrier>=30
      403      18,436      38  GATED             GATED             barrier>=30
      568      26,686      38  GATED             GATED             barrier>=30
