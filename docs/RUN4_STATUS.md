...
**Auto-generated 2026-08-02 12:48 UTC -- T+111h39m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+111h39m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **961** (230 running, 731 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1047 |
| scalar | g5 of 5 | 455 |
| placebo | g5 of 5 | 686 |
| scalar_cvar5 | g5 of 5 | 641 |
| placebo_shuffled | g5 of 5 | 629 |
...
```
2026-08-02T12:43:10Z  RED  records=3824 (+5)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.5m  drift=1  sci=OK  r115=21B  sweep=23.3s  auto-cycle
2026-08-02T12:44:04Z  RED  records=3829 (+5)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=4.5m  drift=1  sci=OK  r115=21B  sweep=28.6s  auto-cycle
2026-08-02T12:45:03Z  RED  records=3833 (+4)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=1  sci=OK  r115=21B  sweep=25.1s  auto-cycle
2026-08-02T12:45:58Z  RED  records=3835 (+2)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=1  sci=OK  r115=21B  sweep=24.9s  auto-cycle
2026-08-02T12:46:53Z  RED  records=3838 (+3)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=1+1dirty  sci=OK  r115=21B  sweep=26.2s  auto-cycle
2026-08-02T12:47:50Z  RED  records=3840 (+2)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.2m  drift=1  sci=OK  r115=21B  sweep=25.4s  auto-cycle
```
