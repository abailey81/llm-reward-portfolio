...
**Auto-generated 2026-08-04 02:44 UTC -- T+149h35m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+149h35m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-04 02:45 UTC | elapsed 6.23 d | 22.9 d to the Aug-27 stop
test tier: 9,439 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      403      20,986     119  GATED             GATED             barrier>=30
      568      30,889     124  GATED             GATED             barrier>=30
