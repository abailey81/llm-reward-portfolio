...
**Auto-generated 2026-08-06 01:16 UTC -- T+196h08m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
```
generated 2026-08-06 01:17 UTC | elapsed 8.17 d | 20.9 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,696      52  GATED             GATED             barrier>=30
      189       6,260      60  GATED             GATED             barrier>=30
      279      10,308      61  GATED             GATED             barrier>=30
      340      13,053      61  GATED             GATED             barrier>=30
      403      15,888      61  GATED             GATED             barrier>=30
      568      23,321      61  GATED             GATED             barrier>=30
