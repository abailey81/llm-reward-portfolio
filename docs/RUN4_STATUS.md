...
**Auto-generated 2026-08-06 12:45 UTC -- T+207h36m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+207h36m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=21; worst streak 2/240 (0.8% to fatal), ops on kimi-k3, 5 min ago; LIVE, still failing** |
...
```
generated 2026-08-06 12:46 UTC | elapsed 8.65 d | 20.5 d to the Aug-27 stop
test tier: 17,626 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    2560 records     106.7 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,689      26  GATED             GATED             barrier>=30
      340      12,434      26  GATED             GATED             barrier>=30
      403      15,269      26  GATED             GATED             barrier>=30
      568      22,702      26  GATED             GATED             barrier>=30
