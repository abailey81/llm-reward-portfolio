...
**Auto-generated 2026-08-06 17:38 UTC -- T+212h29m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+212h29m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=156; worst streak 11/240 (4.6% to fatal), pull on core, 42 min ago; none live, newest failure 40 min ago** |
...
| | |
|---|---|
| cluster jobs | **846** (60 running, 786 queued) |
| **cores computing** | **480** |
| **cores doing RUNG-RAISING work** | **27.7%** -- 144 of 520 cores (17 min old) |
