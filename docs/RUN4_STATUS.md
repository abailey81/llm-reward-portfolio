...
**Auto-generated 2026-08-01 12:31 UTC -- T+87h22m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+87h22m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| scalar | g5 of 5 | 296 |
| placebo | g5 of 5 | 287 |
| scalar_cvar5 | g5 of 5 | 266 |
| placebo_shuffled | g5 of 5 | 250 |
...
```
2026-08-01T12:27:06Z  RED  records=2367 (+1)  spend=$44.7632  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=17B  sweep=17.3s  auto-cycle
2026-08-01T12:27:54Z  RED  records=2367 (+0)  spend=$44.7632  guards=2  arms_full=10/10  budget=2  stalest=2.1m  drift=0  sci=OK  r115=17B  cores=968  sweep=18.8s  auto-cycle
2026-08-01T12:28:43Z  RED  records=2367 (+0)  spend=$44.7632  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=17B  sweep=16.8s  auto-cycle
2026-08-01T12:29:30Z  RED  records=2368 (+1)  spend=$44.7632  guards=2  arms_full=10/10  budget=2  stalest=1.9m  drift=0+1dirty  sci=OK  r115=17B  sweep=17.5s  auto-cycle
2026-08-01T12:30:17Z  RED  records=2368 (+0)  spend=$44.7632  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0+1dirty  sci=OK  r115=17B  sweep=17.1s  auto-cycle
2026-08-01T12:31:05Z  RED  records=2368 (+0)  spend=$44.7632  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0+1dirty  sci=OK  r115=17B  sweep=16.1s  auto-cycle
```
