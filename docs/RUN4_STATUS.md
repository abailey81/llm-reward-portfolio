...
**Auto-generated 2026-08-06 19:55 UTC -- T+214h46m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+214h46m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=80; worst streak 11/240 (4.6% to fatal), pull on core, 3.0 h ago; none live, newest failure 3.0 h ago** |
...
| | |
|---|---|
| cluster jobs | **835** = 101 running + **22 ELIGIBLE** + 712 held by us + 0 held only by the site |
...
| **cores computing** | **808** |
| **cores doing RUNG-RAISING work** | **30.3%** -- 240 of 792 cores (2 min old) |
...
```
generated 2026-08-06 19:56 UTC | elapsed 8.95 d | 20.2 d to the Aug-27 stop
