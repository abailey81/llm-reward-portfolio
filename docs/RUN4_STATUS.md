...
**Auto-generated 2026-08-06 13:10 UTC -- T+208h01m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+208h01m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=21; worst streak 2/240 (0.8% to fatal), ops on kimi-k3, 30 min ago; none live, newest failure 30 min ago** |
...
| **cores computing** | **808** |
| **cores doing RUNG-RAISING work** | **22.6%** -- 184 of 816 cores (26 min old) |
...
```
generated 2026-08-06 13:10 UTC | elapsed 8.67 d | 20.5 d to the Aug-27 stop
test tier: 17,636 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,679      22  GATED             GATED             barrier>=30
      340      12,424      22  GATED             GATED             barrier>=30
      403      15,259      22  GATED             GATED             barrier>=30
      568      22,692      22  GATED             GATED             barrier>=30
...
```
2026-08-06T12:56:55Z  ATTN  records=19174 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.9m  drift=0  sci=OK  r115=22B  sweep=29.7s  auto-cycle
2026-08-06T12:57:55Z  ATTN  records=19177 (+3)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.9m  drift=0  sci=OK  r115=22B  sweep=30.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
