...
**Auto-generated 2026-08-11 10:39 UTC -- T+325h30m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+325h30m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **571** = 136 running + **107 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores doing RUNG-RAISING work** | **87.4%** -- 1000 of 1144 cores (67 min old) |
...
```
generated 2026-08-11 10:40 UTC | elapsed 13.56 d | 15.6 d to the Aug-27 stop
test tier: 28,768 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    2405 records     100.2 rec/h   usable
    12 h rate is 61% from ONE line (test); 3 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279         696     102  2026-08-11 16:43  2026-08-11 16:43  yes
      340       2,831     102  2026-08-12 11:16  2026-08-12 11:16  yes
      403       5,036     102  2026-08-13 06:26  2026-08-13 06:26  yes
      568      11,560     102  2026-08-15 15:07  2026-08-15 15:07  yes
...
> **What is holding it right now: test -- baseline_return_minus_cvar has 157 HOLE(S) below its frontier 406 -- that is what caps this line**
