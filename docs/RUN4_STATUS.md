...
**Auto-generated 2026-08-06 06:20 UTC -- T+201h11m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+201h11m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,944     146  GATED             GATED             barrier>=30
      279       9,992     146  GATED             GATED             barrier>=30
      340      12,737     146  GATED             GATED             barrier>=30
      403      15,572     146  GATED             GATED             barrier>=30
      568      23,005     146  GATED             GATED             barrier>=30
