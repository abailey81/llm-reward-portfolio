...
**Auto-generated 2026-08-05 11:54 UTC -- T+182h45m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+182h45m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=5; worst streak 1/240 (0.4% to fatal), ops on core, 4.6 h ago; none live, newest failure 64 min ago** |
...
```
generated 2026-08-05 11:54 UTC | elapsed 7.62 d | 21.5 d to the Aug-27 stop
test tier: 15,015 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     124 records     124.0 rec/h
    last  3 h     423 records     141.0 rec/h
    last 12 h    1671 records     139.2 rec/h
    last 24 h    3924 records     163.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279      10,891      96  GATED             GATED             barrier>=30
      340      13,913     124  GATED             GATED             barrier>=30
      403      17,063     124  GATED             GATED             barrier>=30
      568      25,313     124  GATED             GATED             barrier>=30
