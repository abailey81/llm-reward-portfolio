...
**Auto-generated 2026-08-05 16:51 UTC -- T+187h42m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+187h42m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 3.8 h ago; none live, newest failure 3.8 h ago** |
...
| | |
|---|---|
| cluster jobs | **887** (167 running, 720 queued) |
...
```
generated 2026-08-05 16:51 UTC | elapsed 7.82 d | 21.3 d to the Aug-27 stop
test tier: 15,767 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     193 records     193.0 rec/h
    last  3 h     600 records     200.0 rec/h
    last 12 h    2149 records     179.1 rec/h
    last 24 h    3847 records     160.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      403      16,471      33  GATED             GATED             barrier>=30
      568      24,561     193  GATED             GATED             barrier>=30
    ...
    !! 84% of the rung-568 backlog (20,624 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
...
```
2026-08-05T16:12:25Z  OK  records=17175 (+24)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.9m  drift=0  sci=OK  r115=22B  cores=1424  sweep=401.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T16:21:32Z  OK  records=17186 (+11)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.0m  drift=0  sci=OK  r115=22B  sweep=517.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T16:26:56Z  OK  records=17215 (+29)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.7m  drift=0  sci=OK  r115=22B  sweep=294.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T16:33:02Z  OK  records=17234 (+19)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.0m  drift=0  sci=OK  r115=22B  cores=1384  sweep=335.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T16:40:37Z  OK  records=17260 (+26)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  sweep=424.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T16:46:53Z  ATTN  records=17284 (+24)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=99  stalest=3.0m  drift=0  sci=OK  r115=22B  sweep=346.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
