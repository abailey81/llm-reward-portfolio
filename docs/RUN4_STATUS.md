...
| | |
|---|---|
| cluster jobs | **932** (94 running, 838 queued) |
| **cores computing** | **752** |
...
```
generated 2026-08-06 06:39 UTC | elapsed 8.40 d | 20.7 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,909     121  GATED             GATED             barrier>=30
      279       9,957     121  GATED             GATED             barrier>=30
      340      12,702     121  GATED             GATED             barrier>=30
      403      15,537     121  GATED             GATED             barrier>=30
      568      22,970     121  GATED             GATED             barrier>=30
