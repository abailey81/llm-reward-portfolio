...
**Auto-generated 2026-08-05 07:23 UTC -- T+178h14m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+178h14m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 8 min ago; LIVE, still failing** |
...
| | |
|---|---|
| cluster jobs | **926** (203 running, 723 queued) |
...
```
generated 2026-08-05 07:24 UTC | elapsed 7.43 d | 21.7 d to the Aug-27 stop
test tier: 14,159 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     210 records     210.0 rec/h
    last  3 h     555 records     185.0 rec/h
    last 12 h    1657 records     138.1 rec/h
    last 24 h    4056 records     169.0 rec/h
    12 h rate is 43% from ONE line (test_leg_haiku_4_5); 10 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       7,247     182  GATED             GATED             barrier>=30
      279      11,719     210  GATED             GATED             barrier>=30
      340      14,769     210  GATED             GATED             barrier>=30
      403      17,919     210  GATED             GATED             barrier>=30
      568      26,169     210  GATED             GATED             barrier>=30
