...
| | |
|---|---|
| cluster jobs | **932** (91 running, 841 queued) |
| **cores computing** | **728** |
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    3362 records     140.1 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,912     126  GATED             GATED             barrier>=30
      279       9,960     126  GATED             GATED             barrier>=30
      340      12,705     126  GATED             GATED             barrier>=30
      403      15,540     126  GATED             GATED             barrier>=30
      568      22,973     126  GATED             GATED             barrier>=30
