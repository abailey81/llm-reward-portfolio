...
**Auto-generated 2026-08-06 20:39 UTC -- T+215h30m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+215h30m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **816** |
| **cores doing RUNG-RAISING work** | **29.4%** -- 240 of 816 cores (15 min old) |
...
```
generated 2026-08-06 20:40 UTC | elapsed 8.98 d | 20.1 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,641       2  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,476       2  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,909       2  GATED             GATED             no-records:test/distributional,test/scalar>=30
