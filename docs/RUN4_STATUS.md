...
**Auto-generated 2026-08-10 00:59 UTC -- T+291h50m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+291h50m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **26810** |
| **Myriad maintenance** | **2026-08-12 from 08:00 UTC, at risk all day** (in 2.3 days). Delayed from Aug 11. Jobs may die and REQUEUE idempotently; the supervisors ride it. Playbook: docs/ops/MAINTENANCE_2026-08-12.md |
| LLM calls / spend | 2956 / **$45.5021** |
| transport health | **timeouts 6h=0; worst streak 0/240 (0.0% to fatal), - on -, age UNKNOWN; none live, newest failure 8.4 h ago** |
...
| | |
|---|---|
| cluster jobs | **638** = 152 running + **110 ELIGIBLE** + 376 held by us + 0 held only by the site |
...
| **cores doing RUNG-RAISING work** | **100.0%** -- 1176 of 1176 cores (82 min old) |
...
```
generated 2026-08-10 01:00 UTC | elapsed 12.16 d | 17.0 d to the Aug-27 stop
test tier: 25,267 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 123.2 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last  3 h     205 records      68.3 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last 12 h    1479 records     123.2 rec/h   usable
    last 24 h    2490 records     103.8 rec/h   usable
    12 h rate is 70% from ONE line (test); 5 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (123 rec/h); latest excludes cells already within
    8 of the ceiling (123 rec/h). Window 12 h.
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189         474      56  2026-08-10 04:51  2026-08-10 04:51  yes
      279       3,621      59  2026-08-11 06:23  2026-08-11 06:23  yes
      340       5,756      59  2026-08-11 23:42  2026-08-11 23:42  yes
      403       7,985      66  2026-08-12 17:47  2026-08-12 17:47  yes
      568      15,061      66  2026-08-15 03:12  2026-08-15 03:12  yes
...
> **What is holding it right now: test -- baseline_log_growth has 235 HOLE(S) below its frontier 406 -- that is what caps this line**
...
|---|---|---|---|---|
| nemotron_3_super | **158** | 161 | 5 |  |
| test | **174** | 176 | 9 |  |
| glm_5_2 | **183** | 188 | 5 |  |
| deepseek_v4_pro | **186** | 191 | 5 |  |
| qwen3_6_27b | **397** | 399 | 5 |  |
| kimi_k3 | **471** | 474 | 5 |  |
...
currently at **172 seeds each** (read live from the archive on this publish). !! THE
...
```
2026-08-10T00:09:33Z  OK  records=26748 (+19)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.0m  drift=0  sci=OK  r115=22B  cores=1184  sweep=583.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-10T00:10:51Z  OK  records=26748 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.9m  drift=0  sci=OK  r115=22B  sweep=47.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-10T00:12:10Z  OK  records=26750 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=0.1m  drift=0  sci=OK  r115=22B  sweep=49.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-10T00:13:27Z  OK  records=26752 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.3m  drift=0  sci=OK  r115=22B  sweep=46.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-10T00:14:46Z  OK  records=26752 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=49.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-10T00:37:07Z  OK  records=26786 (+34)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.6m  drift=0  sci=OK  r115=22B  cores=1208  sweep=1311.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
