...
**Auto-generated 2026-08-06 16:06 UTC -- T+210h57m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+210h57m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 1.6 h ago; none live, newest failure 1.5 h ago** |
...
| | |
|---|---|
| cluster jobs | **876** (48 running, 828 queued) |
| **cores computing** | **384** |
| **cores doing RUNG-RAISING work** | **17.0%** -- 72 of 424 cores (27 min old) |
