...
**Auto-generated 2026-08-05 13:30 UTC -- T+184h21m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+184h21m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 2.7 h ago; none live, newest failure 26 min ago** |
...
```
generated 2026-08-05 13:31 UTC | elapsed 7.68 d | 21.4 d to the Aug-27 stop
test tier: 15,126 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      73 records      73.0 rec/h
    last  3 h     282 records      94.0 rec/h
    last 12 h    1587 records     132.2 rec/h
    last 24 h    3772 records     157.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,802      73  GATED             GATED             barrier>=30
      403      16,952      73  GATED             GATED             barrier>=30
      568      25,202      73  GATED             GATED             barrier>=30
