...
**Auto-generated 2026-08-05 08:19 UTC -- T+179h10m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+179h10m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 63 min ago; none live, newest failure 63 min ago** |
...
| | |
|---|---|
| cluster jobs | **895** (195 running, 700 queued) |
...
```
generated 2026-08-05 08:19 UTC | elapsed 7.47 d | 21.7 d to the Aug-27 stop
test tier: 14,437 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     289 records     289.0 rec/h
    last  3 h     769 records     256.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,171      65  GATED             GATED             barrier>=30
      189       7,176      71  GATED             GATED             barrier>=30
      279      11,441     289  GATED             GATED             barrier>=30
      340      14,491     289  GATED             GATED             barrier>=30
      403      17,641     289  GATED             GATED             barrier>=30
      568      25,891     289  GATED             GATED             barrier>=30
