...
**Auto-generated 2026-08-06 17:10 UTC -- T+212h01m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+212h01m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=156; worst streak 11/240 (4.6% to fatal), pull on core, 14 min ago; none live, newest failure 12 min ago** |
...
| | |
|---|---|
| cluster jobs | **854** (61 running, 793 queued) |
| **cores computing** | **488** |
| **cores doing RUNG-RAISING work** | **17.0%** -- 72 of 424 cores (91 min old **STALE**) |
...
```
2026-08-06T16:50:28Z  ATTN  records=19739 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=825.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T16:51:28Z  ATTN  records=19739 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=30.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T16:52:28Z  ATTN  records=19739 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  sweep=29.6s  auto-cycle
2026-08-06T16:53:28Z  ATTN  records=19739 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  sweep=29.7s  auto-cycle
