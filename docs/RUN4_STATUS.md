...
test tier: 17,423 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,844      60  GATED             GATED             barrier>=30
      279       9,892      60  GATED             GATED             barrier>=30
      340      12,637      60  GATED             GATED             barrier>=30
      403      15,472      60  GATED             GATED             barrier>=30
      568      22,905      60  GATED             GATED             barrier>=30
