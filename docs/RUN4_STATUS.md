...
**Auto-generated 2026-08-05 07:59 UTC -- T+178h50m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+178h50m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 44 min ago; none live, newest failure 44 min ago** |
...
| | |
|---|---|
| cluster jobs | **905** (204 running, 701 queued) |
...
```
generated 2026-08-05 08:00 UTC | elapsed 7.45 d | 21.7 d to the Aug-27 stop
test tier: 14,333 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     243 records     243.0 rec/h
    last  3 h     709 records     236.3 rec/h
    last 12 h    1717 records     143.1 rec/h
    last 24 h    4106 records     171.1 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       7,224      64  GATED             GATED             barrier>=30
      279      11,545     243  GATED             GATED             barrier>=30
      340      14,595     243  GATED             GATED             barrier>=30
      403      17,745     243  GATED             GATED             barrier>=30
      568      25,995     243  GATED             GATED             barrier>=30
