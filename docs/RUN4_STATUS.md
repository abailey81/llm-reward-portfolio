...
**Auto-generated 2026-08-11 21:35 UTC -- T+336h26m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+336h26m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **584** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (123 min old **STALE**) |
...
```
generated 2026-08-11 21:36 UTC | elapsed 14.02 d | 15.1 d to the Aug-27 stop
test tier: 29,975 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    2707 records     112.8 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,624      54  GATED             GATED             barrier>=279
      403       3,829      54  GATED             GATED             barrier>=279
      568      10,353      54  GATED             GATED             barrier>=279
