...
**Auto-generated 2026-08-05 17:32 UTC -- T+188h23m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+188h23m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=5; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 4.5 h ago; none live, newest failure 4.5 h ago** |
...
| | |
|---|---|
| cluster jobs | **870** (156 running, 714 queued) |
...
```
generated 2026-08-05 17:32 UTC | elapsed 7.85 d | 21.3 d to the Aug-27 stop
test tier: 15,905 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      24,423     210  GATED             GATED             barrier>=30
