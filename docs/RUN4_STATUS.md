...
**Auto-generated 2026-08-06 02:03 UTC -- T+196h54m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+196h54m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 02:04 UTC | elapsed 8.21 d | 20.9 d to the Aug-27 stop
test tier: 17,056 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      57 records      57.0 rec/h
    last  3 h     389 records     129.7 rec/h
    last 12 h    1838 records     153.2 rec/h
    ...
    !! 66% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_haiku_4_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,647      57  GATED             GATED             barrier>=30
      189       6,211      57  GATED             GATED             barrier>=30
      279      10,259      57  GATED             GATED             barrier>=30
      340      13,004      57  GATED             GATED             barrier>=30
      403      15,839      57  GATED             GATED             barrier>=30
      568      23,272      57  GATED             GATED             barrier>=30
