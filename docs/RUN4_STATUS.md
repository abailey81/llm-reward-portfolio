...
**Auto-generated 2026-08-05 06:25 UTC -- T+177h16m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+177h16m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 83 min ago; none live, newest failure 83 min ago** |
...
| | |
|---|---|
| cluster jobs | **952** (208 running, 744 queued) |
| **cores computing** | **1664** |
...
```
generated 2026-08-05 06:26 UTC | elapsed 7.39 d | 21.7 d to the Aug-27 stop
test tier: 13,950 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     258 records     258.0 rec/h
    last  3 h     347 records     115.7 rec/h
    last 12 h    1642 records     136.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,238       6  GATED             GATED             barrier>=30
      189       7,428     258  GATED             GATED             barrier>=30
      279      11,928     258  GATED             GATED             barrier>=30
      340      14,978     258  GATED             GATED             barrier>=30
      403      18,128     258  GATED             GATED             barrier>=30
      568      26,378     258  GATED             GATED             barrier>=30
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung     @1664 cores      @830 cores   binding
