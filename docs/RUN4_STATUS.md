...
**Auto-generated 2026-08-11 21:43 UTC -- T+336h34m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+336h34m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on deepseek-v4-pro, 4.0 h ago; none live, newest failure 4.0 h ago** |
...
| **cores computing** | **600** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (130 min old **STALE**) |
...
```
generated 2026-08-11 21:43 UTC | elapsed 14.02 d | 15.1 d to the Aug-27 stop
test tier: 29,983 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 109.1 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h    1309 records     109.1 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,616      51  GATED             GATED             barrier>=279
      403       3,821      51  GATED             GATED             barrier>=279
      568      10,345      51  GATED             GATED             barrier>=279
