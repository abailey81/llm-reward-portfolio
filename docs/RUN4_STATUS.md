...
**Auto-generated 2026-08-05 08:35 UTC -- T+179h26m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+179h26m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 79 min ago; none live, newest failure 79 min ago** |
...
```
generated 2026-08-05 08:35 UTC | elapsed 7.48 d | 21.6 d to the Aug-27 stop
test tier: 14,494 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     264 records     264.0 rec/h
    last  3 h     758 records     252.7 rec/h
    last 12 h    1760 records     146.7 rec/h
    last 24 h    4072 records     169.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,125     108  GATED             GATED             barrier>=30
      189       7,130     108  GATED             GATED             barrier>=30
      279      11,384     264  GATED             GATED             barrier>=30
      340      14,434     264  GATED             GATED             barrier>=30
      403      17,584     264  GATED             GATED             barrier>=30
      568      25,834     264  GATED             GATED             barrier>=30
