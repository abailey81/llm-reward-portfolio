...
**Auto-generated 2026-08-04 22:53 UTC -- T+169h44m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+169h44m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 23 min ago; none live, newest failure 23 min ago** |
...
| | |
|---|---|
| cluster jobs | **991** (157 running, 832 queued) |
| **cores computing** | **1256** |
...
```
generated 2026-08-04 22:53 UTC | elapsed 7.07 d | 22.0 d to the Aug-27 stop
test tier: 13,156 records over 68 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     144 records     144.0 rec/h
    last  3 h     559 records     186.3 rec/h
    last 12 h    2211 records     184.2 rec/h
    last 24 h    4304 records     179.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         240       6  GATED             GATED             barrier
      100       3,341      16  GATED             GATED             barrier>=30
      189       7,791      16  GATED             GATED             barrier>=30
      279      12,291      16  GATED             GATED             barrier>=30
      340      15,341      16  GATED             GATED             barrier>=30
      403      18,491      16  GATED             GATED             barrier>=30
      568      27,172     144  GATED             GATED             barrier>=30
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung     @1256 cores      @830 cores   binding
       30           4.6 d           4.6 d   critical_chain
      100           4.6 d           4.6 d   critical_chain
      189           4.6 d           6.5 d   throughput
      279           6.1 d           9.3 d   throughput
      340           7.4 d          11.1 d   throughput
      403           8.6 d          13.0 d   throughput
      568          11.9 d          18.1 d   throughput
