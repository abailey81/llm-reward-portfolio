...
**Auto-generated 2026-08-05 14:50 UTC -- T+185h41m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+185h41m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 4.0 h ago; none live, newest failure 1.8 h ago** |
...
| | |
|---|---|
| cluster jobs | **932** (185 running, 747 queued) |
...
```
generated 2026-08-05 14:51 UTC | elapsed 7.74 d | 21.4 d to the Aug-27 stop
test tier: 15,408 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     242 records     242.0 rec/h
    last  3 h     401 records     133.7 rec/h
    last 12 h    1811 records     150.9 rec/h
    last 24 h    3789 records     157.9 rec/h
    12 h rate is 77% from ONE line (test_leg_haiku_4_5); 4 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 0% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,636     126  GATED             GATED             barrier>=30
      403      16,670     242  GATED             GATED             barrier>=30
      568      24,920     242  GATED             GATED             barrier>=30
...
2026-08-05T14:46:01Z  OK  records=16918 (+10)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.9m  drift=0  sci=OK  r115=22B  sweep=113.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T14:51:02Z  OK  records=16944 (+26)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.2m  drift=0  sci=OK  r115=22B  sweep=270.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
