...
**Auto-generated 2026-08-01 06:37 UTC -- T+81h28m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+81h28m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **140** (123 running, 17 queued) |
| **cores computing** | **984** |
...
|---|---|---|
| distributional | g5 of 5 | 806 |
| scalar | g5 of 5 | 296 |
| placebo | g5 of 5 | 247 |
| scalar_cvar5 | g5 of 5 | 227 |
| placebo_shuffled | g5 of 5 | 182 |
...
```
2026-08-01T06:33:25Z  RED  records=2144 (+1)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=14B  sweep=10.8s  auto-cycle
2026-08-01T06:34:06Z  RED  records=2145 (+1)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=14B  sweep=14.5s  auto-cycle
2026-08-01T06:34:51Z  RED  records=2146 (+1)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=14B  sweep=15.1s  auto-cycle
2026-08-01T06:35:36Z  RED  records=2148 (+2)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=1.5m  drift=0  sci=OK  r115=14B  sweep=10.6s  auto-cycle
2026-08-01T06:36:17Z  RED  records=2148 (+0)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=14B  sweep=14.8s  auto-cycle
2026-08-01T06:37:02Z  RED  records=2148 (+0)  spend=$43.2642  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=14B  sweep=11.7s  auto-cycle
```
