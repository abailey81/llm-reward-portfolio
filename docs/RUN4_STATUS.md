...
**Auto-generated 2026-08-06 11:51 UTC -- T+206h42m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+206h42m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 11:51 UTC | elapsed 8.61 d | 20.5 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,689      12  GATED             GATED             barrier>=30
      279       9,710      39  GATED             GATED             barrier>=30
      340      12,455      39  GATED             GATED             barrier>=30
      403      15,290      39  GATED             GATED             barrier>=30
      568      22,723      39  GATED             GATED             barrier>=30
