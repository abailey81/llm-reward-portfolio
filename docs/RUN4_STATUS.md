...
**Auto-generated 2026-08-05 12:07 UTC -- T+182h58m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+182h58m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=5; worst streak 1/240 (0.4% to fatal), ops on core, 4.9 h ago; none live, newest failure 78 min ago** |
...
| | |
|---|---|
| cluster jobs | **973** (175 running, 798 queued) |
...
```
generated 2026-08-05 12:08 UTC | elapsed 7.62 d | 21.5 d to the Aug-27 stop
test tier: 15,042 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     123 records     123.0 rec/h
    last  3 h     408 records     136.0 rec/h
    last 12 h    1664 records     138.7 rec/h
    last 24 h    3917 records     163.2 rec/h
    12 h rate is 62% from ONE line (test_leg_haiku_4_5); 5 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 13% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279      10,891      68  GATED             GATED             barrier>=30
      340      13,886     123  GATED             GATED             barrier>=30
      403      17,036     123  GATED             GATED             barrier>=30
      568      25,286     123  GATED             GATED             barrier>=30
