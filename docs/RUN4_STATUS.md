...
**Auto-generated 2026-08-06 15:11 UTC -- T+210h02m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+210h02m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 37 min ago; none live, newest failure 37 min ago** |
...
| | |
|---|---|
| cluster jobs | **869** (75 running, 794 queued) |
| **cores computing** | **600** |
| **cores doing RUNG-RAISING work** | **22.6%** -- 184 of 816 cores (147 min old **STALE**) |
...
```
generated 2026-08-06 15:11 UTC | elapsed 8.75 d | 20.4 d to the Aug-27 stop
test tier: 17,952 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h     873 records      72.8 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30          66      38  GATED             GATED             unstarted:2-unit(s)-absent
      100       2,516      38  GATED             GATED             unstarted:2-unit(s)-absent>=30
      189       5,631      39  GATED             GATED             unstarted:2-unit(s)-absent>=30
      279       9,363     247  GATED             GATED             unstarted:2-unit(s)-absent>=30
      340      12,108     247  GATED             GATED             unstarted:2-unit(s)-absent>=30
      403      14,943     247  GATED             GATED             unstarted:2-unit(s)-absent>=30
      568      22,376     247  GATED             GATED             unstarted:2-unit(s)-absent>=30
