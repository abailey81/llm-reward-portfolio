...
| **cores computing** | **848** |
| **cores doing RUNG-RAISING work** | **22.6%** -- 192 of 848 cores (19 min old) |
...
```
generated 2026-08-06 11:42 UTC | elapsed 8.61 d | 20.5 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,689      25  GATED             GATED             barrier>=30
      279       9,716      46  GATED             GATED             barrier>=30
      340      12,461      46  GATED             GATED             barrier>=30
      403      15,296      46  GATED             GATED             barrier>=30
      568      22,729      46  GATED             GATED             barrier>=30
