...
| transport health | **timeouts 6h=156; worst streak 11/240 (4.6% to fatal), pull on core, 20 min ago; none live, newest failure 18 min ago** |
...
| | |
|---|---|
| cluster jobs | **852** (64 running, 788 queued) |
| **cores computing** | **512** |
| **cores doing RUNG-RAISING work** | **17.0%** -- 72 of 424 cores (97 min old **STALE**) |
