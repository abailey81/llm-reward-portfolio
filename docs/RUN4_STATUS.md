...
**Auto-generated 2026-08-02 01:36 UTC -- T+100h27m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+100h27m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **69** (63 running, 6 queued) |
| **cores computing** | **504** |
...
```
 rung              @504 cores              @830 cores   binding
  ...
  100            6.3 d  08-04            4.6 d  08-02   critical_chain
  189           10.8 d  08-08            6.5 d  08-04   throughput
  279           15.3 d  08-13            9.3 d  08-07   throughput
  340           18.3 d  08-16           11.1 d  08-09   throughput
  403           21.5 d  08-19           13.0 d  08-10   throughput
  568        29.8 d  08-27  X           18.1 d  08-15   throughput
```
...
| scalar | g5 of 5 | 326 |
| placebo | g5 of 5 | 588 |
| scalar_cvar5 | g5 of 5 | 440 |
| placebo_shuffled | g5 of 5 | 438 |
...
```
2026-08-02T01:31:17Z  RED  records=3085 (+4)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=4.2m  drift=0  sci=OK  r115=20B  cores=520  sweep=43.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T01:32:31Z  RED  records=3085 (+0)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=1.9m  drift=0  sci=OK  r115=20B  sweep=19.9s  auto-cycle
2026-08-02T01:33:21Z  RED  records=3087 (+2)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=20B  sweep=19.4s  auto-cycle
2026-08-02T01:34:10Z  RED  records=3088 (+1)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=20B  sweep=19.8s  auto-cycle
2026-08-02T01:35:00Z  RED  records=3090 (+2)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=20B  sweep=20.5s  auto-cycle
2026-08-02T01:35:51Z  RED  records=3091 (+1)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=3.5m  drift=0  sci=OK  r115=20B  sweep=19.9s  auto-cycle
```
