...
```
generated 2026-08-06 05:06 UTC | elapsed 8.33 d | 20.8 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,570      37  GATED             GATED             barrier>=30
      189       6,118      53  GATED             GATED             barrier>=30
      279      10,166      53  GATED             GATED             barrier>=30
      340      12,911      53  GATED             GATED             barrier>=30
      403      15,746      53  GATED             GATED             barrier>=30
      568      23,179      53  GATED             GATED             barrier>=30
