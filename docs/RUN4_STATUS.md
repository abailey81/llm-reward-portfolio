...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 15 min ago; none live, newest failure 14 min ago** |
...
```
generated 2026-08-06 14:49 UTC | elapsed 8.74 d | 20.4 d to the Aug-27 stop
test tier: 17,817 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,498     153  GATED             GATED             unstarted:2-unit(s)-absent>=30
      340      12,243     153  GATED             GATED             unstarted:2-unit(s)-absent>=30
      403      15,078     153  GATED             GATED             unstarted:2-unit(s)-absent>=30
      568      22,511     153  GATED             GATED             unstarted:2-unit(s)-absent>=30
