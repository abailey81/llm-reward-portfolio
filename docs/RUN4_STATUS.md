...
**Auto-generated 2026-08-05 01:11 UTC -- T+172h02m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+172h02m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **948** (173 running, 773 queued) |
...
```
generated 2026-08-05 01:11 UTC | elapsed 7.17 d | 22.0 d to the Aug-27 stop
test tier: 13,507 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     121 records     121.0 rec/h
    last  3 h     464 records     154.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,339       1  GATED             GATED             barrier>=30
      189       7,789       1  GATED             GATED             barrier>=30
      279      12,289       1  GATED             GATED             barrier>=30
      340      15,339       1  GATED             GATED             barrier>=30
      403      18,489       1  GATED             GATED             barrier>=30
      568      26,821     121  GATED             GATED             barrier>=30
