...
**Auto-generated 2026-08-06 04:49 UTC -- T+199h40m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+199h40m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 04:50 UTC | elapsed 8.32 d | 20.8 d to the Aug-27 stop
test tier: 17,129 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      49 records      49.0 rec/h
    last  3 h      92 records      30.7 rec/h
    last 12 h    1365 records     113.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,578      45  GATED             GATED             barrier>=30
      189       6,138      49  GATED             GATED             barrier>=30
      279      10,186      49  GATED             GATED             barrier>=30
      340      12,931      49  GATED             GATED             barrier>=30
      403      15,766      49  GATED             GATED             barrier>=30
      568      23,199      49  GATED             GATED             barrier>=30
