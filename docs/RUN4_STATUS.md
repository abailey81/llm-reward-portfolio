...
**Auto-generated 2026-08-09 16:14 UTC -- T+283h05m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+283h05m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **25813** |
| **Myriad maintenance** | **2026-08-12 from 08:00 UTC, at risk all day** (in 2.7 days). Delayed from Aug 11. Jobs may die and REQUEUE idempotently; the supervisors ride it. Playbook: docs/ops/MAINTENANCE_2026-08-12.md |
| LLM calls / spend | 2956 / **$45.5021** |
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on core, 3.8 h ago; none live, newest failure 3.8 h ago** |
...
| | |
|---|---|
| cluster jobs | **756** = 140 running + **240 ELIGIBLE** + 376 held by us + 0 held only by the site |
...
| **cores computing** | **1120** |
| **cores doing RUNG-RAISING work** | **99.3%** -- 1080 of 1088 cores (41 min old) |
...
```
generated 2026-08-09 16:14 UTC | elapsed 11.80 d | 17.3 d to the Aug-27 stop
test tier: 24,270 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 104.5 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    last  1 h     248 records     248.0 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last  3 h     471 records     157.0 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last 12 h    1254 records     104.5 rec/h   usable
    last 24 h    2771 records     115.5 rec/h   usable
    12 h rate is 60% from ONE line (test); 6 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (104 rec/h); latest excludes cells already within
    8 of the ceiling (104 rec/h). Window 12 h.
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       1,461     248  2026-08-10 06:13  2026-08-10 06:13  yes
      279       4,611     248  2026-08-11 12:22  2026-08-11 12:22  yes
      340       6,746     248  2026-08-12 08:48  2026-08-12 08:48  yes
      403       8,982     248  2026-08-13 06:12  2026-08-13 06:12  yes
      568      16,058     248  2026-08-16 01:54  2026-08-16 01:54  yes
    GATED = the relevant rate is zero, so no throughput number can date that row -- it is
    waiting on a stage barrier (C1 chain / C3 gate), not on cores.

REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung     @1120 cores      @830 cores   binding
       30           4.6 d           4.6 d   critical_chain
      100           4.6 d           4.6 d   critical_chain
      189           4.8 d           6.5 d   throughput
      279           6.9 d           9.3 d   throughput
      340           8.2 d          11.1 d   throughput
      403           9.7 d          13.0 d   throughput
      568          13.4 d          18.1 d   throughput
...
> **What is holding it right now: test -- baseline_return_minus_downside has 274 HOLE(S) below its frontier 406 -- that is what caps this line**
...
currently at **133 seeds each** (read live from the archive on this publish). !! THE
...
```
2026-08-09T14:10:11Z  OK  records=25416 (+7)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  sweep=1412.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-09T14:29:36Z  OK  records=25464 (+48)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.0m  drift=0  sci=OK  r115=22B  cores=1136  sweep=1134.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-09T14:53:26Z  OK  records=25483 (+19)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.9m  drift=0  sci=OK  r115=22B  sweep=1399.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-09T15:12:52Z  OK  records=25557 (+74)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.8m  drift=0  sci=OK  r115=22B  cores=1152  sweep=1135.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-09T15:39:29Z  OK  records=25673 (+116)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  sweep=1566.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-09T15:58:41Z  OK  records=25795 (+122)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=0.2m  drift=0  sci=OK  r115=22B  cores=1120  sweep=1122.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
