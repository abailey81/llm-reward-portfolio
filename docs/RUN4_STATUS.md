...
**Auto-generated 2026-08-05 19:06 UTC -- T+189h57m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+189h57m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 3 min ago; LIVE, still failing** |
...
```
generated 2026-08-05 19:07 UTC | elapsed 7.92 d | 21.2 d to the Aug-27 stop
test tier: 16,164 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     144 records     144.0 rec/h
    last  3 h     542 records     180.7 rec/h
    last 12 h    2051 records     170.9 rec/h
    last 24 h    3731 records     155.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      24,164     144  GATED             GATED             barrier>=30
