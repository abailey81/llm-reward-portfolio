...
**Auto-generated 2026-08-06 16:10 UTC -- T+211h01m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+211h01m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 1.6 h ago; none live, newest failure 1.6 h ago** |
...
| | |
|---|---|
| cluster jobs | **875** (47 running, 828 queued) |
| **cores computing** | **376** |
| **cores doing RUNG-RAISING work** | **17.0%** -- 72 of 424 cores (32 min old) |
