...
**Auto-generated 2026-08-06 08:48 UTC -- T+203h39m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+203h39m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores doing RUNG-RAISING work** | **20.2%** -- 200 of 992 cores (26 min old) |
...
```
generated 2026-08-06 08:48 UTC | elapsed 8.49 d | 20.6 d to the Aug-27 stop
test tier: 17,393 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,874      32  GATED             GATED             barrier>=30
      279       9,922      32  GATED             GATED             barrier>=30
      340      12,667      32  GATED             GATED             barrier>=30
      403      15,502      32  GATED             GATED             barrier>=30
      568      22,935      32  GATED             GATED             barrier>=30
