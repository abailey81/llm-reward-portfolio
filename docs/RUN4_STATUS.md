...
**Auto-generated 2026-08-02 16:15 UTC -- T+115h06m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+115h06m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **876** (240 running, 636 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1180 |
| scalar | g5 of 5 | 584 |
| placebo | g5 of 5 | 811 |
| scalar_cvar5 | g5 of 5 | 774 |
| placebo_shuffled | g5 of 5 | 757 |
...
```
2026-08-02T16:09:21Z  RED  records=4456 (+8)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.2m  drift=0  sci=OK  r115=21B  sweep=30.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T16:10:21Z  RED  records=4463 (+7)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.6m  drift=0  sci=OK  r115=21B  sweep=28.0s  auto-cycle
2026-08-02T16:11:19Z  RED  records=4469 (+6)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=4.6m  drift=0  sci=OK  r115=21B  sweep=31.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T16:12:21Z  RED  records=4472 (+3)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=21B  sweep=30.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T16:13:22Z  RED  records=4494 (+22)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=21B  sweep=59.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
