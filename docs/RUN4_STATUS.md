...
**Auto-generated 2026-08-11 18:42 UTC -- T+333h33m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+333h33m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on deepseek-v4-pro, 62 min ago; none live, newest failure 62 min ago** |
...
| | |
|---|---|
| cluster jobs | **441** = 61 running + **52 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **488** |
| **cores doing RUNG-RAISING work** | **4.8%** -- 24 of 504 cores (69 min old) |
...
```
generated 2026-08-11 18:43 UTC | elapsed 13.90 d | 15.2 d to the Aug-27 stop
test tier: 29,790 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 124.2 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h    1491 records     124.2 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,809      94  GATED             GATED             barrier>=279
      403       4,014      94  GATED             GATED             barrier>=279
      568      10,538      94  GATED             GATED             barrier>=279
