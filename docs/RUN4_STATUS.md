...
**Auto-generated 2026-08-12 03:57 UTC -- T+342h49m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+342h49m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **487** = 112 running + **47 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **896** |
| **cores doing RUNG-RAISING work** | **76.4%** -- 672 of 880 cores (25 min old) |
...
```
generated 2026-08-12 03:58 UTC | elapsed 14.28 d | 14.8 d to the Aug-27 stop
test tier: 30,292 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 66.0 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h     792 records      66.0 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,357      20  GATED             GATED             barrier>=279
      403       3,562      20  GATED             GATED             barrier>=279
      568      10,036      63  GATED             GATED             barrier>=279
