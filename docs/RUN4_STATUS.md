...
**Auto-generated 2026-08-02 11:58 UTC -- T+110h49m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+110h49m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **993** (211 running, 782 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 996 |
| scalar | g5 of 5 | 401 |
| placebo | g5 of 5 | 635 |
| scalar_cvar5 | g5 of 5 | 587 |
| placebo_shuffled | g5 of 5 | 575 |
...
```
2026-08-02T11:53:18Z  RED  records=3553 (+3)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=4.3m  drift=0  sci=OK  r115=21B  sweep=20.6s  auto-cycle
2026-08-02T11:54:09Z  RED  records=3555 (+2)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=21B  sweep=22.2s  auto-cycle
2026-08-02T11:55:02Z  RED  records=3560 (+5)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=21B  sweep=23.3s  auto-cycle
2026-08-02T11:55:55Z  RED  records=3564 (+4)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0  sci=OK  r115=21B  sweep=21.9s  auto-cycle
2026-08-02T11:56:47Z  RED  records=3566 (+2)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=21B  sweep=24.6s  auto-cycle
2026-08-02T11:57:42Z  RED  records=3575 (+9)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=4.0m  drift=0  sci=OK  r115=21B  sweep=43.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
