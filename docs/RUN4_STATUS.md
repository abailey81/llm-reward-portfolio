...
**Auto-generated 2026-08-06 01:50 UTC -- T+196h41m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+196h41m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **969** (67 running, 902 queued) |
| **cores computing** | **536** |
...
```
generated 2026-08-06 01:50 UTC | elapsed 8.20 d | 20.9 d to the Aug-27 stop
test tier: 17,037 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,666      43  GATED             GATED             barrier>=30
      189       6,230      43  GATED             GATED             barrier>=30
      279      10,278      43  GATED             GATED             barrier>=30
      340      13,023      43  GATED             GATED             barrier>=30
      403      15,858      43  GATED             GATED             barrier>=30
      568      23,291      43  GATED             GATED             barrier>=30
