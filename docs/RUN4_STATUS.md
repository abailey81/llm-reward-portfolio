...
**Auto-generated 2026-08-05 23:59 UTC -- T+194h50m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+194h50m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 4.9 h ago; none live, newest failure 4.9 h ago** |
...
| | |
|---|---|
| cluster jobs | **748** (70 running, 678 queued) |
| **cores computing** | **560** |
...
```
generated 2026-08-05 23:59 UTC | elapsed 8.12 d | 21.0 d to the Aug-27 stop
test tier: 16,881 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     234 records     234.0 rec/h
    last  3 h     501 records     167.0 rec/h
    last 12 h    1850 records     154.2 rec/h
    last 24 h    3522 records     146.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         120       4  GATED             GATED             barrier
      100       2,804     118  GATED             GATED             barrier>=30
      189       6,384     234  GATED             GATED             barrier>=30
      279      10,434     234  GATED             GATED             barrier>=30
      340      13,179     234  GATED             GATED             barrier>=30
      403      16,014     234  GATED             GATED             barrier>=30
      568      23,447     234  GATED             GATED             barrier>=30
