...
**Auto-generated 2026-08-06 11:58 UTC -- T+206h49m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+206h49m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 11:58 UTC | elapsed 8.62 d | 20.5 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    12 h rate is 97% from ONE line (test_leg_kimi_k3); 2 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,689       5  GATED             GATED             barrier>=30
      279       9,709      31  GATED             GATED             barrier>=30
      340      12,454      31  GATED             GATED             barrier>=30
      403      15,289      31  GATED             GATED             barrier>=30
      568      22,722      31  GATED             GATED             barrier>=30
