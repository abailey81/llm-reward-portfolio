...
| | |
|---|---|
| cluster jobs | **931** (96 running, 835 queued) |
| **cores computing** | **768** |
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    1239 records     103.2 rec/h
    last 24 h    3347 records     139.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,909     112  GATED             GATED             barrier>=30
      279       9,957     112  GATED             GATED             barrier>=30
      340      12,702     112  GATED             GATED             barrier>=30
      403      15,537     112  GATED             GATED             barrier>=30
      568      22,970     112  GATED             GATED             barrier>=30
