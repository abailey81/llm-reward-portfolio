...
**Auto-generated 2026-08-06 01:41 UTC -- T+196h32m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+196h32m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 01:41 UTC | elapsed 8.19 d | 20.9 d to the Aug-27 stop
test tier: 17,025 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,678      38  GATED             GATED             barrier>=30
      189       6,242      39  GATED             GATED             barrier>=30
      279      10,290      39  GATED             GATED             barrier>=30
      340      13,035      39  GATED             GATED             barrier>=30
      403      15,870      39  GATED             GATED             barrier>=30
      568      23,303      39  GATED             GATED             barrier>=30
