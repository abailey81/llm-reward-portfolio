...
**Auto-generated 2026-08-01 12:15 UTC -- T+87h06m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+87h06m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **2362** |
| LLM calls / spend | 2849 / **$44.3858** |
...
```
2026-08-01T12:11:12Z  RED  records=2360 (+0)  spend=$44.2941  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=17B  sweep=17.0s  auto-cycle
2026-08-01T12:11:59Z  RED  records=2360 (+0)  spend=$44.2941  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0  sci=OK  r115=17B  sweep=16.1s  auto-cycle
2026-08-01T12:12:45Z  RED  records=2360 (+0)  spend=$44.2941  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=17B  sweep=16.6s  auto-cycle
2026-08-01T12:13:32Z  RED  records=2361 (+1)  spend=$44.2941  guards=2  arms_full=10/10  budget=2  stalest=1.7m  drift=0  sci=OK  r115=17B  sweep=24.1s  auto-cycle
2026-08-01T12:14:27Z  RED  records=2361 (+0)  spend=$44.3858  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=17B  sweep=16.4s  auto-cycle
2026-08-01T12:15:13Z  RED  records=2362 (+1)  spend=$44.4822  guards=2  arms_full=10/10  budget=2  stalest=1.8m  drift=0  sci=OK  r115=17B  sweep=13.6s  auto-cycle
```
...
```
  anthropic   spent $ 36.1726  + still to author $  1.2597  = $ 37.4323   credited $ 28.1500   margin $  -9.2823 (-33%)  over the credit ESTIMATE (owner-watched)
