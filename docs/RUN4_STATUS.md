...
**Auto-generated 2026-08-12 03:03 UTC -- T+341h54m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+341h54m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **495** = 106 running + **61 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **848** |
| **cores doing RUNG-RAISING work** | **56.7%** -- 440 of 776 cores (91 min old **STALE**) |
...
```
generated 2026-08-12 03:04 UTC | elapsed 14.25 d | 14.9 d to the Aug-27 stop
test tier: 30,234 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,373      71  GATED             GATED             barrier>=279
      403       3,578      71  GATED             GATED             barrier>=279
      568      10,094      79  GATED             GATED             barrier>=279
