...
**Auto-generated 2026-08-06 05:43 UTC -- T+200h35m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| cluster jobs | **950** (66 running, 884 queued) |
| **cores computing** | **528** |
...
```
generated 2026-08-06 05:44 UTC | elapsed 8.36 d | 20.8 d to the Aug-27 stop
test tier: 17,252 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     128 records     128.0 rec/h
    last  3 h     176 records      58.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,015     128  GATED             GATED             barrier>=30
      279      10,063     128  GATED             GATED             barrier>=30
      340      12,808     128  GATED             GATED             barrier>=30
      403      15,643     128  GATED             GATED             barrier>=30
      568      23,076     128  GATED             GATED             barrier>=30
