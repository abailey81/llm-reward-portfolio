...
```
generated 2026-08-06 02:27 UTC | elapsed 8.22 d | 20.9 d to the Aug-27 stop
test tier: 17,070 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      61 records      61.0 rec/h
    last  3 h     320 records     106.7 rec/h
    ...
    !! 63% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_haiku_4_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,633      61  GATED             GATED             barrier>=30
      189       6,197      61  GATED             GATED             barrier>=30
      279      10,245      61  GATED             GATED             barrier>=30
      340      12,990      61  GATED             GATED             barrier>=30
      403      15,825      61  GATED             GATED             barrier>=30
      568      23,258      61  GATED             GATED             barrier>=30
