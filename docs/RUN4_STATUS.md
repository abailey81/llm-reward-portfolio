...
**Auto-generated 2026-08-06 10:26 UTC -- T+205h17m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| **cores computing** | **904** |
| **cores doing RUNG-RAISING work** | **21.2%** -- 192 of 904 cores (6 min old) |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,730      59  GATED             GATED             barrier>=30
      279       9,778      59  GATED             GATED             barrier>=30
      340      12,523      59  GATED             GATED             barrier>=30
      403      15,358      59  GATED             GATED             barrier>=30
      568      22,791      59  GATED             GATED             barrier>=30
