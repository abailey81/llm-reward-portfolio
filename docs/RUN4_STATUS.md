...
**Auto-generated 2026-08-06 10:02 UTC -- T+204h53m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+204h53m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 10:02 UTC | elapsed 8.54 d | 20.6 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,743     121  GATED             GATED             barrier>=30
      279       9,791     121  GATED             GATED             barrier>=30
      340      12,536     121  GATED             GATED             barrier>=30
      403      15,371     121  GATED             GATED             barrier>=30
      568      22,804     121  GATED             GATED             barrier>=30
