...
**Auto-generated 2026-08-06 00:36 UTC -- T+195h27m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h27m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    3549 records     147.9 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,718     138  GATED             GATED             barrier>=30
      189       6,283     181  GATED             GATED             barrier>=30
      279      10,331     183  GATED             GATED             barrier>=30
      340      13,076     183  GATED             GATED             barrier>=30
      403      15,911     183  GATED             GATED             barrier>=30
      568      23,344     183  GATED             GATED             barrier>=30
