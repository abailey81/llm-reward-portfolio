...
**Auto-generated 2026-08-06 07:01 UTC -- T+201h52m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+201h52m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    3265 records     136.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,908      74  GATED             GATED             barrier>=30
      279       9,956      74  GATED             GATED             barrier>=30
      340      12,701      74  GATED             GATED             barrier>=30
      403      15,536      74  GATED             GATED             barrier>=30
      568      22,969      74  GATED             GATED             barrier>=30
