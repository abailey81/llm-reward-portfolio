...
**Auto-generated 2026-08-02 13:10 UTC -- T+112h01m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+112h01m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **951** (230 running, 721 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1069 |
| scalar | g5 of 5 | 472 |
| placebo | g5 of 5 | 701 |
| scalar_cvar5 | g5 of 5 | 661 |
| placebo_shuffled | g5 of 5 | 645 |
...
```
2026-08-02T13:05:35Z  RED  records=3919 (+4)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=21B  sweep=26.5s  auto-cycle
2026-08-02T13:06:32Z  RED  records=3921 (+2)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=21B  sweep=26.4s  auto-cycle
2026-08-02T13:07:29Z  RED  records=3925 (+4)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=21B  sweep=25.7s  auto-cycle
2026-08-02T13:08:25Z  RED  records=3929 (+4)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.6m  drift=0  sci=OK  r115=21B  sweep=26.0s  auto-cycle
2026-08-02T13:09:21Z  RED  records=3930 (+1)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=4.5m  drift=0  sci=OK  r115=21B  cores=1848  sweep=37.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
