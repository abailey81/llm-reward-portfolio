...
**Auto-generated 2026-08-06 09:18 UTC -- T+204h09m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+204h09m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **924** (122 running, 802 queued) |
| **cores computing** | **976** |
| **cores doing RUNG-RAISING work** | **20.8%** -- 208 of 1000 cores (26 min old) |
...
```
generated 2026-08-06 09:18 UTC | elapsed 8.51 d | 20.6 d to the Aug-27 stop
test tier: 17,444 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,823      79  GATED             GATED             barrier>=30
      279       9,871      79  GATED             GATED             barrier>=30
      340      12,616      79  GATED             GATED             barrier>=30
      403      15,451      79  GATED             GATED             barrier>=30
      568      22,884      79  GATED             GATED             barrier>=30
