...
**Auto-generated 2026-08-06 05:02 UTC -- T+199h53m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+199h53m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 05:02 UTC | elapsed 8.33 d | 20.8 d to the Aug-27 stop
test tier: 17,145 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      51 records      51.0 rec/h
    last  3 h      90 records      30.0 rec/h
    last 12 h    1345 records     112.1 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,122      51  GATED             GATED             barrier>=30
      279      10,170      51  GATED             GATED             barrier>=30
      340      12,915      51  GATED             GATED             barrier>=30
      403      15,750      51  GATED             GATED             barrier>=30
      568      23,183      51  GATED             GATED             barrier>=30
