...
**Auto-generated 2026-08-12 15:39 UTC -- T+354h30m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+354h30m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **335** = 35 running + **0 ELIGIBLE** + 300 held by us + 0 held only by the site |
...
| **cores computing** | **280** |
| **cores doing RUNG-RAISING work** | **58.3%** -- 168 of 288 cores (6 min old) |
...
```
generated 2026-08-12 15:39 UTC | elapsed 14.77 d | 14.3 d to the Aug-27 stop
test tier: 31,449 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    2009 records      83.7 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      403       2,532     100  2026-08-13 17:39  2026-08-13 17:39  yes
      568       8,879     100  2026-08-16 10:48  2026-08-16 10:48  yes
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung      @280 cores      @830 cores   binding
       30           5.0 d           4.6 d   critical_chain
      100          11.3 d           4.6 d   critical_chain
      189          19.4 d           6.5 d   throughput
      279          27.5 d           9.3 d   throughput
      340          33.0 d          11.1 d   throughput
      403          38.7 d          13.0 d   throughput
      568          53.6 d          18.1 d   throughput
