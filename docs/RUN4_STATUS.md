...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 90 min ago; none live, newest failure 90 min ago** |
...
```
generated 2026-08-06 01:34 UTC | elapsed 8.18 d | 20.9 d to the Aug-27 stop
test tier: 17,014 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,689      29  GATED             GATED             barrier>=30
      189       6,253      30  GATED             GATED             barrier>=30
      279      10,301      30  GATED             GATED             barrier>=30
      340      13,046      30  GATED             GATED             barrier>=30
      403      15,881      30  GATED             GATED             barrier>=30
      568      23,314      30  GATED             GATED             barrier>=30
