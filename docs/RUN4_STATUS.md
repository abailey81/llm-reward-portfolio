...
**Auto-generated 2026-08-05 09:03 UTC -- T+179h54m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+179h54m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 1.8 h ago; none live, newest failure 1.8 h ago** |
...
| | |
|---|---|
| cluster jobs | **874** (189 running, 685 queued) |
...
```
generated 2026-08-05 09:03 UTC | elapsed 7.50 d | 21.6 d to the Aug-27 stop
test tier: 14,620 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     267 records     267.0 rec/h
    last  3 h     736 records     245.3 rec/h
    last 12 h    1725 records     143.8 rec/h
    last 24 h    4094 records     170.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,054     159  GATED             GATED             barrier>=30
      189       7,023     195  GATED             GATED             barrier>=30
      279      11,258     267  GATED             GATED             barrier>=30
      340      14,308     267  GATED             GATED             barrier>=30
      403      17,458     267  GATED             GATED             barrier>=30
      568      25,708     267  GATED             GATED             barrier>=30
