...
**Auto-generated 2026-08-05 02:20 UTC -- T+173h11m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+173h11m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 3.8 h ago; LIVE, still failing** |
...
| | |
|---|---|
| cluster jobs | **994** (178 running, 816 queued) |
| **cores computing** | **1424** |
...
```
generated 2026-08-05 02:20 UTC | elapsed 7.22 d | 21.9 d to the Aug-27 stop
test tier: 13,590 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      67 records      67.0 rec/h
    last  3 h     333 records     111.0 rec/h
    last 12 h    2089 records     174.1 rec/h
    last 24 h    4204 records     175.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (174 rec/h); latest excludes cells already within
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,324      12  GATED             GATED             barrier>=30
      189       7,774      12  GATED             GATED             barrier>=30
      279      12,274      12  GATED             GATED             barrier>=30
      340      15,324      12  GATED             GATED             barrier>=30
      403      18,474      12  GATED             GATED             barrier>=30
      568      26,738      67  GATED             GATED             barrier>=30
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung     @1424 cores      @830 cores   binding
