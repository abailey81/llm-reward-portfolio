...
**Auto-generated 2026-08-06 06:13 UTC -- T+201h04m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+201h04m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
test tier: 17,308 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     145 records     145.0 rec/h
    last  3 h     229 records      76.3 rec/h
    last 12 h    1263 records     105.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,959     145  GATED             GATED             barrier>=30
      279      10,007     145  GATED             GATED             barrier>=30
      340      12,752     145  GATED             GATED             barrier>=30
      403      15,587     145  GATED             GATED             barrier>=30
      568      23,020     145  GATED             GATED             barrier>=30
