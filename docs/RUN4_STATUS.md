...
**Auto-generated 2026-08-04 18:38 UTC -- T+165h29m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+165h29m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **174** (172 running, 0 queued) |
...
```
generated 2026-08-04 18:38 UTC | elapsed 6.90 d | 22.2 d to the Aug-27 stop
test tier: 12,339 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     220 records     220.0 rec/h
    last  3 h     586 records     195.3 rec/h
    last 12 h    2379 records     198.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,878      26  GATED             GATED             barrier>=30
      189       8,328      26  GATED             GATED             barrier>=30
      279      12,828      26  GATED             GATED             barrier>=30
      340      15,878      26  GATED             GATED             barrier>=30
      403      19,028      26  GATED             GATED             barrier>=30
      568      27,989     220  GATED             GATED             barrier>=30
