...
**Auto-generated 2026-08-04 22:11 UTC -- T+169h02m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+169h02m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| stalest driver log | **2 min (qwen3_5-9b)** old (P218: the STALEST of the still-running lines, completed ladders excluded; above ~30 means that line has stopped progressing) |
| records archived | **14584** |
...
| transport health | **timeouts 6h=0; worst streak 0/240 (0.0% to fatal), - on -, age UNKNOWN; none live, newest failure 6.4 h ago** |
...
| | |
|---|---|
| cluster jobs | **824** (152 running, 670 queued) |
| **cores computing** | **1216** |
...
```
generated 2026-08-04 22:12 UTC | elapsed 7.04 d | 22.1 d to the Aug-27 stop
test tier: 13,043 records over 67 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     114 records     114.0 rec/h
    last  3 h     586 records     195.3 rec/h
    last 12 h    2206 records     183.8 rec/h
    last 24 h    4360 records     181.7 rec/h
    12 h rate is 71% from ONE line (test_leg_sonnet_5); 10 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 71% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_sonnet_5, test_leg_gpt_5_6_luna) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (184 rec/h); latest excludes cells already within
    8 of the ceiling (53 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         241      21  2026-08-05 02:39  2026-08-05 02:45  yes
      100       3,346      62  2026-08-05 16:24  2026-08-07 13:25  yes
      189       7,796      62  2026-08-06 16:36  2026-08-11 01:31  yes
      279      12,296      62  2026-08-07 17:05  2026-08-14 14:33  yes
      340      15,346      62  2026-08-08 09:40  2026-08-17 00:12  yes
      403      18,496      62  2026-08-09 02:48  2026-08-19 11:43  yes
      568      27,285     114  2026-08-11 02:37  2026-08-26 09:49  yes
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung     @1216 cores      @830 cores   binding
       30           4.6 d           4.6 d   critical_chain
      100           4.6 d           4.6 d   critical_chain
      189           4.6 d           6.5 d   throughput
      279           6.3 d           9.3 d   throughput
      340           7.6 d          11.1 d   throughput
      403           8.9 d          13.0 d   throughput
      568          12.3 d          18.1 d   throughput
...
2026-08-04T21:51:25Z  ATTN  records=14548 (+10)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.4m  drift=0  sci=OK  r115=22B  sweep=249.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T21:56:39Z  ATTN  records=14553 (+5)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=4.8m  drift=0  sci=OK  r115=22B  sweep=284.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T22:02:41Z  OK  records=14560 (+7)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.8m  drift=0  sci=OK  r115=22B  cores=1160  sweep=331.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T22:08:27Z  OK  records=14572 (+12)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  sweep=316.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T22:12:20Z  OK  records=14580 (+8)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=202.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
