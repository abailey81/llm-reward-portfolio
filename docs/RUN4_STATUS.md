...
**Auto-generated 2026-08-06 02:55 UTC -- T+197h46m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+197h46m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **963** (69 running, 894 queued) |
| **cores computing** | **552** |
...
```
generated 2026-08-06 02:55 UTC | elapsed 8.24 d | 20.9 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    !! 60% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_haiku_4_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,625      36  GATED             GATED             barrier>=30
      189       6,189      36  GATED             GATED             barrier>=30
      279      10,237      36  GATED             GATED             barrier>=30
      340      12,982      36  GATED             GATED             barrier>=30
      403      15,817      36  GATED             GATED             barrier>=30
      568      23,250      36  GATED             GATED             barrier>=30
