...
**Auto-generated 2026-08-04 18:55 UTC -- T+165h46m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+165h46m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **167** (165 running, 0 queued) |
...
```
generated 2026-08-04 18:55 UTC | elapsed 6.91 d | 22.2 d to the Aug-27 stop
test tier: 12,388 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     180 records     180.0 rec/h
    last  3 h     584 records     194.7 rec/h
    last 12 h    2399 records     199.9 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,855      49  GATED             GATED             barrier>=30
      189       8,305      49  GATED             GATED             barrier>=30
      279      12,805      49  GATED             GATED             barrier>=30
      340      15,855      49  GATED             GATED             barrier>=30
      403      19,005      49  GATED             GATED             barrier>=30
      568      27,940     180  GATED             GATED             barrier>=30
