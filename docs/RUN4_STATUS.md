...
**Auto-generated 2026-08-06 10:12 UTC -- T+205h03m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+205h03m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **888** |
| **cores doing RUNG-RAISING work** | **20.3%** -- 184 of 904 cores (18 min old) |
...
```
generated 2026-08-06 10:12 UTC | elapsed 8.54 d | 20.6 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,738     101  GATED             GATED             barrier>=30
      279       9,786     101  GATED             GATED             barrier>=30
      340      12,531     101  GATED             GATED             barrier>=30
      403      15,366     101  GATED             GATED             barrier>=30
      568      22,799     101  GATED             GATED             barrier>=30
    ...
    !! 78% of the rung-568 backlog (17,876 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
