...
**Auto-generated 2026-08-06 07:28 UTC -- T+202h19m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+202h19m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    1174 records      97.8 rec/h
    last 24 h    3165 records     131.9 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,908      13  GATED             GATED             barrier>=30
      279       9,956      13  GATED             GATED             barrier>=30
      340      12,701      13  GATED             GATED             barrier>=30
      403      15,536      13  GATED             GATED             barrier>=30
      568      22,969      13  GATED             GATED             barrier>=30
