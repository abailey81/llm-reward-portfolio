...
**Auto-generated 2026-08-05 12:45 UTC -- T+183h36m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+183h36m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 12:45 UTC | elapsed 7.65 d | 21.5 d to the Aug-27 stop
test tier: 15,066 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      74 records      74.0 rec/h
    last  3 h     356 records     118.7 rec/h
    last 12 h    1616 records     134.7 rec/h
    last 24 h    3855 records     160.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279      10,891       6  GATED             GATED             barrier>=30
      340      13,862      74  GATED             GATED             barrier>=30
      403      17,012      74  GATED             GATED             barrier>=30
      568      25,262      74  GATED             GATED             barrier>=30
