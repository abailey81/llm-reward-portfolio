...
**Auto-generated 2026-08-05 14:41 UTC -- T+185h32m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+185h32m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 3.9 h ago; none live, newest failure 1.6 h ago** |
...
| | |
|---|---|
| cluster jobs | **938** (186 running, 752 queued) |
...
```
generated 2026-08-05 14:41 UTC | elapsed 7.73 d | 21.4 d to the Aug-27 stop
test tier: 15,362 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     220 records     220.0 rec/h
    last  3 h     381 records     127.0 rec/h
    last 12 h    1767 records     147.2 rec/h
    last 24 h    3781 records     157.5 rec/h
    12 h rate is 77% from ONE line (test_leg_haiku_4_5); 5 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (146 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,636     150  GATED             GATED             barrier>=30
      403      16,716     220  GATED             GATED             barrier>=30
      568      24,966     220  GATED             GATED             barrier>=30
    ...
    !! 83% of the rung-568 backlog (20,624 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
...
2026-08-05T14:21:23Z  OK  records=16821 (+20)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  sweep=265.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T14:24:59Z  OK  records=16834 (+13)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.0m  drift=0  sci=OK  r115=22B  sweep=186.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T14:33:42Z  OK  records=16851 (+17)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.9m  drift=0  sci=OK  r115=22B  sweep=492.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T14:38:05Z  OK  records=16878 (+27)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.1m  drift=0  sci=OK  r115=22B  cores=1472  sweep=232.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
