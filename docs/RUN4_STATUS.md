...
```
generated 2026-08-06 05:53 UTC | elapsed 8.36 d | 20.8 d to the Aug-27 stop
test tier: 17,267 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     132 records     132.0 rec/h
    last  3 h     189 records      63.0 rec/h
    last 12 h    1301 records     108.4 rec/h
    last 24 h    3436 records     143.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,000     132  GATED             GATED             barrier>=30
      279      10,048     132  GATED             GATED             barrier>=30
      340      12,793     132  GATED             GATED             barrier>=30
      403      15,628     132  GATED             GATED             barrier>=30
      568      23,061     132  GATED             GATED             barrier>=30
