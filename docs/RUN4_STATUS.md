...
**Auto-generated 2026-08-10 04:27 UTC -- T+295h19m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+295h19m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **27162** |
| **Myriad maintenance** | **2026-08-12 from 08:00 UTC, at risk all day** (in 2.1 days). Delayed from Aug 11. Jobs may die and REQUEUE idempotently; the supervisors ride it. Playbook: docs/ops/MAINTENANCE_2026-08-12.md |
| LLM calls / spend | 2956 / **$45.5021** |
| transport health | **timeouts 6h=0; worst streak 0/240 (0.0% to fatal), - on -, age UNKNOWN; none live, newest failure 11.9 h ago** |
...
| | |
|---|---|
| cluster jobs | **922** = 160 running + **386 ELIGIBLE** + 376 held by us + 0 held only by the site |
...
| **cores doing RUNG-RAISING work** | **100.0%** -- 1256 of 1256 cores (50 min old) |
...
```
generated 2026-08-10 04:28 UTC | elapsed 12.31 d | 16.8 d to the Aug-27 stop
test tier: 25,622 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 111.1 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    last  1 h     145 records     145.0 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    ...
    last 12 h    1333 records     111.1 rec/h   usable
    last 24 h    2597 records     108.2 rec/h   usable
    12 h rate is 77% from ONE line (test); 5 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (111 rec/h); latest excludes cells already within
    8 of the ceiling (111 rec/h). Window 12 h.
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189         173     134  2026-08-10 06:02  2026-08-10 06:02  yes
      279       3,267     145  2026-08-11 09:53  2026-08-11 09:53  yes
      340       5,402     145  2026-08-12 05:06  2026-08-12 05:06  yes
      403       7,630     145  2026-08-13 01:09  2026-08-13 01:09  yes
      568      14,706     145  2026-08-15 16:51  2026-08-15 16:51  yes
...
> **What is holding it right now: test -- baseline_return_minus_turnover has 223 HOLE(S) below its frontier 406 -- that is what caps this line**
...
|---|---|---|---|---|
| nemotron_3_super | **159** | 162 | 5 |  |
| test | **187** | 191 | 9 |  |
| glm_5_2 | **188** | 190 | 5 |  |
| deepseek_v4_pro | **198** | 199 | 5 |  |
| qwen3_6_27b | **398** | 399 | 5 |  |
| kimi_k3 | **471** | 474 | 5 |  |
...
currently at **184 seeds each** (read live from the archive on this publish). !! THE
...
```
2026-08-10T02:50:19Z  OK  records=26948 (+40)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.1m  drift=0  sci=OK  r115=22B  cores=1272  sweep=1492.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-10T03:06:23Z  OK  records=26968 (+20)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=933.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-10T03:18:26Z  OK  records=27011 (+43)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.2m  drift=0  sci=OK  r115=22B  cores=1272  sweep=692.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-10T03:43:28Z  OK  records=27037 (+26)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.2m  drift=0  sci=OK  r115=22B  cores=1248  sweep=1472.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-10T03:59:41Z  OK  records=27054 (+17)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.8m  drift=0  sci=OK  r115=22B  sweep=942.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-10T04:11:46Z  OK  records=27102 (+48)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.7m  drift=0  sci=OK  r115=22B  cores=1232  sweep=695.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
