...
**Auto-generated 2026-08-03 08:51 UTC -- T+131h42m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+131h42m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **884** (255 running, 629 queued) |
| **cores computing** | **2040** |

Per-rung ETAs from the registered model at the cores we actually hold:

```
 rung             @2040 cores              @830 cores   binding
  ...
  403            5.3 d  08-03           13.0 d  08-10   throughput
...
|---|---|---|
| distributional | g5 of 5 | 1866 |
| scalar | g5 of 5 | 1282 |
| placebo | g5 of 5 | 1390 |
| scalar_cvar5 | g5 of 5 | 1366 |
| placebo_shuffled | g5 of 5 | 1379 |
...
```
2026-08-03T08:39:44Z  RED  records=7610 (+13)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=21B  sweep=63.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T08:41:17Z  RED  records=7627 (+17)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=1.8m  drift=0  sci=OK  r115=21B  sweep=127.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
