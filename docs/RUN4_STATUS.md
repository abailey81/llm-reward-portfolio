...
**Auto-generated 2026-08-05 00:29 UTC -- T+171h20m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+171h20m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 2.0 h ago; none live, newest failure 53 min ago** |
...
| | |
|---|---|
| cluster jobs | **961** (169 running, 790 queued) |
...
```
generated 2026-08-05 00:29 UTC | elapsed 7.14 d | 22.0 d to the Aug-27 stop
test tier: 13,426 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     140 records     140.0 rec/h
    last  3 h     443 records     147.7 rec/h
    last 12 h    2247 records     187.2 rec/h
    last 24 h    4233 records     176.4 rec/h
    12 h rate is 54% from ONE line (test_leg_sonnet_5); 10 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (85 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      26,902     140  GATED             GATED             barrier>=30
...
2026-08-05T00:28:00Z  OK  records=14957 (+13)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.2m  drift=0  sci=OK  r115=22B  sweep=268.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
