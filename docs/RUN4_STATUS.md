...
**Auto-generated 2026-08-06 04:56 UTC -- T+199h47m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+199h47m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **957** (72 running, 885 queued) |
| **cores computing** | **569** |
...
```
generated 2026-08-06 04:57 UTC | elapsed 8.33 d | 20.8 d to the Aug-27 stop
test tier: 17,137 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      51 records      51.0 rec/h
    last  3 h      90 records      30.0 rec/h
    last 12 h    1349 records     112.4 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,574      43  GATED             GATED             barrier>=30
      189       6,130      51  GATED             GATED             barrier>=30
      279      10,178      51  GATED             GATED             barrier>=30
      340      12,923      51  GATED             GATED             barrier>=30
      403      15,758      51  GATED             GATED             barrier>=30
      568      23,191      51  GATED             GATED             barrier>=30
