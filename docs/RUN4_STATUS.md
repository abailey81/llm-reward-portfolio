...
**Auto-generated 2026-08-06 11:21 UTC -- T+206h12m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+206h12m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **848** |
| **cores doing RUNG-RAISING work** | **21.4%** -- 192 of 896 cores (32 min old) |
...
```
generated 2026-08-06 11:22 UTC | elapsed 8.59 d | 20.5 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,689      41  GATED             GATED             barrier>=30
      279       9,720      58  GATED             GATED             barrier>=30
      340      12,465      58  GATED             GATED             barrier>=30
      403      15,300      58  GATED             GATED             barrier>=30
      568      22,733      58  GATED             GATED             barrier>=30
