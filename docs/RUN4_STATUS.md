...
**Auto-generated 2026-08-05 14:29 UTC -- T+185h20m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+185h20m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 3.7 h ago; none live, newest failure 84 min ago** |
...
| | |
|---|---|
| cluster jobs | **944** (184 running, 760 queued) |
...
```
generated 2026-08-05 14:29 UTC | elapsed 7.72 d | 21.4 d to the Aug-27 stop
test tier: 15,309 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     185 records     185.0 rec/h
    last  3 h     356 records     118.7 rec/h
    last 12 h    1717 records     143.1 rec/h
    last 24 h    3774 records     157.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (142 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,639     165  GATED             GATED             barrier>=30
      403      16,769     185  GATED             GATED             barrier>=30
      568      25,019     185  GATED             GATED             barrier>=30
