...
**Auto-generated 2026-08-06 06:24 UTC -- T+201h15m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+201h15m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **938** (88 running, 850 queued) |
| **cores computing** | **704** |
...
test tier: 17,331 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     138 records     138.0 rec/h
    last  3 h     252 records      84.0 rec/h
    last 12 h    1244 records     103.7 rec/h
    last 24 h    3381 records     140.9 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,936     138  GATED             GATED             barrier>=30
      279       9,984     138  GATED             GATED             barrier>=30
      340      12,729     138  GATED             GATED             barrier>=30
      403      15,564     138  GATED             GATED             barrier>=30
      568      22,997     138  GATED             GATED             barrier>=30
