...
**Auto-generated 2026-08-06 00:14 UTC -- T+195h05m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h05m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.2 h ago; none live, newest failure 10 min ago** |
...
| | |
|---|---|
| cluster jobs | **990** (64 running, 926 queued) |
| **cores computing** | **512** |
...
```
generated 2026-08-06 00:14 UTC | elapsed 8.13 d | 21.0 d to the Aug-27 stop
test tier: 16,932 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     229 records     229.0 rec/h
    last  3 h     534 records     178.0 rec/h
    last 12 h    1886 records     157.2 rec/h
    last 24 h    3539 records     147.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,762     147  GATED             GATED             barrier>=30
      189       6,334     228  GATED             GATED             barrier>=30
      279      10,383     229  GATED             GATED             barrier>=30
      340      13,128     229  GATED             GATED             barrier>=30
      403      15,963     229  GATED             GATED             barrier>=30
      568      23,396     229  GATED             GATED             barrier>=30
