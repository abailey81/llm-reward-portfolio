...
**Auto-generated 2026-08-04 23:06 UTC -- T+169h57m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+169h57m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 37 min ago; none live, newest failure 37 min ago** |
...
| | |
|---|---|
| cluster jobs | **991** (166 running, 823 queued) |
...
```
generated 2026-08-04 23:07 UTC | elapsed 7.08 d | 22.0 d to the Aug-27 stop
test tier: 13,210 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     177 records     177.0 rec/h
    last  3 h     574 records     191.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      27,118     177  GATED             GATED             barrier>=30
