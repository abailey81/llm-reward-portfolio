...
**Auto-generated 2026-08-05 03:31 UTC -- T+174h22m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+174h22m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 5.0 h ago; none live, newest failure 75 min ago** |
...
| | |
|---|---|
| cluster jobs | **990** (188 running, 802 queued) |
...
```
generated 2026-08-05 03:31 UTC | elapsed 7.27 d | 21.9 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     174 records      58.0 rec/h
    last 12 h    1871 records     155.9 rec/h
    last 24 h    4035 records     168.1 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (156 rec/h); latest excludes cells already within
