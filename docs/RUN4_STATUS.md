...
**Auto-generated 2026-08-05 08:40 UTC -- T+179h31m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+179h31m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 84 min ago; none live, newest failure 84 min ago** |
...
| | |
|---|---|
| cluster jobs | **889** (199 running, 690 queued) |
...
```
generated 2026-08-05 08:40 UTC | elapsed 7.48 d | 21.6 d to the Aug-27 stop
test tier: 14,525 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     268 records     268.0 rec/h
    last  3 h     758 records     252.7 rec/h
    last 12 h    1751 records     145.9 rec/h
    last 24 h    4085 records     170.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,100     132  GATED             GATED             barrier>=30
      189       7,105     132  GATED             GATED             barrier>=30
      279      11,353     268  GATED             GATED             barrier>=30
      340      14,403     268  GATED             GATED             barrier>=30
      403      17,553     268  GATED             GATED             barrier>=30
      568      25,803     268  GATED             GATED             barrier>=30
...
```
2026-08-05T08:27:36Z  OK  records=16015 (+14)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.4m  drift=0  sci=OK  r115=22B  cores=1552  sweep=109.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
