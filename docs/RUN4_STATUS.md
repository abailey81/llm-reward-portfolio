...
**Auto-generated 2026-08-04 17:31 UTC -- T+164h22m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+164h22m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=11; worst streak 21/240 (8.8% to fatal), pull on core, 5.0 h ago; none live, newest failure 1.7 h ago** |
...
| | |
|---|---|
| cluster jobs | **215** (212 running, 1 queued) |
...
```
generated 2026-08-04 17:31 UTC | elapsed 6.85 d | 22.3 d to the Aug-27 stop
test tier: 12,055 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (187 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      28,273     187  GATED             GATED             barrier>=30
