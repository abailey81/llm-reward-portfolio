...
**Auto-generated 2026-08-06 06:05 UTC -- T+200h56m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h56m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **941** (72 running, 869 queued) |
| **cores computing** | **576** |
...
```
generated 2026-08-06 06:05 UTC | elapsed 8.37 d | 20.7 d to the Aug-27 stop
test tier: 17,292 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     143 records     143.0 rec/h
    last  3 h     214 records      71.3 rec/h
    last 12 h    1276 records     106.3 rec/h
    ...
    !! 32% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_haiku_4_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,975     143  GATED             GATED             barrier>=30
      279      10,023     143  GATED             GATED             barrier>=30
      340      12,768     143  GATED             GATED             barrier>=30
      403      15,603     143  GATED             GATED             barrier>=30
      568      23,036     143  GATED             GATED             barrier>=30
