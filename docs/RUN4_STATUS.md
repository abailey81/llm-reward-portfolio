...
**Auto-generated 2026-08-05 07:53 UTC -- T+178h44m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+178h44m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 37 min ago; none live, newest failure 37 min ago** |
...
```
generated 2026-08-05 07:53 UTC | elapsed 7.45 d | 21.7 d to the Aug-27 stop
test tier: 14,309 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     241 records     241.0 rec/h
    last  3 h     690 records     230.0 rec/h
    last 12 h    1712 records     142.7 rec/h
    last 24 h    4111 records     171.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       7,228      82  GATED             GATED             barrier>=30
      279      11,569     241  GATED             GATED             barrier>=30
      340      14,619     241  GATED             GATED             barrier>=30
      403      17,769     241  GATED             GATED             barrier>=30
      568      26,019     241  GATED             GATED             barrier>=30
