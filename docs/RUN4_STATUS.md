...
**Auto-generated 2026-08-06 01:16 UTC -- T+196h07m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+196h07m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,697      53  GATED             GATED             barrier>=30
      189       6,261      61  GATED             GATED             barrier>=30
      279      10,309      62  GATED             GATED             barrier>=30
      340      13,054      62  GATED             GATED             barrier>=30
      403      15,889      62  GATED             GATED             barrier>=30
      568      23,322      62  GATED             GATED             barrier>=30
