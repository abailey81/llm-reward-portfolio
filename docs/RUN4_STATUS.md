...
**Auto-generated 2026-08-05 19:57 UTC -- T+190h48m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+190h48m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 54 min ago; none live, newest failure 54 min ago** |
...
| | |
|---|---|
| cluster jobs | **826** (118 running, 708 queued) |
| **cores computing** | **944** |
...
```
generated 2026-08-05 19:57 UTC | elapsed 7.95 d | 21.2 d to the Aug-27 stop
test tier: 16,233 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      83 records      83.0 rec/h
    last  3 h     445 records     148.3 rec/h
    last 12 h    1907 records     158.9 rec/h
    last 24 h    3624 records     151.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      24,095      83  GATED             GATED             barrier>=30
    ...
    !! 86% of the rung-568 backlog (20,624 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
...
2026-08-05T19:27:40Z  OK  records=17726 (+6)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.1m  drift=0  sci=OK  r115=22B  sweep=417.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T19:34:43Z  ATTN  records=17737 (+11)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=99  stalest=3.0m  drift=0  sci=OK  r115=22B  cores=928  sweep=392.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T19:41:52Z  OK  records=17744 (+7)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  sweep=398.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T19:49:44Z  ATTN  records=17758 (+14)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=99  stalest=1.9m  drift=0  sci=OK  r115=22B  sweep=442.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T20:00:27Z  ATTN  records=17770 (+12)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=99  stalest=3.1m  drift=0  sci=OK  r115=22B  cores=944  sweep=612.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
