...
**Auto-generated 2026-08-05 06:01 UTC -- T+176h52m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+176h52m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 59 min ago; none live, newest failure 59 min ago** |
...
| | |
|---|---|
| cluster jobs | **963** (211 running, 752 queued) |
...
```
generated 2026-08-05 06:01 UTC | elapsed 7.37 d | 21.7 d to the Aug-27 stop
test tier: 13,866 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     239 records     239.0 rec/h
    last  3 h     269 records      89.7 rec/h
    last 12 h    1642 records     136.8 rec/h
    last 24 h    3975 records     165.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,238      63  GATED             GATED             barrier>=30
      189       7,512     239  GATED             GATED             barrier>=30
      279      12,012     239  GATED             GATED             barrier>=30
      340      15,062     239  GATED             GATED             barrier>=30
      403      18,212     239  GATED             GATED             barrier>=30
      568      26,462     239  GATED             GATED             barrier>=30
