...
**Auto-generated 2026-08-05 01:40 UTC -- T+172h31m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+172h31m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 3.2 h ago; none live, newest failure 2.1 h ago** |
...
| | |
|---|---|
| cluster jobs | **945** (176 running, 767 queued) |
...
```
generated 2026-08-05 01:41 UTC | elapsed 7.19 d | 21.9 d to the Aug-27 stop
test tier: 13,550 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     108 records     108.0 rec/h
    last  3 h     440 records     146.7 rec/h
    last 12 h    2173 records     181.1 rec/h
    last 24 h    4242 records     176.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (181 rec/h); latest excludes cells already within
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,332       8  GATED             GATED             barrier>=30
      189       7,782       8  GATED             GATED             barrier>=30
      279      12,282       8  GATED             GATED             barrier>=30
      340      15,332       8  GATED             GATED             barrier>=30
      403      18,482       8  GATED             GATED             barrier>=30
      568      26,778     108  GATED             GATED             barrier>=30
