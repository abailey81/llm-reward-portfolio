...
**Auto-generated 2026-08-11 20:36 UTC -- T+335h27m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+335h27m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on deepseek-v4-pro, 2.9 h ago; none live, newest failure 2.9 h ago** |
...
| | |
|---|---|
| cluster jobs | **424** = 62 running + **34 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **496** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (63 min old) |
...
```
generated 2026-08-11 20:36 UTC | elapsed 13.98 d | 15.1 d to the Aug-27 stop
test tier: 29,920 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    2806 records     116.9 rec/h   usable
    12 h rate is 89% from ONE line (test); 2 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,679      90  GATED             GATED             barrier>=279
      403       3,884      90  GATED             GATED             barrier>=279
      568      10,408      90  GATED             GATED             barrier>=279
...
currently at **302 seeds each** (read live from the archive on this publish). !! THE
...
```
2026-08-11T20:18:01Z  OK  records=31434 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  sweep=49.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T20:19:26Z  OK  records=31437 (+3)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  sweep=54.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T20:20:46Z  OK  records=31438 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.4m  drift=0  sci=OK  r115=22B  sweep=49.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T20:22:07Z  OK  records=31438 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  sweep=50.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T20:23:28Z  OK  records=31444 (+6)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=0.5m  drift=0  sci=OK  r115=22B  sweep=50.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T20:35:54Z  OK  records=31463 (+19)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  cores=496  sweep=716.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
