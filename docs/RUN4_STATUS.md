...
**Auto-generated 2026-08-05 11:31 UTC -- T+182h22m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+182h22m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=2; worst streak 1/240 (0.4% to fatal), ops on core, 4.2 h ago; none live, newest failure 41 min ago** |
| transport timeouts (cumulative, ever) | 181 -- a level with no rate; read the row above |
...
| | |
|---|---|
| cluster jobs | **985** (184 running, 801 queued) |
...
```
generated 2026-08-05 11:31 UTC | elapsed 7.60 d | 21.5 d to the Aug-27 stop
test tier: 14,957 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     113 records     113.0 rec/h
    last  3 h     470 records     156.7 rec/h
    last 12 h    1669 records     139.1 rec/h
    last 24 h    3916 records     163.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         180       2  GATED             GATED             barrier
      100       2,980       2  GATED             GATED             barrier>=30
      189       6,841      11  GATED             GATED             barrier>=30
      279      10,921     113  GATED             GATED             barrier>=30
      340      13,971     113  GATED             GATED             barrier>=30
      403      17,121     113  GATED             GATED             barrier>=30
      568      25,371     113  GATED             GATED             barrier>=30
