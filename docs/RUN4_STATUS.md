...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,626      41  GATED             GATED             barrier>=30
      189       6,190      41  GATED             GATED             barrier>=30
      279      10,238      41  GATED             GATED             barrier>=30
      340      12,983      41  GATED             GATED             barrier>=30
      403      15,818      41  GATED             GATED             barrier>=30
      568      23,251      41  GATED             GATED             barrier>=30
