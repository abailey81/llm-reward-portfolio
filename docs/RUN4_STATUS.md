...
**Auto-generated 2026-08-06 06:01 UTC -- T+200h52m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h52m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 06:01 UTC | elapsed 8.37 d | 20.7 d to the Aug-27 stop
test tier: 17,283 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     138 records     138.0 rec/h
    last  3 h     205 records      68.3 rec/h
    last 12 h    1289 records     107.4 rec/h
    last 24 h    3410 records     142.1 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,984     138  GATED             GATED             barrier>=30
      279      10,032     138  GATED             GATED             barrier>=30
      340      12,777     138  GATED             GATED             barrier>=30
      403      15,612     138  GATED             GATED             barrier>=30
      568      23,045     138  GATED             GATED             barrier>=30
