...
**Auto-generated 2026-08-05 10:49 UTC -- T+181h40m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+181h40m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **991** (169 running, 822 queued) |
...
```
generated 2026-08-05 10:49 UTC | elapsed 7.57 d | 21.5 d to the Aug-27 stop
test tier: 14,886 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     167 records     167.0 rec/h
    last  3 h     591 records     197.0 rec/h
    ...
    !! 26% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         180      43  GATED             GATED             barrier
      100       2,980      43  GATED             GATED             barrier>=30
      189       6,842      88  GATED             GATED             barrier>=30
      279      10,992     167  GATED             GATED             barrier>=30
      340      14,042     167  GATED             GATED             barrier>=30
      403      17,192     167  GATED             GATED             barrier>=30
      568      25,442     167  GATED             GATED             barrier>=30
