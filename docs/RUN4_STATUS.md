...
**Auto-generated 2026-08-05 07:04 UTC -- T+177h55m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+177h55m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **933** (197 running, 736 queued) |
...
```
generated 2026-08-05 07:04 UTC | elapsed 7.41 d | 21.7 d to the Aug-27 stop
test tier: 14,098 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     213 records     213.0 rec/h
    last  3 h     494 records     164.7 rec/h
    last 12 h    1673 records     139.4 rec/h
    last 24 h    4073 records     169.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       7,280     213  GATED             GATED             barrier>=30
      279      11,780     213  GATED             GATED             barrier>=30
      340      14,830     213  GATED             GATED             barrier>=30
      403      17,980     213  GATED             GATED             barrier>=30
      568      26,230     213  GATED             GATED             barrier>=30
