...
**Auto-generated 2026-08-06 12:03 UTC -- T+206h54m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+206h54m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **899** (105 running, 794 queued) |
| **cores computing** | **840** |
| **cores doing RUNG-RAISING work** | **22.9%** -- 192 of 840 cores (0 min old) |
...
```
generated 2026-08-06 12:04 UTC | elapsed 8.62 d | 20.5 d to the Aug-27 stop
test tier: 17,608 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    2572 records     107.2 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,707      21  GATED             GATED             barrier>=30
      340      12,452      21  GATED             GATED             barrier>=30
      403      15,287      21  GATED             GATED             barrier>=30
      568      22,720      21  GATED             GATED             barrier>=30
