...
**Auto-generated 2026-08-06 01:23 UTC -- T+196h14m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+196h14m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 79 min ago; none live, newest failure 79 min ago** |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,695      32  GATED             GATED             barrier>=30
      189       6,259      38  GATED             GATED             barrier>=30
      279      10,307      39  GATED             GATED             barrier>=30
      340      13,052      39  GATED             GATED             barrier>=30
      403      15,887      39  GATED             GATED             barrier>=30
      568      23,320      39  GATED             GATED             barrier>=30
