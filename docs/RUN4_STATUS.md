...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 38 min ago; none live, newest failure 37 min ago** |
...
| | |
|---|---|
| cluster jobs | **868** (74 running, 794 queued) |
| **cores computing** | **592** |
| **cores doing RUNG-RAISING work** | **22.6%** -- 184 of 816 cores (148 min old **STALE**) |
...
```
generated 2026-08-06 15:12 UTC | elapsed 8.75 d | 20.4 d to the Aug-27 stop
test tier: 17,957 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30          66      37  GATED             GATED             unstarted:2-unit(s)-absent
      100       2,516      37  GATED             GATED             unstarted:2-unit(s)-absent>=30
      189       5,631      38  GATED             GATED             unstarted:2-unit(s)-absent>=30
      279       9,358     251  GATED             GATED             unstarted:2-unit(s)-absent>=30
      340      12,103     251  GATED             GATED             unstarted:2-unit(s)-absent>=30
      403      14,938     251  GATED             GATED             unstarted:2-unit(s)-absent>=30
      568      22,371     251  GATED             GATED             unstarted:2-unit(s)-absent>=30
