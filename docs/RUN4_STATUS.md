...
**Auto-generated 2026-08-06 06:41 UTC -- T+201h32m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+201h32m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **932** (97 running, 835 queued) |
| **cores computing** | **776** |
...
```
generated 2026-08-06 06:41 UTC | elapsed 8.40 d | 20.7 d to the Aug-27 stop
test tier: 17,358 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     116 records     116.0 rec/h
    last  3 h     279 records      93.0 rec/h
    last 12 h    1240 records     103.3 rec/h
    last 24 h    3350 records     139.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,909     116  GATED             GATED             barrier>=30
      279       9,957     116  GATED             GATED             barrier>=30
      340      12,702     116  GATED             GATED             barrier>=30
      403      15,537     116  GATED             GATED             barrier>=30
      568      22,970     116  GATED             GATED             barrier>=30
