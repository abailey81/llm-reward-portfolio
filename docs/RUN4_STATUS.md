...
**Auto-generated 2026-08-11 15:40 UTC -- T+330h31m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+330h31m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **488** = 84 running + **76 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **672** |
| **cores doing RUNG-RAISING work** | **36.1%** -- 240 of 664 cores (7 min old) |
...
```
generated 2026-08-11 15:40 UTC | elapsed 13.77 d | 15.3 d to the Aug-27 stop
test tier: 29,440 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 134.0 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last  3 h     456 records     152.0 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last 12 h    1608 records     134.0 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279         160      56  2026-08-11 16:52  2026-08-11 16:52  yes
      340       2,159     191  2026-08-12 07:47  2026-08-12 07:47  yes
      403       4,364     191  2026-08-13 00:14  2026-08-13 00:14  yes
      568      10,888     191  2026-08-15 00:56  2026-08-15 00:56  yes
...
> **What is holding it right now: test -- baseline_raw_return has 123 HOLE(S) below its frontier 406 -- that is what caps this line**
