...
**Auto-generated 2026-08-05 03:10 UTC -- T+174h01m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+174h01m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
| lines up | **8 / 12 running; 4 COMPLETE (gemini-2.5-flash, gpt-5.6-luna, h3, qwen3.5-9b)**, all five arms submitted on **10 of the 10 leg lines** (h3ss is single-arm by design) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 4.7 h ago; none live, newest failure 54 min ago** |
...
```
generated 2026-08-05 03:11 UTC | elapsed 7.25 d | 21.9 d to the Aug-27 stop
test tier: 13,598 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      12 records      12.0 rec/h
    last  3 h     213 records      71.0 rec/h
    last 12 h    1920 records     160.0 rec/h
    last 24 h    4077 records     169.9 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (160 rec/h); latest excludes cells already within
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      26,730      12  GATED             GATED             barrier>=30
...
2026-08-05T03:08:42Z  OK  records=15140 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  cores=1480  sweep=295.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
