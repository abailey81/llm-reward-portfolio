...
**Auto-generated 2026-08-06 16:03 UTC -- T+210h54m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+210h54m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 90 min ago; none live, newest failure 89 min ago** |
...
| | |
|---|---|
| cluster jobs | **868** (47 running, 821 queued) |
| **cores computing** | **376** |
| **cores doing RUNG-RAISING work** | **17.0%** -- 72 of 424 cores (24 min old) |
...
```
generated 2026-08-06 16:03 UTC | elapsed 8.79 d | 20.3 d to the Aug-27 stop
test tier: 18,124 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30          60       9  GATED             GATED             unstarted:2-unit(s)-absent
      100       2,510       9  GATED             GATED             unstarted:2-unit(s)-absent>=30
      189       5,625       9  GATED             GATED             unstarted:2-unit(s)-absent>=30
      279       9,191     227  GATED             GATED             unstarted:2-unit(s)-absent>=30
      340      11,936     227  GATED             GATED             unstarted:2-unit(s)-absent>=30
      403      14,771     227  GATED             GATED             unstarted:2-unit(s)-absent>=30
      568      22,204     227  GATED             GATED             unstarted:2-unit(s)-absent>=30
