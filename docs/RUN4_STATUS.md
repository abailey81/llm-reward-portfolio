...
**Auto-generated 2026-08-03 06:28 UTC -- T+129h19m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+129h19m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **951** (290 running, 661 queued) |
...
| scalar | g5 of 5 | 1147 |
| placebo | g5 of 5 | 1284 |
| scalar_cvar5 | g5 of 5 | 1246 |
| placebo_shuffled | g5 of 5 | 1259 |
...
2026-08-03T06:26:28Z  RED  records=7072 (+4)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=21B  sweep=104.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
