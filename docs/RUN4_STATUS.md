...
**Auto-generated 2026-08-11 17:59 UTC -- T+332h50m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+332h50m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on core, 5.4 h ago; none live, newest failure 19 min ago** |
...
| | |
|---|---|
| cluster jobs | **453** = 65 running + **60 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **520** |
| **cores doing RUNG-RAISING work** | **4.8%** -- 24 of 504 cores (26 min old) |
...
```
generated 2026-08-11 18:00 UTC | elapsed 13.87 d | 15.2 d to the Aug-27 stop
test tier: 29,724 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279         128      11  GATED             GATED             barrier
      340       1,875     101  GATED             GATED             barrier>=279
      403       4,080     101  GATED             GATED             barrier>=279
      568      10,604     101  GATED             GATED             barrier>=279
