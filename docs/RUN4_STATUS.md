...
**Auto-generated 2026-08-06 03:02 UTC -- T+197h53m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+197h53m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 03:03 UTC | elapsed 8.25 d | 20.9 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,625      22  GATED             GATED             barrier>=30
      189       6,189      22  GATED             GATED             barrier>=30
      279      10,237      22  GATED             GATED             barrier>=30
      340      12,982      22  GATED             GATED             barrier>=30
      403      15,817      22  GATED             GATED             barrier>=30
      568      23,250      22  GATED             GATED             barrier>=30
