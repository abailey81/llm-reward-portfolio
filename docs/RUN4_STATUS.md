...
**Auto-generated 2026-08-02 13:50 UTC -- T+112h41m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+112h41m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **934** (230 running, 704 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1087 |
| scalar | g5 of 5 | 495 |
| placebo | g5 of 5 | 721 |
| scalar_cvar5 | g5 of 5 | 678 |
| placebo_shuffled | g5 of 5 | 669 |
...
```
2026-08-02T13:44:49Z  RED  records=4025 (+5)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=21B  sweep=50.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T13:46:10Z  RED  records=4028 (+3)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=21B  sweep=27.5s  auto-cycle
2026-08-02T13:47:08Z  RED  records=4028 (+0)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=21B  sweep=28.7s  auto-cycle
2026-08-02T13:48:07Z  RED  records=4034 (+6)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=21B  sweep=28.5s  auto-cycle
2026-08-02T13:49:05Z  RED  records=4035 (+1)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.4m  drift=0  sci=OK  r115=21B  sweep=26.8s  auto-cycle
