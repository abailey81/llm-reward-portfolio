...
**Auto-generated 2026-08-05 15:53 UTC -- T+186h44m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+186h44m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 15:53 UTC | elapsed 7.78 d | 21.3 d to the Aug-27 stop
test tier: 15,575 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     156 records     156.0 rec/h
    last  3 h     500 records     166.7 rec/h
    last 12 h    1971 records     164.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      403      16,503     156  GATED             GATED             barrier>=30
      568      24,753     156  GATED             GATED             barrier>=30
