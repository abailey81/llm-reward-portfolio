...
**Auto-generated 2026-08-05 02:54 UTC -- T+173h45m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+173h45m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 4.4 h ago; none live, newest failure 38 min ago** |
...
```
generated 2026-08-05 02:55 UTC | elapsed 7.24 d | 21.9 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     252 records      84.0 rec/h
    last 12 h    1963 records     163.6 rec/h
    last 24 h    4123 records     171.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (164 rec/h); latest excludes cells already within
