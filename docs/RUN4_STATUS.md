...
**Auto-generated 2026-08-05 05:39 UTC -- T+176h30m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+176h30m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 37 min ago; none live, newest failure 37 min ago** |
...
| | |
|---|---|
| cluster jobs | **978** (204 running, 774 queued) |
| **cores computing** | **1632** |
...
```
generated 2026-08-05 05:39 UTC | elapsed 7.35 d | 21.8 d to the Aug-27 stop
test tier: 13,746 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     135 records     135.0 rec/h
    last  3 h     152 records      50.7 rec/h
    last 12 h    1626 records     135.5 rec/h
    last 24 h    3910 records     162.9 rec/h
    12 h rate is 37% from ONE line (test_leg_qwen3_5_9b); 10 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 56% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,238      79  GATED             GATED             barrier>=30
      189       7,632     135  GATED             GATED             barrier>=30
      279      12,132     135  GATED             GATED             barrier>=30
      340      15,182     135  GATED             GATED             barrier>=30
      403      18,332     135  GATED             GATED             barrier>=30
      568      26,582     135  GATED             GATED             barrier>=30
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung     @1632 cores      @830 cores   binding
