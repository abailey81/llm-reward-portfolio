...
**Auto-generated 2026-08-11 21:50 UTC -- T+336h41m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+336h41m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on deepseek-v4-pro, 4.2 h ago; none live, newest failure 4.2 h ago** |
...
| | |
|---|---|
| cluster jobs | **417** = 77 running + **12 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **616** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (138 min old **STALE**) |
...
```
generated 2026-08-11 21:51 UTC | elapsed 14.03 d | 15.1 d to the Aug-27 stop
test tier: 29,997 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 108.5 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last  3 h     203 records      67.7 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last 12 h    1302 records     108.5 rec/h   usable
    last 24 h    2680 records     111.7 rec/h   usable
    12 h rate is 87% from ONE line (test); 2 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (108 rec/h); latest excludes cells already within
    8 of the ceiling (108 rec/h). Window 12 h.
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,602      57  GATED             GATED             barrier>=279
      403       3,807      57  GATED             GATED             barrier>=279
      568      10,331      57  GATED             GATED             barrier>=279
...
> **What is holding it right now: test_leg_deepseek_v4_pro -- placebo has 32 HOLE(S) below its frontier 339 -- that is what caps this line**
...
```
2026-08-11T21:38:41Z  OK  records=31519 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.6m  drift=0  sci=OK  r115=22B  sweep=54.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T21:40:09Z  OK  records=31520 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.2m  drift=0  sci=OK  r115=22B  sweep=58.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T21:41:33Z  OK  records=31522 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.2m  drift=0  sci=OK  r115=22B  sweep=53.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T21:42:55Z  OK  records=31524 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.9m  drift=0  sci=OK  r115=22B  sweep=51.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T21:44:18Z  OK  records=31525 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  sweep=53.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T21:45:40Z  OK  records=31526 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=52.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
