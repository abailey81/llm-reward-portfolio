...
**Auto-generated 2026-08-01 07:30 UTC -- T+82h21m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+82h21m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **2210** |
| LLM calls / spend | 2763 / **$43.2813** |
...
| | |
|---|---|
| cluster jobs | **126** (123 running, 2 queued) |
| **cores computing** | **984** |
...
|---|---|---|
| distributional | g5 of 5 | 852 |
| scalar | g5 of 5 | 296 |
| placebo | g5 of 5 | 251 |
| scalar_cvar5 | g5 of 5 | 229 |
| placebo_shuffled | g5 of 5 | 191 |
...
```
2026-08-01T07:26:47Z  RED  records=2204 (+1)  spend=$43.2813  guards=2  arms_full=10/10  budget=2  stalest=1.8m  drift=0  sci=OK  r115=14B  sweep=15.6s  auto-cycle
2026-08-01T07:27:33Z  RED  records=2206 (+2)  spend=$43.2813  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=14B  sweep=13.6s  auto-cycle
2026-08-01T07:28:17Z  RED  records=2207 (+1)  spend=$43.2813  guards=2  arms_full=10/10  budget=2  stalest=1.7m  drift=0  sci=OK  r115=14B  cores=976  sweep=16.7s  auto-cycle
2026-08-01T07:29:04Z  RED  records=2208 (+1)  spend=$43.2813  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=14B  sweep=14.8s  auto-cycle
2026-08-01T07:29:49Z  RED  records=2209 (+1)  spend=$43.2813  guards=2  arms_full=10/10  budget=2  stalest=1.6m  drift=0  sci=OK  r115=14B  sweep=12.3s  auto-cycle
2026-08-01T07:30:31Z  RED  records=2210 (+1)  spend=$43.2813  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=14B  sweep=16.1s  auto-cycle
```
