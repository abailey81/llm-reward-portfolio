...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 83 min ago; none live, newest failure 82 min ago** |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,203     252  GATED             GATED             unstarted:2-unit(s)-absent>=30
      340      11,948     252  GATED             GATED             unstarted:2-unit(s)-absent>=30
      403      14,783     252  GATED             GATED             unstarted:2-unit(s)-absent>=30
      568      22,216     252  GATED             GATED             unstarted:2-unit(s)-absent>=30
