...
**Auto-generated 2026-08-06 05:12 UTC -- T+200h03m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h03m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    1324 records     110.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,570      33  GATED             GATED             barrier>=30
      189       6,107      60  GATED             GATED             barrier>=30
      279      10,155      60  GATED             GATED             barrier>=30
      340      12,900      60  GATED             GATED             barrier>=30
      403      15,735      60  GATED             GATED             barrier>=30
      568      23,168      60  GATED             GATED             barrier>=30
