...
**Auto-generated 2026-08-06 00:57 UTC -- T+195h48m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h48m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.9 h ago; none live, newest failure 53 min ago** |
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    1917 records     159.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,269     118  GATED             GATED             barrier>=30
      279      10,317     120  GATED             GATED             barrier>=30
      340      13,062     120  GATED             GATED             barrier>=30
      403      15,897     120  GATED             GATED             barrier>=30
      568      23,330     120  GATED             GATED             barrier>=30
