...
**Auto-generated 2026-08-05 12:14 UTC -- T+183h05m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+183h05m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=5; worst streak 1/240 (0.4% to fatal), ops on core, 5.0 h ago; none live, newest failure 85 min ago** |
...
```
generated 2026-08-05 12:14 UTC | elapsed 7.63 d | 21.5 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     391 records     130.3 rec/h
    last 12 h    1653 records     137.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279      10,891      56  GATED             GATED             barrier>=30
      340      13,882     115  GATED             GATED             barrier>=30
      403      17,032     115  GATED             GATED             barrier>=30
      568      25,282     115  GATED             GATED             barrier>=30
