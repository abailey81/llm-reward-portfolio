...
**Auto-generated 2026-08-02 02:14 UTC -- T+101h05m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+101h05m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **59** (53 running, 6 queued) |
| **cores computing** | **424** |
...
```
 rung              @424 cores              @830 cores   binding
  ...
  100            7.5 d  08-05            4.6 d  08-02   critical_chain
  189           12.8 d  08-10            6.5 d  08-04   throughput
  279           18.1 d  08-16            9.3 d  08-07   throughput
  340           21.8 d  08-19           11.1 d  08-09   throughput
  403           25.5 d  08-23           13.0 d  08-10   throughput
  568        35.4 d  09-02  X           18.1 d  08-15   throughput
```
...
| scalar | g5 of 5 | 326 |
| placebo | g5 of 5 | 588 |
| scalar_cvar5 | g5 of 5 | 495 |
| placebo_shuffled | g5 of 5 | 448 |
...
```
2026-08-02T02:09:17Z  RED  records=3151 (+4)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0  sci=OK  r115=20B  sweep=17.8s  auto-cycle
2026-08-02T02:10:05Z  RED  records=3151 (+0)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=20B  sweep=20.1s  auto-cycle
2026-08-02T02:10:56Z  RED  records=3153 (+2)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=3.2m  drift=0  sci=OK  r115=20B  sweep=20.6s  auto-cycle
2026-08-02T02:11:46Z  RED  records=3153 (+0)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=4.0m  drift=0  sci=OK  r115=20B  sweep=20.4s  auto-cycle
2026-08-02T02:12:37Z  RED  records=3155 (+2)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=20B  sweep=36.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T02:13:43Z  RED  records=3156 (+1)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=20B  sweep=21.0s  auto-cycle
```
