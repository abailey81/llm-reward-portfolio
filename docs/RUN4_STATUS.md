...
**Auto-generated 2026-08-04 22:26 UTC -- T+169h17m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+169h17m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 0/240 (0.0% to fatal), - on -, age UNKNOWN; none live, newest failure 6.6 h ago** |
...
| | |
|---|---|
| cluster jobs | **893** (154 running, 737 queued) |
| **cores computing** | **1232** |
...
```
generated 2026-08-04 22:26 UTC | elapsed 7.05 d | 22.1 d to the Aug-27 stop
test tier: 13,068 records over 68 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      97 records      97.0 rec/h
    last  3 h     562 records     187.3 rec/h
    last 12 h    2193 records     182.8 rec/h
    last 24 h    4325 records     180.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,343      36  GATED             GATED             barrier>=30
      189       7,793      36  GATED             GATED             barrier>=30
      279      12,293      36  GATED             GATED             barrier>=30
      340      15,343      36  GATED             GATED             barrier>=30
      403      18,493      36  GATED             GATED             barrier>=30
      568      27,260      97  GATED             GATED             barrier>=30
