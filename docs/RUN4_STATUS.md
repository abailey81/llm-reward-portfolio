...
**Auto-generated 2026-08-03 08:52 UTC -- T+131h44m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+131h44m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **881** (253 running, 628 queued) |
| **cores computing** | **2024** |

Per-rung ETAs from the registered model at the cores we actually hold:

```
 rung             @2024 cores              @830 cores   binding
...
|---|---|---|
| distributional | g5 of 5 | 1867 |
| scalar | g5 of 5 | 1284 |
| placebo | g5 of 5 | 1393 |
| scalar_cvar5 | g5 of 5 | 1369 |
| placebo_shuffled | g5 of 5 | 1382 |
