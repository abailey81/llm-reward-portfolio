...
**Auto-generated 2026-08-05 11:18 UTC -- T+182h09m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+182h09m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 4.0 h ago; none live, newest failure 28 min ago** |
...
| | |
|---|---|
| cluster jobs | **989** (169 running, 820 queued) |
...
```
generated 2026-08-05 11:18 UTC | elapsed 7.59 d | 21.5 d to the Aug-27 stop
test tier: 14,935 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     138 records     138.0 rec/h
    last  3 h     502 records     167.3 rec/h
    last 12 h    1682 records     140.2 rec/h
    last 24 h    3942 records     164.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         180      16  GATED             GATED             barrier
      100       2,980      16  GATED             GATED             barrier>=30
      189       6,841      33  GATED             GATED             barrier>=30
      279      10,943     138  GATED             GATED             barrier>=30
      340      13,993     138  GATED             GATED             barrier>=30
      403      17,143     138  GATED             GATED             barrier>=30
      568      25,393     138  GATED             GATED             barrier>=30
...
2026-08-05T11:18:28Z  OK  records=16477 (+7)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.0m  drift=0  sci=OK  r115=22B  sweep=141.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
