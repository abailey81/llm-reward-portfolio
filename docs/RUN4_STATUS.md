...
**Auto-generated 2026-08-05 06:44 UTC -- T+177h35m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+177h35m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **943** (205 running, 738 queued) |
...
```
generated 2026-08-05 06:44 UTC | elapsed 7.40 d | 21.7 d to the Aug-27 stop
test tier: 14,017 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     231 records     231.0 rec/h
    last  3 h     413 records     137.7 rec/h
    last 12 h    1661 records     138.4 rec/h
    last 24 h    4048 records     168.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       7,361     231  GATED             GATED             barrier>=30
      279      11,861     231  GATED             GATED             barrier>=30
      340      14,911     231  GATED             GATED             barrier>=30
      403      18,061     231  GATED             GATED             barrier>=30
      568      26,311     231  GATED             GATED             barrier>=30
