...
**Auto-generated 2026-08-03 06:53 UTC -- T+129h44m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+129h44m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **948** (288 running, 660 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1754 |
| scalar | g5 of 5 | 1163 |
| placebo | g5 of 5 | 1290 |
| scalar_cvar5 | g5 of 5 | 1256 |
| placebo_shuffled | g5 of 5 | 1269 |
...
```
2026-08-03T06:44:04Z  RED  records=7103 (+4)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=21B  sweep=70.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T06:45:45Z  RED  records=7107 (+4)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=21B  sweep=62.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T06:47:18Z  RED  records=7114 (+7)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=3.3m  drift=0  sci=OK  r115=21B  sweep=57.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T06:48:46Z  RED  records=7120 (+6)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=21B  sweep=105.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
