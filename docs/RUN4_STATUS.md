...
**Auto-generated 2026-08-06 00:36 UTC -- T+195h28m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h28m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.6 h ago; none live, newest failure 33 min ago** |
...
```
generated 2026-08-06 00:37 UTC | elapsed 8.14 d | 21.0 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,717     139  GATED             GATED             barrier>=30
      189       6,282     182  GATED             GATED             barrier>=30
      279      10,330     184  GATED             GATED             barrier>=30
      340      13,075     184  GATED             GATED             barrier>=30
      403      15,910     184  GATED             GATED             barrier>=30
      568      23,343     184  GATED             GATED             barrier>=30
