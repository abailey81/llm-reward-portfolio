...
**Auto-generated 2026-08-04 17:21 UTC -- T+164h12m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+164h12m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=11; worst streak 21/240 (8.8% to fatal), pull on core, 4.8 h ago; none live, newest failure 1.5 h ago** |
...
| | |
|---|---|
| cluster jobs | **216** (214 running, 0 queued) |
...
```
generated 2026-08-04 17:22 UTC | elapsed 6.84 d | 22.3 d to the Aug-27 stop
test tier: 12,025 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     178 records     178.0 rec/h
    last  3 h     515 records     171.7 rec/h
    last 12 h    2235 records     186.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (186 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      28,303     178  GATED             GATED             barrier>=30
    ...
    !! 97% of the rung-568 backlog (27,554 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
...
2026-08-04T16:48:47Z  OK  records=13448 (+12)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.4m  drift=0  sci=OK  r115=22B  sweep=221.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T16:56:39Z  OK  records=13463 (+15)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.5m  drift=0  sci=OK  r115=22B  cores=1784  sweep=441.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T17:01:11Z  OK  records=13480 (+17)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  sweep=242.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
