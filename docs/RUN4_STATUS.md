...
**Auto-generated 2026-08-06 06:21 UTC -- T+201h12m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,944     140  GATED             GATED             barrier>=30
      279       9,992     140  GATED             GATED             barrier>=30
      340      12,737     140  GATED             GATED             barrier>=30
      403      15,572     140  GATED             GATED             barrier>=30
      568      23,005     140  GATED             GATED             barrier>=30
