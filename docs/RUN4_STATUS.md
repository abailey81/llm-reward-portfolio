...
**Auto-generated 2026-08-05 08:27 UTC -- T+179h18m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+179h18m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 71 min ago; none live, newest failure 71 min ago** |
...
| | |
|---|---|
| cluster jobs | **890** (194 running, 696 queued) |
...
```
generated 2026-08-05 08:27 UTC | elapsed 7.47 d | 21.6 d to the Aug-27 stop
test tier: 14,472 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     281 records     281.0 rec/h
    last  3 h     774 records     258.0 rec/h
    last 12 h    1756 records     146.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,142      94  GATED             GATED             barrier>=30
      189       7,147      94  GATED             GATED             barrier>=30
      279      11,406     281  GATED             GATED             barrier>=30
      340      14,456     281  GATED             GATED             barrier>=30
      403      17,606     281  GATED             GATED             barrier>=30
      568      25,856     281  GATED             GATED             barrier>=30
...
2026-08-05T08:25:17Z  OK  records=16001 (+6)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=93.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
