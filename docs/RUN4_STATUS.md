...
**Auto-generated 2026-08-02 15:02 UTC -- T+113h53m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+113h53m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **911** (243 running, 668 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1123 |
| scalar | g5 of 5 | 526 |
| placebo | g5 of 5 | 756 |
| scalar_cvar5 | g5 of 5 | 714 |
| placebo_shuffled | g5 of 5 | 701 |
...
```
2026-08-02T14:57:06Z  RED  records=4209 (+0)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=21B  sweep=31.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T14:58:08Z  RED  records=4209 (+0)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=21B  sweep=28.2s  auto-cycle
2026-08-02T14:59:06Z  RED  records=4210 (+1)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.5m  drift=0  sci=OK  r115=21B  sweep=53.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T15:00:30Z  RED  records=4211 (+1)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=4.5m  drift=0  sci=OK  r115=21B  sweep=32.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T15:01:33Z  RED  records=4212 (+1)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0  sci=OK  r115=21B  sweep=29.3s  auto-cycle
2026-08-02T15:02:32Z  RED  records=4213 (+1)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=21B  sweep=28.4s  auto-cycle
```
