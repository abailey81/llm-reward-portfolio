...
**Auto-generated 2026-08-01 09:01 UTC -- T+83h52m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+83h52m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **2271** |
| LLM calls / spend | 2798 / **$43.9515** |
...
| | |
|---|---|
| cluster jobs | **126** (124 running, 1 queued) |
| **cores computing** | **992** |
...
```
 rung              @992 cores              @830 cores   binding
  ...
  340            9.3 d  08-07           11.1 d  08-09   throughput
  403           10.9 d  08-08           13.0 d  08-10   throughput
  568           15.1 d  08-13           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 878 |
| scalar | g5 of 5 | 296 |
| placebo | g5 of 5 | 259 |
| scalar_cvar5 | g5 of 5 | 241 |
| placebo_shuffled | g5 of 5 | 205 |
...
```
2026-08-01T08:57:18Z  RED  records=2268 (+3)  spend=$43.9515  guards=2  arms_full=10/10  budget=2  stalest=1.0m  drift=0  sci=OK  r115=14B  sweep=15.4s  auto-cycle
2026-08-01T08:58:03Z  RED  records=2268 (+0)  spend=$43.9515  guards=2  arms_full=10/10  budget=2  stalest=1.8m  drift=0  sci=OK  r115=14B  sweep=15.8s  auto-cycle
2026-08-01T08:58:49Z  RED  records=2268 (+0)  spend=$43.9515  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=14B  cores=1000  sweep=16.8s  auto-cycle
2026-08-01T08:59:37Z  RED  records=2269 (+1)  spend=$43.9515  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=14B  sweep=16.6s  auto-cycle
2026-08-01T09:00:23Z  RED  records=2270 (+1)  spend=$43.9515  guards=2  arms_full=10/10  budget=2  stalest=1.0m  drift=0  sci=OK  r115=14B  sweep=15.5s  auto-cycle
2026-08-01T09:01:09Z  RED  records=2271 (+1)  spend=$43.9515  guards=2  arms_full=10/10  budget=2  stalest=1.8m  drift=0  sci=OK  r115=14B  sweep=15.5s  auto-cycle
```
...
```
  anthropic   spent $ 35.8803  + still to author $  3.4746  = $ 39.3549   credited $ 28.1500   margin $ -11.2049 (-40%)  over the credit ESTIMATE (owner-watched)
  openrouter  spent $  8.0712  + still to author $  1.4263  = $  9.4975   credited $ 19.3100   margin $  +9.8125 (+51%)  comfortable
```
