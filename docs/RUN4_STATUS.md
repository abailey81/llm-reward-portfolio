...
**Auto-generated 2026-08-05 13:14 UTC -- T+184h05m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+184h05m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on core, 6.0 h ago; LIVE, still failing** |
...
| | |
|---|---|
| cluster jobs | **965** (169 running, 796 queued) |
...
```
generated 2026-08-05 13:15 UTC | elapsed 7.67 d | 21.4 d to the Aug-27 stop
test tier: 15,101 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      55 records      55.0 rec/h
    last  3 h     315 records     105.0 rec/h
    last 12 h    1587 records     132.2 rec/h
    last 24 h    3780 records     157.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,827      55  GATED             GATED             barrier>=30
      403      16,977      55  GATED             GATED             barrier>=30
      568      25,227      55  GATED             GATED             barrier>=30
