...
**Auto-generated 2026-08-11 11:39 UTC -- T+326h30m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+326h30m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on kimi-k3, 21 min ago; none live, newest failure 21 min ago** |
...
| | |
|---|---|
| cluster jobs | **559** = 129 running + **102 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **1032** |
| **cores doing RUNG-RAISING work** | **77.9%** -- 816 of 1048 cores (6 min old) |
...
```
generated 2026-08-11 11:39 UTC | elapsed 13.60 d | 15.5 d to the Aug-27 stop
test tier: 28,865 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 112.3 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h    1348 records     112.3 rec/h   usable
    last 24 h    2334 records      97.2 rec/h   usable
    12 h rate is 70% from ONE line (test); 3 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (112 rec/h); latest excludes cells already within
    8 of the ceiling (112 rec/h). Window 12 h.
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279         599      97  2026-08-11 16:59  2026-08-11 16:59  yes
      340       2,734      97  2026-08-12 12:00  2026-08-12 12:00  yes
      403       4,939      97  2026-08-13 07:38  2026-08-13 07:38  yes
      568      11,463      97  2026-08-15 17:42  2026-08-15 17:42  yes
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung     @1032 cores      @830 cores   binding
      ...
      403          10.5 d          13.0 d   throughput
      568          14.5 d          18.1 d   throughput
...
> **What is holding it right now: test -- baseline_log_growth has 152 HOLE(S) below its frontier 406 -- that is what caps this line**
...
currently at **255 seeds each** (read live from the archive on this publish). !! THE
...
```
2026-08-11T10:53:05Z  OK  records=30337 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.6m  drift=0  sci=OK  r115=22B  sweep=49.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T11:07:18Z  OK  records=30360 (+23)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.9m  drift=0  sci=OK  r115=22B  cores=1032  sweep=823.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T11:23:43Z  ATTN  records=30364 (+4)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.4m  drift=0  sci=OK  r115=22B  sweep=954.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T11:35:56Z  ATTN  records=30398 (+34)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  cores=1040  sweep=702.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T11:37:23Z  ATTN  records=30403 (+5)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=56.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T11:38:42Z  ATTN  records=30404 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.0m  drift=0  sci=OK  r115=22B  sweep=49.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
