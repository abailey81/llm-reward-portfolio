...
```
generated 2026-08-06 06:08 UTC | elapsed 8.37 d | 20.7 d to the Aug-27 stop
test tier: 17,299 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     145 records     145.0 rec/h
    last  3 h     220 records      73.3 rec/h
    last 12 h    1273 records     106.1 rec/h
    last 24 h    3398 records     141.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,968     145  GATED             GATED             barrier>=30
      279      10,016     145  GATED             GATED             barrier>=30
      340      12,761     145  GATED             GATED             barrier>=30
      403      15,596     145  GATED             GATED             barrier>=30
      568      23,029     145  GATED             GATED             barrier>=30
