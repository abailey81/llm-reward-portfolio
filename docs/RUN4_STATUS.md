...
**Auto-generated 2026-08-05 11:36 UTC -- T+182h27m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+182h27m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=4; worst streak 1/240 (0.4% to fatal), ops on core, 4.3 h ago; none live, newest failure 46 min ago** |
| transport timeouts (cumulative, ever) | 183 -- a level with no rate; read the row above |
...
```
generated 2026-08-05 11:36 UTC | elapsed 7.60 d | 21.5 d to the Aug-27 stop
test tier: 14,962 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     101 records     101.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279      10,916     101  GATED             GATED             barrier>=30
      340      13,966     101  GATED             GATED             barrier>=30
      403      17,116     101  GATED             GATED             barrier>=30
      568      25,366     101  GATED             GATED             barrier>=30
