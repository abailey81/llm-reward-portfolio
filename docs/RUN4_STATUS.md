...
**Auto-generated 2026-08-03 14:29 UTC -- T+137h20m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+137h20m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **671** (185 running, 486 queued) |
...
```
 rung             @1480 cores              @830 cores   binding
  ...
  568           10.1 d  08-08           18.1 d  08-15   throughput
```
