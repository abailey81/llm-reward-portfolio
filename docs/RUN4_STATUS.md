...
**Auto-generated 2026-08-10 07:09 UTC -- T+298h00m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+298h00m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **27507** |
| **Myriad maintenance** | **2026-08-12 from 08:00 UTC, at risk all day** (in 2.0 days). Delayed from Aug 11. Jobs may die and REQUEUE idempotently; the supervisors ride it. Playbook: docs/ops/MAINTENANCE_2026-08-12.md |
| LLM calls / spend | 2956 / **$45.5021** |
| transport health | **timeouts 6h=0; worst streak 0/240 (0.0% to fatal), - on -, age UNKNOWN; none live, newest failure 14.6 h ago** |
...
| | |
|---|---|
| cluster jobs | **867** = 166 running + **325 ELIGIBLE** + 376 held by us + 0 held only by the site |
...
| **cores doing RUNG-RAISING work** | **100.0%** -- 1320 of 1320 cores (86 min old) |
...
```
generated 2026-08-10 07:10 UTC | elapsed 12.42 d | 16.7 d to the Aug-27 stop
test tier: 25,964 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 103.3 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last  3 h     404 records     134.7 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last 12 h    1240 records     103.3 rec/h   usable
    last 24 h    2752 records     114.7 rec/h   usable
    12 h rate is 85% from ONE line (test); 5 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (103 rec/h); latest excludes cells already within
    8 of the ceiling (103 rec/h). Window 12 h.
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189         145       0  2026-08-10 08:34  2026-08-10 08:34  yes
      279       2,925     140  2026-08-11 11:29  2026-08-11 11:29  yes
      340       5,060     140  2026-08-12 08:08  2026-08-12 08:08  yes
      403       7,288     140  2026-08-13 05:42  2026-08-13 05:42  yes
      568      14,364     140  2026-08-16 02:11  2026-08-16 02:11  yes
...
> **What is holding it right now: test -- baseline_return_minus_turnover has 206 HOLE(S) below its frontier 406 -- that is what caps this line**
...
currently at **201 seeds each** (read live from the archive on this publish). !! THE
...
```
2026-08-10T05:30:49Z  OK  records=27315 (+49)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.0m  drift=0  sci=OK  r115=22B  cores=1288  sweep=1473.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-10T05:47:10Z  OK  records=27322 (+7)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=950.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-10T05:59:32Z  OK  records=27352 (+30)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.7m  drift=0  sci=OK  r115=22B  cores=1312  sweep=712.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-10T06:24:51Z  OK  records=27416 (+64)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  cores=1328  sweep=1488.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-10T06:40:38Z  OK  records=27450 (+34)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  sweep=916.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-10T06:52:44Z  OK  records=27474 (+24)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  cores=1352  sweep=696.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
