...
**Auto-generated 2026-08-11 21:40 UTC -- T+336h31m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+336h31m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **592** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (127 min old **STALE**) |
...
```
generated 2026-08-11 21:40 UTC | elapsed 14.02 d | 15.1 d to the Aug-27 stop
test tier: 29,979 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 109.2 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h    1311 records     109.2 rec/h   usable
    last 24 h    2697 records     112.4 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,620      51  GATED             GATED             barrier>=279
      403       3,825      51  GATED             GATED             barrier>=279
      568      10,349      51  GATED             GATED             barrier>=279
...
> **What is holding it right now: test_leg_deepseek_v4_pro -- placebo has 34 HOLE(S) below its frontier 339 -- that is what caps this line**
