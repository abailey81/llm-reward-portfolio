...
**Auto-generated 2026-08-06 11:57 UTC -- T+206h48m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+206h48m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    2579 records     107.5 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,709      32  GATED             GATED             barrier>=30
      340      12,454      32  GATED             GATED             barrier>=30
      403      15,289      32  GATED             GATED             barrier>=30
      568      22,722      32  GATED             GATED             barrier>=30
