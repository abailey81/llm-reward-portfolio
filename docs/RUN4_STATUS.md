...
**Auto-generated 2026-08-12 03:22 UTC -- T+342h13m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+342h13m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **856** |
| **cores doing RUNG-RAISING work** | **56.7%** -- 440 of 776 cores (110 min old **STALE**) |
...
```
generated 2026-08-12 03:23 UTC | elapsed 14.26 d | 14.9 d to the Aug-27 stop
test tier: 30,255 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      10,073      87  GATED             GATED             barrier>=279
