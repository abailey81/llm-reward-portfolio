...
```
generated 2026-08-07 01:02 UTC | elapsed 9.16 d | 20.0 d to the Aug-27 stop
test tier: 18,499 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    1501 records      62.5 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      403      14,396      72  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,829      72  GATED             GATED             no-records:test/distributional,test/scalar>=30
