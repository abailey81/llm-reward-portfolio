...
**Auto-generated 2026-08-11 19:30 UTC -- T+334h21m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+334h21m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on deepseek-v4-pro, 1.8 h ago; none live, newest failure 1.8 h ago** |
...
| **cores computing** | **512** |
| **cores doing RUNG-RAISING work** | **4.8%** -- 24 of 504 cores (117 min old **STALE**) |
...
```
generated 2026-08-11 19:31 UTC | elapsed 13.93 d | 15.2 d to the Aug-27 stop
test tier: 29,822 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 116.8 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h    1401 records     116.8 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,777      46  GATED             GATED             barrier>=279
      403       3,982      46  GATED             GATED             barrier>=279
      568      10,506      46  GATED             GATED             barrier>=279
