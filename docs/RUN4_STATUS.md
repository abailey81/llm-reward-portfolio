...
**Auto-generated 2026-08-12 04:11 UTC -- T+343h02m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+343h02m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **485** = 113 running + **44 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **904** |
| **cores doing RUNG-RAISING work** | **76.4%** -- 672 of 880 cores (39 min old) |
...
```
generated 2026-08-12 04:12 UTC | elapsed 14.29 d | 14.8 d to the Aug-27 stop
test tier: 30,297 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,357       8  GATED             GATED             barrier>=279
      403       3,562       8  GATED             GATED             barrier>=279
      568      10,031      48  GATED             GATED             barrier>=279
