...
**Auto-generated 2026-08-11 20:38 UTC -- T+335h30m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+335h30m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **496** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (66 min old) |
...
```
generated 2026-08-11 20:39 UTC | elapsed 13.98 d | 15.1 d to the Aug-27 stop
test tier: 29,927 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     242 records      80.7 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last 12 h    1354 records     112.8 rec/h   usable
    last 24 h    2810 records     117.1 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,672      92  GATED             GATED             barrier>=279
      403       3,877      92  GATED             GATED             barrier>=279
      568      10,401      92  GATED             GATED             barrier>=279
