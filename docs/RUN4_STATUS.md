...
**Auto-generated 2026-08-12 02:42 UTC -- T+341h33m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+341h33m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **500** = 104 running + **68 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **832** |
| **cores doing RUNG-RAISING work** | **56.7%** -- 440 of 776 cores (69 min old) |
...
```
generated 2026-08-12 02:43 UTC | elapsed 14.23 d | 14.9 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    2455 records     102.3 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,410      52  GATED             GATED             barrier>=279
      403       3,615      52  GATED             GATED             barrier>=279
      568      10,139      52  GATED             GATED             barrier>=279
