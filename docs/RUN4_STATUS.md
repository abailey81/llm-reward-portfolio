...
**Auto-generated 2026-08-06 09:28 UTC -- T+204h19m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+204h19m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **952** |
| **cores doing RUNG-RAISING work** | **20.7%** -- 200 of 968 cores (9 min old) |
...
```
generated 2026-08-06 09:29 UTC | elapsed 8.51 d | 20.6 d to the Aug-27 stop
test tier: 17,484 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    12 h rate is 65% from ONE line (test_leg_kimi_k3); 4 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,783     114  GATED             GATED             barrier>=30
      279       9,831     114  GATED             GATED             barrier>=30
      340      12,576     114  GATED             GATED             barrier>=30
      403      15,411     114  GATED             GATED             barrier>=30
      568      22,844     114  GATED             GATED             barrier>=30
