...
**Auto-generated 2026-08-05 12:52 UTC -- T+183h43m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+183h43m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on core, 5.6 h ago; none live, newest failure 2.0 h ago** |
...
```
generated 2026-08-05 12:52 UTC | elapsed 7.66 d | 21.5 d to the Aug-27 stop
test tier: 15,072 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      60 records      60.0 rec/h
    last  3 h     347 records     115.7 rec/h
    last 12 h    1607 records     133.9 rec/h
    last 24 h    3826 records     159.4 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279      10,891       1  GATED             GATED             barrier>=30
      340      13,856      60  GATED             GATED             barrier>=30
      403      17,006      60  GATED             GATED             barrier>=30
      568      25,256      60  GATED             GATED             barrier>=30
