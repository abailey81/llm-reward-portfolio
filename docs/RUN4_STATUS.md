...
**Auto-generated 2026-08-04 18:00 UTC -- T+164h51m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+164h51m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **194** (192 running, 0 queued) |
...
```
generated 2026-08-04 18:00 UTC | elapsed 6.87 d | 22.2 d to the Aug-27 stop
test tier: 12,223 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     274 records     274.0 rec/h
    last  3 h     576 records     192.0 rec/h
    last 12 h    2334 records     194.5 rec/h
    last 24 h    4167 records     173.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,903       1  GATED             GATED             barrier>=30
      189       8,353       1  GATED             GATED             barrier>=30
      279      12,853       1  GATED             GATED             barrier>=30
      340      15,903       1  GATED             GATED             barrier>=30
      403      19,053       1  GATED             GATED             barrier>=30
      568      28,105     274  GATED             GATED             barrier>=30
    ...
    !! 97% of the rung-568 backlog (27,260 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
