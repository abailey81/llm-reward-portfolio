...
```
generated 2026-08-06 11:54 UTC | elapsed 8.62 d | 20.5 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,689       7  GATED             GATED             barrier>=30
      279       9,710      34  GATED             GATED             barrier>=30
      340      12,455      34  GATED             GATED             barrier>=30
      403      15,290      34  GATED             GATED             barrier>=30
      568      22,723      34  GATED             GATED             barrier>=30
