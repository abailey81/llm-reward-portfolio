...
**Auto-generated 2026-08-05 08:53 UTC -- T+179h44m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+179h44m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 1.6 h ago; none live, newest failure 1.6 h ago** |
...
| | |
|---|---|
| cluster jobs | **880** (191 running, 689 queued) |
...
```
generated 2026-08-05 08:53 UTC | elapsed 7.49 d | 21.6 d to the Aug-27 stop
test tier: 14,583 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     275 records     275.0 rec/h
    last  3 h     752 records     250.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,063     161  GATED             GATED             barrier>=30
      189       7,056     173  GATED             GATED             barrier>=30
      279      11,295     275  GATED             GATED             barrier>=30
      340      14,345     275  GATED             GATED             barrier>=30
      403      17,495     275  GATED             GATED             barrier>=30
      568      25,745     275  GATED             GATED             barrier>=30
    ...
    !! 70% of the rung-568 backlog (17,994 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
...
```
2026-08-05T08:38:56Z  OK  records=16055 (+11)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.8m  drift=0  sci=OK  r115=22B  sweep=102.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T08:40:58Z  OK  records=16067 (+12)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.3m  drift=0  sci=OK  r115=22B  sweep=92.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
