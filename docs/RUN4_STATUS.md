...
**Auto-generated 2026-08-06 04:15 UTC -- T+199h06m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+199h06m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 04:15 UTC | elapsed 8.30 d | 20.8 d to the Aug-27 stop
test tier: 17,102 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      23 records      23.0 rec/h
    last  3 h      96 records      32.0 rec/h
    last 12 h    1460 records     121.7 rec/h
    last 24 h    3498 records     145.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,601      23  GATED             GATED             barrier>=30
      189       6,165      23  GATED             GATED             barrier>=30
      279      10,213      23  GATED             GATED             barrier>=30
      340      12,958      23  GATED             GATED             barrier>=30
      403      15,793      23  GATED             GATED             barrier>=30
      568      23,226      23  GATED             GATED             barrier>=30
