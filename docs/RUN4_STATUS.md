...
**Auto-generated 2026-08-03 10:44 UTC -- T+133h35m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+133h35m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **779** (169 running, 610 queued) |
...
```
 rung             @1352 cores              @830 cores   binding
  ...
  279            5.7 d  08-03            9.3 d  08-07   throughput
  340            6.8 d  08-04           11.1 d  08-09   throughput
  403            8.0 d  08-05           13.0 d  08-10   throughput
  568           11.1 d  08-08           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 2026 |
| scalar | g5 of 5 | 1436 |
| placebo | g5 of 5 | 1557 |
| scalar_cvar5 | g5 of 5 | 1529 |
| placebo_shuffled | g5 of 5 | 1543 |
...
2026-08-03T10:35:28Z  RED  records=8429 (+48)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=1.4m  drift=0  sci=OK  r115=21B  sweep=105.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T10:37:44Z  RED  records=8443 (+14)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0  sci=OK  r115=21B  sweep=101.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T10:39:56Z  RED  records=8465 (+22)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0  sci=OK  r115=21B  sweep=159.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T10:43:06Z  RED  records=8484 (+19)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=21B  sweep=89.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
