...
**Auto-generated 2026-08-05 16:47 UTC -- T+187h38m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+187h38m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 6.0 h ago; none live, newest failure 3.7 h ago** |
...
| | |
|---|---|
| cluster jobs | **888** (166 running, 722 queued) |
...
```
generated 2026-08-05 16:48 UTC | elapsed 7.82 d | 21.3 d to the Aug-27 stop
test tier: 15,753 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     186 records     186.0 rec/h
    last  3 h     597 records     199.0 rec/h
    last 12 h    2138 records     178.2 rec/h
    last 24 h    3840 records     160.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      403      16,471      40  GATED             GATED             barrier>=30
      568      24,575     186  GATED             GATED             barrier>=30
