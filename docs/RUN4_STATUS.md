...
**Auto-generated 2026-08-05 15:32 UTC -- T+186h23m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+186h23m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 4.7 h ago; none live, newest failure 2.5 h ago** |
...
| | |
|---|---|
| cluster jobs | **911** (187 running, 724 queued) |
...
```
generated 2026-08-05 15:33 UTC | elapsed 7.77 d | 21.4 d to the Aug-27 stop
test tier: 15,550 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     225 records     225.0 rec/h
    last  3 h     497 records     165.7 rec/h
    last 12 h    1947 records     162.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      403      16,528     225  GATED             GATED             barrier>=30
      568      24,778     225  GATED             GATED             barrier>=30
