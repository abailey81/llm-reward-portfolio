...
**Auto-generated 2026-08-05 13:24 UTC -- T+184h15m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+184h15m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 2.6 h ago; none live, newest failure 20 min ago** |
...
| | |
|---|---|
| cluster jobs | **964** (192 running, 772 queued) |
...
```
generated 2026-08-05 13:24 UTC | elapsed 7.68 d | 21.4 d to the Aug-27 stop
test tier: 15,114 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,814      62  GATED             GATED             barrier>=30
      403      16,964      62  GATED             GATED             barrier>=30
      568      25,214      62  GATED             GATED             barrier>=30
