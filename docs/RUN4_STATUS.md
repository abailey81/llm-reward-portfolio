...
**Auto-generated 2026-08-03 08:49 UTC -- T+131h40m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+131h40m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **885** (254 running, 631 queued) |
| **cores computing** | **2032** |

Per-rung ETAs from the registered model at the cores we actually hold:

```
 rung             @2032 cores              @830 cores   binding
...
|---|---|---|
| distributional | g5 of 5 | 1863 |
| scalar | g5 of 5 | 1276 |
| placebo | g5 of 5 | 1386 |
| scalar_cvar5 | g5 of 5 | 1362 |
| placebo_shuffled | g5 of 5 | 1376 |
...
```
2026-08-03T08:38:04Z  RED  records=7597 (+10)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=21B  sweep=69.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
