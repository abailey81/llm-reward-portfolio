...
**Auto-generated 2026-08-05 00:47 UTC -- T+171h38m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+171h38m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 2.3 h ago; none live, newest failure 72 min ago** |
...
| | |
|---|---|
| cluster jobs | **957** (170 running, 785 queued) |
...
```
generated 2026-08-05 00:48 UTC | elapsed 7.15 d | 22.0 d to the Aug-27 stop
test tier: 13,455 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     126 records     126.0 rec/h
    last  3 h     449 records     149.7 rec/h
    last 12 h    2230 records     185.8 rec/h
    last 24 h    4230 records     176.2 rec/h
    12 h rate is 53% from ONE line (test_leg_sonnet_5); 10 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 53% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_sonnet_5, test_leg_gpt_5_6_luna) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      26,873     126  GATED             GATED             barrier>=30
...
2026-08-05T00:31:45Z  OK  records=14967 (+10)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.1m  drift=0  sci=OK  r115=22B  sweep=195.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T00:37:31Z  OK  records=14976 (+9)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.1m  drift=0  sci=OK  r115=22B  cores=1352  sweep=315.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T00:44:40Z  OK  records=14983 (+7)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.0m  drift=0  sci=OK  r115=22B  sweep=399.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
