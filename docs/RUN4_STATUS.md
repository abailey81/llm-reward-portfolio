...
**Auto-generated 2026-08-05 11:23 UTC -- T+182h14m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+182h14m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 4.1 h ago; none live, newest failure 34 min ago** |
...
| | |
|---|---|
| cluster jobs | **989** (184 running, 805 queued) |
...
```
generated 2026-08-05 11:24 UTC | elapsed 7.59 d | 21.5 d to the Aug-27 stop
test tier: 14,943 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     127 records     127.0 rec/h
    last  3 h     485 records     161.7 rec/h
    last 12 h    1676 records     139.7 rec/h
    last 24 h    3934 records     163.9 rec/h
    12 h rate is 56% from ONE line (test_leg_haiku_4_5); 5 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 19% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         180      10  GATED             GATED             barrier
      100       2,980      10  GATED             GATED             barrier>=30
      189       6,841      27  GATED             GATED             barrier>=30
      279      10,935     127  GATED             GATED             barrier>=30
      340      13,985     127  GATED             GATED             barrier>=30
      403      17,135     127  GATED             GATED             barrier>=30
      568      25,385     127  GATED             GATED             barrier>=30
