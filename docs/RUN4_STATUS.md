...
**Auto-generated 2026-08-04 22:49 UTC -- T+169h40m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+169h40m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 19 min ago; none live, newest failure 19 min ago** |
...
```
generated 2026-08-04 22:49 UTC | elapsed 7.07 d | 22.0 d to the Aug-27 stop
test tier: 13,138 records over 68 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     130 records     130.0 rec/h
    last  3 h     554 records     184.7 rec/h
    last 12 h    2204 records     183.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,341      18  GATED             GATED             barrier>=30
      189       7,791      18  GATED             GATED             barrier>=30
      279      12,291      18  GATED             GATED             barrier>=30
      340      15,341      18  GATED             GATED             barrier>=30
      403      18,491      18  GATED             GATED             barrier>=30
      568      27,190     130  GATED             GATED             barrier>=30
