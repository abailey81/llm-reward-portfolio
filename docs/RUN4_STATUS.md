...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.8 h ago; none live, newest failure 49 min ago** |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,709     105  GATED             GATED             barrier>=30
      189       6,273     125  GATED             GATED             barrier>=30
      279      10,321     127  GATED             GATED             barrier>=30
      340      13,066     127  GATED             GATED             barrier>=30
      403      15,901     127  GATED             GATED             barrier>=30
      568      23,334     127  GATED             GATED             barrier>=30
