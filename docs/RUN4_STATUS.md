...
**Auto-generated 2026-08-09 21:39 UTC -- T+288h30m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+288h30m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **26572** |
| **Myriad maintenance** | **2026-08-12 from 08:00 UTC, at risk all day** (in 2.4 days). Delayed from Aug 11. Jobs may die and REQUEUE idempotently; the supervisors ride it. Playbook: docs/ops/MAINTENANCE_2026-08-12.md |
| LLM calls / spend | 2956 / **$45.5021** |
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on kimi-k3, 5.1 h ago; none live, newest failure 5.1 h ago** |
...
| | |
|---|---|
| cluster jobs | **678** = 145 running + **157 ELIGIBLE** + 376 held by us + 0 held only by the site |
...
| **cores doing RUNG-RAISING work** | **100.0%** -- 1152 of 1152 cores (1 min old) |
...
```
generated 2026-08-09 21:39 UTC | elapsed 12.02 d | 17.1 d to the Aug-27 stop
test tier: 25,029 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 135.0 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h    1620 records     135.0 rec/h   usable
    last 24 h    2803 records     116.8 rec/h   usable
    12 h rate is 78% from ONE line (test); 5 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (135 rec/h); latest excludes cells already within
    8 of the ceiling (135 rec/h). Window 12 h.
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189         702     112  2026-08-10 02:51  2026-08-10 02:51  yes
      279       3,852     112  2026-08-11 02:11  2026-08-11 02:11  yes
      340       5,987     112  2026-08-11 18:00  2026-08-11 18:00  yes
      403       8,223     112  2026-08-12 10:34  2026-08-12 10:34  yes
      568      15,299     112  2026-08-14 14:59  2026-08-14 14:59  yes
...
> **What is holding it right now: test -- baseline_log_growth has 243 HOLE(S) below its frontier 406 -- that is what caps this line**
...
currently at **164 seeds each** (read live from the archive on this publish). !! THE
...
2026-08-09T20:33:05Z  OK  records=26449 (+49)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.0m  drift=0  sci=OK  r115=22B  cores=1136  sweep=1193.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-09T20:57:58Z  OK  records=26468 (+19)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.6m  drift=0  sci=OK  r115=22B  sweep=1463.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-09T21:17:52Z  OK  records=26526 (+58)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  cores=1120  sweep=1163.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
