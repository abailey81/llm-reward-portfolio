...
**Auto-generated 2026-08-06 08:35 UTC -- T+203h26m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+203h26m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores doing RUNG-RAISING work** | **20.2%** -- 200 of 992 cores (13 min old) |
...
```
generated 2026-08-06 08:35 UTC | elapsed 8.48 d | 20.6 d to the Aug-27 stop
test tier: 17,375 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    !! 11% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_haiku_4_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,892      16  GATED             GATED             barrier>=30
      279       9,940      16  GATED             GATED             barrier>=30
      340      12,685      16  GATED             GATED             barrier>=30
      403      15,520      16  GATED             GATED             barrier>=30
      568      22,953      16  GATED             GATED             barrier>=30
