...
**Auto-generated 2026-08-12 03:06 UTC -- T+341h57m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+341h57m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **494** = 107 running + **59 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **856** |
| **cores doing RUNG-RAISING work** | **56.7%** -- 440 of 776 cores (94 min old **STALE**) |
...
```
generated 2026-08-12 03:07 UTC | elapsed 14.25 d | 14.9 d to the Aug-27 stop
test tier: 30,240 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      10,088      82  GATED             GATED             barrier>=279
