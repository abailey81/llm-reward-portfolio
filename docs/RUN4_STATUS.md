...
**Auto-generated 2026-08-05 06:40 UTC -- T+177h31m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+177h31m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 06:41 UTC | elapsed 7.40 d | 21.7 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    4045 records     168.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       7,371     238  GATED             GATED             barrier>=30
      279      11,871     238  GATED             GATED             barrier>=30
      340      14,921     238  GATED             GATED             barrier>=30
      403      18,071     238  GATED             GATED             barrier>=30
      568      26,321     238  GATED             GATED             barrier>=30
