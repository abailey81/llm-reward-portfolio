...
**Auto-generated 2026-08-05 08:08 UTC -- T+178h59m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+178h59m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 53 min ago; none live, newest failure 53 min ago** |
...
```
generated 2026-08-05 08:09 UTC | elapsed 7.46 d | 21.7 d to the Aug-27 stop
test tier: 14,379 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     263 records     263.0 rec/h
    last  3 h     737 records     245.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,207      29  GATED             GATED             barrier>=30
      189       7,212      52  GATED             GATED             barrier>=30
      279      11,499     263  GATED             GATED             barrier>=30
      340      14,549     263  GATED             GATED             barrier>=30
      403      17,699     263  GATED             GATED             barrier>=30
      568      25,949     263  GATED             GATED             barrier>=30
