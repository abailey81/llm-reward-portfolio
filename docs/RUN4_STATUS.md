...
```
generated 2026-08-06 00:16 UTC | elapsed 8.13 d | 21.0 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,760     148  GATED             GATED             barrier>=30
      189       6,332     225  GATED             GATED             barrier>=30
      279      10,381     226  GATED             GATED             barrier>=30
      340      13,126     226  GATED             GATED             barrier>=30
      403      15,961     226  GATED             GATED             barrier>=30
      568      23,394     226  GATED             GATED             barrier>=30
