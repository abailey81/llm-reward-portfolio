...
**Auto-generated 2026-08-03 04:05 UTC -- T+126h56m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+126h56m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **985** (289 running, 696 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1700 |
| scalar | g5 of 5 | 1109 |
| placebo | g5 of 5 | 1237 |
| scalar_cvar5 | g5 of 5 | 1210 |
| placebo_shuffled | g5 of 5 | 1220 |
...
2026-08-03T03:58:14Z  RED  records=6845 (+2)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=21B  sweep=102.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T04:00:27Z  RED  records=6856 (+11)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=21B  sweep=58.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T04:01:56Z  RED  records=6864 (+8)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=3.2m  drift=0  sci=OK  r115=21B  sweep=58.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T04:03:25Z  RED  records=6871 (+7)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=21B  sweep=59.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
