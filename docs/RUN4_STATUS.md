...
```
generated 2026-08-06 02:11 UTC | elapsed 8.21 d | 20.9 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,640      62  GATED             GATED             barrier>=30
      189       6,204      62  GATED             GATED             barrier>=30
      279      10,252      62  GATED             GATED             barrier>=30
      340      12,997      62  GATED             GATED             barrier>=30
      403      15,832      62  GATED             GATED             barrier>=30
      568      23,265      62  GATED             GATED             barrier>=30
...
```
2026-08-06T01:48:02Z  OK  records=18574 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.6m  drift=0  sci=OK  r115=22B  sweep=27.7s  auto-cycle
