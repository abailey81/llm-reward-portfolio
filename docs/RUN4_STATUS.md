...
**Auto-generated 2026-08-11 20:18 UTC -- T+335h09m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+335h09m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **429** = 58 running + **43 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **464** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (46 min old) |
...
```
generated 2026-08-11 20:19 UTC | elapsed 13.97 d | 15.2 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,704      96  GATED             GATED             barrier>=279
      403       3,909      96  GATED             GATED             barrier>=279
      568      10,433      96  GATED             GATED             barrier>=279
