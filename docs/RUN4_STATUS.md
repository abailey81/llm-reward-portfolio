...
**Auto-generated 2026-08-03 08:40 UTC -- T+131h31m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+131h31m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **894** (263 running, 631 queued) |
| **cores computing** | **2104** |

Per-rung ETAs from the registered model at the cores we actually hold:

```
 rung             @2104 cores              @830 cores   binding
  ...
  403            5.1 d  08-03           13.0 d  08-10   throughput
  568            7.1 d  08-05           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 1853 |
| scalar | g5 of 5 | 1268 |
| placebo | g5 of 5 | 1376 |
| scalar_cvar5 | g5 of 5 | 1348 |
| placebo_shuffled | g5 of 5 | 1366 |
