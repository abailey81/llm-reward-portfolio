...
**Auto-generated 2026-08-05 13:58 UTC -- T+184h49m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+184h49m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 3.1 h ago; none live, newest failure 54 min ago** |
...
```
generated 2026-08-05 13:59 UTC | elapsed 7.70 d | 21.4 d to the Aug-27 stop
test tier: 15,195 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     113 records     113.0 rec/h
    last  3 h     298 records      99.3 rec/h
    last 12 h    1621 records     135.1 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,733     113  GATED             GATED             barrier>=30
      403      16,883     113  GATED             GATED             barrier>=30
      568      25,133     113  GATED             GATED             barrier>=30
