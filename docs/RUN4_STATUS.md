...
**Auto-generated 2026-08-01 14:32 UTC -- T+89h23m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+89h23m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **111** (106 running, 4 queued) |
| **cores computing** | **848** |
...
```
 rung              @848 cores              @830 cores   binding
  ...
  189            6.4 d  08-04            6.5 d  08-04   throughput
  279            9.1 d  08-06            9.3 d  08-07   throughput
  340           10.9 d  08-08           11.1 d  08-09   throughput
  403           12.8 d  08-10           13.0 d  08-10   throughput
  568           17.7 d  08-15           18.1 d  08-15   throughput
```
...
```
2026-08-01T14:27:44Z  RED  records=2476 (+0)  spend=$44.9851  guards=2  arms_full=10/10  budget=2  stalest=0.9m  drift=0  sci=OK  r115=17B  sweep=23.4s  auto-cycle
2026-08-01T14:28:38Z  RED  records=2477 (+1)  spend=$44.9851  guards=2  arms_full=10/10  budget=2  stalest=1.7m  drift=0  sci=OK  r115=17B  sweep=16.3s  auto-cycle
2026-08-01T14:29:24Z  RED  records=2477 (+0)  spend=$44.9851  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=17B  cores=856  sweep=20.2s  auto-cycle
2026-08-01T14:30:15Z  RED  records=2477 (+0)  spend=$44.9851  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0  sci=OK  r115=17B  sweep=17.0s  auto-cycle
2026-08-01T14:31:02Z  RED  records=2478 (+1)  spend=$44.9851  guards=2  arms_full=10/10  budget=2  stalest=1.0m  drift=0  sci=OK  r115=17B  sweep=16.2s  auto-cycle
2026-08-01T14:31:48Z  RED  records=2478 (+0)  spend=$44.9851  guards=2  arms_full=10/10  budget=2  stalest=1.7m  drift=0  sci=OK  r115=17B  sweep=16.1s  auto-cycle
```
