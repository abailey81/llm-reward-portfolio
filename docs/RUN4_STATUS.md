...
**Auto-generated 2026-08-05 15:26 UTC -- T+186h17m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+186h17m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 4.6 h ago; none live, newest failure 2.4 h ago** |
...
| | |
|---|---|
| cluster jobs | **913** (188 running, 725 queued) |
...
```
generated 2026-08-05 15:26 UTC | elapsed 7.76 d | 21.4 d to the Aug-27 stop
test tier: 15,529 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     229 records     229.0 rec/h
    last  3 h     477 records     159.0 rec/h
    last 12 h    1926 records     160.5 rec/h
    last 24 h    3810 records     158.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,636       6  GATED             GATED             barrier>=30
      403      16,549     229  GATED             GATED             barrier>=30
      568      24,799     229  GATED             GATED             barrier>=30
...
```
2026-08-05T14:56:37Z  OK  records=16964 (+20)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.9m  drift=0  sci=OK  r115=22B  sweep=305.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T15:00:31Z  OK  records=16983 (+19)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.9m  drift=0  sci=OK  r115=22B  cores=1488  sweep=204.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T15:08:28Z  OK  records=17005 (+22)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.6m  drift=0  sci=OK  r115=22B  sweep=446.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T15:15:35Z  OK  records=17044 (+39)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.4m  drift=0  sci=OK  r115=22B  sweep=396.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T15:19:47Z  OK  records=17052 (+8)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=221.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T15:23:55Z  OK  records=17066 (+14)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.0m  drift=0  sci=OK  r115=22B  cores=1504  sweep=218.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
