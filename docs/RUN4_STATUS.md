...
**Auto-generated 2026-08-05 00:43 UTC -- T+171h34m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+171h34m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 2.2 h ago; none live, newest failure 67 min ago** |
...
| | |
|---|---|
| cluster jobs | **958** (170 running, 786 queued) |
...
```
generated 2026-08-05 00:43 UTC | elapsed 7.15 d | 22.0 d to the Aug-27 stop
test tier: 13,445 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     129 records     129.0 rec/h
    last  3 h     448 records     149.3 rec/h
    last 12 h    2238 records     186.5 rec/h
    ...
    !! 54% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_sonnet_5, test_leg_gpt_5_6_luna) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      26,883     129  GATED             GATED             barrier>=30
