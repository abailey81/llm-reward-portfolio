...
**Auto-generated 2026-08-06 03:55 UTC -- T+198h46m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+198h46m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
test tier: 17,084 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h       6 records       6.0 rec/h
    last  3 h      87 records      29.0 rec/h
    last 12 h    1501 records     125.1 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,619       6  GATED             GATED             barrier>=30
      189       6,183       6  GATED             GATED             barrier>=30
      279      10,231       6  GATED             GATED             barrier>=30
      340      12,976       6  GATED             GATED             barrier>=30
      403      15,811       6  GATED             GATED             barrier>=30
      568      23,244       6  GATED             GATED             barrier>=30
