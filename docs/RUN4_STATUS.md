...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,721     162  GATED             GATED             barrier>=30
      189       6,290     208  GATED             GATED             barrier>=30
      279      10,338     210  GATED             GATED             barrier>=30
      340      13,083     210  GATED             GATED             barrier>=30
      403      15,918     210  GATED             GATED             barrier>=30
      568      23,351     210  GATED             GATED             barrier>=30
