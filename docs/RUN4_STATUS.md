...
**Auto-generated 2026-08-04 17:03 UTC -- T+163h54m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+163h54m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=11; worst streak 21/240 (8.8% to fatal), pull on core, 4.5 h ago; none live, newest failure 74 min ago** |
...
| | |
|---|---|
| cluster jobs | **223** (221 running, 0 queued) |
...
```
generated 2026-08-04 17:03 UTC | elapsed 6.83 d | 22.3 d to the Aug-27 stop
test tier: 11,956 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     139 records     139.0 rec/h
    last  3 h     517 records     172.3 rec/h
    last 12 h    2214 records     184.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      28,372     139  GATED             GATED             barrier>=30
