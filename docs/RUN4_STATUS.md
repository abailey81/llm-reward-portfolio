...
**Auto-generated 2026-08-06 04:38 UTC -- T+199h29m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+199h29m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 04:38 UTC | elapsed 8.31 d | 20.8 d to the Aug-27 stop
test tier: 17,118 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      39 records      39.0 rec/h
    last  3 h      96 records      32.0 rec/h
    last 12 h    1403 records     116.9 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,149      39  GATED             GATED             barrier>=30
      279      10,197      39  GATED             GATED             barrier>=30
      340      12,942      39  GATED             GATED             barrier>=30
      403      15,777      39  GATED             GATED             barrier>=30
      568      23,210      39  GATED             GATED             barrier>=30
