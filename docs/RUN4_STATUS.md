...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.2 h ago; none live, newest failure 12 min ago** |
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    3540 records     147.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,760     147  GATED             GATED             barrier>=30
      189       6,332     223  GATED             GATED             barrier>=30
      279      10,381     224  GATED             GATED             barrier>=30
      340      13,126     224  GATED             GATED             barrier>=30
      403      15,961     224  GATED             GATED             barrier>=30
      568      23,394     224  GATED             GATED             barrier>=30
