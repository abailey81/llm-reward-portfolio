...
**Auto-generated 2026-08-05 08:48 UTC -- T+179h39m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+179h39m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 08:48 UTC | elapsed 7.49 d | 21.6 d to the Aug-27 stop
test tier: 14,567 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     276 records     276.0 rec/h
    last  3 h     759 records     253.0 rec/h
    last 12 h    1743 records     145.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,069     160  GATED             GATED             barrier>=30
      189       7,068     166  GATED             GATED             barrier>=30
      279      11,311     276  GATED             GATED             barrier>=30
      340      14,361     276  GATED             GATED             barrier>=30
      403      17,511     276  GATED             GATED             barrier>=30
      568      25,761     276  GATED             GATED             barrier>=30
