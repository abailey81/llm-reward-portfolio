...
**Auto-generated 2026-08-05 05:06 UTC -- T+175h57m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+175h57m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 4 min ago; LIVE, still failing** |
...
```
generated 2026-08-05 05:07 UTC | elapsed 7.33 d | 21.8 d to the Aug-27 stop
test tier: 13,638 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      34 records      34.0 rec/h
    last  3 h      54 records      18.0 rec/h
    last 12 h    1667 records     138.9 rec/h
    last 24 h    3881 records     161.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,290      34  GATED             GATED             barrier>=30
      189       7,740      34  GATED             GATED             barrier>=30
      279      12,240      34  GATED             GATED             barrier>=30
      340      15,290      34  GATED             GATED             barrier>=30
      403      18,440      34  GATED             GATED             barrier>=30
      568      26,690      34  GATED             GATED             barrier>=30
