...
**Auto-generated 2026-08-04 17:12 UTC -- T+164h03m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+164h03m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=11; worst streak 21/240 (8.8% to fatal), pull on core, 4.7 h ago; none live, newest failure 83 min ago** |
...
```
generated 2026-08-04 17:12 UTC | elapsed 6.84 d | 22.3 d to the Aug-27 stop
test tier: 11,993 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     161 records     161.0 rec/h
    last  3 h     507 records     169.0 rec/h
    last 12 h    2221 records     185.1 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      28,335     161  GATED             GATED             barrier>=30
