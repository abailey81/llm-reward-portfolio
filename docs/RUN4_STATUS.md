...
**Auto-generated 2026-08-06 00:13 UTC -- T+195h04m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h04m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.2 h ago; LIVE, still failing** |
...
test tier: 16,927 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,767     142  GATED             GATED             barrier>=30
      189       6,339     229  GATED             GATED             barrier>=30
      279      10,388     230  GATED             GATED             barrier>=30
      340      13,133     230  GATED             GATED             barrier>=30
      403      15,968     230  GATED             GATED             barrier>=30
      568      23,401     230  GATED             GATED             barrier>=30
