...
**Auto-generated 2026-08-05 14:43 UTC -- T+185h34m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+185h34m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **936** (184 running, 752 queued) |
...
```
generated 2026-08-05 14:43 UTC | elapsed 7.73 d | 21.4 d to the Aug-27 stop
test tier: 15,365 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (147 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,636     145  GATED             GATED             barrier>=30
      403      16,713     218  GATED             GATED             barrier>=30
      568      24,963     218  GATED             GATED             barrier>=30
...
2026-08-05T14:43:37Z  OK  records=16908 (+30)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=0.9m  drift=0  sci=OK  r115=22B  sweep=301.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
