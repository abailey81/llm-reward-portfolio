...
**Auto-generated 2026-08-05 08:44 UTC -- T+179h35m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+179h35m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 88 min ago; none live, newest failure 88 min ago** |
...
| | |
|---|---|
| cluster jobs | **885** (195 running, 690 queued) |
...
```
generated 2026-08-05 08:44 UTC | elapsed 7.48 d | 21.6 d to the Aug-27 stop
test tier: 14,550 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     274 records     274.0 rec/h
    last  3 h     764 records     254.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,079     152  GATED             GATED             barrier>=30
      189       7,082     154  GATED             GATED             barrier>=30
      279      11,328     274  GATED             GATED             barrier>=30
      340      14,378     274  GATED             GATED             barrier>=30
      403      17,528     274  GATED             GATED             barrier>=30
      568      25,778     274  GATED             GATED             barrier>=30
