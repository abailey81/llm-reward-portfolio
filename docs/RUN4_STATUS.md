...
| | |
|---|---|
| cluster jobs | **948** (70 running, 878 queued) |
| **cores computing** | **560** |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,003     134  GATED             GATED             barrier>=30
      279      10,051     134  GATED             GATED             barrier>=30
      340      12,796     134  GATED             GATED             barrier>=30
      403      15,631     134  GATED             GATED             barrier>=30
      568      23,064     134  GATED             GATED             barrier>=30
