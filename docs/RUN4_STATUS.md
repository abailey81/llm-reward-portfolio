...
| | |
|---|---|
| cluster jobs | **943** (74 running, 869 queued) |
| **cores computing** | **585** |
...
```
generated 2026-08-06 06:03 UTC | elapsed 8.37 d | 20.7 d to the Aug-27 stop
test tier: 17,286 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     138 records     138.0 rec/h
    last  3 h     208 records      69.3 rec/h
    last 12 h    1284 records     107.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,981     138  GATED             GATED             barrier>=30
      279      10,029     138  GATED             GATED             barrier>=30
      340      12,774     138  GATED             GATED             barrier>=30
      403      15,609     138  GATED             GATED             barrier>=30
      568      23,042     138  GATED             GATED             barrier>=30
