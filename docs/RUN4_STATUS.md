...
**Auto-generated 2026-08-05 05:16 UTC -- T+176h07m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+176h07m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 14 min ago; none live, newest failure 14 min ago** |
...
| | |
|---|---|
| cluster jobs | **986** (198 running, 788 queued) |
...
```
generated 2026-08-05 05:16 UTC | elapsed 7.34 d | 21.8 d to the Aug-27 stop
test tier: 13,656 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      52 records      52.0 rec/h
    last  3 h      68 records      22.7 rec/h
    last 12 h    1641 records     136.8 rec/h
    last 24 h    3878 records     161.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,272      52  GATED             GATED             barrier>=30
      189       7,722      52  GATED             GATED             barrier>=30
      279      12,222      52  GATED             GATED             barrier>=30
      340      15,272      52  GATED             GATED             barrier>=30
      403      18,422      52  GATED             GATED             barrier>=30
      568      26,672      52  GATED             GATED             barrier>=30
