...
**Auto-generated 2026-08-05 02:42 UTC -- T+173h33m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+173h33m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 4.2 h ago; none live, newest failure 26 min ago** |
...
| | |
|---|---|
| cluster jobs | **992** (182 running, 810 queued) |
...
```
generated 2026-08-05 02:42 UTC | elapsed 7.23 d | 21.9 d to the Aug-27 stop
test tier: 13,595 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      39 records      39.0 rec/h
    last  3 h     281 records      93.7 rec/h
    last 12 h    2010 records     167.5 rec/h
    last 24 h    4159 records     173.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      26,733      39  GATED             GATED             barrier>=30
