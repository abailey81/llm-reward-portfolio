...
**Auto-generated 2026-08-06 04:57 UTC -- T+199h48m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+199h48m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **956** (71 running, 885 queued) |
| **cores computing** | **568** |
...
```
generated 2026-08-06 04:58 UTC | elapsed 8.33 d | 20.8 d to the Aug-27 stop
test tier: 17,140 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      51 records      51.0 rec/h
    last  3 h      92 records      30.7 rec/h
    last 12 h    1352 records     112.7 rec/h
    last 24 h    3517 records     146.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,572      42  GATED             GATED             barrier>=30
      189       6,127      51  GATED             GATED             barrier>=30
      279      10,175      51  GATED             GATED             barrier>=30
      340      12,920      51  GATED             GATED             barrier>=30
      403      15,755      51  GATED             GATED             barrier>=30
      568      23,188      51  GATED             GATED             barrier>=30
