...
**Auto-generated 2026-08-03 12:22 UTC -- T+135h13m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+135h13m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **728** (169 running, 559 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 2099 |
| scalar | g5 of 5 | 1510 |
| placebo | g5 of 5 | 1638 |
| scalar_cvar5 | g5 of 5 | 1608 |
| placebo_shuffled | g5 of 5 | 1620 |
...
```
2026-08-03T12:07:33Z  RED  records=8827 (+3)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.1m  drift=0  sci=OK  r115=21B  sweep=104.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T12:09:48Z  RED  records=8839 (+12)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=21B  sweep=137.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
