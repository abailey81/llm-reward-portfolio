...
**Auto-generated 2026-08-11 21:04 UTC -- T+335h55m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+335h55m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **560** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (92 min old **STALE**) |
...
```
generated 2026-08-11 21:05 UTC | elapsed 14.00 d | 15.1 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,651      74  GATED             GATED             barrier>=279
      403       3,856      74  GATED             GATED             barrier>=279
      568      10,380      74  GATED             GATED             barrier>=279
