...
**Auto-generated 2026-08-05 01:26 UTC -- T+172h17m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+172h17m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 2.9 h ago; none live, newest failure 1.8 h ago** |
...
| | |
|---|---|
| cluster jobs | **946** (174 running, 770 queued) |
...
```
generated 2026-08-05 01:26 UTC | elapsed 7.18 d | 21.9 d to the Aug-27 stop
test tier: 13,527 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     106 records     106.0 rec/h
    last  3 h     457 records     152.3 rec/h
    last 12 h    2183 records     181.9 rec/h
    last 24 h    4251 records     177.1 rec/h
    12 h rate is 48% from ONE line (test_leg_sonnet_5); 10 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 59% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_sonnet_5, test_leg_qwen3_5_9b) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,336       4  GATED             GATED             barrier>=30
      189       7,786       4  GATED             GATED             barrier>=30
      279      12,286       4  GATED             GATED             barrier>=30
      340      15,336       4  GATED             GATED             barrier>=30
      403      18,486       4  GATED             GATED             barrier>=30
      568      26,801     106  GATED             GATED             barrier>=30
...
```
2026-08-05T00:54:52Z  OK  records=15005 (+7)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.1m  drift=0  sci=OK  r115=22B  sweep=279.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T01:00:16Z  OK  records=15014 (+9)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  cores=1376  sweep=293.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
