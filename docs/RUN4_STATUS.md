...
**Auto-generated 2026-08-03 12:40 UTC -- T+135h31m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+135h31m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **717** (158 running, 559 queued) |
...
```
 rung             @1264 cores              @830 cores   binding
  ...
  279            6.1 d  08-03            9.3 d  08-07   throughput
  340            7.3 d  08-05           11.1 d  08-09   throughput
...
|---|---|---|
| distributional | g5 of 5 | 2109 |
| scalar | g5 of 5 | 1518 |
| placebo | g5 of 5 | 1646 |
