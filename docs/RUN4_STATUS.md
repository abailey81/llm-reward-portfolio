...
**Auto-generated 2026-08-04 18:41 UTC -- T+165h32m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+165h32m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-04 18:42 UTC | elapsed 6.90 d | 22.2 d to the Aug-27 stop
test tier: 12,349 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     219 records     219.0 rec/h
    last  3 h     585 records     195.0 rec/h
    last 12 h    2386 records     198.8 rec/h
    last 24 h    4255 records     177.3 rec/h
    12 h rate is 99% from ONE line (test_leg_sonnet_5); 3 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,874      30  GATED             GATED             barrier>=30
      189       8,324      30  GATED             GATED             barrier>=30
      279      12,824      30  GATED             GATED             barrier>=30
      340      15,874      30  GATED             GATED             barrier>=30
      403      19,024      30  GATED             GATED             barrier>=30
      568      27,979     219  GATED             GATED             barrier>=30
    ...
    !! 90% of the rung-568 backlog (25,108 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
...
```
2026-08-04T18:16:04Z  OK  records=13796 (+9)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  sweep=213.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
