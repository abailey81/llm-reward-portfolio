...
**Auto-generated 2026-08-06 05:35 UTC -- T+200h26m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h26m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 05:35 UTC | elapsed 8.35 d | 20.8 d to the Aug-27 stop
test tier: 17,225 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     108 records     108.0 rec/h
    last  3 h     150 records      50.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,042     108  GATED             GATED             barrier>=30
      279      10,090     108  GATED             GATED             barrier>=30
      340      12,835     108  GATED             GATED             barrier>=30
      403      15,670     108  GATED             GATED             barrier>=30
      568      23,103     108  GATED             GATED             barrier>=30
