...
**Auto-generated 2026-08-05 03:22 UTC -- T+174h13m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+174h13m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 4.9 h ago; none live, newest failure 66 min ago** |
...
| | |
|---|---|
| cluster jobs | **990** (186 running, 804 queued) |
...
```
generated 2026-08-05 03:22 UTC | elapsed 7.26 d | 21.9 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     192 records      64.0 rec/h
    last 12 h    1894 records     157.8 rec/h
    last 24 h    4050 records     168.8 rec/h
    12 h rate is 37% from ONE line (test_leg_sonnet_5); 10 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (158 rec/h); latest excludes cells already within
