...
**Auto-generated 2026-08-04 18:25 UTC -- T+165h16m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+165h16m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **179** (176 running, 1 queued) |
...
```
generated 2026-08-04 18:26 UTC | elapsed 6.89 d | 22.2 d to the Aug-27 stop
test tier: 12,305 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     269 records     269.0 rec/h
    last  3 h     588 records     196.0 rec/h
    last 12 h    2367 records     197.2 rec/h
    last 24 h    4221 records     175.9 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,888      16  GATED             GATED             barrier>=30
      189       8,338      16  GATED             GATED             barrier>=30
      279      12,838      16  GATED             GATED             barrier>=30
      340      15,888      16  GATED             GATED             barrier>=30
      403      19,038      16  GATED             GATED             barrier>=30
      568      28,023     269  GATED             GATED             barrier>=30
