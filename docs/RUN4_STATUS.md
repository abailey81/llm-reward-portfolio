...
**Auto-generated 2026-08-06 02:01 UTC -- T+196h52m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+196h52m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
test tier: 17,052 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,651      54  GATED             GATED             barrier>=30
      189       6,215      54  GATED             GATED             barrier>=30
      279      10,263      54  GATED             GATED             barrier>=30
      340      13,008      54  GATED             GATED             barrier>=30
      403      15,843      54  GATED             GATED             barrier>=30
      568      23,276      54  GATED             GATED             barrier>=30
