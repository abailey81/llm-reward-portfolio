...
**Auto-generated 2026-08-03 12:07 UTC -- T+134h58m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+134h58m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **734** (162 running, 572 queued) |
...
```
 rung             @1296 cores              @830 cores   binding
  ...
  279            5.9 d  08-03            9.3 d  08-07   throughput
  340            7.1 d  08-05           11.1 d  08-09   throughput
  403            8.4 d  08-06           13.0 d  08-10   throughput
  568           11.6 d  08-09           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 2087 |
| scalar | g5 of 5 | 1498 |
| placebo | g5 of 5 | 1630 |
| scalar_cvar5 | g5 of 5 | 1599 |
| placebo_shuffled | g5 of 5 | 1612 |
...
```
2026-08-03T11:52:01Z  RED  records=8779 (+12)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=1.9m  drift=0  sci=OK  r115=21B  sweep=147.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T11:54:59Z  RED  records=8782 (+3)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=21B  sweep=101.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T11:57:11Z  RED  records=8790 (+8)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=21B  sweep=127.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T11:59:49Z  RED  records=8799 (+9)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=21B  sweep=103.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
