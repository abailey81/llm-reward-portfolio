...
**Auto-generated 2026-08-11 20:16 UTC -- T+335h07m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+335h07m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **429** = 57 running + **44 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **456** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (44 min old) |
...
```
generated 2026-08-11 20:17 UTC | elapsed 13.96 d | 15.2 d to the Aug-27 stop
