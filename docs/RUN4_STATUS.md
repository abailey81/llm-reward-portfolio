...
**Auto-generated 2026-08-06 21:25 UTC -- T+216h16m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+216h16m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **848** |
| **cores doing RUNG-RAISING work** | **29.4%** -- 240 of 816 cores (60 min old) |
...
```
generated 2026-08-06 21:25 UTC | elapsed 9.01 d | 20.1 d to the Aug-27 stop
test tier: 18,427 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 79.3 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h     952 records      79.3 rec/h   usable
