...
**Auto-generated 2026-08-01 07:57 UTC -- T+82h48m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+82h48m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
|---|---|---|
| distributional | g5 of 5 | 866 |
| scalar | g5 of 5 | 296 |
| placebo | g5 of 5 | 256 |
| scalar_cvar5 | g5 of 5 | 232 |
...
```
2026-08-01T07:53:06Z  RED  records=2235 (+0)  spend=$43.3339  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=14B  sweep=14.5s  auto-cycle
2026-08-01T07:53:51Z  RED  records=2236 (+1)  spend=$43.354  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=14B  sweep=16.0s  auto-cycle
2026-08-01T07:54:37Z  RED  records=2237 (+1)  spend=$43.3761  guards=2  arms_full=10/10  budget=2  stalest=1.3m  drift=0  sci=OK  r115=14B  sweep=16.6s  auto-cycle
2026-08-01T07:55:24Z  RED  records=2237 (+0)  spend=$43.4312  guards=2  arms_full=10/10  budget=2  stalest=2.0m  drift=0  sci=OK  r115=14B  sweep=14.1s  auto-cycle
2026-08-01T07:56:08Z  RED  records=2237 (+0)  spend=$43.4582  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=14B  sweep=15.8s  auto-cycle
2026-08-01T07:56:54Z  RED  records=2238 (+1)  spend=$43.4582  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=14B  sweep=15.9s  auto-cycle
```
