...
**Auto-generated 2026-08-05 07:31 UTC -- T+178h22m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+178h22m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 16 min ago; none live, newest failure 16 min ago** |
...
| | |
|---|---|
| cluster jobs | **922** (199 running, 723 queued) |
...
```
generated 2026-08-05 07:32 UTC | elapsed 7.43 d | 21.7 d to the Aug-27 stop
test tier: 14,212 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     232 records     232.0 rec/h
    last  3 h     607 records     202.3 rec/h
    last 12 h    1687 records     140.6 rec/h
    last 24 h    4083 records     170.1 rec/h
    12 h rate is 44% from ONE line (test_leg_haiku_4_5); 10 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 38% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,234       4  GATED             GATED             barrier>=30
      189       7,239     159  GATED             GATED             barrier>=30
      279      11,666     232  GATED             GATED             barrier>=30
      340      14,716     232  GATED             GATED             barrier>=30
      403      17,866     232  GATED             GATED             barrier>=30
      568      26,116     232  GATED             GATED             barrier>=30
...
```
2026-08-05T06:47:27Z  OK  records=15560 (+18)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.0m  drift=0  sci=OK  r115=22B  cores=1632  sweep=227.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T06:54:40Z  OK  records=15599 (+39)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.3m  drift=0  sci=OK  r115=22B  sweep=402.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T06:59:29Z  OK  records=15616 (+17)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.2m  drift=0  sci=OK  r115=22B  cores=1600  sweep=258.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
