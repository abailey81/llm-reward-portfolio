...
**Auto-generated 2026-08-05 08:01 UTC -- T+178h52m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+178h52m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 45 min ago; none live, newest failure 45 min ago** |
...
| | |
|---|---|
| cluster jobs | **904** (203 running, 701 queued) |
...
```
generated 2026-08-05 08:01 UTC | elapsed 7.45 d | 21.7 d to the Aug-27 stop
test tier: 14,341 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     247 records     247.0 rec/h
    last  3 h     714 records     238.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,215      21  GATED             GATED             barrier>=30
      189       7,220      64  GATED             GATED             barrier>=30
      279      11,537     247  GATED             GATED             barrier>=30
      340      14,587     247  GATED             GATED             barrier>=30
      403      17,737     247  GATED             GATED             barrier>=30
      568      25,987     247  GATED             GATED             barrier>=30
...
2026-08-05T08:01:43Z  OK  records=15879 (+18)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  sweep=89.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
