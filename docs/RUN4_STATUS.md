...
**Auto-generated 2026-08-04 17:19 UTC -- T+164h10m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+164h10m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **217** (214 running, 1 queued) |
...
```
generated 2026-08-04 17:20 UTC | elapsed 6.84 d | 22.3 d to the Aug-27 stop
test tier: 12,023 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     177 records     177.0 rec/h
    last  3 h     522 records     174.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      28,305     177  GATED             GATED             barrier>=30
    ...
    !! 97% of the rung-568 backlog (27,432 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
