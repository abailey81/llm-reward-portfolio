...
**Auto-generated 2026-08-06 00:49 UTC -- T+195h40m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h40m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.8 h ago; none live, newest failure 45 min ago** |
...
```
generated 2026-08-06 00:50 UTC | elapsed 8.15 d | 21.0 d to the Aug-27 stop
test tier: 16,993 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     140 records     140.0 rec/h
    last  3 h     546 records     182.0 rec/h
    last 12 h    1923 records     160.2 rec/h
    last 24 h    3532 records     147.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,710     111  GATED             GATED             barrier>=30
      189       6,274     138  GATED             GATED             barrier>=30
      279      10,322     140  GATED             GATED             barrier>=30
      340      13,067     140  GATED             GATED             barrier>=30
      403      15,902     140  GATED             GATED             barrier>=30
      568      23,335     140  GATED             GATED             barrier>=30
...
```
2026-08-06T00:31:36Z  OK  records=18522 (+6)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.2m  drift=0  sci=OK  r115=22B  sweep=257.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
