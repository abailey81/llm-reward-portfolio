...
**Auto-generated 2026-08-05 19:03 UTC -- T+189h54m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+189h54m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 0 min ago; LIVE, still failing** |
...
| | |
|---|---|
| cluster jobs | **833** (119 running, 714 queued) |
| **cores computing** | **952** |
...
```
generated 2026-08-05 19:04 UTC | elapsed 7.91 d | 21.2 d to the Aug-27 stop
test tier: 16,158 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     151 records     151.0 rec/h
    last  3 h     549 records     183.0 rec/h
    last 12 h    2056 records     171.3 rec/h
    last 24 h    3736 records     155.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      24,170     151  GATED             GATED             barrier>=30
