...
**Auto-generated 2026-08-04 22:52 UTC -- T+169h43m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+169h43m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 22 min ago; none live, newest failure 22 min ago** |
...
```
generated 2026-08-04 22:52 UTC | elapsed 7.07 d | 22.0 d to the Aug-27 stop
test tier: 13,153 records over 68 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     143 records     143.0 rec/h
    last  3 h     559 records     186.3 rec/h
    last 12 h    2213 records     184.4 rec/h
    last 24 h    4306 records     179.4 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      27,175     143  GATED             GATED             barrier>=30
