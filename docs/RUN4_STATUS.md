...
**Auto-generated 2026-08-11 18:15 UTC -- T+333h06m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+333h06m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **520** |
| **cores doing RUNG-RAISING work** | **4.8%** -- 24 of 504 cores (42 min old) |
...
```
generated 2026-08-11 18:16 UTC | elapsed 13.88 d | 15.2 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,852      94  GATED             GATED             barrier>=279
      403       4,057      94  GATED             GATED             barrier>=279
      568      10,581      94  GATED             GATED             barrier>=279
