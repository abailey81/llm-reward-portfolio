...
**Auto-generated 2026-08-05 15:40 UTC -- T+186h31m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+186h31m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **908** (184 running, 724 queued) |
...
```
generated 2026-08-05 15:41 UTC | elapsed 7.77 d | 21.3 d to the Aug-27 stop
test tier: 15,558 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      403      16,520     195  GATED             GATED             barrier>=30
      568      24,770     195  GATED             GATED             barrier>=30
