...
**Auto-generated 2026-08-12 01:05 UTC -- T+339h56m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+339h56m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **744** |
| **cores doing RUNG-RAISING work** | **37.8%** -- 248 of 656 cores (93 min old **STALE**) |
...
```
generated 2026-08-12 01:06 UTC | elapsed 14.16 d | 15.0 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,495      44  GATED             GATED             barrier>=279
      403       3,700      44  GATED             GATED             barrier>=279
      568      10,224      44  GATED             GATED             barrier>=279
