...
**Auto-generated 2026-08-10 05:40 UTC -- T+296h31m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+296h31m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **890** = 164 running + **350 ELIGIBLE** + 376 held by us + 0 held only by the site |
...
| **cores doing RUNG-RAISING work** | **100.0%** -- 1312 of 1312 cores (2 min old) |
...
```
generated 2026-08-10 05:40 UTC | elapsed 12.36 d | 16.8 d to the Aug-27 stop
test tier: 25,783 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 106.5 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h    1278 records     106.5 rec/h   usable
    last 24 h    2649 records     110.4 rec/h   usable
    12 h rate is 84% from ONE line (test); 5 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189         145       8  2026-08-10 07:02  2026-08-10 07:02  yes
      279       3,106     108  2026-08-11 10:50  2026-08-11 10:50  yes
      340       5,241     108  2026-08-12 06:53  2026-08-12 06:53  yes
      403       7,469     108  2026-08-13 03:48  2026-08-13 03:48  yes
      568      14,545     108  2026-08-15 22:15  2026-08-15 22:15  yes
...
> **What is holding it right now: test -- baseline_log_growth has 215 HOLE(S) below its frontier 406 -- that is what caps this line**
...
currently at **192 seeds each** (read live from the archive on this publish). !! THE
