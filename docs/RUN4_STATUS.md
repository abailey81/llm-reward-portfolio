...
**Auto-generated 2026-08-12 16:49 UTC -- T+355h40m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+355h40m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 0/240 (0.0% to fatal), - on -, age UNKNOWN; none live, newest failure 23.1 h ago** |
...
| | |
|---|---|
| cluster jobs | **330** = 30 running + **0 ELIGIBLE** + 300 held by us + 0 held only by the site |
...
| **cores computing** | **240** |
| **cores doing RUNG-RAISING work** | **58.3%** -- 168 of 288 cores (76 min old) |
...
```
generated 2026-08-12 16:49 UTC | elapsed 14.82 d | 14.3 d to the Aug-27 stop
test tier: 31,482 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 94.9 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last  3 h     248 records      82.7 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last 12 h    1139 records      94.9 rec/h   usable
    last 24 h    1877 records      78.2 rec/h   usable
    12 h rate is 76% from ONE line (test); 3 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (95 rec/h); latest excludes cells already within
    8 of the ceiling (95 rec/h). Window 12 h.
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340         472       0  2026-08-12 21:48  2026-08-12 21:48  yes
      403       2,499      24  2026-08-13 19:09  2026-08-13 19:09  yes
      568       8,846      24  2026-08-16 14:01  2026-08-16 14:01  yes
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung      @240 cores      @830 cores   binding
       30           5.8 d           4.6 d   critical_chain
      100          13.2 d           4.6 d   critical_chain
      189          22.6 d           6.5 d   throughput
      279          32.1 d           9.3 d   throughput
      340          38.5 d          11.1 d   throughput
      403          45.1 d          13.0 d   throughput
      568          62.5 d          18.1 d   throughput
...
```
2026-08-12T16:21:48Z  OK  records=33015 (+9)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=4.4m  drift=0  sci=OK  r115=22B  sweep=806.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T16:34:54Z  OK  records=33016 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.4m  drift=0  sci=OK  r115=22B  cores=256  sweep=756.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T16:44:55Z  OK  records=33024 (+8)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.8m  drift=0  sci=OK  r115=22B  sweep=571.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T16:46:22Z  OK  records=33024 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.8m  drift=0  sci=OK  r115=22B  sweep=57.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T16:48:04Z  OK  records=33024 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.5m  drift=0  sci=OK  r115=22B  sweep=72.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T16:49:31Z  OK  records=33025 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.0m  drift=0  sci=OK  r115=22B  sweep=56.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
