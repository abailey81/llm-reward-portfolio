...
**Auto-generated 2026-08-06 06:52 UTC -- T+201h43m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+201h43m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **931** (99 running, 832 queued) |
| **cores computing** | **792** |
...
```
generated 2026-08-06 06:53 UTC | elapsed 8.41 d | 20.7 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    1219 records     101.6 rec/h
    last 24 h    3293 records     137.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,908      92  GATED             GATED             barrier>=30
      279       9,956      92  GATED             GATED             barrier>=30
      340      12,701      92  GATED             GATED             barrier>=30
      403      15,536      92  GATED             GATED             barrier>=30
      568      22,969      92  GATED             GATED             barrier>=30
