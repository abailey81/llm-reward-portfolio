...
**Auto-generated 2026-08-06 18:18 UTC -- T+213h10m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
```
generated 2026-08-06 18:19 UTC | elapsed 8.88 d | 20.2 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,693      60  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,528      60  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,961      60  GATED             GATED             no-records:test/distributional,test/scalar>=30
