...
**Auto-generated 2026-08-04 18:35 UTC -- T+165h26m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+165h26m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on nemotron-3-super, 2.8 h ago; none live, newest failure 2.8 h ago** |
...
| | |
|---|---|
| cluster jobs | **175** (173 running, 0 queued) |
...
```
generated 2026-08-04 18:35 UTC | elapsed 6.89 d | 22.2 d to the Aug-27 stop
test tier: 12,328 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     229 records     229.0 rec/h
    last  3 h     580 records     193.3 rec/h
    last 12 h    2371 records     197.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,879      25  GATED             GATED             barrier>=30
      189       8,329      25  GATED             GATED             barrier>=30
      279      12,829      25  GATED             GATED             barrier>=30
      340      15,879      25  GATED             GATED             barrier>=30
      403      19,029      25  GATED             GATED             barrier>=30
      568      28,000     229  GATED             GATED             barrier>=30
