...
```
generated 2026-08-06 10:43 UTC | elapsed 8.57 d | 20.6 d to the Aug-27 stop
test tier: 17,555 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,712      41  GATED             GATED             barrier>=30
      279       9,760      41  GATED             GATED             barrier>=30
      340      12,505      41  GATED             GATED             barrier>=30
      403      15,340      41  GATED             GATED             barrier>=30
      568      22,773      41  GATED             GATED             barrier>=30
