...
| **cores computing** | **912** |
| **cores doing RUNG-RAISING work** | **20.7%** -- 200 of 968 cores (15 min old) |
...
```
generated 2026-08-06 09:35 UTC | elapsed 8.52 d | 20.6 d to the Aug-27 stop
test tier: 17,503 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,764     128  GATED             GATED             barrier>=30
      279       9,812     128  GATED             GATED             barrier>=30
      340      12,557     128  GATED             GATED             barrier>=30
      403      15,392     128  GATED             GATED             barrier>=30
      568      22,825     128  GATED             GATED             barrier>=30
