...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,628      54  GATED             GATED             barrier>=30
      189       6,192      54  GATED             GATED             barrier>=30
      279      10,240      54  GATED             GATED             barrier>=30
      340      12,985      54  GATED             GATED             barrier>=30
      403      15,820      54  GATED             GATED             barrier>=30
      568      23,253      54  GATED             GATED             barrier>=30
