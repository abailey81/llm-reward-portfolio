...
**Auto-generated 2026-08-06 12:04 UTC -- T+206h55m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+206h55m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,707      20  GATED             GATED             barrier>=30
      340      12,452      20  GATED             GATED             barrier>=30
      403      15,287      20  GATED             GATED             barrier>=30
      568      22,720      20  GATED             GATED             barrier>=30
