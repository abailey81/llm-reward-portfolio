...
**Auto-generated 2026-08-06 05:46 UTC -- T+200h37m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h37m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    12 h rate is 36% from ONE line (test_leg_haiku_4_5); 4 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,570      10  GATED             GATED             barrier>=30
      189       6,006     136  GATED             GATED             barrier>=30
      279      10,054     136  GATED             GATED             barrier>=30
      340      12,799     136  GATED             GATED             barrier>=30
      403      15,634     136  GATED             GATED             barrier>=30
      568      23,067     136  GATED             GATED             barrier>=30
