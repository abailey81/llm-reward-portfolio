...
**Auto-generated 2026-08-11 20:52 UTC -- T+335h43m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+335h43m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on deepseek-v4-pro, 3.2 h ago; none live, newest failure 3.2 h ago** |
...
| | |
|---|---|
| cluster jobs | **422** = 65 running + **29 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **520** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (80 min old) |
...
```
generated 2026-08-11 20:53 UTC | elapsed 13.99 d | 15.1 d to the Aug-27 stop
test tier: 29,940 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    2799 records     116.6 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,659      85  GATED             GATED             barrier>=279
      403       3,864      85  GATED             GATED             barrier>=279
      568      10,388      85  GATED             GATED             barrier>=279
