...
**Auto-generated 2026-08-05 17:02 UTC -- T+187h53m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+187h53m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 4.0 h ago; none live, newest failure 4.0 h ago** |
...
| | |
|---|---|
| cluster jobs | **883** (169 running, 714 queued) |
...
```
generated 2026-08-05 17:02 UTC | elapsed 7.83 d | 21.3 d to the Aug-27 stop
test tier: 15,800 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     196 records     196.0 rec/h
    last  3 h     591 records     197.0 rec/h
    last 12 h    2171 records     180.9 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      403      16,471      12  GATED             GATED             barrier>=30
      568      24,528     196  GATED             GATED             barrier>=30
