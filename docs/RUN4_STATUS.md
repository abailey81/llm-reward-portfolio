...
**Auto-generated 2026-08-05 14:13 UTC -- T+185h04m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+185h04m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 3.4 h ago; none live, newest failure 69 min ago** |
...
| | |
|---|---|
| cluster jobs | **952** (185 running, 767 queued) |
...
```
generated 2026-08-05 14:14 UTC | elapsed 7.71 d | 21.4 d to the Aug-27 stop
test tier: 15,252 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     150 records     150.0 rec/h
    last  3 h     325 records     108.3 rec/h
    last 12 h    1666 records     138.8 rec/h
    last 24 h    3765 records     156.9 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,676     150  GATED             GATED             barrier>=30
      403      16,826     150  GATED             GATED             barrier>=30
      568      25,076     150  GATED             GATED             barrier>=30
