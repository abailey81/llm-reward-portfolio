...
**Auto-generated 2026-08-05 18:05 UTC -- T+188h56m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+188h56m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **857** (143 running, 714 queued) |
...
```
generated 2026-08-05 18:05 UTC | elapsed 7.87 d | 21.2 d to the Aug-27 stop
test tier: 16,004 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     194 records     194.0 rec/h
    last  3 h     533 records     177.7 rec/h
    last 12 h    2111 records     175.9 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      24,324     194  GATED             GATED             barrier>=30
