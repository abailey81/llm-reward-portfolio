...
**Auto-generated 2026-08-03 01:45 UTC -- T+124h36m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+124h36m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **905** (283 running, 622 queued) |
| **cores computing** | **2264** |

Per-rung ETAs from the registered model at the cores we actually hold:

```
 rung             @2264 cores              @830 cores   binding
...
|---|---|---|
| distributional | g5 of 5 | 1586 |
| scalar | g5 of 5 | 1000 |
| placebo | g5 of 5 | 1155 |
| scalar_cvar5 | g5 of 5 | 1123 |
| placebo_shuffled | g5 of 5 | 1111 |
...
## Monitoring -- the 30-second cycle (last monitoring cycle 6 min ago)
...
```
2026-08-03T01:31:51Z  RED  records=6321 (+4)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=1.8m  drift=0  sci=OK  r115=21B  sweep=97.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
