...
**Auto-generated 2026-08-05 05:23 UTC -- T+176h14m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+176h14m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 21 min ago; none live, newest failure 21 min ago** |
...
| | |
|---|---|
| cluster jobs | **984** (201 running, 783 queued) |
...
```
generated 2026-08-05 05:23 UTC | elapsed 7.34 d | 21.8 d to the Aug-27 stop
test tier: 13,677 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      73 records      73.0 rec/h
    last  3 h      85 records      28.3 rec/h
    last 12 h    1647 records     137.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,255      69  GATED             GATED             barrier>=30
      189       7,701      73  GATED             GATED             barrier>=30
      279      12,201      73  GATED             GATED             barrier>=30
      340      15,251      73  GATED             GATED             barrier>=30
      403      18,401      73  GATED             GATED             barrier>=30
      568      26,651      73  GATED             GATED             barrier>=30
