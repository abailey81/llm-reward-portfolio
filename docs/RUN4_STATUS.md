...
**Auto-generated 2026-08-12 01:43 UTC -- T+340h34m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+340h34m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **776** |
| **cores doing RUNG-RAISING work** | **56.7%** -- 440 of 776 cores (10 min old) |
...
```
generated 2026-08-12 01:44 UTC | elapsed 14.19 d | 14.9 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279          72      12  GATED             GATED             barrier
      340       1,462      52  GATED             GATED             barrier>=279
      403       3,667      52  GATED             GATED             barrier>=279
      568      10,191      52  GATED             GATED             barrier>=279
