...
**Auto-generated 2026-08-11 20:04 UTC -- T+334h55m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+334h55m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **480** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (31 min old) |
...
```
generated 2026-08-11 20:04 UTC | elapsed 13.96 d | 15.2 d to the Aug-27 stop
test tier: 29,870 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    2789 records     116.2 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,729      76  GATED             GATED             barrier>=279
      403       3,934      76  GATED             GATED             barrier>=279
      568      10,458      76  GATED             GATED             barrier>=279
