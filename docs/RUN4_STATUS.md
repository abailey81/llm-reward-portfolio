...
**Auto-generated 2026-08-05 04:47 UTC -- T+175h39m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+175h39m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 2.5 h ago; none live, newest failure 2.5 h ago** |
...
| | |
|---|---|
| cluster jobs | **989** (191 running, 798 queued) |
...
```
generated 2026-08-05 04:48 UTC | elapsed 7.32 d | 21.8 d to the Aug-27 stop
test tier: 13,615 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      11 records      11.0 rec/h
    last  3 h      49 records      16.3 rec/h
    last 12 h    1701 records     141.8 rec/h
    last 24 h    3926 records     163.6 rec/h
    12 h rate is 36% from ONE line (test_leg_qwen3_5_9b); 10 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 65% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,313      11  GATED             GATED             barrier>=30
      189       7,763      11  GATED             GATED             barrier>=30
      279      12,263      11  GATED             GATED             barrier>=30
      340      15,313      11  GATED             GATED             barrier>=30
      403      18,463      11  GATED             GATED             barrier>=30
      568      26,713      11  GATED             GATED             barrier>=30
...
2026-08-05T04:35:39Z  OK  records=15148 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=326.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T04:41:19Z  OK  records=15153 (+5)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.0m  drift=0  sci=OK  r115=22B  sweep=309.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T04:46:58Z  OK  records=15156 (+3)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  cores=1528  sweep=308.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
