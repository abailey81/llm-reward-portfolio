...
| | |
|---|---|
| cluster jobs | **940** (73 running, 867 queued) |
| **cores computing** | **584** |
...
```
generated 2026-08-06 06:06 UTC | elapsed 8.37 d | 20.7 d to the Aug-27 stop
test tier: 17,296 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     146 records     146.0 rec/h
    last  3 h     218 records      72.7 rec/h
    last 12 h    1278 records     106.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,971     146  GATED             GATED             barrier>=30
      279      10,019     146  GATED             GATED             barrier>=30
      340      12,764     146  GATED             GATED             barrier>=30
      403      15,599     146  GATED             GATED             barrier>=30
      568      23,032     146  GATED             GATED             barrier>=30
