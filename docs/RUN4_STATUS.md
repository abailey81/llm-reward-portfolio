...
**Auto-generated 2026-08-05 05:51 UTC -- T+176h42m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+176h42m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 49 min ago; none live, newest failure 49 min ago** |
...
| | |
|---|---|
| cluster jobs | **973** (210 running, 763 queued) |
...
```
generated 2026-08-05 05:51 UTC | elapsed 7.36 d | 21.8 d to the Aug-27 stop
test tier: 13,813 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     195 records     195.0 rec/h
    last  3 h     216 records      72.0 rec/h
    last 12 h    1623 records     135.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       7,565     195  GATED             GATED             barrier>=30
      279      12,065     195  GATED             GATED             barrier>=30
      340      15,115     195  GATED             GATED             barrier>=30
      403      18,265     195  GATED             GATED             barrier>=30
      568      26,515     195  GATED             GATED             barrier>=30
