...
**Auto-generated 2026-08-06 19:40 UTC -- T+214h32m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| cluster jobs | **836** = 100 running + **34 ELIGIBLE** + 565 held by us + 137 held only by the site |
...
```
generated 2026-08-06 19:41 UTC | elapsed 8.94 d | 20.2 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,643      40  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,478      40  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,911      40  GATED             GATED             no-records:test/distributional,test/scalar>=30
