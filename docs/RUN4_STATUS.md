...
**Auto-generated 2026-08-06 16:00 UTC -- T+210h51m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+210h51m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 87 min ago; none live, newest failure 86 min ago** |
...
| | |
|---|---|
| cluster jobs | **869** (48 running, 821 queued) |
| **cores computing** | **384** |
| **cores doing RUNG-RAISING work** | **17.0%** -- 72 of 424 cores (21 min old) |
...
```
generated 2026-08-06 16:00 UTC | elapsed 8.79 d | 20.3 d to the Aug-27 stop
test tier: 18,120 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,195     241  GATED             GATED             unstarted:2-unit(s)-absent>=30
      340      11,940     241  GATED             GATED             unstarted:2-unit(s)-absent>=30
      403      14,775     241  GATED             GATED             unstarted:2-unit(s)-absent>=30
      568      22,208     241  GATED             GATED             unstarted:2-unit(s)-absent>=30
