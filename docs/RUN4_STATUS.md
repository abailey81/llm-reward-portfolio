...
**Auto-generated 2026-08-03 09:52 UTC -- T+132h43m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+132h43m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **829** (208 running, 621 queued) |
...
```
 rung             @1664 cores              @830 cores   binding
  ...
  568            9.0 d  08-06           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 1951 |
| scalar | g5 of 5 | 1365 |
| placebo | g5 of 5 | 1477 |
| scalar_cvar5 | g5 of 5 | 1458 |
| placebo_shuffled | g5 of 5 | 1465 |
