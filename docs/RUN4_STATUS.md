...
**Auto-generated 2026-07-31 19:45 UTC -- T+70h36m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+70h36m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **190** (102 running, 88 queued) |
| **cores computing** | **816** |
...
```
 rung              @816 cores              @830 cores   binding
  ...
  100            3.9 d  08-01            3.8 d  08-01   throughput
...
2026-07-31T19:39:55Z  RED  records=1500 (+2)  spend=$38.2559  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=13B  cores=776  auto-cycle
2026-07-31T19:42:06Z  RED  records=1500 (+0)  spend=$38.2559  guards=2  arms_full=10/10  budget=2  stalest=2.1m  drift=0  sci=OK  r115=13B  auto-cycle
