...
**Auto-generated 2026-08-05 07:56 UTC -- T+178h47m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+178h47m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **15859** |
| **Myriad maintenance** | **2026-08-12 from 08:00 UTC, at risk all day** (in 7.0 days). Delayed from Aug 11. Jobs may die and REQUEUE idempotently; the supervisors ride it. Playbook: docs/ops/MAINTENANCE_2026-08-12.md |
| LLM calls / spend | 2956 / **$45.5021** |
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 40 min ago; none live, newest failure 40 min ago** |
...
| | |
|---|---|
| cluster jobs | **907** (206 running, 701 queued) |
...
```
generated 2026-08-05 07:56 UTC | elapsed 7.45 d | 21.7 d to the Aug-27 stop
test tier: 14,316 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     238 records     238.0 rec/h
    last  3 h     694 records     231.3 rec/h
    last 12 h    1710 records     142.5 rec/h
    last 24 h    4107 records     171.1 rec/h
    12 h rate is 47% from ONE line (test_leg_haiku_4_5); 10 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 37% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,223      13  GATED             GATED             barrier>=30
      189       7,228      72  GATED             GATED             barrier>=30
      279      11,562     238  GATED             GATED             barrier>=30
      340      14,612     238  GATED             GATED             barrier>=30
      403      17,762     238  GATED             GATED             barrier>=30
      568      26,012     238  GATED             GATED             barrier>=30
    ...
    !! 69% of the rung-568 backlog (17,994 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
...
```
2026-08-05T07:11:26Z  OK  records=15657 (+16)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.2m  drift=0  sci=OK  r115=22B  sweep=245.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T07:23:51Z  OK  records=15679 (+22)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  cores=1624  sweep=714.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T07:39:24Z  OK  records=15750 (+71)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.6m  drift=0  sci=OK  r115=22B  sweep=903.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T07:45:21Z  RED  records=15807 (+57)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.1m  drift=0  sci=OK  r115=22B  cores=1600  sweep=326.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T07:49:57Z  RED  records=15824 (+17)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.2m  drift=0  sci=OK  r115=22B  sweep=245.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T07:52:47Z  ATTN  records=15840 (+16)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=BLIND(6/8+norec)  r115=22B  sweep=139.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
