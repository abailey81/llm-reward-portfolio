...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 74 min ago; none live, newest failure 74 min ago** |
...
| **cores computing** | **408** |
| **cores doing RUNG-RAISING work** | **17.0%** -- 72 of 424 cores (9 min old) |
...
```
generated 2026-08-06 15:48 UTC | elapsed 8.78 d | 20.3 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,241     257  GATED             GATED             unstarted:2-unit(s)-absent>=30
      340      11,986     257  GATED             GATED             unstarted:2-unit(s)-absent>=30
      403      14,821     257  GATED             GATED             unstarted:2-unit(s)-absent>=30
      568      22,254     257  GATED             GATED             unstarted:2-unit(s)-absent>=30
