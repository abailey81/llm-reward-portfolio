...
**Auto-generated 2026-08-06 09:46 UTC -- T+204h38m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| **cores computing** | **904** |
| **cores doing RUNG-RAISING work** | **20.7%** -- 200 of 968 cores (27 min old) |
...
```
generated 2026-08-06 09:47 UTC | elapsed 8.53 d | 20.6 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,751     124  GATED             GATED             barrier>=30
      279       9,799     124  GATED             GATED             barrier>=30
      340      12,544     124  GATED             GATED             barrier>=30
      403      15,379     124  GATED             GATED             barrier>=30
      568      22,812     124  GATED             GATED             barrier>=30
