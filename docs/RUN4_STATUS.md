...
**Auto-generated 2026-08-06 05:23 UTC -- T+200h14m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h14m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 05:24 UTC | elapsed 8.34 d | 20.8 d to the Aug-27 stop
test tier: 17,186 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      75 records      75.0 rec/h
    last  3 h     118 records      39.3 rec/h
    last 12 h    1307 records     108.9 rec/h
    last 24 h    3505 records     146.0 rec/h
    12 h rate is 42% from ONE line (test_leg_haiku_4_5); 4 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 42% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_haiku_4_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,081      75  GATED             GATED             barrier>=30
      279      10,129      75  GATED             GATED             barrier>=30
      340      12,874      75  GATED             GATED             barrier>=30
      403      15,709      75  GATED             GATED             barrier>=30
      568      23,142      75  GATED             GATED             barrier>=30
