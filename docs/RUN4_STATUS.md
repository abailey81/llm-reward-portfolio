...
**Auto-generated 2026-08-04 18:19 UTC -- T+165h10m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+165h10m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **184** (182 running, 0 queued) |
...
```
generated 2026-08-04 18:19 UTC | elapsed 6.88 d | 22.2 d to the Aug-27 stop
test tier: 12,277 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     254 records     254.0 rec/h
    last  3 h     578 records     192.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (196 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,896       8  GATED             GATED             barrier>=30
      189       8,346       8  GATED             GATED             barrier>=30
      279      12,846       8  GATED             GATED             barrier>=30
      340      15,896       8  GATED             GATED             barrier>=30
      403      19,046       8  GATED             GATED             barrier>=30
      568      28,051     254  GATED             GATED             barrier>=30
