...
**Auto-generated 2026-08-06 01:03 UTC -- T+195h54m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h54m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 6.0 h ago; none live, newest failure 59 min ago** |
...
| | |
|---|---|
| cluster jobs | **972** (67 running, 905 queued) |
| **cores computing** | **536** |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,704      85  GATED             GATED             barrier>=30
      189       6,268      96  GATED             GATED             barrier>=30
      279      10,316      98  GATED             GATED             barrier>=30
      340      13,061      98  GATED             GATED             barrier>=30
      403      15,896      98  GATED             GATED             barrier>=30
      568      23,329      98  GATED             GATED             barrier>=30
