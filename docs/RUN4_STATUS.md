...
**Auto-generated 2026-08-06 10:48 UTC -- T+205h39m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+205h39m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **907** (112 running, 795 queued) |
| **cores computing** | **896** |
| **cores doing RUNG-RAISING work** | **21.2%** -- 192 of 904 cores (28 min old) |
...
```
generated 2026-08-06 10:49 UTC | elapsed 8.57 d | 20.5 d to the Aug-27 stop
test tier: 17,561 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    12 h rate is 82% from ONE line (test_leg_kimi_k3); 3 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,706      43  GATED             GATED             barrier>=30
      279       9,754      43  GATED             GATED             barrier>=30
      340      12,499      43  GATED             GATED             barrier>=30
      403      15,334      43  GATED             GATED             barrier>=30
      568      22,767      43  GATED             GATED             barrier>=30
