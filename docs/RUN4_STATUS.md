...
**Auto-generated 2026-08-05 02:08 UTC -- T+172h59m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+172h59m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **990** (176 running, 813 queued) |
...
```
generated 2026-08-05 02:09 UTC | elapsed 7.21 d | 21.9 d to the Aug-27 stop
test tier: 13,585 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      84 records      84.0 rec/h
    last  3 h     368 records     122.7 rec/h
    last 12 h    2118 records     176.5 rec/h
    last 24 h    4223 records     176.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (176 rec/h); latest excludes cells already within
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      26,743      84  GATED             GATED             barrier>=30
