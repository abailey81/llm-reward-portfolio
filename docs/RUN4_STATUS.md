...
**Auto-generated 2026-08-04 23:31 UTC -- T+170h22m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+170h22m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 62 min ago; none live, newest failure 17 min ago** |
...
| | |
|---|---|
| cluster jobs | **986** (161 running, 823 queued) |
...
```
generated 2026-08-04 23:32 UTC | elapsed 7.10 d | 22.0 d to the Aug-27 stop
test tier: 13,288 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     205 records     205.0 rec/h
    last  3 h     563 records     187.7 rec/h
    last 12 h    2245 records     187.1 rec/h
    last 24 h    4263 records     177.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      27,040     205  GATED             GATED             barrier>=30
