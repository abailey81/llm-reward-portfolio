...
**Auto-generated 2026-08-04 21:46 UTC -- T+168h37m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+168h37m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| stalest driver log | **0 min (kimi-k3)** old (P218: the STALEST of the still-running lines, completed ladders excluded; above ~30 means that line has stopped progressing) |
| records archived | **14543** |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on nemotron-3-super, 5.9 h ago; none live, newest failure 5.9 h ago** |
...
| | |
|---|---|
| cluster jobs | **492** (147 running, 343 queued) |
| **cores computing** | **1176** |
...
```
generated 2026-08-04 21:46 UTC | elapsed 7.03 d | 22.1 d to the Aug-27 stop
test tier: 13,002 records over 67 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     190 records     190.0 rec/h
    last  3 h     639 records     213.0 rec/h
    last 12 h    2271 records     189.2 rec/h
    last 24 h    4419 records     184.1 rec/h
    12 h rate is 73% from ONE line (test_leg_sonnet_5); 10 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 74% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_sonnet_5, test_leg_gpt_5_6_luna) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (189 rec/h); latest excludes cells already within
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         249      57  2026-08-05 02:13  2026-08-05 02:48  yes
      100       3,363     140  2026-08-05 15:32  2026-08-07 17:42  yes
      189       7,813     140  2026-08-06 15:03  2026-08-11 11:36  yes
      279      12,313     140  2026-08-07 14:50  2026-08-15 06:31  yes
      340      15,363     140  2026-08-08 06:57  2026-08-17 20:08  yes
      403      18,513     140  2026-08-08 23:35  2026-08-20 11:46  yes
      568      27,326     190  2026-08-10 22:10  2026-08-27 21:48  risk
    GATED = the relevant rate is zero, so no throughput number can date that row -- it is
    waiting on a stage barrier (C1 chain / C3 gate), not on cores.
    (+4 registered unit(s) have no directory yet; each owes a FULL rung and is counted in 'remaining' above)
    !! those 4 unit(s) are NOT in the rate's denominator and CANNOT be -- they have produced nothing at all, so no window contains them.
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung     @1176 cores      @830 cores   binding
       30           4.6 d           4.6 d   critical_chain
      100           4.6 d           4.6 d   critical_chain
      189           4.6 d           6.5 d   throughput
      279           6.5 d           9.3 d   throughput
      340           7.9 d          11.1 d   throughput
      403           9.2 d          13.0 d   throughput
      568          12.8 d          18.1 d   throughput
...
2026-08-04T21:27:16Z  ATTN  records=14505 (+18)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=417.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T21:33:58Z  ATTN  records=14517 (+12)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  sweep=371.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T21:38:53Z  ATTN  records=14532 (+15)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.8m  drift=0  sci=OK  r115=22B  sweep=264.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T21:43:16Z  ATTN  records=14534 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  cores=1160  sweep=232.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T21:46:45Z  ATTN  records=14538 (+4)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=179.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
