...
**Auto-generated 2026-08-01 22:42 UTC -- T+97h33m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+97h33m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **2874** |
| LLM calls / spend | 2933 / **$45.4541** |
...
| | |
|---|---|
| cluster jobs | **80** (74 running, 6 queued) |
| **cores computing** | **592** |
...
```
 rung              @592 cores              @830 cores   binding
  ...
  100            5.4 d  08-03            4.6 d  08-02   critical_chain
  189            9.2 d  08-07            6.5 d  08-04   throughput
  279           13.0 d  08-10            9.3 d  08-07   throughput
  340           15.6 d  08-13           11.1 d  08-09   throughput
  403           18.3 d  08-16           13.0 d  08-10   throughput
  568           25.3 d  08-23           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 917 |
| scalar | g5 of 5 | 326 |
| placebo | g5 of 5 | 498 |
| scalar_cvar5 | g5 of 5 | 427 |
| placebo_shuffled | g5 of 5 | 327 |
...
```
2026-08-01T22:36:49Z  RED  records=2865 (+2)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=19B  sweep=19.1s  auto-cycle
2026-08-01T22:37:39Z  RED  records=2865 (+0)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=19B  sweep=15.6s  auto-cycle
2026-08-01T22:38:25Z  RED  records=2867 (+2)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0  sci=OK  r115=19B  sweep=37.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-01T22:39:32Z  RED  records=2870 (+3)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=4.3m  drift=0  sci=OK  r115=19B  sweep=38.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-01T22:40:41Z  RED  records=2872 (+2)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=19B  sweep=55.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-01T22:42:07Z  RED  records=2874 (+2)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=19B  sweep=56.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
...
```
  ...
  openrouter  spent $  8.7123  + still to author $  0.0660  = $  8.7783   credited $ 19.3100   margin $ +10.5317 (+55%)  comfortable
```
