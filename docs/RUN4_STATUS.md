...
**Auto-generated 2026-08-06 00:37 UTC -- T+195h28m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,282     177  GATED             GATED             barrier>=30
      279      10,330     179  GATED             GATED             barrier>=30
      340      13,075     179  GATED             GATED             barrier>=30
      403      15,910     179  GATED             GATED             barrier>=30
      568      23,343     179  GATED             GATED             barrier>=30
