...
**Auto-generated 2026-08-11 03:42 UTC -- T+318h33m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+318h33m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **29376** |
| **Myriad maintenance** | **2026-08-12 from 08:00 UTC, at risk all day** (in 1.2 days). Delayed from Aug 11. Jobs may die and REQUEUE idempotently; the supervisors ride it. Playbook: docs/ops/MAINTENANCE_2026-08-12.md |
| LLM calls / spend | 2956 / **$45.5021** |
| transport health | **timeouts 6h=0; worst streak 0/240 (0.0% to fatal), - on -, age UNKNOWN; none live, newest failure 17.0 h ago** |
...
| | |
|---|---|
| cluster jobs | **690** = 141 running + **195 ELIGIBLE** + 354 held by us + 0 held only by the site |
...
| **cores doing RUNG-RAISING work** | **100.0%** -- 1144 of 1144 cores (10 min old) |
...
```
generated 2026-08-11 03:43 UTC | elapsed 13.27 d | 15.8 d to the Aug-27 stop
test tier: 27,838 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 82.2 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    last  1 h     104 records     104.0 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last  3 h     220 records      73.3 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last 12 h     986 records      82.2 rec/h   usable
    last 24 h    2337 records      97.4 rec/h   usable
    12 h rate is 30% from ONE line (test_leg_deepseek_v4_pro); 5 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       1,626     104  2026-08-11 23:31  2026-08-11 23:31  yes
      340       3,761     104  2026-08-13 01:30  2026-08-13 01:30  yes
      403       5,966     104  2026-08-14 04:20  2026-08-14 04:20  yes
      568      12,490     104  2026-08-17 11:44  2026-08-17 11:44  yes
    GATED = the relevant rate is zero, so no throughput number can date that row -- it is
    waiting on a stage barrier (C1 chain / C3 gate), not on cores.
    !! 21% of the rung-568 backlog (2,626 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
...
> **What is holding it right now: test -- baseline_log_growth has 199 HOLE(S) below its frontier 406 -- that is what caps this line**
...
currently at **208 seeds each** (read live from the archive on this publish). !! THE
...
```
2026-08-11T03:14:14Z  OK  records=29303 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  sweep=69.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T03:15:35Z  OK  records=29309 (+6)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.4m  drift=0  sci=OK  r115=22B  sweep=50.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T03:16:56Z  OK  records=29311 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  sweep=50.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T03:18:18Z  OK  records=29313 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.5m  drift=0  sci=OK  r115=22B  sweep=51.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T03:19:42Z  OK  records=29313 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.6m  drift=0  sci=OK  r115=22B  sweep=54.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T03:21:06Z  OK  records=29317 (+4)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.0m  drift=0  sci=OK  r115=22B  sweep=53.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
