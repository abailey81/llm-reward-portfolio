...
```
generated 2026-08-06 06:59 UTC | elapsed 8.41 d | 20.7 d to the Aug-27 stop
test tier: 17,359 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      79 records      79.0 rec/h
    last  3 h     268 records      89.3 rec/h
    last 12 h    1206 records     100.5 rec/h
    last 24 h    3271 records     136.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,908      79  GATED             GATED             barrier>=30
      279       9,956      79  GATED             GATED             barrier>=30
      340      12,701      79  GATED             GATED             barrier>=30
      403      15,536      79  GATED             GATED             barrier>=30
      568      22,969      79  GATED             GATED             barrier>=30
