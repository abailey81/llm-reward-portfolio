...
**Auto-generated 2026-08-01 15:36 UTC -- T+90h27m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+90h27m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **116** (109 running, 6 queued) |
| **cores computing** | **872** |
...
```
 rung              @872 cores              @830 cores   binding
  ...
  279            8.8 d  08-06            9.3 d  08-07   throughput
  340           10.6 d  08-08           11.1 d  08-09   throughput
  403           12.4 d  08-10           13.0 d  08-10   throughput
  568           17.2 d  08-15           18.1 d  08-15   throughput
```
...
| scalar | g5 of 5 | 326 |
| placebo | g5 of 5 | 314 |
| scalar_cvar5 | g5 of 5 | 296 |
| placebo_shuffled | g5 of 5 | 281 |
...
```
2026-08-01T15:32:57Z  RED  records=2511 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=18B  sweep=16.1s  auto-cycle
2026-08-01T15:33:44Z  RED  records=2512 (+1)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=18B  sweep=16.6s  auto-cycle
2026-08-01T15:34:30Z  RED  records=2512 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=18B  sweep=16.2s  auto-cycle
2026-08-01T15:35:17Z  RED  records=2513 (+1)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.1m  drift=0  sci=OK  r115=18B  sweep=15.3s  auto-cycle
2026-08-01T15:36:02Z  RED  records=2515 (+2)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=18B  sweep=16.5s  auto-cycle
2026-08-01T15:36:49Z  RED  records=2515 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=18B  sweep=14.2s  auto-cycle
```
...
```
  anthropic   spent $ 36.7418  + still to author $  1.0446  = $ 37.7864   credited $ 28.1500   margin $  -9.6364 (-34%)  over the credit ESTIMATE (owner-watched)
  openrouter  spent $  8.7012  + still to author $  0.4814  = $  9.1826   credited $ 19.3100   margin $ +10.1274 (+52%)  comfortable
```
