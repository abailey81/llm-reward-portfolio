...
**Auto-generated 2026-08-06 05:49 UTC -- T+200h40m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h40m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 5.8 h ago; none live, newest failure 5.8 h ago** |
...
| | |
|---|---|
| cluster jobs | **947** (70 running, 877 queued) |
| **cores computing** | **560** |
...
```
generated 2026-08-06 05:50 UTC | elapsed 8.36 d | 20.8 d to the Aug-27 stop
test tier: 17,264 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     133 records     133.0 rec/h
    last  3 h     187 records      62.3 rec/h
    last 12 h    1308 records     109.0 rec/h
    last 24 h    3450 records     143.8 rec/h
    12 h rate is 37% from ONE line (test_leg_kimi_k3); 4 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,570       7  GATED             GATED             barrier>=30
      189       6,003     133  GATED             GATED             barrier>=30
      279      10,051     133  GATED             GATED             barrier>=30
      340      12,796     133  GATED             GATED             barrier>=30
      403      15,631     133  GATED             GATED             barrier>=30
      568      23,064     133  GATED             GATED             barrier>=30
