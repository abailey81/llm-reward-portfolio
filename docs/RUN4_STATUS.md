...
**Auto-generated 2026-08-04 11:35 UTC -- T+158h26m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+158h26m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| stalest driver log | **4 min (deepseek-v4-pro)** old (P218: the STALEST of the still-running lines, completed ladders excluded; above ~30 means that line has stopped progressing) |
| records archived | **12582** |
| **Myriad maintenance** | **2026-08-12 from 08:00 UTC, at risk all day** (in 7.8 days). Delayed from Aug 11. Jobs may die and REQUEUE idempotently; the supervisors ride it. Playbook: docs/ops/MAINTENANCE_2026-08-12.md |
| LLM calls / spend | 2956 / **$45.5021** |
| transport health | **timeouts 6h=2; worst streak 2/240 (0.8% to fatal), pull on core** |
| transport timeouts (cumulative, ever) | 168 -- a level with no rate; read the row above |
...
| | |
|---|---|
| cluster jobs | **338** (228 running, 108 queued) |
| **cores computing** | **1824** |
...
```
generated 2026-08-04 11:38 UTC | elapsed 6.60 d | 22.5 d to the Aug-27 stop
test tier: 11,057 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     152 records     152.0 rec/h
    last  3 h     623 records     207.7 rec/h
    last 12 h    2006 records     167.2 rec/h
    last 24 h    3844 records     160.2 rec/h
    12 h rate is 67% from ONE line (test_leg_sonnet_5); 3 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (167 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         404       0  2026-08-05 00:59  2026-08-05 00:59  yes
      100       3,904       0  2026-08-05 10:59  2026-08-05 10:59  yes
      189       8,354       0  2026-08-06 13:36  2026-08-06 13:36  yes
      279      12,854      58  2026-08-07 16:31  2026-08-07 16:31  yes
      340      16,115     152  2026-08-08 12:02  2026-08-08 12:02  yes
      403      19,580     152  2026-08-09 08:46  2026-08-09 08:46  yes
      568      29,271     152  2026-08-11 18:44  2026-08-11 18:44  yes
    ...
    !! 90% of the rung-568 backlog (26,200 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.

REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung     @1824 cores      @830 cores   binding
       30           4.6 d           4.6 d   critical_chain
      100           4.6 d           4.6 d   critical_chain
      189           4.6 d           6.5 d   throughput
      279           4.6 d           9.3 d   throughput
      340           5.1 d          11.1 d   throughput
      403           5.9 d          13.0 d   throughput
      568           8.2 d          18.1 d   throughput

    saturation: more than ~3235 cores buy NOTHING at rung 568
    critical-chain floor: 4.64 d total, 0.56 d still to run   (bayes_opt owes 3 of 30 candidates)
...
|---|---|---|---|---|
| test | **0** | 30 | 7 | 3 arm(s) still at zero |
| deepseek_v4_pro | **0** | 30 | 5 | 2 arm(s) still at zero |
| glm_5_2 | **0** | 30 | 5 | 2 arm(s) still at zero |
| nemotron_3_super | **0** | 30 | 5 | 3 arm(s) still at zero |
| kimi_k3 | **12** | 30 | 5 |  |
| haiku_4_5 | **30** | 30 | 5 |  |
| qwen3_6_27b | **30** | 30 | 5 |  |
| sonnet_5 | **284** | 302 | 5 |  |
| qwen3_5_9b | **446** | 448 | 5 |  |
...
```
UNDECIDED (cluster unreachable or tag unresolved -- NOT an alarm): test, test_leg_deepseek_v4_pro, test_leg_glm_5_2, test_leg_nemotron_3_super, test_leg_kimi_k3, test_leg_haiku_4_5, test_leg_qwen3_6_27b, test_leg_sonnet_5, test_leg_qwen3_5_9b, test_leg_gpt_5_6_luna
...
```
2026-08-04T11:05:33Z  ATTN  records=12490 (+5)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.2m  drift=0  sci=OK  r115=22B  sweep=254.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T11:15:05Z  ATTN  records=12501 (+11)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.0m  drift=0  sci=OK  r115=22B  sweep=542.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T11:19:57Z  ATTN  records=12519 (+18)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.5m  drift=0  sci=OK  r115=22B  sweep=261.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T11:26:15Z  ATTN  records=12543 (+24)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  cores=1832  sweep=347.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T11:30:13Z  ATTN  records=12564 (+21)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.9m  drift=0  sci=OK  r115=22B  sweep=207.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T11:37:15Z  ATTN  records=12578 (+14)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=391.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
