...
**Auto-generated 2026-08-05 23:58 UTC -- T+194h49m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+194h49m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **751** (73 running, 678 queued) |
| **cores computing** | **584** |
...
```
generated 2026-08-05 23:58 UTC | elapsed 8.12 d | 21.0 d to the Aug-27 stop
test tier: 16,879 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         120       5  GATED             GATED             barrier
      100       2,805     119  GATED             GATED             barrier>=30
      189       6,386     236  GATED             GATED             barrier>=30
      279      10,436     236  GATED             GATED             barrier>=30
      340      13,181     236  GATED             GATED             barrier>=30
      403      16,016     236  GATED             GATED             barrier>=30
      568      23,449     236  GATED             GATED             barrier>=30
