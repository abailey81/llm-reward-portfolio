...
**Auto-generated 2026-08-06 11:02 UTC -- T+205h53m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+205h53m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **856** |
| **cores doing RUNG-RAISING work** | **21.4%** -- 192 of 896 cores (12 min old) |
...
```
generated 2026-08-06 11:02 UTC | elapsed 8.58 d | 20.5 d to the Aug-27 stop
test tier: 17,584 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,689      54  GATED             GATED             barrier>=30
      279       9,731      60  GATED             GATED             barrier>=30
      340      12,476      60  GATED             GATED             barrier>=30
      403      15,311      60  GATED             GATED             barrier>=30
      568      22,744      60  GATED             GATED             barrier>=30
