...
**Auto-generated 2026-08-02 12:43 UTC -- T+111h34m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+111h34m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **966** (225 running, 741 queued) |
...
```
 rung             @1800 cores              @830 cores   binding
  ...
  340            5.1 d  08-03           11.1 d  08-09   throughput
...
|---|---|---|
| distributional | g5 of 5 | 1043 |
| scalar | g5 of 5 | 452 |
| placebo | g5 of 5 | 682 |
| scalar_cvar5 | g5 of 5 | 638 |
| placebo_shuffled | g5 of 5 | 622 |
...
2026-08-02T12:38:04Z  RED  records=3801 (+3)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.5m  drift=0+1dirty  sci=OK  r115=21B  sweep=23.3s  auto-cycle
2026-08-02T12:38:58Z  RED  records=3805 (+4)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=4.4m  drift=1  sci=OK  r115=21B  sweep=24.2s  auto-cycle
2026-08-02T12:39:52Z  RED  records=3811 (+6)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=1  sci=OK  r115=21B  cores=1808  sweep=57.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T12:41:20Z  RED  records=3816 (+5)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=1  sci=OK  r115=21B  sweep=25.0s  auto-cycle
2026-08-02T12:42:15Z  RED  records=3819 (+3)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=1  sci=OK  r115=21B  sweep=24.5s  auto-cycle
```
