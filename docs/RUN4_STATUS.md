...
**Auto-generated 2026-08-03 09:38 UTC -- T+132h29m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+132h29m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **837** (216 running, 621 queued) |
...
```
 rung             @1728 cores              @830 cores   binding
  ...
  340            5.3 d  08-03           11.1 d  08-09   throughput
  403            6.3 d  08-04           13.0 d  08-10   throughput
  568            8.7 d  08-06           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 1935 |
| scalar | g5 of 5 | 1351 |
| placebo | g5 of 5 | 1462 |
| scalar_cvar5 | g5 of 5 | 1439 |
| placebo_shuffled | g5 of 5 | 1452 |
...
```
2026-08-03T09:26:55Z  RED  records=7963 (+16)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=21B  sweep=98.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T09:29:04Z  RED  records=7976 (+13)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.1m  drift=0  sci=OK  r115=21B  sweep=147.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T09:32:02Z  RED  records=7996 (+20)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=3.2m  drift=0  sci=OK  r115=21B  sweep=76.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T09:33:49Z  RED  records=8007 (+11)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=1.8m  drift=0  sci=OK  r115=21B  sweep=76.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T09:35:35Z  RED  records=8018 (+11)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=21B  sweep=73.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T09:37:19Z  RED  records=8030 (+12)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.1m  drift=0  sci=OK  r115=21B  sweep=72.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
