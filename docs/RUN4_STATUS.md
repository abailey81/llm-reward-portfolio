...
**Auto-generated 2026-08-05 13:50 UTC -- T+184h41m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+184h41m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 3.0 h ago; none live, newest failure 46 min ago** |
...
| | |
|---|---|
| cluster jobs | **959** (192 running, 767 queued) |
...
```
generated 2026-08-05 13:50 UTC | elapsed 7.70 d | 21.4 d to the Aug-27 stop
test tier: 15,160 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      90 records      90.0 rec/h
    last  3 h     272 records      90.7 rec/h
    last 12 h    1591 records     132.6 rec/h
    last 24 h    3755 records     156.5 rec/h
    12 h rate is 73% from ONE line (test_leg_haiku_4_5); 5 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 2% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,768      90  GATED             GATED             barrier>=30
      403      16,918      90  GATED             GATED             barrier>=30
      568      25,168      90  GATED             GATED             barrier>=30
...
```
2026-08-05T13:31:13Z  OK  records=16668 (+8)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=166.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T13:34:06Z  OK  records=16670 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.8m  drift=0  sci=OK  r115=22B  sweep=143.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T13:37:43Z  OK  records=16673 (+3)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.1m  drift=0  sci=OK  r115=22B  sweep=186.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T13:42:56Z  OK  records=16685 (+12)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.2m  drift=0  sci=OK  r115=22B  sweep=282.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T13:45:05Z  OK  records=16687 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  sweep=99.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T13:48:25Z  OK  records=16697 (+10)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.1m  drift=0  sci=OK  r115=22B  cores=1544  sweep=169.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
