...
**Auto-generated 2026-08-01 17:19 UTC -- T+92h10m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+92h10m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| scalar | g5 of 5 | 326 |
| placebo | g5 of 5 | 373 |
| scalar_cvar5 | g5 of 5 | 326 |
| placebo_shuffled | g5 of 5 | 287 |
...
```
2026-08-01T17:17:17Z  RED  records=2606 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=19B  sweep=17.6s  auto-cycle
2026-08-01T17:17:17Z  RED  records=2606 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=19B  cores=800  sweep=18.8s  auto-cycle
2026-08-01T17:18:06Z  RED  records=2606 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=19B  sweep=17.3s  auto-cycle
2026-08-01T17:18:05Z  RED  records=2606 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=19B  sweep=18.5s  auto-cycle
2026-08-01T17:18:54Z  RED  records=2606 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=19B  sweep=17.7s  auto-cycle
2026-08-01T17:18:54Z  RED  records=2606 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=19B  sweep=17.7s  auto-cycle
```
