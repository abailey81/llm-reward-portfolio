...
**Auto-generated 2026-08-04 23:39 UTC -- T+170h30m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+170h30m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 70 min ago; LIVE, still failing** |
...
| | |
|---|---|
| cluster jobs | **979** (157 running, 820 queued) |
...
```
generated 2026-08-04 23:40 UTC | elapsed 7.11 d | 22.0 d to the Aug-27 stop
test tier: 13,310 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     202 records     202.0 rec/h
    last  3 h     537 records     179.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      27,018     202  GATED             GATED             barrier>=30
