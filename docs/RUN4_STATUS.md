...
**Auto-generated 2026-08-06 07:45 UTC -- T+202h36m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+202h36m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **931** (111 running, 820 queued) |
| **cores computing** | **888** |
...
```
generated 2026-08-06 07:46 UTC | elapsed 8.44 d | 20.7 d to the Aug-27 stop
test tier: 17,360 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    3079 records     128.3 rec/h   usable
    12 h rate is 50% from ONE line (test_leg_kimi_k3); 4 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 19% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_haiku_4_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,907       1  GATED             GATED             barrier>=30
      279       9,955       1  GATED             GATED             barrier>=30
      340      12,700       1  GATED             GATED             barrier>=30
      403      15,535       1  GATED             GATED             barrier>=30
      568      22,968       1  GATED             GATED             barrier>=30
...
```
2026-08-06T07:20:31Z  OK  records=18902 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  cores=888  sweep=36.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T07:21:29Z  OK  records=18902 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=27.3s  auto-cycle
2026-08-06T07:22:28Z  OK  records=18902 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.0m  drift=0  sci=OK  r115=22B  sweep=28.6s  auto-cycle
