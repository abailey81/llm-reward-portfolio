...
**Auto-generated 2026-08-03 08:01 UTC -- T+130h52m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+130h52m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **919** (282 running, 637 queued) |
| **cores computing** | **2256** |

Per-rung ETAs from the registered model at the cores we actually hold:

```
 rung             @2256 cores              @830 cores   binding
...
|---|---|---|
| distributional | g5 of 5 | 1803 |
| scalar | g5 of 5 | 1218 |
| placebo | g5 of 5 | 1338 |
| scalar_cvar5 | g5 of 5 | 1309 |
| placebo_shuffled | g5 of 5 | 1315 |
...
```
2026-08-03T07:50:09Z  RED  records=7327 (+5)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=21B  sweep=59.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T07:51:38Z  RED  records=7335 (+8)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0  sci=OK  r115=21B  cores=2288  sweep=110.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T07:53:59Z  RED  records=7350 (+15)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=21B  sweep=62.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T07:55:32Z  RED  records=7361 (+11)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=21B  sweep=134.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T07:58:17Z  RED  records=7363 (+2)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=21B  sweep=67.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
