...
**Auto-generated 2026-08-06 05:34 UTC -- T+200h25m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h25m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,570      17  GATED             GATED             barrier>=30
      189       6,042     109  GATED             GATED             barrier>=30
      279      10,090     109  GATED             GATED             barrier>=30
      340      12,835     109  GATED             GATED             barrier>=30
      403      15,670     109  GATED             GATED             barrier>=30
      568      23,103     109  GATED             GATED             barrier>=30
