...
| transport health | **timeouts 6h=156; worst streak 11/240 (4.6% to fatal), pull on core, 55 min ago; none live, newest failure 52 min ago** |
...
| | |
|---|---|
| cluster jobs | **844** (68 running, 776 queued) |
| **cores computing** | **544** |
| **cores doing RUNG-RAISING work** | **28.3%** -- 136 of 480 cores (11 min old) |
