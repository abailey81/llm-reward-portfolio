...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 45 min ago; none live, newest failure 45 min ago** |
...
| | |
|---|---|
| cluster jobs | **861** (67 running, 794 queued) |
| **cores computing** | **536** |
| **cores doing RUNG-RAISING work** | **22.6%** -- 184 of 816 cores (155 min old **STALE**) |
...
```
generated 2026-08-06 15:19 UTC | elapsed 8.76 d | 20.4 d to the Aug-27 stop
