...
**Auto-generated 2026-08-05 13:33 UTC -- T+184h24m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+184h24m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 2.7 h ago; none live, newest failure 29 min ago** |
...
| | |
|---|---|
| cluster jobs | **963** (194 running, 769 queued) |
...
```
generated 2026-08-05 13:34 UTC | elapsed 7.68 d | 21.4 d to the Aug-27 stop
test tier: 15,127 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      73 records      73.0 rec/h
    last  3 h     271 records      90.3 rec/h
    last 12 h    1584 records     132.0 rec/h
    last 24 h    3766 records     156.9 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,801      73  GATED             GATED             barrier>=30
      403      16,951      73  GATED             GATED             barrier>=30
      568      25,201      73  GATED             GATED             barrier>=30
