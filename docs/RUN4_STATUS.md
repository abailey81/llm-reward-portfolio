...
**Auto-generated 2026-08-06 01:33 UTC -- T+196h24m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+196h24m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 89 min ago; none live, newest failure 89 min ago** |
...
```
generated 2026-08-06 01:33 UTC | elapsed 8.18 d | 20.9 d to the Aug-27 stop
test tier: 17,013 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      29 records      29.0 rec/h
    last  3 h     436 records     145.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,690      28  GATED             GATED             barrier>=30
      189       6,254      29  GATED             GATED             barrier>=30
      279      10,302      29  GATED             GATED             barrier>=30
      340      13,047      29  GATED             GATED             barrier>=30
      403      15,882      29  GATED             GATED             barrier>=30
      568      23,315      29  GATED             GATED             barrier>=30
