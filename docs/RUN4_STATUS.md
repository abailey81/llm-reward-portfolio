...
**Auto-generated 2026-08-02 12:04 UTC -- T+110h55m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+110h55m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **991** (218 running, 773 queued) |
| **cores computing** | **1737** |

Per-rung ETAs from the registered model at the cores we actually hold:

```
 rung             @1737 cores              @830 cores   binding
...
|---|---|---|
| distributional | g5 of 5 | 1000 |
| scalar | g5 of 5 | 410 |
| placebo | g5 of 5 | 641 |
| scalar_cvar5 | g5 of 5 | 594 |
| placebo_shuffled | g5 of 5 | 581 |
...
```
2026-08-02T11:59:50Z  RED  records=3587 (+6)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=21B  sweep=25.8s  auto-cycle
2026-08-02T12:00:46Z  RED  records=3590 (+3)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=21B  sweep=21.2s  auto-cycle
2026-08-02T12:01:38Z  RED  records=3593 (+3)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=21B  sweep=22.8s  auto-cycle
2026-08-02T12:02:31Z  RED  records=3604 (+11)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.4m  drift=0  sci=OK  r115=21B  sweep=24.3s  auto-cycle
2026-08-02T12:03:25Z  RED  records=3605 (+1)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=4.3m  drift=0  sci=OK  r115=21B  sweep=24.5s  auto-cycle
