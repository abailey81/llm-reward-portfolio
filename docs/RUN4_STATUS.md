...
```
generated 2026-08-06 07:22 UTC | elapsed 8.43 d | 20.7 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     249 records      83.0 rec/h
    last 12 h    1179 records      98.2 rec/h
    last 24 h    3198 records     133.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,908      30  GATED             GATED             barrier>=30
      279       9,956      30  GATED             GATED             barrier>=30
      340      12,701      30  GATED             GATED             barrier>=30
      403      15,536      30  GATED             GATED             barrier>=30
      568      22,969      30  GATED             GATED             barrier>=30
