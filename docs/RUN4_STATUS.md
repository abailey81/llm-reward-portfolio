...
**Auto-generated 2026-08-13 02:33 UTC -- T+365h24m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+365h24m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 0/240 (0.0% to fatal), - on -, age UNKNOWN; none live, newest failure 32.9 h ago** |
...
| | |
|---|---|
| cluster jobs | **316** = 63 running + **187 ELIGIBLE** + 66 held by us + 0 held only by the site |
...
| **cores computing** | **504** |
| **cores doing RUNG-RAISING work** | **27.5%** -- 112 of 408 cores (59 min old) |
...
```
generated 2026-08-13 02:34 UTC | elapsed 15.23 d | 13.9 d to the Aug-27 stop
test tier: 31,538 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 17.0 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    last  1 h       2 records       2.0 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last  3 h       2 records       0.7 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last 12 h     204 records      17.0 rec/h   usable
    last 24 h    1364 records      56.8 rec/h   usable
    12 h rate is 75% from ONE line (test); 4 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (17 rec/h); latest excludes cells already within
    8 of the ceiling (17 rec/h). Window 12 h.
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340         422       2  2026-08-14 03:23  2026-08-14 03:23  yes
      403       2,443       2  2026-08-19 02:16  2026-08-19 02:16  yes
      568       8,790       2  2026-09-03 15:37  2026-09-03 15:37  NO
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung      @504 cores      @830 cores   binding
       30           4.6 d           4.6 d   critical_chain
      100           6.3 d           4.6 d   critical_chain
      189          10.8 d           6.5 d   throughput
      279          15.3 d           9.3 d   throughput
      340          18.3 d          11.1 d   throughput
      403          21.5 d          13.0 d   throughput
      568          29.8 d          18.1 d   throughput
...
```
2026-08-13T01:50:36Z  OK  records=33079 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=0.2m  drift=0  sci=BLIND(deep_audit)  r115=22B  sweep=58.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-13T01:52:03Z  OK  records=33079 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.5m  drift=0  sci=BLIND(deep_audit)  r115=22B  sweep=57.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-13T02:15:10Z  ATTN  records=33079 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.3m  drift=0  sci=BLIND(deep_audit)  r115=22B  sweep=1356.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-13T02:30:24Z  OK  records=33079 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=BLIND(deep_audit)  r115=22B  cores=504  sweep=883.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-13T02:31:55Z  OK  records=33079 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.4m  drift=0  sci=BLIND(deep_audit)  r115=22B  sweep=61.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
