...
**Auto-generated 2026-08-06 11:42 UTC -- T+206h33m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+206h33m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **848** |
| **cores doing RUNG-RAISING work** | **22.6%** -- 192 of 848 cores (20 min old) |
...
```
generated 2026-08-06 11:43 UTC | elapsed 8.61 d | 20.5 d to the Aug-27 stop
test tier: 17,599 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,689      23  GATED             GATED             barrier>=30
      279       9,716      44  GATED             GATED             barrier>=30
      340      12,461      44  GATED             GATED             barrier>=30
      403      15,296      44  GATED             GATED             barrier>=30
      568      22,729      44  GATED             GATED             barrier>=30
    ...
    !! 81% of the rung-568 backlog (18,420 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
...
2026-08-06T11:14:57Z  OK  records=19134 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  sweep=27.8s  auto-cycle
2026-08-06T11:26:34Z  OK  records=19136 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.9m  drift=0  sci=OK  r115=22B  sweep=667.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T11:37:11Z  OK  records=19139 (+3)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.9m  drift=0  sci=OK  r115=22B  cores=848  sweep=607.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
