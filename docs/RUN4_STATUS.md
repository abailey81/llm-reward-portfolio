...
**Auto-generated 2026-08-06 19:14 UTC -- T+214h05m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+214h05m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **672** |
| **cores doing RUNG-RAISING work** | **31.8%** -- 216 of 680 cores (20 min old) |
...
test tier: 18,386 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,674      23  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,509      23  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,942      23  GATED             GATED             no-records:test/distributional,test/scalar>=30
