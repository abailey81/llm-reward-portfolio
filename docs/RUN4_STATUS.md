...
**Auto-generated 2026-08-07 00:17 UTC -- T+219h08m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+219h08m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **832** = 108 running + **178 ELIGIBLE** + 546 held by us + 0 held only by the site |
...
| **cores computing** | **864** |
| **cores doing RUNG-RAISING work** | **33.6%** -- 288 of 856 cores (37 min old) |
...
```
generated 2026-08-07 00:17 UTC | elapsed 9.13 d | 20.0 d to the Aug-27 stop
...
```
2026-08-06T23:46:02Z  OK  records=19970 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.1m  drift=0  sci=OK  r115=22B  sweep=29.2s  auto-cycle
