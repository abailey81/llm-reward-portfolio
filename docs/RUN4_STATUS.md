...
**Auto-generated 2026-08-05 05:37 UTC -- T+176h28m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+176h28m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 35 min ago; none live, newest failure 35 min ago** |
...
| | |
|---|---|
| cluster jobs | **980** (203 running, 777 queued) |
| **cores computing** | **1624** |
...
```
generated 2026-08-05 05:37 UTC | elapsed 7.35 d | 21.8 d to the Aug-27 stop
test tier: 13,741 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     131 records     131.0 rec/h
    last  3 h     149 records      49.7 rec/h
    last 12 h    1625 records     135.4 rec/h
    last 24 h    3909 records     162.9 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,238      80  GATED             GATED             barrier>=30
      189       7,637     131  GATED             GATED             barrier>=30
      279      12,137     131  GATED             GATED             barrier>=30
      340      15,187     131  GATED             GATED             barrier>=30
      403      18,337     131  GATED             GATED             barrier>=30
      568      26,587     131  GATED             GATED             barrier>=30
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung     @1624 cores      @830 cores   binding
