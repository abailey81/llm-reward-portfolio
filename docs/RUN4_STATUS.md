...
**Auto-generated 2026-08-05 11:06 UTC -- T+181h57m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+181h57m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 3.8 h ago; none live, newest failure 17 min ago** |
...
| | |
|---|---|
| cluster jobs | **994** (168 running, 826 queued) |
...
```
generated 2026-08-05 11:07 UTC | elapsed 7.58 d | 21.5 d to the Aug-27 stop
test tier: 14,913 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     157 records     157.0 rec/h
    last  3 h     546 records     182.0 rec/h
    last 12 h    1702 records     141.8 rec/h
    last 24 h    3950 records     164.6 rec/h
    12 h rate is 53% from ONE line (test_leg_haiku_4_5); 5 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 22% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         180      33  GATED             GATED             barrier
      100       2,980      33  GATED             GATED             barrier>=30
      189       6,842      59  GATED             GATED             barrier>=30
      279      10,965     157  GATED             GATED             barrier>=30
      340      14,015     157  GATED             GATED             barrier>=30
      403      17,165     157  GATED             GATED             barrier>=30
      568      25,415     157  GATED             GATED             barrier>=30
...
```
2026-08-05T10:46:10Z  OK  records=16422 (+10)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  sweep=104.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T10:49:30Z  OK  records=16426 (+4)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=169.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T10:51:41Z  OK  records=16431 (+5)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.9m  drift=0  sci=OK  r115=22B  sweep=101.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
