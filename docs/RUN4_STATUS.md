...
**Auto-generated 2026-08-04 18:57 UTC -- T+165h48m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+165h48m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-04 18:57 UTC | elapsed 6.91 d | 22.2 d to the Aug-27 stop
test tier: 12,395 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     182 records     182.0 rec/h
    last  3 h     590 records     196.7 rec/h
    last 12 h    2401 records     200.1 rec/h
    last 24 h    4288 records     178.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,852      52  GATED             GATED             barrier>=30
      189       8,302      52  GATED             GATED             barrier>=30
      279      12,802      52  GATED             GATED             barrier>=30
      340      15,852      52  GATED             GATED             barrier>=30
      403      19,002      52  GATED             GATED             barrier>=30
      568      27,933     182  GATED             GATED             barrier>=30
