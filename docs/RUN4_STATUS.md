...
**Auto-generated 2026-08-02 13:44 UTC -- T+112h35m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+112h35m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **936** (228 running, 708 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1084 |
| scalar | g5 of 5 | 488 |
| placebo | g5 of 5 | 718 |
| scalar_cvar5 | g5 of 5 | 678 |
| placebo_shuffled | g5 of 5 | 666 |
...
```
2026-08-02T13:37:35Z  RED  records=4006 (+7)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=21B  sweep=29.4s  auto-cycle
2026-08-02T13:38:34Z  RED  records=4007 (+1)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.5m  drift=0  sci=OK  r115=21B  sweep=29.5s  auto-cycle
2026-08-02T13:39:34Z  RED  records=4010 (+3)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=4.4m  drift=0  sci=OK  r115=21B  cores=1824  sweep=49.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T13:40:53Z  RED  records=4017 (+7)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=6.8m  drift=0  sci=OK  r115=21B  sweep=89.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T13:42:53Z  RED  records=4018 (+1)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=7.8m  drift=0  sci=OK  r115=21B  sweep=29.0s  auto-cycle
2026-08-02T13:43:53Z  RED  records=4020 (+2)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=8.7m  drift=0  sci=OK  r115=21B  sweep=26.2s  auto-cycle
```
