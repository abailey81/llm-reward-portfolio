...
**Auto-generated 2026-08-04 22:58 UTC -- T+169h49m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+169h49m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 28 min ago; none live, newest failure 28 min ago** |
...
```
generated 2026-08-04 22:58 UTC | elapsed 7.08 d | 22.0 d to the Aug-27 stop
test tier: 13,171 records over 68 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     151 records     151.0 rec/h
    last  3 h     556 records     185.3 rec/h
    last 12 h    2220 records     185.0 rec/h
    last 24 h    4296 records     179.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (64 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,341      11  GATED             GATED             barrier>=30
      189       7,791      11  GATED             GATED             barrier>=30
      279      12,291      11  GATED             GATED             barrier>=30
      340      15,341      11  GATED             GATED             barrier>=30
      403      18,491      11  GATED             GATED             barrier>=30
      568      27,157     151  GATED             GATED             barrier>=30
