...
**Auto-generated 2026-08-01 16:14 UTC -- T+91h05m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+91h05m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **110** (92 running, 17 queued) |
| **cores computing** | **736** |
...
```
 rung              @736 cores              @830 cores   binding
  ...
  279           10.5 d  08-08            9.3 d  08-07   throughput
  340           12.6 d  08-10           11.1 d  08-09   throughput
  403           14.7 d  08-12           13.0 d  08-10   throughput
  568           20.4 d  08-18           18.1 d  08-15   throughput
```
...
```
2026-08-01T16:11:02Z  RED  records=2575 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=19B  sweep=23.1s  auto-cycle
2026-08-01T16:11:55Z  RED  records=2575 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=19B  sweep=17.5s  auto-cycle
2026-08-01T16:12:43Z  RED  records=2575 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=19B  sweep=26.0s  auto-cycle
2026-08-01T16:13:39Z  RED  records=2576 (+1)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=19B  sweep=17.1s  auto-cycle
2026-08-01T16:14:04Z  RED  records=2576 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=19B  sweep=17.8s  auto-cycle
2026-08-01T16:14:27Z  RED  records=2576 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=19B  sweep=16.3s  auto-cycle
```
