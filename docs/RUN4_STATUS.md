...
**Auto-generated 2026-08-12 04:29 UTC -- T+343h20m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+343h20m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **928** |
| **cores doing RUNG-RAISING work** | **76.4%** -- 672 of 880 cores (56 min old) |
...
```
generated 2026-08-12 04:30 UTC | elapsed 14.31 d | 14.8 d to the Aug-27 stop
test tier: 30,309 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,357       0  GATED             GATED             barrier>=279
      403       3,562       0  GATED             GATED             barrier>=279
      568      10,019      42  GATED             GATED             barrier>=279
...
2026-08-12T04:29:08Z  OK  records=31840 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.3m  drift=0  sci=OK  r115=22B  sweep=1334.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
