...
**Auto-generated 2026-08-06 03:52 UTC -- T+198h43m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+198h43m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 3.8 h ago; none live, newest failure 3.8 h ago** |
...
```
generated 2026-08-06 03:53 UTC | elapsed 8.28 d | 20.8 d to the Aug-27 stop
test tier: 17,082 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h       4 records       4.0 rec/h
    last  3 h      85 records      28.3 rec/h
    last 12 h    1506 records     125.5 rec/h
    last 24 h    3478 records     144.9 rec/h
    12 h rate is 56% from ONE line (test_leg_haiku_4_5); 4 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 56% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_haiku_4_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,621       4  GATED             GATED             barrier>=30
      189       6,185       4  GATED             GATED             barrier>=30
      279      10,233       4  GATED             GATED             barrier>=30
      340      12,978       4  GATED             GATED             barrier>=30
      403      15,813       4  GATED             GATED             barrier>=30
      568      23,246       4  GATED             GATED             barrier>=30
...
```
2026-08-06T03:32:42Z  OK  records=18622 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.0m  drift=0  sci=OK  r115=22B  sweep=27.3s  auto-cycle
2026-08-06T03:38:06Z  OK  records=18622 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.9m  drift=0  sci=OK  r115=22B  sweep=294.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T03:39:05Z  OK  records=18622 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.9m  drift=0  sci=OK  r115=22B  sweep=29.1s  auto-cycle
