...
**Auto-generated 2026-08-05 14:15 UTC -- T+185h07m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+185h07m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **16801** |
| **Myriad maintenance** | **2026-08-12 from 08:00 UTC, at risk all day** (in 6.7 days). Delayed from Aug 11. Jobs may die and REQUEUE idempotently; the supervisors ride it. Playbook: docs/ops/MAINTENANCE_2026-08-12.md |
| LLM calls / spend | 2956 / **$45.5021** |
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 3.4 h ago; none live, newest failure 71 min ago** |
...
| | |
|---|---|
| cluster jobs | **951** (184 running, 767 queued) |
...
```
generated 2026-08-05 14:16 UTC | elapsed 7.71 d | 21.4 d to the Aug-27 stop
test tier: 15,262 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     158 records     158.0 rec/h
    last  3 h     329 records     109.7 rec/h
    last 12 h    1674 records     139.5 rec/h
    last 24 h    3770 records     157.1 rec/h
    12 h rate is 75% from ONE line (test_leg_haiku_4_5); 5 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 1% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,666     158  GATED             GATED             barrier>=30
      403      16,816     158  GATED             GATED             barrier>=30
      568      25,066     158  GATED             GATED             barrier>=30
...
2026-08-05T13:56:42Z  OK  records=16709 (+12)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=466.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T14:00:33Z  OK  records=16739 (+30)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.6m  drift=0  sci=OK  r115=22B  sweep=201.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T14:06:43Z  OK  records=16767 (+28)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.9m  drift=0  sci=OK  r115=22B  sweep=340.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T14:09:59Z  OK  records=16779 (+12)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.0m  drift=0  sci=OK  r115=22B  cores=1504  sweep=165.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T14:16:27Z  OK  records=16801 (+22)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.8m  drift=0  sci=OK  r115=22B  sweep=358.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
