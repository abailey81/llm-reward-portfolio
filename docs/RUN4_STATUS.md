...
**Auto-generated 2026-08-01 17:40 UTC -- T+92h31m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+92h31m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **142** (102 running, 40 queued) |
| **cores computing** | **809** |

Per-rung ETAs from the registered model at the cores we actually hold:

```
 rung              @809 cores              @830 cores   binding
  ...
  568           18.5 d  08-16           18.1 d  08-15   throughput
```
...
```
2026-08-01T17:39:07Z  RED  records=2606 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=19B  sweep=17.1s  auto-cycle
2026-08-01T17:39:07Z  RED  records=2606 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=19B  sweep=17.1s  auto-cycle
2026-08-01T17:39:54Z  RED  records=2606 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=19B  sweep=18.0s  auto-cycle
2026-08-01T17:39:54Z  RED  records=2606 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=19B  sweep=18.1s  auto-cycle
2026-08-01T17:40:43Z  RED  records=2606 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=19B  sweep=13.7s  auto-cycle
2026-08-01T17:40:43Z  RED  records=2606 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=19B  sweep=13.7s  auto-cycle
```
