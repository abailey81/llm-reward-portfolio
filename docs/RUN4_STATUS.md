...
**Auto-generated 2026-08-05 09:01 UTC -- T+179h52m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+179h52m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **875** (189 running, 686 queued) |
...
```
generated 2026-08-05 09:01 UTC | elapsed 7.50 d | 21.6 d to the Aug-27 stop
test tier: 14,615 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,057     156  GATED             GATED             barrier>=30
      189       7,028     190  GATED             GATED             barrier>=30
      279      11,263     269  GATED             GATED             barrier>=30
      340      14,313     269  GATED             GATED             barrier>=30
      403      17,463     269  GATED             GATED             barrier>=30
      568      25,713     269  GATED             GATED             barrier>=30
