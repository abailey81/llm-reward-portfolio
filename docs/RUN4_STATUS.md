...
**Auto-generated 2026-08-04 18:13 UTC -- T+165h04m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+165h04m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 21/240 (8.8% to fatal), pull on core, 5.7 h ago; none live, newest failure 2.4 h ago** |
...
| | |
|---|---|
| cluster jobs | **188** (186 running, 0 queued) |
...
```
generated 2026-08-04 18:14 UTC | elapsed 6.88 d | 22.2 d to the Aug-27 stop
test tier: 12,258 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     254 records     254.0 rec/h
    last  3 h     575 records     191.7 rec/h
    last 12 h    2343 records     195.2 rec/h
    last 24 h    4190 records     174.6 rec/h
    12 h rate is 100% from ONE line (test_leg_sonnet_5); 3 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (195 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,901       3  GATED             GATED             barrier>=30
      189       8,351       3  GATED             GATED             barrier>=30
      279      12,851       3  GATED             GATED             barrier>=30
      340      15,901       3  GATED             GATED             barrier>=30
      403      19,051       3  GATED             GATED             barrier>=30
      568      28,070     254  GATED             GATED             barrier>=30
    ...
    !! 93% of the rung-568 backlog (26,184 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
...
```
2026-08-04T17:49:14Z  OK  records=13695 (+25)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  sweep=145.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T17:53:23Z  OK  records=13714 (+19)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.1m  drift=0  sci=OK  r115=22B  sweep=219.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T17:58:50Z  OK  records=13747 (+33)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.3m  drift=0  sci=OK  r115=22B  sweep=297.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
