...
**Auto-generated 2026-08-04 22:28 UTC -- T+169h19m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+169h19m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 0/240 (0.0% to fatal), - on -, age UNKNOWN; none live, newest failure 6.7 h ago** |
...
| | |
|---|---|
| cluster jobs | **978** (161 running, 815 queued) |
| **cores computing** | **1288** |
...
```
generated 2026-08-04 22:29 UTC | elapsed 7.06 d | 22.1 d to the Aug-27 stop
test tier: 13,076 records over 68 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      94 records      94.0 rec/h
    last  3 h     563 records     187.7 rec/h
    last 12 h    2184 records     182.0 rec/h
    last 24 h    4319 records     180.0 rec/h
    12 h rate is 69% from ONE line (test_leg_sonnet_5); 10 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (182 rec/h); latest excludes cells already within
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,343      30  GATED             GATED             barrier>=30
      189       7,793      30  GATED             GATED             barrier>=30
      279      12,293      30  GATED             GATED             barrier>=30
      340      15,343      30  GATED             GATED             barrier>=30
      403      18,493      30  GATED             GATED             barrier>=30
      568      27,252      94  GATED             GATED             barrier>=30
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung     @1288 cores      @830 cores   binding
      ...
      403           8.4 d          13.0 d   throughput
      568          11.6 d          18.1 d   throughput
