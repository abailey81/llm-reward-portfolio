...
**Auto-generated 2026-08-06 10:14 UTC -- T+205h05m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+205h05m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **888** |
| **cores doing RUNG-RAISING work** | **20.3%** -- 184 of 904 cores (20 min old) |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,738      97  GATED             GATED             barrier>=30
      279       9,786      97  GATED             GATED             barrier>=30
      340      12,531      97  GATED             GATED             barrier>=30
      403      15,366      97  GATED             GATED             barrier>=30
      568      22,799      97  GATED             GATED             barrier>=30
