...
**Auto-generated 2026-08-05 01:34 UTC -- T+172h25m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+172h25m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 01:34 UTC | elapsed 7.18 d | 21.9 d to the Aug-27 stop
test tier: 13,542 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,334       6  GATED             GATED             barrier>=30
      189       7,784       6  GATED             GATED             barrier>=30
      279      12,284       6  GATED             GATED             barrier>=30
      340      15,334       6  GATED             GATED             barrier>=30
      403      18,484       6  GATED             GATED             barrier>=30
      568      26,786     109  GATED             GATED             barrier>=30
