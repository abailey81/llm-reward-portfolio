...
**Auto-generated 2026-08-06 02:47 UTC -- T+197h38m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+197h38m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 02:47 UTC | elapsed 8.24 d | 20.9 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    1681 records     140.1 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,626      44  GATED             GATED             barrier>=30
      189       6,190      44  GATED             GATED             barrier>=30
      279      10,238      44  GATED             GATED             barrier>=30
      340      12,983      44  GATED             GATED             barrier>=30
      403      15,818      44  GATED             GATED             barrier>=30
      568      23,251      44  GATED             GATED             barrier>=30
