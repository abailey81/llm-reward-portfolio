...
**Auto-generated 2026-08-05 03:04 UTC -- T+173h55m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+173h55m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 4.6 h ago; none live, newest failure 48 min ago** |
...
```
generated 2026-08-05 03:04 UTC | elapsed 7.25 d | 21.9 d to the Aug-27 stop
test tier: 13,597 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      15 records      15.0 rec/h
    last  3 h     229 records      76.3 rec/h
    last 12 h    1940 records     161.7 rec/h
    last 24 h    4092 records     170.5 rec/h
    12 h rate is 38% from ONE line (test_leg_sonnet_5); 10 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (162 rec/h); latest excludes cells already within
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      26,731      15  GATED             GATED             barrier>=30
...
2026-08-05T03:03:16Z  ATTN  records=15140 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=4.1m  drift=0  sci=OK  r115=22B  sweep=227.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
