...
**Auto-generated 2026-08-04 18:23 UTC -- T+165h14m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+165h14m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **179** (177 running, 0 queued) |
...
```
generated 2026-08-04 18:24 UTC | elapsed 6.89 d | 22.2 d to the Aug-27 stop
test tier: 12,297 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,891      13  GATED             GATED             barrier>=30
      189       8,341      13  GATED             GATED             barrier>=30
      279      12,841      13  GATED             GATED             barrier>=30
      340      15,891      13  GATED             GATED             barrier>=30
      403      19,041      13  GATED             GATED             barrier>=30
      568      28,031     264  GATED             GATED             barrier>=30
