...
**Auto-generated 2026-08-06 15:37 UTC -- T+210h29m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 64 min ago; none live, newest failure 64 min ago** |
...
| | |
|---|---|
| cluster jobs | **848** (54 running, 794 queued) |
| **cores computing** | **432** |
| **cores doing RUNG-RAISING work** | **22.6%** -- 184 of 816 cores (174 min old **STALE**) |
...
```
generated 2026-08-06 15:38 UTC | elapsed 8.77 d | 20.3 d to the Aug-27 stop
test tier: 18,054 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,261     270  GATED             GATED             unstarted:2-unit(s)-absent>=30
      340      12,006     270  GATED             GATED             unstarted:2-unit(s)-absent>=30
      403      14,841     270  GATED             GATED             unstarted:2-unit(s)-absent>=30
      568      22,274     270  GATED             GATED             unstarted:2-unit(s)-absent>=30
