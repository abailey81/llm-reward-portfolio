...
**Auto-generated 2026-08-06 06:07 UTC -- T+200h58m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h58m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **940** (76 running, 864 queued) |
| **cores computing** | **608** |
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    1274 records     106.2 rec/h
    last 24 h    3400 records     141.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,968     146  GATED             GATED             barrier>=30
      279      10,016     146  GATED             GATED             barrier>=30
      340      12,761     146  GATED             GATED             barrier>=30
      403      15,596     146  GATED             GATED             barrier>=30
      568      23,029     146  GATED             GATED             barrier>=30
