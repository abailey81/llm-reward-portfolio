...
**Auto-generated 2026-08-11 20:25 UTC -- T+335h16m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+335h16m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **480** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (52 min old) |
...
```
generated 2026-08-11 20:25 UTC | elapsed 13.97 d | 15.1 d to the Aug-27 stop
test tier: 29,906 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 113.8 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h    1365 records     113.8 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,693      90  GATED             GATED             barrier>=279
      403       3,898      90  GATED             GATED             barrier>=279
      568      10,422      90  GATED             GATED             barrier>=279
