...
**Auto-generated 2026-08-06 01:13 UTC -- T+196h04m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+196h04m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 69 min ago; none live, newest failure 69 min ago** |
...
```
generated 2026-08-06 01:13 UTC | elapsed 8.17 d | 20.9 d to the Aug-27 stop
test tier: 17,004 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,699      63  GATED             GATED             barrier>=30
      189       6,263      71  GATED             GATED             barrier>=30
      279      10,311      72  GATED             GATED             barrier>=30
      340      13,056      72  GATED             GATED             barrier>=30
      403      15,891      72  GATED             GATED             barrier>=30
      568      23,324      72  GATED             GATED             barrier>=30
...
2026-08-06T01:13:17Z  OK  records=18544 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  cores=552  sweep=180.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
