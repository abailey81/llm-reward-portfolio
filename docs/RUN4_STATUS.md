...
**Auto-generated 2026-08-03 11:54 UTC -- T+134h45m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+134h45m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **739** (163 running, 576 queued) |
...
```
 rung             @1304 cores              @830 cores   binding
  ...
  340            7.1 d  08-04           11.1 d  08-09   throughput
  403            8.3 d  08-06           13.0 d  08-10   throughput
  568           11.5 d  08-09           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 2075 |
| scalar | g5 of 5 | 1490 |
| placebo | g5 of 5 | 1623 |
...
```
2026-08-03T11:40:28Z  RED  records=8734 (+5)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=21B  sweep=166.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
