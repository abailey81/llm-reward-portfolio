...
**Auto-generated 2026-08-05 04:18 UTC -- T+175h09m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+175h09m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 5.8 h ago; none live, newest failure 2.0 h ago** |
...
| | |
|---|---|
| cluster jobs | **989** (189 running, 800 queued) |
...
```
generated 2026-08-05 04:18 UTC | elapsed 7.30 d | 21.8 d to the Aug-27 stop
test tier: 13,604 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h       2 records       2.0 rec/h
    last  3 h      84 records      28.0 rec/h
    last 12 h    1761 records     146.8 rec/h
    last 24 h    3961 records     165.0 rec/h
    12 h rate is 35% from ONE line (test_leg_qwen3_5_9b); 10 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      26,724       2  GATED             GATED             barrier>=30
...
2026-08-05T04:10:43Z  OK  records=15147 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.2m  drift=0  sci=OK  r115=22B  sweep=278.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T04:15:04Z  OK  records=15147 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.2m  drift=0  sci=OK  r115=22B  sweep=230.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
