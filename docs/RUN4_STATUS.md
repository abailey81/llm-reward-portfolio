...
| **cores computing** | **880** |
| **cores doing RUNG-RAISING work** | **33.6%** -- 288 of 856 cores (68 min old) |
...
test tier: 18,466 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,480      30  GATED             GATED             no-records:test/distributional,test/scalar>=30
      189       5,595      30  GATED             GATED             no-records:test/distributional,test/scalar>=30
      279       9,125      30  GATED             GATED             no-records:test/distributional,test/scalar>=30
      340      11,594      39  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,429      39  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,862      39  GATED             GATED             no-records:test/distributional,test/scalar>=30
