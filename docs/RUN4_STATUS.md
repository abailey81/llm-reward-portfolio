...
**Auto-generated 2026-08-04 18:40 UTC -- T+165h31m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+165h31m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-04 18:40 UTC | elapsed 6.90 d | 22.2 d to the Aug-27 stop
test tier: 12,345 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,875      29  GATED             GATED             barrier>=30
      189       8,325      29  GATED             GATED             barrier>=30
      279      12,825      29  GATED             GATED             barrier>=30
      340      15,875      29  GATED             GATED             barrier>=30
      403      19,025      29  GATED             GATED             barrier>=30
      568      27,983     225  GATED             GATED             barrier>=30
