...
**Auto-generated 2026-08-06 05:41 UTC -- T+200h32m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h32m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
test tier: 17,242 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     120 records     120.0 rec/h
    last  3 h     166 records      55.3 rec/h
    last 12 h    1309 records     109.1 rec/h
    last 24 h    3470 records     144.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,025     120  GATED             GATED             barrier>=30
      279      10,073     120  GATED             GATED             barrier>=30
      340      12,818     120  GATED             GATED             barrier>=30
      403      15,653     120  GATED             GATED             barrier>=30
      568      23,086     120  GATED             GATED             barrier>=30
