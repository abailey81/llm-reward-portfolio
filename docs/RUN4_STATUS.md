...
**Auto-generated 2026-08-06 01:31 UTC -- T+196h22m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+196h22m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 87 min ago; none live, newest failure 87 min ago** |
...
```
generated 2026-08-06 01:31 UTC | elapsed 8.18 d | 20.9 d to the Aug-27 stop
test tier: 17,012 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,691      27  GATED             GATED             barrier>=30
      189       6,255      29  GATED             GATED             barrier>=30
      279      10,303      29  GATED             GATED             barrier>=30
      340      13,048      29  GATED             GATED             barrier>=30
      403      15,883      29  GATED             GATED             barrier>=30
      568      23,316      29  GATED             GATED             barrier>=30
...
2026-08-06T01:29:41Z  OK  records=18553 (+6)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.0m  drift=0  sci=OK  r115=22B  sweep=532.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T01:30:41Z  OK  records=18555 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.9m  drift=0  sci=OK  r115=22B  sweep=29.7s  auto-cycle
2026-08-06T01:31:39Z  OK  records=18555 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.9m  drift=0  sci=OK  r115=22B  sweep=28.7s  auto-cycle
```
