...
**Auto-generated 2026-08-05 14:49 UTC -- T+185h40m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+185h40m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 4.0 h ago; none live, newest failure 1.7 h ago** |
...
| | |
|---|---|
| cluster jobs | **932** (181 running, 751 queued) |
...
```
generated 2026-08-05 14:49 UTC | elapsed 7.74 d | 21.4 d to the Aug-27 stop
test tier: 15,401 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     240 records     240.0 rec/h
    last  3 h     398 records     132.7 rec/h
    last 12 h    1805 records     150.4 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,636     131  GATED             GATED             barrier>=30
      403      16,677     240  GATED             GATED             barrier>=30
      568      24,927     240  GATED             GATED             barrier>=30
