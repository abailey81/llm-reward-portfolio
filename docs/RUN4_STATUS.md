...
**Auto-generated 2026-08-06 05:24 UTC -- T+200h15m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h15m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
test tier: 17,190 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,077      79  GATED             GATED             barrier>=30
      279      10,125      79  GATED             GATED             barrier>=30
      340      12,870      79  GATED             GATED             barrier>=30
      403      15,705      79  GATED             GATED             barrier>=30
      568      23,138      79  GATED             GATED             barrier>=30
