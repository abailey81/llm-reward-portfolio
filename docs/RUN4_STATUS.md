...
**Auto-generated 2026-08-01 08:40 UTC -- T+83h31m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+83h31m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **2256** |
| LLM calls / spend | 2793 / **$43.9381** |
...
| | |
|---|---|
| cluster jobs | **126** (120 running, 5 queued) |
| **cores computing** | **960** |
...
|---|---|---|
| distributional | g5 of 5 | 871 |
| scalar | g5 of 5 | 296 |
| placebo | g5 of 5 | 258 |
| scalar_cvar5 | g5 of 5 | 238 |
| placebo_shuffled | g5 of 5 | 201 |
...
```
2026-08-01T08:36:12Z  RED  records=2255 (+1)  spend=$43.8648  guards=2  arms_full=10/10  budget=2  stalest=1.4m  drift=0  sci=OK  r115=14B  cores=968  sweep=20.6s  auto-cycle
2026-08-01T08:37:03Z  RED  records=2256 (+1)  spend=$43.9381  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=14B  sweep=17.8s  auto-cycle
2026-08-01T08:37:51Z  RED  records=2256 (+0)  spend=$43.9381  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=14B  sweep=17.3s  auto-cycle
2026-08-01T08:38:38Z  RED  records=2256 (+0)  spend=$43.9381  guards=2  arms_full=10/10  budget=2  stalest=0.7m  drift=0  sci=OK  r115=14B  sweep=16.3s  auto-cycle
2026-08-01T08:39:25Z  RED  records=2256 (+0)  spend=$43.9381  guards=2  arms_full=10/10  budget=2  stalest=1.5m  drift=0  sci=OK  r115=14B  sweep=15.5s  auto-cycle
2026-08-01T08:40:11Z  RED  records=2256 (+0)  spend=$43.9381  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=14B  sweep=15.7s  auto-cycle
```
...
```
  anthropic   spent $ 35.8803  + still to author $  4.4653  = $ 40.3456   credited $ 28.1500   margin $ -12.1956 (-43%)  over the credit ESTIMATE (owner-watched)
  openrouter  spent $  8.0578  + still to author $  1.4904  = $  9.5482   credited $ 19.3100   margin $  +9.7618 (+51%)  comfortable
```
