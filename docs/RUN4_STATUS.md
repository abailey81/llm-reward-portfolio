...
**Auto-generated 2026-08-04 17:52 UTC -- T+164h43m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+164h43m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 21/240 (8.8% to fatal), pull on core, 5.4 h ago; none live, newest failure 2.1 h ago** |
...
| | |
|---|---|
| cluster jobs | **204** (201 running, 1 queued) |
...
```
generated 2026-08-04 17:52 UTC | elapsed 6.86 d | 22.3 d to the Aug-27 stop
test tier: 12,192 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     272 records     272.0 rec/h
    last  3 h     564 records     188.0 rec/h
    last 12 h    2318 records     193.2 rec/h
    last 24 h    4143 records     172.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (193 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      28,136     272  GATED             GATED             barrier>=30
