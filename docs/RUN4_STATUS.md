...
**Auto-generated 2026-08-11 13:25 UTC -- T+328h16m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+328h16m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on core, 51 min ago; none live, newest failure 51 min ago** |
...
| | |
|---|---|
| cluster jobs | **532** = 122 running + **82 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **976** |
| **cores doing RUNG-RAISING work** | **77.9%** -- 816 of 1048 cores (112 min old **STALE**) |
...
```
generated 2026-08-11 13:26 UTC | elapsed 13.68 d | 15.4 d to the Aug-27 stop
test tier: 29,062 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    12 h rate is 82% from ONE line (test); 2 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279         402     113  2026-08-11 16:53  2026-08-11 16:53  yes
      340       2,537     113  2026-08-12 11:16  2026-08-12 11:16  yes
      403       4,742     113  2026-08-13 06:15  2026-08-13 06:15  yes
      568      11,266     113  2026-08-15 14:24  2026-08-15 14:24  yes
...
> **What is holding it right now: test -- baseline_log_growth has 143 HOLE(S) below its frontier 406 -- that is what caps this line**
...
currently at **264 seeds each** (read live from the archive on this publish). !! THE
