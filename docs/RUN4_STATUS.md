...
**Auto-generated 2026-08-06 08:20 UTC -- T+203h11m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+203h11m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **992** |
| **cores doing RUNG-RAISING work** | **20.3%** -- 200 of 984 cores (2 min old) |
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    2924 records     121.8 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,901       7  GATED             GATED             barrier>=30
      279       9,949       7  GATED             GATED             barrier>=30
      340      12,694       7  GATED             GATED             barrier>=30
      403      15,529       7  GATED             GATED             barrier>=30
      568      22,962       7  GATED             GATED             barrier>=30
