...
**Auto-generated 2026-08-11 18:28 UTC -- T+333h19m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+333h19m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on core, 5.9 h ago; none live, newest failure 49 min ago** |
...
| | |
|---|---|
| cluster jobs | **447** = 67 running + **52 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **536** |
| **cores doing RUNG-RAISING work** | **4.8%** -- 24 of 504 cores (56 min old) |
...
```
generated 2026-08-11 18:29 UTC | elapsed 13.89 d | 15.2 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,830     101  GATED             GATED             barrier>=279
      403       4,035     101  GATED             GATED             barrier>=279
      568      10,559     101  GATED             GATED             barrier>=279
