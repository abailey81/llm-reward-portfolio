...
**Auto-generated 2026-08-05 01:43 UTC -- T+172h34m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+172h34m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 01:44 UTC | elapsed 7.19 d | 21.9 d to the Aug-27 stop
test tier: 13,556 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     108 records     108.0 rec/h
    last  3 h     435 records     145.0 rec/h
    last 12 h    2168 records     180.7 rec/h
    last 24 h    4244 records     176.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,331       9  GATED             GATED             barrier>=30
      189       7,781       9  GATED             GATED             barrier>=30
      279      12,281       9  GATED             GATED             barrier>=30
      340      15,331       9  GATED             GATED             barrier>=30
      403      18,481       9  GATED             GATED             barrier>=30
      568      26,772     108  GATED             GATED             barrier>=30
