...
**Auto-generated 2026-08-02 23:17 UTC -- T+122h08m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+122h08m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| scalar | g5 of 5 | 631 |
| placebo | g5 of 5 | 859 |
| scalar_cvar5 | g5 of 5 | 822 |
| placebo_shuffled | g5 of 5 | 805 |
...
```
2026-08-02T23:12:13Z  RED  records=4733 (+0)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=4.9m  drift=0  sci=OK  r115=21B  sweep=31.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T23:13:16Z  RED  records=4733 (+0)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=5.9m  drift=0  sci=OK  r115=21B  sweep=32.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T23:14:18Z  RED  records=4733 (+0)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=6.9m  drift=0  sci=OK  r115=21B  sweep=31.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T23:15:20Z  RED  records=4733 (+0)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=8.0m  drift=0  sci=OK  r115=21B  sweep=38.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T23:16:29Z  RED  records=4733 (+0)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=9.2m  drift=0  sci=OK  r115=21B  sweep=39.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T23:17:38Z  RED  records=4733 (+0)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=10.0m  drift=0  sci=OK  r115=21B  sweep=33.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
