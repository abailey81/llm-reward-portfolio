...
**Auto-generated 2026-08-06 18:28 UTC -- T+213h19m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+213h19m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=156; worst streak 11/240 (4.6% to fatal), pull on core, 1.5 h ago; none live, newest failure 90 min ago** |
...
| **cores computing** | **616** |
| **cores doing RUNG-RAISING work** | **28.8%** -- 168 of 584 cores (26 min old) |
...
```
generated 2026-08-06 18:28 UTC | elapsed 8.89 d | 20.2 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,691      45  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,526      45  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,959      45  GATED             GATED             no-records:test/distributional,test/scalar>=30
