...
**Auto-generated 2026-08-05 08:38 UTC -- T+179h29m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+179h29m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 82 min ago; none live, newest failure 82 min ago** |
...
```
generated 2026-08-05 08:39 UTC | elapsed 7.48 d | 21.6 d to the Aug-27 stop
test tier: 14,515 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     268 records     268.0 rec/h
    last  3 h     763 records     254.3 rec/h
    last 12 h    1752 records     146.0 rec/h
    last 24 h    4080 records     170.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,110     122  GATED             GATED             barrier>=30
      189       7,115     122  GATED             GATED             barrier>=30
      279      11,363     268  GATED             GATED             barrier>=30
      340      14,413     268  GATED             GATED             barrier>=30
      403      17,563     268  GATED             GATED             barrier>=30
      568      25,813     268  GATED             GATED             barrier>=30
