...
**Auto-generated 2026-08-05 06:23 UTC -- T+177h14m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+177h14m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 81 min ago; none live, newest failure 81 min ago** |
...
```
generated 2026-08-05 06:24 UTC | elapsed 7.39 d | 21.7 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    1638 records     136.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,238      14  GATED             GATED             barrier>=30
      189       7,439     259  GATED             GATED             barrier>=30
      279      11,939     259  GATED             GATED             barrier>=30
      340      14,989     259  GATED             GATED             barrier>=30
      403      18,139     259  GATED             GATED             barrier>=30
      568      26,389     259  GATED             GATED             barrier>=30
