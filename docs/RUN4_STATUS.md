...
| **cores computing** | **904** |
| **cores doing RUNG-RAISING work** | **21.2%** -- 192 of 904 cores (12 min old) |
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    2691 records     112.1 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,725      43  GATED             GATED             barrier>=30
      279       9,773      43  GATED             GATED             barrier>=30
      340      12,518      43  GATED             GATED             barrier>=30
      403      15,353      43  GATED             GATED             barrier>=30
      568      22,786      43  GATED             GATED             barrier>=30
