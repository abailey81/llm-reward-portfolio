...
**Auto-generated 2026-08-05 11:13 UTC -- T+182h04m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+182h04m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 3.9 h ago; none live, newest failure 23 min ago** |
...
| | |
|---|---|
| cluster jobs | **991** (165 running, 826 queued) |
...
```
generated 2026-08-05 11:13 UTC | elapsed 7.59 d | 21.5 d to the Aug-27 stop
test tier: 14,922 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     140 records     140.0 rec/h
    last  3 h     516 records     172.0 rec/h
    last 12 h    1689 records     140.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         180      20  GATED             GATED             barrier
      100       2,980      20  GATED             GATED             barrier>=30
      189       6,842      39  GATED             GATED             barrier>=30
      279      10,956     140  GATED             GATED             barrier>=30
      340      14,006     140  GATED             GATED             barrier>=30
      403      17,156     140  GATED             GATED             barrier>=30
      568      25,406     140  GATED             GATED             barrier>=30
