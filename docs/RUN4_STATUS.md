...
**Auto-generated 2026-08-06 12:17 UTC -- T+207h08m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+207h08m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,697      25  GATED             GATED             barrier>=30
      340      12,442      25  GATED             GATED             barrier>=30
      403      15,277      25  GATED             GATED             barrier>=30
      568      22,710      25  GATED             GATED             barrier>=30
