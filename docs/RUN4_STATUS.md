...
**Auto-generated 2026-08-11 19:42 UTC -- T+334h33m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+334h33m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **434** = 61 running + **45 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **488** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (9 min old) |
...
```
generated 2026-08-11 19:43 UTC | elapsed 13.94 d | 15.2 d to the Aug-27 stop
test tier: 29,838 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,761      48  GATED             GATED             barrier>=279
      403       3,966      48  GATED             GATED             barrier>=279
      568      10,490      48  GATED             GATED             barrier>=279
