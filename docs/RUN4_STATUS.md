...
**Auto-generated 2026-08-11 18:36 UTC -- T+333h27m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+333h27m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on deepseek-v4-pro, 56 min ago; none live, newest failure 56 min ago** |
...
| **cores computing** | **512** |
| **cores doing RUNG-RAISING work** | **4.8%** -- 24 of 504 cores (63 min old) |
...
```
generated 2026-08-11 18:36 UTC | elapsed 13.89 d | 15.2 d to the Aug-27 stop
test tier: 29,782 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,817     101  GATED             GATED             barrier>=279
      403       4,022     101  GATED             GATED             barrier>=279
      568      10,546     101  GATED             GATED             barrier>=279
