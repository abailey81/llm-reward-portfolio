...
**Auto-generated 2026-08-03 10:35 UTC -- T+133h26m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+133h26m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| stalest driver log | **1 (qwen3_5-9b) min** old (P218: the STALEST of the still-running lines, completed ladders excluded; above ~30 means that line has stopped progressing) |
| records archived | **8428** |
...
| | |
|---|---|
| cluster jobs | **790** (177 running, 613 queued) |
...
```
 rung             @1416 cores              @830 cores   binding
  ...
  279            5.4 d  08-03            9.3 d  08-07   throughput
  340            6.5 d  08-04           11.1 d  08-09   throughput
  403            7.6 d  08-05           13.0 d  08-10   throughput
  568           10.6 d  08-08           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 2011 |
| scalar | g5 of 5 | 1430 |
| placebo | g5 of 5 | 1541 |
| scalar_cvar5 | g5 of 5 | 1516 |
| placebo_shuffled | g5 of 5 | 1531 |
...
```
2026-08-03T10:15:40Z  RED  records=8301 (+32)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=21B  sweep=165.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T10:18:55Z  RED  records=8323 (+22)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=1.6m  drift=0  sci=OK  r115=21B  sweep=114.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T10:21:20Z  RED  records=8341 (+18)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=21B  sweep=138.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T10:24:09Z  RED  records=8358 (+17)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=3.2m  drift=0  sci=OK  r115=21B  sweep=131.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T10:26:51Z  RED  records=8381 (+23)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=None  sweep=486.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T10:28:50Z  RED  records=8381 (+23)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=None  sweep=367.1s  p214-corrected
```
