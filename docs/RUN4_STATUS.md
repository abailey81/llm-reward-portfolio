...
| | |
|---|---|
| cluster jobs | **880** (69 running, 811 queued) |
| **cores computing** | **552** |
...
```
generated 2026-08-06 00:02 UTC | elapsed 8.12 d | 21.0 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    3525 records     146.9 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,373     235  GATED             GATED             barrier>=30
      279      10,423     235  GATED             GATED             barrier>=30
      340      13,168     235  GATED             GATED             barrier>=30
      403      16,003     235  GATED             GATED             barrier>=30
      568      23,436     235  GATED             GATED             barrier>=30
