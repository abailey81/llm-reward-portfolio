...
**Auto-generated 2026-08-04 02:46 UTC -- T+149h37m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+149h37m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-04 02:47 UTC | elapsed 6.23 d | 22.9 d to the Aug-27 stop
test tier: 9,449 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    12 h rate is 100% from ONE line (test_leg_qwen3_5_9b); 1 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         428       0  GATED             GATED             barrier
      100       4,278       0  GATED             GATED             barrier>=30
      189       9,173       0  GATED             GATED             barrier>=30
      279      14,123       0  GATED             GATED             barrier>=30
      340      17,478       0  GATED             GATED             barrier>=30
      403      20,979     119  GATED             GATED             barrier>=30
      568      30,879     127  GATED             GATED             barrier>=30
    ...
    !! 97% of the rung-568 backlog (30,026 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
