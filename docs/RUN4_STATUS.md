...
| | |
|---|---|
| cluster jobs | **949** (69 running, 880 queued) |
| **cores computing** | **552** |
...
```
generated 2026-08-06 05:47 UTC | elapsed 8.36 d | 20.8 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,006     135  GATED             GATED             barrier>=30
      279      10,054     135  GATED             GATED             barrier>=30
      340      12,799     135  GATED             GATED             barrier>=30
      403      15,634     135  GATED             GATED             barrier>=30
      568      23,067     135  GATED             GATED             barrier>=30
