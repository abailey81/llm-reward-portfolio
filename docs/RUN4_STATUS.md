...
**Auto-generated 2026-08-05 05:10 UTC -- T+176h01m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+176h01m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 8 min ago; LIVE, still failing** |
...
| | |
|---|---|
| cluster jobs | **988** (197 running, 791 queued) |
...
```
generated 2026-08-05 05:10 UTC | elapsed 7.33 d | 21.8 d to the Aug-27 stop
test tier: 13,643 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      39 records      39.0 rec/h
    last  3 h      58 records      19.3 rec/h
    last 12 h    1659 records     138.2 rec/h
    last 24 h    3876 records     161.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,285      39  GATED             GATED             barrier>=30
      189       7,735      39  GATED             GATED             barrier>=30
      279      12,235      39  GATED             GATED             barrier>=30
      340      15,285      39  GATED             GATED             barrier>=30
      403      18,435      39  GATED             GATED             barrier>=30
      568      26,685      39  GATED             GATED             barrier>=30
