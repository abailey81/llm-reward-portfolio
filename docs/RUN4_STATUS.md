...
**Auto-generated 2026-08-04 17:24 UTC -- T+164h15m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+164h15m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **215** (213 running, 0 queued) |
...
```
generated 2026-08-04 17:24 UTC | elapsed 6.84 d | 22.3 d to the Aug-27 stop
test tier: 12,030 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     177 records     177.0 rec/h
    last  3 h     508 records     169.3 rec/h
    last 12 h    2237 records     186.4 rec/h
    last 24 h    4023 records     167.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      28,298     177  GATED             GATED             barrier>=30
