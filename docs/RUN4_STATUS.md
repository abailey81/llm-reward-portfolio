...
**Auto-generated 2026-08-05 09:11 UTC -- T+180h02m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+180h02m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 09:11 UTC | elapsed 7.50 d | 21.6 d to the Aug-27 stop
test tier: 14,641 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     247 records     247.0 rec/h
    last  3 h     727 records     242.3 rec/h
    last 12 h    1712 records     142.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,048     152  GATED             GATED             barrier>=30
      189       7,005     200  GATED             GATED             barrier>=30
      279      11,237     247  GATED             GATED             barrier>=30
      340      14,287     247  GATED             GATED             barrier>=30
      403      17,437     247  GATED             GATED             barrier>=30
      568      25,687     247  GATED             GATED             barrier>=30
