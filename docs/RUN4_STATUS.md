...
**Auto-generated 2026-08-06 14:45 UTC -- T+209h36m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+209h36m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 12 min ago; none live, newest failure 11 min ago** |
...
| | |
|---|---|
| cluster jobs | **878** (84 running, 794 queued) |
| **cores computing** | **672** |
| **cores doing RUNG-RAISING work** | **22.6%** -- 184 of 816 cores (121 min old **STALE**) |
...
```
generated 2026-08-06 14:45 UTC | elapsed 8.73 d | 20.4 d to the Aug-27 stop
test tier: 17,802 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30          74      43  GATED             GATED             unstarted:2-unit(s)-absent
      100       2,524      43  GATED             GATED             unstarted:2-unit(s)-absent>=30
      189       5,639      47  GATED             GATED             unstarted:2-unit(s)-absent>=30
      279       9,513     140  GATED             GATED             unstarted:2-unit(s)-absent>=30
      340      12,258     140  GATED             GATED             unstarted:2-unit(s)-absent>=30
      403      15,093     140  GATED             GATED             unstarted:2-unit(s)-absent>=30
      568      22,526     140  GATED             GATED             unstarted:2-unit(s)-absent>=30
...
2026-08-06T14:37:36Z  ATTN  records=19289 (+9)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=0.3m  drift=0  sci=OK  r115=22B  sweep=801.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
