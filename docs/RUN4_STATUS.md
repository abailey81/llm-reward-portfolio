...
**Auto-generated 2026-08-05 19:27 UTC -- T+190h18m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+190h18m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 23 min ago; none live, newest failure 23 min ago** |
...
```
generated 2026-08-05 19:27 UTC | elapsed 7.93 d | 21.2 d to the Aug-27 stop
test tier: 16,183 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      91 records      91.0 rec/h
    last  3 h     505 records     168.3 rec/h
    last 12 h    1992 records     166.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      24,145      91  GATED             GATED             barrier>=30
