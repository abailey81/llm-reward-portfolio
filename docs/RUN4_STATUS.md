...
**Auto-generated 2026-08-11 01:59 UTC -- T+316h50m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+316h50m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **706** = 141 running + **211 ELIGIBLE** + 354 held by us + 0 held only by the site |
...
| **cores doing RUNG-RAISING work** | **100.0%** -- 1120 of 1120 cores (21 min old) |
...
```
generated 2026-08-11 01:59 UTC | elapsed 13.20 d | 15.9 d to the Aug-27 stop
test tier: 27,696 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 82.2 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    last  1 h      56 records      56.0 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last  3 h     254 records      84.7 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last 12 h     986 records      82.2 rec/h   usable
    last 24 h    2368 records      98.7 rec/h   usable
    12 h rate is 32% from ONE line (test_leg_nemotron_3_super); 5 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       1,768      56  2026-08-11 23:30  2026-08-11 23:30  yes
      340       3,903      56  2026-08-13 01:29  2026-08-13 01:29  yes
      403       6,108      56  2026-08-14 04:20  2026-08-14 04:20  yes
      568      12,632      56  2026-08-17 11:44  2026-08-17 11:44  yes
...
```
2026-08-11T01:35:57Z  ATTN  records=29217 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  sweep=61.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T01:37:22Z  ATTN  records=29217 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.0m  drift=0  sci=OK  r115=22B  sweep=55.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T01:39:01Z  ATTN  records=29218 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  cores=1120  sweep=68.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T01:40:23Z  ATTN  records=29219 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  sweep=51.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T01:41:46Z  ATTN  records=29220 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  sweep=52.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T01:57:03Z  ATTN  records=29231 (+11)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=0.6m  drift=0  sci=OK  r115=22B  sweep=886.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
