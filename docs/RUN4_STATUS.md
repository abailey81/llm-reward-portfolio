...
**Auto-generated 2026-08-07 00:18 UTC -- T+219h09m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+219h09m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **832** = 109 running + **177 ELIGIBLE** + 546 held by us + 0 held only by the site |
...
| **cores computing** | **872** |
| **cores doing RUNG-RAISING work** | **33.6%** -- 288 of 856 cores (38 min old) |
...
```
generated 2026-08-07 00:18 UTC | elapsed 9.13 d | 20.0 d to the Aug-27 stop
test tier: 18,430 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,509       1  GATED             GATED             no-records:test/distributional,test/scalar>=30
      189       5,624       1  GATED             GATED             no-records:test/distributional,test/scalar>=30
      279       9,154       1  GATED             GATED             no-records:test/distributional,test/scalar>=30
      340      11,630       3  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,465       3  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,898       3  GATED             GATED             no-records:test/distributional,test/scalar>=30
    GATED = the relevant rate is zero, so no throughput number can date that row -- it is
    waiting on a stage barrier (C1 chain / C3 gate), not on cores.
    !! 79% of the rung-568 backlog (17,284 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
...
```
2026-08-06T23:58:12Z  OK  records=19970 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  sweep=700.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-07T00:03:22Z  OK  records=19970 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.1m  drift=0  sci=OK  r115=22B  sweep=279.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-07T00:15:06Z  OK  records=19972 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.1m  drift=0  sci=OK  r115=22B  cores=848  sweep=673.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-07T00:16:08Z  OK  records=19972 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.9m  drift=0  sci=OK  r115=22B  sweep=32.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-07T00:17:11Z  OK  records=19972 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=32.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-07T00:18:13Z  OK  records=19973 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.2m  drift=0  sci=OK  r115=22B  sweep=31.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
