...
**Auto-generated 2026-08-12 19:25 UTC -- T+358h16m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+358h16m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **208** |
| **cores doing RUNG-RAISING work** | **46.4%** -- 104 of 224 cores (112 min old **STALE**) |
...
```
generated 2026-08-12 19:25 UTC | elapsed 14.93 d | 14.2 d to the Aug-27 stop
test tier: 31,509 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 76.2 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    last  1 h       5 records       5.0 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    ...
    last 12 h     914 records      76.2 rec/h   usable
    last 24 h    1693 records      70.5 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340         451       5  2026-08-13 01:21  2026-08-13 01:21  yes
      403       2,472       5  2026-08-14 03:53  2026-08-14 03:53  yes
      568       8,819       5  2026-08-17 15:13  2026-08-17 15:13  yes
...
> **What is holding it right now: test_leg_deepseek_v4_pro -- distributional has 27 HOLE(S) below its frontier 339 -- that is what caps this line**
