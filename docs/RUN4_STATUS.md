...
**Auto-generated 2026-08-06 02:11 UTC -- T+197h02m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+197h02m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 2.1 h ago; none live, newest failure 2.1 h ago** |
...
| | |
|---|---|
| cluster jobs | **966** (68 running, 898 queued) |
| **cores computing** | **544** |
...
```
generated 2026-08-06 02:12 UTC | elapsed 8.21 d | 20.9 d to the Aug-27 stop
test tier: 17,063 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    !! 65% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_haiku_4_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,640      61  GATED             GATED             barrier>=30
      189       6,204      61  GATED             GATED             barrier>=30
      279      10,252      61  GATED             GATED             barrier>=30
      340      12,997      61  GATED             GATED             barrier>=30
      403      15,832      61  GATED             GATED             barrier>=30
      568      23,265      61  GATED             GATED             barrier>=30
...
```
2026-08-06T01:51:20Z  OK  records=18580 (+6)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.8m  drift=0  sci=OK  r115=22B  sweep=167.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T01:58:23Z  OK  records=18580 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=392.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T02:03:12Z  OK  records=18596 (+16)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  cores=552  sweep=259.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T02:09:59Z  OK  records=18605 (+9)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  cores=544  sweep=376.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T02:10:56Z  OK  records=18605 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.3m  drift=0  sci=OK  r115=22B  sweep=26.5s  auto-cycle
2026-08-06T02:11:58Z  OK  records=18606 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  sweep=32.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
