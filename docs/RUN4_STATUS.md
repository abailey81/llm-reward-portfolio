...
**Auto-generated 2026-08-04 18:58 UTC -- T+165h49m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+165h49m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **166** (164 running, 0 queued) |
...
```
generated 2026-08-04 18:58 UTC | elapsed 6.91 d | 22.2 d to the Aug-27 stop
test tier: 12,403 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     183 records     183.0 rec/h
    last  3 h     598 records     199.3 rec/h
    last 12 h    2401 records     200.1 rec/h
    last 24 h    4294 records     178.9 rec/h
    12 h rate is 98% from ONE line (test_leg_sonnet_5); 2 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 20% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,849      55  GATED             GATED             barrier>=30
      189       8,299      55  GATED             GATED             barrier>=30
      279      12,799      55  GATED             GATED             barrier>=30
      340      15,849      55  GATED             GATED             barrier>=30
      403      18,999      55  GATED             GATED             barrier>=30
      568      27,925     183  GATED             GATED             barrier>=30
