...
**Auto-generated 2026-08-06 06:26 UTC -- T+201h17m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+201h17m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
test tier: 17,340 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,927     142  GATED             GATED             barrier>=30
      279       9,975     142  GATED             GATED             barrier>=30
      340      12,720     142  GATED             GATED             barrier>=30
      403      15,555     142  GATED             GATED             barrier>=30
      568      22,988     142  GATED             GATED             barrier>=30
