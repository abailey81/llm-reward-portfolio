...
**Auto-generated 2026-08-01 16:09 UTC -- T+91h00m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+91h00m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **108** (94 running, 13 queued) |
| **cores computing** | **752** |
...
```
 rung              @752 cores              @830 cores   binding
  ...
  189            7.2 d  08-05            6.5 d  08-04   throughput
  279           10.2 d  08-08            9.3 d  08-07   throughput
  340           12.3 d  08-10           11.1 d  08-09   throughput
  403           14.4 d  08-12           13.0 d  08-10   throughput
  568           20.0 d  08-17           18.1 d  08-15   throughput
```
...
| scalar | g5 of 5 | 326 |
| placebo | g5 of 5 | 354 |
| scalar_cvar5 | g5 of 5 | 313 |
| placebo_shuffled | g5 of 5 | 283 |
...
```
2026-08-01T16:04:49Z  RED  records=2569 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=18B  cores=760  sweep=19.0s  auto-cycle
2026-08-01T16:05:38Z  RED  records=2570 (+1)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=18B  sweep=13.4s  auto-cycle
2026-08-01T16:06:21Z  RED  records=2570 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.1m  drift=0  sci=OK  r115=18B  sweep=16.9s  auto-cycle
2026-08-01T16:07:09Z  RED  records=2570 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=18B  sweep=16.7s  auto-cycle
2026-08-01T16:07:56Z  RED  records=2572 (+2)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=19B  sweep=16.4s  auto-cycle
2026-08-01T16:08:42Z  RED  records=2572 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=19B  sweep=17.1s  auto-cycle
```
