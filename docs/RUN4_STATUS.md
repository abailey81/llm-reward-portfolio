...
**Auto-generated 2026-08-06 00:33 UTC -- T+195h24m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h24m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,718     147  GATED             GATED             barrier>=30
      189       6,284     193  GATED             GATED             barrier>=30
      279      10,332     195  GATED             GATED             barrier>=30
      340      13,077     195  GATED             GATED             barrier>=30
      403      15,912     195  GATED             GATED             barrier>=30
      568      23,345     195  GATED             GATED             barrier>=30
