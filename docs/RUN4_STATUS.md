...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.7 h ago; none live, newest failure 42 min ago** |
...
```
generated 2026-08-06 00:46 UTC | elapsed 8.15 d | 21.0 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,714     116  GATED             GATED             barrier>=30
      189       6,278     151  GATED             GATED             barrier>=30
      279      10,326     153  GATED             GATED             barrier>=30
      340      13,071     153  GATED             GATED             barrier>=30
      403      15,906     153  GATED             GATED             barrier>=30
      568      23,339     153  GATED             GATED             barrier>=30
