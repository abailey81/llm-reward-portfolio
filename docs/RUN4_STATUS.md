...
**Auto-generated 2026-08-06 06:36 UTC -- T+201h27m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+201h27m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 06:36 UTC | elapsed 8.39 d | 20.7 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    1244 records     103.7 rec/h
    last 24 h    3364 records     140.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,910     127  GATED             GATED             barrier>=30
      279       9,958     127  GATED             GATED             barrier>=30
      340      12,703     127  GATED             GATED             barrier>=30
      403      15,538     127  GATED             GATED             barrier>=30
      568      22,971     127  GATED             GATED             barrier>=30
