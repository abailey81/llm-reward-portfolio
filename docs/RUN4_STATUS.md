...
**Auto-generated 2026-08-06 06:06 UTC -- T+200h57m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h57m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    3402 records     141.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,971     144  GATED             GATED             barrier>=30
      279      10,019     144  GATED             GATED             barrier>=30
      340      12,764     144  GATED             GATED             barrier>=30
      403      15,599     144  GATED             GATED             barrier>=30
      568      23,032     144  GATED             GATED             barrier>=30
