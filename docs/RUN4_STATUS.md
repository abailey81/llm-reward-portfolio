...
**Auto-generated 2026-08-06 06:27 UTC -- T+201h18m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+201h18m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **937** (93 running, 844 queued) |
| **cores computing** | **744** |
...
```
generated 2026-08-06 06:27 UTC | elapsed 8.39 d | 20.7 d to the Aug-27 stop
test tier: 17,341 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     143 records     143.0 rec/h
    last  3 h     262 records      87.3 rec/h
    last 12 h    1249 records     104.1 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,926     143  GATED             GATED             barrier>=30
      279       9,974     143  GATED             GATED             barrier>=30
      340      12,719     143  GATED             GATED             barrier>=30
      403      15,554     143  GATED             GATED             barrier>=30
      568      22,987     143  GATED             GATED             barrier>=30
