...
**Auto-generated 2026-08-12 03:25 UTC -- T+342h16m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+342h16m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **491** = 109 running + **54 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **872** |
| **cores doing RUNG-RAISING work** | **56.7%** -- 440 of 776 cores (112 min old **STALE**) |
...
```
generated 2026-08-12 03:25 UTC | elapsed 14.26 d | 14.9 d to the Aug-27 stop
test tier: 30,257 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 71.4 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h     857 records      71.4 rec/h   usable
    last 24 h    2463 records     102.6 rec/h   usable
    12 h rate is 51% from ONE line (test); 4 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,360      70  GATED             GATED             barrier>=279
      403       3,565      70  GATED             GATED             barrier>=279
      568      10,071      88  GATED             GATED             barrier>=279
...
```
2026-08-12T03:16:36Z  OK  records=31793 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.2m  drift=0  sci=OK  r115=22B  sweep=56.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T03:18:01Z  OK  records=31795 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.0m  drift=0  sci=OK  r115=22B  sweep=54.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T03:19:26Z  OK  records=31795 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.2m  drift=0  sci=OK  r115=22B  sweep=54.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T03:20:50Z  OK  records=31795 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.9m  drift=0  sci=OK  r115=22B  sweep=54.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T03:22:13Z  OK  records=31797 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.6m  drift=0  sci=OK  r115=22B  sweep=52.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T03:23:37Z  OK  records=31798 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  sweep=53.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
