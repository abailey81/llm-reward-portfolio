...
**Auto-generated 2026-08-06 07:30 UTC -- T+202h21m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+202h21m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 07:30 UTC | elapsed 8.43 d | 20.7 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    3155 records     131.5 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,908      10  GATED             GATED             barrier>=30
      279       9,956      10  GATED             GATED             barrier>=30
      340      12,701      10  GATED             GATED             barrier>=30
      403      15,536      10  GATED             GATED             barrier>=30
      568      22,969      10  GATED             GATED             barrier>=30
...
```
2026-08-06T07:18:27Z  OK  records=18902 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  sweep=209.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
