...
**Auto-generated 2026-08-06 02:31 UTC -- T+197h22m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+197h22m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 2.5 h ago; none live, newest failure 2.5 h ago** |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,630      60  GATED             GATED             barrier>=30
      189       6,194      60  GATED             GATED             barrier>=30
      279      10,242      60  GATED             GATED             barrier>=30
      340      12,987      60  GATED             GATED             barrier>=30
      403      15,822      60  GATED             GATED             barrier>=30
      568      23,255      60  GATED             GATED             barrier>=30
