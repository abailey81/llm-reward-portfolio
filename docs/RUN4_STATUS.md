...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 57 min ago; none live, newest failure 57 min ago** |
...
test tier: 18,037 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,278     284  GATED             GATED             unstarted:2-unit(s)-absent>=30
      340      12,023     284  GATED             GATED             unstarted:2-unit(s)-absent>=30
      403      14,858     284  GATED             GATED             unstarted:2-unit(s)-absent>=30
      568      22,291     284  GATED             GATED             unstarted:2-unit(s)-absent>=30
