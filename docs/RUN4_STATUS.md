...
**Auto-generated 2026-08-03 10:20 UTC -- T+133h11m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+133h11m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **805** (186 running, 619 queued) |
...
```
 rung             @1488 cores              @830 cores   binding
  ...
  403            7.3 d  08-05           13.0 d  08-10   throughput
  568           10.1 d  08-07           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 1996 |
| scalar | g5 of 5 | 1415 |
| placebo | g5 of 5 | 1518 |
| scalar_cvar5 | g5 of 5 | 1492 |
| placebo_shuffled | g5 of 5 | 1510 |
