...
**Auto-generated 2026-08-05 17:43 UTC -- T+188h34m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+188h34m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 17:44 UTC | elapsed 7.86 d | 21.3 d to the Aug-27 stop
test tier: 15,937 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     198 records     198.0 rec/h
    last  3 h     566 records     188.7 rec/h
    last 12 h    2156 records     179.7 rec/h
    last 24 h    3794 records     158.1 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      24,391     198  GATED             GATED             barrier>=30
