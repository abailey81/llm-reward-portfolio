...
**Auto-generated 2026-08-06 00:34 UTC -- T+195h25m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h25m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.5 h ago; none live, newest failure 30 min ago** |
...
```
generated 2026-08-06 00:34 UTC | elapsed 8.14 d | 21.0 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,718     145  GATED             GATED             barrier>=30
      189       6,283     191  GATED             GATED             barrier>=30
      279      10,331     193  GATED             GATED             barrier>=30
      340      13,076     193  GATED             GATED             barrier>=30
      403      15,911     193  GATED             GATED             barrier>=30
      568      23,344     193  GATED             GATED             barrier>=30
