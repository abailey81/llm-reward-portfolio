...
**Auto-generated 2026-08-06 07:56 UTC -- T+202h47m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+202h47m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **18906** |
| **Myriad maintenance** | **2026-08-12 from 08:00 UTC, at risk all day** (in 6.0 days). Delayed from Aug 11. Jobs may die and REQUEUE idempotently; the supervisors ride it. Playbook: docs/ops/MAINTENANCE_2026-08-12.md |
...
| | |
|---|---|
| cluster jobs | **931** (115 running, 816 queued) |
| **cores computing** | **920** |
...
```
generated 2026-08-06 07:56 UTC | elapsed 8.45 d | 20.7 d to the Aug-27 stop
test tier: 17,363 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    3045 records     126.9 rec/h   usable
    12 h rate is 51% from ONE line (test_leg_kimi_k3); 4 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 17% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_haiku_4_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,904       4  GATED             GATED             barrier>=30
      279       9,952       4  GATED             GATED             barrier>=30
      340      12,697       4  GATED             GATED             barrier>=30
      403      15,532       4  GATED             GATED             barrier>=30
      568      22,965       4  GATED             GATED             barrier>=30
...
```
2026-08-06T07:27:32Z  OK  records=18902 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  sweep=274.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T07:32:43Z  OK  records=18902 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.9m  drift=0  sci=OK  r115=22B  sweep=280.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T07:40:18Z  ATTN  records=18902 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.9m  drift=0  sci=OK  r115=22B  sweep=425.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T07:50:51Z  OK  records=18904 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.1m  drift=0  sci=OK  r115=22B  cores=904  sweep=602.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T07:51:51Z  OK  records=18905 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  sweep=29.9s  auto-cycle
2026-08-06T07:52:59Z  OK  records=18906 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.3m  drift=0  sci=OK  r115=22B  sweep=38.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
