...
**Auto-generated 2026-08-05 06:12 UTC -- T+177h03m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+177h03m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 70 min ago; none live, newest failure 70 min ago** |
...
| | |
|---|---|
| cluster jobs | **957** (210 running, 747 queued) |
...
```
generated 2026-08-05 06:13 UTC | elapsed 7.38 d | 21.7 d to the Aug-27 stop
test tier: 13,914 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     267 records     267.0 rec/h
    last  3 h     315 records     105.0 rec/h
    last 12 h    1659 records     138.2 rec/h
    last 24 h    4002 records     166.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,238      43  GATED             GATED             barrier>=30
      189       7,464     267  GATED             GATED             barrier>=30
      279      11,964     267  GATED             GATED             barrier>=30
      340      15,014     267  GATED             GATED             barrier>=30
      403      18,164     267  GATED             GATED             barrier>=30
      568      26,414     267  GATED             GATED             barrier>=30
