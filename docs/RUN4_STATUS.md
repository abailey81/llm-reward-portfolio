...
**Auto-generated 2026-08-11 17:35 UTC -- T+332h26m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+332h26m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **456** = 61 running + **67 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **488** |
| **cores doing RUNG-RAISING work** | **4.8%** -- 24 of 504 cores (2 min old) |
...
```
generated 2026-08-11 17:36 UTC | elapsed 13.85 d | 15.3 d to the Aug-27 stop
test tier: 29,675 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279         128      32  GATED             GATED             barrier
      340       1,924      99  GATED             GATED             barrier>=279
      403       4,129      99  GATED             GATED             barrier>=279
      568      10,653      99  GATED             GATED             barrier>=279
