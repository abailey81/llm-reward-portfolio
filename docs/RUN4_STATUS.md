...
**Auto-generated 2026-08-05 04:39 UTC -- T+175h31m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+175h31m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 04:40 UTC | elapsed 7.31 d | 21.8 d to the Aug-27 stop
test tier: 13,611 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,317       7  GATED             GATED             barrier>=30
      189       7,767       7  GATED             GATED             barrier>=30
      279      12,267       7  GATED             GATED             barrier>=30
      340      15,317       7  GATED             GATED             barrier>=30
      403      18,467       7  GATED             GATED             barrier>=30
      568      26,717       7  GATED             GATED             barrier>=30
