...
| **cores computing** | **896** |
| **cores doing RUNG-RAISING work** | **21.2%** -- 192 of 904 cores (27 min old) |
...
```
generated 2026-08-06 10:48 UTC | elapsed 8.57 d | 20.5 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,706      45  GATED             GATED             barrier>=30
      279       9,754      45  GATED             GATED             barrier>=30
      340      12,499      45  GATED             GATED             barrier>=30
      403      15,334      45  GATED             GATED             barrier>=30
      568      22,767      45  GATED             GATED             barrier>=30
