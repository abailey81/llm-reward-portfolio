...
**Auto-generated 2026-08-05 09:05 UTC -- T+179h56m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+179h56m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **873** (188 running, 685 queued) |
...
```
generated 2026-08-05 09:05 UTC | elapsed 7.50 d | 21.6 d to the Aug-27 stop
test tier: 14,622 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     261 records     261.0 rec/h
    last  3 h     730 records     243.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,052     160  GATED             GATED             barrier>=30
      189       7,021     196  GATED             GATED             barrier>=30
      279      11,256     261  GATED             GATED             barrier>=30
      340      14,306     261  GATED             GATED             barrier>=30
      403      17,456     261  GATED             GATED             barrier>=30
      568      25,706     261  GATED             GATED             barrier>=30
