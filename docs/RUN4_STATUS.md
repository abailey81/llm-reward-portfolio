...
**Auto-generated 2026-08-06 15:39 UTC -- T+210h31m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 66 min ago; none live, newest failure 66 min ago** |
...
| | |
|---|---|
| cluster jobs | **869** (51 running, 818 queued) |
| **cores computing** | **408** |
...
```
generated 2026-08-06 15:40 UTC | elapsed 8.77 d | 20.3 d to the Aug-27 stop
test tier: 18,061 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,254     274  GATED             GATED             unstarted:2-unit(s)-absent>=30
      340      11,999     274  GATED             GATED             unstarted:2-unit(s)-absent>=30
      403      14,834     274  GATED             GATED             unstarted:2-unit(s)-absent>=30
      568      22,267     274  GATED             GATED             unstarted:2-unit(s)-absent>=30
