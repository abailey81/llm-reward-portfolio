...
**Auto-generated 2026-08-06 15:41 UTC -- T+210h32m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+210h32m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 68 min ago; none live, newest failure 67 min ago** |
...
| | |
|---|---|
| cluster jobs | **876** (51 running, 825 queued) |
| **cores computing** | **408** |
| **cores doing RUNG-RAISING work** | **17.0%** -- 72 of 424 cores (2 min old) |
...
```
generated 2026-08-06 15:41 UTC | elapsed 8.77 d | 20.3 d to the Aug-27 stop
test tier: 18,065 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30          63      12  GATED             GATED             unstarted:2-unit(s)-absent
      100       2,513      12  GATED             GATED             unstarted:2-unit(s)-absent>=30
      189       5,628      12  GATED             GATED             unstarted:2-unit(s)-absent>=30
      279       9,250     273  GATED             GATED             unstarted:2-unit(s)-absent>=30
      340      11,995     273  GATED             GATED             unstarted:2-unit(s)-absent>=30
      403      14,830     273  GATED             GATED             unstarted:2-unit(s)-absent>=30
      568      22,263     273  GATED             GATED             unstarted:2-unit(s)-absent>=30
...
2026-08-06T15:37:23Z  RED  records=19588 (+56)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=4  sci=OK  r115=22B  cores=440  sweep=687.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T15:38:24Z  OK  records=19597 (+9)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=31.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T15:39:27Z  OK  records=19599 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.1m  drift=0  sci=OK  r115=22B  sweep=32.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T15:40:28Z  OK  records=19599 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.1m  drift=0  sci=OK  r115=22B  sweep=30.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
