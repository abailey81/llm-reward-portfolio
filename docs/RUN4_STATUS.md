...
**Auto-generated 2026-08-05 08:13 UTC -- T+179h04m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+179h04m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 58 min ago; none live, newest failure 58 min ago** |
...
| | |
|---|---|
| cluster jobs | **898** (197 running, 701 queued) |
...
```
generated 2026-08-05 08:14 UTC | elapsed 7.46 d | 21.7 d to the Aug-27 stop
test tier: 14,407 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     275 records     275.0 rec/h
    last  3 h     757 records     252.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,190      46  GATED             GATED             barrier>=30
      189       7,195      58  GATED             GATED             barrier>=30
      279      11,471     275  GATED             GATED             barrier>=30
      340      14,521     275  GATED             GATED             barrier>=30
      403      17,671     275  GATED             GATED             barrier>=30
      568      25,921     275  GATED             GATED             barrier>=30
