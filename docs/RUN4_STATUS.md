...
**Auto-generated 2026-08-06 12:41 UTC -- T+207h32m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+207h32m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=21; worst streak 2/240 (0.8% to fatal), ops on kimi-k3, 0 min ago; LIVE, still failing** |
...
| **cores computing** | **816** |
| **cores doing RUNG-RAISING work** | **22.6%** -- 184 of 816 cores (0 min old) |
...
```
generated 2026-08-06 12:41 UTC | elapsed 8.65 d | 20.5 d to the Aug-27 stop
test tier: 17,625 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,690      26  GATED             GATED             barrier>=30
      340      12,435      26  GATED             GATED             barrier>=30
      403      15,270      26  GATED             GATED             barrier>=30
      568      22,703      26  GATED             GATED             barrier>=30
    ...
    !! 90% of the rung-568 backlog (20,475 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
