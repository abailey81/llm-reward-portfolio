...
**Auto-generated 2026-08-05 14:18 UTC -- T+185h09m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+185h09m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 3.5 h ago; none live, newest failure 74 min ago** |
...
| | |
|---|---|
| cluster jobs | **950** (184 running, 766 queued) |
...
```
generated 2026-08-05 14:19 UTC | elapsed 7.72 d | 21.4 d to the Aug-27 stop
test tier: 15,269 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     164 records     164.0 rec/h
    last  3 h     333 records     111.0 rec/h
    last 12 h    1679 records     139.9 rec/h
    ...
    !! 1% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_sonnet_5, test_leg_qwen3_5_9b) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,659     164  GATED             GATED             barrier>=30
      403      16,809     164  GATED             GATED             barrier>=30
      568      25,059     164  GATED             GATED             barrier>=30
