...
**Auto-generated 2026-08-03 10:53 UTC -- T+133h44m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+133h44m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **774** (166 running, 608 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 2032 |
| scalar | g5 of 5 | 1444 |
| placebo | g5 of 5 | 1570 |
| scalar_cvar5 | g5 of 5 | 1542 |
| placebo_shuffled | g5 of 5 | 1552 |
...
2026-08-03T10:45:06Z  RED  records=8490 (+6)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=1.7m  drift=0  sci=OK  r115=21B  sweep=168.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T10:48:24Z  RED  records=8510 (+20)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=21B  sweep=110.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T10:50:45Z  RED  records=8530 (+20)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=21B  sweep=158.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
