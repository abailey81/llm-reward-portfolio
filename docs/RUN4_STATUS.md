...
**Auto-generated 2026-08-05 04:41 UTC -- T+175h32m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+175h32m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 2.4 h ago; none live, newest failure 2.4 h ago** |
...
```
generated 2026-08-05 04:42 UTC | elapsed 7.31 d | 21.8 d to the Aug-27 stop
test tier: 13,613 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,315       9  GATED             GATED             barrier>=30
      189       7,765       9  GATED             GATED             barrier>=30
      279      12,265       9  GATED             GATED             barrier>=30
      340      15,315       9  GATED             GATED             barrier>=30
      403      18,465       9  GATED             GATED             barrier>=30
      568      26,715       9  GATED             GATED             barrier>=30
