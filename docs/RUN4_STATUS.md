...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.3 h ago; none live, newest failure 15 min ago** |
...
| | |
|---|---|
| cluster jobs | **985** (66 running, 919 queued) |
| **cores computing** | **528** |
...
```
generated 2026-08-06 00:19 UTC | elapsed 8.13 d | 21.0 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    1898 records     158.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,746     159  GATED             GATED             barrier>=30
      189       6,318     230  GATED             GATED             barrier>=30
      279      10,367     231  GATED             GATED             barrier>=30
      340      13,112     231  GATED             GATED             barrier>=30
      403      15,947     231  GATED             GATED             barrier>=30
      568      23,380     231  GATED             GATED             barrier>=30
