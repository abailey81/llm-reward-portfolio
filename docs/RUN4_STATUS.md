...
**Auto-generated 2026-08-06 12:59 UTC -- T+207h50m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+207h50m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,681      27  GATED             GATED             barrier>=30
      340      12,426      27  GATED             GATED             barrier>=30
      403      15,261      27  GATED             GATED             barrier>=30
      568      22,694      27  GATED             GATED             barrier>=30
