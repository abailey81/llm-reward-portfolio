...
**Auto-generated 2026-08-11 21:17 UTC -- T+336h08m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+336h08m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **544** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (105 min old **STALE**) |
...
```
generated 2026-08-11 21:18 UTC | elapsed 14.01 d | 15.1 d to the Aug-27 stop
test tier: 29,955 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 109.5 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h    1314 records     109.5 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,644      61  GATED             GATED             barrier>=279
      403       3,849      61  GATED             GATED             barrier>=279
      568      10,373      61  GATED             GATED             barrier>=279
