...
```
generated 2026-08-06 00:35 UTC | elapsed 8.14 d | 21.0 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,718     144  GATED             GATED             barrier>=30
      189       6,283     190  GATED             GATED             barrier>=30
      279      10,331     192  GATED             GATED             barrier>=30
      340      13,076     192  GATED             GATED             barrier>=30
      403      15,911     192  GATED             GATED             barrier>=30
      568      23,344     192  GATED             GATED             barrier>=30
