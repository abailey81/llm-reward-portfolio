...
**Auto-generated 2026-08-12 01:52 UTC -- T+340h43m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+340h43m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **503** = 95 running + **80 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **760** |
| **cores doing RUNG-RAISING work** | **56.7%** -- 440 of 776 cores (19 min old) |
...
```
generated 2026-08-12 01:53 UTC | elapsed 14.20 d | 14.9 d to the Aug-27 stop
test tier: 30,148 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279          72       2  GATED             GATED             barrier
      340       1,451      50  GATED             GATED             barrier>=279
      403       3,656      50  GATED             GATED             barrier>=279
      568      10,180      50  GATED             GATED             barrier>=279
