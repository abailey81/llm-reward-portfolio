...
**Auto-generated 2026-08-11 21:12 UTC -- T+336h04m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| **cores computing** | **552** |
| **cores doing RUNG-RAISING work** | **46.9%** -- 240 of 512 cores (100 min old **STALE**) |
...
```
generated 2026-08-11 21:13 UTC | elapsed 14.00 d | 15.1 d to the Aug-27 stop
test tier: 29,953 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,646      66  GATED             GATED             barrier>=279
      403       3,851      66  GATED             GATED             barrier>=279
      568      10,375      66  GATED             GATED             barrier>=279
