...
**Auto-generated 2026-08-05 06:17 UTC -- T+177h08m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+177h08m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 75 min ago; none live, newest failure 75 min ago** |
...
| | |
|---|---|
| cluster jobs | **954** (210 running, 744 queued) |
...
```
generated 2026-08-05 06:17 UTC | elapsed 7.38 d | 21.7 d to the Aug-27 stop
test tier: 13,931 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     271 records     271.0 rec/h
    last  3 h     329 records     109.7 rec/h
    last 12 h    1658 records     138.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,238      30  GATED             GATED             barrier>=30
      189       7,447     271  GATED             GATED             barrier>=30
      279      11,947     271  GATED             GATED             barrier>=30
      340      14,997     271  GATED             GATED             barrier>=30
      403      18,147     271  GATED             GATED             barrier>=30
      568      26,397     271  GATED             GATED             barrier>=30
