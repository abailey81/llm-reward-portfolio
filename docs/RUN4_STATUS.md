...
**Auto-generated 2026-08-06 05:21 UTC -- T+200h12m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h12m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **956** (69 running, 887 queued) |
| **cores computing** | **552** |
...
test tier: 17,177 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      67 records      67.0 rec/h
    last  3 h     110 records      36.7 rec/h
    last 12 h    1309 records     109.1 rec/h
    last 24 h    3504 records     146.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,570      23  GATED             GATED             barrier>=30
      189       6,090      67  GATED             GATED             barrier>=30
      279      10,138      67  GATED             GATED             barrier>=30
      340      12,883      67  GATED             GATED             barrier>=30
      403      15,718      67  GATED             GATED             barrier>=30
      568      23,151      67  GATED             GATED             barrier>=30
