...
**Auto-generated 2026-08-05 06:15 UTC -- T+177h06m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+177h06m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 73 min ago; none live, newest failure 73 min ago** |
...
| | |
|---|---|
| cluster jobs | **955** (211 running, 744 queued) |
...
```
generated 2026-08-05 06:16 UTC | elapsed 7.38 d | 21.7 d to the Aug-27 stop
test tier: 13,927 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     272 records     272.0 rec/h
    last  3 h     327 records     109.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,238      35  GATED             GATED             barrier>=30
      189       7,451     272  GATED             GATED             barrier>=30
      279      11,951     272  GATED             GATED             barrier>=30
      340      15,001     272  GATED             GATED             barrier>=30
      403      18,151     272  GATED             GATED             barrier>=30
      568      26,401     272  GATED             GATED             barrier>=30
