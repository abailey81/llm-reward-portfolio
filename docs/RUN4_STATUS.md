...
**Auto-generated 2026-08-05 07:44 UTC -- T+178h35m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+178h35m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 28 min ago; none live, newest failure 28 min ago** |
...
```
generated 2026-08-05 07:44 UTC | elapsed 7.44 d | 21.7 d to the Aug-27 stop
test tier: 14,271 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,232       6  GATED             GATED             barrier>=30
      189       7,237     124  GATED             GATED             barrier>=30
      279      11,607     254  GATED             GATED             barrier>=30
      340      14,657     254  GATED             GATED             barrier>=30
      403      17,807     254  GATED             GATED             barrier>=30
      568      26,057     254  GATED             GATED             barrier>=30
