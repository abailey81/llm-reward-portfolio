...
**Auto-generated 2026-08-06 18:51 UTC -- T+213h42m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+213h42m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=135; worst streak 11/240 (4.6% to fatal), pull on core, 1.9 h ago; none live, newest failure 1.9 h ago** |
...
| **cores computing** | **680** |
| **cores doing RUNG-RAISING work** | **28.8%** -- 168 of 584 cores (50 min old) |
...
```
generated 2026-08-06 18:51 UTC | elapsed 8.90 d | 20.2 d to the Aug-27 stop
test tier: 18,379 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,681      26  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,516      26  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,949      26  GATED             GATED             no-records:test/distributional,test/scalar>=30
...
2026-08-06T18:43:02Z  OK  records=19920 (+4)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  cores=680  sweep=456.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T18:44:01Z  OK  records=19920 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.0m  drift=0  sci=OK  r115=22B  sweep=29.1s  auto-cycle
2026-08-06T18:51:46Z  OK  records=19922 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.2m  drift=0  sci=OK  r115=22B  sweep=435.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
