...
**Auto-generated 2026-08-05 01:06 UTC -- T+171h57m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+171h57m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 2.6 h ago; none live, newest failure 90 min ago** |
...
```
generated 2026-08-05 01:06 UTC | elapsed 7.17 d | 22.0 d to the Aug-27 stop
test tier: 13,493 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     119 records     119.0 rec/h
    last  3 h     462 records     154.0 rec/h
    last 12 h    2190 records     182.5 rec/h
    last 24 h    4246 records     176.9 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      26,835     119  GATED             GATED             barrier>=30
