...
**Auto-generated 2026-08-03 06:27 UTC -- T+129h18m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+129h18m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **951** (289 running, 662 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1738 |
| scalar | g5 of 5 | 1146 |
| placebo | g5 of 5 | 1283 |
| scalar_cvar5 | g5 of 5 | 1246 |
| placebo_shuffled | g5 of 5 | 1258 |
...
2026-08-03T06:22:09Z  RED  records=7065 (+2)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=21B  sweep=58.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T06:23:38Z  RED  records=7066 (+1)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=1.8m  drift=0  sci=OK  r115=21B  sweep=55.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T06:25:03Z  RED  records=7068 (+2)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=21B  sweep=54.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
