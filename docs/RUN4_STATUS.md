...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,570      40  GATED             GATED             barrier>=30
      189       6,123      51  GATED             GATED             barrier>=30
      279      10,171      51  GATED             GATED             barrier>=30
      340      12,916      51  GATED             GATED             barrier>=30
      403      15,751      51  GATED             GATED             barrier>=30
      568      23,184      51  GATED             GATED             barrier>=30
