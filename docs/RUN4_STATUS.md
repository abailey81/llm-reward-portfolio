...
| **cores computing** | **848** |
| **cores doing RUNG-RAISING work** | **33.6%** -- 288 of 856 cores (80 min old) |
...
test tier: 18,497 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    1499 records      62.5 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,469      41  GATED             GATED             no-records:test/distributional,test/scalar>=30
      189       5,584      41  GATED             GATED             no-records:test/distributional,test/scalar>=30
      279       9,114      41  GATED             GATED             no-records:test/distributional,test/scalar>=30
      340      11,563      70  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,398      70  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,831      70  GATED             GATED             no-records:test/distributional,test/scalar>=30
