...
**Auto-generated 2026-08-05 02:44 UTC -- T+173h35m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+173h35m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 4.2 h ago; none live, newest failure 27 min ago** |
...
| | |
|---|---|
| cluster jobs | **991** (182 running, 809 queued) |
| **cores computing** | **1456** |
...
```
generated 2026-08-05 02:44 UTC | elapsed 7.23 d | 21.9 d to the Aug-27 stop
test tier: 13,595 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      35 records      35.0 rec/h
    last  3 h     277 records      92.3 rec/h
    last 12 h    2004 records     167.0 rec/h
    last 24 h    4153 records     173.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (167 rec/h); latest excludes cells already within
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,324       7  GATED             GATED             barrier>=30
      189       7,774       7  GATED             GATED             barrier>=30
      279      12,274       7  GATED             GATED             barrier>=30
      340      15,324       7  GATED             GATED             barrier>=30
      403      18,474       7  GATED             GATED             barrier>=30
      568      26,733      35  GATED             GATED             barrier>=30
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung     @1456 cores      @830 cores   binding
