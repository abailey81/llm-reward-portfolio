...
**Auto-generated 2026-08-01 18:34 UTC -- T+93h25m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+93h25m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **112** (100 running, 12 queued) |
| **cores computing** | **800** |
...
```
 rung              @800 cores              @830 cores   binding
  ...
  279            9.6 d  08-07            9.3 d  08-07   throughput
  340           11.5 d  08-09           11.1 d  08-09   throughput
  403           13.5 d  08-11           13.0 d  08-10   throughput
  568           18.8 d  08-16           18.1 d  08-15   throughput
```
...
| scalar | g5 of 5 | 326 |
| placebo | g5 of 5 | 380 |
| scalar_cvar5 | g5 of 5 | 331 |
| placebo_shuffled | g5 of 5 | 296 |
...
```
2026-08-01T18:30:14Z  RED  records=2622 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=19B  sweep=18.0s  auto-cycle
2026-08-01T18:31:02Z  RED  records=2622 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=19B  sweep=16.9s  auto-cycle
2026-08-01T18:31:49Z  RED  records=2622 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=19B  sweep=16.8s  auto-cycle
2026-08-01T18:32:36Z  RED  records=2622 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=19B  sweep=17.1s  auto-cycle
2026-08-01T18:33:23Z  RED  records=2623 (+1)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=19B  sweep=17.6s  auto-cycle
2026-08-01T18:34:11Z  RED  records=2623 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=19B  sweep=17.0s  auto-cycle
```
...
```
  ...
  openrouter  spent $  8.7012  + still to author $  0.2307  = $  8.9319   credited $ 19.3100   margin $ +10.3781 (+54%)  comfortable
```
