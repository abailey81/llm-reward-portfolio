...
**Auto-generated 2026-08-05 11:39 UTC -- T+182h30m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+182h30m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=5; worst streak 1/240 (0.4% to fatal), ops on core, 4.4 h ago; none live, newest failure 50 min ago** |
...
```
generated 2026-08-05 11:40 UTC | elapsed 7.61 d | 21.5 d to the Aug-27 stop
test tier: 14,977 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     108 records     108.0 rec/h
    last  3 h     450 records     150.0 rec/h
    last 12 h    1667 records     138.9 rec/h
    last 24 h    3908 records     162.8 rec/h
    12 h rate is 58% from ONE line (test_leg_haiku_4_5); 5 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 17% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279      10,901     108  GATED             GATED             barrier>=30
      340      13,951     108  GATED             GATED             barrier>=30
      403      17,101     108  GATED             GATED             barrier>=30
      568      25,351     108  GATED             GATED             barrier>=30
