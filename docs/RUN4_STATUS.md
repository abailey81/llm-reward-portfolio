...
**Auto-generated 2026-08-05 13:12 UTC -- T+184h03m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+184h03m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 13:12 UTC | elapsed 7.67 d | 21.4 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    3775 records     157.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,834      49  GATED             GATED             barrier>=30
      403      16,984      49  GATED             GATED             barrier>=30
      568      25,234      49  GATED             GATED             barrier>=30
