...
**Auto-generated 2026-08-06 11:19 UTC -- T+206h10m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+206h10m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **848** |
| **cores doing RUNG-RAISING work** | **21.4%** -- 192 of 896 cores (29 min old) |
...
```
generated 2026-08-06 11:20 UTC | elapsed 8.59 d | 20.5 d to the Aug-27 stop
test tier: 17,593 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    12 h rate is 91% from ONE line (test_leg_kimi_k3); 3 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,689      44  GATED             GATED             barrier>=30
      279       9,722      59  GATED             GATED             barrier>=30
      340      12,467      59  GATED             GATED             barrier>=30
      403      15,302      59  GATED             GATED             barrier>=30
      568      22,735      59  GATED             GATED             barrier>=30
