...
**Auto-generated 2026-08-06 10:23 UTC -- T+205h14m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+205h14m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 10:23 UTC | elapsed 8.55 d | 20.6 d to the Aug-27 stop
test tier: 17,537 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,730      70  GATED             GATED             barrier>=30
      279       9,778      70  GATED             GATED             barrier>=30
      340      12,523      70  GATED             GATED             barrier>=30
      403      15,358      70  GATED             GATED             barrier>=30
      568      22,791      70  GATED             GATED             barrier>=30
