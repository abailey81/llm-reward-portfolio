...
**Auto-generated 2026-08-12 01:21 UTC -- T+340h12m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+340h12m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **776** |
| **cores doing RUNG-RAISING work** | **37.8%** -- 248 of 656 cores (108 min old **STALE**) |
...
```
generated 2026-08-12 01:22 UTC | elapsed 14.18 d | 14.9 d to the Aug-27 stop
test tier: 30,115 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279          72      28  GATED             GATED             barrier
      340       1,484      46  GATED             GATED             barrier>=279
      403       3,689      46  GATED             GATED             barrier>=279
      568      10,213      46  GATED             GATED             barrier>=279
