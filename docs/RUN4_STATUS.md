...
**Auto-generated 2026-08-06 03:19 UTC -- T+198h10m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+198h10m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     121 records      40.3 rec/h
    last 12 h    1563 records     130.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,624      13  GATED             GATED             barrier>=30
      189       6,188      13  GATED             GATED             barrier>=30
      279      10,236      13  GATED             GATED             barrier>=30
      340      12,981      13  GATED             GATED             barrier>=30
      403      15,816      13  GATED             GATED             barrier>=30
      568      23,249      13  GATED             GATED             barrier>=30
