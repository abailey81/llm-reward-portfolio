...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.5 h ago; none live, newest failure 31 min ago** |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,718     143  GATED             GATED             barrier>=30
      189       6,283     187  GATED             GATED             barrier>=30
      279      10,331     189  GATED             GATED             barrier>=30
      340      13,076     189  GATED             GATED             barrier>=30
      403      15,911     189  GATED             GATED             barrier>=30
      568      23,344     189  GATED             GATED             barrier>=30
