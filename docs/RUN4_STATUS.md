...
**Auto-generated 2026-08-05 06:10 UTC -- T+177h01m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+177h01m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 68 min ago; none live, newest failure 68 min ago** |
...
| | |
|---|---|
| cluster jobs | **958** (210 running, 748 queued) |
| **cores computing** | **1680** |
...
```
generated 2026-08-05 06:11 UTC | elapsed 7.38 d | 21.7 d to the Aug-27 stop
test tier: 13,907 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     261 records     261.0 rec/h
    last  3 h     309 records     103.0 rec/h
    last 12 h    1655 records     137.9 rec/h
    ...
    !! 47% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,238      44  GATED             GATED             barrier>=30
      189       7,471     261  GATED             GATED             barrier>=30
      279      11,971     261  GATED             GATED             barrier>=30
      340      15,021     261  GATED             GATED             barrier>=30
      403      18,171     261  GATED             GATED             barrier>=30
      568      26,421     261  GATED             GATED             barrier>=30
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung     @1680 cores      @830 cores   binding
...
```
2026-08-05T05:35:56Z  OK  records=15251 (+36)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  cores=1632  sweep=422.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T05:40:27Z  OK  records=15284 (+33)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  sweep=240.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T05:47:44Z  OK  records=15320 (+36)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.0m  drift=0  sci=OK  r115=22B  sweep=406.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
