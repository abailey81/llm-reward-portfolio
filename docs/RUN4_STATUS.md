...
```
generated 2026-08-06 06:00 UTC | elapsed 8.37 d | 20.7 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    1287 records     107.2 rec/h
    last 24 h    3411 records     142.1 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,570       1  GATED             GATED             barrier>=30
      189       5,990     135  GATED             GATED             barrier>=30
      279      10,038     135  GATED             GATED             barrier>=30
      340      12,783     135  GATED             GATED             barrier>=30
      403      15,618     135  GATED             GATED             barrier>=30
      568      23,051     135  GATED             GATED             barrier>=30
