...
**Auto-generated 2026-08-05 17:59 UTC -- T+188h50m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+188h50m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=2; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 4.9 h ago; none live, newest failure 4.9 h ago** |
...
| | |
|---|---|
| cluster jobs | **860** (146 running, 714 queued) |
...
```
generated 2026-08-05 17:59 UTC | elapsed 7.87 d | 21.3 d to the Aug-27 stop
test tier: 15,983 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     188 records     188.0 rec/h
    last  3 h     539 records     179.7 rec/h
    last 12 h    2118 records     176.5 rec/h
    last 24 h    3761 records     156.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      24,345     188  GATED             GATED             barrier>=30
...
```
2026-08-05T17:21:16Z  OK  records=17403 (+27)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  cores=1296  sweep=439.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
