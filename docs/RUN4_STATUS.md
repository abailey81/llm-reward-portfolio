...
**Auto-generated 2026-08-05 02:37 UTC -- T+173h28m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+173h28m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 4.1 h ago; none live, newest failure 21 min ago** |
...
```
generated 2026-08-05 02:37 UTC | elapsed 7.23 d | 21.9 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    2026 records     168.8 rec/h
    last 24 h    4170 records     173.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,324       9  GATED             GATED             barrier>=30
      189       7,774       9  GATED             GATED             barrier>=30
      279      12,274       9  GATED             GATED             barrier>=30
      340      15,324       9  GATED             GATED             barrier>=30
      403      18,474       9  GATED             GATED             barrier>=30
      568      26,736      44  GATED             GATED             barrier>=30
