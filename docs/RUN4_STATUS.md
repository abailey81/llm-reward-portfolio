...
**Auto-generated 2026-08-05 14:24 UTC -- T+185h15m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+185h15m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 3.6 h ago; none live, newest failure 80 min ago** |
...
| | |
|---|---|
| cluster jobs | **946** (185 running, 761 queued) |
...
```
generated 2026-08-05 14:25 UTC | elapsed 7.72 d | 21.4 d to the Aug-27 stop
test tier: 15,293 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     177 records     177.0 rec/h
    last  3 h     346 records     115.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,645     167  GATED             GATED             barrier>=30
      403      16,785     177  GATED             GATED             barrier>=30
      568      25,035     177  GATED             GATED             barrier>=30
