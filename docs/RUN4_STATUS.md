...
**Auto-generated 2026-08-05 18:53 UTC -- T+189h44m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+189h44m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.8 h ago; none live, newest failure 5.8 h ago** |
...
| | |
|---|---|
| cluster jobs | **837** (123 running, 714 queued) |
| **cores computing** | **984** |
...
```
generated 2026-08-05 18:54 UTC | elapsed 7.91 d | 21.2 d to the Aug-27 stop
test tier: 16,144 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     174 records     174.0 rec/h
    last  3 h     562 records     187.3 rec/h
    last 12 h    2074 records     172.8 rec/h
    last 24 h    3758 records     156.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      24,184     174  GATED             GATED             barrier>=30
