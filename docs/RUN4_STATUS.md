...
**Auto-generated 2026-08-01 01:50 UTC -- T+76h41m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+76h41m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
|---|---|---|
| distributional | g5 of 5 | 321 |
| scalar | g5 of 5 | 296 |
| placebo | g5 of 5 | 225 |
| scalar_cvar5 | g5 of 5 | 185 |
...
```
2026-08-01T01:46:39Z  RED  records=1597 (+0)  spend=$40.7143  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0+8dirty  sci=OK  r115=13B  sweep=8.8s  auto-cycle
2026-08-01T01:47:18Z  RED  records=1598 (+1)  spend=$40.7169  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0+8dirty  sci=OK  r115=13B  sweep=12.2s  auto-cycle
2026-08-01T01:48:01Z  RED  records=1598 (+0)  spend=$40.7169  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0+8dirty  sci=OK  r115=13B  sweep=12.0s  auto-cycle
2026-08-01T01:48:43Z  RED  records=1599 (+1)  spend=$40.7169  guards=2  arms_full=10/10  budget=2  stalest=1.3m  drift=0+8dirty  sci=OK  r115=13B  sweep=11.3s  auto-cycle
2026-08-01T01:49:24Z  RED  records=1599 (+0)  spend=$40.7169  guards=2  arms_full=10/10  budget=2  stalest=2.0m  drift=0+8dirty  sci=OK  r115=13B  sweep=12.3s  auto-cycle
2026-08-01T01:50:07Z  RED  records=1600 (+1)  spend=$40.7169  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0+8dirty  sci=OK  r115=13B  sweep=11.2s  auto-cycle
```
