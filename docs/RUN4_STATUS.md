...
**Auto-generated 2026-08-03 08:42 UTC -- T+131h33m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+131h33m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **892** (261 running, 631 queued) |
| **cores computing** | **2088** |

Per-rung ETAs from the registered model at the cores we actually hold:

```
 rung             @2088 cores              @830 cores   binding
...
|---|---|---|
| distributional | g5 of 5 | 1856 |
| scalar | g5 of 5 | 1272 |
| placebo | g5 of 5 | 1378 |
| scalar_cvar5 | g5 of 5 | 1351 |
| placebo_shuffled | g5 of 5 | 1371 |
