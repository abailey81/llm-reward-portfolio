...
**Auto-generated 2026-08-12 01:10 UTC -- T+340h01m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+340h01m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 0/240 (0.0% to fatal), - on -, age UNKNOWN; none live, newest failure 7.5 h ago** |
...
| | |
|---|---|
| cluster jobs | **509** = 93 running + **88 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **744** |
| **cores doing RUNG-RAISING work** | **37.8%** -- 248 of 656 cores (98 min old **STALE**) |
...
```
generated 2026-08-12 01:11 UTC | elapsed 14.17 d | 15.0 d to the Aug-27 stop
test tier: 30,108 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 89.3 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last  3 h      89 records      29.7 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last 12 h    1072 records      89.3 rec/h   usable
    last 24 h    2456 records     102.3 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279          72      33  GATED             GATED             barrier
      340       1,491      44  GATED             GATED             barrier>=279
      403       3,696      44  GATED             GATED             barrier>=279
      568      10,220      44  GATED             GATED             barrier>=279
...
```
2026-08-12T00:52:27Z  OK  records=31636 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=0.3m  drift=0  sci=OK  r115=22B  sweep=56.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T00:53:51Z  OK  records=31636 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.7m  drift=0  sci=OK  r115=22B  sweep=54.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T00:55:23Z  OK  records=31636 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.1m  drift=0  sci=OK  r115=22B  sweep=61.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T00:56:52Z  OK  records=31642 (+6)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=0.4m  drift=0  sci=OK  r115=22B  sweep=59.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T00:58:23Z  OK  records=31642 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.8m  drift=0  sci=OK  r115=22B  sweep=61.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T01:10:07Z  OK  records=31650 (+8)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  cores=744  sweep=673.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
