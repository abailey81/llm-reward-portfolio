...
**Auto-generated 2026-07-31 20:11 UTC -- T+71h02m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+71h02m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **191** (105 running, 86 queued) |
| **cores computing** | **840** |
...
```
 rung              @840 cores              @830 cores   binding
  ...
  100            3.8 d  08-01            3.8 d  08-01   throughput
...
| scalar | g5 of 5 | 294 |
| placebo | g5 of 5 | 182 |
| scalar_cvar5 | g5 of 5 | 162 |
| placebo_shuffled | g5 of 5 | 153 |
...
```
2026-07-31T19:59:45Z  RED  records=1503 (+0)  spend=$38.268  guards=2  arms_full=10/10  budget=2  stalest=1.6m  drift=0  sci=OK  r115=13B  auto-cycle
2026-07-31T20:01:58Z  RED  records=1504 (+1)  spend=$38.268  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=13B  cores=832  auto-cycle
2026-07-31T20:04:12Z  RED  records=1505 (+1)  spend=$38.268  guards=2  arms_full=10/10  budget=2  stalest=1.9m  drift=0  sci=OK  r115=13B  auto-cycle
2026-07-31T20:06:25Z  RED  records=1505 (+0)  spend=$38.268  guards=2  arms_full=10/10  budget=2  stalest=2.1m  drift=0  sci=OK  r115=13B  auto-cycle
2026-07-31T20:08:33Z  RED  records=1505 (+0)  spend=$38.268  guards=2  arms_full=10/10  budget=2  stalest=1.3m  drift=0  sci=OK  r115=13B  auto-cycle
2026-07-31T20:10:45Z  RED  records=1506 (+1)  spend=$38.268  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=13B  auto-cycle
```
...
```
  ...
  openrouter  spent $  6.9814  + still to author $  2.4860  = $  9.4674   credited $ 19.3100   margin $  +9.8426 (+51%)  comfortable
```
