...
**Auto-generated 2026-08-06 09:02 UTC -- T+203h53m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+203h53m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **992** |
| **cores doing RUNG-RAISING work** | **20.8%** -- 208 of 1000 cores (10 min old) |
...
```
generated 2026-08-06 09:02 UTC | elapsed 8.50 d | 20.6 d to the Aug-27 stop
test tier: 17,402 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,865      39  GATED             GATED             barrier>=30
      279       9,913      39  GATED             GATED             barrier>=30
      340      12,658      39  GATED             GATED             barrier>=30
      403      15,493      39  GATED             GATED             barrier>=30
      568      22,926      39  GATED             GATED             barrier>=30
