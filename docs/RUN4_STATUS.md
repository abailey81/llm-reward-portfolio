...
```
generated 2026-08-06 06:14 UTC | elapsed 8.38 d | 20.7 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,959     143  GATED             GATED             barrier>=30
      279      10,007     143  GATED             GATED             barrier>=30
      340      12,752     143  GATED             GATED             barrier>=30
      403      15,587     143  GATED             GATED             barrier>=30
      568      23,020     143  GATED             GATED             barrier>=30
