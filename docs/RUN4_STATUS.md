...
**Auto-generated 2026-08-06 20:17 UTC -- T+215h08m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+215h08m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=35; worst streak 11/240 (4.6% to fatal), pull on core, 3.4 h ago; none live, newest failure 3.3 h ago** |
...
| | |
|---|---|
| cluster jobs | **835** = 102 running + **80 ELIGIBLE** + 546 held by us + 107 held only by the site |
...
| **cores computing** | **816** |
| **cores doing RUNG-RAISING work** | **30.3%** -- 240 of 792 cores (24 min old) |
...
```
generated 2026-08-06 20:17 UTC | elapsed 8.96 d | 20.2 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,641      28  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,476      28  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,909      28  GATED             GATED             no-records:test/distributional,test/scalar>=30
