...
**Auto-generated 2026-08-03 00:54 UTC -- T+123h45m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+123h45m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **666** (268 running, 398 queued) |
| **cores computing** | **2144** |

Per-rung ETAs from the registered model at the cores we actually hold:

```
 rung             @2144 cores              @830 cores   binding
...
|---|---|---|
| distributional | g5 of 5 | 1529 |
| scalar | g5 of 5 | 933 |
| placebo | g5 of 5 | 1148 |
| scalar_cvar5 | g5 of 5 | 1106 |
| placebo_shuffled | g5 of 5 | 1088 |
