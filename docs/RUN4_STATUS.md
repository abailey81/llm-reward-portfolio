...
```
generated 2026-08-07 00:41 UTC | elapsed 9.15 d | 20.0 d to the Aug-27 stop
test tier: 18,454 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,606      27  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,441      27  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,874      27  GATED             GATED             no-records:test/distributional,test/scalar>=30
