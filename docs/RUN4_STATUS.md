...
**Auto-generated 2026-08-02 12:09 UTC -- T+111h00m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+111h00m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **987** (217 running, 770 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1007 |
| scalar | g5 of 5 | 415 |
| placebo | g5 of 5 | 649 |
| scalar_cvar5 | g5 of 5 | 606 |
| placebo_shuffled | g5 of 5 | 590 |
...
```
2026-08-02T12:04:20Z  RED  records=3613 (+8)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=21B  sweep=23.6s  auto-cycle
2026-08-02T12:05:14Z  RED  records=3616 (+3)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=21B  sweep=23.1s  auto-cycle
2026-08-02T12:06:07Z  RED  records=3626 (+10)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=21B  sweep=25.8s  auto-cycle
2026-08-02T12:07:03Z  RED  records=3631 (+5)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=21B  sweep=24.2s  auto-cycle
2026-08-02T12:07:58Z  RED  records=3643 (+12)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=4.1m  drift=0  sci=OK  r115=21B  sweep=44.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T12:09:12Z  RED  records=3649 (+6)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=21B  sweep=27.4s  auto-cycle
```
