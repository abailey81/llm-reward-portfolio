...
**Auto-generated 2026-08-11 17:57 UTC -- T+332h48m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+332h48m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **520** |
| **cores doing RUNG-RAISING work** | **4.8%** -- 24 of 504 cores (24 min old) |
...
```
generated 2026-08-11 17:58 UTC | elapsed 13.87 d | 15.3 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279         128      13  GATED             GATED             barrier
      340       1,885      94  GATED             GATED             barrier>=279
      403       4,090      94  GATED             GATED             barrier>=279
      568      10,614      94  GATED             GATED             barrier>=279
