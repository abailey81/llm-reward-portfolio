...
**Auto-generated 2026-08-02 16:55 UTC -- T+115h46m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+115h46m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **848** (248 running, 600 queued) |
| **cores computing** | **1984** |

Per-rung ETAs from the registered model at the cores we actually hold:

```
 rung             @1984 cores              @830 cores   binding
  ...
  340            4.7 d  08-02           11.1 d  08-09   throughput
  403            5.5 d  08-03           13.0 d  08-10   throughput
  568            7.6 d  08-05           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 1218 |
| scalar | g5 of 5 | 625 |
| placebo | g5 of 5 | 854 |
| scalar_cvar5 | g5 of 5 | 815 |
| placebo_shuffled | g5 of 5 | 798 |
...
```
2026-08-02T16:49:06Z  RED  records=4684 (+5)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=21B  sweep=33.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T16:50:09Z  RED  records=4686 (+2)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=21B  sweep=31.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T16:51:11Z  RED  records=4693 (+7)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.9m  drift=0  sci=OK  r115=21B  sweep=35.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T16:52:17Z  RED  records=4694 (+1)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=21B  sweep=32.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T16:53:20Z  RED  records=4698 (+4)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=21B  cores=1968  sweep=62.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T16:54:52Z  RED  records=4701 (+3)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=21B  sweep=36.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
