...
**Auto-generated 2026-08-11 17:53 UTC -- T+332h44m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+332h44m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on core, 5.3 h ago; none live, newest failure 13 min ago** |
...
```
generated 2026-08-11 17:54 UTC | elapsed 13.86 d | 15.3 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279         128      16  GATED             GATED             barrier
      340       1,889      97  GATED             GATED             barrier>=279
      403       4,094      97  GATED             GATED             barrier>=279
      568      10,618      97  GATED             GATED             barrier>=279
