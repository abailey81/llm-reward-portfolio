...
**Auto-generated 2026-08-05 07:51 UTC -- T+178h42m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+178h42m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **908** (204 running, 704 queued) |
...
```
generated 2026-08-05 07:52 UTC | elapsed 7.45 d | 21.7 d to the Aug-27 stop
test tier: 14,298 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,225      12  GATED             GATED             barrier>=30
      189       7,230      86  GATED             GATED             barrier>=30
      279      11,580     236  GATED             GATED             barrier>=30
      340      14,630     236  GATED             GATED             barrier>=30
      403      17,780     236  GATED             GATED             barrier>=30
      568      26,030     236  GATED             GATED             barrier>=30
