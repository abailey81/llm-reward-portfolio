...
**Auto-generated 2026-08-12 17:26 UTC -- T+356h17m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+356h17m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 0/240 (0.0% to fatal), - on -, age UNKNOWN; none live, newest failure 23.8 h ago** |
...
| | |
|---|---|
| cluster jobs | **329** = 29 running + **0 ELIGIBLE** + 300 held by us + 0 held only by the site |
...
| **cores computing** | **232** |
| **cores doing RUNG-RAISING work** | **58.3%** -- 168 of 288 cores (113 min old **STALE**) |
...
```
generated 2026-08-12 17:26 UTC | elapsed 14.85 d | 14.3 d to the Aug-27 stop
test tier: 31,487 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 90.5 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    last  1 h      11 records      11.0 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last  3 h     176 records      58.7 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last 12 h    1086 records      90.5 rec/h   usable
    last 24 h    1819 records      75.8 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340         472       0  2026-08-12 22:39  2026-08-12 22:39  yes
      403       2,494      11  2026-08-13 21:00  2026-08-13 21:00  yes
      568       8,841      11  2026-08-16 19:08  2026-08-16 19:08  yes
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung      @232 cores      @830 cores   binding
       30           6.0 d           4.6 d   critical_chain
      100          13.7 d           4.6 d   critical_chain
      189          23.4 d           6.5 d   throughput
      279          33.2 d           9.3 d   throughput
      340          39.8 d          11.1 d   throughput
      403          46.7 d          13.0 d   throughput
      568          64.7 d          18.1 d   throughput
...
```
2026-08-12T16:52:21Z  OK  records=33025 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.9m  drift=0  sci=OK  r115=22B  sweep=55.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T16:53:46Z  OK  records=33025 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.3m  drift=0  sci=OK  r115=22B  sweep=54.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T17:02:27Z  OK  records=33028 (+3)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.2m  drift=0  sci=OK  r115=22B  cores=232  sweep=490.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T17:03:56Z  OK  records=33028 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.5m  drift=0  sci=OK  r115=22B  sweep=58.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
