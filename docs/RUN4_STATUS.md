...
**Auto-generated 2026-08-02 06:47 UTC -- T+105h38m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+105h38m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **393** (141 running, 252 queued) |
...
```
 rung             @1128 cores              @830 cores   binding
  ...
  189            4.8 d  08-02            6.5 d  08-04   throughput
  279            6.8 d  08-04            9.3 d  08-07   throughput
  340            8.2 d  08-06           11.1 d  08-09   throughput
  403            9.6 d  08-07           13.0 d  08-10   throughput
  568           13.3 d  08-11           18.1 d  08-15   throughput
```
...
```
2026-08-02T06:41:54Z  RED  records=3332 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=20B  sweep=20.0s  auto-cycle
2026-08-02T06:42:44Z  RED  records=3332 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=20B  sweep=21.3s  auto-cycle
2026-08-02T06:43:35Z  RED  records=3334 (+2)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=20B  sweep=21.5s  auto-cycle
2026-08-02T06:44:27Z  RED  records=3334 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=3.8m  drift=0  sci=OK  r115=20B  sweep=21.0s  auto-cycle
2026-08-02T06:45:18Z  RED  records=3334 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=4.7m  drift=0  sci=OK  r115=20B  sweep=21.5s  auto-cycle
2026-08-02T06:46:10Z  RED  records=3334 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=20B  sweep=38.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
