...
**Auto-generated 2026-08-05 13:26 UTC -- T+184h17m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+184h17m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 2.6 h ago; none live, newest failure 21 min ago** |
...
| | |
|---|---|
| cluster jobs | **964** (193 running, 771 queued) |
...
```
generated 2026-08-05 13:26 UTC | elapsed 7.68 d | 21.4 d to the Aug-27 stop
test tier: 15,117 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      65 records      65.0 rec/h
    last  3 h     294 records      98.0 rec/h
    last 12 h    1587 records     132.2 rec/h
    last 24 h    3773 records     157.2 rec/h
    12 h rate is 70% from ONE line (test_leg_haiku_4_5); 5 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 4% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,811      65  GATED             GATED             barrier>=30
      403      16,961      65  GATED             GATED             barrier>=30
      568      25,211      65  GATED             GATED             barrier>=30
...
2026-08-05T13:19:29Z  OK  records=16647 (+5)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.2m  drift=0  sci=OK  r115=22B  sweep=105.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T13:22:26Z  OK  records=16650 (+3)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.6m  drift=0  sci=OK  r115=22B  sweep=146.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T13:27:55Z  OK  records=16660 (+10)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.0m  drift=0  sci=OK  r115=22B  cores=1544  sweep=299.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
