...
**Auto-generated 2026-08-06 22:14 UTC -- T+217h05m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+217h05m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 11/240 (4.6% to fatal), pull on core, 5.3 h ago; none live, newest failure 5.3 h ago** |
...
| **cores computing** | **840** |
| **cores doing RUNG-RAISING work** | **32.1%** -- 272 of 848 cores (34 min old) |
...
```
generated 2026-08-06 22:15 UTC | elapsed 9.05 d | 20.1 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,633       0  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,468       0  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,901       0  GATED             GATED             no-records:test/distributional,test/scalar>=30
...
2026-08-06T22:10:43Z  OK  records=19970 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  sweep=431.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
