...
**Auto-generated 2026-08-04 17:33 UTC -- T+164h24m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+164h24m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-04 17:33 UTC | elapsed 6.85 d | 22.3 d to the Aug-27 stop
test tier: 12,077 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     204 records     204.0 rec/h
    last  3 h     521 records     173.7 rec/h
    last 12 h    2257 records     188.1 rec/h
    last 24 h    4051 records     168.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (188 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      28,251     204  GATED             GATED             barrier>=30
    ...
    !! 98% of the rung-568 backlog (27,554 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
