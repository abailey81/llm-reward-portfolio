...
| transport health | **timeouts 6h=21; worst streak 2/240 (0.8% to fatal), ops on kimi-k3, 22 min ago; none live, newest failure 22 min ago** |
...
| **cores computing** | **808** |
| **cores doing RUNG-RAISING work** | **22.6%** -- 184 of 816 cores (19 min old) |
...
```
generated 2026-08-06 13:03 UTC | elapsed 8.66 d | 20.5 d to the Aug-27 stop
...
```
2026-08-06T12:54:55Z  ATTN  records=19173 (+8)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=4.0m  drift=0  sci=OK  r115=22B  sweep=639.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
