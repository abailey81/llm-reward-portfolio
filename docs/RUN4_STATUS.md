...
**Auto-generated 2026-08-05 04:49 UTC -- T+175h40m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+175h40m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 04:49 UTC | elapsed 7.32 d | 21.8 d to the Aug-27 stop
test tier: 13,616 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      12 records      12.0 rec/h
    last  3 h      47 records      15.7 rec/h
    last 12 h    1700 records     141.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,312      12  GATED             GATED             barrier>=30
      189       7,762      12  GATED             GATED             barrier>=30
      279      12,262      12  GATED             GATED             barrier>=30
      340      15,312      12  GATED             GATED             barrier>=30
      403      18,462      12  GATED             GATED             barrier>=30
      568      26,712      12  GATED             GATED             barrier>=30
