...
**Auto-generated 2026-08-03 09:35 UTC -- T+132h26m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+132h26m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **841** (220 running, 621 queued) |
...
```
 rung             @1760 cores              @830 cores   binding
  ...
  568            8.5 d  08-06           18.1 d  08-15   throughput
```
...
| scalar | g5 of 5 | 1346 |
| placebo | g5 of 5 | 1456 |
| scalar_cvar5 | g5 of 5 | 1435 |
| placebo_shuffled | g5 of 5 | 1448 |
