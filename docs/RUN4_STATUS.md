...
**Auto-generated 2026-08-06 11:59 UTC -- T+206h50m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+206h50m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 12:00 UTC | elapsed 8.62 d | 20.5 d to the Aug-27 stop
test tier: 17,606 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,689       3  GATED             GATED             barrier>=30
      279       9,709      27  GATED             GATED             barrier>=30
      340      12,454      27  GATED             GATED             barrier>=30
      403      15,289      27  GATED             GATED             barrier>=30
      568      22,722      27  GATED             GATED             barrier>=30
