...
**Auto-generated 2026-08-05 05:43 UTC -- T+176h34m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+176h34m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 41 min ago; none live, newest failure 41 min ago** |
...
| | |
|---|---|
| cluster jobs | **975** (204 running, 771 queued) |
...
```
generated 2026-08-05 05:44 UTC | elapsed 7.36 d | 21.8 d to the Aug-27 stop
test tier: 13,777 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     163 records     163.0 rec/h
    last  3 h     181 records      60.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,238      76  GATED             GATED             barrier>=30
      189       7,601     163  GATED             GATED             barrier>=30
      279      12,101     163  GATED             GATED             barrier>=30
      340      15,151     163  GATED             GATED             barrier>=30
      403      18,301     163  GATED             GATED             barrier>=30
      568      26,551     163  GATED             GATED             barrier>=30
