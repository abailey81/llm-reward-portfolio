...
**Auto-generated 2026-08-03 21:33 UTC -- T+144h24m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+144h24m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **573** (192 running, 381 queued) |
...
```
generated 2026-08-03 21:33 UTC | elapsed 6.02 d | 23.1 d to the Aug-27 stop
test tier: 8,537 records over 62 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    12 h rate is 54% from ONE line (test_leg_gpt_5_6_luna); 3 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 54% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_gpt_5_6_luna) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.

EMPIRICAL ETA -- earliest = total remaining / the whole fleet's rate (assumes the
    cluster REDIRECTS freed slots, 170 rec/h); latest excludes cells
    already within 8 of the ceiling (79 rec/h), i.e. assumes
    the finishing line's slots are NOT reused. Window 12 h:
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         428       0  2026-08-04 00:03  2026-08-04 02:58  yes
      100       4,278       0  2026-08-04 22:38  2026-08-06 03:45  yes
      189       9,173       0  2026-08-06 03:21  2026-08-08 17:47  yes
      279      14,443     178  2026-08-07 10:15  2026-08-11 12:34  yes
      340      18,103     178  2026-08-08 07:43  2026-08-13 10:57  yes
      403      21,883     178  2026-08-09 05:54  2026-08-15 10:50  yes
      568      31,791     178  2026-08-11 16:00  2026-08-20 16:23  yes
