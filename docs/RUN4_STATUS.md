...
**Auto-generated 2026-08-12 03:20 UTC -- T+342h11m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+342h11m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **492** = 108 running + **56 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **864** |
| **cores doing RUNG-RAISING work** | **56.7%** -- 440 of 776 cores (108 min old **STALE**) |
...
```
generated 2026-08-12 03:21 UTC | elapsed 14.26 d | 14.9 d to the Aug-27 stop
test tier: 30,254 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    2472 records     103.0 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,361      70  GATED             GATED             barrier>=279
      403       3,566      70  GATED             GATED             barrier>=279
      568      10,074      86  GATED             GATED             barrier>=279
...
2026-08-12T03:15:09Z  OK  records=31792 (+60)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.4m  drift=0  sci=OK  r115=22B  cores=872  sweep=893.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
