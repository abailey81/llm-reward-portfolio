...
**Auto-generated 2026-08-05 17:10 UTC -- T+188h01m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+188h01m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 4.1 h ago; none live, newest failure 4.1 h ago** |
...
| | |
|---|---|
| cluster jobs | **880** (166 running, 714 queued) |
...
```
generated 2026-08-05 17:11 UTC | elapsed 7.83 d | 21.3 d to the Aug-27 stop
test tier: 15,828 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     195 records     195.0 rec/h
    last  3 h     584 records     194.7 rec/h
    last 12 h    2183 records     181.9 rec/h
    last 24 h    3841 records     160.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      403      16,471       2  GATED             GATED             barrier>=30
      568      24,500     195  GATED             GATED             barrier>=30
