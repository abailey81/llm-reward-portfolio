...
**Auto-generated 2026-08-06 15:39 UTC -- T+210h30m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+210h30m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 66 min ago; none live, newest failure 65 min ago** |
...
| | |
|---|---|
| cluster jobs | **861** (52 running, 809 queued) |
| **cores computing** | **416** |
| **cores doing RUNG-RAISING work** | **17.0%** -- 72 of 424 cores (0 min old) |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,259     270  GATED             GATED             unstarted:2-unit(s)-absent>=30
      340      12,004     270  GATED             GATED             unstarted:2-unit(s)-absent>=30
      403      14,839     270  GATED             GATED             unstarted:2-unit(s)-absent>=30
      568      22,272     270  GATED             GATED             unstarted:2-unit(s)-absent>=30
