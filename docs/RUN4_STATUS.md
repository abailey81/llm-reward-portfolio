...
**Auto-generated 2026-08-10 12:53 UTC -- T+303h44m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+303h44m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=6; worst streak 1/240 (0.4% to fatal), ops on core, 2.1 h ago; none live, newest failure 2.1 h ago** |
...
| | |
|---|---|
| cluster jobs | **803** = 149 running + **278 ELIGIBLE** + 376 held by us + 0 held only by the site |
...
| **cores doing RUNG-RAISING work** | **67.1%** -- 768 of 1144 cores (77 min old) |
...
```
generated 2026-08-10 12:55 UTC | elapsed 12.66 d | 16.5 d to the Aug-27 stop
test tier: 26,623 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189           1      31  2026-08-10 12:56  2026-08-10 12:56  yes
      279       2,525      33  2026-08-11 11:14  2026-08-11 11:14  yes
      340       4,660      33  2026-08-12 06:06  2026-08-12 06:06  yes
      403       6,865      33  2026-08-13 01:35  2026-08-13 01:35  yes
      568      13,705      80  2026-08-15 14:02  2026-08-15 14:02  yes
...
```
UNDECIDED (cluster unreachable or tag unresolved -- NOT an alarm): test_leg_nemotron_3_super, test_leg_glm_5_2, test, test_leg_deepseek_v4_pro, test_leg_qwen3_6_27b, test_leg_kimi_k3
