...
**Auto-generated 2026-08-02 14:57 UTC -- T+113h48m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+113h48m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **911** (241 running, 670 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1122 |
| scalar | g5 of 5 | 525 |
| placebo | g5 of 5 | 755 |
| scalar_cvar5 | g5 of 5 | 714 |
| placebo_shuffled | g5 of 5 | 700 |
...
```
2026-08-02T14:52:08Z  RED  records=4204 (+2)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=1.7m  drift=0  sci=OK  r115=21B  sweep=28.7s  auto-cycle
2026-08-02T14:53:07Z  RED  records=4204 (+0)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=21B  sweep=30.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T14:54:07Z  RED  records=4205 (+1)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.2m  drift=0  sci=OK  r115=21B  sweep=31.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T14:55:09Z  RED  records=4209 (+4)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=4.1m  drift=0  sci=OK  r115=21B  sweep=28.3s  auto-cycle
2026-08-02T14:56:08Z  RED  records=4209 (+0)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=21B  sweep=28.4s  auto-cycle
