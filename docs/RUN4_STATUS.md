...
**Auto-generated 2026-08-06 05:36 UTC -- T+200h27m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h27m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 5.5 h ago; none live, newest failure 5.5 h ago** |
...
| | |
|---|---|
| cluster jobs | **958** (72 running, 886 queued) |
| **cores computing** | **555** |
...
```
generated 2026-08-06 05:36 UTC | elapsed 8.35 d | 20.8 d to the Aug-27 stop
test tier: 17,227 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     110 records     110.0 rec/h
    last  3 h     152 records      50.7 rec/h
    last 12 h    1309 records     109.1 rec/h
    last 24 h    3486 records     145.2 rec/h
    12 h rate is 39% from ONE line (test_leg_haiku_4_5); 4 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 39% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_haiku_4_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,570      16  GATED             GATED             barrier>=30
      189       6,040     110  GATED             GATED             barrier>=30
      279      10,088     110  GATED             GATED             barrier>=30
      340      12,833     110  GATED             GATED             barrier>=30
      403      15,668     110  GATED             GATED             barrier>=30
      568      23,101     110  GATED             GATED             barrier>=30
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung      @555 cores      @830 cores   binding
       30           4.6 d           4.6 d   critical_chain
      100           5.7 d           4.6 d   critical_chain
      189           9.8 d           6.5 d   throughput
      279          13.9 d           9.3 d   throughput
      340          16.6 d          11.1 d   throughput
      403          19.5 d          13.0 d   throughput
      568          27.0 d          18.1 d   throughput
...
```
2026-08-06T05:20:43Z  OK  records=18717 (+6)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=31.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T05:21:42Z  OK  records=18720 (+3)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.5m  drift=0  sci=OK  r115=22B  sweep=28.4s  auto-cycle
2026-08-06T05:22:42Z  OK  records=18725 (+5)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=30.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T05:28:05Z  OK  records=18739 (+14)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  sweep=292.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T05:29:06Z  OK  records=18745 (+6)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=30.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T05:36:11Z  OK  records=18768 (+23)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.6m  drift=0  sci=OK  r115=22B  sweep=395.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
