...
**Auto-generated 2026-08-05 05:25 UTC -- T+176h16m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+176h16m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 23 min ago; none live, newest failure 23 min ago** |
...
| | |
|---|---|
| cluster jobs | **983** (202 running, 781 queued) |
...
```
generated 2026-08-05 05:25 UTC | elapsed 7.34 d | 21.8 d to the Aug-27 stop
test tier: 13,681 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      76 records      76.0 rec/h
    last  3 h      89 records      29.7 rec/h
    ...
    !! 60% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,252      71  GATED             GATED             barrier>=30
      189       7,697      76  GATED             GATED             barrier>=30
      279      12,197      76  GATED             GATED             barrier>=30
      340      15,247      76  GATED             GATED             barrier>=30
      403      18,397      76  GATED             GATED             barrier>=30
      568      26,647      76  GATED             GATED             barrier>=30
