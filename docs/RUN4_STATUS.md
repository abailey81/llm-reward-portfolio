...
**Auto-generated 2026-08-05 11:34 UTC -- T+182h25m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+182h25m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=3; worst streak 1/240 (0.4% to fatal), ops on core, 4.3 h ago; none live, newest failure 44 min ago** |
| transport timeouts (cumulative, ever) | 182 -- a level with no rate; read the row above |
...
| | |
|---|---|
| cluster jobs | **985** (187 running, 798 queued) |
...
```
generated 2026-08-05 11:34 UTC | elapsed 7.60 d | 21.5 d to the Aug-27 stop
test tier: 14,961 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     103 records     103.0 rec/h
    last  3 h     467 records     155.7 rec/h
    last 12 h    1665 records     138.8 rec/h
    last 24 h    3907 records     162.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,841       7  GATED             GATED             barrier>=30
      279      10,917     103  GATED             GATED             barrier>=30
      340      13,967     103  GATED             GATED             barrier>=30
      403      17,117     103  GATED             GATED             barrier>=30
      568      25,367     103  GATED             GATED             barrier>=30
