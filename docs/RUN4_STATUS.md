...
**Auto-generated 2026-08-06 00:45 UTC -- T+195h36m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h36m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,715     118  GATED             GATED             barrier>=30
      189       6,279     154  GATED             GATED             barrier>=30
      279      10,327     156  GATED             GATED             barrier>=30
      340      13,072     156  GATED             GATED             barrier>=30
      403      15,907     156  GATED             GATED             barrier>=30
      568      23,340     156  GATED             GATED             barrier>=30
