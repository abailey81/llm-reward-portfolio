...
| **cores computing** | **904** |
| **cores doing RUNG-RAISING work** | **21.2%** -- 192 of 904 cores (7 min old) |
...
```
generated 2026-08-06 10:28 UTC | elapsed 8.55 d | 20.6 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,729      57  GATED             GATED             barrier>=30
      279       9,777      57  GATED             GATED             barrier>=30
      340      12,522      57  GATED             GATED             barrier>=30
      403      15,357      57  GATED             GATED             barrier>=30
      568      22,790      57  GATED             GATED             barrier>=30
