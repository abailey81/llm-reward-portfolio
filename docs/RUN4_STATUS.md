...
**Auto-generated 2026-08-04 16:43 UTC -- T+163h34m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+163h34m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=11; worst streak 21/240 (8.8% to fatal), pull on core, 4.2 h ago; none live, newest failure 55 min ago** |
...
| | |
|---|---|
| cluster jobs | **227** (225 running, 0 queued) |
...
```
generated 2026-08-04 16:44 UTC | elapsed 6.82 d | 22.3 d to the Aug-27 stop
test tier: 11,905 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     139 records     139.0 rec/h
    last  3 h     518 records     172.7 rec/h
    last 12 h    2222 records     185.2 rec/h
    last 24 h    3981 records     165.9 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      28,423     139  GATED             GATED             barrier>=30
