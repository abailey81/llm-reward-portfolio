...
**Auto-generated 2026-08-06 18:00 UTC -- T+212h51m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+212h51m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=156; worst streak 11/240 (4.6% to fatal), pull on core, 64 min ago; none live, newest failure 62 min ago** |
...
| | |
|---|---|
| cluster jobs | **844** (73 running, 771 queued) |
| **cores computing** | **584** |
| **cores doing RUNG-RAISING work** | **28.3%** -- 136 of 480 cores (20 min old) |
...
```
2026-08-06T17:33:10Z  OK  records=19876 (+9)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.0m  drift=0  sci=OK  r115=22B  sweep=253.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T17:38:23Z  OK  records=19883 (+7)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  sweep=283.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T17:39:30Z  OK  records=19885 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  cores=480  sweep=36.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
