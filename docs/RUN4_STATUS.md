...
**Auto-generated 2026-08-01 16:52 UTC -- T+91h43m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+91h43m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **104** (98 running, 6 queued) |
| **cores computing** | **784** |
...
```
 rung              @784 cores              @830 cores   binding
  ...
  189            6.9 d  08-04            6.5 d  08-04   throughput
  279            9.8 d  08-07            9.3 d  08-07   throughput
  340           11.8 d  08-09           11.1 d  08-09   throughput
  403           13.8 d  08-11           13.0 d  08-10   throughput
  568           19.1 d  08-17           18.1 d  08-15   throughput
```
...
| scalar | g5 of 5 | 326 |
| placebo | g5 of 5 | 372 |
| scalar_cvar5 | g5 of 5 | 323 |
| placebo_shuffled | g5 of 5 | 284 |
...
```
2026-08-01T16:50:30Z  RED  records=2601 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=19B  sweep=17.9s  auto-cycle
2026-08-01T16:50:30Z  RED  records=2601 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=19B  sweep=18.7s  auto-cycle
2026-08-01T16:51:18Z  RED  records=2601 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=3.2m  drift=0  sci=OK  r115=19B  sweep=13.2s  auto-cycle
2026-08-01T16:51:19Z  RED  records=2601 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=3.2m  drift=0  sci=OK  r115=19B  sweep=13.1s  auto-cycle
2026-08-01T16:52:02Z  RED  records=2601 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=19B  sweep=17.8s  auto-cycle
2026-08-01T16:52:02Z  RED  records=2601 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=19B  sweep=17.2s  auto-cycle
```
...
```
  anthropic   spent $ 36.7418  + still to author $  0.2291  = $ 36.9709   credited $ 28.1500   margin $  -8.8209 (-31%)  over the credit ESTIMATE (owner-watched)
  openrouter  spent $  8.7012  + still to author $  0.2672  = $  8.9684   credited $ 19.3100   margin $ +10.3416 (+54%)  comfortable
```
