...
```
generated 2026-08-06 04:52 UTC | elapsed 8.32 d | 20.8 d to the Aug-27 stop
test tier: 17,132 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,576      45  GATED             GATED             barrier>=30
      189       6,135      50  GATED             GATED             barrier>=30
      279      10,183      50  GATED             GATED             barrier>=30
      340      12,928      50  GATED             GATED             barrier>=30
      403      15,763      50  GATED             GATED             barrier>=30
      568      23,196      50  GATED             GATED             barrier>=30
