...
**Auto-generated 2026-08-04 17:56 UTC -- T+164h47m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+164h47m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **200** (198 running, 0 queued) |
...
```
generated 2026-08-04 17:56 UTC | elapsed 6.87 d | 22.3 d to the Aug-27 stop
test tier: 12,206 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     269 records     269.0 rec/h
    last  3 h     567 records     189.0 rec/h
    last 12 h    2326 records     193.8 rec/h
    last 24 h    4155 records     173.1 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      28,122     269  GATED             GATED             barrier>=30
