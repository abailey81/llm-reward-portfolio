...
**Auto-generated 2026-08-04 23:59 UTC -- T+170h50m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+170h50m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 90 min ago; none live, newest failure 23 min ago** |
...
| | |
|---|---|
| cluster jobs | **972** (169 running, 801 queued) |
...
```
generated 2026-08-05 00:00 UTC | elapsed 7.12 d | 22.0 d to the Aug-27 stop
test tier: 13,357 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     173 records     173.0 rec/h
    last  3 h     475 records     158.3 rec/h
    last 12 h    2258 records     188.2 rec/h
    last 24 h    4236 records     176.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      26,971     173  GATED             GATED             barrier>=30
