...
```
generated 2026-08-06 06:15 UTC | elapsed 8.38 d | 20.7 d to the Aug-27 stop
test tier: 17,309 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,958     144  GATED             GATED             barrier>=30
      279      10,006     144  GATED             GATED             barrier>=30
      340      12,751     144  GATED             GATED             barrier>=30
      403      15,586     144  GATED             GATED             barrier>=30
      568      23,019     144  GATED             GATED             barrier>=30
