...
**Auto-generated 2026-08-02 16:43 UTC -- T+115h34m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+115h34m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **853** (232 running, 621 queued) |
...
```
 rung             @1856 cores              @830 cores   binding
  ...
  340            5.0 d  08-02           11.1 d  08-09   throughput
  403            5.8 d  08-03           13.0 d  08-10   throughput
  568            8.1 d  08-05           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 1208 |
| scalar | g5 of 5 | 611 |
| placebo | g5 of 5 | 848 |
| scalar_cvar5 | g5 of 5 | 808 |
| placebo_shuffled | g5 of 5 | 791 |
...
2026-08-02T16:39:03Z  RED  records=4633 (+6)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=21B  sweep=34.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T16:40:08Z  RED  records=4638 (+5)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=21B  sweep=33.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T16:41:11Z  RED  records=4646 (+8)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.9m  drift=0  sci=OK  r115=21B  sweep=31.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T16:42:13Z  RED  records=4650 (+4)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.4m  drift=0  sci=OK  r115=21B  sweep=34.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
