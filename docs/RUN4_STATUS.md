...
**Auto-generated 2026-08-04 23:14 UTC -- T+170h05m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+170h05m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 44 min ago; none live, newest failure 44 min ago** |
...
| | |
|---|---|
| cluster jobs | **994** (165 running, 827 queued) |
...
```
generated 2026-08-04 23:14 UTC | elapsed 7.09 d | 22.0 d to the Aug-27 stop
test tier: 13,235 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     186 records     186.0 rec/h
    last  3 h     565 records     188.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      27,093     186  GATED             GATED             barrier>=30
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung     @1320 cores      @830 cores   binding
