...
**Auto-generated 2026-08-05 13:10 UTC -- T+184h01m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+184h01m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on core, 5.9 h ago; LIVE, still failing** |
...
| | |
|---|---|
| cluster jobs | **965** (168 running, 797 queued) |
...
```
generated 2026-08-05 13:11 UTC | elapsed 7.67 d | 21.5 d to the Aug-27 stop
test tier: 15,094 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      50 records      50.0 rec/h
    last  3 h     318 records     106.0 rec/h
    last 12 h    1587 records     132.2 rec/h
    last 24 h    3777 records     157.4 rec/h
    12 h rate is 69% from ONE line (test_leg_haiku_4_5); 5 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 5% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_qwen3_5_9b, test_leg_sonnet_5) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279      10,891       0  GATED             GATED             barrier>=30
      340      13,834      50  GATED             GATED             barrier>=30
      403      16,984      50  GATED             GATED             barrier>=30
      568      25,234      50  GATED             GATED             barrier>=30
...
```
2026-08-05T12:50:16Z  ATTN  records=16610 (+7)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  sweep=320.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T12:52:40Z  ATTN  records=16614 (+4)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.3m  drift=0  sci=OK  r115=22B  sweep=113.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T12:56:31Z  ATTN  records=16620 (+6)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  sweep=201.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T13:03:05Z  ATTN  records=16630 (+10)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.3m  drift=0  sci=OK  r115=22B  sweep=363.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T13:06:49Z  OK  records=16632 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.1m  drift=0  sci=OK  r115=22B  cores=1344  sweep=194.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T13:08:59Z  OK  records=16634 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.9m  drift=0  sci=OK  r115=22B  sweep=99.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
