...
**Auto-generated 2026-08-06 03:30 UTC -- T+198h21m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,624       6  GATED             GATED             barrier>=30
      189       6,188       6  GATED             GATED             barrier>=30
      279      10,236       6  GATED             GATED             barrier>=30
      340      12,981       6  GATED             GATED             barrier>=30
      403      15,816       6  GATED             GATED             barrier>=30
      568      23,249       6  GATED             GATED             barrier>=30
