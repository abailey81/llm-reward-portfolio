...
**Auto-generated 2026-08-02 16:49 UTC -- T+115h40m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+115h40m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **849** (239 running, 610 queued) |
...
```
 rung             @1912 cores              @830 cores   binding
  ...
  340            4.8 d  08-02           11.1 d  08-09   throughput
  403            5.7 d  08-03           13.0 d  08-10   throughput
  568            7.8 d  08-05           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 1213 |
| scalar | g5 of 5 | 620 |
| placebo | g5 of 5 | 851 |
| scalar_cvar5 | g5 of 5 | 813 |
| placebo_shuffled | g5 of 5 | 795 |
...
```
2026-08-02T16:43:18Z  RED  records=4659 (+9)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=21B  sweep=32.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T16:44:21Z  RED  records=4660 (+1)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0  sci=OK  r115=21B  sweep=31.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T16:45:22Z  RED  records=4670 (+10)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=3.3m  drift=0  sci=OK  r115=21B  sweep=35.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T16:46:28Z  RED  records=4678 (+8)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=21B  sweep=62.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T16:48:00Z  RED  records=4679 (+1)  spend=$45.4819  guards=2  arms_full=10/10  budget=2  stalest=2.1m  drift=0  sci=OK  r115=21B  sweep=35.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
