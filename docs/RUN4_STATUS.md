...
**Auto-generated 2026-08-03 10:23 UTC -- T+133h14m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+133h14m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **801** (182 running, 619 queued) |
...
```
 rung             @1456 cores              @830 cores   binding
  ...
  568           10.3 d  08-08           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 1999 |
| scalar | g5 of 5 | 1415 |
| placebo | g5 of 5 | 1523 |
| scalar_cvar5 | g5 of 5 | 1498 |
| placebo_shuffled | g5 of 5 | 1515 |
