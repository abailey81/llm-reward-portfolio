...
**Auto-generated 2026-08-05 06:32 UTC -- T+177h23m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+177h23m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 1.5 h ago; none live, newest failure 1.5 h ago** |
...
| | |
|---|---|
| cluster jobs | **947** (208 running, 739 queued) |
...
```
generated 2026-08-05 06:33 UTC | elapsed 7.39 d | 21.7 d to the Aug-27 stop
test tier: 13,979 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       7,399     250  GATED             GATED             barrier>=30
      279      11,899     250  GATED             GATED             barrier>=30
      340      14,949     250  GATED             GATED             barrier>=30
      403      18,099     250  GATED             GATED             barrier>=30
      568      26,349     250  GATED             GATED             barrier>=30
