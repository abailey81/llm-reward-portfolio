...
**Auto-generated 2026-08-06 05:40 UTC -- T+200h31m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h31m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **953** (68 running, 885 queued) |
| **cores computing** | **544** |
...
```
generated 2026-08-06 05:41 UTC | elapsed 8.36 d | 20.8 d to the Aug-27 stop
test tier: 17,238 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,570      13  GATED             GATED             barrier>=30
      189       6,029     117  GATED             GATED             barrier>=30
      279      10,077     117  GATED             GATED             barrier>=30
      340      12,822     117  GATED             GATED             barrier>=30
      403      15,657     117  GATED             GATED             barrier>=30
      568      23,090     117  GATED             GATED             barrier>=30
