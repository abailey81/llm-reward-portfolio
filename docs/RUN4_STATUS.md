...
**Auto-generated 2026-08-06 02:07 UTC -- T+196h58m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+196h58m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 02:07 UTC | elapsed 8.21 d | 20.9 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,641      62  GATED             GATED             barrier>=30
      189       6,205      62  GATED             GATED             barrier>=30
      279      10,253      62  GATED             GATED             barrier>=30
      340      12,998      62  GATED             GATED             barrier>=30
      403      15,833      62  GATED             GATED             barrier>=30
      568      23,266      62  GATED             GATED             barrier>=30
