...
| transport health | **timeouts 6h=156; worst streak 7/240 (2.9% to fatal), pull on core, 0 min ago; LIVE, still failing** |
...
| **cores computing** | **?** |
| **cores doing RUNG-RAISING work** | **17.0%** -- 72 of 424 cores (66 min old) |
