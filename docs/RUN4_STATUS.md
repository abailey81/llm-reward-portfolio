...
**Auto-generated 2026-08-06 00:20 UTC -- T+195h11m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h11m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.3 h ago; none live, newest failure 16 min ago** |
...
| | |
|---|---|
| cluster jobs | **984** (66 running, 918 queued) |
| **cores computing** | **528** |
...
test tier: 16,961 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     239 records     239.0 rec/h
    last  3 h     559 records     186.3 rec/h
    last 12 h    1911 records     159.2 rec/h
    last 24 h    3555 records     148.1 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,735     170  GATED             GATED             barrier>=30
      189       6,305     238  GATED             GATED             barrier>=30
      279      10,354     239  GATED             GATED             barrier>=30
      340      13,099     239  GATED             GATED             barrier>=30
      403      15,934     239  GATED             GATED             barrier>=30
      568      23,367     239  GATED             GATED             barrier>=30
