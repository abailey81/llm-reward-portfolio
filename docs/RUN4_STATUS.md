...
**Auto-generated 2026-08-06 01:01 UTC -- T+195h52m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h52m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 6.0 h ago; none live, newest failure 58 min ago** |
...
```
generated 2026-08-06 01:02 UTC | elapsed 8.16 d | 21.0 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    1911 records     159.2 rec/h
    last 24 h    3510 records     146.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,705      91  GATED             GATED             barrier>=30
      189       6,269     103  GATED             GATED             barrier>=30
      279      10,317     105  GATED             GATED             barrier>=30
      340      13,062     105  GATED             GATED             barrier>=30
      403      15,897     105  GATED             GATED             barrier>=30
      568      23,330     105  GATED             GATED             barrier>=30
...
2026-08-06T01:01:28Z  ATTN  records=18541 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.3m  drift=0  sci=OK  r115=22B  sweep=26.3s  auto-cycle
2026-08-06T01:02:25Z  ATTN  records=18541 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.2m  drift=0  sci=OK  r115=22B  sweep=27.0s  auto-cycle
```
