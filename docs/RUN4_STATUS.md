...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 1.5 h ago; none live, newest failure 1.5 h ago** |
...
| | |
|---|---|
| cluster jobs | **874** (47 running, 827 queued) |
| **cores computing** | **376** |
| **cores doing RUNG-RAISING work** | **17.0%** -- 72 of 424 cores (26 min old) |
