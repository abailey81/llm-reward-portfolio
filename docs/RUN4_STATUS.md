...
**Auto-generated 2026-08-01 12:04 UTC -- T+86h55m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+86h55m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| scalar | g5 of 5 | 296 |
| placebo | g5 of 5 | 284 |
| scalar_cvar5 | g5 of 5 | 261 |
| placebo_shuffled | g5 of 5 | 247 |
...
```
2026-08-01T12:00:02Z  RED  records=2354 (+1)  spend=$44.2823  guards=2  arms_full=10/10  budget=2  stalest=2.0m  drift=0  sci=OK  r115=17B  sweep=16.0s  auto-cycle
2026-08-01T12:00:48Z  RED  records=2355 (+1)  spend=$44.2823  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0  sci=OK  r115=17B  sweep=15.4s  auto-cycle
2026-08-01T12:01:34Z  RED  records=2355 (+0)  spend=$44.2823  guards=2  arms_full=10/10  budget=2  stalest=2.1m  drift=0  sci=OK  r115=17B  sweep=17.1s  auto-cycle
2026-08-01T12:02:21Z  RED  records=2355 (+0)  spend=$44.2823  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=17B  sweep=16.4s  auto-cycle
2026-08-01T12:03:08Z  RED  records=2356 (+1)  spend=$44.2823  guards=2  arms_full=10/10  budget=2  stalest=2.1m  drift=0  sci=OK  r115=17B  sweep=23.1s  auto-cycle
2026-08-01T12:04:01Z  RED  records=2357 (+1)  spend=$44.2823  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=17B  cores=944  sweep=18.6s  auto-cycle
```
...
```
  anthropic   spent $ 35.9845  + still to author $  2.1097  = $ 38.0942   credited $ 28.1500   margin $  -9.9442 (-35%)  over the credit ESTIMATE (owner-watched)
