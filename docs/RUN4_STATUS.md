...
**Auto-generated 2026-08-06 04:03 UTC -- T+198h54m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+198h54m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 04:03 UTC | elapsed 8.29 d | 20.8 d to the Aug-27 stop
test tier: 17,094 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      16 records      16.0 rec/h
    last  3 h      95 records      31.7 rec/h
    last 12 h    1488 records     124.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,609      16  GATED             GATED             barrier>=30
      189       6,173      16  GATED             GATED             barrier>=30
      279      10,221      16  GATED             GATED             barrier>=30
      340      12,966      16  GATED             GATED             barrier>=30
      403      15,801      16  GATED             GATED             barrier>=30
      568      23,234      16  GATED             GATED             barrier>=30
...
2026-08-06T04:02:46Z  OK  records=18637 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  sweep=27.8s  auto-cycle
```
