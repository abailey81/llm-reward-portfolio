...
**Auto-generated 2026-08-06 12:00 UTC -- T+206h51m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+206h51m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 12:01 UTC | elapsed 8.62 d | 20.5 d to the Aug-27 stop
test tier: 17,607 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,689       1  GATED             GATED             barrier>=30
      279       9,708      26  GATED             GATED             barrier>=30
      340      12,453      26  GATED             GATED             barrier>=30
      403      15,288      26  GATED             GATED             barrier>=30
      568      22,721      26  GATED             GATED             barrier>=30
