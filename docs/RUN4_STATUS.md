...
**Auto-generated 2026-08-06 07:20 UTC -- T+202h11m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+202h11m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 07:20 UTC | elapsed 8.42 d | 20.7 d to the Aug-27 stop
test tier: 17,359 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h      36 records      36.0 rec/h
    last  3 h     252 records      84.0 rec/h
    last 12 h    1179 records      98.2 rec/h
    last 24 h    3208 records     133.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,908      36  GATED             GATED             barrier>=30
      279       9,956      36  GATED             GATED             barrier>=30
      340      12,701      36  GATED             GATED             barrier>=30
      403      15,536      36  GATED             GATED             barrier>=30
      568      22,969      36  GATED             GATED             barrier>=30
