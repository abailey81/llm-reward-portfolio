...
**Auto-generated 2026-08-05 11:22 UTC -- T+182h13m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+182h13m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on core, 4.1 h ago; none live, newest failure 32 min ago** |
...
| | |
|---|---|
| cluster jobs | **989** (181 running, 808 queued) |
...
```
generated 2026-08-05 11:22 UTC | elapsed 7.59 d | 21.5 d to the Aug-27 stop
test tier: 14,939 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     128 records     128.0 rec/h
    last  3 h     486 records     162.0 rec/h
    last 12 h    1675 records     139.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30         180      11  GATED             GATED             barrier
      100       2,980      11  GATED             GATED             barrier>=30
      189       6,841      28  GATED             GATED             barrier>=30
      279      10,939     128  GATED             GATED             barrier>=30
      340      13,989     128  GATED             GATED             barrier>=30
      403      17,139     128  GATED             GATED             barrier>=30
      568      25,389     128  GATED             GATED             barrier>=30
