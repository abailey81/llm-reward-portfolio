...
**Auto-generated 2026-08-06 05:13 UTC -- T+200h04m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h04m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 05:13 UTC | elapsed 8.34 d | 20.8 d to the Aug-27 stop
test tier: 17,160 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,570      32  GATED             GATED             barrier>=30
      189       6,107      59  GATED             GATED             barrier>=30
      279      10,155      59  GATED             GATED             barrier>=30
      340      12,900      59  GATED             GATED             barrier>=30
      403      15,735      59  GATED             GATED             barrier>=30
      568      23,168      59  GATED             GATED             barrier>=30
