...
| transport health | **timeouts 6h=156; worst streak 8/240 (3.3% to fatal), pull on core, 3 min ago; LIVE, still failing** |
...
| **cores computing** | **?** |
| **cores doing RUNG-RAISING work** | **17.0%** -- 72 of 424 cores (71 min old) |
