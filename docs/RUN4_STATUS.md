...
**Auto-generated 2026-08-03 01:02 UTC -- T+123h53m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+123h53m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **662** (274 running, 388 queued) |
| **cores computing** | **2192** |

Per-rung ETAs from the registered model at the cores we actually hold:

```
 rung             @2192 cores              @830 cores   binding
...
|---|---|---|
| distributional | g5 of 5 | 1535 |
| scalar | g5 of 5 | 947 |
| placebo | g5 of 5 | 1149 |
| scalar_cvar5 | g5 of 5 | 1110 |
