...
**Auto-generated 2026-08-06 00:39 UTC -- T+195h30m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h30m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.6 h ago; none live, newest failure 36 min ago** |
...
| | |
|---|---|
| cluster jobs | **975** (68 running, 907 queued) |
| **cores computing** | **544** |
...
```
generated 2026-08-06 00:40 UTC | elapsed 8.15 d | 21.0 d to the Aug-27 stop
test tier: 16,985 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     170 records     170.0 rec/h
    last  3 h     565 records     188.3 rec/h
    last 12 h    1925 records     160.4 rec/h
    last 24 h    3543 records     147.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,717     128  GATED             GATED             barrier>=30
      189       6,282     168  GATED             GATED             barrier>=30
      279      10,330     170  GATED             GATED             barrier>=30
      340      13,075     170  GATED             GATED             barrier>=30
      403      15,910     170  GATED             GATED             barrier>=30
      568      23,343     170  GATED             GATED             barrier>=30
