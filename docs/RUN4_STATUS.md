...
**Auto-generated 2026-08-11 16:34 UTC -- T+331h25m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+331h25m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on core, 4.0 h ago; none live, newest failure 4.0 h ago** |
...
| | |
|---|---|
| cluster jobs | **470** = 69 running + **73 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **552** |
| **cores doing RUNG-RAISING work** | **36.1%** -- 240 of 664 cores (61 min old) |
...
```
generated 2026-08-11 16:34 UTC | elapsed 13.81 d | 15.3 d to the Aug-27 stop
test tier: 29,567 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     494 records     164.7 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last 12 h    1599 records     133.2 rec/h   usable
    last 24 h    2665 records     111.0 rec/h   usable
    12 h rate is 98% from ONE line (test); 2 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279         160       0  2026-08-11 17:46  2026-08-11 17:46  yes
      340       2,032     142  2026-08-12 07:49  2026-08-12 07:49  yes
      403       4,237     142  2026-08-13 00:22  2026-08-13 00:22  yes
      568      10,761     142  2026-08-15 01:20  2026-08-15 01:20  yes
...
> **What is holding it right now: test -- baseline_log_growth has 117 HOLE(S) below its frontier 406 -- that is what caps this line**
