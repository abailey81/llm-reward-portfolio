...
**Auto-generated 2026-08-04 16:46 UTC -- T+163h37m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+163h37m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=11; worst streak 21/240 (8.8% to fatal), pull on core, 4.3 h ago; none live, newest failure 57 min ago** |
...
| | |
|---|---|
| cluster jobs | **226** (224 running, 0 queued) |
...
```
generated 2026-08-04 16:47 UTC | elapsed 6.82 d | 22.3 d to the Aug-27 stop
test tier: 11,910 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     136 records     136.0 rec/h
    last  3 h     514 records     171.3 rec/h
    last 12 h    2223 records     185.2 rec/h
    last 24 h    3980 records     165.8 rec/h
    12 h rate is 98% from ONE line (test_leg_sonnet_5); 2 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (185 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,904       0  GATED             GATED             barrier>=30
      189       8,354       0  GATED             GATED             barrier>=30
      279      12,854       0  GATED             GATED             barrier>=30
      340      15,904       0  GATED             GATED             barrier>=30
      403      19,054       0  GATED             GATED             barrier>=30
      568      28,418     136  GATED             GATED             barrier>=30
    ...
    !! 96% of the rung-568 backlog (27,312 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
...
2026-08-04T16:22:37Z  OK  records=13382 (+4)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.0m  drift=0  sci=OK  r115=22B  sweep=215.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T16:27:18Z  OK  records=13392 (+10)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.4m  drift=0  sci=OK  r115=22B  sweep=250.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T16:33:13Z  OK  records=13399 (+7)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.1m  drift=0  sci=OK  r115=22B  cores=1824  sweep=325.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T16:39:58Z  OK  records=13428 (+29)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.2m  drift=0  sci=OK  r115=22B  sweep=374.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-04T16:44:35Z  OK  records=13436 (+8)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.1m  drift=0  sci=OK  r115=22B  sweep=246.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
