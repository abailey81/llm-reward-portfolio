...
**Auto-generated 2026-08-06 11:33 UTC -- T+206h24m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+206h24m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **848** |
| **cores doing RUNG-RAISING work** | **22.6%** -- 192 of 848 cores (11 min old) |
...
```
generated 2026-08-06 11:34 UTC | elapsed 8.60 d | 20.5 d to the Aug-27 stop
test tier: 17,596 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,689      33  GATED             GATED             barrier>=30
      279       9,719      51  GATED             GATED             barrier>=30
      340      12,464      51  GATED             GATED             barrier>=30
      403      15,299      51  GATED             GATED             barrier>=30
      568      22,732      51  GATED             GATED             barrier>=30
