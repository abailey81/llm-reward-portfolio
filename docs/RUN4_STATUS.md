...
**Auto-generated 2026-08-04 18:20 UTC -- T+165h11m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+165h11m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 21/240 (8.8% to fatal), pull on core, 5.8 h ago; none live, newest failure 2.5 h ago** |
...
| | |
|---|---|
| cluster jobs | **182** (180 running, 0 queued) |
...
```
generated 2026-08-04 18:21 UTC | elapsed 6.88 d | 22.2 d to the Aug-27 stop
test tier: 12,285 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     260 records     260.0 rec/h
    last  3 h     580 records     193.3 rec/h
    last 12 h    2360 records     196.7 rec/h
    last 24 h    4203 records     175.1 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,893      11  GATED             GATED             barrier>=30
      189       8,343      11  GATED             GATED             barrier>=30
      279      12,843      11  GATED             GATED             barrier>=30
      340      15,893      11  GATED             GATED             barrier>=30
      403      19,043      11  GATED             GATED             barrier>=30
      568      28,043     260  GATED             GATED             barrier>=30
