...
**Auto-generated 2026-08-06 07:12 UTC -- T+202h03m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+202h03m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 07:13 UTC | elapsed 8.42 d | 20.7 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     259 records      86.3 rec/h
    last 12 h    1190 records      99.2 rec/h
    last 24 h    3231 records     134.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,908      51  GATED             GATED             barrier>=30
      279       9,956      51  GATED             GATED             barrier>=30
      340      12,701      51  GATED             GATED             barrier>=30
      403      15,536      51  GATED             GATED             barrier>=30
      568      22,969      51  GATED             GATED             barrier>=30
