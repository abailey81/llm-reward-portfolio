...
**Auto-generated 2026-08-05 04:36 UTC -- T+175h27m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+175h27m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 04:37 UTC | elapsed 7.31 d | 21.8 d to the Aug-27 stop
test tier: 13,608 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,320       4  GATED             GATED             barrier>=30
      189       7,770       4  GATED             GATED             barrier>=30
      279      12,270       4  GATED             GATED             barrier>=30
      340      15,320       4  GATED             GATED             barrier>=30
      403      18,470       4  GATED             GATED             barrier>=30
      568      26,720       4  GATED             GATED             barrier>=30
