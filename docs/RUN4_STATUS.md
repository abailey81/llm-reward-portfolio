...
**Auto-generated 2026-08-05 14:35 UTC -- T+185h26m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+185h26m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 3.8 h ago; none live, newest failure 1.5 h ago** |
...
| | |
|---|---|
| cluster jobs | **940** (182 running, 758 queued) |
...
```
generated 2026-08-05 14:36 UTC | elapsed 7.73 d | 21.4 d to the Aug-27 stop
test tier: 15,333 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     203 records     203.0 rec/h
    last  3 h     367 records     122.3 rec/h
    last 12 h    1741 records     145.1 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (144 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,636     162  GATED             GATED             barrier>=30
      403      16,745     203  GATED             GATED             barrier>=30
      568      24,995     203  GATED             GATED             barrier>=30
