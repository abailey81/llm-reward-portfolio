...
**Auto-generated 2026-08-06 02:49 UTC -- T+197h40m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+197h40m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     223 records      74.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,626      40  GATED             GATED             barrier>=30
      189       6,190      40  GATED             GATED             barrier>=30
      279      10,238      40  GATED             GATED             barrier>=30
      340      12,983      40  GATED             GATED             barrier>=30
      403      15,818      40  GATED             GATED             barrier>=30
      568      23,251      40  GATED             GATED             barrier>=30
