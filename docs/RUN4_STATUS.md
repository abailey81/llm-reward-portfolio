...
**Auto-generated 2026-08-07 00:51 UTC -- T+219h43m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| cluster jobs | **831** = 110 running + **175 ELIGIBLE** + 546 held by us + 0 held only by the site |
...
```
generated 2026-08-07 00:52 UTC | elapsed 9.16 d | 20.0 d to the Aug-27 stop
test tier: 18,475 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,476      34  GATED             GATED             no-records:test/distributional,test/scalar>=30
      189       5,591      34  GATED             GATED             no-records:test/distributional,test/scalar>=30
      279       9,121      34  GATED             GATED             no-records:test/distributional,test/scalar>=30
      340      11,585      48  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,420      48  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,853      48  GATED             GATED             no-records:test/distributional,test/scalar>=30
