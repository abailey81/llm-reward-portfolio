...
**Auto-generated 2026-08-12 10:32 UTC -- T+349h23m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+349h23m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **409** = 90 running + **0 ELIGIBLE** + 319 held by us + 0 held only by the site |
...
| **cores computing** | **720** |
| **cores doing RUNG-RAISING work** | **100.0%** -- 776 of 776 cores (60 min old) |
...
```
generated 2026-08-12 10:33 UTC | elapsed 14.56 d | 14.6 d to the Aug-27 stop
test tier: 30,870 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340         906     100  2026-08-12 23:41  2026-08-12 23:41  yes
      403       3,111     100  2026-08-14 07:38  2026-08-14 07:38  yes
      568       9,458     100  2026-08-18 03:37  2026-08-18 03:37  yes
...
currently at **314 seeds each** (read live from the archive on this publish). !! THE
