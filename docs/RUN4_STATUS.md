...
**Auto-generated 2026-08-05 14:06 UTC -- T+184h57m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+184h57m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 3.3 h ago; none live, newest failure 61 min ago** |
...
| | |
|---|---|
| cluster jobs | **956** (189 running, 767 queued) |
...
```
generated 2026-08-05 14:07 UTC | elapsed 7.71 d | 21.4 d to the Aug-27 stop
test tier: 15,225 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     134 records     134.0 rec/h
    last  3 h     311 records     103.7 rec/h
    last 12 h    1641 records     136.8 rec/h
    last 24 h    3769 records     157.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,703     134  GATED             GATED             barrier>=30
      403      16,853     134  GATED             GATED             barrier>=30
      568      25,103     134  GATED             GATED             barrier>=30
