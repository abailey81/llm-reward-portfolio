...
```
generated 2026-08-06 01:52 UTC | elapsed 8.20 d | 20.9 d to the Aug-27 stop
test tier: 17,038 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,665      44  GATED             GATED             barrier>=30
      189       6,229      44  GATED             GATED             barrier>=30
      279      10,277      44  GATED             GATED             barrier>=30
      340      13,022      44  GATED             GATED             barrier>=30
      403      15,857      44  GATED             GATED             barrier>=30
      568      23,290      44  GATED             GATED             barrier>=30
