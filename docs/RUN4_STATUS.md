...
**Auto-generated 2026-08-04 17:35 UTC -- T+164h26m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+164h26m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=11; worst streak 21/240 (8.8% to fatal), pull on core, 5.1 h ago; none live, newest failure 1.8 h ago** |
...
| | |
|---|---|
| cluster jobs | **213** (211 running, 0 queued) |
...
```
generated 2026-08-04 17:36 UTC | elapsed 6.85 d | 22.3 d to the Aug-27 stop
test tier: 12,098 records over 63 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     211 records     211.0 rec/h
    last  3 h     535 records     178.3 rec/h
    last 12 h    2272 records     189.3 rec/h
    last 24 h    4068 records     169.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    8 of the ceiling (189 rec/h). Window 12 h.
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      28,230     211  GATED             GATED             barrier>=30
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
    ...
    critical-chain floor: 4.64 d total, 0.37 d still to run   (tpe owes 2 of 30 candidates)
