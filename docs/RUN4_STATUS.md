...
**Auto-generated 2026-08-11 10:45 UTC -- T+325h36m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+325h36m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores doing RUNG-RAISING work** | **87.4%** -- 1000 of 1144 cores (72 min old) |
...
```
generated 2026-08-11 10:46 UTC | elapsed 13.57 d | 15.6 d to the Aug-27 stop
test tier: 28,781 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279         683     104  2026-08-11 16:42  2026-08-11 16:42  yes
      340       2,818     104  2026-08-12 11:16  2026-08-12 11:16  yes
      403       5,023     104  2026-08-13 06:26  2026-08-13 06:26  yes
      568      11,547     104  2026-08-15 15:10  2026-08-15 15:10  yes
...
> **What is holding it right now: test -- baseline_log_growth has 155 HOLE(S) below its frontier 406 -- that is what caps this line**
