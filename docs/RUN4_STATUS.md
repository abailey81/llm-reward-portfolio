...
**Auto-generated 2026-08-01 22:21 UTC -- T+97h12m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+97h12m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| scalar | g5 of 5 | 326 |
| placebo | g5 of 5 | 498 |
| scalar_cvar5 | g5 of 5 | 423 |
| placebo_shuffled | g5 of 5 | 307 |
...
```
2026-08-01T22:16:53Z  RED  records=2849 (+1)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=2.4m  drift=0  sci=OK  r115=19B  sweep=18.7s  auto-cycle
2026-08-01T22:17:42Z  RED  records=2850 (+1)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=19B  sweep=18.7s  auto-cycle
2026-08-01T22:18:31Z  RED  records=2851 (+1)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=3.3m  drift=0  sci=OK  r115=19B  sweep=20.2s  auto-cycle
2026-08-01T22:19:22Z  RED  records=2851 (+0)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=4.3m  drift=0  sci=OK  r115=19B  sweep=25.5s  auto-cycle
2026-08-01T22:20:18Z  RED  records=2851 (+0)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=2.6m  drift=0  sci=OK  r115=19B  sweep=18.7s  auto-cycle
2026-08-01T22:21:06Z  RED  records=2851 (+0)  spend=$45.4541  guards=2  arms_full=10/10  budget=2  stalest=1.9m  drift=0  sci=OK  r115=19B  sweep=26.5s  auto-cycle
```
