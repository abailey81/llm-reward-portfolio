...
**Auto-generated 2026-08-06 15:05 UTC -- T+209h56m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+209h56m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 31 min ago; none live, newest failure 31 min ago** |
...
| **cores computing** | **624** |
| **cores doing RUNG-RAISING work** | **22.6%** -- 184 of 816 cores (141 min old **STALE**) |
...
```
generated 2026-08-06 15:05 UTC | elapsed 8.75 d | 20.4 d to the Aug-27 stop
test tier: 17,904 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30          69      46  GATED             GATED             unstarted:2-unit(s)-absent
      100       2,519      46  GATED             GATED             unstarted:2-unit(s)-absent>=30
      189       5,634      47  GATED             GATED             unstarted:2-unit(s)-absent>=30
      279       9,411     219  GATED             GATED             unstarted:2-unit(s)-absent>=30
      340      12,156     219  GATED             GATED             unstarted:2-unit(s)-absent>=30
      403      14,991     219  GATED             GATED             unstarted:2-unit(s)-absent>=30
      568      22,424     219  GATED             GATED             unstarted:2-unit(s)-absent>=30
...
```
2026-08-06T14:52:35Z  OK  records=19375 (+10)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=29.9s  auto-cycle
2026-08-06T14:53:35Z  OK  records=19382 (+7)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.3m  drift=0  sci=OK  r115=22B  sweep=29.6s  auto-cycle
