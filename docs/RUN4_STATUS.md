...
**Auto-generated 2026-08-05 01:04 UTC -- T+171h55m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+171h55m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 2.6 h ago; none live, newest failure 88 min ago** |
...
| | |
|---|---|
| cluster jobs | **950** (172 running, 776 queued) |
...
```
generated 2026-08-05 01:05 UTC | elapsed 7.16 d | 22.0 d to the Aug-27 stop
test tier: 13,491 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     122 records     122.0 rec/h
    last  3 h     462 records     154.0 rec/h
    last 12 h    2192 records     182.7 rec/h
    last 24 h    4245 records     176.9 rec/h
    12 h rate is 50% from ONE line (test_leg_sonnet_5); 10 line(s) contributed at all
    (windows under 12 h are a STALL INDICATOR ONLY and do not price the ETA -- the arrival quantum is a 15 h pack-8 job)
    !! 56% of the 12 h window came from cell(s) now within 8 records of rung 568 (test_leg_sonnet_5, test_leg_qwen3_5_9b) -- that rate STOPS. The ETA below assumes the cluster redirects those slots; it is an assumption, not a measurement.
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      26,837     122  GATED             GATED             barrier>=30
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung     @1376 cores      @830 cores   binding
      ...
      340           6.7 d          11.1 d   throughput
      403           7.9 d          13.0 d   throughput
      568          10.9 d          18.1 d   throughput
