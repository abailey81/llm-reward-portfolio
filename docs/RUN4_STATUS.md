...
**Auto-generated 2026-08-06 10:38 UTC -- T+205h29m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+205h29m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **904** |
| **cores doing RUNG-RAISING work** | **21.2%** -- 192 of 904 cores (18 min old) |
...
```
generated 2026-08-06 10:38 UTC | elapsed 8.56 d | 20.6 d to the Aug-27 stop
test tier: 17,546 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    12 h rate is 80% from ONE line (test_leg_kimi_k3); 3 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,721      37  GATED             GATED             barrier>=30
      279       9,769      37  GATED             GATED             barrier>=30
      340      12,514      37  GATED             GATED             barrier>=30
      403      15,349      37  GATED             GATED             barrier>=30
      568      22,782      37  GATED             GATED             barrier>=30
