...
**Auto-generated 2026-08-06 04:14 UTC -- T+199h05m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+199h05m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 4.2 h ago; none live, newest failure 4.2 h ago** |
...
| | |
|---|---|
| cluster jobs | **960** (68 running, 892 queued) |
| **cores computing** | **544** |
...
```
generated 2026-08-06 04:14 UTC | elapsed 8.30 d | 20.8 d to the Aug-27 stop
test tier: 17,101 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,602      22  GATED             GATED             barrier>=30
      189       6,166      22  GATED             GATED             barrier>=30
      279      10,214      22  GATED             GATED             barrier>=30
      340      12,959      22  GATED             GATED             barrier>=30
      403      15,794      22  GATED             GATED             barrier>=30
      568      23,227      22  GATED             GATED             barrier>=30
