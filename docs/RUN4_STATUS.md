...
**Auto-generated 2026-08-05 06:09 UTC -- T+177h00m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+177h00m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on qwen3_6-27b, 67 min ago; none live, newest failure 67 min ago** |
...
| | |
|---|---|
| cluster jobs | **959** (211 running, 748 queued) |
| **cores computing** | **1688** |
...
```
generated 2026-08-05 06:09 UTC | elapsed 7.38 d | 21.7 d to the Aug-27 stop
test tier: 13,902 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     259 records     259.0 rec/h
    last  3 h     305 records     101.7 rec/h
    last 12 h    1655 records     137.9 rec/h
    last 24 h    3997 records     166.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,238      47  GATED             GATED             barrier>=30
      189       7,476     259  GATED             GATED             barrier>=30
      279      11,976     259  GATED             GATED             barrier>=30
      340      15,026     259  GATED             GATED             barrier>=30
      403      18,176     259  GATED             GATED             barrier>=30
      568      26,426     259  GATED             GATED             barrier>=30
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung     @1688 cores      @830 cores   binding
