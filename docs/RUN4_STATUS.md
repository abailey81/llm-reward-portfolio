...
**Auto-generated 2026-08-06 20:31 UTC -- T+215h22m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+215h22m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=26; worst streak 11/240 (4.6% to fatal), pull on core, 3.6 h ago; none live, newest failure 3.5 h ago** |
...
| **cores computing** | **816** |
| **cores doing RUNG-RAISING work** | **29.4%** -- 240 of 816 cores (6 min old) |
...
```
generated 2026-08-06 20:31 UTC | elapsed 8.97 d | 20.1 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,641       8  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,476       8  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,909       8  GATED             GATED             no-records:test/distributional,test/scalar>=30
