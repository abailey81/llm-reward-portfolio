...
**Auto-generated 2026-08-06 00:28 UTC -- T+195h19m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,722     165  GATED             GATED             barrier>=30
      189       6,292     214  GATED             GATED             barrier>=30
      279      10,340     216  GATED             GATED             barrier>=30
      340      13,085     216  GATED             GATED             barrier>=30
      403      15,920     216  GATED             GATED             barrier>=30
      568      23,353     216  GATED             GATED             barrier>=30
