...
**Auto-generated 2026-08-05 15:19 UTC -- T+186h10m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+186h10m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 4.5 h ago; none live, newest failure 2.2 h ago** |
...
| | |
|---|---|
| cluster jobs | **916** (191 running, 725 queued) |
...
```
generated 2026-08-05 15:20 UTC | elapsed 7.76 d | 21.4 d to the Aug-27 stop
test tier: 15,514 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     236 records     236.0 rec/h
    last  3 h     464 records     154.7 rec/h
    last 12 h    1912 records     159.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,636      18  GATED             GATED             barrier>=30
      403      16,564     236  GATED             GATED             barrier>=30
      568      24,814     236  GATED             GATED             barrier>=30
