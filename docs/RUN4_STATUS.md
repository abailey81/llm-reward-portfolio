...
**Auto-generated 2026-08-13 01:18 UTC -- T+364h09m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+364h09m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **320** = 50 running + **204 ELIGIBLE** + 66 held by us + 0 held only by the site |
...
| **cores computing** | **400** |
| **cores doing RUNG-RAISING work** | **43.8%** -- 112 of 256 cores (106 min old **STALE**) |
...
```
generated 2026-08-13 01:19 UTC | elapsed 15.17 d | 13.9 d to the Aug-27 stop
test tier: 31,536 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 29.0 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h     348 records      29.0 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    the whole fleet (29 rec/h); latest excludes cells already within
    8 of the ceiling (29 rec/h). Window 12 h.
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340         424       0  2026-08-13 15:56  2026-08-13 15:56  yes
      403       2,445       0  2026-08-16 13:38  2026-08-16 13:38  yes
      568       8,792       0  2026-08-25 16:30  2026-08-25 16:30  yes
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung      @400 cores      @830 cores   binding
       30           4.6 d           4.6 d   critical_chain
      100           7.9 d           4.6 d   critical_chain
      189          13.5 d           6.5 d   throughput
      279          19.2 d           9.3 d   throughput
      340          23.1 d          11.1 d   throughput
      403          27.1 d          13.0 d   throughput
      568          37.5 d          18.1 d   throughput
