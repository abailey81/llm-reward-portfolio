...
**Auto-generated 2026-08-06 05:32 UTC -- T+200h23m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+200h23m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 05:33 UTC | elapsed 8.35 d | 20.8 d to the Aug-27 stop
test tier: 17,219 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     106 records     106.0 rec/h
    last  3 h     144 records      48.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       6,048     106  GATED             GATED             barrier>=30
      279      10,096     106  GATED             GATED             barrier>=30
      340      12,841     106  GATED             GATED             barrier>=30
      403      15,676     106  GATED             GATED             barrier>=30
      568      23,109     106  GATED             GATED             barrier>=30
