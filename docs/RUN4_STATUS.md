...
**Auto-generated 2026-08-05 15:47 UTC -- T+186h38m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+186h38m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 15:47 UTC | elapsed 7.78 d | 21.3 d to the Aug-27 stop
test tier: 15,565 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     171 records     171.0 rec/h
    last  3 h     498 records     166.0 rec/h
    last 12 h    1961 records     163.4 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      403      16,513     171  GATED             GATED             barrier>=30
      568      24,763     171  GATED             GATED             barrier>=30
