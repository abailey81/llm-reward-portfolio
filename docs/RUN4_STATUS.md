...
**Auto-generated 2026-08-06 04:08 UTC -- T+198h59m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+198h59m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-06 04:09 UTC | elapsed 8.29 d | 20.8 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h      98 records      32.7 rec/h
    last 12 h    1472 records     122.7 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,605      19  GATED             GATED             barrier>=30
      189       6,169      19  GATED             GATED             barrier>=30
      279      10,217      19  GATED             GATED             barrier>=30
      340      12,962      19  GATED             GATED             barrier>=30
      403      15,797      19  GATED             GATED             barrier>=30
      568      23,230      19  GATED             GATED             barrier>=30
