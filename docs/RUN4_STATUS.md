...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 2.6 h ago; none live, newest failure 2.6 h ago** |
...
```
generated 2026-08-06 02:43 UTC | elapsed 8.23 d | 20.9 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,627      46  GATED             GATED             barrier>=30
      189       6,191      46  GATED             GATED             barrier>=30
      279      10,239      46  GATED             GATED             barrier>=30
      340      12,984      46  GATED             GATED             barrier>=30
      403      15,819      46  GATED             GATED             barrier>=30
      568      23,252      46  GATED             GATED             barrier>=30
...
```
2026-08-06T02:24:46Z  OK  records=18610 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  sweep=28.1s  auto-cycle
