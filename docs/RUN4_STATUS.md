...
**Auto-generated 2026-08-05 07:37 UTC -- T+178h29m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+178h29m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **919** (199 running, 720 queued) |
...
```
generated 2026-08-05 07:38 UTC | elapsed 7.44 d | 21.7 d to the Aug-27 stop
test tier: 14,241 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     242 records     242.0 rec/h
    last  3 h     630 records     210.0 rec/h
    last 12 h    1694 records     141.2 rec/h
    last 24 h    4096 records     170.7 rec/h
    12 h rate is 45% from ONE line (test_leg_haiku_4_5); 10 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       7,237     142  GATED             GATED             barrier>=30
      279      11,637     242  GATED             GATED             barrier>=30
      340      14,687     242  GATED             GATED             barrier>=30
      403      17,837     242  GATED             GATED             barrier>=30
      568      26,087     242  GATED             GATED             barrier>=30
