...
**Auto-generated 2026-08-06 00:05 UTC -- T+194h56m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+194h56m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
test tier: 16,902 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,788     130  GATED             GATED             barrier>=30
      189       6,363     231  GATED             GATED             barrier>=30
      279      10,413     231  GATED             GATED             barrier>=30
      340      13,158     231  GATED             GATED             barrier>=30
      403      15,993     231  GATED             GATED             barrier>=30
      568      23,426     231  GATED             GATED             barrier>=30
