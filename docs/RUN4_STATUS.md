...
**Auto-generated 2026-08-06 12:13 UTC -- T+207h05m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+207h05m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **824** |
| **cores doing RUNG-RAISING work** | **22.1%** -- 184 of 832 cores (1 min old) |
...
```
generated 2026-08-06 12:14 UTC | elapsed 8.63 d | 20.5 d to the Aug-27 stop
test tier: 17,615 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,700      24  GATED             GATED             barrier>=30
      340      12,445      24  GATED             GATED             barrier>=30
      403      15,280      24  GATED             GATED             barrier>=30
      568      22,713      24  GATED             GATED             barrier>=30
    ...
    !! 85% of the rung-568 backlog (19,336 records) sits on cells that produced NOTHING in the 12 h window -- work behind a stage barrier (C1 chain / C3 gate) is not accelerated by redirected cores. Neither column models when it starts.
