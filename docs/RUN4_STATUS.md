...
```
generated 2026-08-06 06:11 UTC | elapsed 8.38 d | 20.7 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 12 h    1266 records     105.5 rec/h
    last 24 h    3390 records     141.2 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,964     145  GATED             GATED             barrier>=30
      279      10,012     145  GATED             GATED             barrier>=30
      340      12,757     145  GATED             GATED             barrier>=30
      403      15,592     145  GATED             GATED             barrier>=30
      568      23,025     145  GATED             GATED             barrier>=30
