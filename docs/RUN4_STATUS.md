...
**Auto-generated 2026-08-03 08:15 UTC -- T+131h06m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+131h06m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **914** (278 running, 636 queued) |
| **cores computing** | **2224** |

Per-rung ETAs from the registered model at the cores we actually hold:

```
 rung             @2224 cores              @830 cores   binding
