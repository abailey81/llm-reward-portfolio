...
**Auto-generated 2026-08-06 12:15 UTC -- T+207h06m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+207h06m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **824** |
| **cores doing RUNG-RAISING work** | **22.1%** -- 184 of 832 cores (2 min old) |
...
```
generated 2026-08-06 12:15 UTC | elapsed 8.63 d | 20.5 d to the Aug-27 stop
test tier: 17,617 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,698      26  GATED             GATED             barrier>=30
      340      12,443      26  GATED             GATED             barrier>=30
      403      15,278      26  GATED             GATED             barrier>=30
      568      22,711      26  GATED             GATED             barrier>=30
