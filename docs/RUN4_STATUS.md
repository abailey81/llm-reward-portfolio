...
**Auto-generated 2026-08-05 07:11 UTC -- T+178h02m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+178h02m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **931** (198 running, 733 queued) |
...
```
generated 2026-08-05 07:11 UTC | elapsed 7.42 d | 21.7 d to the Aug-27 stop
test tier: 14,123 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       7,259     204  GATED             GATED             barrier>=30
      279      11,755     208  GATED             GATED             barrier>=30
      340      14,805     208  GATED             GATED             barrier>=30
      403      17,955     208  GATED             GATED             barrier>=30
      568      26,205     208  GATED             GATED             barrier>=30
