...
**Auto-generated 2026-08-04 23:58 UTC -- T+170h49m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+170h49m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 88 min ago; none live, newest failure 22 min ago** |
...
| | |
|---|---|
| cluster jobs | **973** (170 running, 801 queued) |
...
```
generated 2026-08-04 23:58 UTC | elapsed 7.12 d | 22.0 d to the Aug-27 stop
test tier: 13,356 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     181 records     181.0 rec/h
    last  3 h     484 records     161.3 rec/h
    last 12 h    2260 records     188.3 rec/h
    last 24 h    4238 records     176.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      26,972     181  GATED             GATED             barrier>=30
