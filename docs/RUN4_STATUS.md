...
**Auto-generated 2026-08-05 06:46 UTC -- T+177h37m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+177h37m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **942** (204 running, 738 queued) |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       7,361     221  GATED             GATED             barrier>=30
      279      11,861     221  GATED             GATED             barrier>=30
      340      14,911     221  GATED             GATED             barrier>=30
      403      18,061     221  GATED             GATED             barrier>=30
      568      26,311     221  GATED             GATED             barrier>=30
