...
**Auto-generated 2026-08-06 00:27 UTC -- T+195h18m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h18m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.4 h ago; none live, newest failure 23 min ago** |
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,722     170  GATED             GATED             barrier>=30
      189       6,292     220  GATED             GATED             barrier>=30
      279      10,340     222  GATED             GATED             barrier>=30
      340      13,085     222  GATED             GATED             barrier>=30
      403      15,920     222  GATED             GATED             barrier>=30
      568      23,353     222  GATED             GATED             barrier>=30
