...
**Auto-generated 2026-08-06 00:15 UTC -- T+195h06m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h06m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.2 h ago; none live, newest failure 11 min ago** |
...
| | |
|---|---|
| cluster jobs | **989** (63 running, 926 queued) |
| **cores computing** | **504** |
...
```
generated 2026-08-06 00:15 UTC | elapsed 8.13 d | 21.0 d to the Aug-27 stop
test tier: 16,934 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     230 records     230.0 rec/h
    last  3 h     535 records     178.3 rec/h
    last 12 h    1888 records     157.3 rec/h
    last 24 h    3541 records     147.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,760     149  GATED             GATED             barrier>=30
      189       6,332     229  GATED             GATED             barrier>=30
      279      10,381     230  GATED             GATED             barrier>=30
      340      13,126     230  GATED             GATED             barrier>=30
      403      15,961     230  GATED             GATED             barrier>=30
      568      23,394     230  GATED             GATED             barrier>=30
