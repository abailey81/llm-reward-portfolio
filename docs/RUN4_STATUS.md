...
**Auto-generated 2026-08-06 11:39 UTC -- T+206h30m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+206h30m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **848** |
| **cores doing RUNG-RAISING work** | **22.6%** -- 192 of 848 cores (16 min old) |
...
```
generated 2026-08-06 11:39 UTC | elapsed 8.60 d | 20.5 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,689      31  GATED             GATED             barrier>=30
      279       9,717      51  GATED             GATED             barrier>=30
      340      12,462      51  GATED             GATED             barrier>=30
      403      15,297      51  GATED             GATED             barrier>=30
      568      22,730      51  GATED             GATED             barrier>=30
