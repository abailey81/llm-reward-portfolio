...
```
generated 2026-08-06 00:13 UTC | elapsed 8.13 d | 21.0 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    3536 records     147.3 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,769     140  GATED             GATED             barrier>=30
      189       6,342     229  GATED             GATED             barrier>=30
      279      10,392     229  GATED             GATED             barrier>=30
      340      13,137     229  GATED             GATED             barrier>=30
      403      15,972     229  GATED             GATED             barrier>=30
      568      23,405     229  GATED             GATED             barrier>=30
