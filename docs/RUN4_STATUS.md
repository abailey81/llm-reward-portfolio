...
```
generated 2026-08-06 07:21 UTC | elapsed 8.43 d | 20.7 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     250 records      83.3 rec/h
    last 12 h    1179 records      98.2 rec/h
    last 24 h    3206 records     133.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,908      34  GATED             GATED             barrier>=30
      279       9,956      34  GATED             GATED             barrier>=30
      340      12,701      34  GATED             GATED             barrier>=30
      403      15,536      34  GATED             GATED             barrier>=30
      568      22,969      34  GATED             GATED             barrier>=30
