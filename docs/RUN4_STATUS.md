...
**Auto-generated 2026-08-11 15:16 UTC -- T+330h07m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+330h07m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on core, 2.7 h ago; none live, newest failure 2.7 h ago** |
...
| | |
|---|---|
| cluster jobs | **498** = 92 running + **78 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **736** |
| **cores doing RUNG-RAISING work** | **59.0%** -- 576 of 976 cores (103 min old **STALE**) |
...
```
generated 2026-08-11 15:16 UTC | elapsed 13.76 d | 15.4 d to the Aug-27 stop
test tier: 29,370 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 133.4 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    last  1 h     193 records     193.0 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last  3 h     426 records     142.0 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    last 12 h    1601 records     133.4 rec/h   usable
    last 24 h    2562 records     106.8 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279         160     127  2026-08-11 16:28  2026-08-11 16:28  yes
      340       2,229     193  2026-08-12 07:59  2026-08-12 07:59  yes
      403       4,434     193  2026-08-13 00:30  2026-08-13 00:30  yes
      568      10,958     193  2026-08-15 01:24  2026-08-15 01:24  yes
...
> **What is holding it right now: test -- baseline_log_growth has 127 HOLE(S) below its frontier 406 -- that is what caps this line**
...
currently at **280 seeds each** (read live from the archive on this publish). !! THE
...
2026-08-11T15:00:02Z  OK  records=30809 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=801.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T15:12:38Z  OK  records=30893 (+84)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.4m  drift=0  sci=OK  r115=22B  cores=752  sweep=726.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-11T15:14:02Z  OK  records=30897 (+4)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.1m  drift=0  sci=OK  r115=22B  sweep=53.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
