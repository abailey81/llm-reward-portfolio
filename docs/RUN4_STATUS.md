...
**Auto-generated 2026-08-06 14:52 UTC -- T+209h43m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+209h43m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 19 min ago; none live, newest failure 19 min ago** |
...
| | |
|---|---|
| cluster jobs | **877** (83 running, 794 queued) |
| **cores computing** | **664** |
| **cores doing RUNG-RAISING work** | **22.6%** -- 184 of 816 cores (129 min old **STALE**) |
...
```
generated 2026-08-06 14:53 UTC | elapsed 8.74 d | 20.4 d to the Aug-27 stop
test tier: 17,841 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
       30          72      45  GATED             GATED             unstarted:2-unit(s)-absent
      100       2,522      45  GATED             GATED             unstarted:2-unit(s)-absent>=30
      189       5,637      48  GATED             GATED             unstarted:2-unit(s)-absent>=30
      279       9,474     173  GATED             GATED             unstarted:2-unit(s)-absent>=30
      340      12,219     173  GATED             GATED             unstarted:2-unit(s)-absent>=30
      403      15,054     173  GATED             GATED             unstarted:2-unit(s)-absent>=30
      568      22,487     173  GATED             GATED             unstarted:2-unit(s)-absent>=30
...
2026-08-06T14:48:35Z  OK  records=19349 (+60)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.0m  drift=0  sci=OK  r115=22B  sweep=629.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T14:49:38Z  OK  records=19360 (+11)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.1m  drift=0  sci=OK  r115=22B  sweep=32.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T14:50:36Z  OK  records=19365 (+5)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.1m  drift=0  sci=OK  r115=22B  sweep=28.2s  auto-cycle
2026-08-06T14:51:35Z  OK  records=19365 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.0m  drift=0  sci=OK  r115=22B  sweep=28.3s  auto-cycle
