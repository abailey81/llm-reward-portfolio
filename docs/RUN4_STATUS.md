...
**Auto-generated 2026-08-02 08:14 UTC -- T+107h05m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+107h05m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **396** (190 running, 206 queued) |
...
```
 rung             @1520 cores              @830 cores   binding
  ...
  403            7.1 d  08-05           13.0 d  08-10   throughput
...
```
2026-08-02T08:09:33Z  RED  records=3353 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=21B  sweep=19.9s  auto-cycle
2026-08-02T08:10:23Z  RED  records=3353 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=3.8m  drift=0  sci=OK  r115=21B  sweep=20.8s  auto-cycle
2026-08-02T08:11:14Z  RED  records=3354 (+1)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=21B  sweep=39.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-02T08:12:24Z  RED  records=3354 (+0)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.5m  drift=0  sci=OK  r115=21B  sweep=21.6s  auto-cycle
2026-08-02T08:13:15Z  RED  records=3355 (+1)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=21B  sweep=21.8s  auto-cycle
2026-08-02T08:14:07Z  RED  records=3356 (+1)  spend=$45.4651  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=21B  sweep=21.8s  auto-cycle
```
