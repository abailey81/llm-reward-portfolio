...
**Auto-generated 2026-08-09 09:12 UTC -- T+276h03m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+276h03m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| records archived | **24901** |
| **Myriad maintenance** | **2026-08-12 from 08:00 UTC, at risk all day** (in 2.9 days). Delayed from Aug 11. Jobs may die and REQUEUE idempotently; the supervisors ride it. Playbook: docs/ops/MAINTENANCE_2026-08-12.md |
| LLM calls / spend | 2956 / **$45.5021** |
| transport health | **timeouts 6h=0; worst streak 0/240 (0.0% to fatal), - on -, age UNKNOWN; none live, newest failure 42.0 h ago** |
...
| | |
|---|---|
| cluster jobs | **708** = 136 running + **133 ELIGIBLE** + 439 held by us + 0 held only by the site |
...
| **cores doing RUNG-RAISING work** | **47.0%** -- 496 of 1056 cores (99 min old **STALE**) |
...
```
generated 2026-08-09 09:12 UTC | elapsed 11.50 d | 17.6 d to the Aug-27 stop
test tier: 23,358 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100           0       4  REACHED           REACHED           yes
      189       2,352      69  2026-08-10 08:34  2026-08-10 08:34  yes
      279       5,502      69  2026-08-11 15:52  2026-08-11 15:52  yes
      340       7,637      69  2026-08-12 13:04  2026-08-12 13:04  yes
      403       9,894      75  2026-08-13 11:30  2026-08-13 11:30  yes
      568      16,970      75  2026-08-16 09:47  2026-08-16 09:47  yes
...
| glm_5_2 | **147** | 150 | 5 |  |
| deepseek_v4_pro | **153** | 156 | 5 |  |
| qwen3_6_27b | **391** | 394 | 5 |  |
| kimi_k3 | **471** | 474 | 5 |  |
...
currently at **100 seeds each** (read live from the archive on this publish). !! THE
...
2026-08-09T08:41:58Z  OK  records=24853 (+20)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  sweep=1447.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-09T08:56:53Z  OK  records=24886 (+33)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  cores=1120  sweep=864.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-09T08:58:02Z  OK  records=24886 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=39.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
