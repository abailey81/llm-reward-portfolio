...
**Auto-generated 2026-08-06 00:58 UTC -- T+195h49m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h49m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 5.9 h ago; none live, newest failure 54 min ago** |
...
```
generated 2026-08-06 00:58 UTC | elapsed 8.16 d | 21.0 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last 24 h    3518 records     146.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,705     100  GATED             GATED             barrier>=30
      189       6,269     117  GATED             GATED             barrier>=30
      279      10,317     119  GATED             GATED             barrier>=30
      340      13,062     119  GATED             GATED             barrier>=30
      403      15,897     119  GATED             GATED             barrier>=30
      568      23,330     119  GATED             GATED             barrier>=30
