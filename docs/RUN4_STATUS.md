...
**Auto-generated 2026-08-09 00:17 UTC -- T+267h08m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+267h08m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **793** = 111 running + **243 ELIGIBLE** + 439 held by us + 0 held only by the site |
...
| **cores computing** | **888** |
| **cores doing RUNG-RAISING work** | **46.3%** -- 400 of 864 cores (45 min old) |
...
```
generated 2026-08-09 00:18 UTC | elapsed 11.13 d | 18.0 d to the Aug-27 stop
test tier: 22,672 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100         247      33  2026-08-09 02:32  2026-08-09 02:32  yes
      189       2,879     129  2026-08-10 02:16  2026-08-10 02:16  yes
      279       6,029     129  2026-08-11 06:40  2026-08-11 06:40  yes
      340       8,164     129  2026-08-12 01:55  2026-08-12 01:55  yes
      403      10,516     180  2026-08-12 23:07  2026-08-12 23:07  yes
      568      17,656     180  2026-08-15 15:29  2026-08-15 15:29  yes
...
| deepseek_v4_pro | **136** | 137 | 5 |  |
| qwen3_6_27b | **372** | 375 | 5 |  |
| kimi_k3 | **458** | 462 | 5 |  |
...
currently at **85 seeds each** (read live from the archive on this publish). !! THE
...
```
2026-08-08T23:52:34Z  OK  records=24125 (+50)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  cores=888  sweep=767.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-08T23:53:43Z  OK  records=24125 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.7m  drift=0  sci=OK  r115=22B  sweep=38.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-08T23:54:51Z  OK  records=24129 (+4)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=38.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
