...
**Auto-generated 2026-08-06 18:15 UTC -- T+213h06m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+213h06m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=156; worst streak 11/240 (4.6% to fatal), pull on core, 79 min ago; none live, newest failure 77 min ago** |
...
| **cores computing** | **592** |
| **cores doing RUNG-RAISING work** | **28.8%** -- 168 of 584 cores (14 min old) |
...
```
generated 2026-08-06 18:16 UTC | elapsed 8.88 d | 20.2 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,697      65  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,532      65  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,965      65  GATED             GATED             no-records:test/distributional,test/scalar>=30
...
```
2026-08-06T17:46:43Z  OK  records=19885 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=403.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
