...
| transport health | **timeouts 6h=21; worst streak 2/240 (0.8% to fatal), ops on kimi-k3, 32 min ago; none live, newest failure 32 min ago** |
...
| **cores computing** | **808** |
| **cores doing RUNG-RAISING work** | **22.6%** -- 184 of 816 cores (29 min old) |
...
```
generated 2026-08-06 13:13 UTC | elapsed 8.67 d | 20.4 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,679      21  GATED             GATED             barrier>=30
      340      12,424      21  GATED             GATED             barrier>=30
      403      15,259      21  GATED             GATED             barrier>=30
      568      22,692      21  GATED             GATED             barrier>=30
