...
**Auto-generated 2026-08-03 07:06 UTC -- T+129h57m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+129h57m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **944** (287 running, 657 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1764 |
| scalar | g5 of 5 | 1172 |
| placebo | g5 of 5 | 1300 |
| scalar_cvar5 | g5 of 5 | 1267 |
| placebo_shuffled | g5 of 5 | 1276 |
...
2026-08-03T07:06:10Z  RED  records=7178 (+3)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=3.1m  drift=0  sci=OK  r115=21B  sweep=64.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
