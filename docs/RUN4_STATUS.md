...
**Auto-generated 2026-08-05 06:34 UTC -- T+177h25m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+177h25m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
```
generated 2026-08-05 06:34 UTC | elapsed 7.39 d | 21.7 d to the Aug-27 stop
test tier: 13,987 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     253 records     253.0 rec/h
    last  3 h     384 records     128.0 rec/h
    last 12 h    1660 records     138.3 rec/h
    last 24 h    4032 records     168.0 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       7,391     253  GATED             GATED             barrier>=30
      279      11,891     253  GATED             GATED             barrier>=30
      340      14,941     253  GATED             GATED             barrier>=30
      403      18,091     253  GATED             GATED             barrier>=30
      568      26,341     253  GATED             GATED             barrier>=30
