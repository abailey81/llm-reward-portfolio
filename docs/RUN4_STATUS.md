...
**Auto-generated 2026-08-11 11:57 UTC -- T+326h48m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+326h48m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on kimi-k3, 40 min ago; none live, newest failure 40 min ago** |
...
| | |
|---|---|
| cluster jobs | **556** = 130 running + **98 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores doing RUNG-RAISING work** | **77.9%** -- 816 of 1048 cores (24 min old) |
...
```
generated 2026-08-11 11:58 UTC | elapsed 13.62 d | 15.5 d to the Aug-27 stop
test tier: 28,899 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279         565      94  2026-08-11 16:56  2026-08-11 16:56  yes
      340       2,700      94  2026-08-12 11:42  2026-08-12 11:42  yes
      403       4,905      94  2026-08-13 07:05  2026-08-13 07:05  yes
      568      11,429      94  2026-08-15 16:26  2026-08-15 16:26  yes
...
> **What is holding it right now: test -- baseline_log_growth has 151 HOLE(S) below its frontier 406 -- that is what caps this line**
