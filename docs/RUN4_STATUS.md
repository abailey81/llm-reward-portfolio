...
**Auto-generated 2026-08-01 16:36 UTC -- T+91h27m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+91h27m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **106** (96 running, 10 queued) |
| **cores computing** | **768** |
...
```
 rung              @768 cores              @830 cores   binding
  ...
  189            7.1 d  08-04            6.5 d  08-04   throughput
  279           10.0 d  08-07            9.3 d  08-07   throughput
  340           12.0 d  08-09           11.1 d  08-09   throughput
  403           14.1 d  08-11           13.0 d  08-10   throughput
  568           19.5 d  08-17           18.1 d  08-15   throughput
```
...
```
2026-08-01T16:32:51Z  RED  records=2597 (+1)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=1.9m  drift=0  sci=OK  r115=19B  sweep=19.5s  auto-cycle
2026-08-01T16:33:40Z  RED  records=2597 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=19B  sweep=23.8s  auto-cycle
2026-08-01T16:33:41Z  RED  records=2597 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.8m  drift=0  sci=OK  r115=19B  sweep=23.4s  auto-cycle
2026-08-01T16:34:35Z  RED  records=2597 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=19B  sweep=17.6s  auto-cycle
2026-08-01T16:34:34Z  RED  records=2597 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=19B  sweep=17.7s  auto-cycle
2026-08-01T16:35:23Z  RED  records=2597 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=19B  sweep=17.4s  auto-cycle
```
