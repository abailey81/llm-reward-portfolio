...
**Auto-generated 2026-08-05 19:20 UTC -- T+190h11m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+190h11m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 17 min ago; none live, newest failure 17 min ago** |
...
| | |
|---|---|
| cluster jobs | **830** (116 running, 714 queued) |
| **cores computing** | **928** |
...
```
generated 2026-08-05 19:21 UTC | elapsed 7.93 d | 21.2 d to the Aug-27 stop
test tier: 16,179 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     109 records     109.0 rec/h
    last  3 h     523 records     174.3 rec/h
    last 12 h    2027 records     168.9 rec/h
    last 24 h    3690 records     153.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      24,149     109  GATED             GATED             barrier>=30
