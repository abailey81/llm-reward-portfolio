...
**Auto-generated 2026-08-06 02:00 UTC -- T+196h51m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+196h51m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 1.9 h ago; none live, newest failure 1.9 h ago** |
...
```
generated 2026-08-06 02:00 UTC | elapsed 8.20 d | 20.9 d to the Aug-27 stop
test tier: 17,049 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,654      51  GATED             GATED             barrier>=30
      189       6,218      51  GATED             GATED             barrier>=30
      279      10,266      51  GATED             GATED             barrier>=30
      340      13,011      51  GATED             GATED             barrier>=30
      403      15,846      51  GATED             GATED             barrier>=30
      568      23,279      51  GATED             GATED             barrier>=30
