...
**Auto-generated 2026-08-05 17:27 UTC -- T+188h18m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+188h18m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 4.4 h ago; none live, newest failure 4.4 h ago** |
...
| | |
|---|---|
| cluster jobs | **871** (157 running, 714 queued) |
...
```
generated 2026-08-05 17:28 UTC | elapsed 7.85 d | 21.3 d to the Aug-27 stop
test tier: 15,887 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      24,441     208  GATED             GATED             barrier>=30
