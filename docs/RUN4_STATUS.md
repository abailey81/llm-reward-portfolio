...
```
generated 2026-08-06 00:49 UTC | elapsed 8.15 d | 21.0 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,710     115  GATED             GATED             barrier>=30
      189       6,274     143  GATED             GATED             barrier>=30
      279      10,322     145  GATED             GATED             barrier>=30
      340      13,067     145  GATED             GATED             barrier>=30
      403      15,902     145  GATED             GATED             barrier>=30
      568      23,335     145  GATED             GATED             barrier>=30
