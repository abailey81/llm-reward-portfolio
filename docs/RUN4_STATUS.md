...
**Auto-generated 2026-08-06 19:40 UTC -- T+214h31m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+214h31m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **836** = 100 running + **24 ELIGIBLE** + 565 held by us + 147 held only by the site |
...
| **cores computing** | **800** |
| **cores doing RUNG-RAISING work** | **31.8%** -- 216 of 680 cores (46 min old) |
...
```
generated 2026-08-06 19:40 UTC | elapsed 8.94 d | 20.2 d to the Aug-27 stop
test tier: 18,417 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,643      41  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,478      41  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,911      41  GATED             GATED             no-records:test/distributional,test/scalar>=30
