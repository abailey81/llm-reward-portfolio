...
**Auto-generated 2026-08-03 07:04 UTC -- T+129h56m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+129h56m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **944** (285 running, 659 queued) |
...
|---|---|---|
| distributional | g5 of 5 | 1763 |
| scalar | g5 of 5 | 1172 |
| placebo | g5 of 5 | 1299 |
| scalar_cvar5 | g5 of 5 | 1267 |
| placebo_shuffled | g5 of 5 | 1275 |
...
2026-08-03T06:59:56Z  RED  records=7155 (+11)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=21B  cores=2296  sweep=155.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T07:03:02Z  RED  records=7161 (+6)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=21B  sweep=66.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-03T07:04:39Z  RED  records=7175 (+14)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=2.2m  drift=0  sci=OK  r115=21B  sweep=60.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
