...
```
generated 2026-08-06 11:33 UTC | elapsed 8.60 d | 20.5 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,689      35  GATED             GATED             barrier>=30
      279       9,719      53  GATED             GATED             barrier>=30
      340      12,464      53  GATED             GATED             barrier>=30
      403      15,299      53  GATED             GATED             barrier>=30
      568      22,732      53  GATED             GATED             barrier>=30
