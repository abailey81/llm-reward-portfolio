...
**Auto-generated 2026-08-06 15:32 UTC -- T+210h23m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+210h23m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=156; worst streak 2/240 (0.8% to fatal), ops on core, 58 min ago; none live, newest failure 58 min ago** |
...
| **cores computing** | **456** |
| **cores doing RUNG-RAISING work** | **22.6%** -- 184 of 816 cores (168 min old **STALE**) |
...
```
generated 2026-08-06 15:32 UTC | elapsed 8.77 d | 20.4 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  1 h     279 records     279.0 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279       9,277     279  GATED             GATED             unstarted:2-unit(s)-absent>=30
      340      12,022     279  GATED             GATED             unstarted:2-unit(s)-absent>=30
      403      14,857     279  GATED             GATED             unstarted:2-unit(s)-absent>=30
      568      22,290     279  GATED             GATED             unstarted:2-unit(s)-absent>=30
