...
**Auto-generated 2026-08-05 16:23 UTC -- T+187h14m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+187h14m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=7; worst streak 1/240 (0.4% to fatal), ops on deepseek-v4-pro, 5.6 h ago; none live, newest failure 3.3 h ago** |
...
| | |
|---|---|
| cluster jobs | **899** (177 running, 722 queued) |
...
```
generated 2026-08-05 16:24 UTC | elapsed 7.80 d | 21.3 d to the Aug-27 stop
test tier: 15,662 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      403      16,471      80  GATED             GATED             barrier>=30
      568      24,666     135  GATED             GATED             barrier>=30
...
```
2026-08-05T15:49:56Z  OK  records=17110 (+11)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  cores=1464  sweep=294.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T15:56:09Z  OK  records=17125 (+15)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  sweep=343.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T16:00:08Z  OK  records=17136 (+11)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.4m  drift=0  sci=OK  r115=22B  sweep=208.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T16:05:13Z  OK  records=17151 (+15)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.5m  drift=0  sci=OK  r115=22B  sweep=275.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
