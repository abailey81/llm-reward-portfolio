...
```
generated 2026-08-06 06:31 UTC | elapsed 8.39 d | 20.7 d to the Aug-27 stop
test tier: 17,348 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     132 records     132.0 rec/h
    last  3 h     269 records      89.7 rec/h
    last 12 h    1244 records     103.7 rec/h
    last 24 h    3375 records     140.6 rec/h
    12 h rate is 45% from ONE line (test_leg_kimi_k3); 4 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,919     132  GATED             GATED             barrier>=30
      279       9,967     132  GATED             GATED             barrier>=30
      340      12,712     132  GATED             GATED             barrier>=30
      403      15,547     132  GATED             GATED             barrier>=30
      568      22,980     132  GATED             GATED             barrier>=30
