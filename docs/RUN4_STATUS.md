...
**Auto-generated 2026-08-05 19:14 UTC -- T+190h05m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+190h05m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on haiku-4_5, 11 min ago; none live, newest failure 11 min ago** |
...
| | |
|---|---|
| cluster jobs | **831** (117 running, 714 queued) |
| **cores computing** | **936** |
...
```
generated 2026-08-05 19:15 UTC | elapsed 7.92 d | 21.2 d to the Aug-27 stop
test tier: 16,170 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     121 records     121.0 rec/h
    last  3 h     530 records     176.7 rec/h
    last 12 h    2034 records     169.5 rec/h
    last 24 h    3704 records     154.3 rec/h
    12 h rate is 80% from ONE line (test_leg_haiku_4_5); 3 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      568      24,158     121  GATED             GATED             barrier>=30
...
2026-08-05T18:54:10Z  ATTN  records=17680 (+19)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.1m  drift=0  sci=OK  r115=22B  sweep=377.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T19:00:12Z  ATTN  records=17693 (+13)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.3m  drift=0  sci=OK  r115=22B  sweep=331.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T19:03:59Z  ATTN  records=17699 (+6)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.7m  drift=0  sci=OK  r115=22B  sweep=197.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T19:09:20Z  OK  records=17707 (+8)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.1m  drift=0  sci=OK  r115=22B  cores=944  sweep=290.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-05T19:15:20Z  OK  records=17713 (+6)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.2m  drift=0  sci=OK  r115=22B  sweep=330.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
