...
**Auto-generated 2026-08-06 00:12 UTC -- T+195h03m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+195h03m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **991** (65 running, 926 queued) |
| **cores computing** | **520** |
...
```
generated 2026-08-06 00:12 UTC | elapsed 8.13 d | 21.0 d to the Aug-27 stop
test tier: 16,923 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     233 records     233.0 rec/h
    last  3 h     528 records     176.0 rec/h
    last 12 h    1878 records     156.5 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,769     142  GATED             GATED             barrier>=30
      189       6,342     233  GATED             GATED             barrier>=30
      279      10,392     233  GATED             GATED             barrier>=30
      340      13,137     233  GATED             GATED             barrier>=30
      403      15,972     233  GATED             GATED             barrier>=30
      568      23,405     233  GATED             GATED             barrier>=30
