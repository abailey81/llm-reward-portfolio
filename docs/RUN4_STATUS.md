...
**Auto-generated 2026-08-06 10:52 UTC -- T+205h43m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+205h43m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores computing** | **880** |
| **cores doing RUNG-RAISING work** | **21.4%** -- 192 of 896 cores (2 min old) |
...
```
generated 2026-08-06 10:52 UTC | elapsed 8.57 d | 20.5 d to the Aug-27 stop
test tier: 17,566 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       5,701      45  GATED             GATED             barrier>=30
      279       9,749      45  GATED             GATED             barrier>=30
      340      12,494      45  GATED             GATED             barrier>=30
      403      15,329      45  GATED             GATED             barrier>=30
      568      22,762      45  GATED             GATED             barrier>=30
