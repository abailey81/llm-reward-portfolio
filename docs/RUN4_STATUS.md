...
**Auto-generated 2026-08-06 02:05 UTC -- T+196h56m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+196h56m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on nemotron-3-super, 2.0 h ago; none live, newest failure 2.0 h ago** |
...
```
generated 2026-08-06 02:06 UTC | elapsed 8.21 d | 20.9 d to the Aug-27 stop
test tier: 17,060 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       2,643      61  GATED             GATED             barrier>=30
      189       6,207      61  GATED             GATED             barrier>=30
      279      10,255      61  GATED             GATED             barrier>=30
      340      13,000      61  GATED             GATED             barrier>=30
      403      15,835      61  GATED             GATED             barrier>=30
      568      23,268      61  GATED             GATED             barrier>=30
...
```
2026-08-06T01:46:07Z  OK  records=18574 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.4m  drift=0  sci=OK  r115=22B  sweep=31.1s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T01:47:05Z  OK  records=18574 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=27.9s  auto-cycle
