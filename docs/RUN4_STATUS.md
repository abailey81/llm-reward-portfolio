...
**Auto-generated 2026-08-05 15:28 UTC -- T+186h19m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+186h19m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **913** (189 running, 724 queued) |
...
```
generated 2026-08-05 15:28 UTC | elapsed 7.76 d | 21.4 d to the Aug-27 stop
test tier: 15,540 records over 69 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    last  1 h     232 records     232.0 rec/h
    last  3 h     487 records     162.3 rec/h
    last 12 h    1937 records     161.4 rec/h
    last 24 h    3812 records     158.8 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      13,636       3  GATED             GATED             barrier>=30
      403      16,538     232  GATED             GATED             barrier>=30
      568      24,788     232  GATED             GATED             barrier>=30
...
2026-08-05T15:28:41Z  OK  records=17081 (+15)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.1m  drift=0  sci=OK  r115=22B  sweep=255.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
