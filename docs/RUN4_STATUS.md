...
**Auto-generated 2026-08-06 18:47 UTC -- T+213h38m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+213h38m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=135; worst streak 11/240 (4.6% to fatal), pull on core, 1.9 h ago; none live, newest failure 1.8 h ago** |
...
| **cores computing** | **680** |
| **cores doing RUNG-RAISING work** | **28.8%** -- 168 of 584 cores (46 min old) |
...
```
generated 2026-08-06 18:47 UTC | elapsed 8.90 d | 20.2 d to the Aug-27 stop
test tier: 18,378 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,682      28  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,517      28  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,950      28  GATED             GATED             no-records:test/distributional,test/scalar>=30
