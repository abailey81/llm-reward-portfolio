...
**Auto-generated 2026-08-01 20:22 UTC -- T+95h13m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+95h13m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **93** (87 running, 6 queued) |
| **cores computing** | **696** |
...
```
 rung              @696 cores              @830 cores   binding
  ...
  189            7.8 d  08-05            6.5 d  08-04   throughput
  279           11.1 d  08-08            9.3 d  08-07   throughput
  340           13.3 d  08-11           11.1 d  08-09   throughput
  403           15.6 d  08-13           13.0 d  08-10   throughput
  568           21.6 d  08-19           18.1 d  08-15   throughput
```
...
```
2026-08-01T20:17:57Z  RED  records=2737 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=3.9m  drift=0  sci=OK  r115=19B  sweep=14.2s  auto-cycle
2026-08-01T20:18:42Z  RED  records=2737 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.7m  drift=0+1dirty  sci=OK  r115=19B  sweep=19.9s  auto-cycle
2026-08-01T20:19:32Z  RED  records=2737 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=1.5m  drift=0+1dirty  sci=OK  r115=19B  sweep=18.4s  auto-cycle
2026-08-01T20:20:20Z  RED  records=2737 (+0)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.3m  drift=0  sci=OK  r115=19B  sweep=17.0s  auto-cycle
2026-08-01T20:21:08Z  RED  records=2739 (+2)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=3.0m  drift=0  sci=OK  r115=19B  sweep=17.7s  auto-cycle
2026-08-01T20:21:56Z  RED  records=2740 (+1)  spend=$45.4429  guards=2  arms_full=10/10  budget=2  stalest=2.9m  drift=0  sci=OK  r115=19B  sweep=16.9s  auto-cycle
```
