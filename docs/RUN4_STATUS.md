...
**Auto-generated 2026-08-05 02:28 UTC -- T+173h19m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+173h19m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), ops on glm-5_2, 4.0 h ago; none live, newest failure 12 min ago** |
...
| | |
|---|---|
| cluster jobs | **993** (181 running, 812 queued) |
| **cores computing** | **1448** |
...
```
generated 2026-08-05 02:29 UTC | elapsed 7.22 d | 21.9 d to the Aug-27 stop
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    last  3 h     306 records     102.0 rec/h
    last 12 h    2058 records     171.5 rec/h
    last 24 h    4191 records     174.6 rec/h
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      100       3,324      11  GATED             GATED             barrier>=30
      189       7,774      11  GATED             GATED             barrier>=30
      279      12,274      11  GATED             GATED             barrier>=30
      340      15,324      11  GATED             GATED             barrier>=30
      403      18,474      11  GATED             GATED             barrier>=30
      568      26,736      57  GATED             GATED             barrier>=30
...
REGISTERED MODEL (src/cluster/lanes.py) -- a DURATION from a standing start, not a date:
     rung     @1448 cores      @830 cores   binding
