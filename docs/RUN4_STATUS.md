...
**Auto-generated 2026-08-03 12:31 UTC -- T+135h22m.** Refreshed every 5 minutes by the live session and pushed to GitHub, so
...
| | |
|---|---|
| elapsed | **T+135h22m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **724** (165 running, 559 queued) |
...
```
 rung             @1320 cores              @830 cores   binding
  ...
  568           11.4 d  08-09           18.1 d  08-15   throughput
```
...
|---|---|---|
| distributional | g5 of 5 | 2105 |
| scalar | g5 of 5 | 1517 |
| placebo | g5 of 5 | 1642 |
| scalar_cvar5 | g5 of 5 | 1615 |
| placebo_shuffled | g5 of 5 | 1628 |
...
2026-08-03T12:29:07Z  RED  records=8902 (+16)  spend=$45.483  guards=2  arms_full=10/10  budget=2  stalest=1.1m  drift=0  sci=OK  r115=21B  cores=1328  sweep=215.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
