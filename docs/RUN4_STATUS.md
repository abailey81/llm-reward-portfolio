...
**Auto-generated 2026-08-06 20:20 UTC -- T+215h11m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+215h11m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=35; worst streak 11/240 (4.6% to fatal), pull on core, 3.4 h ago; none live, newest failure 3.4 h ago** |
...
| | |
|---|---|
| cluster jobs | **835** = 102 running + **102 ELIGIBLE** + 546 held by us + 85 held only by the site |
...
| **cores computing** | **816** |
| **cores doing RUNG-RAISING work** | **30.3%** -- 240 of 792 cores (27 min old) |
...
```
generated 2026-08-06 20:21 UTC | elapsed 8.97 d | 20.2 d to the Aug-27 stop
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    'is this plausible on current throughput', NOT as an assurance verdict.
     rung   remaining     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340      11,641      19  GATED             GATED             no-records:test/distributional,test/scalar>=30
      403      14,476      19  GATED             GATED             no-records:test/distributional,test/scalar>=30
      568      21,909      19  GATED             GATED             no-records:test/distributional,test/scalar>=30
...
```
2026-08-06T19:47:26Z  OK  records=19957 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  sweep=700.4s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T20:00:34Z  OK  records=19962 (+5)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.2m  drift=0  sci=OK  r115=22B  cores=816  sweep=757.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T20:01:35Z  OK  records=19962 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=31.5s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T20:02:37Z  OK  records=19962 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.3m  drift=0  sci=OK  r115=22B  sweep=31.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-06T20:09:23Z  OK  records=19962 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.1m  drift=0  sci=OK  r115=22B  sweep=375.9s(SWEEP-BOUND: >30s sleep)  auto-cycle
