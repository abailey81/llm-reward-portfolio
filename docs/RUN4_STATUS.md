...
**Auto-generated 2026-08-11 12:20 UTC -- T+327h12m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+327h12m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 1/240 (0.4% to fatal), pull on kimi-k3, 63 min ago; none live, newest failure 63 min ago** |
...
| **cores doing RUNG-RAISING work** | **77.9%** -- 816 of 1048 cores (48 min old) |
...
```
generated 2026-08-11 12:21 UTC | elapsed 13.63 d | 15.5 d to the Aug-27 stop
test tier: 28,945 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279         519     111  2026-08-11 16:55  2026-08-11 16:55  yes
      340       2,654     111  2026-08-12 11:42  2026-08-12 11:42  yes
      403       4,859     111  2026-08-13 07:06  2026-08-13 07:06  yes
      568      11,383     111  2026-08-15 16:30  2026-08-15 16:30  yes
...
> **What is holding it right now: test -- baseline_return_minus_downside has 148 HOLE(S) below its frontier 406 -- that is what caps this line**
