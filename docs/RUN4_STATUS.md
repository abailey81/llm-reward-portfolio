...
**Auto-generated 2026-08-12 02:38 UTC -- T+341h29m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+341h29m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| transport health | **timeouts 6h=0; worst streak 0/240 (0.0% to fatal), - on -, age UNKNOWN; none live, newest failure 9.0 h ago** |
...
| | |
|---|---|
| cluster jobs | **501** = 105 running + **68 ELIGIBLE** + 328 held by us + 0 held only by the site |
...
| **cores computing** | **840** |
| **cores doing RUNG-RAISING work** | **56.7%** -- 440 of 776 cores (65 min old) |
...
```
generated 2026-08-12 02:39 UTC | elapsed 14.23 d | 14.9 d to the Aug-27 stop
test tier: 30,181 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 78.1 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    ...
    last 12 h     937 records      78.1 rec/h   usable
    last 24 h    2449 records     102.0 rec/h   usable
    12 h rate is 64% from ONE line (test); 3 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      340       1,418      48  GATED             GATED             barrier>=279
      403       3,623      48  GATED             GATED             barrier>=279
      568      10,147      48  GATED             GATED             barrier>=279
...
```
2026-08-12T02:29:31Z  OK  records=31712 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=1.9m  drift=0  sci=OK  r115=22B  sweep=57.0s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T02:30:56Z  OK  records=31713 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.0m  drift=0  sci=OK  r115=22B  sweep=54.7s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T02:32:21Z  OK  records=31714 (+1)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.8m  drift=0  sci=OK  r115=22B  sweep=54.3s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T02:33:45Z  OK  records=31714 (+0)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.5m  drift=0  sci=OK  r115=22B  sweep=53.8s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T02:35:08Z  OK  records=31716 (+2)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=3.1m  drift=0  sci=OK  r115=22B  sweep=52.6s(SWEEP-BOUND: >30s sleep)  auto-cycle
2026-08-12T02:36:34Z  OK  records=31719 (+3)  spend=$45.5019  guards=0n/2k  arms_full=10/10legs-ever  budget=2  stalest=2.6m  drift=0  sci=OK  r115=22B  sweep=56.2s(SWEEP-BOUND: >30s sleep)  auto-cycle
```
