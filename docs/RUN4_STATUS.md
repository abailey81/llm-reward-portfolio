...
**Auto-generated 2026-08-11 10:43 UTC -- T+325h34m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+325h34m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| **cores doing RUNG-RAISING work** | **87.4%** -- 1000 of 1144 cores (71 min old) |
...
```
generated 2026-08-11 10:44 UTC | elapsed 13.57 d | 15.6 d to the Aug-27 stop
test tier: 28,776 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)
...
MEASURED test-tier throughput (record mtimes; an observation, not a model):
    ...
    12 h rate is 62% from ONE line (test); 3 line(s) contributed at all
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      279         688     102  2026-08-11 16:43  2026-08-11 16:43  yes
      340       2,823     102  2026-08-12 11:17  2026-08-12 11:17  yes
      403       5,028     102  2026-08-13 06:27  2026-08-13 06:27  yes
      568      11,552     102  2026-08-15 15:11  2026-08-15 15:11  yes
...
> **What is holding it right now: test -- baseline_log_growth has 156 HOLE(S) below its frontier 406 -- that is what caps this line**
...
currently at **251 seeds each** (read live from the archive on this publish). !! THE
