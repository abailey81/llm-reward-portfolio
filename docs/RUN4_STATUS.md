...
**Auto-generated 2026-08-09 15:34 UTC -- T+282h25m.** Refreshed about every 1-1.5 minutes (measured; the publish itself takes
...
| | |
|---|---|
| elapsed | **T+282h25m** (launched 2026-07-28 21:08 UTC; exogenous stop 2026-08-27) |
...
| | |
|---|---|
| cluster jobs | **656** = 136 running + **144 ELIGIBLE** + 376 held by us + 0 held only by the site |
...
| **cores doing RUNG-RAISING work** | **99.3%** -- 1080 of 1088 cores (2 min old) |
...
```
generated 2026-08-09 15:35 UTC | elapsed 11.77 d | 17.4 d to the Aug-27 stop
test tier: 24,159 records over 71 of the 71 registered units (lanes.py _TEST_UNITS_PER_RUNG)

MEASURED test-tier throughput (record mtimes; an observation, not a model):
    => OPERATIVE RATE 98.2 rec/h  (the 12 h window; the shortest one an ETA may be priced from)
    last  1 h     231 records     231.0 rec/h   NOISE, not a rate: shorter than one job's 15.0 h quantum, so it samples the gaps between 8-record bursts
    ...
    last 12 h    1179 records      98.2 rec/h   usable
...
EMPIRICAL ETA -- BOTH columns divide total remaining by a FLEET-WIDE rate, so both
    ...
    !! `remaining` IS A RECORD COUNT AND `REACHED` MEANS *THE COUNT IS MET* --
     ...
     rung  rec-count left     -1h  earliest (UTC)    latest (UTC)      Aug-27?
      ...
      189       1,572     231  2026-08-10 07:35  2026-08-10 07:35  yes
      279       4,722     231  2026-08-11 15:39  2026-08-11 15:39  yes
      340       6,857     231  2026-08-12 13:23  2026-08-12 13:23  yes
      403       9,093     231  2026-08-13 12:08  2026-08-13 12:08  yes
      568      16,169     231  2026-08-16 12:09  2026-08-16 12:09  yes
